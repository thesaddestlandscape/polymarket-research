# Hipótesis automáticas — 2026-09-13 03:13 UTC
_Generado por shadow_postmortem.py sobre 413798 resoluciones (PNL=+43640.77€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.4` → IC=-0.264 (n=5290)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.4
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=15871)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.122 (n=1816)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1130)

- **FILTRO** `restante_s_al_confirmar` < `141.29` → IC=-0.278 (n=736)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.29
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2210)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `132.89` → IC=-0.292 (n=675)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.89
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2026)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `144.91` → IC=-0.165 (n=1368)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.91
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4108)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.41` → IC=-0.254 (n=1213)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.41
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=3642)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.1` → IC=-0.347 (n=1335)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.1
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=2713)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.31` → IC=-0.291 (n=41)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=133)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.171 (n=68)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1534)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `14489.7584` → IC=+0.215 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14489.7584 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=1134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.212 (n=1241)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.269 (n=1090)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1595)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `12692.5302` → IC=+0.206 (n=560)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.189 (n=265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `3892.5771` → IC=+0.165 (n=410)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3892.5771 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.140 (n=1829)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 15.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` > `0.7` → IC=+0.331 (n=689)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=1088)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `4405.1957` → IC=+0.243 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4405.1957 (IC base=+0.237)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.138 (n=448)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=593)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.195 (n=1002)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.85` → IC=+0.426 (n=497)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.186 (n=485)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.187 (n=1051)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.200 (n=7021)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.196)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.217 (n=2986)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.178 (n=1999)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2096)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.239 (n=1574)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.324 (n=596)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=1715)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.189)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.190 (n=1429)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.71 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.191 (n=852)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.235 (n=9395)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.172 (n=3420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 12.0 (IC base=+0.165)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.184 (n=4480)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.224 (n=4312)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.224)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.271 (n=1573)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4477)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.220 (n=1658)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.219)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1566)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.200 (n=4001)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.250 (n=2063)
...
- **PATRÓN** `libro_liquidez` > `1640.8166` → IC=+0.297 (n=875)
...
- **PATRÓN** `libro_liquidez` > `1498.702` → IC=+0.310 (n=372)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1498.702 (IC base=+0.292)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.398 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.86 (IC base=+0.262)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `964.0515` → IC=+0.275 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 964.0515 (IC base=+0.262)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9742` → IC=+0.229 (n=1839)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9742 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.21` → IC=+0.242 (n=1131)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.21 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.83` → IC=+0.166 (n=2122)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.83 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.2306` → IC=+0.242 (n=1366)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2306 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0679` → IC=+0.239 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0679 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.1759` → IC=+0.191 (n=3694)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1759 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.1106` → IC=+0.194 (n=1380)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1106 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `2.8516` → IC=+0.190 (n=3561)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.8516 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.4711` → IC=+0.193 (n=3561)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4711 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.5769` → IC=+0.123 (n=6778)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5769 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` < `0.1302` → IC=+0.164 (n=2001)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1302 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` < `1.2015` → IC=+0.160 (n=2097)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2015 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` > `0.6189` → IC=+0.162 (n=2097)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6189 (IC base=+0.055)

- **PATRÓN** `volumen_pendiente_norm` > `0.1692` → IC=+0.224 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1692 (IC base=+0.055)

- **PATRÓN** `volumen_spike_ratio` > `1.4625` → IC=+0.193 (n=3487)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4625 (IC base=+0.055)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.202 (n=3251)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 166.0 (IC base=+0.055)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.191 (n=412)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3242` → IC=+0.170 (n=1236)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3242 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.193 (n=610)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 8.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.272 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.966` → IC=+0.284 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.966 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2301` → IC=+0.196 (n=222)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2301 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.6282` → IC=+0.156 (n=1130)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.6282 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.163 (n=1130)
...
- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.190 (n=894)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1923` → IC=+0.279 (n=612)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.063` → IC=+0.286 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.063 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.377` → IC=+0.248 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.377 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.0688` → IC=+0.232 (n=723)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7009` → IC=+0.267 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7009 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.240 (n=918)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1573.1624` → IC=+0.247 (n=820)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1573.1624 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.231 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.237)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.239 (n=412)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1116` → IC=+0.237 (n=412)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1116 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.229 (n=980)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.9251` → IC=+0.252 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9251 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.1993` → IC=+0.216 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1993 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.114` → IC=+0.228 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.114 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.224 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8783` → IC=+0.212 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8783 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.1654` → IC=+0.214 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1654 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4924` → IC=+0.230 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4924 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.4178` → IC=+0.219 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4178 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.229 (n=837)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.190 (n=1204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.255 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.367` → IC=+0.236 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.367 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1079` → IC=+0.183 (n=1008)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1079 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.3774` → IC=+0.175 (n=158)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.3774 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.6649` → IC=+0.183 (n=1116)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.6649 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=1351)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.199 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.217 (n=1038)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.210 (n=926)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.1469` → IC=+0.212 (n=457)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.215 (n=483)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.210)

- **PATRÓN** `ibs_20min` < `0.3929` → IC=+0.229 (n=913)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3929 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.688` → IC=+0.233 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.688 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.210 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.394 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.3649` → IC=+0.272 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3649 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` < `1.8456` → IC=+0.200 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8456 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.3036` → IC=+0.216 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3036 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.222 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.210)

- **PATRÓN** `libro_liquidez` > `1887.4151` → IC=+0.221 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.4151 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.202 (n=565)
...
- **PATRÓN** `dist_vwap_pct` > `0.1504` → IC=+0.187 (n=148)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1504 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` < `1.1607` → IC=+0.140 (n=459)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.1607 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.135 (n=458)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6129 (IC base=-0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2145` → IC=+0.203 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2145 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5018` → IC=+0.168 (n=365)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.5018 (IC base=-0.009)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.126 (n=1580)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.607` → IC=-0.196 (n=261)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2104)
...
- **PATRÓN** `dist_vwap_pct` > `0.6436` → IC=+0.289 (n=17)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6436 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` < `1.1373` → IC=+0.179 (n=166)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 1.1373 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` > `0.9321` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 0.9321 (IC base=-0.048)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7403` → IC=+0.242 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7403 (IC base=-0.048)
...
- **FILTRO** `drift_60min` |x|> `0.6317` → IC=-0.189 (n=387)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6317
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1162)

- **FILTRO** `ibs_20min` < `0.6419` → IC=-0.156 (n=1022)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6419
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=527)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.180 (n=311)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1238)

- **FILTRO** `ibs_20min` > `0.7778` → IC=-0.193 (n=588)
...
- **PATRÓN** `dist_vwap_pct` < `0.2364` → IC=+0.227 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2364 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` > `1.0829` → IC=+0.287 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0829 (IC base=-0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.1065` → IC=+0.252 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1065 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` < `2.224` → IC=+0.243 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.224 (IC base=-0.031)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.224 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 36.0 (IC base=-0.031)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.167 (n=2289)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0091 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.4554` → IC=+0.170 (n=6130)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4554 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.6962` → IC=+0.271 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6962 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.483` → IC=+0.136 (n=3251)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.483 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` > `0.6734` → IC=+0.225 (n=2061)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6734 (IC base=+0.084)

- **PATRÓN** `volumen_pendiente_norm` > `0.249` → IC=+0.252 (n=732)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.249 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `1.4807` → IC=+0.233 (n=1215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4807 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `2.8039` → IC=+0.232 (n=1215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8039 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.275 (n=3125)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.084)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.137 (n=2359)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0084 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.145 (n=6229)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5625 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6563` → IC=+0.240 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6563 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.1953` → IC=+0.255 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1953 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.2502` → IC=+0.321 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2502 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `1.6166` → IC=+0.251 (n=1041)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6166 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `2.3743` → IC=+0.257 (n=1073)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3743 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.254 (n=2217)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3469` → IC=-0.123 (n=614)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3469
  - _Potencial_: sin este filtro IC_bueno=+0.116 (n=1247)

- **FILTRO** `sigma_ewma_delta_pct` > `4.316` → IC=-0.158 (n=358)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.316
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1178)

- **PATRÓN** `ibs_20min` > `0.8545` → IC=+0.252 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8545 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.987` → IC=+0.161 (n=487)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8686` → IC=+0.195 (n=303)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6662` → IC=+0.199 (n=151)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6662 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.215 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 74.0 (IC base=+0.037)
...
- **FILTRO** `ibs_20min` > `0.8364` → IC=-0.151 (n=526)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1582)

- **PATRÓN** `dist_vwap_pct` > `0.1106` → IC=+0.122 (n=310)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.1106 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `0.6518` → IC=+0.123 (n=528)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4206` → IC=+0.158 (n=191)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4206 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `236.0` → IC=+0.172 (n=187)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 236.0 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.241 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1336 (IC base=-0.004)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.354 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.276 (IC base=-0.004)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.220 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7599 (IC base=-0.004)

- **PATRÓN** `volumen_spike_ratio` > `2.13` → IC=+0.227 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.13 (IC base=-0.004)

- **PATRÓN** `ballena_activa_n` < `517.0` → IC=+0.216 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 517.0 (IC base=-0.004)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.266 (n=978)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.251 (n=536)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.58` → IC=+0.279 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.58 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.1116` → IC=+0.256 (n=903)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1116 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `3.1092` → IC=+0.248 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1092 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.296 (n=865)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `2.2948` → IC=+0.226 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2948 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.224 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 158.0 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` > `0.1051` → IC=+0.167 (n=67)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1051 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` < `1.0742` → IC=+0.148 (n=160)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0742 (IC base=-0.031)

- **PATRÓN** `volumen_regimen` > `0.6828` → IC=+0.136 (n=160)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.6828 (IC base=-0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.1844` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1844 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.7063` → IC=+0.220 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7063 (IC base=-0.031)

- **PATRÓN** `volumen_spike_ratio` > `1.4982` → IC=+0.225 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4982 (IC base=-0.031)

- **PATRÓN** `ballena_activa_n` < `155.0` → IC=+0.219 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 155.0 (IC base=-0.031)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6579` → IC=-0.196 (n=747)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6579
  - _Potencial_: sin este filtro IC_bueno=+0.243 (n=750)

- **FILTRO** `ibs_20min` > `0.7241` → IC=-0.236 (n=399)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7241
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1201)

- **FILTRO** `sigma_ewma_delta_pct` > `4.766` → IC=-0.158 (n=384)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.766
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1216)

- **PATRÓN** `ibs_20min` > `0.6579` → IC=+0.243 (n=750)
...
- **PATRÓN** `dist_vwap_pct` > `0.5114` → IC=+0.172 (n=59)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5114 (IC base=-0.002)

- **PATRÓN** `dist_vwap_pct` < `0.156` → IC=+0.184 (n=261)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.156 (IC base=-0.002)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.225 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=-0.002)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.186 (n=253)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.1007 (IC base=-0.002)
...
- **PATRÓN** `sigma_h` > `0.0138` → IC=+0.295 (n=699)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0138 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.283 (n=524)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.269)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.269 (n=1115)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.3875` → IC=+0.302 (n=1049)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3875 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.5158` → IC=+0.291 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5158 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.385` → IC=+0.281 (n=373)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.385 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` < `0.6348` → IC=+0.270 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6348 (IC base=+0.269)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.265 (n=892)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `2.1719` → IC=+0.269 (n=404)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1719 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `2556.2328` → IC=+0.279 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2556.2328 (IC base=+0.269)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.177 (n=1840)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0047 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1838)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.3338` → IC=+0.175 (n=4853)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3338 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=5763)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.6946` → IC=+0.229 (n=4926)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6946 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1608` → IC=+0.196 (n=2413)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1608 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.217` → IC=+0.250 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.217 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.162 (n=3689)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2184 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6224` → IC=+0.159 (n=3690)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6224 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.107` → IC=+0.188 (n=2156)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.107 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `2.3147` → IC=+0.169 (n=4593)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.3147 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `3831.2799` → IC=+0.174 (n=1838)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3831.2799 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.185 (n=4431)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 127.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.186 (n=3527)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0063 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.0783` → IC=+0.203 (n=1763)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4565` → IC=+0.224 (n=5287)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4565 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.732` → IC=+0.189 (n=2192)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 3.732 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.155 (n=3877)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1856 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.152 (n=3877)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6252 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.291` → IC=+0.227 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.291 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.8752` → IC=+0.169 (n=3097)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.8752 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.631` → IC=+0.173 (n=1548)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.631 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.169 (n=4247)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.239 (n=577)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1821` → IC=+0.295 (n=437)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.244 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.236)

- **PATRÓN** `ibs_20min` < `0.1095` → IC=+0.265 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1095 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.964` → IC=+0.248 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.964 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` < `0.0688` → IC=+0.231 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0688 (IC base=+0.236)

- **PATRÓN** `volumen_pendiente_norm` > `0.2346` → IC=+0.258 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2346 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` < `1.8662` → IC=+0.252 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8662 (IC base=+0.236)

- **PATRÓN** `volumen_spike_ratio` > `2.631` → IC=+0.231 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.631 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `1576.48` → IC=+0.251 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.48 (IC base=+0.236)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.229 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 73.0 (IC base=+0.236)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3628` → IC=+0.175 (n=796)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4506` → IC=+0.221 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4506 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.2099` → IC=+0.215 (n=471)
...
- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.177 (n=796)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.198 (n=903)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0059 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.1967` → IC=+0.197 (n=602)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1967 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.219 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.190 (n=420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 7.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.553` → IC=+0.270 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.553 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.1079` → IC=+0.184 (n=733)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1079 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.6731` → IC=+0.183 (n=279)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.6731 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.3539` → IC=+0.193 (n=558)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.3539 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=998)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.206 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.231 (n=756)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.223 (n=344)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0092 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.0863` → IC=+0.240 (n=252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3571` → IC=+0.249 (n=758)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3571 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.666` → IC=+0.266 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.666 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.3595` → IC=+0.270 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3595 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.8345` → IC=+0.208 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8345 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.2531` → IC=+0.227 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2531 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1886.4395` → IC=+0.228 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1886.4395 (IC base=+0.217)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.207 (n=380)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.4227` → IC=+0.169 (n=862)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.4164` → IC=+0.206 (n=861)
...
- **PATRÓN** `volumen_regimen` < `0.8656` → IC=+0.166 (n=575)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8656 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `1.2029` → IC=+0.185 (n=287)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 1.2029 (IC base=+0.157)
...
- **PATRÓN** `libro_liquidez` > `7612.6539` → IC=+0.196 (n=574)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 7612.6539 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.166 (n=701)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 158.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.159 (n=814)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.006 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.372` → IC=+0.147 (n=925)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.372 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.185 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 18.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.5954` → IC=+0.176 (n=925)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5954 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.1469` → IC=+0.139 (n=923)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1469 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.147` → IC=+0.194 (n=181)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 12.147 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `0.8624` → IC=+0.140 (n=617)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8624 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.132 (n=924)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.6135 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.0738` → IC=+0.168 (n=365)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.0738 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `1.7858` → IC=+0.130 (n=541)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.7858 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `9877.5526` → IC=+0.151 (n=419)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9877.5526 (IC base=+0.126)
...
- **PATRÓN** `ibs_20min` > `0.5111` → IC=+0.196 (n=1042)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1060)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3132.1873` → IC=+0.211 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3132.1873 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.138 (n=744)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.150 (n=441)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0059 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.0964` → IC=+0.143 (n=334)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.0964 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.178 (n=467)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5294` → IC=+0.204 (n=1002)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5294 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.6832` → IC=+0.130 (n=187)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.6832 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.1817` → IC=+0.136 (n=924)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1817 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.316` → IC=+0.154 (n=209)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.316 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.0465` → IC=+0.128 (n=882)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.0465 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.2729` → IC=+0.175 (n=118)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2729 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.5679` → IC=+0.123 (n=380)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.5679 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.1435` → IC=+0.141 (n=391)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.1435 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3109.6156` → IC=+0.155 (n=334)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3109.6156 (IC base=+0.115)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.208 (n=660)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0175 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.215 (n=436)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.203 (n=452)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.250 (n=886)
...
- **PATRÓN** `volumen_regimen` < `1.2034` → IC=+0.200 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2034 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.8476` → IC=+0.216 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8476 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.1692` → IC=+0.254 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1692 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `2.2072` → IC=+0.213 (n=835)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2072 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.4285` → IC=+0.202 (n=949)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.211 (n=482)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.4309` → IC=+0.235 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4309 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `0.4886` → IC=+0.207 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4886 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.938` → IC=+0.231 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.938 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6258` → IC=+0.214 (n=1046)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6258 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.291 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.194 (n=803)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2444 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.186 (n=912)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4611 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `2520.5921` → IC=+0.211 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2520.5921 (IC base=+0.200)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.144 (n=562)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0941` → IC=+0.149 (n=426)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.0941 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.164 (n=1196)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.4087` → IC=+0.168 (n=1278)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.4087 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.783` → IC=+0.188 (n=171)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.783 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.713` → IC=+0.176 (n=576)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.713 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.160 (n=727)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8615 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` < `0.0753` → IC=+0.141 (n=1094)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.0753 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1672` → IC=+0.164 (n=352)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1672 (IC base=+0.139)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8234` → IC=+0.153 (n=813)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8234 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.146 (n=1409)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `8031.121` → IC=+0.175 (n=580)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 8031.121 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.162 (n=362)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 20.0 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.142 (n=442)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0037 (IC base=+0.103)

- **PATRÓN** `ibs_20min` < `0.305` → IC=+0.160 (n=879)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.305 (IC base=+0.103)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.825` → IC=+0.129 (n=524)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 3.825 (IC base=+0.103)

- **PATRÓN** `volumen_pendiente_norm` > `0.1662` → IC=+0.146 (n=337)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1662 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` < `2.2258` → IC=+0.126 (n=1101)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.257 (n=175)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.237 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.2721` → IC=+0.248 (n=391)
...
- **PATRÓN** `volumen_regimen` > `1.1605` → IC=+0.244 (n=131)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0232` → IC=+0.268 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0232 (IC base=+0.207)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `12495.4243` → IC=+0.229 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12495.4243 (IC base=+0.207)

- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.132 (n=218)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0047 (IC base=+0.085)

- **PATRÓN** `drift_60min` |x|≤ `0.0956` → IC=+0.149 (n=109)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0956 (IC base=+0.085)

- **PATRÓN** `ibs_20min` < `0.3259` → IC=+0.136 (n=218)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.3259 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.016` → IC=+0.130 (n=117)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 4.016 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.128 (n=76)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1657 (IC base=+0.085)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=126)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 15.0 (IC base=+0.066)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.211 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.066)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.145 (n=122)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.066)

- **PATRÓN** `libro_liquidez` > `2775.0073` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2775.0073 (IC base=+0.066)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.153 (n=240)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.4524 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.751` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 8.751 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` < `0.7263` → IC=+0.148 (n=106)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7263 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `2.4886` → IC=+0.121 (n=217)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.4886 (IC base=+0.073)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.131 (n=185)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 47.0 (IC base=+0.073)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.191 (n=3133)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4754` → IC=+0.211 (n=6907)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4754 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.3884` → IC=+0.189 (n=1792)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.3884 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.221 (n=3387)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.164 (n=3123)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8827 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1701` → IC=+0.184 (n=1900)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1701 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6484` → IC=+0.178 (n=2184)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6484 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8199)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3790.4821` → IC=+0.172 (n=2303)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3790.4821 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.192 (n=4872)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 98.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.197 (n=4210)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0067 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4744` → IC=+0.184 (n=6315)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4744 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.200 (n=2432)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.184 (n=2897)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.237 (n=6315)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5597 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2256` → IC=+0.166 (n=3997)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.2256 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.771` → IC=+0.202 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.771 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.691` → IC=+0.182 (n=6098)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.691 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.0564` → IC=+0.157 (n=3838)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.0564 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.1975` → IC=+0.160 (n=1455)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.1975 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2366` → IC=+0.244 (n=1101)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2366 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2916` → IC=+0.190 (n=2535)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2916 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.177 (n=5198)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 131.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.221 (n=388)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.322` → IC=+0.197 (n=1152)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.213 (n=773)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.329 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.775` → IC=+0.327 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.775 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.0945` → IC=+0.225 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0945 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.5585` → IC=+0.201 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5585 (IC base=+0.196)
...
- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.232 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 80.0 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.264 (n=797)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.259)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.272 (n=909)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0043 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.2046` → IC=+0.285 (n=604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2046 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.271 (n=822)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.0693` → IC=+0.305 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0693 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.621` → IC=+0.269 (n=905)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2285` → IC=+0.316 (n=161)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2285 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `1.9092` → IC=+0.278 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9092 (IC base=+0.259)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.259 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1576.48` → IC=+0.268 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.48 (IC base=+0.259)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.257 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.259)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.195 (n=369)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0027 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.1832` → IC=+0.155 (n=729)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1832 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1144)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.6943` → IC=+0.241 (n=729)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6943 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1242` → IC=+0.190 (n=608)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1242 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.887` → IC=+0.169 (n=255)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.887 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.155 (n=971)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.2804` → IC=+0.162 (n=1093)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2804 (IC base=+0.148)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4495` → IC=+0.162 (n=1041)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4495 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7674` → IC=+0.160 (n=694)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7674 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10653.1142` → IC=+0.172 (n=977)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 10653.1142 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `500.0` → IC=+0.165 (n=969)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 500.0 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.226 (n=1076)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.236 (n=384)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.226)

- **PATRÓN** `ibs_20min` < `0.3871` → IC=+0.264 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3871 (IC base=+0.226)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.683` → IC=+0.273 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.683 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` > `0.3614` → IC=+0.286 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3614 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` < `2.9643` → IC=+0.216 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9643 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` > `2.256` → IC=+0.225 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.256 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.237 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `1891.5784` → IC=+0.227 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.5784 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.215 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 55.0 (IC base=+0.226)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.172 (n=513)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0038 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.143 (n=390)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7134` → IC=+0.236 (n=776)
...
- **PATRÓN** `volumen_regimen` < `0.8819` → IC=+0.161 (n=777)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8819 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1997` → IC=+0.139 (n=388)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.1997 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7491` → IC=+0.160 (n=744)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7491 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `9055.4459` → IC=+0.236 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9055.4459 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.145 (n=914)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 169.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.164 (n=620)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.005 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.424` → IC=+0.150 (n=930)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.424 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.166 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.155 (n=415)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6941` → IC=+0.181 (n=930)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6941 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.1974` → IC=+0.136 (n=858)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1974 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.137` → IC=+0.186 (n=138)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.137 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.299` → IC=+0.132 (n=868)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.299 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.8525` → IC=+0.138 (n=620)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8525 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.1684` → IC=+0.144 (n=310)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1684 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2736` → IC=+0.245 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2736 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.1232` → IC=+0.160 (n=392)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.1232 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `11109.2556` → IC=+0.173 (n=310)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 11109.2556 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `199.0` → IC=+0.133 (n=853)
...
- **PATRÓN** `ibs_20min` > `0.4583` → IC=+0.174 (n=1208)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4583 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0026` → IC=+0.174 (n=213)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 1.0026 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.213 (n=447)
...
- **PATRÓN** `libro_liquidez` > `2936.1798` → IC=+0.248 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2936.1798 (IC base=+0.094)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.182 (n=376)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0055 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.151 (n=376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1197 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.156 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.211 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.619 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` < `0.1894` → IC=+0.141 (n=915)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1894 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.368` → IC=+0.128 (n=1082)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.368 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `0.7146` → IC=+0.154 (n=495)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7146 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.2176` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2176 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.4671` → IC=+0.159 (n=323)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4671 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `2.2064` → IC=+0.137 (n=439)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.2064 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.127 (n=1235)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.03 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2958.5751` → IC=+0.161 (n=375)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2958.5751 (IC base=+0.119)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0238` → IC=+0.215 (n=552)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=1083)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.202)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.306 (n=436)
...
- **PATRÓN** `volumen_regimen` < `1.2386` → IC=+0.206 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2386 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.206 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6199 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2377` → IC=+0.233 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2377 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `2.612` → IC=+0.226 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.612 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=1243)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2558.2904` → IC=+0.208 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2558.2904 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=447)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.200)

- **PATRÓN** `sigma_h` > `0.0252` → IC=+0.225 (n=445)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.204 (n=1412)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.251 (n=1336)
...
- **PATRÓN** `dist_vwap_pct` < `0.2603` → IC=+0.203 (n=1245)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2603 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.532` → IC=+0.264 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.532 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.2318` → IC=+0.238 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2318 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.253 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2267` → IC=+0.192 (n=1020)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2267 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4468` → IC=+0.197 (n=1158)
...
- **PATRÓN** `libro_liquidez` > `2535.8754` → IC=+0.203 (n=890)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2535.8754 (IC base=+0.200)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.182 (n=1068)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.144 (n=1864)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0096 (IC base=+0.130)

- **PATRÓN** `drift_60min` |x|≤ `0.5333` → IC=+0.138 (n=2118)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.138 (n=708)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_regimen` > `0.8972` → IC=+0.129 (n=918)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.8972 (IC base=+0.130)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8844` → IC=+0.143 (n=1397)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8844 (IC base=+0.130)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.026` → IC=+0.190 (n=27)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 9.026 (IC base=-0.006)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.177 (n=385)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.005 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.162 (n=208)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 18.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.6404` → IC=+0.199 (n=486)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.248` → IC=+0.206 (n=158)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.248 (IC base=+0.091)

- **PATRÓN** `volumen_pendiente_norm` > `0.2867` → IC=+0.231 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2867 (IC base=+0.091)

- **PATRÓN** `volumen_spike_ratio` < `2.5266` → IC=+0.140 (n=381)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.5266 (IC base=+0.091)
...
- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.160 (n=210)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.091)
...
- **FILTRO** `dist_vwap_pct` > `0.2306` → IC=-0.333 (n=16)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.246 (n=124)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=92)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.048)

- **PATRÓN** `ibs_20min` < `0.251` → IC=+0.140 (n=170)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.251 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.866` → IC=+0.147 (n=83)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 5.866 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.0649` → IC=+0.133 (n=58)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.0649 (IC base=+0.048)

- **PATRÓN** `libro_liquidez` > `3687.23` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3687.23 (IC base=+0.048)
...
- **PATRÓN** `ibs_20min` > `0.6645` → IC=+0.179 (n=51)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.6645 (IC base=+0.071)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.321` → IC=+0.300 (n=18)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.321 (IC base=+0.018)
...
- **PATRÓN** `libro_liquidez` > `2813.5755` → IC=+0.174 (n=139)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2813.5755 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2385.287` → IC=+0.127 (n=408)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2385.287 (IC base=+0.088)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=5641)

### MOMENTUM_IBS_15M#BTC#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=967)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1096)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.173 (n=2342)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=7049)

- **FILTRO** `py_entrada` > `0.605` → IC=-0.167 (n=2432)

  - _Acción_: SKIP cuando `py_entrada` > 0.605
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=7310)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.208 (n=375)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=1180)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.200 (n=395)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=1233)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.218 (n=409)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1293)

- **FILTRO** `ibs_20min` > `0.2889` → IC=-0.179 (n=425)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.191 (n=376)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1148)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.185 (n=426)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2000)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1885)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5492)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=16870)

- **FILTRO** `ibs_7min` < `0.7125` → IC=-0.231 (n=5586)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7125
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=16776)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.162 (n=7563)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=14799)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.220 (n=6899)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=20959)

- **FILTRO** `ibs_7min` > `0.298` → IC=-0.174 (n=6964)

  - _Acción_: SKIP cuando `ibs_7min` > 0.298
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=20894)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.313 (n=818)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2681)

- **FILTRO** `ibs_7min` < `0.7109` → IC=-0.258 (n=1154)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7109
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2345)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.203 (n=849)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2650)

- **FILTRO** `py_entrada` > `0.51` → IC=-0.150 (n=3180)

  - _Acción_: SKIP cuando `py_entrada` > 0.51
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=1664)

- **FILTRO** `drift_7min_pct` |x|> `0.1097` → IC=-0.125 (n=1645)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1097
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3199)

- **FILTRO** `ibs_7min` > `0.8014` → IC=-0.202 (n=1210)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8014
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3634)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.149 (n=903)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=3046)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.253 (n=978)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2971)

- **FILTRO** `ibs_7min` < `0.7638` → IC=-0.180 (n=987)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7638
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2962)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.170 (n=984)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2965)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=911)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3054)

- **FILTRO** `ibs_7min` > `0.2497` → IC=-0.168 (n=991)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2497
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2974)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.162 (n=1340)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2625)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.177 (n=800)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=2509)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=777)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2532)

- **FILTRO** `ibs_7min` < `0.21` → IC=-0.268 (n=827)

  - _Acción_: SKIP cuando `ibs_7min` < 0.21
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2482)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.215 (n=773)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2536)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=1174)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3910)

- **FILTRO** `ibs_7min` > `0.2667` → IC=-0.152 (n=1725)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2667
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3359)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.133 (n=1149)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2539)

- **FILTRO** `ibs_7min` < `0.7524` → IC=-0.183 (n=922)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7524
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=2766)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.184 (n=919)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=2769)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.262 (n=913)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2829)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.173 (n=935)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2807)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.176 (n=932)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2810)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.233 (n=1029)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=3118)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.200 (n=1031)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3116)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.170 (n=1260)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=4008)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.280 (n=889)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2881)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.223 (n=942)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2828)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=878)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2892)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.194 (n=1190)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=3765)
...
- **PATRÓN** `hora_utc` > `3.0` → IC=+0.415 (n=69)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=2136)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.189 (n=323)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0584` → IC=+0.174 (n=326)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.0584 (IC base=+0.166)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0589` → IC=+0.171 (n=967)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.85€ cuando `delta_ratio_macro` |x|> 0.0589 (IC base=+0.166)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3447` → IC=+0.207 (n=647)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.187 (n=464)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 6.0 (IC base=+0.166)

- **PATRÓN** `ibs_15` > `0.6173` → IC=+0.239 (n=967)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6173 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.1038` → IC=+0.170 (n=635)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1038 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.699` → IC=+0.242 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.699 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.167 (n=858)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2972.5116` → IC=+0.178 (n=645)
...
- **FILTRO** `sigma_ewma_delta_pct` > `26.847` → IC=-0.265 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=269)
...
- **PATRÓN** `libro_liquidez` > `8644.3532` → IC=+0.223 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8644.3532 (IC base=+0.193)
...
- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.148 (n=103)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0055 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0768` → IC=+0.167 (n=100)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0768 (IC base=+0.137)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1408` → IC=+0.167 (n=151)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1408 (IC base=+0.137)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2712` → IC=+0.171 (n=138)

  - _Acción_: Kelly boost +0.86€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2712 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.151 (n=236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 17.0 (IC base=+0.137)

- **PATRÓN** `ibs_15` > `0.698` → IC=+0.265 (n=202)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.698 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.3919` → IC=+0.156 (n=239)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.3919 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.024` → IC=+0.211 (n=102)
...
- **PATRÓN** `libro_liquidez` > `10110.2635` → IC=+0.138 (n=103)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 10110.2635 (IC base=+0.137)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.62` → IC=-0.143 (n=113)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.62
...
- **PATRÓN** `ibs_15` < `0.1053` → IC=+0.163 (n=292)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0122` → IC=-0.196 (n=495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0122
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1487)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=611)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1371)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.297` → IC=+0.216 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.297 (IC base=-0.056)

- **PATRÓN** `ibs_15` > `0.5837` → IC=+0.244 (n=495)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5837 (IC base=-0.056)

- **PATRÓN** `dist_vwap_pct` < `0.2628` → IC=+0.172 (n=388)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.2628 (IC base=-0.056)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1184` → IC=+0.224 (n=635)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1184 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1818` → IC=+0.230 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1818 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.356` → IC=+0.268 (n=952)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.356 (IC base=-0.051)

- **PATRÓN** `dist_vwap_pct` > `0.3824` → IC=+0.251 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3824 (IC base=-0.051)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.145 (n=302)

- **PATRÓN** `sigma_h` > `0.0039` → IC=+0.157 (n=214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0039 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.0791` → IC=+0.222 (n=106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0791 (IC base=+0.129)

- **PATRÓN** `drift_15min` |x|≤ `0.4169` → IC=+0.171 (n=80)

  - _Acción_: Kelly boost +0.85€ cuando `drift_15min` |x|≤ 0.4169 (IC base=+0.129)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0547` → IC=+0.132 (n=240)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.66€ cuando `delta_ratio_macro` |x|> 0.0547 (IC base=+0.129)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3059` → IC=+0.231 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3059 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.161 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 15.0 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.140 (n=98)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 5.0 (IC base=+0.129)

- **PATRÓN** `ibs_15` > `0.6371` → IC=+0.256 (n=240)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6371 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.1041` → IC=+0.163 (n=173)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1041 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` < `18.838` → IC=+0.140 (n=256)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 18.838 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=302)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `10550.3134` → IC=+0.212 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10550.3134 (IC base=+0.129)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.225 (n=347)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0068 (IC base=+0.212)

- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.212 (n=394)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0043 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.3488` → IC=+0.225 (n=347)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3488 (IC base=+0.212)

- **PATRÓN** `drift_15min` |x|≤ `0.7427` → IC=+0.213 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7427 (IC base=+0.212)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2338` → IC=+0.231 (n=132)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2338 (IC base=+0.212)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.241 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.212)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.222 (n=264)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.212)

- **PATRÓN** `ibs_15` < `0.3605` → IC=+0.258 (n=394)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3605 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` > `0.7133` → IC=+0.233 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7133 (IC base=+0.212)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `11.764` → IC=+0.220 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.764 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `3697.3773` → IC=+0.212 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3697.3773 (IC base=+0.212)

### UPDOWN_GBM_15M_TARDIO#SOL#15min
- **FILTRO** `drift_60min` |x|> `0.1649` → IC=-0.213 (n=165)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
...
- **FILTRO** `drift_15min` |x|> `0.8384` → IC=-0.240 (n=121)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.113 (n=367)

- **PATRÓN** `ibs_15` > `0.8889` → IC=+0.333 (n=16)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8889 (IC base=-0.145)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0711` → IC=+0.201 (n=185)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0711 (IC base=-0.045)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.194` → IC=+0.181 (n=133)

  - _Acción_: Kelly boost +0.91€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.194 (IC base=-0.045)

- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.246 (n=207)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.293 (n=322)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.058` → IC=+0.334 (n=161)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_15` > `0.835` → IC=+0.331 (n=483)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.491` → IC=+0.303 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.491 (IC base=+0.288)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.292 (n=589)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.300 (n=188)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0502` → IC=+0.338 (n=72)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0502 (IC base=+0.297)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1901` → IC=+0.328 (n=97)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1901 (IC base=+0.297)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2262` → IC=+0.356 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2262 (IC base=+0.297)
...
- **PATRÓN** `dist_vwap_pct` < `0.4391` → IC=+0.303 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4391 (IC base=+0.297)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.398` → IC=+0.322 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.398 (IC base=+0.297)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.311 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.297)

- **PATRÓN** `libro_liquidez` > `10425.7161` → IC=+0.308 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10425.7161 (IC base=+0.297)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.309 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 165.0 (IC base=+0.297)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6173 sube el IC de +0.166 a +0.239 en UPDOWN_GBM#15min (n=967). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.698 sube el IC de +0.137 a +0.265 en UPDOWN_GBM#ETH#15min (n=202). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1053 sube el IC de +0.044 a +0.163 en UPDOWN_GBM#XRP#15min (n=292). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5837 sube el IC de -0.056 a +0.244 en UPDOWN_GBM_15M_TARDIO (n=495). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.356 sube el IC de -0.051 a +0.268 en UPDOWN_GBM_15M_TARDIO (n=952). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6371 sube el IC de +0.129 a +0.256 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=240). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3605 sube el IC de +0.212 a +0.258 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=394). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.045 a +0.246 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=207). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3333 sube el IC de -0.050 a +0.284 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=271). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0