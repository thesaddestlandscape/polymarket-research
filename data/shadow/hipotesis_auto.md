# Hipótesis automáticas — 2026-09-05 23:44 UTC
_Generado por shadow_postmortem.py sobre 302141 resoluciones (PNL=+29517.82€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.55` → IC=-0.300 (n=4033)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.55
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=12099)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `133.5` → IC=-0.323 (n=547)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.5
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1641)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `628.69` → IC=-0.159 (n=338)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` > 628.69
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=658)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `118.98` → IC=-0.397 (n=531)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.98
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=1596)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `157.2` → IC=-0.161 (n=1068)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.2
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3207)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `145.69` → IC=-0.312 (n=902)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.69
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2707)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `160.75` → IC=-0.374 (n=968)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.75
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=1969)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.192 (n=8414)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.162 (n=2161)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2364.1007` → IC=+0.163 (n=2073)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2364.1007 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.144 (n=5242)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=5328)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.179 (n=4147)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.02 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1942.236` → IC=+0.171 (n=3551)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1942.236 (IC base=+0.138)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=931)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1184)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `13015.441` → IC=+0.216 (n=421)
...
- **PATRÓN** `py_entrada` < `0.325` → IC=+0.289 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.193 (n=1257)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.41` → IC=+0.181 (n=349)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.41 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `4037.3082` → IC=+0.157 (n=333)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 4037.3082 (IC base=+0.132)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.144 (n=1665)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.309 (n=589)
...
- **PATRÓN** `libro_liquidez` > `1926.6564` → IC=+0.268 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.6564 (IC base=+0.253)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.213 (n=419)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.128 (n=559)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.197 (n=6645)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.205 (n=3188)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `6148.0953` → IC=+0.325 (n=55)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=1699)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.405 (n=40)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.299)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.332 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.299)

- **PATRÓN** `libro_liquidez` > `5363.4643` → IC=+0.320 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5363.4643 (IC base=+0.299)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1594)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.187 (n=1134)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.72 (IC base=+0.172)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=1425)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.315 (n=539)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=1625)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.193 (n=837)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.179 (n=3327)

  - _Acción_: Kelly boost +0.89€ cuando `py_entrada` > 0.71 (IC base=+0.154)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.229 (n=1652)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.276 (n=1483)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.225)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.181 (n=1215)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=3323)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.167)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=1696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.29` → IC=+0.166 (n=1281)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9516` → IC=+0.211 (n=1350)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9516 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.227 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` < `0.1712` → IC=+0.226 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1712 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.724` → IC=+0.154 (n=1549)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.724 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` < `0.627` → IC=+0.232 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.627 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.243 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.1711` → IC=+0.191 (n=714)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1711 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` < `2.8651` → IC=+0.182 (n=2471)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.8651 (IC base=+0.087)

- **PATRÓN** `volumen_spike_ratio` > `1.4716` → IC=+0.179 (n=2471)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4716 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4014` → IC=+0.126 (n=3846)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.4014 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.334` → IC=+0.142 (n=1432)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.334 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8548` → IC=+0.145 (n=926)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8548 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.0483` → IC=+0.143 (n=629)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9355` → IC=+0.195 (n=1453)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2955` → IC=+0.167 (n=908)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.270 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.665` → IC=+0.282 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.665 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2298` → IC=+0.239 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2298 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `2.6728` → IC=+0.149 (n=811)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.6728 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.5555` → IC=+0.156 (n=724)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.5555 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.198 (n=767)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `43.0` → IC=+0.194 (n=371)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 43.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.251 (n=419)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.241)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.256 (n=563)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.241)

- **PATRÓN** `drift_60min` |x|≤ `0.1822` → IC=+0.291 (n=419)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.255 (n=659)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.241)

- **PATRÓN** `ibs_20min` < `0.4088` → IC=+0.274 (n=552)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4088 (IC base=+0.241)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.37` → IC=+0.259 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.37 (IC base=+0.241)

- **PATRÓN** `volumen_pendiente_norm` < `0.0688` → IC=+0.237 (n=465)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8125` → IC=+0.299 (n=172)
...
- **PATRÓN** `libro_liquidez` > `1719.82` → IC=+0.257 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1719.82 (IC base=+0.241)

- **PATRÓN** `ballena_activa_n` < `67.0` → IC=+0.241 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 67.0 (IC base=+0.241)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.248 (n=236)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2019` → IC=+0.229 (n=470)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2019 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.232 (n=710)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.3717` → IC=+0.225 (n=704)
...
- **PATRÓN** `dist_vwap_pct` < `0.4532` → IC=+0.215 (n=647)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4532 (IC base=+0.213)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0786` → IC=+0.163 (n=253)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0786 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.148 (n=679)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6605` → IC=+0.169 (n=757)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6605 (IC base=+0.145)
...
- **PATRÓN** `volumen_regimen` < `0.6809` → IC=+0.166 (n=333)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6809 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7274` → IC=+0.164 (n=433)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.7274 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4046` → IC=+0.162 (n=648)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4046 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12567.3384` → IC=+0.150 (n=504)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12567.3384 (IC base=+0.145)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.193 (n=288)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.389` → IC=+0.278 (n=187)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.389 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` < `0.1035` → IC=+0.163 (n=712)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` < 0.1035 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `3.1353` → IC=+0.160 (n=683)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 3.1353 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.8863` → IC=+0.181 (n=693)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.8863 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.190 (n=914)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.193 (n=546)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 48.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.229 (n=715)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.222)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.224 (n=640)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.222)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.237 (n=355)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0263` → IC=+0.277 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0263 (IC base=+0.222)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.992` → IC=+0.234 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.992 (IC base=+0.222)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6995` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6995 (IC base=+0.222)

- **PATRÓN** `volumen_spike_ratio` > `2.4031` → IC=+0.212 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4031 (IC base=+0.222)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1153` → IC=+0.286 (n=68)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4292` → IC=+0.375 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4292 (IC base=-0.026)

- **PATRÓN** `volumen_spike_ratio` > `1.9064` → IC=+0.290 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9064 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `154.0` → IC=+0.297 (n=72)
...
- **FILTRO** `ibs_20min` < `0.2941` → IC=-0.157 (n=65)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.140 (n=134)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.162 (n=2275)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0078 (IC base=+0.079)

- **PATRÓN** `ibs_20min` > `0.3106` → IC=+0.149 (n=5009)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.3106 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `1.1801` → IC=+0.294 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1801 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.486` → IC=+0.122 (n=2652)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` > 2.486 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` > `0.6815` → IC=+0.224 (n=1467)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6815 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.2513` → IC=+0.247 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2513 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `1.4866` → IC=+0.233 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4866 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` > `2.8017` → IC=+0.223 (n=844)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8017 (IC base=+0.079)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.292 (n=1991)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.079)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.128 (n=4797)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.5833 (IC base=+0.051)

- **PATRÓN** `dist_vwap_pct` > `0.7669` → IC=+0.250 (n=238)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7669 (IC base=+0.051)
...
- **PATRÓN** `volumen_regimen` > `1.2233` → IC=+0.242 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2233 (IC base=+0.051)

- **PATRÓN** `volumen_pendiente_norm` > `0.2586` → IC=+0.333 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2586 (IC base=+0.051)

- **PATRÓN** `volumen_spike_ratio` > `2.415` → IC=+0.258 (n=675)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.415 (IC base=+0.051)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.253 (n=1336)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.051)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3302` → IC=-0.142 (n=420)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3302
  - _Potencial_: sin este filtro IC_bueno=+0.125 (n=854)

- **FILTRO** `sigma_ewma_delta_pct` > `2.488` → IC=-0.161 (n=375)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.488
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=825)

- **PATRÓN** `ibs_20min` > `0.8425` → IC=+0.251 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8425 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.69` → IC=+0.172 (n=239)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.69 (IC base=+0.037)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8706` → IC=+0.241 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8706 (IC base=+0.037)

- **PATRÓN** `volumen_spike_ratio` > `1.4728` → IC=+0.227 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4728 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.282 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 87.0 (IC base=+0.037)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8603` → IC=-0.155 (n=410)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8603
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1231)

- **PATRÓN** `volumen_spike_ratio` < `1.7037` → IC=+0.138 (n=252)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.7037 (IC base=-0.008)

- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.140 (n=159)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 290.0 (IC base=-0.008)

- **PATRÓN** `dist_vwap_pct` < `0.1433` → IC=+0.183 (n=203)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1433 (IC base=-0.021)

- **PATRÓN** `volumen_regimen` < `0.5828` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.5828 (IC base=-0.021)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4228` → IC=+0.181 (n=161)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4228 (IC base=-0.021)
...
- **PATRÓN** `ibs_20min` > `0.7101` → IC=+0.259 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7101 (IC base=+0.230)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.394` → IC=+0.293 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.394 (IC base=+0.230)

- **PATRÓN** `volumen_pendiente_norm` < `0.2202` → IC=+0.235 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2202 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` < `2.3907` → IC=+0.233 (n=481)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3907 (IC base=+0.230)

- **PATRÓN** `volumen_spike_ratio` > `1.7188` → IC=+0.236 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7188 (IC base=+0.230)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.258 (n=848)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.230)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.313 (n=528)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.289)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.315 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.289)

- **PATRÓN** `ibs_20min` < `0.35` → IC=+0.302 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.35 (IC base=+0.289)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.71` → IC=+0.314 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.71 (IC base=+0.289)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6624` → IC=+0.281 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6624 (IC base=+0.289)

- **PATRÓN** `volumen_spike_ratio` > `2.3431` → IC=+0.297 (n=333)
...
- **PATRÓN** `libro_liquidez` > `1849.4184` → IC=+0.289 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1849.4184 (IC base=+0.289)
...
- **FILTRO** `ibs_20min` < `0.5834` → IC=-0.159 (n=412)
...
- **FILTRO** `ibs_20min` < `0.84` → IC=-0.131 (n=719)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.291 (n=371)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.143 (n=306)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=922)

- **PATRÓN** `ibs_20min` > `0.84` → IC=+0.291 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.84 (IC base=+0.013)

- **PATRÓN** `dist_vwap_pct` > `0.2099` → IC=+0.300 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2099 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.265 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.013)

- **PATRÓN** `volumen_regimen` > `1.1627` → IC=+0.280 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1627 (IC base=+0.013)

- **PATRÓN** `volumen_pendiente_norm` < `0.1143` → IC=+0.260 (n=327)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2747` → IC=+0.292 (n=46)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2747 (IC base=+0.013)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3531` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3531 (IC base=+0.013)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.309 (n=270)
...
- **PATRÓN** `sigma_h` > `0.0136` → IC=+0.335 (n=524)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0136 (IC base=+0.255)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.258 (n=790)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.255)

- **PATRÓN** `ibs_20min` > `0.8982` → IC=+0.327 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8982 (IC base=+0.255)

- **PATRÓN** `dist_vwap_pct` > `1.3647` → IC=+0.343 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3647 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.192` → IC=+0.288 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.192 (IC base=+0.255)

- **PATRÓN** `volumen_regimen` > `0.8418` → IC=+0.295 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8418 (IC base=+0.255)

- **PATRÓN** `volumen_pendiente_norm` > `0.2406` → IC=+0.289 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2406 (IC base=+0.255)

- **PATRÓN** `volumen_spike_ratio` < `2.5673` → IC=+0.262 (n=726)
...
- **PATRÓN** `libro_liquidez` > `2451.004` → IC=+0.259 (n=703)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2451.004 (IC base=+0.255)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.281 (n=805)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.273)

- **PATRÓN** `ibs_20min` < `0.384` → IC=+0.310 (n=847)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.384 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` > `0.5418` → IC=+0.289 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5418 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` < `0.2774` → IC=+0.273 (n=798)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2774 (IC base=+0.273)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.370 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` < `2.577` → IC=+0.261 (n=689)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.577 (IC base=+0.273)

- **PATRÓN** `volumen_spike_ratio` > `2.1862` → IC=+0.284 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1862 (IC base=+0.273)

- **PATRÓN** `ballena_activa_n` < `40.0` → IC=+0.267 (n=590)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 40.0 (IC base=+0.273)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3391` → IC=+0.170 (n=3703)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3391 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.170 (n=4240)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.223 (n=3765)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `1.1052` → IC=+0.230 (n=668)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1052 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.13` → IC=+0.250 (n=877)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.13 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.154 (n=2837)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2233 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `0.6308` → IC=+0.161 (n=2836)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6308 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.105` → IC=+0.187 (n=1590)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.105 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `2.313` → IC=+0.163 (n=3465)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.313 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.163 (n=4260)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.03 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3892.8648` → IC=+0.172 (n=1403)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3892.8648 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `140.0` → IC=+0.181 (n=3116)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 140.0 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.179 (n=3442)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0083 (IC base=+0.171)

- **PATRÓN** `drift_60min` |x|≤ `0.0788` → IC=+0.203 (n=1304)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0788 (IC base=+0.171)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.194 (n=1895)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 15.0 (IC base=+0.171)

- **PATRÓN** `ibs_20min` < `0.4409` → IC=+0.221 (n=3911)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4409 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` < `0.2208` → IC=+0.165 (n=2911)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2208 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.085` → IC=+0.208 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.085 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `1.1724` → IC=+0.161 (n=2925)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1724 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `0.6222` → IC=+0.155 (n=2925)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6222 (IC base=+0.171)

- **PATRÓN** `volumen_pendiente_norm` > `0.2931` → IC=+0.243 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2931 (IC base=+0.171)

- **PATRÓN** `volumen_spike_ratio` > `2.6536` → IC=+0.193 (n=1094)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6536 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.166 (n=2872)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.255 (n=406)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.228)

- **PATRÓN** `drift_60min` |x|≤ `0.1683` → IC=+0.310 (n=303)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.771` → IC=+0.242 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.771 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` < `0.0675` → IC=+0.220 (n=334)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2915` → IC=+0.287 (n=59)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2915 (IC base=+0.228)
...
- **PATRÓN** `libro_liquidez` > `1701.724` → IC=+0.257 (n=303)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1701.724 (IC base=+0.228)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.222 (n=304)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2878` → IC=+0.168 (n=543)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2878 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.211 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4738` → IC=+0.208 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4738 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.2623` → IC=+0.226 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2623 (IC base=+0.163)
...
- **PATRÓN** `volumen_regimen` < `1.2757` → IC=+0.167 (n=617)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.231 (n=533)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.216)

- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.217 (n=242)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0092 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.2226` → IC=+0.229 (n=356)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2226 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.240 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` < `0.3659` → IC=+0.249 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3659 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.704` → IC=+0.257 (n=212)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3087` → IC=+0.268 (n=110)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3087 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` < `1.9009` → IC=+0.209 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9009 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `3.6802` → IC=+0.216 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6802 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1858.9834` → IC=+0.217 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1858.9834 (IC base=+0.216)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.188 (n=562)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0071 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.1192` → IC=+0.175 (n=281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.1192 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=654)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.4254` → IC=+0.198 (n=638)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.4254 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.1491` → IC=+0.179 (n=447)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1491 (IC base=+0.153)
...
- **PATRÓN** `volumen_regimen` < `0.8882` → IC=+0.154 (n=426)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8882 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.2156` → IC=+0.188 (n=213)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.2156 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2936` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2936 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `2.6202` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 2.6202 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=711)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `8687.9043` → IC=+0.193 (n=425)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 8687.9043 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.147 (n=383)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 135.0 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.148 (n=695)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0076 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3757` → IC=+0.142 (n=693)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3757 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.172 (n=233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5426` → IC=+0.176 (n=693)
...
- **PATRÓN** `volumen_regimen` < `1.1618` → IC=+0.133 (n=693)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.1618 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.130 (n=693)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5424` → IC=+0.145 (n=257)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.5424 (IC base=+0.125)
...
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.189 (n=265)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0117 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=834)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.5263` → IC=+0.187 (n=794)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.5263 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `1.1251` → IC=+0.239 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1251 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.303` → IC=+0.266 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.303 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `3182.2806` → IC=+0.200 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3182.2806 (IC base=+0.110)

- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.163 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0104 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.0982` → IC=+0.143 (n=242)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0982 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.182 (n=335)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 15.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.4722` → IC=+0.212 (n=723)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4722 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `1.0296` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 1.0296 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `1.18` → IC=+0.136 (n=723)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.18 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.8584` → IC=+0.128 (n=482)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4461` → IC=+0.131 (n=196)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4461 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.3673` → IC=+0.187 (n=196)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.3673 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `3159.8644` → IC=+0.163 (n=241)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3159.8644 (IC base=+0.123)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=829)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.246 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7317 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.268` → IC=+0.224 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.268 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.240 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `0.8419` → IC=+0.221 (n=525)
...
- **PATRÓN** `volumen_spike_ratio` < `2.532` → IC=+0.211 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.532 (IC base=+0.193)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.213 (n=367)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.425` → IC=+0.246 (n=808)
...
- **PATRÓN** `volumen_regimen` > `0.6912` → IC=+0.229 (n=720)
...
- **PATRÓN** `libro_liquidez` > `2505.8642` → IC=+0.207 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2505.8642 (IC base=+0.202)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.165 (n=413)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0077 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.166 (n=869)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.4333` → IC=+0.169 (n=911)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4333 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.9443` → IC=+0.218 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9443 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.645` → IC=+0.173 (n=420)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 3.645 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.159 (n=493)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8708 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1751` → IC=+0.153 (n=246)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1751 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1705` → IC=+0.181 (n=252)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1705 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.2631` → IC=+0.145 (n=754)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.2631 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8202` → IC=+0.146 (n=571)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8202 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.161 (n=708)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `9553.6554` → IC=+0.183 (n=304)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 9553.6554 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.3132` → IC=+0.120 (n=612)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` < 0.3132 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` > `0.004` → IC=+0.142 (n=107)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.004 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.163 (n=164)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 10.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.5605` → IC=+0.144 (n=144)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.5605 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.8281` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8281 (IC base=+0.093)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.475` → IC=+0.167 (n=79)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 3.475 (IC base=+0.093)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6919 (IC base=+0.093)

- **PATRÓN** `volumen_spike_ratio` < `2.3825` → IC=+0.141 (n=151)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.3825 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `8533.3968` → IC=+0.156 (n=161)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 8533.3968 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `150.0` → IC=+0.160 (n=45)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 150.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` < `0.6327` → IC=+0.152 (n=271)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.6327 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.142` → IC=+0.161 (n=57)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.142 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.1552` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1552 (IC base=+0.083)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.290 (n=250)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` > `0.379` → IC=+0.281 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.379 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.15` → IC=+0.282 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.15 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` < `0.9169` → IC=+0.264 (n=282)
...
- **PATRÓN** `volumen_regimen` < `0.8223` → IC=+0.268 (n=166)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0979` → IC=+0.357 (n=103)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0848` → IC=+0.332 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0848 (IC base=+0.260)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.263 (n=260)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.199 (n=2312)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0086 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=5134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4828` → IC=+0.211 (n=5099)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4828 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `1.0441` → IC=+0.221 (n=714)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0441 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.466` → IC=+0.226 (n=2551)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.466 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.886` → IC=+0.158 (n=2341)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.886 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.1678` → IC=+0.197 (n=1396)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1678 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `1.8741` → IC=+0.172 (n=3178)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8741 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.165 (n=4769)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.02 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3813.8034` → IC=+0.182 (n=1700)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3813.8034 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.210 (n=2504)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 63.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.191 (n=4655)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0109 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.478` → IC=+0.189 (n=4654)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.478 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=2276)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.236 (n=4654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5597 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.4391` → IC=+0.166 (n=3261)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4391 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.719` → IC=+0.213 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.719 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.718` → IC=+0.184 (n=4329)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.718 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `0.6227` → IC=+0.168 (n=1093)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6227 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.164 (n=1092)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1936 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2368` → IC=+0.244 (n=765)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2368 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.3029` → IC=+0.194 (n=1788)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.3029 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.176 (n=3528)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 138.0 (IC base=+0.183)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.192 (n=284)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0052 (IC base=+0.192)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.240 (n=382)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.322 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.192)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.908` → IC=+0.311 (n=480)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5829` → IC=+0.196 (n=334)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.5829 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `2.3008` → IC=+0.182 (n=344)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.3008 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.238 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.192)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.244 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.192)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.270 (n=558)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.263 (n=634)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.4158` → IC=+0.298 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4158 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.535` → IC=+0.273 (n=640)
...
- **PATRÓN** `volumen_spike_ratio` > `2.415` → IC=+0.310 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.415 (IC base=+0.257)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.273 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.257)

- **PATRÓN** `libro_liquidez` > `1520.3192` → IC=+0.264 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1520.3192 (IC base=+0.257)

- **PATRÓN** `ballena_activa_n` < `73.0` → IC=+0.266 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 73.0 (IC base=+0.257)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.186 (n=278)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0029 (IC base=+0.155)

- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.163 (n=277)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0067 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.177 (n=744)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 8.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.4506` → IC=+0.209 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4506 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.2176` → IC=+0.202 (n=465)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2176 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.183 (n=200)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.322` → IC=+0.164 (n=724)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 4.322 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.163 (n=829)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2673 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `1.1002` → IC=+0.156 (n=376)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.1002 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` < `0.0705` → IC=+0.165 (n=702)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.147` → IC=+0.197 (n=226)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.147 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3955` → IC=+0.170 (n=779)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.3955 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.7262` → IC=+0.177 (n=519)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.7262 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `10554.1348` → IC=+0.181 (n=741)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10554.1348 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `465.0` → IC=+0.171 (n=621)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 465.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.179 (n=740)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.179 (n=740)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.207 (n=740)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.846` → IC=+0.226 (n=133)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=955)
...
- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.230 (n=498)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3964` → IC=+0.275 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3964 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.571` → IC=+0.272 (n=248)
...
- **PATRÓN** `volumen_spike_ratio` < `3.0513` → IC=+0.233 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0513 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `1.9003` → IC=+0.217 (n=556)
...
- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.155 (n=746)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0069 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.140 (n=848)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0033 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=766)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.7314` → IC=+0.237 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7314 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.3665` → IC=+0.185 (n=338)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3665 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.313` → IC=+0.166 (n=378)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.313 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.057` → IC=+0.140 (n=845)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 7.057 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8944` → IC=+0.167 (n=565)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=922)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9500.4052` → IC=+0.238 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9500.4052 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.171 (n=223)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0032 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.4356` → IC=+0.141 (n=661)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4356 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.147 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6749` → IC=+0.171 (n=661)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6749 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.6764` → IC=+0.136 (n=735)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.6764 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.305` → IC=+0.218 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.305 (IC base=+0.124)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4531` → IC=+0.139 (n=599)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4531 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `9483.0008` → IC=+0.172 (n=300)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 9483.0008 (IC base=+0.124)

- **PATRÓN** `ballena_activa_n` < `191.0` → IC=+0.134 (n=515)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 191.0 (IC base=+0.124)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.138 (n=595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0079 (IC base=+0.093)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.134 (n=599)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.093)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.179 (n=892)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4706 (IC base=+0.093)

- **PATRÓN** `dist_vwap_pct` > `0.8687` → IC=+0.177 (n=227)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.8687 (IC base=+0.093)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=623)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.01 (IC base=+0.093)

- **PATRÓN** `libro_liquidez` > `2944.7288` → IC=+0.256 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2944.7288 (IC base=+0.093)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.133 (n=668)

  - _Acción_: Kelly boost +0.66€ cuando `ballena_activa_n` < 63.0 (IC base=+0.093)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.180 (n=279)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0057 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1276` → IC=+0.180 (n=279)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.1276 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.149 (n=406)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.5862` → IC=+0.196 (n=836)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.5862 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.5063` → IC=+0.135 (n=803)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.5063 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.252` → IC=+0.127 (n=812)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.252 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.147 (n=369)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7144 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.176 (n=288)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.4564` → IC=+0.145 (n=229)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4564 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.1802` → IC=+0.133 (n=311)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.1802 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2634.4653` → IC=+0.148 (n=379)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2634.4653 (IC base=+0.117)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=996)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1721` → IC=+0.247 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1721 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.177` → IC=+0.248 (n=470)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.177 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6933` → IC=+0.213 (n=844)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8278` → IC=+0.209 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8278 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1041)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.209 (n=985)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.257 (n=1053)
...
- **PATRÓN** `volumen_regimen` > `0.7033` → IC=+0.220 (n=930)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2225` → IC=+0.187 (n=761)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.2225 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4555` → IC=+0.196 (n=865)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.130 (n=1817)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.134 (n=1463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0103 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.5544` → IC=+0.132 (n=1660)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.5544 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.172 (n=574)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` > `0.926` → IC=+0.194 (n=554)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.926 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.464` → IC=+0.146 (n=261)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 10.464 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.79` → IC=+0.123 (n=1437)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 2.79 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.1727` → IC=+0.156 (n=457)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1727 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` < `1.4601` → IC=+0.142 (n=548)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 1.4601 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `1.8939` → IC=+0.145 (n=1096)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8939 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `8643.8042` → IC=+0.129 (n=753)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 8643.8042 (IC base=+0.122)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.177 (n=459)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0039 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.5002` → IC=+0.148 (n=1375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1963` → IC=+0.151 (n=605)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.1963 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.7583` → IC=+0.131 (n=234)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.7583 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.34` → IC=+0.137 (n=1368)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 6.34 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.0986` → IC=+0.140 (n=1152)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.0986 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` < `0.1489` → IC=+0.128 (n=1376)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1489 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.0693` → IC=+0.150 (n=649)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.0693 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` < `2.5013` → IC=+0.137 (n=1360)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.5013 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `1.8071` → IC=+0.137 (n=906)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.8071 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=1817)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7723.2634` → IC=+0.135 (n=1228)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 7723.2634 (IC base=+0.127)

### GBM_LATE_5M#BTC#5min
- **FILTRO** `sigma_ewma_delta_pct` > `2.403` → IC=-0.224 (n=27)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.403
  - _Potencial_: sin este filtro IC_bueno=+0.146 (n=190)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.403` → IC=+0.146 (n=190)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 2.403 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.9417` → IC=+0.145 (n=74)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.9417 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.184 (n=55)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `12574.1361` → IC=+0.149 (n=146)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 12574.1361 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.183 (n=276)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.1654` → IC=+0.158 (n=276)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.372` → IC=+0.139 (n=624)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.372 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.8666` → IC=+0.146 (n=419)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8666 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.0635` → IC=+0.154 (n=296)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0635 (IC base=+0.113)
...
- **PATRÓN** `libro_liquidez` > `11129.4732` → IC=+0.125 (n=627)

  - _Acción_: Kelly boost +0.62€ cuando `libro_liquidez` > 11129.4732 (IC base=+0.113)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.207 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.149)

- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.177 (n=187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0106 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.2875` → IC=+0.164 (n=275)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.2875 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.192 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 10.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.9849` → IC=+0.227 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9849 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.295` → IC=+0.219 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.295 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2139` → IC=+0.167 (n=109)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2139 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `3.5044` → IC=+0.160 (n=410)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 3.5044 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.8314` → IC=+0.155 (n=366)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.8314 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `2296.3342` → IC=+0.176 (n=137)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2296.3342 (IC base=+0.149)
...
- **FILTRO** `volumen_regimen` > `0.8468` → IC=-0.328 (n=56)

  - _Acción_: SKIP cuando `volumen_regimen` > 0.8468
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `libro_liquidez` > `2751.7792` → IC=+0.188 (n=107)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 2751.7792 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2247.816` → IC=+0.126 (n=273)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2247.816 (IC base=+0.095)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=1620)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=4948)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.183 (n=1626)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=5164)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.223 (n=258)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=784)

- **FILTRO** `ibs_20min` < `0.7375` → IC=-0.191 (n=260)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7375
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=782)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.183 (n=260)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=799)

- **FILTRO** `ballena_activa_n` > `57.0` → IC=-0.158 (n=264)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.182 (n=357)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=737)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.215 (n=286)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=878)

- **FILTRO** `ibs_20min` > `0.7067` → IC=-0.192 (n=290)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7067
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=874)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.177 (n=258)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.141 (n=293)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=812)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=290)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.309 (n=40)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=548)
...
- **PATRÓN** `libro_liquidez` > `4444.4944` → IC=+0.196 (n=21)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 4444.4944 (IC base=-0.057)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=3842)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=11979)

- **FILTRO** `ibs_7min` < `0.7153` → IC=-0.234 (n=3955)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7153
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=11866)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=5327)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=10494)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.222 (n=4887)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=15183)

- **FILTRO** `ibs_7min` > `0.7132` → IC=-0.173 (n=5017)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7132
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=15053)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=562)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=1780)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.249 (n=772)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1570)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.219 (n=557)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1785)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.243 (n=861)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2624)

- **FILTRO** `drift_7min_pct` |x|> `0.1143` → IC=-0.132 (n=1181)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1143
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=2304)

- **FILTRO** `ibs_7min` > `0.8349` → IC=-0.199 (n=871)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8349
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2614)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=635)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2282)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=704)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2213)

- **FILTRO** `ibs_7min` < `0.7734` → IC=-0.190 (n=729)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7734
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2188)

- **FILTRO** `ballena_activa_n` > `166.0` → IC=-0.176 (n=726)

  - _Acción_: SKIP cuando `ballena_activa_n` > 166.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2191)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.243 (n=714)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2231)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.170 (n=998)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=1947)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.183 (n=740)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=1585)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.303 (n=738)
...
- **FILTRO** `ibs_7min` < `0.2222` → IC=-0.289 (n=580)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=1745)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.240 (n=552)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1773)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.225 (n=862)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=2775)

- **FILTRO** `ibs_7min` > `0.797` → IC=-0.171 (n=909)

  - _Acción_: SKIP cuando `ibs_7min` > 0.797
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=2728)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.141 (n=808)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=1862)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.263 (n=638)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2032)

- **FILTRO** `ibs_7min` < `0.7555` → IC=-0.188 (n=667)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7555
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=2003)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.181 (n=662)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2008)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.236 (n=883)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1824)

- **FILTRO** `ibs_7min` > `0.2755` → IC=-0.178 (n=676)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2755
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2031)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.186 (n=667)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2040)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.238 (n=719)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2239)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.202 (n=734)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.177 (n=888)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2872)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.126 (n=615)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1994)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.294 (n=630)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1979)

- **FILTRO** `ibs_7min` < `0.74` → IC=-0.230 (n=650)

  - _Acción_: SKIP cuando `ibs_7min` < 0.74
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1959)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.225 (n=630)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1979)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.205 (n=853)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2683)

- **FILTRO** `ibs_7min` > `0.76` → IC=-0.156 (n=879)

  - _Acción_: SKIP cuando `ibs_7min` > 0.76
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=2657)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=1684)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.180 (n=204)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0075 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.1916` → IC=+0.141 (n=610)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1916 (IC base=+0.141)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1911` → IC=+0.142 (n=277)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.71€ cuando `delta_ratio_macro` |x|> 0.1911 (IC base=+0.141)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3329` → IC=+0.186 (n=297)

  - _Acción_: Kelly boost +0.93€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3329 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.141 (n=613)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5919` → IC=+0.219 (n=610)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5919 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.5539` → IC=+0.141 (n=649)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=606)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `9584.2249` → IC=+0.170 (n=204)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 9584.2249 (IC base=+0.141)
...
- **FILTRO** `ibs_15` < `0.8221` → IC=-0.135 (n=94)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: SKIP cuando `ibs_15` < 0.8221
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.351` → IC=+0.145 (n=29)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 20.351 (IC base=+0.005)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2614` → IC=+0.167 (n=49)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.2614 (IC base=+0.094)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.122 (n=149)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 17.0 (IC base=+0.094)

- **PATRÓN** `ibs_15` > `0.6414` → IC=+0.191 (n=147)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.96€ cuando `ibs_15` > 0.6414 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` < `0.1542` → IC=+0.144 (n=116)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.1542 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.717` → IC=+0.162 (n=66)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 8.717 (IC base=+0.094)
...
- **FILTRO** `drift_15min` |x|> `0.4795` → IC=-0.150 (n=161)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0241` → IC=-0.217 (n=44)
...
- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.182 (n=190)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1159 (IC base=+0.030)
...
- **FILTRO** `sigma_h` > `0.0112` → IC=-0.192 (n=371)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `ibs_15` < `0.5856` → IC=-0.184 (n=166)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.232 (n=338)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.145 (n=390)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1095)

- **FILTRO** `sigma_ewma_delta_pct` > `18.747` → IC=-0.154 (n=535)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.747
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=4073)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3537` → IC=+0.183 (n=216)

  - _Acción_: Kelly boost +0.92€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3537 (IC base=-0.066)

- **PATRÓN** `ibs_15` > `0.5856` → IC=+0.232 (n=338)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5856 (IC base=-0.066)

- **PATRÓN** `dist_vwap_pct` < `0.1752` → IC=+0.132 (n=229)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1752 (IC base=-0.066)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0809` → IC=+0.216 (n=79)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0809 (IC base=+0.094)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2769` → IC=+0.218 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2769 (IC base=+0.094)

- **PATRÓN** `ibs_15` > `0.6448` → IC=+0.258 (n=159)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6448 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` < `0.1823` → IC=+0.128 (n=135)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.1823 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `10832.9607` → IC=+0.199 (n=81)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 10832.9607 (IC base=+0.094)
...
- **FILTRO** `drift_60min` |x|> `0.1627` → IC=-0.195 (n=126)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=246)

- **FILTRO** `drift_15min` |x|> `0.8298` → IC=-0.266 (n=92)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.8298
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=280)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0761` → IC=+0.161 (n=107)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio_macro` |x|> 0.0761 (IC base=-0.050)
...
- **PATRÓN** `ibs_15` < `0.3814` → IC=+0.213 (n=120)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3814 (IC base=-0.050)

- **PATRÓN** `dist_vwap_pct` < `0.2528` → IC=+0.184 (n=112)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.2528 (IC base=-0.050)

### UPDOWN_GBM_15M_TARDIO#XRP#15min
- **FILTRO** `sigma_h` > `0.018` → IC=-0.227 (n=207)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.018
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=209)

- **FILTRO** `drift_15min` |x|> `1.1964` → IC=-0.252 (n=103)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 1.1964
  - _Potencial_: sin este filtro IC_bueno=-0.135 (n=313)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.287 (n=360)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1322` → IC=+0.302 (n=240)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.8311` → IC=+0.315 (n=360)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8311 (IC base=+0.284)

- **PATRÓN** `dist_vwap_pct` > `0.3017` → IC=+0.319 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3017 (IC base=+0.284)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.713` → IC=+0.285 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.713 (IC base=+0.284)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.292 (n=441)
...
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.283 (n=155)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0071 (IC base=+0.284)

- **PATRÓN** `drift_60min` |x|≤ `0.0694` → IC=+0.329 (n=68)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0694 (IC base=+0.284)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1882` → IC=+0.322 (n=71)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1882 (IC base=+0.284)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1463` → IC=+0.330 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1463 (IC base=+0.284)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.317 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.284)

- **PATRÓN** `ibs_15` > `0.8441` → IC=+0.322 (n=155)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8441 (IC base=+0.284)

- **PATRÓN** `dist_vwap_pct` > `0.2966` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2966 (IC base=+0.284)

- **PATRÓN** `dist_vwap_pct` < `0.4822` → IC=+0.287 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4822 (IC base=+0.284)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.547` → IC=+0.297 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.547 (IC base=+0.284)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.307 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.284)

- **PATRÓN** `libro_liquidez` > `10755.3155` → IC=+0.308 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10755.3155 (IC base=+0.284)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.282 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 184.0 (IC base=+0.284)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5919 sube el IC de +0.141 a +0.219 en UPDOWN_GBM#15min (n=610). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6414 sube el IC de +0.094 a +0.191 en UPDOWN_GBM#ETH#15min (n=147). Ya aplicado como kelly_boost=+0.96€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1159 sube el IC de +0.030 a +0.182 en UPDOWN_GBM#XRP#15min (n=190). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5856 sube el IC de -0.066 a +0.232 en UPDOWN_GBM_15M_TARDIO (n=338). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.6077 sube el IC de +0.028 a +0.310 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=56). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6448 sube el IC de +0.094 a +0.258 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=159). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3814 sube el IC de -0.050 a +0.213 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=120). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8311 sube el IC de +0.284 a +0.315 en UPDOWN_GBM_IBS_ALTO (n=360). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8441 sube el IC de +0.284 a +0.322 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=155). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 16132 | -0.118 | -2596.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 996 | -0.017 | -147.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 15136 | -0.124 | -2448.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2188 | -0.109 | -489.47€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2188 | -0.109 | -489.47€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 996 | -0.017 | -147.71€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 996 | -0.017 | -147.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2127 | -0.170 | -579.08€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2127 | -0.170 | -579.08€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4275 | -0.061 | -398.39€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4275 | -0.061 | -398.39€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3609 | -0.130 | -230.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3609 | -0.130 | -230.88€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2937 | -0.188 | -750.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2937 | -0.188 | -750.86€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 5200 | -0.080 | +1938.20€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1486 | -0.014 | +1060.21€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3714 | -0.107 | +877.99€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 5200 | -0.080 | +1938.20€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1486 | -0.014 | +1060.21€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3714 | -0.107 | +877.99€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 51825 | +0.114 | -3110.09€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 8588 | +0.182 | -297.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 184 | -0.118 | -59.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 39154 | +0.099 | -2672.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3899 | +0.116 | -79.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 6565 | +0.086 | -807.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 28 | -0.100 | +6.23€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 6522 | +0.088 | -801.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 10348 | +0.132 | -231.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2534 | +0.197 | -118.79€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 6473 | +0.109 | -133.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1299 | +0.123 | +42.77€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 6586 | +0.086 | -760.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 31 | +0.015 | +3.38€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 6540 | +0.088 | -752.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 11194 | +0.126 | -183.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 3216 | +0.170 | -29.73€ | 1 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 6517 | +0.111 | -108.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1449 | +0.098 | -36.22€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 10565 | +0.121 | -691.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2756 | +0.188 | -160.80€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 90 | -0.033 | -6.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 6568 | +0.094 | -438.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1151 | +0.130 | -86.43€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6567 | +0.105 | -436.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 23 | -0.020 | +1.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 10 | +0.000 | +0.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 6534 | +0.105 | -438.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 8477 | +0.180 | -641.05€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 8477 | +0.180 | -641.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2167 | +0.168 | -235.53€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2167 | +0.168 | -235.53€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2115 | +0.172 | -217.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2115 | +0.172 | -217.40€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1899 | +0.236 | -47.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1899 | +0.236 | -47.56€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 2068 | +0.186 | -153.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 2068 | +0.186 | -153.48€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 27802 | +0.191 | -2513.99€ | 1 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 