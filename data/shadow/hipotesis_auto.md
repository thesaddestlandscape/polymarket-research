# Hipótesis automáticas — 2026-09-15 11:40 UTC
_Generado por shadow_postmortem.py sobre 450814 resoluciones (PNL=+48312.21€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.257 (n=5623)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=16876)
...
- **FILTRO** `restante_s_al_confirmar` < `141.07` → IC=-0.158 (n=1450)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.07
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4355)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.3` → IC=-0.253 (n=1324)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.3
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3974)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `157.46` → IC=-0.334 (n=1401)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.46
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2847)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.38` → IC=-0.271 (n=142)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=291)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.195 (n=11484)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=2846)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5231.7115` → IC=+0.168 (n=1816)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 5231.7115 (IC base=+0.097)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1651)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `14701.5004` → IC=+0.206 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14701.5004 (IC base=+0.201)
...
- **PATRÓN** `py_entrada` > `0.595` → IC=+0.169 (n=367)

  - _Acción_: Kelly boost +0.85€ cuando `py_entrada` > 0.595 (IC base=+0.102)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.241 (n=1192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `3739.5225` → IC=+0.241 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3739.5225 (IC base=+0.237)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.125)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.132 (n=536)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1940.1614` → IC=+0.161 (n=355)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 1940.1614 (IC base=+0.125)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=1067)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.183 (n=955)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.182 (n=1102)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=672)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `5296.2198` → IC=+0.343 (n=246)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5296.2198 (IC base=+0.195)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2139)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=2219)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.297 (n=156)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.297)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.357 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.297)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=2202)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.179 (n=2107)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 17.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.181 (n=1885)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` > 0.71 (IC base=+0.176)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.247 (n=1968)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.236)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.237 (n=1681)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=4854)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=3556)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `lag_apertura_s` < `4.4` → IC=+0.145 (n=2432)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9771` → IC=+0.229 (n=1990)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9771 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.6046` → IC=+0.243 (n=1592)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6046 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.721` → IC=+0.153 (n=3270)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 2.721 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.6141` → IC=+0.251 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6141 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0696` → IC=+0.247 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0696 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1752` → IC=+0.191 (n=4041)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1752 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.3093` → IC=+0.202 (n=558)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3093 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4716` → IC=+0.195 (n=3900)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4716 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5701` → IC=+0.130 (n=7351)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5701 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5655` → IC=+0.182 (n=451)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5655 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3421` → IC=+0.168 (n=2485)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3421 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8691` → IC=+0.174 (n=1575)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8691 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2459` → IC=+0.222 (n=789)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2459 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4638` → IC=+0.199 (n=3933)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4638 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.207 (n=3703)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.265 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.069` → IC=+0.279 (n=585)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.230 (n=1062)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9239` → IC=+0.255 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9239 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.2116` → IC=+0.220 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2116 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.3757` → IC=+0.213 (n=950)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3757 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.237 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.223 (n=1012)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2628 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8751` → IC=+0.215 (n=675)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.219 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3925 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `11900.8434` → IC=+0.226 (n=904)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11900.8434 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.161 (n=959)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0048 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.169 (n=363)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6723` → IC=+0.179 (n=1088)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.6723 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1319` → IC=+0.158 (n=976)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1062` → IC=+0.182 (n=1108)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3768` → IC=+0.182 (n=171)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.3768 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.0275` → IC=+0.193 (n=555)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 3.0275 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=1493)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.222 (n=379)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3824` → IC=+0.231 (n=999)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.389` → IC=+0.215 (n=1242)
...
- **PATRÓN** `volumen_spike_ratio` > `2.289` → IC=+0.224 (n=672)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.289 (IC base=+0.213)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=568)
...
- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.214 (n=414)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1661)
...
- **PATRÓN** `dist_vwap_pct` < `0.4573` → IC=+0.143 (n=598)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.4573 (IC base=-0.000)

- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.152 (n=352)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.856 (IC base=-0.000)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.128 (n=1700)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=+0.117 (n=842)

- **FILTRO** `sigma_ewma_delta_pct` > `8.618` → IC=-0.198 (n=276)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.618
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2266)
...
- **PATRÓN** `volumen_regimen` < `1.1047` → IC=+0.197 (n=206)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2029` → IC=+0.203 (n=193)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.230 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4885 (IC base=-0.046)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6458` → IC=-0.189 (n=419)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6458
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1259)

- **FILTRO** `ibs_20min` < `0.7753` → IC=-0.141 (n=1258)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.198 (n=376)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1302)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.200 (n=635)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=1908)
...
- **PATRÓN** `dist_vwap_pct` < `0.2555` → IC=+0.290 (n=174)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2555 (IC base=-0.087)

- **PATRÓN** `volumen_regimen` > `0.6279` → IC=+0.286 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6279 (IC base=-0.087)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4665` → IC=+0.265 (n=181)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4665 (IC base=-0.087)
...
- **PATRÓN** `dist_vwap_pct` < `0.2575` → IC=+0.243 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2575 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` < `0.7344` → IC=+0.242 (n=227)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1062` → IC=+0.254 (n=173)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4747` → IC=+0.238 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4747 (IC base=-0.029)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.240 (n=414)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 36.0 (IC base=-0.029)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.175 (n=2497)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.009 (IC base=+0.085)

- **PATRÓN** `ibs_20min` > `0.9824` → IC=+0.288 (n=2494)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9824 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.7022` → IC=+0.279 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7022 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.142 (n=3535)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.085)

- **PATRÓN** `volumen_regimen` > `0.6785` → IC=+0.233 (n=2263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6785 (IC base=+0.085)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4784` → IC=+0.235 (n=1345)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4784 (IC base=+0.085)

- **PATRÓN** `volumen_spike_ratio` > `2.7847` → IC=+0.234 (n=1342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7847 (IC base=+0.085)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.276 (n=3509)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.085)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.139 (n=2551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0084 (IC base=+0.067)

- **PATRÓN** `ibs_20min` < `0.557` → IC=+0.149 (n=6729)
...
- **PATRÓN** `dist_vwap_pct` < `0.1661` → IC=+0.229 (n=1886)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1661 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` < `0.7147` → IC=+0.227 (n=906)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7147 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `1.1988` → IC=+0.256 (n=687)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1988 (IC base=+0.067)

- **PATRÓN** `volumen_pendiente_norm` > `0.2514` → IC=+0.323 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2514 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` < `1.6226` → IC=+0.252 (n=1177)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6226 (IC base=+0.067)

- **PATRÓN** `volumen_spike_ratio` > `2.3705` → IC=+0.256 (n=1213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3705 (IC base=+0.067)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.253 (n=2527)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.067)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `2.601` → IC=-0.149 (n=511)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.601
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=1160)

- **PATRÓN** `ibs_20min` > `0.8641` → IC=+0.247 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8641 (IC base=+0.038)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.283` → IC=+0.150 (n=686)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 3.283 (IC base=+0.038)

- **PATRÓN** `volumen_pendiente_norm` > `0.2255` → IC=+0.304 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2255 (IC base=+0.038)

- **PATRÓN** `volumen_spike_ratio` < `1.8494` → IC=+0.198 (n=346)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.8494 (IC base=+0.038)
...
- **FILTRO** `ibs_20min` > `0.8296` → IC=-0.148 (n=563)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1693)

- **PATRÓN** `dist_vwap_pct` > `0.3024` → IC=+0.140 (n=248)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.3024 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` > `0.6545` → IC=+0.132 (n=577)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.6545 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.171 (n=83)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.009)
...
- **PATRÓN** `ballena_activa_n` < `235.0` → IC=+0.186 (n=205)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 235.0 (IC base=+0.009)
...
- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.267 (n=1064)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.52` → IC=+0.269 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.52 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.1095` → IC=+0.255 (n=989)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1095 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.8738` → IC=+0.240 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8738 (IC base=+0.237)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.254 (n=1341)
...
- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.286 (n=950)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=471)
...
- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.277 (n=357)
...
- **FILTRO** `ibs_20min` < `0.2435` → IC=-0.212 (n=338)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1016)

- **FILTRO** `ibs_20min` > `0.816` → IC=-0.181 (n=446)

  - _Acción_: SKIP cuando `ibs_20min` > 0.816
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=1341)

- **PATRÓN** `ibs_20min` > `0.8024` → IC=+0.144 (n=461)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.8024 (IC base=-0.018)

- **PATRÓN** `dist_vwap_pct` > `0.3041` → IC=+0.223 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3041 (IC base=-0.018)

- **PATRÓN** `volumen_regimen` < `0.9565` → IC=+0.205 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9565 (IC base=-0.018)

- **PATRÓN** `volumen_regimen` > `0.6179` → IC=+0.188 (n=270)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 0.6179 (IC base=-0.018)

- **PATRÓN** `volumen_pendiente_norm` > `0.2683` → IC=+0.311 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2683 (IC base=-0.018)

- **PATRÓN** `volumen_spike_ratio` < `1.4909` → IC=+0.252 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4909 (IC base=-0.018)

- **PATRÓN** `volumen_spike_ratio` > `1.7487` → IC=+0.217 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7487 (IC base=-0.018)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.249 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 118.0 (IC base=-0.018)
...
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.205 (n=809)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6667
  - _Potencial_: sin este filtro IC_bueno=+0.251 (n=821)

- **FILTRO** `ibs_20min` > `0.7187` → IC=-0.235 (n=429)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7187
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1300)

- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.168 (n=405)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.705
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=1324)

- **PATRÓN** `ibs_20min` > `0.6667` → IC=+0.251 (n=821)
...
- **PATRÓN** `volumen_regimen` > `0.7204` → IC=+0.273 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7204 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1089` → IC=+0.276 (n=515)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.319 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.025)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.128 (n=868)
...
- **PATRÓN** `dist_vwap_pct` < `0.3848` → IC=+0.181 (n=359)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.3848 (IC base=+0.002)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.239 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=+0.002)

- **PATRÓN** `volumen_pendiente_norm` < `0.1001` → IC=+0.180 (n=311)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.200 (n=321)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.212 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.002)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.015` → IC=+0.321 (n=684)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.343 (n=685)
...
- **PATRÓN** `volumen_regimen` > `0.6873` → IC=+0.286 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6873 (IC base=+0.267)

- **PATRÓN** `volumen_pendiente_norm` > `0.2364` → IC=+0.298 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2364 (IC base=+0.267)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.270 (n=1059)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.267)

- **PATRÓN** `libro_liquidez` > `2582.8199` → IC=+0.274 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2582.8199 (IC base=+0.267)
...
- **PATRÓN** `ibs_20min` < `0.386` → IC=+0.304 (n=1117)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.386 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` > `0.5405` → IC=+0.285 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5405 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` < `0.8998` → IC=+0.268 (n=1272)
...
- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.313 (n=372)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2435 (IC base=+0.267)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5476` → IC=+0.265 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5476 (IC base=+0.267)

- **PATRÓN** `volumen_spike_ratio` > `2.17` → IC=+0.264 (n=434)
...
- **PATRÓN** `libro_liquidez` > `2557.92` → IC=+0.275 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2557.92 (IC base=+0.267)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.200 (n=1976)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3322` → IC=+0.172 (n=5216)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3322 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=6181)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6954` → IC=+0.229 (n=5293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6954 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1641` → IC=+0.198 (n=2593)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1641 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.223` → IC=+0.249 (n=1227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.223 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2153` → IC=+0.163 (n=3954)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2153 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6244` → IC=+0.159 (n=3954)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6244 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1068` → IC=+0.186 (n=2321)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1068 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.3095` → IC=+0.167 (n=4950)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.3095 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.676` → IC=+0.168 (n=1875)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.676 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3820.3005` → IC=+0.173 (n=1975)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 3820.3005 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.183 (n=4836)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 123.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.188 (n=3824)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0063 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.0786` → IC=+0.206 (n=1910)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4583` → IC=+0.228 (n=5728)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4583 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.223` → IC=+0.163 (n=4232)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.223 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.27` → IC=+0.193 (n=995)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 10.27 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `1.1845` → IC=+0.156 (n=4186)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1845 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `0.6258` → IC=+0.152 (n=4185)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6258 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.2921` → IC=+0.228 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2921 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.172 (n=2233)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` > `2.6472` → IC=+0.179 (n=1692)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.6472 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.172 (n=4691)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3129` → IC=+0.202 (n=996)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.077` → IC=+0.307 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.077 (IC base=+0.188)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8722` → IC=+0.252 (n=433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8722 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.6495` → IC=+0.240 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6495 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.239 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1585.8448` → IC=+0.252 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1585.8448 (IC base=+0.238)
...
- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.177 (n=859)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4117` → IC=+0.197 (n=275)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.4117 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `9812.7811` → IC=+0.183 (n=858)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 9812.7811 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `407.0` → IC=+0.161 (n=686)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 407.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.182 (n=859)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0049 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2259` → IC=+0.173 (n=858)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.2259 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.167 (n=893)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.5289` → IC=+0.195 (n=975)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5289 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.3185` → IC=+0.165 (n=1071)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.3185 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.1` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.1 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.165 (n=975)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2089 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.190 (n=298)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.162 (n=865)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `231.0` → IC=+0.160 (n=260)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 231.0 (IC base=+0.151)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.197 (n=977)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0058 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.1938` → IC=+0.195 (n=651)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.681` → IC=+0.186 (n=304)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.202 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.226 (n=724)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.222)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.222 (n=735)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.250 (n=823)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.164 (n=885)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.006 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.3751` → IC=+0.143 (n=1004)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6027` → IC=+0.180 (n=1004)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6027 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.3356` → IC=+0.139 (n=1096)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3356 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.114` → IC=+0.190 (n=198)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.114 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.8585` → IC=+0.140 (n=670)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8585 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.130 (n=1004)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8021` → IC=+0.134 (n=593)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8021 (IC base=+0.128)
...
- **PATRÓN** `libro_liquidez` > `9950.2818` → IC=+0.152 (n=455)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 9950.2818 (IC base=+0.128)
...
- **PATRÓN** `volumen_regimen` < `1.2184` → IC=+0.121 (n=1107)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2184 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.126 (n=709)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 1.8007 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1137)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2896.4901` → IC=+0.193 (n=502)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.155 (n=482)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0057 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.174 (n=501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5417` → IC=+0.207 (n=1095)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5417 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `0.692` → IC=+0.145 (n=201)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.692 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.191` → IC=+0.137 (n=1006)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.191 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.336` → IC=+0.157 (n=234)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.336 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.0382` → IC=+0.129 (n=963)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0382 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2754` → IC=+0.184 (n=131)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2754 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.131 (n=318)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.173` → IC=+0.138 (n=432)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 2.173 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3078.551` → IC=+0.159 (n=365)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3078.551 (IC base=+0.114)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` < `0.027` → IC=+0.200 (n=1056)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=1095)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7209` → IC=+0.254 (n=944)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.342` → IC=+0.241 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.342 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.204 (n=1056)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` > `0.6107` → IC=+0.209 (n=1056)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6107 (IC base=+0.199)
...
- **PATRÓN** `dist_vwap_pct` < `0.2648` → IC=+0.205 (n=1153)
...
- **PATRÓN** `volumen_regimen` > `0.6303` → IC=+0.218 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6303 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2818` → IC=+0.283 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2818 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.2423` → IC=+0.198 (n=860)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2423 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4614` → IC=+0.192 (n=978)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4614 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2524.095` → IC=+0.212 (n=742)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2524.095 (IC base=+0.205)
...
- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.170 (n=1417)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.3963 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.8162` → IC=+0.168 (n=206)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.8162 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.703` → IC=+0.168 (n=643)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 3.703 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8649` → IC=+0.157 (n=812)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8649 (IC base=+0.137)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4335` → IC=+0.159 (n=452)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5919` → IC=+0.159 (n=452)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5919 (IC base=+0.137)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.143 (n=1562)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8101.5764` → IC=+0.162 (n=643)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 8101.5764 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.160 (n=1198)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 156.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.159 (n=496)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0037 (IC base=+0.114)

- **PATRÓN** `drift_60min` |x|≤ `0.3367` → IC=+0.126 (n=1305)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3367 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.125 (n=1493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.4835` → IC=+0.157 (n=1305)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4835 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2096` → IC=+0.123 (n=1291)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2096 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.834` → IC=+0.134 (n=585)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 3.834 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.227` → IC=+0.123 (n=1305)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.227 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.1668` → IC=+0.140 (n=379)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` > 0.1668 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.2373` → IC=+0.134 (n=1245)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.2373 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.127 (n=591)
...
- **PATRÓN** `ibs_20min` > `0.2663` → IC=+0.236 (n=434)
...
- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.167 (n=268)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.4524 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.921` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 8.921 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` < `0.7183` → IC=+0.147 (n=117)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7183 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `2.513` → IC=+0.130 (n=244)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 2.513 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.135 (n=209)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 44.0 (IC base=+0.084)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.191 (n=3393)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0085 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7804)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4738` → IC=+0.212 (n=7470)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4738 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8923` → IC=+0.200 (n=1005)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8923 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.578` → IC=+0.221 (n=3670)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.578 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.8828` → IC=+0.164 (n=3361)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8828 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.187 (n=1428)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6426` → IC=+0.182 (n=2370)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6426 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8929)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3784.1723` → IC=+0.171 (n=2490)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3784.1723 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.193 (n=5362)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 94.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.197 (n=4596)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0066 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.4734` → IC=+0.184 (n=6881)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.557` → IC=+0.239 (n=6881)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.557 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2336` → IC=+0.164 (n=4309)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2336 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.853` → IC=+0.201 (n=986)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.853 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.0563` → IC=+0.157 (n=4182)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0563 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.162 (n=1584)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.2011 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.253 (n=883)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.3006` → IC=+0.191 (n=2788)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3006 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.178 (n=5763)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.205 (n=853)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.194)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.320 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.194)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.366` → IC=+0.291 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.366 (IC base=+0.194)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5578` → IC=+0.189 (n=513)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.5578 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `2.5862` → IC=+0.196 (n=389)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.5862 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.223 (n=1125)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.261 (n=660)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.255)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.265 (n=884)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.807` → IC=+0.163 (n=277)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.807 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.152 (n=1045)
...
- **PATRÓN** `ibs_20min` < `0.6377` → IC=+0.208 (n=1057)
...
- **PATRÓN** `dist_vwap_pct` < `0.1316` → IC=+0.169 (n=962)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.1316 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.581` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.581 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.168 (n=1057)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1888 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.217` → IC=+0.215 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.217 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.409` → IC=+0.172 (n=960)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.409 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.5156` → IC=+0.165 (n=857)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.5156 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `12088.7653` → IC=+0.158 (n=705)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 12088.7653 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `376.0` → IC=+0.166 (n=576)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 376.0 (IC base=+0.158)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.222 (n=1179)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3701` → IC=+0.267 (n=1004)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2419` → IC=+0.227 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2419 (IC base=+0.230)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.242 (n=583)
...
- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.241 (n=427)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4307` → IC=+0.137 (n=1268)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.4307 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.145 (n=1329)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.7095` → IC=+0.234 (n=845)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.295` → IC=+0.166 (n=543)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 4.295 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.8804` → IC=+0.158 (n=846)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8804 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2746` → IC=+0.227 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2746 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4706` → IC=+0.157 (n=406)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.4706 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `8841.7476` → IC=+0.228 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8841.7476 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `90.0` → IC=+0.156 (n=382)
...
- **PATRÓN** `ibs_20min` > `0.4667` → IC=+0.177 (n=1292)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.428` → IC=+0.217 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.428 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.122 (n=900)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.241 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.126 (n=952)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 53.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.176 (n=551)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0061 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.1219` → IC=+0.149 (n=414)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.209 (n=1245)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.4698` → IC=+0.131 (n=1216)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.4698 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.439` → IC=+0.126 (n=1198)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.218` → IC=+0.170 (n=189)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.218 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.137 (n=362)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.5613` → IC=+0.129 (n=362)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.5613 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2922.181` → IC=+0.166 (n=414)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2922.181 (IC base=+0.115)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.214 (n=590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.203)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.204 (n=1162)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.203)
...
- **PATRÓN** `dist_vwap_pct` > `0.1854` → IC=+0.234 (n=751)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1854 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.545` → IC=+0.241 (n=709)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.545 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.2434` → IC=+0.205 (n=1302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2434 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6279` → IC=+0.209 (n=1302)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5936` → IC=+0.237 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5936 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=1305)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2562.8289` → IC=+0.209 (n=868)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2562.8289 (IC base=+0.203)
...
- **PATRÓN** `libro_liquidez` > `2536.7617` → IC=+0.200 (n=956)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2536.7617 (IC base=+0.201)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.141 (n=2545)

- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.154 (n=2214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0094 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.5274` → IC=+0.154 (n=2516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.737` → IC=+0.165 (n=807)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.737 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.9065` → IC=+0.151 (n=1017)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.9065 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1739` → IC=+0.173 (n=687)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1739 (IC base=+0.144)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9088` → IC=+0.157 (n=1660)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.9088 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `8078.2796` → IC=+0.151 (n=1141)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8078.2796 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.188 (n=643)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0037 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.157 (n=1921)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4847 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` < `0.1769` → IC=+0.161 (n=845)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1769 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.7054` → IC=+0.145 (n=345)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.7054 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.241` → IC=+0.146 (n=1905)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.241 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.148 (n=1603)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1137 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0723` → IC=+0.155 (n=905)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0723 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.5724` → IC=+0.143 (n=1901)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.5724 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8264` → IC=+0.150 (n=1267)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8264 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=2545)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.01 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7743.0752` → IC=+0.151 (n=1716)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7743.0752 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.149 (n=741)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0088 (IC base=+0.142)

- **PATRÓN** `sigma_h` > `0.0045` → IC=+0.147 (n=741)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0045 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.5046` → IC=+0.151 (n=741)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.1834` → IC=+0.152 (n=742)
...
- **PATRÓN** `dist_vwap_pct` < `0.424` → IC=+0.149 (n=702)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.424 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.735` → IC=+0.150 (n=742)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.735 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.1122` → IC=+0.145 (n=652)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4406` → IC=+0.169 (n=243)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.4406 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=701)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `8243.4336` → IC=+0.150 (n=741)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8243.4336 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.164 (n=531)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0071 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.511` → IC=+0.183 (n=604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.511 (IC base=+0.151)
...
- **PATRÓN** `ibs_20min` > `0.0956` → IC=+0.166 (n=603)
...
- **PATRÓN** `dist_vwap_pct` < `0.3879` → IC=+0.152 (n=616)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.3879 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.966` → IC=+0.181 (n=136)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 8.966 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6473` → IC=+0.186 (n=202)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6473 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.7274` → IC=+0.156 (n=539)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7274 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1527` → IC=+0.155 (n=619)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` < 0.1527 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.0741` → IC=+0.182 (n=259)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.0741 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.1958` → IC=+0.167 (n=521)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.1958 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4508` → IC=+0.167 (n=592)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4508 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `8204.9591` → IC=+0.171 (n=603)
...
- **FILTRO** `sigma_h` > `0.008` → IC=-0.255 (n=92)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=279)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.179 (n=425)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `dist_vwap_pct` > `0.1326` → IC=+0.166 (n=285)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1326 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.09` → IC=+0.217 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.09 (IC base=+0.101)

- **PATRÓN** `volumen_regimen` < `1.0919` → IC=+0.122 (n=546)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.0919 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.232 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.101)

- **PATRÓN** `volumen_spike_ratio` < `2.5266` → IC=+0.150 (n=441)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.5266 (IC base=+0.101)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=441)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.02 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `2444.1883` → IC=+0.161 (n=237)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2444.1883 (IC base=+0.101)

- **PATRÓN** `ibs_20min` < `0.0688` → IC=+0.302 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0688 (IC base=-0.017)

- **PATRÓN** `dist_vwap_pct` < `0.1621` → IC=+0.137 (n=213)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1621 (IC base=-0.017)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.902` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.902 (IC base=-0.017)

- **PATRÓN** `volumen_pendiente_norm` > `0.0857` → IC=+0.202 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0857 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` < `2.637` → IC=+0.171 (n=144)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.637 (IC base=-0.017)

- **PATRÓN** `volumen_spike_ratio` > `1.4611` → IC=+0.154 (n=128)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4611 (IC base=-0.017)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.147 (n=151)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=-0.017)

- **PATRÓN** `libro_liquidez` > `2919.9798` → IC=+0.143 (n=54)

  - _Acción_: Kelly boost +0.71€ cuando `libro_liquidez` > 2919.9798 (IC base=-0.017)

### GBM_LATE_60M#BTC#60min
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.201 (n=192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.209 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5857 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.1296` → IC=+0.188 (n=91)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.1296 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.136 (n=119)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.106)

- **PATRÓN** `volumen_regimen` < `1.0552` → IC=+0.135 (n=165)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.0552 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.149 (n=132)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.106)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0198` → IC=+0.187 (n=132)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.0198 (IC base=+0.106)

- **PATRÓN** `libro_liquidez` > `2825.3738` → IC=+0.131 (n=174)

  - _Acción_: Kelly boost +0.65€ cuando `libro_liquidez` > 2825.3738 (IC base=+0.106)

- **PATRÓN** `drift_60min` |x|≤ `0.0401` → IC=+0.231 (n=24)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0401 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.4946` → IC=+0.226 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4946 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` < `0.9643` → IC=+0.171 (n=71)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.9643 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.0796` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0796 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` < `2.4111` → IC=+0.233 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4111 (IC base=+0.053)

- **PATRÓN** `libro_liquidez` > `3148.6557` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3148.6557 (IC base=+0.053)
...
- **PATRÓN** `ibs_20min` > `0.7368` → IC=+0.138 (n=186)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.7368 (IC base=+0.063)

- **PATRÓN** `ibs_20min` < `0.234` → IC=+0.132 (n=191)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.234 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.126` → IC=+0.139 (n=95)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 6.126 (IC base=+0.048)

- **PATRÓN** `libro_liquidez` > `3761.0521` → IC=+0.150 (n=98)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3761.0521 (IC base=+0.048)
...
- **PATRÓN** `ibs_20min` < `0.1524` → IC=+0.174 (n=84)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.1524 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.339` → IC=+0.132 (n=93)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 11.339 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` < `0.1725` → IC=+0.132 (n=66)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` < 0.1725 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.131 (n=63)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `3550.6412` → IC=+0.139 (n=95)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 3550.6412 (IC base=+0.102)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6103)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=1024)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1301)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=2547)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=7799)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2658)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8130)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.217 (n=418)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=1317)

- **FILTRO** `ibs_20min` < `0.748` → IC=-0.177 (n=431)

  - _Acción_: SKIP cuando `ibs_20min` < 0.748
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=1304)

### MOMENTUM_IBS_15M_BALLENA#BTC#15min
- **FILTRO** `py_entrada` > `0.555` → IC=-0.168 (n=410)

  - _Acción_: SKIP cuando `py_entrada` > 0.555
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=1247)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.195 (n=441)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=1348)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.216 (n=452)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=1440)

- **FILTRO** `ibs_20min` > `0.287` → IC=-0.171 (n=472)

  - _Acción_: SKIP cuando `ibs_20min` > 0.287
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1420)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.201 (n=413)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1295)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.194 (n=465)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1436)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2345)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7497)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16874)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.280 (n=5627)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=18744)

- **FILTRO** `ibs_7min` < `0.7066` → IC=-0.237 (n=6092)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7066
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=18279)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.160 (n=8095)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=16276)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.223 (n=7598)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=22921)

- **FILTRO** `ibs_7min` > `0.2973` → IC=-0.177 (n=7625)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2973
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=22894)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=917)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2964)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.256 (n=1278)
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.192 (n=946)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2935)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3576)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1740)

- **FILTRO** `ibs_7min` > `0.7992` → IC=-0.204 (n=1327)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7992
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3989)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=988)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=3280)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=986)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=3282)
...
- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.170 (n=1062)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3206)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.256 (n=1008)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=3316)

- **FILTRO** `ibs_7min` > `0.2509` → IC=-0.167 (n=1080)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2509
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3244)

- **FILTRO** `ballena_activa_n` > `114.0` → IC=-0.164 (n=1454)

  - _Acción_: SKIP cuando `ballena_activa_n` > 114.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2870)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.181 (n=898)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=2757)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.319 (n=872)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=2783)

- **FILTRO** `drift_7min_pct` |x|> `0.1813` → IC=-0.129 (n=1241)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1813
  - _Potencial_: sin este filtro IC_bueno=-0.109 (n=2414)

- **FILTRO** `ibs_7min` < `0.2031` → IC=-0.272 (n=913)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2031
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2742)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.217 (n=888)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2767)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.235 (n=1308)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=4272)

- **FILTRO** `ibs_7min` > `0.2649` → IC=-0.157 (n=1897)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2649
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=3683)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1277)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2733)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=965)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3045)

- **FILTRO** `ibs_7min` < `0.7455` → IC=-0.189 (n=1002)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7455
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3008)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.184 (n=982)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3028)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1004)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3098)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.177 (n=1025)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3077)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.181 (n=1019)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3083)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.239 (n=1088)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3342)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.208 (n=1106)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3324)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.175 (n=1393)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=4378)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.124 (n=1246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=2881)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.278 (n=984)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3143)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.227 (n=1028)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3099)
...
- **FILTRO** `py_entrada` > `0.68` → IC=-0.204 (n=1301)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=4125)
...
- **PATRÓN** `delta_ratio` |x|> `0.3987` → IC=+0.134 (n=616)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `delta_ratio` |x|> 0.3987 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.136 (n=555)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 6.0 (IC base=+0.121)

- **PATRÓN** `total_vol_5m` < `474.7871` → IC=+0.144 (n=206)

  - _Acción_: Kelly boost +0.72€ cuando `total_vol_5m` < 474.7871 (IC base=+0.121)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2283)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1176)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.190 (n=472)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3414` → IC=+0.207 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3414 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.173 (n=734)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1495` → IC=+0.166 (n=519)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1495 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.547` → IC=+0.167 (n=1093)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.547 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.093` → IC=+0.254 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.093 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `5104.4221` → IC=+0.181 (n=472)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 5104.4221 (IC base=+0.168)
...
- **FILTRO** `dist_vwap_pct` > `0.5854` → IC=-0.147 (n=114)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.063 (n=568)
...
- **FILTRO** `sigma_h` > `0.0124` → IC=-0.203 (n=523)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.207 (n=247)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1846)
...
- **PATRÓN** `dist_vwap_pct` < `0.354` → IC=+0.265 (n=113)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.354 (IC base=+0.074)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0717` → IC=+0.204 (n=201)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0717 (IC base=-0.043)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1052` → IC=+0.362 (n=136)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1052 (IC base=-0.047)
...
- **PATRÓN** `dist_vwap_pct` > `1.0955` → IC=+0.417 (n=34)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0955 (IC base=-0.047)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6173 sube el IC de +0.168 a +0.239 en UPDOWN_GBM#15min (n=1041). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3519 sube el IC de -0.047 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1077). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.043 a +0.241 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=226). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3256 sube el IC de -0.047 a +0.299 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=316). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20074 | -0.105 | -2922.37€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1210 | -0.041 | -211.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 18864 | -0.110 | -2711.30€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 