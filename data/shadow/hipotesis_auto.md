# Hipótesis automáticas — 2026-09-12 23:55 UTC
_Generado por shadow_postmortem.py sobre 411624 resoluciones (PNL=+43308.69€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.4` → IC=-0.264 (n=5272)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.4
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=15821)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `141.98` → IC=-0.277 (n=733)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.98
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2199)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `132.71` → IC=-0.294 (n=672)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.71
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2019)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `145.1` → IC=-0.167 (n=1366)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.1
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4099)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.09` → IC=-0.255 (n=1209)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.09
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=3630)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.1` → IC=-0.346 (n=1330)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.1
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=2703)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.199 (n=9847)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2663)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `11059.2357` → IC=+0.193 (n=851)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 11059.2357 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.142 (n=8104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1527)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `14512.1835` → IC=+0.216 (n=396)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14512.1835 (IC base=+0.201)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.268 (n=1086)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=1589)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.175 (n=263)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` > 0.615 (IC base=+0.104)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.145 (n=2158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.331 (n=686)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=1083)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `4425.7357` → IC=+0.241 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4425.7357 (IC base=+0.236)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.214 (n=488)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.85` → IC=+0.425 (n=492)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.186 (n=1049)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=8293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.755` → IC=+0.358 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.755 (IC base=+0.334)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.182 (n=1969)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.326 (n=591)
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.190 (n=1049)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.7 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.191 (n=847)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4460)

  - _Acción_: Kelly boost +0.92€ cuando `py_entrada` > 0.71 (IC base=+0.165)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=4340)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.267 (n=1553)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.206 (n=1514)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.249 (n=2049)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.199)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.190 (n=4116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.42` → IC=+0.151 (n=3377)
...
- **PATRÓN** `restante_min` < `3.99` → IC=+0.142 (n=1667)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 3.99 (IC base=+0.130)

- **PATRÓN** `restante_min` > `4.89` → IC=+0.145 (n=2315)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.262)

- **PATRÓN** `libro_liquidez` > `963.9705` → IC=+0.275 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 963.9705 (IC base=+0.262)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.974` → IC=+0.230 (n=1829)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.974 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2143` → IC=+0.243 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2143 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.832` → IC=+0.166 (n=2112)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.832 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `1.23` → IC=+0.242 (n=1358)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.23 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.238 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1756` → IC=+0.190 (n=3676)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1756 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.1103` → IC=+0.194 (n=1368)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1103 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4707` → IC=+0.193 (n=3540)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4707 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5775` → IC=+0.123 (n=6750)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5775 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.1323` → IC=+0.164 (n=1986)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1323 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` < `1.2004` → IC=+0.160 (n=2083)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2004 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `0.6202` → IC=+0.163 (n=2082)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6202 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.1691` → IC=+0.224 (n=1014)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1691 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4625` → IC=+0.194 (n=3463)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4625 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.203 (n=3229)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 167.0 (IC base=+0.056)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.189 (n=413)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3264` → IC=+0.169 (n=1232)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3264 (IC base=+0.166)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.191 (n=604)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 8.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.271 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.966` → IC=+0.282 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.966 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2779` → IC=+0.200 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2779 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `2.6284` → IC=+0.156 (n=1125)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.6284 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.162 (n=1125)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.182 (n=1307)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.06 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.188 (n=887)
...
- **PATRÓN** `drift_60min` |x|≤ `0.195` → IC=+0.277 (n=609)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.377` → IC=+0.250 (n=949)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.377 (IC base=+0.238)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2878` → IC=+0.289 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2878 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.679` → IC=+0.272 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.679 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.242 (n=963)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1573.1624` → IC=+0.249 (n=815)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1573.1624 (IC base=+0.238)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.233 (n=750)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1127` → IC=+0.236 (n=411)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1127 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=933)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.9266` → IC=+0.251 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9266 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.2036` → IC=+0.215 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2036 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.095` → IC=+0.228 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.095 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.223 (n=932)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2628 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `0.8772` → IC=+0.213 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8772 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.1654` → IC=+0.212 (n=950)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4881` → IC=+0.228 (n=399)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4881 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.4058` → IC=+0.214 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4058 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `10916.3675` → IC=+0.225 (n=932)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10916.3675 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.164 (n=879)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0048 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.322` → IC=+0.149 (n=999)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.322 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.160 (n=339)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 18.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.3189` → IC=+0.195 (n=667)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.3189 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.678` → IC=+0.176 (n=331)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 6.678 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.150 (n=999)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1954 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.141 (n=999)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.613 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1556` → IC=+0.202 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1556 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.4011` → IC=+0.156 (n=890)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.4011 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4117` → IC=+0.152 (n=890)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4117 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `12848.4723` → IC=+0.151 (n=666)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 12848.4723 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `220.0` → IC=+0.170 (n=271)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.255 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.369` → IC=+0.234 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.369 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1072` → IC=+0.184 (n=1003)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1072 (IC base=+0.177)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1484` → IC=+0.211 (n=455)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1484 (IC base=+0.210)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2989` → IC=+0.216 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2989 (IC base=+0.210)
...
- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.202 (n=559)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=87)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1515)

- **PATRÓN** `ibs_20min` > `0.9299` → IC=+0.158 (n=258)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.9299 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` < `0.1829` → IC=+0.339 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1829 (IC base=+0.006)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.199` → IC=+0.124 (n=477)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 4.199 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` < `0.6044` → IC=+0.406 (n=62)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4779` → IC=+0.352 (n=79)
...
- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.334 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 168.0 (IC base=+0.006)

- **PATRÓN** `dist_vwap_pct` > `0.1577` → IC=+0.185 (n=147)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1577 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `1.1531` → IC=+0.142 (n=451)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1531 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.137 (n=450)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6141 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.0654` → IC=+0.187 (n=148)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.0654 (IC base=-0.010)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.126 (n=1576)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.607` → IC=-0.196 (n=261)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2097)
...
- **FILTRO** `drift_60min` |x|> `0.638` → IC=-0.187 (n=385)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.638
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1157)

- **FILTRO** `ibs_20min` < `0.64` → IC=-0.157 (n=1017)

  - _Acción_: SKIP cuando `ibs_20min` < 0.64
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=525)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.184 (n=305)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1237)

- **FILTRO** `ibs_20min` > `0.78` → IC=-0.193 (n=585)
...
- **PATRÓN** `dist_vwap_pct` > `0.4467` → IC=+0.258 (n=89)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4467 (IC base=-0.031)

- **PATRÓN** `dist_vwap_pct` < `0.2503` → IC=+0.229 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2503 (IC base=-0.031)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.157 (n=3098)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0077 (IC base=+0.083)

- **PATRÓN** `ibs_20min` > `0.4545` → IC=+0.169 (n=6105)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4545 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` > `0.6998` → IC=+0.270 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6998 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.482` → IC=+0.136 (n=3233)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 3.482 (IC base=+0.083)

- **PATRÓN** `volumen_regimen` > `0.6734` → IC=+0.225 (n=2050)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6734 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.2487` → IC=+0.253 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2487 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` < `1.4796` → IC=+0.232 (n=1208)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4796 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` > `2.8011` → IC=+0.233 (n=1207)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8011 (IC base=+0.083)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.275 (n=3098)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.083)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.137 (n=2348)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0084 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.145 (n=6200)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5625 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6602` → IC=+0.243 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6602 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.1942` → IC=+0.260 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1942 (IC base=+0.064)

- **PATRÓN** `volumen_pendiente_norm` > `0.2499` → IC=+0.322 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2499 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `1.6166` → IC=+0.250 (n=1035)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6166 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `2.3737` → IC=+0.256 (n=1065)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3737 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2202)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.3448` → IC=-0.125 (n=611)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3448
  - _Potencial_: sin este filtro IC_bueno=+0.114 (n=1242)

- **FILTRO** `sigma_ewma_delta_pct` > `4.296` → IC=-0.159 (n=353)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.296
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1170)

- **PATRÓN** `ibs_20min` > `0.8488` → IC=+0.251 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8488 (IC base=+0.035)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.987` → IC=+0.158 (n=484)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.987 (IC base=+0.035)

- **PATRÓN** `volumen_pendiente_norm` > `0.2213` → IC=+0.298 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2213 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` < `1.8706` → IC=+0.191 (n=299)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.8706 (IC base=+0.035)

- **PATRÓN** `volumen_spike_ratio` > `1.4614` → IC=+0.184 (n=448)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.4614 (IC base=+0.035)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.214 (n=362)
...
- **FILTRO** `ibs_20min` > `0.8364` → IC=-0.152 (n=524)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=1575)

- **PATRÓN** `dist_vwap_pct` > `0.2999` → IC=+0.126 (n=217)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.2999 (IC base=+0.005)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4154` → IC=+0.160 (n=189)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.4154 (IC base=+0.005)

- **PATRÓN** `ballena_activa_n` < `236.0` → IC=+0.174 (n=185)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 236.0 (IC base=+0.005)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.275` → IC=+0.354 (n=39)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.275 (IC base=-0.004)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.219 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7599 (IC base=-0.004)

- **PATRÓN** `volumen_spike_ratio` > `2.127` → IC=+0.225 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.127 (IC base=-0.004)

- **PATRÓN** `ballena_activa_n` < `517.0` → IC=+0.214 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 517.0 (IC base=-0.004)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.266 (n=975)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0062 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.0951` → IC=+0.245 (n=363)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.290 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.58` → IC=+0.277 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.58 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.1115` → IC=+0.255 (n=899)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1115 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `3.1012` → IC=+0.251 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1012 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1210)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.296 (n=863)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.286 (n=861)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3452` → IC=+0.318 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3452 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` < `3.3742` → IC=+0.272 (n=767)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3742 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.228` → IC=+0.284 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.228 (IC base=+0.278)
...
- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.278 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 22.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.22` → IC=-0.209 (n=297)

  - _Acción_: SKIP cuando `ibs_20min` < 0.22
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=893)

- **FILTRO** `ibs_20min` > `0.8333` → IC=-0.179 (n=406)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8333
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=1221)

- **PATRÓN** `ibs_20min` > `0.7998` → IC=+0.129 (n=405)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` > 0.7998 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` > `0.3052` → IC=+0.220 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3052 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.9213` → IC=+0.199 (n=207)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.9213 (IC base=-0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4982` → IC=+0.250 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4982 (IC base=-0.026)

- **PATRÓN** `ballena_activa_n` < `158.0` → IC=+0.227 (n=185)
...
- **FILTRO** `ibs_20min` > `0.7241` → IC=-0.235 (n=398)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.076 (n=1197)

- **FILTRO** `sigma_ewma_delta_pct` > `4.748` → IC=-0.158 (n=384)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.748
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1211)
...
- **PATRÓN** `ibs_20min` < `0.2105` → IC=+0.163 (n=532)
...
- **PATRÓN** `sigma_h` > `0.0137` → IC=+0.296 (n=698)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0137 (IC base=+0.270)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.283 (n=523)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3853` → IC=+0.302 (n=1047)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.383` → IC=+0.282 (n=374)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.267 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `1.4369` → IC=+0.264 (n=889)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4369 (IC base=+0.270)

- **PATRÓN** `libro_liquidez` > `2556.7679` → IC=+0.279 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2556.7679 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.175 (n=1842)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1834)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3347` → IC=+0.175 (n=4829)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3347 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=5758)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.6949` → IC=+0.229 (n=4902)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6949 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1627` → IC=+0.195 (n=2403)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1627 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.219` → IC=+0.249 (n=1129)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.219 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2173` → IC=+0.162 (n=3673)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2173 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6223` → IC=+0.159 (n=3673)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6223 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.1069` → IC=+0.187 (n=2141)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1069 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.3099` → IC=+0.168 (n=4570)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.3099 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.679` → IC=+0.165 (n=1731)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.679 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3839.1297` → IC=+0.174 (n=1829)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3839.1297 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.184 (n=4402)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 127.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.185 (n=3519)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0064 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.0785` → IC=+0.203 (n=1756)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0785 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.201 (n=2582)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` < `0.4561` → IC=+0.224 (n=5265)
...
- **PATRÓN** `volumen_regimen` < `1.1823` → IC=+0.155 (n=3860)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1823 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.625` → IC=+0.152 (n=3860)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.625 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2909` → IC=+0.228 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2909 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.8729` → IC=+0.169 (n=3081)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.8729 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6285` → IC=+0.174 (n=1540)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6285 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.169 (n=4228)
...
- **PATRÓN** `drift_60min` |x|≤ `0.319` → IC=+0.208 (n=920)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.319 (IC base=+0.189)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.309 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.044 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2294` → IC=+0.233 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2294 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `2.2575` → IC=+0.178 (n=729)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.2575 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `1.4408` → IC=+0.181 (n=828)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4408 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.213 (n=821)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.203 (n=568)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 56.0 (IC base=+0.189)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.246 (n=266)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.165)

- **PATRÓN** `drift_60min` |x|≤ `0.3642` → IC=+0.175 (n=793)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3642 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.191 (n=720)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 8.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.5868` → IC=+0.230 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5868 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.2116` → IC=+0.218 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2116 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.757` → IC=+0.241 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.757 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `1.2719` → IC=+0.175 (n=793)
...
- **PATRÓN** `libro_liquidez` > `11274.9584` → IC=+0.190 (n=708)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1947` → IC=+0.198 (n=597)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.287 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.56` → IC=+0.267 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.56 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.184 (n=730)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1074 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.1354` → IC=+0.185 (n=344)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1354 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `3.6503` → IC=+0.203 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6503 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.205 (n=990)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.231 (n=752)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0105 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.220 (n=674)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3571` → IC=+0.250 (n=754)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.274 (n=122)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2457` → IC=+0.224 (n=450)
...
- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.200 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.218)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.186 (n=754)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0066 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.4235` → IC=+0.169 (n=857)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.4235 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=867)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `0.4164` → IC=+0.205 (n=857)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4164 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.1355` → IC=+0.189 (n=571)
...
- **PATRÓN** `volumen_regimen` < `0.8636` → IC=+0.164 (n=572)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8636 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `1.2001` → IC=+0.184 (n=286)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.2001 (IC base=+0.157)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4142` → IC=+0.173 (n=279)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4142 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `2.5331` → IC=+0.189 (n=278)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.5331 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `7640.2791` → IC=+0.198 (n=571)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 7640.2791 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.162 (n=699)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 159.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.158 (n=809)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.006 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3739` → IC=+0.147 (n=919)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3739 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.185 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 18.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.5951` → IC=+0.175 (n=919)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5951 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.1489` → IC=+0.138 (n=918)
...
- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.132 (n=919)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.613 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.0738` → IC=+0.165 (n=362)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0738 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` < `1.7863` → IC=+0.130 (n=538)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.7863 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `9896.1185` → IC=+0.149 (n=417)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9896.1185 (IC base=+0.125)
...
- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.123 (n=1038)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.2233 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `2.1542` → IC=+0.123 (n=877)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.1542 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1055)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `3136.4952` → IC=+0.213 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3136.4952 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.139 (n=740)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.151 (n=333)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0053 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.177 (n=466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.5278` → IC=+0.204 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5278 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2469` → IC=+0.130 (n=964)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2469 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `1.0407` → IC=+0.126 (n=876)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0407 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1374` → IC=+0.136 (n=388)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.1374 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3110.9294` → IC=+0.156 (n=332)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3110.9294 (IC base=+0.115)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0174` → IC=+0.209 (n=658)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0174 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.216 (n=435)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1645 (IC base=+0.197)
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.251 (n=884)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.294` → IC=+0.239 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.294 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `1.2022` → IC=+0.199 (n=988)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.2022 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `0.8467` → IC=+0.217 (n=658)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2071` → IC=+0.213 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2071 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.203 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8207 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.199 (n=1022)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `2554.1268` → IC=+0.197 (n=658)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2554.1268 (IC base=+0.197)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.142 (n=560)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0044 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.154 (n=576)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0072 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0946` → IC=+0.148 (n=424)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0946 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.164 (n=1194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.168 (n=1271)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.4056 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.784` → IC=+0.186 (n=170)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.784 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.176 (n=572)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.159 (n=723)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8616 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1672` → IC=+0.166 (n=348)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1672 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.4352` → IC=+0.148 (n=404)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4352 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.823` → IC=+0.153 (n=807)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.823 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.145 (n=1401)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.02 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `8121.9037` → IC=+0.173 (n=576)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 8121.9037 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.162 (n=362)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 20.0 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.141 (n=438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0037 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.494` → IC=+0.140 (n=1155)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.494 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.834` → IC=+0.131 (n=521)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 3.834 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.1661` → IC=+0.146 (n=334)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1661 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.2216` → IC=+0.125 (n=1097)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.2216 (IC base=+0.102)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.139 (n=391)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 20.0 (IC base=+0.102)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.140 (n=187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0037 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.105` → IC=+0.167 (n=124)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.105 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.156 (n=289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.9057` → IC=+0.182 (n=127)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.9057 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` > `0.3049` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3049 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.328` → IC=+0.189 (n=130)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 3.328 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.5852` → IC=+0.198 (n=94)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 0.5852 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.065` → IC=+0.122 (n=117)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` > 0.065 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `9742.4663` → IC=+0.156 (n=280)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 9742.4663 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `147.0` → IC=+0.155 (n=85)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 147.0 (IC base=+0.113)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.201 (n=192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.003 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.2718` → IC=+0.137 (n=384)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.2718 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.125 (n=390)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 7.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.3751` → IC=+0.186 (n=291)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.3751 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.279` → IC=+0.137 (n=180)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 4.279 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` > `0.7044` → IC=+0.133 (n=390)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.7044 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.1552` → IC=+0.205 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1552 (IC base=+0.112)
...
- **PATRÓN** `ballena_activa_n` < `260.0` → IC=+0.141 (n=271)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 260.0 (IC base=+0.112)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.227 (n=130)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.235 (n=353)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.2679` → IC=+0.247 (n=390)
...
- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.222 (n=261)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=419)
...
- **FILTRO** `dist_vwap_pct` > `0.3429` → IC=-0.204 (n=25)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=290)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.177 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.064)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.212 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.139 (n=120)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.064)

- **PATRÓN** `libro_liquidez` > `2775.0073` → IC=+0.167 (n=124)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2775.0073 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.148 (n=237)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.4524 (IC base=+0.068)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.751` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.751 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7227` → IC=+0.151 (n=104)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.7227 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.120 (n=214)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.4885 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.125 (n=182)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 47.0 (IC base=+0.068)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.191 (n=3122)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0086 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4751` → IC=+0.211 (n=6876)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4751 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.8943` → IC=+0.198 (n=914)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8943 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.578` → IC=+0.222 (n=3371)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.578 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.882` → IC=+0.163 (n=3110)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.882 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1698` → IC=+0.185 (n=1886)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1698 (IC base=+0.164)

- **PATRÓN** `volumen_spike_ratio` > `2.6443` → IC=+0.179 (n=2173)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6443 (IC base=+0.164)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=8161)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `3803.692` → IC=+0.171 (n=2292)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3803.692 (IC base=+0.164)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.191 (n=4839)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 98.0 (IC base=+0.164)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.197 (n=4190)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.182)

- **PATRÓN** `drift_60min` |x|≤ `0.475` → IC=+0.185 (n=6285)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.475 (IC base=+0.182)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.200 (n=2430)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.237 (n=6285)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.167 (n=3975)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.2283 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.774` → IC=+0.203 (n=920)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.774 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.055` → IC=+0.157 (n=3819)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.055 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.197` → IC=+0.161 (n=1447)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.197 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.236` → IC=+0.244 (n=1090)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.236 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2866` → IC=+0.190 (n=2521)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2866 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.178 (n=5163)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 131.0 (IC base=+0.182)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.220 (n=383)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0049 (IC base=+0.195)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.232 (n=521)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.195)

- **PATRÓN** `drift_60min` |x|≤ `0.3223` → IC=+0.195 (n=1147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.3223 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=558)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.328 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.778` → IC=+0.326 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.778 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.0953` → IC=+0.224 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0953 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` < `1.559` → IC=+0.197 (n=467)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.559 (IC base=+0.195)

- **PATRÓN** `volumen_spike_ratio` > `2.5623` → IC=+0.194 (n=354)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.5623 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.225 (n=1069)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.195)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.231 (n=811)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2066` → IC=+0.282 (n=603)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.636` → IC=+0.269 (n=901)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.636 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2284` → IC=+0.316 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2284 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.9092` → IC=+0.279 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9092 (IC base=+0.258)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.259 (n=906)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1576.58` → IC=+0.269 (n=806)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.58 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.257 (n=652)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.194 (n=364)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0027 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.1839` → IC=+0.152 (n=726)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1839 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.695` → IC=+0.240 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.695 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.3384` → IC=+0.200 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3384 (IC base=+0.148)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.153 (n=967)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6949` → IC=+0.184 (n=479)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6949 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1572` → IC=+0.185 (n=303)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1572 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4264` → IC=+0.160 (n=1036)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4264 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7617` → IC=+0.158 (n=691)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7617 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10659.1786` → IC=+0.174 (n=973)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10659.1786 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `500.0` → IC=+0.164 (n=964)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 500.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.174 (n=856)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0049 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.3258` → IC=+0.174 (n=973)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3258 (IC base=+0.159)
...
- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.207 (n=973)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6433 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.618` → IC=+0.193 (n=177)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 11.618 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.170 (n=973)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.1847 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.1495` → IC=+0.225 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1495 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.393` → IC=+0.173 (n=876)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.393 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `2.0873` → IC=+0.167 (n=397)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.0873 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `322.0` → IC=+0.173 (n=344)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.214 (n=1075)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)
...
- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.251 (n=953)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6739 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.426` → IC=+0.291 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.426 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.219` → IC=+0.219 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.219 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `1.6797` → IC=+0.220 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6797 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.228 (n=1192)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.238 (n=782)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1476` → IC=+0.227 (n=460)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1476 (IC base=+0.227)
...
- **PATRÓN** `ibs_20min` < `0.3871` → IC=+0.266 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3871 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.274 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.68 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` > `0.3603` → IC=+0.291 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3603 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` < `2.9608` → IC=+0.215 (n=810)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9608 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` > `2.2501` → IC=+0.225 (n=613)
...
- **PATRÓN** `libro_liquidez` > `1891.307` → IC=+0.229 (n=348)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.307 (IC base=+0.227)

- **PATRÓN** `ballena_activa_n` < `23.0` → IC=+0.226 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 23.0 (IC base=+0.227)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.170 (n=510)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0038 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0941` → IC=+0.143 (n=387)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.0941 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.147 (n=1160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 6.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.7132` → IC=+0.235 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7132 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.5474` → IC=+0.182 (n=325)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.5474 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.356` → IC=+0.171 (n=505)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 4.356 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.159 (n=773)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7416` → IC=+0.161 (n=741)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7416 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `9055.4459` → IC=+0.235 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9055.4459 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.145 (n=907)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 169.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.165 (n=616)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0051 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.425` → IC=+0.150 (n=922)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.182 (n=923)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6933 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.2025` → IC=+0.137 (n=852)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2025 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.14` → IC=+0.183 (n=137)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 11.14 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.299` → IC=+0.132 (n=861)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.299 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.8509` → IC=+0.137 (n=615)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8509 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.1607` → IC=+0.143 (n=309)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1607 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2736` → IC=+0.250 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2736 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.1233` → IC=+0.159 (n=388)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.1233 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `11124.4077` → IC=+0.174 (n=308)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 11124.4077 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.133 (n=742)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 177.0 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.174 (n=492)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0062 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.1205` → IC=+0.153 (n=373)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1205 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.155 (n=532)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` < `0.6154` → IC=+0.212 (n=1119)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6154 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` < `0.2627` → IC=+0.139 (n=962)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2627 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.344` → IC=+0.128 (n=1078)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2169` → IC=+0.172 (n=172)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.2169 (IC base=+0.120)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.127 (n=1227)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.03 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `2959.015` → IC=+0.159 (n=373)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2959.015 (IC base=+0.120)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0175` → IC=+0.211 (n=809)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.237 (n=1222)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.1779` → IC=+0.235 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1779 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.535` → IC=+0.240 (n=659)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.535 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.2371` → IC=+0.206 (n=1214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2371 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6192` → IC=+0.206 (n=1214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6192 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2377` → IC=+0.235 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2377 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `2.6099` → IC=+0.228 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6099 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=1242)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2559.4339` → IC=+0.206 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2559.4339 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.248 (n=447)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0251` → IC=+0.224 (n=444)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0251 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.201)
...
- **PATRÓN** `ibs_20min` < `0.5008` → IC=+0.252 (n=1331)
...
- **PATRÓN** `dist_vwap_pct` < `0.2629` → IC=+0.204 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2629 (IC base=+0.201)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2225` → IC=+0.192 (n=1014)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2225 (IC base=+0.201)
...
- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.184 (n=1063)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5354` → IC=+0.137 (n=2113)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1731` → IC=+0.152 (n=584)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.1731 (IC base=+0.129)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8808` → IC=+0.140 (n=1394)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8808 (IC base=+0.129)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.175 (n=386)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0051 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.160 (n=207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 18.0 (IC base=+0.092)

- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.201 (n=483)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.267` → IC=+0.211 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.267 (IC base=+0.092)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.242 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.092)

- **PATRÓN** `volumen_spike_ratio` < `2.5476` → IC=+0.140 (n=379)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.5476 (IC base=+0.092)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.150 (n=78)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.006 (IC base=+0.065)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.124 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 14.0 (IC base=+0.065)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.185 (n=147)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.6744 (IC base=+0.065)
...
- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.147 (n=49)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.0632 (IC base=+0.065)

- **PATRÓN** `volumen_pendiente_norm` > `0.0856` → IC=+0.125 (n=62)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` > 0.0856 (IC base=+0.065)

- **PATRÓN** `volumen_spike_ratio` < `2.5681` → IC=+0.162 (n=128)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.5681 (IC base=+0.065)

- **PATRÓN** `libro_liquidez` > `376.737` → IC=+0.156 (n=126)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 376.737 (IC base=+0.065)
...
- **PATRÓN** `ibs_20min` > `0.6429` → IC=+0.149 (n=189)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.6429 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.224 (n=27)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0046 (IC base=+0.120)

- **PATRÓN** `drift_60min` |x|≤ `0.3593` → IC=+0.134 (n=80)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.3593 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.139 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 6.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.127 (n=81)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` > 0.7143 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.5856` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.5856 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` < `0.1848` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1848 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.688` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.688 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `0.7968` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7968 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.132 (n=55)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.04 (IC base=+0.120)
...
- **PATRÓN** `libro_liquidez` > `2816.9896` → IC=+0.176 (n=137)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2816.9896 (IC base=+0.099)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=5600)

### MOMENTUM_IBS_15M#BTC#15min
- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=962)

### MOMENTUM_IBS_15M#ETH#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1089)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.465` → IC=-0.175 (n=2315)

  - _Acción_: SKIP cuando `py_entrada` < 0.465
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=7021)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=2215)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=7466)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.209 (n=373)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.085 (n=1172)

- **FILTRO** `ibs_20min` < `0.7485` → IC=-0.173 (n=386)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.200 (n=394)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.073 (n=1222)
...
- **FILTRO** `ibs_20min` > `0.2883` → IC=-0.179 (n=422)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2883
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=1270)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.192 (n=375)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1140)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.185 (n=424)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=1279)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1977)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1855)

### MOMENTUM_IBS_15M_FADE#BTC#15min
- **FILTRO** `hora_utc` < `15.0` → IC=-0.147 (n=83)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=197)
...
- **FILTRO** `ibs_20min` < `0.2344` → IC=-0.214 (n=96)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2344
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5458)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=16782)

- **FILTRO** `ibs_7min` < `0.713` → IC=-0.230 (n=5559)

  - _Acción_: SKIP cuando `ibs_7min` < 0.713
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=16681)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.162 (n=7541)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=14699)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.219 (n=6856)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=20846)

- **FILTRO** `ibs_7min` > `0.2981` → IC=-0.174 (n=6924)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2981
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=20778)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=813)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2658)

- **FILTRO** `ibs_7min` < `0.7103` → IC=-0.256 (n=1145)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7103
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2326)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.203 (n=849)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2622)

- **FILTRO** `py_entrada` > `0.51` → IC=-0.150 (n=3164)

  - _Acción_: SKIP cuando `py_entrada` > 0.51
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=1654)

- **FILTRO** `drift_7min_pct` |x|> `0.1102` → IC=-0.126 (n=1638)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1102
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3180)

- **FILTRO** `ibs_7min` > `0.801` → IC=-0.202 (n=1204)

  - _Acción_: SKIP cuando `ibs_7min` > 0.801
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3614)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.146 (n=889)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3044)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.252 (n=972)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2961)

- **FILTRO** `ibs_7min` < `0.7633` → IC=-0.180 (n=983)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7633
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=2950)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.170 (n=982)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=906)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3037)

- **FILTRO** `ibs_7min` > `0.2503` → IC=-0.168 (n=983)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2503
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2960)

- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.171 (n=984)

  - _Acción_: SKIP cuando `ballena_activa_n` > 152.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2959)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.177 (n=785)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=2506)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=772)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2519)

- **FILTRO** `ibs_7min` < `0.2105` → IC=-0.267 (n=822)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2105
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=2469)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.214 (n=772)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=2519)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=1165)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3890)

- **FILTRO** `ibs_7min` > `0.2667` → IC=-0.153 (n=1714)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2667
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3341)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=1129)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2538)

- **FILTRO** `ibs_7min` < `0.7524` → IC=-0.183 (n=916)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7524
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2751)

- **FILTRO** `ballena_activa_n` > `35.0` → IC=-0.182 (n=891)

  - _Acción_: SKIP cuando `ballena_activa_n` > 35.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=2776)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=908)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2816)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.173 (n=930)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2794)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.175 (n=928)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2796)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.233 (n=1023)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=3106)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.201 (n=1025)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=3104)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.168 (n=1255)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=3984)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.281 (n=885)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2864)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.225 (n=935)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2814)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=878)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2871)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.195 (n=1185)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=3738)
...
- **PATRÓN** `streak_estiramiento` < `0.4159` → IC=+0.214 (n=54)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `streak_estiramiento` < 0.4159 (IC base=+0.028)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=2125)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1122)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.187 (n=321)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0039 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.176 (n=436)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.007 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.0584` → IC=+0.171 (n=323)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0584 (IC base=+0.166)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0587` → IC=+0.172 (n=960)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.86€ cuando `delta_ratio_macro` |x|> 0.0587 (IC base=+0.166)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.225 (n=282)
...
- **PATRÓN** `ibs_15` > `0.617` → IC=+0.239 (n=960)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.617 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.1056` → IC=+0.169 (n=632)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1056 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.695` → IC=+0.239 (n=450)
...
- **PATRÓN** `libro_liquidez` > `2978.7992` → IC=+0.178 (n=640)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2978.7992 (IC base=+0.166)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=263)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.6402` → IC=-0.167 (n=109)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6402
...
- **PATRÓN** `sigma_h` > `0.0133` → IC=+0.223 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0133 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.0876` → IC=+0.185 (n=122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0876 (IC base=+0.159)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0472` → IC=+0.184 (n=273)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.92€ cuando `delta_ratio_macro` |x|> 0.0472 (IC base=+0.159)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0933` → IC=+0.274 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0933 (IC base=+0.159)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.221 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.159)

- **PATRÓN** `ibs_15` > `0.5075` → IC=+0.249 (n=273)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.2989` → IC=+0.159 (n=253)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2989 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.35` → IC=+0.202 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.35 (IC base=+0.159)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.158 (n=296)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.03 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `2565.5344` → IC=+0.190 (n=182)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2565.5344 (IC base=+0.159)
...
- **PATRÓN** `dist_vwap_pct` > `0.3864` → IC=+0.255 (n=202)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3864 (IC base=-0.051)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0711` → IC=+0.199 (n=184)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.99€ cuando `delta_ratio_macro` |x|> 0.0711 (IC base=-0.045)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1933` → IC=+0.179 (n=132)

  - _Acción_: Kelly boost +0.90€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1933 (IC base=-0.045)
...
- **PATRÓN** `dist_vwap_pct` < `0.143` → IC=+0.193 (n=190)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.143 (IC base=-0.045)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.617 sube el IC de +0.166 a +0.239 en UPDOWN_GBM#15min (n=960). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5075 sube el IC de +0.159 a +0.249 en UPDOWN_GBM#XRP#15min (n=273). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1053 sube el IC de +0.044 a +0.163 en UPDOWN_GBM#XRP#15min (n=289). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3561 sube el IC de -0.051 a +0.270 en UPDOWN_GBM_15M_TARDIO (n=946). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.045 a +0.245 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=206). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 21093 | -0.105 | -3136.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1133 | -0.027 | -189.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19960 | -0.109 | -2946.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2932 | -0.112 | -513.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2932 | -0.112 | -513.83€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1133 | -0.027 | -189.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1133 | -0.027 | -189.73€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2691 | -0.090 | -608.20€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2691 | -0.090 | -608.20€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 5465 | -0.063 | -510.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5465 | -0.063 | -510.30€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 4839 | -0.110 | -375.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 4839 | -0.110 | -375.24€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4033 | -0.180 | -938.70€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4033 | -0.180 | -938.70€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 9911 | -0.050 | +4209.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 2721 | -0.010 | +1849.40€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 7190 | -0.066 | +2360.43€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 9911 | -0.050 | +4209.83€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 