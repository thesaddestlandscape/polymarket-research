# Hipótesis automáticas — 2026-08-18 23:38 UTC
_Generado por shadow_postmortem.py sobre 69063 resoluciones (PNL=+6876.15€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `n_ballenas` < `5.0` → IC=-0.127 (n=2187)

  - _Acción_: SKIP cuando `n_ballenas` < 5.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=1484)

- **FILTRO** `restante_s_al_confirmar` < `151.44` → IC=-0.252 (n=917)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 151.44
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2754)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `118.28` → IC=-0.399 (n=97)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.28
  - _Potencial_: sin este filtro IC_bueno=-0.119 (n=292)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` > `641.05` → IC=-0.278 (n=115)
...
- **FILTRO** `concentracion_yes` < `1.0` → IC=-0.135 (n=61)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.122 (n=828)

- **FILTRO** `restante_s_al_confirmar` < `247.21` → IC=-0.150 (n=666)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 247.21
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=223)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.92` → IC=-0.284 (n=179)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.92
  - _Potencial_: sin este filtro IC_bueno=-0.207 (n=540)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.192 (n=2358)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` > 0.7 (IC base=+0.092)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=1173)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.092)

- **PATRÓN** `libro_liquidez` > `2373.5135` → IC=+0.168 (n=1133)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2373.5135 (IC base=+0.092)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.158 (n=4031)
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.286 (n=1513)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=2027)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `4052.555` → IC=+0.181 (n=822)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 4052.555 (IC base=+0.152)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=371)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.785` → IC=+0.362 (n=121)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.231 (n=314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.300 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.142 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.555` → IC=+0.144 (n=425)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.316 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.317 (n=260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2188.8928` → IC=+0.168 (n=272)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2188.8928 (IC base=+0.146)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.83` → IC=+0.396 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.83 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.274 (n=122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.235)

- **PATRÓN** `py_entrada` < `0.31` → IC=+0.353 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.31 (IC base=+0.235)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.245 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `913.222` → IC=+0.246 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 913.222 (IC base=+0.235)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.202 (n=920)
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.172 (n=610)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.217 (n=613)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.188 (n=507)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` < 0.72 (IC base=+0.172)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.432 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.915` → IC=+0.409 (n=64)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.409 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.412)

- **PATRÓN** `libro_liquidez` > `3351.8902` → IC=+0.433 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3351.8902 (IC base=+0.412)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.194 (n=1752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.227 (n=3279)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.188)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.135 (n=428)

  - _Acción_: Kelly boost +0.67€ cuando `py_entrada` > 0.73 (IC base=+0.096)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.298 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.326 (n=245)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.178 (n=318)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 6.0 (IC base=+0.153)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.218 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.153)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.233 (n=380)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.298 (n=266)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.285 (n=365)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.146 (n=846)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `profundidad_ratio_no` > `11.8` → IC=+0.166 (n=282)

  - _Acción_: Kelly boost +0.83€ cuando `profundidad_ratio_no` > 11.8 (IC base=+0.142)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.307 (n=366)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.287 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `3939.2578` → IC=+0.280 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3939.2578 (IC base=+0.274)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.311 (n=199)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1882.9092` → IC=+0.318 (n=190)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1882.9092 (IC base=+0.300)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.409 (n=174)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9882` → IC=+0.265 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9882 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.4171` → IC=+0.288 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4171 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.717` → IC=+0.235 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.717 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` < `1.294` → IC=+0.253 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.294 (IC base=+0.100)

- **PATRÓN** `volumen_regimen` > `0.646` → IC=+0.247 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.646 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.6654` → IC=+0.122 (n=2183)
...
- **PATRÓN** `volumen_regimen` < `1.3049` → IC=+0.140 (n=493)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.3049 (IC base=+0.077)

- **PATRÓN** `volumen_regimen` > `0.6936` → IC=+0.141 (n=441)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6936 (IC base=+0.077)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8143` → IC=+0.221 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8143 (IC base=+0.077)

- **PATRÓN** `ballena_activa_n` < `245.0` → IC=+0.268 (n=123)
...
- **PATRÓN** `libro_spread` < `0.06` → IC=+0.156 (n=303)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.06 (IC base=+0.121)
...
- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.333 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0019 (IC base=+0.270)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.311 (n=35)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.270)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.323 (n=94)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 9.0 (IC base=+0.270)

- **PATRÓN** `ibs_20min` < `0.6521` → IC=+0.284 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6521 (IC base=+0.270)

- **PATRÓN** `ibs_20min` > `0.917` → IC=+0.303 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.917 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.325 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.566` → IC=+0.345 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.566 (IC base=+0.270)

- **PATRÓN** `volumen_regimen` < `1.3826` → IC=+0.290 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3826 (IC base=+0.270)

- **PATRÓN** `volumen_pendiente_norm` < `0.1716` → IC=+0.319 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1716 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` < `2.7035` → IC=+0.340 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.7035 (IC base=+0.270)

- **PATRÓN** `libro_liquidez` > `12395.6781` → IC=+0.316 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12395.6781 (IC base=+0.270)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.167 (n=124)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.958` → IC=+0.288 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.958 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.145 (n=412)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.06 (IC base=+0.126)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.354 (n=80)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0053 (IC base=+0.286)

- **PATRÓN** `drift_60min` |x|≤ `0.0877` → IC=+0.305 (n=80)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0877 (IC base=+0.286)
...
- **PATRÓN** `ibs_20min` < `0.5027` → IC=+0.312 (n=238)
...
- **PATRÓN** `volumen_spike_ratio` < `4.6682` → IC=+0.269 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 4.6682 (IC base=+0.286)

- **PATRÓN** `volumen_spike_ratio` > `2.9764` → IC=+0.272 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9764 (IC base=+0.286)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.291 (n=280)
...
- **PATRÓN** `dist_vwap_pct` > `0.0972` → IC=+0.167 (n=16)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.0972 (IC base=-0.020)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.439` → IC=+0.144 (n=57)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 8.439 (IC base=-0.029)

- **PATRÓN** `volumen_regimen` < `0.7863` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.7863 (IC base=-0.029)
...
- **PATRÓN** `ibs_20min` > `0.9444` → IC=+0.235 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9444 (IC base=+0.050)

- **PATRÓN** `dist_vwap_pct` > `0.1197` → IC=+0.161 (n=169)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1197 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.215` → IC=+0.127 (n=1018)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 2.215 (IC base=+0.050)

- **PATRÓN** `volumen_pendiente_norm` > `0.3396` → IC=+0.194 (n=106)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.3396 (IC base=+0.050)

- **PATRÓN** `volumen_spike_ratio` > `2.2038` → IC=+0.154 (n=446)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.2038 (IC base=+0.050)

- **PATRÓN** `ballena_activa_n` < `38.0` → IC=+0.263 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 38.0 (IC base=+0.050)

- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.166 (n=866)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.382` → IC=+0.169 (n=125)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 3.382 (IC base=-0.013)
...
- **PATRÓN** `volumen_spike_ratio` > `2.317` → IC=+0.190 (n=27)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.317 (IC base=-0.013)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8827 (IC base=-0.012)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0601` → IC=+0.208 (n=118)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0601 (IC base=+0.176)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1395` → IC=+0.185 (n=255)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1395 (IC base=+0.176)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0881` → IC=+0.164 (n=120)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.0881 (IC base=+0.176)

- **PATRÓN** `volumen_spike_ratio` > `3.8995` → IC=+0.198 (n=124)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 3.8995 (IC base=+0.176)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.193 (n=385)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.06 (IC base=+0.176)

- **PATRÓN** `libro_liquidez` > `1915.1084` → IC=+0.205 (n=161)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.409 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.371)

- **PATRÓN** `drift_60min` |x|≤ `0.1839` → IC=+0.373 (n=108)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1839 (IC base=+0.371)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.397 (n=153)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.371)

- **PATRÓN** `ibs_20min` < `0.2414` → IC=+0.389 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2414 (IC base=+0.371)

- **PATRÓN** `volumen_pendiente_norm` < `0.3211` → IC=+0.392 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.3211 (IC base=+0.371)

- **PATRÓN** `volumen_pendiente_norm` > `0.1384` → IC=+0.400 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1384 (IC base=+0.371)

- **PATRÓN** `volumen_spike_ratio` < `2.9702` → IC=+0.439 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.9702 (IC base=+0.371)

- **PATRÓN** `libro_liquidez` > `1869.9762` → IC=+0.429 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1869.9762 (IC base=+0.371)
...
- **FILTRO** `ibs_20min` < `0.4545` → IC=-0.149 (n=146)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4545
  - _Potencial_: sin este filtro IC_bueno=+0.122 (n=146)
...
- **PATRÓN** `ibs_20min` > `0.4545` → IC=+0.122 (n=146)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` > 0.4545 (IC base=-0.014)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0897` → IC=+0.154 (n=134)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0897 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.143 (n=113)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9048` → IC=+0.226 (n=202)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9048 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.3235` → IC=+0.214 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3235 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.12` → IC=+0.224 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.12 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `0.5938` → IC=+0.149 (n=303)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.5938 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.3138` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3138 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.1447` → IC=+0.123 (n=165)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` > 2.1447 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.149 (n=306)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `2467.2556` → IC=+0.137 (n=271)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2467.2556 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.299 (n=277)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.285)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.328 (n=143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.285)

- **PATRÓN** `ibs_20min` < `0.3182` → IC=+0.337 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3182 (IC base=+0.285)

- **PATRÓN** `dist_vwap_pct` > `0.5452` → IC=+0.375 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5452 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.238` → IC=+0.286 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.238 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.001` → IC=+0.288 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.001 (IC base=+0.285)

- **PATRÓN** `volumen_regimen` > `0.7044` → IC=+0.306 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7044 (IC base=+0.285)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.379 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2891 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `3.5418` → IC=+0.318 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5418 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `2855.6732` → IC=+0.290 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2855.6732 (IC base=+0.285)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.154 (n=431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0047 (IC base=+0.139)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.191 (n=584)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0066 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=448)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 17.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.180 (n=483)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 6.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.9211` → IC=+0.252 (n=857)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9211 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.1207` → IC=+0.148 (n=376)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.1207 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.935` → IC=+0.267 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.935 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1821` → IC=+0.143 (n=667)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1821 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.6258` → IC=+0.142 (n=666)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6258 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1106` → IC=+0.155 (n=430)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1106 (IC base=+0.139)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.146 (n=1449)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.06 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `2695.6908` → IC=+0.177 (n=429)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2695.6908 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.219 (n=1238)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.2358` → IC=+0.223 (n=1090)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2358 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.257 (n=586)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` < `0.375` → IC=+0.280 (n=1240)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.277` → IC=+0.215 (n=1227)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.277 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` < `1.2477` → IC=+0.191 (n=962)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.2477 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.201 (n=641)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0477` → IC=+0.228 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0477 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `3.1117` → IC=+0.248 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.1117 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.279 (n=134)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1492` → IC=+0.149 (n=72)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.1492 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.08` → IC=+0.166 (n=348)
...
- **PATRÓN** `sigma_h` < `0.002` → IC=+0.276 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.002 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.284 (n=35)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0034 (IC base=+0.223)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.269 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.223)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.309 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.223)

- **PATRÓN** `dist_vwap_pct` > `0.2977` → IC=+0.296 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2977 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.767` → IC=+0.290 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.767 (IC base=+0.223)

- **PATRÓN** `volumen_regimen` < `1.3738` → IC=+0.229 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.3738 (IC base=+0.223)

- **PATRÓN** `volumen_regimen` > `0.9006` → IC=+0.236 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9006 (IC base=+0.223)

- **PATRÓN** `volumen_pendiente_norm` > `0.196` → IC=+0.286 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.196 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` < `1.4774` → IC=+0.250 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4774 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `1.9813` → IC=+0.255 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9813 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `11817.8916` → IC=+0.338 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11817.8916 (IC base=+0.223)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.147 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0056 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.168 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0065 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.147` → IC=+0.153 (n=200)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.147 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.158 (n=118)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2311` → IC=+0.125 (n=238)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_pendiente_norm` < 0.2311 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.0094` → IC=+0.201 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0094 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `3.8668` → IC=+0.149 (n=109)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 3.8668 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=230)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `1970.8484` → IC=+0.157 (n=100)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 1970.8484 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.333 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.310)

- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.307 (n=133)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0053 (IC base=+0.310)

- **PATRÓN** `drift_60min` |x|≤ `0.1706` → IC=+0.363 (n=100)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1706 (IC base=+0.310)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.329 (n=103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.310)

- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.342 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.25 (IC base=+0.310)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.746` → IC=+0.353 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.746 (IC base=+0.310)

- **PATRÓN** `volumen_pendiente_norm` > `0.3448` → IC=+0.364 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3448 (IC base=+0.310)

- **PATRÓN** `volumen_spike_ratio` < `3.417` → IC=+0.308 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.417 (IC base=+0.310)

- **PATRÓN** `volumen_spike_ratio` > `2.1697` → IC=+0.312 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1697 (IC base=+0.310)

- **PATRÓN** `libro_liquidez` > `1915.1084` → IC=+0.308 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1915.1084 (IC base=+0.310)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.318 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0021 (IC base=+0.254)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.258 (n=60)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0029 (IC base=+0.254)

- **PATRÓN** `drift_60min` |x|≤ `0.1718` → IC=+0.309 (n=61)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1718 (IC base=+0.254)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.259 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7638` → IC=+0.304 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7638 (IC base=+0.254)

- **PATRÓN** `dist_vwap_pct` < `0.3636` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3636 (IC base=+0.254)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.807` → IC=+0.403 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.807 (IC base=+0.254)

- **PATRÓN** `volumen_regimen` > `0.6636` → IC=+0.283 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6636 (IC base=+0.254)

- **PATRÓN** `volumen_pendiente_norm` > `0.114` → IC=+0.292 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.114 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` < `1.6992` → IC=+0.295 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6992 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` > `2.5456` → IC=+0.275 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5456 (IC base=+0.254)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.255 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.254)

- **PATRÓN** `libro_liquidez` > `2543.553` → IC=+0.261 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2543.553 (IC base=+0.254)
...
- **FILTRO** `ibs_20min` > `0.5588` → IC=-0.235 (n=81)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.224 (n=244)

- **PATRÓN** `ibs_20min` > `0.8667` → IC=+0.175 (n=152)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.8667 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.4` → IC=+0.194 (n=70)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 7.4 (IC base=+0.043)
...
- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.224 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.5824` → IC=+0.144 (n=43)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.5824 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.906` → IC=+0.250 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.906 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.148 (n=163)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.8699 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.1182` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1182 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `1.5471` → IC=+0.144 (n=116)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.5471 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2407.6604` → IC=+0.238 (n=82)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2105` → IC=+0.142 (n=216)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.2105 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.173 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 7.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.229 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.3045` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3045 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.0667` → IC=+0.137 (n=169)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.0667 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.308` → IC=+0.227 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.308 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `1.1205` → IC=+0.141 (n=246)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1205 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.6045` → IC=+0.125 (n=246)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.6045 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2721` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.2721 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `3.0538` → IC=+0.129 (n=211)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 3.0538 (IC base=+0.123)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.130 (n=252)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `2469.502` → IC=+0.135 (n=220)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2469.502 (IC base=+0.123)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.282 (n=232)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.267)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.276 (n=235)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.267)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.289 (n=88)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.267)
...
- **PATRÓN** `ibs_20min` < `0.2353` → IC=+0.321 (n=232)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2353 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` > `0.4019` → IC=+0.333 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4019 (IC base=+0.267)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2721` → IC=+0.342 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2721 (IC base=+0.267)

- **PATRÓN** `volumen_spike_ratio` > `1.659` → IC=+0.259 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.659 (IC base=+0.267)

- **PATRÓN** `libro_liquidez` > `2658.9572` → IC=+0.277 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2658.9572 (IC base=+0.267)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.215 (n=114)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.049)

- **PATRÓN** `ibs_20min` > `0.9601` → IC=+0.173 (n=108)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.9601 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.863` → IC=+0.253 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.863 (IC base=+0.049)

- **PATRÓN** `volumen_pendiente_norm` > `0.181` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.181 (IC base=+0.049)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.285 (n=63)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.057)

- **PATRÓN** `ibs_20min` < `0.3636` → IC=+0.122 (n=162)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.3636 (IC base=+0.057)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.079` → IC=+0.239 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.079 (IC base=+0.057)

- **PATRÓN** `volumen_spike_ratio` < `2.6304` → IC=+0.126 (n=113)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.6304 (IC base=+0.057)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **FILTRO** `ibs_20min` < `0.3944` → IC=-0.292 (n=22)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.195 (n=520)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0068 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=593)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 17.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.9625` → IC=+0.280 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9625 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` > `0.3511` → IC=+0.182 (n=174)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3511 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.252` → IC=+0.231 (n=1048)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.252 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.1809` → IC=+0.136 (n=369)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.1809 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `1.6907` → IC=+0.121 (n=1121)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` > 1.6907 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.125 (n=1746)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.06 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2737.2776` → IC=+0.157 (n=520)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2737.2776 (IC base=+0.119)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.181 (n=183)

  - _Acción_: Kelly boost +0.91€ cuando `ballena_activa_n` < 142.0 (IC base=+0.119)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.232 (n=1220)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.225)

- **PATRÓN** `sigma_h` > `0.0038` → IC=+0.231 (n=1384)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0038 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.235 (n=1272)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.225)

- **PATRÓN** `ibs_20min` < `0.5` → IC=+0.287 (n=1386)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` < `0.1568` → IC=+0.199 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1568 (IC base=+0.225)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.485` → IC=+0.227 (n=1294)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.485 (IC base=+0.225)

- **PATRÓN** `volumen_regimen` < `0.6189` → IC=+0.206 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6189 (IC base=+0.225)

- **PATRÓN** `volumen_regimen` > `1.0614` → IC=+0.217 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0614 (IC base=+0.225)

- **PATRÓN** `volumen_pendiente_norm` < `0.113` → IC=+0.249 (n=619)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.113 (IC base=+0.225)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.269 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.225)

- **PATRÓN** `volumen_spike_ratio` < `2.0228` → IC=+0.273 (n=464)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0228 (IC base=+0.225)
...
- **PATRÓN** `ibs_20min` > `0.9463` → IC=+0.290 (n=179)
...
- **PATRÓN** `libro_spread` < `0.06` → IC=+0.162 (n=285)

  - _Acción_: Kelly boost +0.81€ cuando `libro_spread` < 0.06 (IC base=+0.129)
...
- **FILTRO** `ibs_20min` < `0.4245` → IC=-0.176 (n=66)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.283 (n=136)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.164 (n=102)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0026 (IC base=+0.132)

- **PATRÓN** `sigma_h` > `0.0034` → IC=+0.185 (n=52)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0034 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.292 (n=51)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` > `0.4245` → IC=+0.283 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4245 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.3609` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3609 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.779` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.779 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.6608` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.6608 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.1082` → IC=+0.176 (n=69)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.1082 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` < `0.1037` → IC=+0.190 (n=98)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1037 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `2.8379` → IC=+0.232 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.8379 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `8878.5012` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8878.5012 (IC base=+0.132)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.365 (n=87)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5421` → IC=+0.339 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5421 (IC base=+0.277)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.674` → IC=+0.278 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.674 (IC base=+0.277)
...
- **PATRÓN** `volumen_spike_ratio` < `3.6549` → IC=+0.262 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.6549 (IC base=+0.277)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.300 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.277)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 20.0 (IC base=+0.277)

### GBM_LATE_15M_TARDIO#ETH#15min
- **FILTRO** `ibs_20min` < `0.3557` → IC=-0.222 (n=52)

  - _Acción_: SKIP cuando `ibs_20min` < 0.3557
  - _Potencial_: sin este filtro IC_bueno=+0.211 (n=157)
...
- **PATRÓN** `ibs_20min` > `0.3557` → IC=+0.211 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3557 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.4333` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4333 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.292` → IC=+0.207 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.292 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `0.7759` → IC=+0.162 (n=69)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.7759 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.1862` → IC=+0.136 (n=53)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 1.1862 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.4389` → IC=+0.219 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4389 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `7163.2603` → IC=+0.257 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7163.2603 (IC base=+0.102)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.237 (n=116)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0032 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.0556` → IC=+0.207 (n=39)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0556 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 6.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` < `0.3087` → IC=+0.240 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3087 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2052` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2052 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.578` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.578 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `0.8934` → IC=+0.202 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8934 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.1407` → IC=+0.324 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1407 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `2.2709` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2709 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.281 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4416 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `7056.133` → IC=+0.232 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7056.133 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 128.0 (IC base=+0.154)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.195 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0063 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.0717` → IC=+0.192 (n=102)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.0717 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.175 (n=118)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.181 (n=111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 6.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.250 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` > `0.3315` → IC=+0.250 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3315 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.293` → IC=+0.217 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.293 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `0.6753` → IC=+0.140 (n=273)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6753 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.1933` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1933 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.7654` → IC=+0.129 (n=230)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.7654 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=312)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `2476.2054` → IC=+0.140 (n=273)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2476.2054 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `38.0` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 38.0 (IC base=+0.131)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.287 (n=350)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0073 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.281 (n=322)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.261)

- **PATRÓN** `ibs_20min` < `0.187` → IC=+0.364 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.187 (IC base=+0.261)

- **PATRÓN** `dist_vwap_pct` > `0.3857` → IC=+0.351 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3857 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.869` → IC=+0.322 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.869 (IC base=+0.261)

- **PATRÓN** `volumen_regimen` > `0.8819` → IC=+0.300 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8819 (IC base=+0.261)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.333 (n=40)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6958` → IC=+0.281 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6958 (IC base=+0.261)

- **PATRÓN** `libro_liquidez` > `2832.6472` → IC=+0.265 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2832.6472 (IC base=+0.261)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.234 (n=62)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.160 (n=51)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 15.0 (IC base=+0.018)
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.283 (n=21)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.214)

- **PATRÓN** `py_entrada` < `0.505` → IC=+0.300 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.505 (IC base=+0.214)
...
- **PATRÓN** `ibs_20min` < `0.9585` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.9585 (IC base=+0.087)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.200 (n=18)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.057)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0441` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `drift_20min_pct` |x|≤ 0.0441 (IC base=+0.057)

- **PATRÓN** `ibs_20min` > `0.1002` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.1002 (IC base=+0.057)
...
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.167 (n=19)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 19.0 (IC base=+0.110)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.227 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.110)

- **PATRÓN** `drift_20min_pct` |x|≤ `0.0655` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `drift_20min_pct` |x|≤ 0.0655 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `15323.3068` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15323.3068 (IC base=+0.110)

### MOMENTUM_IBS_15M#SOL#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=20)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.009)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `hora_utc` > `19.0` → IC=-0.136 (n=97)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=332)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.223 (n=207)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=222)

- **FILTRO** `ibs_20min` < `0.7235` → IC=-0.252 (n=107)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7235
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=322)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.206 (n=107)
...
- **FILTRO** `ibs_20min` > `0.9273` → IC=-0.167 (n=16)
...
- **FILTRO** `hora_utc` > `19.0` → IC=-0.265 (n=15)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 19.0
...
- **FILTRO** `libro_liquidez` < `15643.6833` → IC=-0.194 (n=47)
...
- **FILTRO** `ibs_20min` < `0.8592` → IC=-0.132 (n=36)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8592
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.051)
...
- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.237 (n=17)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=52)

- **FILTRO** `libro_liquidez` < `11699.3594` → IC=-0.160 (n=45)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.180 (n=23)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 8.0 (IC base=+0.048)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.167 (n=37)
...
- **FILTRO** `libro_liquidez` < `2537.1559` → IC=-0.160 (n=51)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.145 (n=29)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `py_entrada` < 0.5 (IC base=+0.013)

- **PATRÓN** `libro_liquidez` > `2677.2264` → IC=+0.179 (n=26)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2677.2264 (IC base=+0.013)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.283 (n=288)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=905)

- **FILTRO** `ibs_7min` < `0.7248` → IC=-0.240 (n=298)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7248
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=895)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.197 (n=295)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=898)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.197 (n=318)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=978)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.238 (n=59)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=130)

- **FILTRO** `ibs_7min` < `0.8533` → IC=-0.219 (n=94)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8533
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=95)

- **FILTRO** `ballena_activa_n` > `4.0` → IC=-0.225 (n=89)

  - _Acción_: SKIP cuando `ballena_activa_n` > 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=100)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.204 (n=42)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=138)

- **FILTRO** `drift_7min_pct` |x|> `0.0988` → IC=-0.151 (n=61)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.277 (n=83)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.064 (n=76)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.315 (n=52)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.260 (n=48)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.041 (n=181)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.151 (n=81)

  - _Acción_: Kelly boost +0.75€ cuando `py_entrada` < 0.5 (IC base=-0.024)
...
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.123 (n=59)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` < 13.0 (IC base=+0.060)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=701)
...
- **FILTRO** `ibs_15` < `0.5714` → IC=-0.155 (n=137)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.224 (n=284)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.124 (n=139)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0036 (IC base=+0.101)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.124 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` > 0.0047 (IC base=+0.101)

- **PATRÓN** `ibs_15` > `0.5714` → IC=+0.224 (n=284)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5714 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` > `0.3516` → IC=+0.182 (n=86)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.3516 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.021` → IC=+0.227 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.021 (IC base=+0.101)

- **PATRÓN** `ibs_15` < `0.4561` → IC=+0.121 (n=389)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` < 0.4561 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.4863` → IC=+0.157 (n=68)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.4863 (IC base=+0.081)
...
- **PATRÓN** `sigma_h` > `0.002` → IC=+0.142 (n=65)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.002 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.1916` → IC=+0.140 (n=73)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.1916 (IC base=+0.122)

- **PATRÓN** `drift_15min` |x|≤ `0.3897` → IC=+0.147 (n=32)

  - _Acción_: Kelly boost +0.74€ cuando `drift_15min` |x|≤ 0.3897 (IC base=+0.122)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0878` → IC=+0.127 (n=65)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.63€ cuando `delta_ratio_macro` |x|> 0.0878 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.167 (n=70)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 4.0 (IC base=+0.122)

- **PATRÓN** `ibs_15` > `0.9676` → IC=+0.231 (n=24)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9676 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` > `0.3722` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3722 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.1019` → IC=+0.191 (n=40)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.1019 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.029` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 7.029 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `18.708` → IC=+0.135 (n=72)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 18.708 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `8349.505` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8349.505 (IC base=+0.122)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.017` → IC=+0.139 (n=70)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.69€ cuando `pct_spot_vs_ref` |x|≤ 0.017 (IC base=+0.079)

- **PATRÓN** `sigma_h` < `0.0019` → IC=+0.188 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0019 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.444` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.444 (IC base=+0.079)

- **PATRÓN** `libro_liquidez` > `11028.905` → IC=+0.132 (n=93)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 11028.905 (IC base=+0.079)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.149 (n=35)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0026 (IC base=+0.138)

- **PATRÓN** `sigma_h` > `0.004` → IC=+0.181 (n=70)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.004 (IC base=+0.138)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1155` → IC=+0.139 (n=95)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.70€ cuando `delta_ratio_macro` |x|> 0.1155 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.146 (n=94)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3424` → IC=+0.164 (n=105)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.82€ cuando `ibs_15` < 0.3424 (IC base=+0.138)

- **PATRÓN** `ibs_15` > `0.0292` → IC=+0.182 (n=105)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` > 0.0292 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.4698` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4698 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` < `22.914` → IC=+0.189 (n=104)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 22.914 (IC base=+0.138)
...
- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.214 (n=33)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0021 (IC base=+0.070)

- **PATRÓN** `drift_15min` |x|≤ `0.2772` → IC=+0.154 (n=50)

  - _Acción_: Kelly boost +0.77€ cuando `drift_15min` |x|≤ 0.2772 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `1.0` → IC=+0.143 (n=40)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 1.0 (IC base=+0.070)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.3095` → IC=+0.156 (n=30)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.3095 (IC base=+0.033)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.180 (n=23)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 4.0 (IC base=+0.033)

- **PATRÓN** `ibs_15` < `0.1034` → IC=+0.250 (n=30)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1034 (IC base=+0.033)
...
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.156 (n=91)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.0063 (IC base=+0.109)

- **PATRÓN** `drift_60min` |x|≤ `0.1583` → IC=+0.198 (n=61)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1583 (IC base=+0.109)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0793` → IC=+0.147 (n=137)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.74€ cuando `delta_ratio_macro` |x|> 0.0793 (IC base=+0.109)

- **PATRÓN** `hora_utc` < `19.0` → IC=+0.133 (n=137)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 19.0 (IC base=+0.109)

- **PATRÓN** `ibs_15` < `0.2353` → IC=+0.181 (n=92)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.2353 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.311` → IC=+0.235 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.311 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.393` → IC=+0.152 (n=116)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 5.393 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2603.9534` → IC=+0.153 (n=122)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 2603.9534 (IC base=+0.109)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1934` → IC=+0.263 (n=74)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1934 (IC base=+0.252)
...
- **PATRÓN** `sigma_h` > `0.0032` → IC=+0.250 (n=38)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0032 (IC base=+0.252)

- **PATRÓN** `drift_60min` |x|≤ `0.1599` → IC=+0.276 (n=74)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1599 (IC base=+0.252)

- **PATRÓN** `drift_15min` |x|≤ `0.4089` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4089 (IC base=+0.252)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0706` → IC=+0.259 (n=85)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0706 (IC base=+0.252)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.333 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.252)

- **PATRÓN** `ibs_15` > `0.7078` → IC=+0.302 (n=84)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7078 (IC base=+0.252)

- **PATRÓN** `dist_vwap_pct` > `0.3609` → IC=+0.367 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3609 (IC base=+0.252)

- **PATRÓN** `dist_vwap_pct` < `0.0842` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0842 (IC base=+0.252)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.495` → IC=+0.288 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.495 (IC base=+0.252)

- **PATRÓN** `libro_liquidez` > `3208.0074` → IC=+0.266 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3208.0074 (IC base=+0.252)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2095` → IC=+0.254 (n=55)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2095 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.254 (n=55)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.216)

- **PATRÓN** `drift_60min` |x|≤ `0.1514` → IC=+0.240 (n=48)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1514 (IC base=+0.216)

- **PATRÓN** `drift_15min` |x|≤ `0.6311` → IC=+0.237 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6311 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.250 (n=54)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.216)

- **PATRÓN** `ibs_15` < `0.9942` → IC=+0.219 (n=55)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.9942 (IC base=+0.216)

- **PATRÓN** `ibs_15` > `0.9024` → IC=+0.263 (n=36)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9024 (IC base=+0.216)

- **PATRÓN** `dist_vwap_pct` > `0.3017` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3017 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.854` → IC=+0.222 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.854 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` < `15.813` → IC=+0.235 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 15.813 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `7152.8647` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7152.8647 (IC base=+0.216)
...
- **FILTRO** `ibs_15` < `0.3768` → IC=-0.323 (n=77)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.154 (n=157)

- **FILTRO** `sigma_ewma_delta_pct` > `12.832` → IC=-0.152 (n=228)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 12.832
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=934)

- **PATRÓN** `ibs_15` > `0.3768` → IC=+0.154 (n=157)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` > 0.3768 (IC base=-0.044)
...
- **FILTRO** `sigma_h` > `0.0033` → IC=-0.227 (n=86)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0033
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.253 (n=79)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.171 (n=174)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.214 (n=54)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
...
- **FILTRO** `hora_utc` > `7.0` → IC=-0.160 (n=95)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.288 (n=50)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0033 (IC base=+0.250)

- **PATRÓN** `drift_60min` |x|≤ `0.1815` → IC=+0.259 (n=110)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1815 (IC base=+0.250)

- **PATRÓN** `drift_15min` |x|≤ `0.625` → IC=+0.258 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.625 (IC base=+0.250)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0673` → IC=+0.268 (n=110)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0673 (IC base=+0.250)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.296 (n=101)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.250)

- **PATRÓN** `ibs_15` > `0.9358` → IC=+0.327 (n=73)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9358 (IC base=+0.250)

- **PATRÓN** `dist_vwap_pct` > `0.3722` → IC=+0.311 (n=35)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.98` → IC=+0.265 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.98 (IC base=+0.250)

### UPDOWN_GBM_IBS_ALTO#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.2` → IC=+0.268 (n=67)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.2 (IC base=+0.236)

- **PATRÓN** `sigma_h` < `0.003` → IC=+0.239 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.003 (IC base=+0.236)

- **PATRÓN** `sigma_h` > `0.0022` → IC=+0.258 (n=60)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0022 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1826` → IC=+0.268 (n=67)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1826 (IC base=+0.236)

- **PATRÓN** `drift_15min` |x|≤ `0.6581` → IC=+0.254 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6581 (IC base=+0.236)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0878` → IC=+0.242 (n=60)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0878 (IC base=+0.236)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.294 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.236)

- **PATRÓN** `ibs_15` < `0.9998` → IC=+0.243 (n=68)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.9998 (IC base=+0.236)

- **PATRÓN** `ibs_15` > `0.9356` → IC=+0.287 (n=45)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9356 (IC base=+0.236)

- **PATRÓN** `dist_vwap_pct` > `0.3682` → IC=+0.370 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3682 (IC base=+0.236)

- **PATRÓN** `dist_vwap_pct` < `0.0966` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0966 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` > `27.672` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 27.672 (IC base=+0.236)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.495` → IC=+0.245 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.495 (IC base=+0.236)

- **PATRÓN** `libro_liquidez` > `5486.381` → IC=+0.266 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5486.381 (IC base=+0.236)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.305 (n=39)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0027 (IC base=+0.263)

- **PATRÓN** `drift_15min` |x|≤ `0.3977` → IC=+0.265 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3977 (IC base=+0.263)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1796` → IC=+0.409 (n=20)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1796 (IC base=+0.263)
...
- **PATRÓN** `ibs_15` > `0.978` → IC=+0.409 (n=20)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.978 (IC base=+0.263)

- **PATRÓN** `dist_vwap_pct` > `0.2663` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2663 (IC base=+0.263)

- **PATRÓN** `dist_vwap_pct` < `0.0769` → IC=+0.315 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.0769 (IC base=+0.263)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.209` → IC=+0.281 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 16.209 (IC base=+0.263)
...
- **H-IBS-UPDOWN_GBM#SOL#5min**: dentro de BUY_NO, IBS < 0.1034 sube el IC de +0.033 a +0.250 en UPDOWN_GBM#SOL#5min (n=30). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5714 sube el IC de +0.101 a +0.224 en UPDOWN_GBM#15min (n=284). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.9676 sube el IC de +0.122 a +0.231 en UPDOWN_GBM#BTC#15min (n=24). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS < 0.3424 sube el IC de +0.138 a +0.164 en UPDOWN_GBM#ETH#15min (n=105). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_NO, IBS > 0.0292 sube el IC de +0.138 a +0.182 en UPDOWN_GBM#ETH#15min (n=105). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.2353 sube el IC de +0.109 a +0.181 en UPDOWN_GBM#XRP#15min (n=92). Ya aplicado como kelly_boost=+0.90€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0