# Hipótesis automáticas — 2026-09-20 19:39 UTC
_Generado por shadow_postmortem.py sobre 530709 resoluciones (PNL=+58770.55€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=467)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.255 (n=467)
...
- **PATRÓN** `banda_hit_calibrado` > `0.804` → IC=+0.260 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.804 (IC base=+0.132)

- **PATRÓN** `banda_z` > `4.287` → IC=+0.161 (n=502)

  - _Acción_: Kelly boost +0.80€ cuando `banda_z` > 4.287 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.147 (n=352)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=535)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `2870.3252` → IC=+0.144 (n=335)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2870.3252 (IC base=+0.132)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.264 (n=366)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.264 (n=366)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.93` → IC=-0.237 (n=6432)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.93
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19296)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.4` → IC=-0.243 (n=877)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.4
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2633)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `494.42` → IC=-0.153 (n=344)
...
- **FILTRO** `restante_s_al_confirmar` < `133.5` → IC=-0.276 (n=775)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=2328)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `160.39` → IC=-0.231 (n=1517)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.39
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4551)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.38` → IC=-0.366 (n=1271)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.38
  - _Potencial_: sin este filtro IC_bueno=-0.117 (n=3815)
...
- **FILTRO** `py_entrada` > `0.54` → IC=-0.177 (n=215)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.182 (n=64)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.236 (n=9857)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5290)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `1661.6674` → IC=+0.159 (n=5960)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1661.6674 (IC base=+0.131)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.211 (n=1330)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1924)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `15659.1031` → IC=+0.235 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15659.1031 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.151 (n=322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` < 7.0 (IC base=+0.115)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.152 (n=2584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.335 (n=848)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.255 (n=491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.244 (n=1376)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.237)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.145 (n=421)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=693)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `1297.853` → IC=+0.147 (n=601)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 1297.853 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.224 (n=650)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.86` → IC=+0.429 (n=577)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=10357)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3581)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.181 (n=2544)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.74 (IC base=+0.170)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=2422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.192 (n=1755)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.200 (n=30725)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11536)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=6263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5716)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.71 (IC base=+0.174)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=5492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=2752)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.263 (n=1943)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.220)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.210 (n=5086)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.252 (n=2566)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.205)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.195 (n=5140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.252 (n=2029)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.192)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.201 (n=4701)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.121)

- **PATRÓN** `restante_min` < `4.12` → IC=+0.131 (n=4329)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 4.12 (IC base=+0.121)

- **PATRÓN** `restante_min` > `4.95` → IC=+0.146 (n=4495)
...
- **PATRÓN** `lag_apertura_s` < `3.56` → IC=+0.146 (n=2129)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.56 (IC base=+0.125)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=2323)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.117)

- **PATRÓN** `restante_min` < `4.16` → IC=+0.127 (n=2164)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.16 (IC base=+0.117)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.144 (n=2286)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` > 4.96 (IC base=+0.117)

- **PATRÓN** `lag_apertura_s` < `2.35` → IC=+0.147 (n=2163)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 2.35 (IC base=+0.117)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.317 (n=724)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.289)

- **PATRÓN** `py_entrada` > `0.815` → IC=+0.384 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.289)

- **PATRÓN** `libro_liquidez` > `1583.3801` → IC=+0.295 (n=1022)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1583.3801 (IC base=+0.289)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.293 (n=317)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.273)

- **PATRÓN** `py_entrada` > `0.805` → IC=+0.336 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.805 (IC base=+0.273)

- **PATRÓN** `libro_liquidez` > `4195.4603` → IC=+0.290 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4195.4603 (IC base=+0.273)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.332 (n=344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1483.2932` → IC=+0.311 (n=438)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.445 (n=473)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.440 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.935 (IC base=+0.436)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.443 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.436)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.438 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.436)

- **PATRÓN** `libro_liquidez` > `1835.6869` → IC=+0.440 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1835.6869 (IC base=+0.436)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3537` → IC=+0.126 (n=6299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3537 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9808` → IC=+0.242 (n=2386)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9808 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.208` → IC=+0.247 (n=1528)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.208 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.917` → IC=+0.174 (n=2760)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.917 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.2117` → IC=+0.246 (n=1886)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2117 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.0517` → IC=+0.243 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0517 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.3076` → IC=+0.211 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3076 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9158` → IC=+0.205 (n=3220)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9158 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5702` → IC=+0.132 (n=8652)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5702 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5657` → IC=+0.197 (n=588)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5657 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1421` → IC=+0.172 (n=2693)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1421 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7022` → IC=+0.176 (n=1296)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7022 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.173 (n=1964)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8706 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.225 (n=1425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5842` → IC=+0.201 (n=4378)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5842 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `144.0` → IC=+0.211 (n=4684)
...
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.176 (n=544)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0081 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3383` → IC=+0.169 (n=1625)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3383 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.168 (n=792)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.274 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.047` → IC=+0.274 (n=705)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.047 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2803` → IC=+0.212 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2803 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.167 (n=1510)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.246 (n=1063)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.233)

- **PATRÓN** `drift_60min` |x|≤ `0.0888` → IC=+0.289 (n=397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0888 (IC base=+0.233)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.245 (n=814)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.233)

- **PATRÓN** `ibs_20min` < `0.0613` → IC=+0.298 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0613 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.381` → IC=+0.248 (n=1247)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.381 (IC base=+0.233)

- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.271 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2765 (IC base=+0.233)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.253 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.233)

- **PATRÓN** `libro_liquidez` > `1774.82` → IC=+0.244 (n=792)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1774.82 (IC base=+0.233)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.236 (n=540)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.0838` → IC=+0.254 (n=409)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0838 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.7303` → IC=+0.246 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7303 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.1859` → IC=+0.217 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1859 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.5623` → IC=+0.216 (n=1290)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5623 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.867` → IC=+0.242 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.867 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2524` → IC=+0.221 (n=1227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2524 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8723` → IC=+0.213 (n=818)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8723 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0746` → IC=+0.221 (n=499)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0746 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.403` → IC=+0.224 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.403 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3807` → IC=+0.216 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3807 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `15821.8878` → IC=+0.224 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15821.8878 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.174 (n=433)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0026 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.162 (n=430)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=510)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6835` → IC=+0.166 (n=1289)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6835 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.1248` → IC=+0.151 (n=1160)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1248 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.294` → IC=+0.160 (n=210)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 11.294 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.146 (n=1289)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2046 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.135 (n=859)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.8523 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.1566` → IC=+0.172 (n=346)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1566 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.147 (n=1180)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.7701` → IC=+0.143 (n=786)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.7701 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `413.0` → IC=+0.143 (n=1096)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 413.0 (IC base=+0.134)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.202 (n=1055)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=1580)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.017` → IC=+0.240 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.017 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.1055` → IC=+0.190 (n=1353)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1055 (IC base=+0.184)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9235` → IC=+0.206 (n=676)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9235 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1043)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.223 (n=1346)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.218)

- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.221 (n=1202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0065 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.259 (n=509)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.218)

- **PATRÓN** `ibs_20min` < `0.0643` → IC=+0.242 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0643 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.554` → IC=+0.237 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.554 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.219 (n=1473)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.394 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3632` → IC=+0.272 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3632 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2814` → IC=+0.229 (n=811)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2814 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.232 (n=836)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1862.8007` → IC=+0.229 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.8007 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.228 (n=791)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=1988)

- **PATRÓN** `ibs_20min` > `0.9396` → IC=+0.202 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9396 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3391` → IC=+0.355 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3391 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` < `0.669` → IC=+0.326 (n=303)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.669 (IC base=+0.019)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.619` → IC=+0.149 (n=628)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 4.619 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `0.6001` → IC=+0.353 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6001 (IC base=+0.019)

- **PATRÓN** `volumen_pendiente_norm` < `0.1662` → IC=+0.324 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1662 (IC base=+0.019)

- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.346 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2917 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` < `1.391` → IC=+0.348 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.391 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` > `2.177` → IC=+0.331 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.177 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.339 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 167.0 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3065` → IC=+0.171 (n=220)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.3065 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.8577` → IC=+0.151 (n=474)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.8577 (IC base=+0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2244` → IC=+0.237 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2244 (IC base=+0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5133` → IC=+0.179 (n=587)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.5133 (IC base=+0.009)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `hora_utc` < `17.0` → IC=-0.155 (n=56)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=286)

- **FILTRO** `ibs_20min` < `0.375` → IC=-0.170 (n=110)

  - _Acción_: SKIP cuando `ibs_20min` < 0.375
  - _Potencial_: sin este filtro IC_bueno=+0.154 (n=232)

- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1974)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=977)

- **FILTRO** `sigma_ewma_delta_pct` > `8.635` → IC=-0.202 (n=320)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.635
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2631)

- **PATRÓN** `ibs_20min` > `0.7619` → IC=+0.231 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7619 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` > `0.9817` → IC=+0.295 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9817 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` < `0.5471` → IC=+0.269 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5471 (IC base=+0.049)

- **PATRÓN** `volumen_regimen` < `0.6466` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6466 (IC base=+0.049)

- **PATRÓN** `volumen_regimen` > `0.7744` → IC=+0.297 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7744 (IC base=+0.049)

- **PATRÓN** `volumen_pendiente_norm` < `0.0735` → IC=+0.310 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0735 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` < `2.2644` → IC=+0.300 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2644 (IC base=+0.049)

- **PATRÓN** `volumen_spike_ratio` > `1.5596` → IC=+0.258 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5596 (IC base=+0.049)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.298 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 47.0 (IC base=+0.049)

- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.126 (n=977)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2632 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` > `0.6436` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6436 (IC base=-0.044)

- **PATRÓN** `volumen_regimen` < `1.096` → IC=+0.232 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.096 (IC base=-0.044)

- **PATRÓN** `volumen_pendiente_norm` < `0.1008` → IC=+0.230 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1008 (IC base=-0.044)

- **PATRÓN** `volumen_pendiente_norm` > `0.1499` → IC=+0.263 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1499 (IC base=-0.044)

- **PATRÓN** `volumen_spike_ratio` < `2.43` → IC=+0.268 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.43 (IC base=-0.044)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6416` → IC=-0.191 (n=500)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6416
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1504)

- **FILTRO** `ibs_20min` < `0.6915` → IC=-0.159 (n=1322)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6915
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=682)
...
- **FILTRO** `ibs_20min` > `0.7733` → IC=-0.204 (n=745)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7733
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=2237)

- **PATRÓN** `dist_vwap_pct` > `0.9208` → IC=+0.316 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9208 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` < `0.2479` → IC=+0.319 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2479 (IC base=-0.077)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.303 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=-0.077)

- **PATRÓN** `volumen_pendiente_norm` > `0.0772` → IC=+0.296 (n=111)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8487` → IC=+0.298 (n=176)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8487 (IC base=-0.077)

- **PATRÓN** `dist_vwap_pct` > `0.9769` → IC=+0.302 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9769 (IC base=-0.023)

- **PATRÓN** `dist_vwap_pct` < `0.2683` → IC=+0.245 (n=654)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2683 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` < `0.7367` → IC=+0.254 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7367 (IC base=-0.023)

- **PATRÓN** `volumen_regimen` > `1.0811` → IC=+0.295 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0811 (IC base=-0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.1058` → IC=+0.281 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1058 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` < `2.2057` → IC=+0.257 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2057 (IC base=-0.023)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.246 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=-0.023)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=2973)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4671` → IC=+0.186 (n=7963)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4671 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `1.0016` → IC=+0.288 (n=681)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0016 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.547` → IC=+0.152 (n=4235)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.547 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1729` → IC=+0.231 (n=3113)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1729 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.682` → IC=+0.242 (n=2781)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.682 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2985` → IC=+0.260 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2985 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4754` → IC=+0.243 (n=1684)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4754 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.7129` → IC=+0.243 (n=1683)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7129 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.272 (n=4559)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=3011)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5509` → IC=+0.151 (n=7944)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5509 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.676` → IC=+0.242 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.676 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1702` → IC=+0.236 (n=2346)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1702 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7162` → IC=+0.238 (n=1136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7162 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.2001` → IC=+0.245 (n=860)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2001 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.311 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4913` → IC=+0.252 (n=1121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4913 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3513` → IC=+0.261 (n=1524)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3513 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.264 (n=3234)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.493` → IC=-0.164 (n=477)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.493
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1610)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.273 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.675` → IC=+0.199 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.675 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2222` → IC=+0.283 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2222 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `1.4427` → IC=+0.189 (n=249)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.4427 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.1594` → IC=+0.201 (n=339)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1594 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.184 (n=318)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 15.0 (IC base=+0.048)
...
- **FILTRO** `ibs_20min` > `0.8163` → IC=-0.148 (n=652)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8163
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1958)

- **PATRÓN** `ibs_20min` > `0.862` → IC=+0.158 (n=600)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.862 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.2936` → IC=+0.159 (n=315)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.2936 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `1.1952` → IC=+0.143 (n=810)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1952 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `0.6581` → IC=+0.148 (n=723)
...
- **PATRÓN** `ballena_activa_n` < `249.0` → IC=+0.190 (n=343)
...
- **PATRÓN** `volumen_regimen` > `0.6009` → IC=+0.204 (n=485)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4573` → IC=+0.218 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4573 (IC base=-0.001)

- **PATRÓN** `volumen_spike_ratio` > `2.1913` → IC=+0.218 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1913 (IC base=-0.001)

- **PATRÓN** `ballena_activa_n` < `483.0` → IC=+0.204 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 483.0 (IC base=-0.001)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.287 (n=944)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0076 (IC base=+0.245)

- **PATRÓN** `drift_60min` |x|≤ `0.1052` → IC=+0.247 (n=473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1052 (IC base=+0.245)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.246 (n=706)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.576` → IC=+0.277 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.576 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` < `0.1388` → IC=+0.260 (n=1247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1388 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` > `2.9597` → IC=+0.263 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9597 (IC base=+0.245)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=924)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.245)

- **PATRÓN** `libro_liquidez` > `1930.1086` → IC=+0.255 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1930.1086 (IC base=+0.245)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.265 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.306 (n=1005)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.285)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.329 (n=383)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.285)

- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.290 (n=1124)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.884` → IC=+0.303 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.884 (IC base=+0.285)

- **PATRÓN** `volumen_pendiente_norm` > `0.3452` → IC=+0.317 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3452 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` < `1.6234` → IC=+0.291 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6234 (IC base=+0.285)

- **PATRÓN** `volumen_spike_ratio` > `2.2087` → IC=+0.290 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2087 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.297 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `1912.76` → IC=+0.317 (n=374)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1912.76 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.286 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.285)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2689` → IC=-0.200 (n=428)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2689
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1284)

- **FILTRO** `ibs_20min` > `0.7868` → IC=-0.178 (n=533)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7868
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1600)

- **PATRÓN** `ibs_20min` > `0.8045` → IC=+0.158 (n=583)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8045 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.4424` → IC=+0.219 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4424 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.9794` → IC=+0.231 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9794 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.6452` → IC=+0.209 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6452 (IC base=+0.004)

- **PATRÓN** `volumen_pendiente_norm` > `0.2657` → IC=+0.292 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2657 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` < `2.091` → IC=+0.249 (n=376)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.091 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.266 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.1468` → IC=+0.201 (n=172)
...
- **PATRÓN** `volumen_regimen` < `1.1494` → IC=+0.188 (n=338)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 1.1494 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` > `0.6698` → IC=+0.182 (n=338)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6698 (IC base=-0.010)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.290 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=-0.010)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1389` → IC=+0.265 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1389 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.233 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.010)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7021` → IC=-0.209 (n=950)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7021
  - _Potencial_: sin este filtro IC_bueno=+0.272 (n=951)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.230 (n=498)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1498)

- **FILTRO** `sigma_ewma_delta_pct` > `4.657` → IC=-0.175 (n=444)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.657
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=1552)

- **PATRÓN** `ibs_20min` > `0.7021` → IC=+0.272 (n=951)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7021 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` > `0.8059` → IC=+0.345 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8059 (IC base=+0.032)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.152 (n=297)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.295 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8646 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `0.6388` → IC=+0.286 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6388 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` < `0.1047` → IC=+0.289 (n=633)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7981` → IC=+0.304 (n=441)
...
- **PATRÓN** `ibs_20min` < `0.1` → IC=+0.210 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` > `0.8315` → IC=+0.200 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8315 (IC base=+0.012)

- **PATRÓN** `dist_vwap_pct` < `0.2002` → IC=+0.220 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2002 (IC base=+0.012)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.273 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.012)

- **PATRÓN** `volumen_pendiente_norm` < `0.0994` → IC=+0.209 (n=428)
...
- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.348 (n=779)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.274)

- **PATRÓN** `dist_vwap_pct` > `0.9362` → IC=+0.330 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9362 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.464` → IC=+0.300 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.464 (IC base=+0.274)

- **PATRÓN** `volumen_regimen` > `1.0359` → IC=+0.306 (n=529)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4382` → IC=+0.278 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4382 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `2.1738` → IC=+0.290 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1738 (IC base=+0.274)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.278 (n=1224)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.274)

- **PATRÓN** `libro_liquidez` > `2601.1926` → IC=+0.287 (n=777)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2601.1926 (IC base=+0.274)

- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.301 (n=857)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0147 (IC base=+0.271)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.280 (n=584)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2585.317` → IC=+0.277 (n=857)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2585.317 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.172 (n=2348)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.201 (n=2346)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0883` → IC=+0.186 (n=2342)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.0883 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=7348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5824` → IC=+0.217 (n=7025)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5824 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.168` → IC=+0.195 (n=3047)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.168 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.219` → IC=+0.255 (n=1443)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.219 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2143` → IC=+0.161 (n=4644)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2143 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6258` → IC=+0.157 (n=4645)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6258 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2462` → IC=+0.192 (n=1404)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2462 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5652` → IC=+0.172 (n=2952)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5652 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6482` → IC=+0.175 (n=2236)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6482 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3825.7125` → IC=+0.168 (n=2342)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3825.7125 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=5938)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=4481)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0793` → IC=+0.202 (n=2238)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0793 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.208 (n=2259)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.475` → IC=+0.226 (n=6713)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.475 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2242` → IC=+0.159 (n=4929)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2242 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.199 (n=1136)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1764` → IC=+0.151 (n=4896)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1764 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.225 (n=964)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5742` → IC=+0.167 (n=2661)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5742 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2808` → IC=+0.173 (n=2742)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2808 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.171 (n=5681)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.195 (n=405)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0082 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.3327` → IC=+0.206 (n=1210)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3327 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=595)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.049` → IC=+0.308 (n=549)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.049 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.2282` → IC=+0.240 (n=233)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2282 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `1.4334` → IC=+0.182 (n=1111)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.4334 (IC base=+0.184)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0745` → IC=+0.207 (n=346)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0745 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.187 (n=1096)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4163` → IC=+0.229 (n=1037)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4163 (IC base=+0.163)

- **PATRÓN** `dist_vwap_pct` > `0.1987` → IC=+0.216 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1987 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.506` → IC=+0.231 (n=210)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.506 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.169 (n=1037)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.2628 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2352` → IC=+0.196 (n=228)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2352 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `1.414` → IC=+0.206 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.414 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `15757.8757` → IC=+0.170 (n=470)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 15757.8757 (IC base=+0.163)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.194 (n=384)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0025 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.2886` → IC=+0.154 (n=1142)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.2886 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.177 (n=388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 18.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` < `0.5528` → IC=+0.184 (n=1142)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.5528 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1297` → IC=+0.160 (n=1151)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1297 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.882` → IC=+0.211 (n=223)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.882 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2096` → IC=+0.155 (n=1142)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2096 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.1575` → IC=+0.155 (n=352)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1575 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.147 (n=1032)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.4443 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.7587` → IC=+0.135 (n=688)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.7587 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.153 (n=318)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 221.0 (IC base=+0.137)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.224 (n=534)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0093 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2067` → IC=+0.216 (n=782)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2067 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.224 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.777` → IC=+0.273 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.777 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` < `0.2119` → IC=+0.195 (n=1132)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` < 0.2119 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.2824` → IC=+0.205 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2824 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1935.1784` → IC=+0.205 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1935.1784 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.237 (n=970)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0106 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.224 (n=866)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.223)

- **PATRÓN** `drift_60min` |x|≤ `0.0922` → IC=+0.248 (n=323)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0922 (IC base=+0.223)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.280 (n=344)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.223)

- **PATRÓN** `ibs_20min` < `0.3521` → IC=+0.252 (n=969)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3521 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.729` → IC=+0.274 (n=400)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6428` → IC=+0.222 (n=297)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6428 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `2.2644` → IC=+0.236 (n=593)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2644 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1865.0432` → IC=+0.223 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1865.0432 (IC base=+0.223)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.211 (n=375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.162 (n=1114)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.164 (n=1116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.203 (n=1114)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3963 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1493` → IC=+0.184 (n=744)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1493 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.946` → IC=+0.243 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.946 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.05` → IC=+0.156 (n=981)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.05 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1899` → IC=+0.155 (n=372)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.1899 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5375` → IC=+0.161 (n=479)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.5375 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.529` → IC=+0.171 (n=363)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.529 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `6834.4767` → IC=+0.187 (n=743)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 6834.4767 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.151 (n=1053)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 169.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=1177)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3801` → IC=+0.142 (n=1177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3801 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.185 (n=398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6122` → IC=+0.172 (n=1177)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6122 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3418` → IC=+0.138 (n=1270)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3418 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `0.8541` → IC=+0.143 (n=785)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8541 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2894` → IC=+0.212 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2894 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4806` → IC=+0.139 (n=353)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.4806 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9988.1936` → IC=+0.160 (n=534)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9988.1936 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.163 (n=580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0099 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.202 (n=1278)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5156 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `1.0636` → IC=+0.219 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0636 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.527` → IC=+0.251 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.527 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.128 (n=1279)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2233 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` < `0.1664` → IC=+0.129 (n=1274)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1664 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.8114` → IC=+0.133 (n=820)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.8114 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1330)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2888.477` → IC=+0.198 (n=580)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2888.477 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=952)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1005` → IC=+0.143 (n=432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1005 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1319)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.205 (n=1296)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5588 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.9514` → IC=+0.145 (n=164)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9514 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.1935` → IC=+0.133 (n=1190)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1935 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.404` → IC=+0.156 (n=271)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.404 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0418` → IC=+0.121 (n=1140)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.0418 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.276 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4585` → IC=+0.140 (n=384)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4585 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `2.173` → IC=+0.124 (n=522)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` > 2.173 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3069.3649` → IC=+0.157 (n=432)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3069.3649 (IC base=+0.111)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.208 (n=812)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.1691` → IC=+0.200 (n=535)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1691 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.199 (n=1265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 5.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `0.7317` → IC=+0.256 (n=1087)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7317 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `1.2097` → IC=+0.225 (n=296)
...
- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.199 (n=1216)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.2089 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `0.8579` → IC=+0.213 (n=811)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1687` → IC=+0.207 (n=1031)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1687 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `1.8081` → IC=+0.201 (n=781)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8081 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.197 (n=1270)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `2587.3393` → IC=+0.196 (n=811)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.170 (n=553)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0089 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.153 (n=728)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1344 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=834)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.179 (n=1655)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.3963 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.3662` → IC=+0.178 (n=486)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.3662 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.719` → IC=+0.174 (n=768)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.719 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.8725` → IC=+0.162 (n=956)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8725 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `1.2058` → IC=+0.151 (n=477)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2058 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1644` → IC=+0.173 (n=457)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1644 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.156 (n=530)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `2.5522` → IC=+0.173 (n=530)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5522 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.148 (n=1857)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `12054.4463` → IC=+0.153 (n=552)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12054.4463 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.164 (n=1434)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 165.0 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.127 (n=1161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.63€ cuando `sigma_h` < 0.0057 (IC base=+0.101)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.122 (n=1167)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 11.0 (IC base=+0.101)

- **PATRÓN** `ibs_20min` < `0.6549` → IC=+0.134 (n=1741)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2374` → IC=+0.120 (n=1471)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.2374 (IC base=+0.101)
...
- **PATRÓN** `libro_liquidez` > `12288.3929` → IC=+0.135 (n=365)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 12288.3929 (IC base=+0.106)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.137 (n=549)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` < `0.6039` → IC=+0.174 (n=483)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.406` → IC=+0.148 (n=214)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.406 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.7208` → IC=+0.138 (n=490)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.7208 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.203 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `2.1106` → IC=+0.147 (n=474)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.1106 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `1.4187` → IC=+0.134 (n=539)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.4187 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.157 (n=173)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 152.0 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.212 (n=161)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0953` → IC=+0.218 (n=161)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0953 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.254 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.6988` → IC=+0.265 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6988 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` > `0.3645` → IC=+0.248 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3645 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.043` → IC=+0.239 (n=159)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2535` → IC=+0.317 (n=69)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2535 (IC base=+0.201)
...
- **PATRÓN** `ibs_20min` < `0.3319` → IC=+0.140 (n=295)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.3319 (IC base=+0.077)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.126 (n=105)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.077)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.138 (n=244)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0069 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.145 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 8.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.241 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.8338` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.8338 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.190 (n=172)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `1.0671` → IC=+0.130 (n=322)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0671 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.150 (n=158)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `3065.6596` → IC=+0.210 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3065.6596 (IC base=+0.109)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.198 (n=2981)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8945)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.8959` → IC=+0.195 (n=1210)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.8959 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.599` → IC=+0.225 (n=4361)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.599 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8814` → IC=+0.164 (n=3990)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8814 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2399` → IC=+0.194 (n=1669)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2399 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6244` → IC=+0.186 (n=2853)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6244 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2322.2922` → IC=+0.168 (n=5959)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2322.2922 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6659)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.195 (n=3573)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0053 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1439` → IC=+0.185 (n=3574)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.1439 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.207 (n=3090)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.564` → IC=+0.238 (n=8119)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.564 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2362` → IC=+0.161 (n=5086)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2362 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.88` → IC=+0.200 (n=1148)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.88 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.696` → IC=+0.182 (n=7873)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.696 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7051` → IC=+0.160 (n=2474)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7051 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2027` → IC=+0.152 (n=1874)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2027 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2883` → IC=+0.245 (n=1061)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2883 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.2867` → IC=+0.191 (n=3346)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2867 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.198 (n=2333)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.321 (n=546)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.471` → IC=+0.349 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.471 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.2267` → IC=+0.248 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2267 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.2452` → IC=+0.207 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2452 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=838)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.258 (n=1162)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.257)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.262 (n=1039)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.257)

- **PATRÓN** `drift_60min` |x|≤ `0.127` → IC=+0.291 (n=511)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.127 (IC base=+0.257)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.266 (n=1054)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.194 (n=478)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0028 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.1819` → IC=+0.160 (n=953)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.1819 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.201 (n=1427)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3102 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.183 (n=802)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.756` → IC=+0.164 (n=328)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 9.756 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.150 (n=1280)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.279 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.6265` → IC=+0.180 (n=476)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6265 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.2687` → IC=+0.186 (n=205)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2687 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `2.1195` → IC=+0.157 (n=1208)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1195 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1372)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `13656.0542` → IC=+0.151 (n=951)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 13656.0542 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `482.0` → IC=+0.155 (n=1304)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 482.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.161 (n=1245)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0056 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.078` → IC=+0.176 (n=415)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.078 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.176 (n=418)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 18.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.191 (n=1245)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6443 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6839` → IC=+0.162 (n=199)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.6839 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1279` → IC=+0.163 (n=1134)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1279 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.493` → IC=+0.162 (n=214)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 11.493 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.1888` → IC=+0.160 (n=1245)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1888 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1506` → IC=+0.195 (n=339)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1506 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4292` → IC=+0.159 (n=1147)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4292 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7532` → IC=+0.157 (n=765)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7532 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `363.0` → IC=+0.158 (n=703)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 363.0 (IC base=+0.147)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.235 (n=958)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.222 (n=1507)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.255 (n=1284)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.733` → IC=+0.292 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.733 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2147` → IC=+0.222 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2147 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9133` → IC=+0.250 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9133 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=945)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1934.3468` → IC=+0.224 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.3468 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.241 (n=1339)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.243 (n=892)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1568` → IC=+0.238 (n=589)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1568 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.268 (n=507)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.270 (n=1178)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3651 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.758` → IC=+0.278 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.758 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` > `0.3534` → IC=+0.297 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3534 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.7916` → IC=+0.231 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7916 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2288` → IC=+0.239 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2288 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.252 (n=834)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1916.36` → IC=+0.252 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1916.36 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.245 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.237)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.181 (n=509)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0034 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.142 (n=1525)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1600)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.8802` → IC=+0.262 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8802 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3564` → IC=+0.171 (n=600)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.3564 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.201` → IC=+0.159 (n=635)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.201 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8779` → IC=+0.161 (n=1017)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8779 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2789` → IC=+0.229 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2789 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.5228` → IC=+0.154 (n=648)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5228 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4148` → IC=+0.147 (n=1472)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4148 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8150.9955` → IC=+0.228 (n=692)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8150.9955 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.151 (n=468)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 81.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.157 (n=1237)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0075 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4369` → IC=+0.150 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4369 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.173 (n=466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6898` → IC=+0.189 (n=1237)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6898 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.3579` → IC=+0.140 (n=1243)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3579 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.009` → IC=+0.194 (n=184)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 11.009 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.146 (n=544)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6973 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1808` → IC=+0.145 (n=412)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.1808 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2803` → IC=+0.265 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2803 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4412` → IC=+0.153 (n=1166)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4412 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `11032.6717` → IC=+0.208 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11032.6717 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.142 (n=1159)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 184.0 (IC base=+0.136)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.131 (n=1013)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.4694` → IC=+0.186 (n=1516)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4694 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `1.0378` → IC=+0.192 (n=284)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 1.0378 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.228 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.104)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=1053)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.244 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.126 (n=1136)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1277` → IC=+0.153 (n=496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1277 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1541)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1489)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` < `0.2138` → IC=+0.128 (n=1209)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2138 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.126 (n=1435)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.7176` → IC=+0.155 (n=654)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7176 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2238` → IC=+0.175 (n=232)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2238 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `1.4566` → IC=+0.140 (n=443)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4566 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2852.4784` → IC=+0.160 (n=495)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2852.4784 (IC base=+0.111)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.212 (n=1009)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=1582)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5124` → IC=+0.245 (n=1514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5124 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.1878` → IC=+0.225 (n=866)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1878 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.476` → IC=+0.248 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.476 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.0764` → IC=+0.203 (n=1332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0764 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6343` → IC=+0.209 (n=1514)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6343 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2361` → IC=+0.236 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2361 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `2.5313` → IC=+0.232 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5313 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1560)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2596.3007` → IC=+0.210 (n=1009)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2596.3007 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.233 (n=552)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0172` → IC=+0.213 (n=1104)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0172 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.211 (n=811)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)
...
- **PATRÓN** `ibs_20min` < `0.52` → IC=+0.257 (n=1656)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.52 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.8352` → IC=+0.203 (n=1853)
...
- **PATRÓN** `libro_liquidez` > `2568.9526` → IC=+0.202 (n=1104)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2568.9526 (IC base=+0.201)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2785)

- **PATRÓN** `sigma_h` < `0.0112` → IC=+0.156 (n=2697)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0112 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.52` → IC=+0.159 (n=2696)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.52 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.156 (n=899)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1876` → IC=+0.161 (n=942)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1876 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4956` → IC=+0.140 (n=1593)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4956 (IC base=+0.150)
...
- **PATRÓN** `ibs_20min` < `0.1747` → IC=+0.160 (n=925)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.1747 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.142 (n=392)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.4316` → IC=+0.125 (n=2084)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.4316 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.261` → IC=+0.140 (n=2086)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.146 (n=987)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.5338` → IC=+0.138 (n=915)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5338 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.8163` → IC=+0.140 (n=1386)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8163 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2785)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7453.0099` → IC=+0.144 (n=1876)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7453.0099 (IC base=+0.132)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.172 (n=309)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0056 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.0033` → IC=+0.177 (n=314)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0033 (IC base=+0.161)

- **PATRÓN** `drift_60min` |x|≤ `0.0902` → IC=+0.189 (n=117)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.0902 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.169 (n=358)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 5.0 (IC base=+0.161)

- **PATRÓN** `ibs_20min` < `0.5245` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5245 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` > `0.2159` → IC=+0.183 (n=159)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.2159 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.3969` → IC=+0.164 (n=346)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.3969 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.308` → IC=+0.174 (n=379)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` < 2.308 (IC base=+0.161)

- **PATRÓN** `volumen_regimen` > `0.8402` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8402 (IC base=+0.161)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.198 (n=117)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `2.7581` → IC=+0.206 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7581 (IC base=+0.161)

- **PATRÓN** `libro_liquidez` > `12570.0288` → IC=+0.202 (n=313)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12570.0288 (IC base=+0.161)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.154 (n=50)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 1.0 (IC base=+0.040)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.185` → IC=+0.167 (n=58)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.185 (IC base=+0.040)

- **PATRÓN** `volumen_pendiente_norm` > `0.1563` → IC=+0.180 (n=48)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1563 (IC base=+0.040)

- **PATRÓN** `ibs_20min` < `0.1781` → IC=+0.182 (n=64)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.1781 (IC base=+0.046)

- **PATRÓN** `dist_vwap_pct` > `0.6027` → IC=+0.167 (n=64)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6027 (IC base=+0.046)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.214 (n=344)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0039 (IC base=+0.103)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.121 (n=808)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 6.0 (IC base=+0.103)

- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.198 (n=687)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5857 (IC base=+0.103)

- **PATRÓN** `dist_vwap_pct` > `0.3437` → IC=+0.173 (n=258)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.3437 (IC base=+0.103)
...
- **PATRÓN** `volumen_regimen` > `0.9748` → IC=+0.131 (n=312)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.9748 (IC base=+0.103)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1232` → IC=+0.158 (n=509)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1232 (IC base=+0.103)

- **PATRÓN** `volumen_spike_ratio` > `1.4086` → IC=+0.135 (n=578)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.4086 (IC base=+0.103)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.134 (n=560)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.02 (IC base=+0.103)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.150 (n=301)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.103)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.176 (n=180)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.005 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.143 (n=253)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 7.0 (IC base=+0.120)

- **PATRÓN** `ibs_20min` > `0.557` → IC=+0.224 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.557 (IC base=+0.120)

- **PATRÓN** `dist_vwap_pct` > `0.5243` → IC=+0.187 (n=65)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5243 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.217` → IC=+0.333 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.217 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.150 (n=158)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.8141 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.5884` → IC=+0.144 (n=237)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7779` → IC=+0.169 (n=125)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.7779 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.154 (n=186)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.120)

- **PATRÓN** `libro_spread` < `0.013` → IC=+0.150 (n=155)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.013 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `1103.6894` → IC=+0.176 (n=208)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 1103.6894 (IC base=+0.120)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.127 (n=108)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.006 (IC base=+0.078)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.133 (n=175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 13.0 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.6316` → IC=+0.167 (n=214)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.6316 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` > `0.1948` → IC=+0.150 (n=121)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1948 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.231` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.231 (IC base=+0.078)

- **PATRÓN** `volumen_regimen` > `1.0396` → IC=+0.162 (n=72)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0396 (IC base=+0.078)

- **PATRÓN** `volumen_pendiente_norm` > `0.0865` → IC=+0.200 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0865 (IC base=+0.078)

- **PATRÓN** `volumen_spike_ratio` < `2.1825` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.1825 (IC base=+0.078)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.147 (n=216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 16.0 (IC base=+0.110)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.127 (n=588)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2844.5756` → IC=+0.170 (n=201)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2844.5756 (IC base=+0.110)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.143 (n=208)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=461)
...
- **FILTRO** `py_entrada` < `0.445` → IC=-0.135 (n=50)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=180)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7204)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3018)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=9450)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3139)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9790)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.220 (n=516)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=1629)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.172 (n=540)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1768)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=1291)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.024)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=543)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1636)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=570)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1727)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.158 (n=574)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1723)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.178 (n=575)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1726)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2597)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2740)
...
- **FILTRO** `ibs_20min` > `0.1792` → IC=-0.139 (n=106)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=322)
...
- **FILTRO** `ibs_20min` < `0.1716` → IC=-0.229 (n=94)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=191)

- **FILTRO** `ballena_activa_n` > `96.0` → IC=-0.247 (n=85)

  - _Acción_: SKIP cuando `ballena_activa_n` > 96.0
  - _Potencial_: sin este filtro IC_bueno=-0.095 (n=166)

### MOMENTUM_IBS_15M_FADE#SOL#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=710)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=19980)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.278 (n=6949)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=21923)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7213)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21659)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9761)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19111)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.228 (n=9009)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=27143)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9028)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27124)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1126)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3594)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.257 (n=1556)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3164)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1142)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3578)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4198)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=2045)

- **FILTRO** `drift_7min_pct` |x|> `0.1116` → IC=-0.127 (n=2121)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1116
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4122)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.205 (n=1558)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4685)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3848)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1210)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3805)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.188 (n=1253)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3762)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.173 (n=1251)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3764)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1245)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3829)

- **FILTRO** `ibs_7min` > `0.2581` → IC=-0.172 (n=1268)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3806)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1262)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3812)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.173 (n=1097)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3363)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.311 (n=1082)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3378)

- **FILTRO** `ibs_7min` < `0.1972` → IC=-0.258 (n=1115)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1972
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3345)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1086)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3374)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1543)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5080)

- **FILTRO** `ibs_7min` > `0.7598` → IC=-0.176 (n=1655)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7598
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=4968)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=3229)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.247 (n=1164)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3583)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.180 (n=1184)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3563)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.179 (n=1154)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3593)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1212)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3656)

- **FILTRO** `ibs_7min` > `0.2747` → IC=-0.173 (n=1216)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2747
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3652)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.188 (n=1180)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3688)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.267 (n=1188)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3909)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.231 (n=1271)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3826)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1658)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5199)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.280 (n=1116)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3717)

- **FILTRO** `ibs_7min` < `0.71` → IC=-0.231 (n=1208)

  - _Acción_: SKIP cuando `ibs_7min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3625)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1163)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3670)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1608)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=4879)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1030)
...
- **FILTRO** `py_entrada` < `0.445` → IC=-0.167 (n=103)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.445
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=322)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3981` → IC=+0.129 (n=704)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio` |x|> 0.3981 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.123 (n=634)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.114)

- **PATRÓN** `total_vol_5m` < `459.6089` → IC=+0.150 (n=235)

  - _Acción_: Kelly boost +0.75€ cuando `total_vol_5m` < 459.6089 (IC base=+0.114)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1064)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2645)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1354)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1362)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1627` → IC=+0.193 (n=1205)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1627 (IC base=+0.185)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2178` → IC=+0.186 (n=456)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.93€ cuando `delta_ratio_macro` |x|> 0.2178 (IC base=+0.185)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.133` → IC=+0.234 (n=461)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.133 (IC base=+0.185)
...
- **PATRÓN** `ibs_15` > `0.6136` → IC=+0.261 (n=1368)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6136 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` > `0.4417` → IC=+0.185 (n=319)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4417 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.5544` → IC=+0.174 (n=1347)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5544 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.265` → IC=+0.271 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.265 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `2964.2504` → IC=+0.194 (n=912)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2964.2504 (IC base=+0.185)
...
- **PATRÓN** `drift_15min` |x|≤ `0.3804` → IC=+0.212 (n=109)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3804 (IC base=+0.206)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1506` → IC=+0.288 (n=111)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1506 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.233 (n=301)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.206)

- **PATRÓN** `ibs_15` > `0.7061` → IC=+0.268 (n=326)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7061 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.279 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.503` → IC=+0.254 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.503 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `14926.7198` → IC=+0.247 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14926.7198 (IC base=+0.206)
...
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.158 (n=144)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0057 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.162 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1407` → IC=+0.159 (n=212)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.1407 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.258` → IC=+0.168 (n=218)

  - _Acción_: Kelly boost +0.84€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.258 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.164 (n=236)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6255` → IC=+0.228 (n=318)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6255 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1061` → IC=+0.165 (n=222)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1061 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.717` → IC=+0.217 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.717 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.151 (n=144)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.140)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.213 (n=594)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1785)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=768)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1611)

- **FILTRO** `libro_liquidez` < `3905.3214` → IC=-0.133 (n=1570)

  - _Acción_: SKIP cuando `libro_liquidez` < 3905.3214
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=809)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.138` → IC=+0.265 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.138 (IC base=-0.058)

- **PATRÓN** `ibs_15` > `0.6314` → IC=+0.267 (n=586)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6314 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` > `0.5593` → IC=+0.179 (n=107)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.5593 (IC base=-0.058)

- **PATRÓN** `dist_vwap_pct` < `0.1102` → IC=+0.185 (n=360)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.1102 (IC base=-0.058)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.237 (n=961)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1809` → IC=+0.238 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1809 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.279 (n=1439)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.039)

- **PATRÓN** `dist_vwap_pct` > `0.8624` → IC=+0.266 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8624 (IC base=-0.039)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.216 (n=357)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0069
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=1075)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.228 (n=472)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=960)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=906)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=526)

- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.242 (n=254)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.708
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1178)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.184 (n=134)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0027 (IC base=+0.086)
...
- **PATRÓN** `dist_vwap_pct` > `0.1352` → IC=+0.292 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1352 (IC base=+0.086)
...
- **FILTRO** `ibs_15` < `0.6625` → IC=-0.205 (n=93)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.259 (n=280)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.156 (n=356)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.172 (n=187)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.005 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.0768` → IC=+0.214 (n=124)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0768 (IC base=+0.143)

- **PATRÓN** `drift_15min` |x|≤ `0.4223` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `drift_15min` |x|≤ 0.4223 (IC base=+0.143)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1323` → IC=+0.151 (n=187)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.75€ cuando `delta_ratio_macro` |x|> 0.1323 (IC base=+0.143)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=130)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.143)

- **PATRÓN** `ibs_15` > `0.6625` → IC=+0.259 (n=280)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6625 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.6245` → IC=+0.143 (n=54)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6245 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1135` → IC=+0.182 (n=199)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1135 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.579` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 6.579 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=356)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `10899.0951` → IC=+0.182 (n=127)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10899.0951 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.238 (n=585)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.223)

- **PATRÓN** `drift_15min` |x|≤ `0.7722` → IC=+0.232 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7722 (IC base=+0.223)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2028` → IC=+0.257 (n=265)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.273` → IC=+0.278 (n=515)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.273 (IC base=+0.223)

- **PATRÓN** `dist_vwap_pct` > `0.7133` → IC=+0.260 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7133 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.065` → IC=+0.243 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.065 (IC base=+0.223)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.262` → IC=+0.227 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.262 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `3493.9209` → IC=+0.224 (n=585)
...
- **FILTRO** `drift_15min` |x|> `0.8849` → IC=-0.255 (n=141)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.126 (n=426)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.262 (n=179)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.169 (n=536)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1526` → IC=+0.270 (n=133)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1526 (IC base=-0.044)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1052` → IC=+0.362 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1052 (IC base=-0.044)

- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.315 (n=397)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3457 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` > `1.0601` → IC=+0.396 (n=46)
...
- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.304 (n=273)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.295 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `14356.961` → IC=+0.308 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14356.961 (IC base=+0.293)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0733` → IC=+0.308 (n=118)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0733 (IC base=+0.303)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1481` → IC=+0.321 (n=177)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1481 (IC base=+0.303)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.288` → IC=+0.345 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.288 (IC base=+0.303)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.350 (n=191)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.303)

- **PATRÓN** `ibs_15` > `0.8516` → IC=+0.346 (n=265)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8516 (IC base=+0.303)

- **PATRÓN** `dist_vwap_pct` > `0.6071` → IC=+0.323 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6071 (IC base=+0.303)

- **PATRÓN** `dist_vwap_pct` < `0.1651` → IC=+0.303 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1651 (IC base=+0.303)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.221` → IC=+0.333 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.221 (IC base=+0.303)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.310 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.303)

- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.303 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 153.0 (IC base=+0.303)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6136 sube el IC de +0.185 a +0.261 en UPDOWN_GBM#15min (n=1368). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7061 sube el IC de +0.206 a +0.268 en UPDOWN_GBM#BTC#15min (n=326). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6255 sube el IC de +0.140 a +0.228 en UPDOWN_GBM#ETH#15min (n=318). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6314 sube el IC de -0.058 a +0.267 en UPDOWN_GBM_15M_TARDIO (n=586). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.039 a +0.279 en UPDOWN_GBM_15M_TARDIO (n=1439). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6625 sube el IC de +0.143 a +0.259 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=280). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.273 sube el IC de +0.223 a +0.278 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=515). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8382 sube el IC de +0.293 a +0.331 en UPDOWN_GBM_IBS_ALTO (n=601). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8516 sube el IC de +0.303 a +0.346 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=265). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1224 | +0.090 | +152.72€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1224 | +0.090 | +152.72€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 896 | +0.099 | +129.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 896 | +0.099 | +129.37€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 242 | +0.045 | +4.70€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 242 | +0.045 | +4.70€ | 4 | 5 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 22999 | -0.093 | -3090.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1378 | -0.043 | -203.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21621 | -0.096 | -2887.01€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3510 | -0.087 | -573.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3510 | -0.087 | -573.88€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1378 | -0.043 | -203.88€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1378 | -0.043 | -203.88€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6583 | -0.035 | -612.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6583 | -0.035 | -612.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6068 | -0.095 | -444.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6068 | -0.095 | -444.52€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5086 | -0.179 | -1095.28€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5086 | -0.179 | -1095.28€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15333 | -0.033 | +4130.45€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4042 | -0.002 | +1828.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11291 | -0.044 | +2302.11€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15333 | -0.033 | +4130.45€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4042 | -0.002 | +1828.33€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11291 | -0.044 | +2302.11€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1369 | -0.102 | -184.96€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 149 | -0.043 | -15.16€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1220 | -0.109 | -169.80€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 413 | -0.129 | -73.49€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 389 | -0.132 | -68.26€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 84042 | +0.113 | -4263.51€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12908 | +0.184 | -407.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min |