# Hipótesis automáticas — 2026-08-27 01:41 UTC
_Generado por shadow_postmortem.py sobre 168782 resoluciones (PNL=+12248.64€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.76` → IC=-0.285 (n=2336)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.76
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=7008)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `148.86` → IC=-0.196 (n=287)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.86
  - _Potencial_: sin este filtro IC_bueno=+0.069 (n=865)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `n_ballenas` < `6.0` → IC=-0.169 (n=164)

  - _Acción_: SKIP cuando `n_ballenas` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=514)

- **FILTRO** `restante_s_al_confirmar` < `390.04` → IC=-0.284 (n=169)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 390.04
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=509)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `95.92` → IC=-0.434 (n=287)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 95.92
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=863)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `158.64` → IC=-0.186 (n=636)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.64
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=1908)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `154.0` → IC=-0.268 (n=549)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1649)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `151.38` → IC=-0.360 (n=535)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 151.38
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=1087)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=5292)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1565)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2382.8902` → IC=+0.174 (n=1509)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.155 (n=4122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.140)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.259 (n=3266)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=2907)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `1855.8565` → IC=+0.182 (n=2430)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 1855.8565 (IC base=+0.140)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.212 (n=772)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `12753.7064` → IC=+0.221 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12753.7064 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.195 (n=566)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 7.0 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.191 (n=428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 11.0 (IC base=+0.184)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.291 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.184 (n=805)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.01 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `12164.5258` → IC=+0.209 (n=208)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12164.5258 (IC base=+0.184)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.127 (n=1012)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.196 (n=623)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 12.0 (IC base=+0.192)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.444 (n=304)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.190 (n=3771)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.186)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2131)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.178 (n=967)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.165 (n=955)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.170 (n=568)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.229 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.183 (n=927)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 15.0 (IC base=+0.183)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.196 (n=547)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.7 (IC base=+0.183)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.220 (n=8497)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.130 (n=1557)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 12.0 (IC base=+0.125)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.157 (n=1642)
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.272 (n=1377)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.163 (n=1448)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 12.0 (IC base=+0.163)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.213 (n=708)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.288 (n=669)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.247 (n=1156)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.189 (n=1420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 12.0 (IC base=+0.183)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.210 (n=1458)
...
- **PATRÓN** `restante_min` < `3.94` → IC=+0.139 (n=1445)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` < 3.94 (IC base=+0.133)

- **PATRÓN** `restante_min` > `4.93` → IC=+0.160 (n=1464)

  - _Acción_: Kelly boost +0.80€ cuando `restante_min` > 4.93 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.151 (n=2105)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 8.0 (IC base=+0.133)

- **PATRÓN** `lag_apertura_s` < `4.46` → IC=+0.157 (n=1450)

  - _Acción_: Kelly boost +0.79€ cuando `lag_apertura_s` < 4.46 (IC base=+0.133)
...
- **PATRÓN** `restante_min` < `4.27` → IC=+0.142 (n=950)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 4.27 (IC base=+0.140)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.166 (n=744)

  - _Acción_: Kelly boost +0.83€ cuando `restante_min` > 4.91 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.161 (n=1042)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 8.0 (IC base=+0.140)

- **PATRÓN** `lag_apertura_s` < `5.53` → IC=+0.167 (n=722)

  - _Acción_: Kelly boost +0.84€ cuando `lag_apertura_s` < 5.53 (IC base=+0.140)
...
- **PATRÓN** `restante_min` < `4.42` → IC=+0.131 (n=971)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 4.42 (IC base=+0.127)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.159 (n=782)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.140 (n=1063)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 8.0 (IC base=+0.127)

- **PATRÓN** `lag_apertura_s` < `3.48` → IC=+0.163 (n=727)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 3.48 (IC base=+0.127)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.305 (n=347)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9497` → IC=+0.208 (n=739)
...
- **PATRÓN** `dist_vwap_pct` < `0.4917` → IC=+0.216 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4917 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.196` → IC=+0.169 (n=904)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.196 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` < `0.6325` → IC=+0.225 (n=158)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3081` → IC=+0.145 (n=170)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.3081 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.142 (n=1044)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `1.4577` → IC=+0.133 (n=1186)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.4577 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.2143` → IC=+0.134 (n=1505)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.2143 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.2981` → IC=+0.146 (n=761)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2981 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6357` → IC=+0.157 (n=243)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6357 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.06` → IC=+0.146 (n=331)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.06 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.3022` → IC=+0.260 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3022 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.6222` → IC=+0.202 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6222 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` > `2.9133` → IC=+0.230 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9133 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.228 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.031)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.184 (n=166)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0075 (IC base=+0.118)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.164 (n=233)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.130 (n=117)
  ...
  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.118)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.298 (n=176)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0689` → IC=+0.344 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0689 (IC base=+0.274)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.276 (n=248)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.274)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.287 (n=233)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.274)

- **PATRÓN** `ibs_20min` < `0.4341` → IC=+0.315 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4341 (IC base=+0.274)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.310 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` < `0.0561` → IC=+0.303 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0561 (IC base=+0.274)

- **PATRÓN** `volumen_pendiente_norm` > `0.23` → IC=+0.300 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.23 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` < `1.7907` → IC=+0.294 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7907 (IC base=+0.274)

- **PATRÓN** `volumen_spike_ratio` > `1.5478` → IC=+0.290 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5478 (IC base=+0.274)
...
- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.292 (n=94)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.274)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3346` → IC=+0.218 (n=324)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.210 (n=350)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.222 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.2233` → IC=+0.231 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2233 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` < `0.5452` → IC=+0.211 (n=323)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.05` → IC=+0.211 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.05 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.216 (n=368)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.267` → IC=+0.265 (n=49)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.267 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` < `1.349` → IC=+0.252 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.349 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `11289.7522` → IC=+0.219 (n=329)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11289.7522 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.192 (n=141)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0022 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.169` → IC=+0.157 (n=281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.151 (n=442)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 18.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.5876` → IC=+0.169 (n=421)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.5876 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` < `0.1424` → IC=+0.170 (n=355)
...
- **PATRÓN** `volumen_regimen` < `0.6337` → IC=+0.178 (n=141)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6337 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.025` → IC=+0.148 (n=191)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 1.025 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.0939` → IC=+0.218 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0939 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.7452` → IC=+0.182 (n=212)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.7452 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.163 (n=318)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=544)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `14111.5146` → IC=+0.185 (n=141)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 14111.5146 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `227.0` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 227.0 (IC base=+0.141)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.0714` → IC=+0.132 (n=150)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.0714 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.216 (n=153)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1477` → IC=+0.121 (n=338)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_pendiente_norm` < 0.1477 (IC base=+0.131)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1278` → IC=+0.283 (n=141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.269 (n=331)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.264)

- **PATRÓN** `ibs_20min` < `0.5146` → IC=+0.301 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5146 (IC base=+0.264)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.961` → IC=+0.309 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.961 (IC base=+0.264)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.571` → IC=+0.264 (n=354)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.571 (IC base=+0.264)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7842` → IC=+0.235 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7842 (IC base=+0.264)

- **PATRÓN** `volumen_spike_ratio` > `2.743` → IC=+0.237 (n=131)
...
- **PATRÓN** `ballena_activa_n` < `28.0` → IC=+0.238 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 28.0 (IC base=+0.264)

### GBM_LATE_15M#ETH#15min
- **FILTRO** `ibs_20min` > `0.8711` → IC=-0.165 (n=195)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.162 (n=63)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=721)
...
- **PATRÓN** `dist_vwap_pct` > `0.238` → IC=+0.239 (n=21)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.238 (IC base=-0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.0567` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0567 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.5315` → IC=+0.155 (n=27)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.5315 (IC base=-0.052)

- **PATRÓN** `volumen_spike_ratio` > `2.1413` → IC=+0.233 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1413 (IC base=-0.052)

- **PATRÓN** `ballena_activa_n` < `114.0` → IC=+0.177 (n=29)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 114.0 (IC base=-0.052)
...
- **FILTRO** `ibs_20min` > `0.7619` → IC=-0.160 (n=319)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=961)
...
- **FILTRO** `drift_60min` |x|> `0.5168` → IC=-0.152 (n=225)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5168
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=437)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.144 (n=930)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0089 (IC base=+0.053)

- **PATRÓN** `ibs_20min` > `0.9461` → IC=+0.249 (n=930)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9461 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `1.2681` → IC=+0.288 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2681 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.1564` → IC=+0.197 (n=321)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.1564 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` < `0.115` → IC=+0.168 (n=1245)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` < 0.115 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.2479` → IC=+0.206 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2479 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` < `1.4786` → IC=+0.194 (n=426)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4786 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.837` → IC=+0.171 (n=426)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.837 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.265 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.0943` → IC=+0.185 (n=1184)
...
- **PATRÓN** `dist_vwap_pct` < `0.2092` → IC=+0.205 (n=734)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3705` → IC=+0.289 (n=282)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3705 (IC base=+0.040)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.260 (n=457)
...
- **FILTRO** `sigma_ewma_delta_pct` > `5.197` → IC=-0.210 (n=122)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 5.197
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=620)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1444` → IC=+0.189 (n=329)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1444 (IC base=+0.179)

- **PATRÓN** `volumen_pendiente_norm` > `0.4225` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.4225 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` < `2.0145` → IC=+0.188 (n=155)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.0145 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `3.6311` → IC=+0.177 (n=159)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 3.6311 (IC base=+0.179)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.226 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `1915.1184` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1915.1184 (IC base=+0.179)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.352 (n=201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.1308` → IC=+0.357 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1308 (IC base=+0.350)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.389` → IC=+0.354 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.389 (IC base=+0.350)

- **PATRÓN** `volumen_pendiente_norm` > `0.097` → IC=+0.380 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.097 (IC base=+0.350)

- **PATRÓN** `volumen_spike_ratio` < `1.732` → IC=+0.375 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.732 (IC base=+0.350)

- **PATRÓN** `volumen_spike_ratio` > `1.9567` → IC=+0.347 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9567 (IC base=+0.350)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.153 (n=148)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.7343` → IC=+0.259 (n=27)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7343 (IC base=-0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.3975` → IC=+0.222 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3975 (IC base=-0.071)

- **PATRÓN** `volumen_spike_ratio` > `1.7258` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7258 (IC base=-0.071)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7368` → IC=-0.123 (n=414)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=+0.210 (n=215)
...
- **PATRÓN** `volumen_regimen` < `0.8598` → IC=+0.189 (n=120)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4917` → IC=+0.172 (n=56)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.4917 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `2.0538` → IC=+0.179 (n=76)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.0538 (IC base=-0.009)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.225 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=-0.009)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0244` → IC=+0.318 (n=185)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0244 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.227 (n=214)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.224 (n=208)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.142` → IC=+0.274 (n=321)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.142 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `1.0201` → IC=+0.256 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0201 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` < `0.0802` → IC=+0.220 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0802 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.2771` → IC=+0.267 (n=71)
...
- **PATRÓN** `libro_liquidez` > `2453.0908` → IC=+0.225 (n=555)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2453.0908 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.282 (n=250)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.268)

- **PATRÓN** `drift_60min` |x|≤ `0.4819` → IC=+0.273 (n=500)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.253 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 42.0 (IC base=+0.268)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.196 (n=805)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0098 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.0858` → IC=+0.158 (n=806)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0858 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.182 (n=891)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.155)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.157 (n=905)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `1.1475` → IC=+0.259 (n=426)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1475 (IC base=+0.155)
...
- **PATRÓN** `volumen_regimen` < `1.2156` → IC=+0.158 (n=1678)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.2156 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `0.686` → IC=+0.171 (n=1500)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.686 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.102` → IC=+0.183 (n=865)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.102 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.2771` → IC=+0.152 (n=1907)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.2771 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.8508` → IC=+0.149 (n=1444)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8508 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=1976)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `3197.0046` → IC=+0.182 (n=1095)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3197.0046 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `125.0` → IC=+0.176 (n=1167)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 125.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.202 (n=1889)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.186)

- **PATRÓN** `drift_60min` |x|≤ `0.4113` → IC=+0.199 (n=2146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.4113 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.214 (n=821)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` < `0.4065` → IC=+0.239 (n=2146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4065 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.3585` → IC=+0.178 (n=1883)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.3585 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.761` → IC=+0.221 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.761 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.167 (n=1735)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.176 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.174 (n=1156)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8709` → IC=+0.179 (n=1024)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.8709 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.6138` → IC=+0.208 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6138 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `202.0` → IC=+0.185 (n=1105)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 202.0 (IC base=+0.186)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.215 (n=177)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.253` → IC=+0.150 (n=390)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.253 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.200 (n=188)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.029` → IC=+0.344 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.029 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1454` → IC=+0.174 (n=93)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1454 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.131 (n=312)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4352 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.170 (n=234)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.04 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.275 (n=167)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.268)

- **PATRÓN** `sigma_h` > `0.0052` → IC=+0.278 (n=169)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0052 (IC base=+0.268)

- **PATRÓN** `drift_60min` |x|≤ `0.3311` → IC=+0.312 (n=190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3311 (IC base=+0.268)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.291 (n=175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.268)

- **PATRÓN** `ibs_20min` < `0.0763` → IC=+0.360 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0763 (IC base=+0.268)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.838` → IC=+0.283 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.838 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` < `1.7907` → IC=+0.316 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7907 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` > `2.8103` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8103 (IC base=+0.268)
...
- **PATRÓN** `volumen_regimen` < `1.2907` → IC=+0.186 (n=342)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 1.2907 (IC base=+0.178)

- **PATRÓN** `volumen_regimen` > `0.8896` → IC=+0.196 (n=228)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 0.8896 (IC base=+0.178)
...
- **PATRÓN** `libro_liquidez` > `12172.2264` → IC=+0.200 (n=228)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12172.2264 (IC base=+0.178)

- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.171 (n=435)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0055 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2908` → IC=+0.175 (n=435)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4047` → IC=+0.189 (n=435)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.4047 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1586` → IC=+0.177 (n=428)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1714` → IC=+0.223 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1714 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.7385` → IC=+0.173 (n=218)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.7385 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `14245.6725` → IC=+0.160 (n=145)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 14245.6725 (IC base=+0.151)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2` → IC=+0.321 (n=149)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2 (IC base=+0.282)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.318 (n=152)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.282)

- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.318 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.244` → IC=+0.321 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.244 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3755` → IC=+0.426 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3755 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `1.9918` → IC=+0.284 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9918 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.255 (n=104)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1378` → IC=+0.227 (n=152)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1378 (IC base=+0.181)
...
- **PATRÓN** `volumen_regimen` > `0.6356` → IC=+0.195 (n=345)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.6356 (IC base=+0.181)
...
- **PATRÓN** `ibs_20min` < `0.343` → IC=+0.217 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.343 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.3201` → IC=+0.167 (n=458)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3201 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.227` → IC=+0.215 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.227 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.8554` → IC=+0.160 (n=277)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8554 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6177` → IC=+0.156 (n=414)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6177 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.0994` → IC=+0.161 (n=122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0994 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.8875` → IC=+0.191 (n=205)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.8875 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `10015.5876` → IC=+0.150 (n=138)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 10015.5876 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `197.0` → IC=+0.134 (n=200)

  - _Acción_: Kelly boost +0.67€ cuando `ballena_activa_n` < 197.0 (IC base=+0.148)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0102` → IC=+0.203 (n=217)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0102 (IC base=+0.120)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.138 (n=435)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 8.0 (IC base=+0.120)
...
- **PATRÓN** `dist_vwap_pct` > `0.7959` → IC=+0.274 (n=153)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7959 (IC base=+0.120)
...
- **PATRÓN** `volumen_regimen` > `0.6818` → IC=+0.143 (n=427)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6818 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.231` → IC=+0.133 (n=96)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_pendiente_norm` > 0.231 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `1.5631` → IC=+0.133 (n=399)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.5631 (IC base=+0.120)

- **PATRÓN** `libro_liquidez` > `3204.0646` → IC=+0.216 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3204.0646 (IC base=+0.120)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.189 (n=133)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0049 (IC base=+0.126)

- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.187 (n=132)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0096 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.232 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.141 (n=369)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.2166 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.672` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 6.672 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `1.2004` → IC=+0.137 (n=397)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 1.2004 (IC base=+0.126)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.127 (n=336)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `2065.7928` → IC=+0.177 (n=264)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2065.7928 (IC base=+0.126)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0227` → IC=+0.189 (n=233)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0227 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.1638` → IC=+0.194 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1638 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.199 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 17.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.9211` → IC=+0.259 (n=343)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9211 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `1.6268` → IC=+0.254 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6268 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.073` → IC=+0.245 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.073 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `0.8273` → IC=+0.190 (n=343)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 0.8273 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2365` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2365 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `2.1643` → IC=+0.175 (n=420)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1643 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=561)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `2453.0908` → IC=+0.163 (n=514)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2453.0908 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.277 (n=164)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.221)

- **PATRÓN** `drift_60min` |x|≤ `0.6677` → IC=+0.236 (n=490)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.253 (n=233)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.221)

- **PATRÓN** `ibs_20min` < `0.1333` → IC=+0.299 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1333 (IC base=+0.221)

- **PATRÓN** `dist_vwap_pct` < `0.8176` → IC=+0.229 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8176 (IC base=+0.221)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.17` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.17 (IC base=+0.221)

- **PATRÓN** `volumen_regimen` > `0.7127` → IC=+0.243 (n=438)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5893` → IC=+0.221 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5893 (IC base=+0.221)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.187 (n=273)
...
- **PATRÓN** `ibs_20min` > `0.6308` → IC=+0.154 (n=377)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.6308 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.7807` → IC=+0.250 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7807 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.235` → IC=+0.199 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.235 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.188 (n=110)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `2920.0962` → IC=+0.129 (n=281)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 2920.0962 (IC base=+0.087)

- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.165 (n=168)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0041 (IC base=+0.081)

- **PATRÓN** `drift_60min` |x|≤ `0.1132` → IC=+0.127 (n=167)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.1132 (IC base=+0.081)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.132 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 14.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` < `0.6296` → IC=+0.131 (n=380)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.6296 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.192` → IC=+0.212 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.192 (IC base=+0.081)

- **PATRÓN** `volumen_regimen` < `0.6527` → IC=+0.147 (n=117)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6527 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `1.6103` → IC=+0.162 (n=143)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.6103 (IC base=+0.081)

- **PATRÓN** `libro_liquidez` > `11322.5447` → IC=+0.151 (n=127)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 11322.5447 (IC base=+0.081)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.162 (n=66)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 15.0 (IC base=+0.020)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 1.0 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.605` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.605 (IC base=+0.020)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.020)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.208 (n=1271)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9434` → IC=+0.291 (n=1272)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9434 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `1.0829` → IC=+0.253 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0829 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.349` → IC=+0.247 (n=1180)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.349 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.7028` → IC=+0.151 (n=872)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7028 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `1.0816` → IC=+0.155 (n=899)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0816 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.165` → IC=+0.185 (n=713)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.165 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.8738` → IC=+0.161 (n=1655)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8738 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2286)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `3902.0492` → IC=+0.193 (n=934)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 3902.0492 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.191 (n=1255)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 159.0 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.228 (n=1670)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.4613` → IC=+0.205 (n=2504)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4613 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.202 (n=939)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.196)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.205 (n=912)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` < `0.5546` → IC=+0.253 (n=2504)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5546 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` < `0.7189` → IC=+0.184 (n=2046)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.7189 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.377` → IC=+0.227 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.377 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.639` → IC=+0.200 (n=2358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.639 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` < `0.6242` → IC=+0.188 (n=630)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6242 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.192 (n=630)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.1936 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` > `0.2815` → IC=+0.272 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2815 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.2519` → IC=+0.212 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2519 (IC base=+0.196)

- **PATRÓN** `ballena_activa_n` < `180.0` → IC=+0.177 (n=1377)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 180.0 (IC base=+0.196)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.171 (n=165)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 6.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.8271` → IC=+0.255 (n=300)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9026` → IC=+0.141 (n=246)
  ...
  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.9026 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.188 (n=238)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1044` → IC=+0.328 (n=120)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1044 (IC base=+0.282)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.283 (n=256)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.282)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.294 (n=246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.282)

- **PATRÓN** `ibs_20min` < `0.5819` → IC=+0.339 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5819 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` < `0.0678` → IC=+0.295 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0678 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.2905` → IC=+0.306 (n=29)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7082` → IC=+0.347 (n=57)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7082 (IC base=+0.282)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.207 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.184 (n=400)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 8.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.206 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3271 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.2609` → IC=+0.248 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2609 (IC base=+0.156)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.205 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `0.6489` → IC=+0.173 (n=148)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.6489 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `1.1006` → IC=+0.175 (n=201)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.1006 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.1452` → IC=+0.228 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1452 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.1158` → IC=+0.183 (n=348)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.1158 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.7052` → IC=+0.198 (n=263)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.7052 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `11800.2375` → IC=+0.185 (n=296)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 11800.2375 (IC base=+0.156)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2654` → IC=+0.180 (n=370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `2.4777` → IC=+0.194 (n=325)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.4777 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.5054` → IC=+0.188 (n=290)
...
- **PATRÓN** `libro_liquidez` > `12012.7226` → IC=+0.174 (n=191)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 12012.7226 (IC base=+0.167)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.238 (n=166)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.179)

- **PATRÓN** `ibs_20min` > `0.7131` → IC=+0.263 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7131 (IC base=+0.179)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2301` → IC=+0.184 (n=302)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.2301 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` < `2.0554` → IC=+0.199 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0554 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `2.7899` → IC=+0.170 (n=198)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.7899 (IC base=+0.179)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `1856.141` → IC=+0.195 (n=247)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 1856.141 (IC base=+0.179)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.230 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.179)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.331 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.266)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.283 (n=233)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.266)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.288 (n=116)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.266)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.333 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5652 (IC base=+0.266)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7663` → IC=+0.305 (n=75)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7663 (IC base=+0.266)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.270 (n=146)
...
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.153 (n=448)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.199 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3491 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.9062` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9062 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.433` → IC=+0.196 (n=215)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 4.433 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.6318` → IC=+0.191 (n=150)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6318 (IC base=+0.142)
...
- **PATRÓN** `volumen_spike_ratio` > `1.3991` → IC=+0.196 (n=412)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 1.3991 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `5388.027` → IC=+0.230 (n=298)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5388.027 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.177 (n=215)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 167.0 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.183 (n=323)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0076 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.5036` → IC=+0.167 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5036 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.183 (n=257)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 11.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` < `0.0802` → IC=+0.250 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0802 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` > `0.1617` → IC=+0.163 (n=188)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1617 (IC base=+0.156)

- **PATRÓN** `dist_vwap_pct` < `0.6682` → IC=+0.178 (n=392)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.6682 (IC base=+0.156)
...
- **PATRÓN** `volumen_regimen` < `0.596` → IC=+0.180 (n=123)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.596 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `1.1275` → IC=+0.188 (n=123)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` > 1.1275 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` > `0.2304` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2304 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` < `2.1811` → IC=+0.193 (n=272)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.1811 (IC base=+0.156)

- **PATRÓN** `volumen_spike_ratio` > `1.4584` → IC=+0.178 (n=309)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.4584 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `9441.0647` → IC=+0.210 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9441.0647 (IC base=+0.156)
...
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.172 (n=227)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0107 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.161 (n=178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 18.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.309 (n=228)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `1.0609` → IC=+0.277 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0609 (IC base=+0.100)
...
- **PATRÓN** `libro_liquidez` > `2940.9508` → IC=+0.287 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2940.9508 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.175 (n=275)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 68.0 (IC base=+0.100)
...
- **PATRÓN** `sigma_h` > `0.0266` → IC=+0.210 (n=198)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9655` → IC=+0.293 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9655 (IC base=+0.171)

- **PATRÓN** `dist_vwap_pct` > `1.4593` → IC=+0.288 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4593 (IC base=+0.171)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.923` → IC=+0.261 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.923 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` < `0.611` → IC=+0.180 (n=198)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.611 (IC base=+0.171)

- **PATRÓN** `volumen_regimen` > `1.0385` → IC=+0.194 (n=269)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8207` → IC=+0.184 (n=362)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.8207 (IC base=+0.171)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.185 (n=643)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.01 (IC base=+0.171)

- **PATRÓN** `libro_liquidez` > `3105.3037` → IC=+0.190 (n=198)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 3105.3037 (IC base=+0.171)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.211 (n=320)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4762` → IC=+0.229 (n=566)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.216 (n=684)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.215)

- **PATRÓN** `ibs_20min` < `0.4875` → IC=+0.280 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4875 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `1.2142` → IC=+0.223 (n=753)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 1.2142 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.508` → IC=+0.283 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.508 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.021` → IC=+0.217 (n=642)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5474` → IC=+0.240 (n=156)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5474 (IC base=+0.215)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.176 (n=356)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 37.0 (IC base=+0.215)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.154 (n=941)

- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.136 (n=399)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0098 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.160 (n=186)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 17.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.8363` → IC=+0.149 (n=206)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` > 0.8363 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.5234` → IC=+0.195 (n=116)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 1.5234 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.6122` → IC=+0.151 (n=130)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6122 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` > `0.8957` → IC=+0.124 (n=259)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.8957 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.1533` → IC=+0.164 (n=129)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1533 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4921` → IC=+0.146 (n=196)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4921 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=427)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `8331.3362` → IC=+0.151 (n=302)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8331.3362 (IC base=+0.114)

- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.211 (n=240)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.3567` → IC=+0.167 (n=631)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3567 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.201 (n=276)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 4.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.63` → IC=+0.159 (n=631)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.63 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `0.0856` → IC=+0.155 (n=717)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.0856 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.6272` → IC=+0.171 (n=159)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6272 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.3818` → IC=+0.147 (n=709)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3818 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.057` → IC=+0.162 (n=320)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.057 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.039` → IC=+0.149 (n=722)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 6.039 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.161 (n=703)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2231 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.0707` → IC=+0.165 (n=341)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0707 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.4757` → IC=+0.166 (n=710)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4757 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.5115` → IC=+0.154 (n=634)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5115 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=941)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `8505.7624` → IC=+0.152 (n=717)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 8505.7624 (IC base=+0.148)
...
- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.166 (n=405)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0063 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.3567` → IC=+0.154 (n=405)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3567 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.194 (n=158)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 17.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.192 (n=154)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 5.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.1706` → IC=+0.172 (n=178)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.1706 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.6099` → IC=+0.172 (n=59)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.6099 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.225` → IC=+0.157 (n=409)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 6.225 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.151 (n=405)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1847 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.6265` → IC=+0.154 (n=405)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6265 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.182 (n=187)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.159 (n=403)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.7752` → IC=+0.149 (n=269)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.7752 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `11900.5247` → IC=+0.148 (n=362)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 11900.5247 (IC base=+0.145)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.186 (n=192)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0089 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.4517` → IC=+0.155 (n=192)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4517 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` < `0.1748` → IC=+0.180 (n=73)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.1748 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.8027` → IC=+0.183 (n=99)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.8027 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `1.1467` → IC=+0.223 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1467 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.4234` → IC=+0.152 (n=185)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.4234 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.126` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 11.126 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.861` → IC=+0.144 (n=217)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.861 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.6457` → IC=+0.180 (n=73)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6457 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0812` → IC=+0.160 (n=98)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0812 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4092` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4092 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `8953.8054` → IC=+0.185 (n=195)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 8953.8054 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.174 (n=213)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0088 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.160 (n=142)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0062 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.4057` → IC=+0.198 (n=187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.4057 (IC base=+0.153)
...
- **PATRÓN** `ibs_20min` < `0.5912` → IC=+0.156 (n=187)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5912 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.089` → IC=+0.188 (n=213)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.089 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.1942` → IC=+0.152 (n=90)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1942 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.3517` → IC=+0.168 (n=206)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3517 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.392` → IC=+0.194 (n=96)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 4.392 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.1943` → IC=+0.193 (n=213)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 1.1943 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` < `0.1284` → IC=+0.171 (n=217)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` < 0.1284 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.1163` → IC=+0.203 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1163 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.4319` → IC=+0.181 (n=208)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4319 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `10375.0696` → IC=+0.185 (n=71)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 10375.0696 (IC base=+0.153)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.122 (n=72)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 13.0 (IC base=+0.027)
...
- **PATRÓN** `sigma_h` > `0.0018` → IC=+0.130 (n=52)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0018 (IC base=+0.106)

- **PATRÓN** `drift_60min` |x|≤ `0.129` → IC=+0.157 (n=33)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.129 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.250 (n=18)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.3394` → IC=+0.185 (n=52)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.3394 (IC base=+0.106)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.574` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.574 (IC base=+0.106)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.156 (n=126)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 18.0 (IC base=+0.135)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `py_entrada` < 0.495 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `2495.3515` → IC=+0.167 (n=118)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2495.3515 (IC base=+0.135)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.170 (n=791)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=2435)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.213 (n=754)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2464)

- **FILTRO** `ibs_20min` > `0.2723` → IC=-0.174 (n=803)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2723
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=2415)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.239 (n=117)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=352)

- **FILTRO** `ibs_20min` < `0.7263` → IC=-0.206 (n=117)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7263
  - _Potencial_: sin este filtro IC_bueno=+0.045 (n=352)

- **FILTRO** `ibs_20min` > `0.7424` → IC=-0.143 (n=138)
...
- **FILTRO** `ibs_20min` > `0.7596` → IC=-0.199 (n=134)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7596
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=406)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.179 (n=154)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.221 (n=134)
...
- **FILTRO** `ibs_20min` > `0.283` → IC=-0.229 (n=127)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=1947)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=6038)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.281 (n=1911)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=6074)

- **FILTRO** `ibs_7min` < `0.7376` → IC=-0.230 (n=1996)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7376
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=5989)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.173 (n=2713)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=5272)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.228 (n=2242)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=7502)

- **FILTRO** `ibs_7min` > `0.7168` → IC=-0.172 (n=2435)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7168
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=7309)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.159 (n=247)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=834)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.328 (n=265)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=816)

- **FILTRO** `ibs_7min` < `0.9821` → IC=-0.199 (n=713)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9821
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=368)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.258 (n=267)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=814)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.227 (n=408)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1252)

- **FILTRO** `drift_7min_pct` |x|> `0.1394` → IC=-0.157 (n=564)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1394
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1096)

- **FILTRO** `ibs_7min` > `0.8378` → IC=-0.195 (n=414)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8378
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1246)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.228 (n=391)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1181)

- **FILTRO** `ibs_7min` < `0.8031` → IC=-0.162 (n=392)

  - _Acción_: SKIP cuando `ibs_7min` < 0.8031
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1180)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.172 (n=391)

  - _Acción_: SKIP cuando `ballena_activa_n` > 155.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1181)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.219 (n=389)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1215)

- **FILTRO** `ballena_activa_n` > `129.0` → IC=-0.166 (n=399)

  - _Acción_: SKIP cuando `ballena_activa_n` > 129.0
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1205)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.193 (n=268)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=865)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.312 (n=365)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=768)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.282 (n=282)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=851)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.275 (n=282)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=851)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.262 (n=360)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1339)

- **FILTRO** `ibs_7min` > `0.8182` → IC=-0.185 (n=424)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8182
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=1275)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.154 (n=293)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.260 (n=315)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=1036)

- **FILTRO** `ibs_7min` < `0.7649` → IC=-0.187 (n=337)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7649
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=1014)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.216 (n=332)
...
- **FILTRO** `hora_utc` > `18.0` → IC=-0.146 (n=289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=1054)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.281 (n=326)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1017)

- **FILTRO** `ibs_7min` > `0.1821` → IC=-0.162 (n=456)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1821
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=887)

- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.206 (n=335)

  - _Acción_: SKIP cuando `ballena_activa_n` > 37.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=1008)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.41` → IC=-0.234 (n=377)

  - _Acción_: SKIP cuando `py_entrada` < 0.41
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1142)

- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.199 (n=377)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1142)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.191 (n=373)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1146)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.184 (n=447)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1353)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.272 (n=323)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1006)

- **FILTRO** `ibs_7min` < `0.7547` → IC=-0.209 (n=331)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7547
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=998)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.223 (n=330)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=999)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.268 (n=330)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1308)

- **FILTRO** `ibs_7min` > `0.8333` → IC=-0.159 (n=408)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.123 (n=157)
  ...
  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.505 (IC base=+0.072)

- **PATRÓN** `streak_len` < `3.0` → IC=+0.144 (n=147)

  - _Acción_: Kelly boost +0.72€ cuando `streak_len` < 3.0 (IC base=+0.072)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.129 (n=149)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=1160)
...
- **PATRÓN** `ibs_15` < `0.1151` → IC=+0.142 (n=428)
...
### UPDOWN_GBM#BTC#5min
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0237` → IC=-0.167 (n=25)
...
- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.132 (n=172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0054 (IC base=+0.016)
...
- **PATRÓN** `ibs_15` < `0.1282` → IC=+0.213 (n=106)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.262` → IC=-0.176 (n=338)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.266 (n=92)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=-0.078)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.095` → IC=+0.360 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.095 (IC base=-0.078)

- **PATRÓN** `ibs_15` < `0.32` → IC=+0.344 (n=139)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.32 (IC base=-0.078)

- **PATRÓN** `dist_vwap_pct` < `0.1185` → IC=+0.269 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1185 (IC base=-0.078)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.232 (n=207)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0064
  - _Potencial_: sin este filtro IC_bueno=-0.195 (n=404)

- **FILTRO** `sigma_h` < `0.0033` → IC=-0.209 (n=201)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `hora_utc` > `16.0` → IC=-0.247 (n=152)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=459)

- **FILTRO** `sigma_ewma_delta_pct` > `19.944` → IC=-0.267 (n=114)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.944
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=497)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2338` → IC=+0.250 (n=58)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2338 (IC base=+0.252)

- **PATRÓN** `drift_15min` |x|≤ `0.4277` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4277 (IC base=+0.252)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0962` → IC=+0.275 (n=78)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0962 (IC base=+0.252)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2369` → IC=+0.271 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2369 (IC base=+0.252)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.294 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.252)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.274 (n=29)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.252)

- **PATRÓN** `ibs_15` < `0.3345` → IC=+0.343 (n=87)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.3303` → IC=+0.255 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3303 (IC base=+0.252)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.280 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.252)

- **PATRÓN** `libro_liquidez` > `12147.9804` → IC=+0.309 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12147.9804 (IC base=+0.252)

- **PATRÓN** `ballena_activa_n` < `210.0` → IC=+0.280 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 210.0 (IC base=+0.252)
...
- **FILTRO** `sigma_ewma_delta_pct` > `12.777` → IC=-0.149 (n=146)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1282 sube el IC de +0.051 a +0.213 en UPDOWN_GBM#XRP#15min (n=106). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.32 sube el IC de -0.078 a +0.344 en UPDOWN_GBM_15M_TARDIO (n=139). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3345 sube el IC de +0.252 a +0.343 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=87). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 6734 | -0.103 | -1003.13€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 678 | -0.091 | -125.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 6056 | -0.105 | -878.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1152 | +0.003 | -163.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1152 | +0.003 | -163.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 678 | -0.091 | -125.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 678 | -0.091 | -125.13€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 2198 | -0.073 | -106.31€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2198 | -0.073 | -106.31€ | 1 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 1622 | -0.202 | -415.05€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 1622 | -0.202 | -415.05€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 31383 | +0.114 | -2014.63€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5818 | +0.187 | -190.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 107 | -0.105 | -50.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 22293 | +0.095 | -1732.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3165 | +0.120 | -41.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3742 | +0.063 | -637.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3716 | +0.065 | -633.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6493 | +0.133 | -150.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1639 | +0.197 | -89.98€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3711 | +0.108 | -93.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1101 | +0.129 | +54.94€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3750 | +0.079 | -478.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 21 | +0.065 | +3.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3728 | +0.079 | -479.90€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6972 | +0.128 | -94.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2118 | +0.168 | -10.89€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3712 | +0.113 | -50.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1130 | +0.102 | -24.28€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6687 | +0.135 | -395.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2002 | +0.204 | -94.35€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 46 | +0.000 | -9.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3705 | +0.099 | -219.69€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 934 | +0.133 | -71.94€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3739 | +0.105 | -257.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3721 | +0.106 | -255.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5772 | +0.172 | -460.77€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 5772 | +0.172 | -460.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1451 | +0.167 | -153.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1451 | +0.167 | -153.93€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1440 | +0.159 | -173.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1440 | +0.159 | -173.33€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1296 | +0.229 | -38.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1296 | +0.229 | -38.75€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1394 | +0.183 | -110.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1394 | +0.183 | -110.56€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 15949 | +0.190 | -1417.92€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 15949 | +0.190 | -1417.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 2925 | +0.125 | -541.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 2925 | +0.125 | -541.10€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 