# Hipótesis automáticas — 2026-07-01 20:35 UTC
_Generado por shadow_postmortem.py sobre 2466 resoluciones (PNL=-82.13€)_
...
- **FILTRO** `ibs_15` > `0.2802` → IC=-0.130 (n=25)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.2802
  - _Potencial_: sin este filtro IC_bueno=+0.167 (n=49)

- **PATRÓN** `sigma_h` < `0.009` → IC=+0.276 (n=47)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.009 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.167 (n=19)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.094)

- **PATRÓN** `ibs_15` < `0.2802` → IC=+0.167 (n=49)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.2802 (IC base=+0.094)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.2802 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.167 n=49). Confirma señal de reversión media → alinear con BUY_YES.
...
| ✅ UPDOWN_GBM | 718 | -0.035 | -31.01€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 506 | -0.010 | -6.16€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.119) — sin ventaja clara. oversold(IBS<0.3): IC=+0.025 n=97 | neutral: IC=-0.094 n=94 | overbought(IBS>0.7): IC=-0.023 n=128
  - _Datos_: n=328 IC=-0.027 PNL=-5.78€
...
**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=-0.000 n=1157 | tras_1loss IC=-0.034 n=1219 | tras_2loss IC=-0.050 n=633/40 | gap=+0.049 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=595 IC=-0.028 PNL=-17.46€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=595 IC=-0.028 PNL=-17.46€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=123 IC=+0.060 PNL=+21.70€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=123 IC=+0.060 PNL=+21.70€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 49/200 ops en el filtro definido (IC actual=+0.108 PNL=+10.79€)
  - _Datos_: n=49 IC=+0.108 PNL=+10.79€
...
**⏳ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: 49/100 ops en el filtro definido (IC actual=+0.108 PNL=+10.79€)
  - _Datos_: n=49 IC=+0.108 PNL=+10.79€
