# Hipótesis automáticas — 2026-07-15 10:00 UTC
_Generado por shadow_postmortem.py sobre 15136 resoluciones (PNL=+2947.29€)_
...
- **PATRÓN** `libro_liquidez` > `7292.9528` → IC=+0.184 (n=280)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 7292.9528 (IC base=+0.162)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2090 | +0.177 | -28.56€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 735 | +0.174 | -26.13€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.098 n=8710 | tras_1loss IC=+0.061 n=6232 | tras_2loss IC=+0.028 n=2709/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12678 IC=+0.101 PNL=+3023.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12678 IC=+0.101 PNL=+3023.17€
...
**🔶 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA en SOL (IC=+0.226 n=104) pero sin cruzar ≥2 pares más — BTC: n=13 IC=+0.065; ETH: n=114 IC=+0.155 ✓
  - _Datos_: n=104 IC=+0.226 PNL=+8.47€
