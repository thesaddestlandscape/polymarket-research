# Hipótesis automáticas — 2026-09-20 15:15 UTC
_Generado por shadow_postmortem.py sobre 528030 resoluciones (PNL=+58315.84€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=461)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.254 (n=461)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8039` → IC=+0.261 (n=332)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.144 (n=346)
...
- **PATRÓN** `libro_liquidez` > `2853.9997` → IC=+0.141 (n=332)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.262 (n=360)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.262 (n=360)
...
- **PATRÓN** `banda_hit_calibrado` > `0.802` → IC=+0.276 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.802 (IC base=+0.139)

- **PATRÓN** `banda_z` > `4.482` → IC=+0.170 (n=392)
...
- **FILTRO** `restante_s_al_confirmar` < `160.09` → IC=-0.231 (n=1511)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.09
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4535)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.81` → IC=-0.365 (n=1263)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.81
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=3789)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12863)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=3218)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5470.7315` → IC=+0.174 (n=2047)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.236 (n=9825)
...
- **PATRÓN** `libro_liquidez` > `7512.304` → IC=+0.173 (n=1980)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7512.304 (IC base=+0.131)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1527)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.205)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=693)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.205)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1915)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `15704.4993` → IC=+0.236 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15704.4993 (IC base=+0.205)
...
- **PATRÓN** `py_entrada` > `0.62` → IC=+0.179 (n=300)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.146 (n=475)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 11.0 (IC base=+0.116)
...
- **PATRÓN** `libro_liquidez` > `5856.6213` → IC=+0.170 (n=219)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 5856.6213 (IC base=+0.116)
...
- **PATRÓN** `libro_liquidez` > `1300.2394` → IC=+0.148 (n=598)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.428 (n=571)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.134 (n=739)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10292)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.201 (n=9887)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.223 (n=3570)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=2417)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2530)
...
- **PATRÓN** `libro_liquidez` > `2062.8229` → IC=+0.440 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2062.8229 (IC base=+0.433)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.435 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.457 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.439 (n=194)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=2715)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1588.4149` → IC=+0.295 (n=1017)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1588.4149 (IC base=+0.289)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.294 (n=314)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4194.9158` → IC=+0.289 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4194.9158 (IC base=+0.274)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.331 (n=341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1485.2195` → IC=+0.313 (n=436)
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.437 (n=203)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3517` → IC=+0.125 (n=6254)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3517 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.239 (n=2370)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.1451` → IC=+0.247 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1451 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.911` → IC=+0.172 (n=2742)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 5.911 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.246 (n=1870)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.242 (n=848)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.3078` → IC=+0.210 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3078 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.915` → IC=+0.203 (n=3195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.915 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5699` → IC=+0.132 (n=8610)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5699 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5603` → IC=+0.186 (n=575)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5603 (IC base=+0.062)
...
- **PATRÓN** `volumen_regimen` > `0.8709` → IC=+0.173 (n=1953)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8709 (IC base=+0.062)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5838` → IC=+0.200 (n=4353)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5838 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `144.0` → IC=+0.211 (n=4654)
...
- **PATRÓN** `drift_60min` |x|≤ `0.334` → IC=+0.167 (n=1613)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.273 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.023` → IC=+0.274 (n=701)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.166 (n=1499)
...
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.235 (n=538)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.0838` → IC=+0.255 (n=406)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0838 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1277)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9943` → IC=+0.262 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9943 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.1843` → IC=+0.216 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1843 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.1279` → IC=+0.215 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1279 (IC base=+0.213)
...
- **PATRÓN** `volumen_regimen` < `1.2501` → IC=+0.221 (n=1217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2501 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `0.8719` → IC=+0.213 (n=811)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8719 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0749` → IC=+0.218 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0749 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.4035` → IC=+0.227 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4035 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3852` → IC=+0.214 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3852 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `12240.9476` → IC=+0.220 (n=1087)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12240.9476 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.173 (n=432)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0026 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.0749` → IC=+0.161 (n=428)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0749 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=505)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 17.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.6828` → IC=+0.166 (n=1284)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6828 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.124` → IC=+0.151 (n=1160)
...
- **PATRÓN** `volumen_regimen` < `1.2049` → IC=+0.145 (n=1284)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2049 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.135 (n=856)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.8523 (IC base=+0.133)
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.224 (n=1340)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.0637` → IC=+0.242 (n=590)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.401` → IC=+0.219 (n=1466)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.232 (n=830)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1863.822` → IC=+0.229 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1863.822 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.228 (n=785)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.145 (n=91)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=1977)
...
- **PATRÓN** `dist_vwap_pct` < `0.6471` → IC=+0.328 (n=301)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6471 (IC base=+0.019)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.599` → IC=+0.146 (n=625)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2917` → IC=+0.344 (n=75)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1749` → IC=+0.329 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1749 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `168.0` → IC=+0.338 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 168.0 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3008` → IC=+0.164 (n=215)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.3008 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.6997` → IC=+0.155 (n=311)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.6997 (IC base=+0.009)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1967)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.127 (n=971)

- **FILTRO** `sigma_ewma_delta_pct` > `8.635` → IC=-0.201 (n=319)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.635
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2619)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.127 (n=971)
...
- **FILTRO** `ibs_20min` < `0.69` → IC=-0.158 (n=1313)

  - _Acción_: SKIP cuando `ibs_20min` < 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=680)
...
- **FILTRO** `ibs_20min` > `0.7733` → IC=-0.204 (n=741)
...
- **PATRÓN** `dist_vwap_pct` < `0.2479` → IC=+0.318 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2479 (IC base=-0.077)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.302 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6141 (IC base=-0.077)

- **PATRÓN** `volumen_pendiente_norm` > `0.0764` → IC=+0.295 (n=110)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8422` → IC=+0.291 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8422 (IC base=-0.077)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.192 (n=2959)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4667` → IC=+0.186 (n=7915)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4667 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.695` → IC=+0.286 (n=878)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.695 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.543` → IC=+0.151 (n=4208)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.543 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1722` → IC=+0.231 (n=3087)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1722 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6815` → IC=+0.243 (n=2758)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6815 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2988` → IC=+0.261 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2988 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4754` → IC=+0.243 (n=1668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4754 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.712` → IC=+0.242 (n=1668)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.712 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.272 (n=4514)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.146 (n=2994)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.55` → IC=+0.151 (n=7903)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.55 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6717` → IC=+0.240 (n=502)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6717 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1695` → IC=+0.236 (n=2343)
...
- **PATRÓN** `volumen_regimen` > `1.2001` → IC=+0.246 (n=855)
...
- **PATRÓN** `volumen_spike_ratio` > `2.351` → IC=+0.260 (n=1515)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.464` → IC=-0.165 (n=472)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.464
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=1597)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.273 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.675` → IC=+0.197 (n=335)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 8.675 (IC base=+0.047)

- **PATRÓN** `volumen_pendiente_norm` > `0.2224` → IC=+0.285 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2224 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.4419` → IC=+0.192 (n=245)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.4419 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` > `2.5711` → IC=+0.204 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5711 (IC base=+0.047)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.187 (n=311)
...
- **FILTRO** `ibs_20min` > `0.8156` → IC=-0.150 (n=649)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1949)

- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.156 (n=597)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.86 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.2893` → IC=+0.161 (n=308)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.2893 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `1.1921` → IC=+0.143 (n=803)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.1921 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `0.6566` → IC=+0.149 (n=717)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6566 (IC base=+0.019)

- **PATRÓN** `volumen_pendiente_norm` > `0.2774` → IC=+0.195 (n=103)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.2774 (IC base=+0.019)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.200 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.019)

- **PATRÓN** `ballena_activa_n` < `250.0` → IC=+0.190 (n=340)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=740)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.244)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.559` → IC=+0.276 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.559 (IC base=+0.244)

- **PATRÓN** `volumen_pendiente_norm` < `0.1388` → IC=+0.260 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1388 (IC base=+0.244)

- **PATRÓN** `volumen_spike_ratio` > `2.9594` → IC=+0.262 (n=599)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9594 (IC base=+0.244)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1930.62` → IC=+0.254 (n=469)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1930.62 (IC base=+0.244)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.265 (n=495)
...
- **FILTRO** `ibs_20min` < `0.2648` → IC=-0.202 (n=424)
...
- **FILTRO** `ibs_20min` > `0.7889` → IC=-0.180 (n=530)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1593)

- **PATRÓN** `ibs_20min` > `0.8031` → IC=+0.159 (n=578)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8031 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.8506` → IC=+0.227 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8506 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.9683` → IC=+0.231 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9683 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `0.6452` → IC=+0.212 (n=401)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0829` → IC=+0.248 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0829 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.265 (n=283)
...
- **FILTRO** `ibs_20min` < `0.7` → IC=-0.211 (n=944)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.273 (n=946)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.231 (n=496)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1489)

- **FILTRO** `sigma_ewma_delta_pct` > `4.656` → IC=-0.176 (n=442)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.656
  - _Potencial_: sin este filtro IC_bueno=+0.066 (n=1543)

- **PATRÓN** `ibs_20min` > `0.7` → IC=+0.273 (n=946)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` > `0.8055` → IC=+0.342 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8055 (IC base=+0.031)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.153 (n=295)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.8622` → IC=+0.293 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8622 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `0.6366` → IC=+0.287 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6366 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` < `0.1049` → IC=+0.289 (n=627)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1049 (IC base=+0.031)

- **PATRÓN** `volumen_pendiente_norm` > `0.274` → IC=+0.302 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.274 (IC base=+0.031)

- **PATRÓN** `volumen_spike_ratio` < `1.7979` → IC=+0.302 (n=437)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7979 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.316 (n=574)
...
- **PATRÓN** `dist_vwap_pct` < `0.2002` → IC=+0.221 (n=410)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0684` → IC=+0.198 (n=180)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.0684 (IC base=+0.012)

- **PATRÓN** `volumen_spike_ratio` < `2.5113` → IC=+0.221 (n=435)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.319 (n=772)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0161 (IC base=+0.275)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.281 (n=1166)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.275)

- **PATRÓN** `ibs_20min` > `0.9091` → IC=+0.349 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9091 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.9303` → IC=+0.334 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9303 (IC base=+0.275)
...
- **PATRÓN** `volumen_regimen` > `1.0357` → IC=+0.308 (n=525)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4418` → IC=+0.281 (n=364)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.279 (n=1216)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2451.1204` → IC=+0.285 (n=1034)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2451.1204 (IC base=+0.275)
...
- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.172 (n=2330)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0048 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.203 (n=2325)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3423` → IC=+0.175 (n=6137)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3423 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=7280)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5833` → IC=+0.217 (n=6974)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5833 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.167` → IC=+0.194 (n=3017)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.167 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.217` → IC=+0.254 (n=1432)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.217 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.212` → IC=+0.161 (n=4614)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.212 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6255` → IC=+0.157 (n=4614)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6255 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2463` → IC=+0.190 (n=1396)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2463 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5652` → IC=+0.172 (n=2930)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5652 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6455` → IC=+0.174 (n=2219)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6455 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `3828.4706` → IC=+0.167 (n=2325)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3828.4706 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=5886)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=4474)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.0792` → IC=+0.201 (n=2231)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4745` → IC=+0.226 (n=6691)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4745 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` < `0.2234` → IC=+0.159 (n=4923)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2234 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.213` → IC=+0.199 (n=1133)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.213 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.1777` → IC=+0.151 (n=4877)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1777 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6259` → IC=+0.144 (n=4877)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6259 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.225 (n=964)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5733` → IC=+0.166 (n=2650)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5733 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6423` → IC=+0.174 (n=2008)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6423 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.171 (n=5652)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 119.0 (IC base=+0.167)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.218 (n=402)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3311` → IC=+0.205 (n=1198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.304 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.032` → IC=+0.308 (n=545)
...
- **PATRÓN** `volumen_spike_ratio` > `1.429` → IC=+0.181 (n=1100)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.501` → IC=+0.225 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.501 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `0.6831` → IC=+0.181 (n=453)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6831 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2334` → IC=+0.189 (n=226)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2334 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `1.4154` → IC=+0.207 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4154 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `15765.4015` → IC=+0.169 (n=466)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.153 (n=1138)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.2896 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=1048)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.2113` → IC=+0.153 (n=1138)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4453` → IC=+0.146 (n=1028)
...
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.226 (n=528)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0093 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2038` → IC=+0.213 (n=776)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2038 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.226 (n=392)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.196)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.196)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.781` → IC=+0.272 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.781 (IC base=+0.196)

- **PATRÓN** `volumen_pendiente_norm` < `0.2129` → IC=+0.195 (n=1123)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` < 0.2129 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.6513` → IC=+0.196 (n=366)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6513 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.9434` → IC=+0.208 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9434 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=762)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1936.1714` → IC=+0.205 (n=388)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.215 (n=370)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.429` → IC=+0.162 (n=1108)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.429 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.164 (n=1107)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3977` → IC=+0.202 (n=1107)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.936` → IC=+0.236 (n=199)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.936 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.0496` → IC=+0.156 (n=975)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.0496 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1897` → IC=+0.152 (n=369)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.1897 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2902` → IC=+0.215 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2902 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.5382` → IC=+0.159 (n=476)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.5382 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.5288` → IC=+0.175 (n=361)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.5288 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `6834.4767` → IC=+0.186 (n=738)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6834.4767 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.152 (n=1046)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 169.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.160 (n=1172)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0071 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3796` → IC=+0.142 (n=1172)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6096` → IC=+0.173 (n=1172)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6096 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.3396` → IC=+0.138 (n=1269)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.3396 (IC base=+0.123)
...
- **PATRÓN** `volumen_regimen` < `0.8554` → IC=+0.144 (n=782)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8554 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.213 (n=169)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4783` → IC=+0.141 (n=352)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.4783 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `10015.5876` → IC=+0.159 (n=532)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10015.5876 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.123 (n=987)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1305)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5152` → IC=+0.202 (n=1271)
...
- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.127 (n=1271)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2208 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` < `0.1666` → IC=+0.129 (n=1266)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1666 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `1.8125` → IC=+0.133 (n=816)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 1.8125 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1321)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2892.276` → IC=+0.196 (n=576)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.5588` → IC=+0.204 (n=1290)
...
- **PATRÓN** `dist_vwap_pct` < `0.193` → IC=+0.134 (n=1186)
...
- **PATRÓN** `volumen_regimen` < `1.0418` → IC=+0.120 (n=1135)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.0418 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.163 (n=158)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.110)
...
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.208 (n=806)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.202 (n=532)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.7321` → IC=+0.255 (n=1080)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7321 (IC base=+0.196)

- **PATRÓN** `dist_vwap_pct` > `1.2054` → IC=+0.228 (n=292)
...
- **PATRÓN** `volumen_regimen` < `1.2084` → IC=+0.199 (n=1209)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` < 1.2084 (IC base=+0.196)

- **PATRÓN** `volumen_regimen` > `0.8567` → IC=+0.214 (n=806)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8567 (IC base=+0.196)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1687` → IC=+0.208 (n=1025)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1687 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.197 (n=1261)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `2590.751` → IC=+0.197 (n=806)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2590.751 (IC base=+0.196)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.153 (n=727)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1344 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.185 (n=828)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.178 (n=1650)
...
- **PATRÓN** `volumen_regimen` < `0.8708` → IC=+0.164 (n=952)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8708 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `1.2036` → IC=+0.149 (n=477)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.2036 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.170 (n=453)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.157 (n=528)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `2.5522` → IC=+0.172 (n=528)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.5522 (IC base=+0.144)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.148 (n=1852)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `12075.9356` → IC=+0.154 (n=550)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12075.9356 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.163 (n=1431)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 165.0 (IC base=+0.144)
...
- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.210 (n=160)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.200)
...
- **PATRÓN** `ibs_20min` > `0.4087` → IC=+0.242 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4087 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `0.3636` → IC=+0.244 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3636 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` < `0.8399` → IC=+0.211 (n=320)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8399 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.1573` → IC=+0.210 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1573 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2528` → IC=+0.312 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2528 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `1.3839` → IC=+0.231 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3839 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `2.391` → IC=+0.267 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.391 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `12251.2185` → IC=+0.204 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12251.2185 (IC base=+0.200)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.198 (n=2963)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9274)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8890)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.8917` → IC=+0.197 (n=1194)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8917 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.593` → IC=+0.224 (n=4340)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.593 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8805` → IC=+0.164 (n=3964)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8805 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2395` → IC=+0.193 (n=1663)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2395 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6226` → IC=+0.186 (n=2834)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6226 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2324.2036` → IC=+0.168 (n=5921)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2324.2036 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6609)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.192 (n=5390)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1431` → IC=+0.184 (n=3555)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.1431 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=3059)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5633` → IC=+0.238 (n=8081)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5633 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2357` → IC=+0.161 (n=5075)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2357 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.877` → IC=+0.201 (n=1141)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.877 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.694` → IC=+0.182 (n=7833)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.694 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7053` → IC=+0.158 (n=2461)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7053 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.202` → IC=+0.154 (n=1866)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3383` → IC=+0.193 (n=1512)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.320 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.191)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.433` → IC=+0.348 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.433 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.2266` → IC=+0.246 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2266 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `2.2431` → IC=+0.204 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2431 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=823)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.195 (n=474)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0027 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0832` → IC=+0.166 (n=474)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.0832 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3123` → IC=+0.200 (n=1416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3123 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.3218` → IC=+0.191 (n=555)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3218 (IC base=+0.147)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.279` → IC=+0.151 (n=1269)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.279 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.6261` → IC=+0.180 (n=473)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6261 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0752` → IC=+0.152 (n=1233)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2681` → IC=+0.186 (n=205)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2681 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1213` → IC=+0.158 (n=1198)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1213 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.5037` → IC=+0.152 (n=1217)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.5037 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13672.1173` → IC=+0.152 (n=944)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 13672.1173 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `482.0` → IC=+0.156 (n=1294)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 482.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.159 (n=1240)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0057 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.3178` → IC=+0.156 (n=1240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.191 (n=1240)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.154` → IC=+0.158 (n=606)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.154 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.1913` → IC=+0.159 (n=1240)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4305` → IC=+0.158 (n=1142)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4305 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7547` → IC=+0.157 (n=761)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.7547 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `363.0` → IC=+0.157 (n=698)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 363.0 (IC base=+0.146)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.238 (n=955)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.216)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.221 (n=1495)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.216)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.221 (n=1454)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.216)

- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.255 (n=1274)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.216)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.733` → IC=+0.292 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.733 (IC base=+0.216)

- **PATRÓN** `volumen_pendiente_norm` < `0.2145` → IC=+0.222 (n=1395)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2145 (IC base=+0.216)

- **PATRÓN** `volumen_spike_ratio` > `2.9089` → IC=+0.246 (n=612)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9089 (IC base=+0.216)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=936)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.216)

- **PATRÓN** `libro_liquidez` > `1935.1784` → IC=+0.222 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1935.1784 (IC base=+0.216)

- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.242 (n=1332)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0107 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.242 (n=889)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3648` → IC=+0.269 (n=1172)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2342` → IC=+0.237 (n=804)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2342 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.253 (n=828)
...
- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.246 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.237)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.179 (n=506)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0034 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4312` → IC=+0.142 (n=1516)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4312 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1588)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8801` → IC=+0.262 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8801 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.5535` → IC=+0.177 (n=425)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5535 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.174` → IC=+0.158 (n=632)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.174 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.160 (n=1011)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8772 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2789` → IC=+0.228 (n=211)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2789 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.153 (n=644)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.4148` → IC=+0.148 (n=1463)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4148 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8211.9616` → IC=+0.230 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8211.9616 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.150 (n=464)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 81.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.159 (n=1230)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0075 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4348` → IC=+0.150 (n=1229)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_liquidez` > `11047.6745` → IC=+0.209 (n=410)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11047.6745 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.143 (n=1152)
...
- **PATRÓN** `ibs_20min` > `0.4688` → IC=+0.186 (n=1508)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2774)
...
- **PATRÓN** `drift_60min` |x|≤ `0.476` → IC=+0.153 (n=2093)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.173` → IC=+0.161 (n=921)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.173 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` > `0.6849` → IC=+0.138 (n=387)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.6849 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.431` → IC=+0.126 (n=2079)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.431 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.261` → IC=+0.140 (n=2078)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8153` → IC=+0.140 (n=1381)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8153 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2774)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7482.7428` → IC=+0.145 (n=1869)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 7482.7428 (IC base=+0.132)
...
- **PATRÓN** `ibs_20min` < `0.1667` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.1667 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` > `0.8053` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.8053 (IC base=+0.035)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=802)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.5857` → IC=+0.201 (n=683)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5857 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.3412` → IC=+0.184 (n=254)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.3412 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.576` → IC=+0.214 (n=166)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.576 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `0.8058` → IC=+0.131 (n=456)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 0.8058 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `0.975` → IC=+0.131 (n=310)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.975 (IC base=+0.105)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1222` → IC=+0.159 (n=505)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1222 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.409` → IC=+0.137 (n=573)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.409 (IC base=+0.105)
...
- **PATRÓN** `hora_utc` > `13.0` → IC=+0.138 (n=172)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 13.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.6944` → IC=+0.191 (n=189)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.6944 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.1941` → IC=+0.164 (n=120)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1941 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.203` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.203 (IC base=+0.080)

- **PATRÓN** `volumen_regimen` > `1.0396` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.0396 (IC base=+0.080)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1825` → IC=+0.143 (n=169)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.1825 (IC base=+0.080)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.128 (n=582)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2846.2392` → IC=+0.172 (n=199)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2846.2392 (IC base=+0.110)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7192)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3015)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=9378)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.173 (n=3117)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9744)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.220 (n=515)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1615)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.172 (n=537)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1758)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=1282)
...
- **FILTRO** `py_entrada` < `0.44` → IC=-0.203 (n=530)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1634)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=567)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1717)

- **FILTRO** `ibs_20min` > `0.2846` → IC=-0.159 (n=570)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2846
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1714)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.475` → IC=-0.195 (n=525)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1575)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.179 (n=569)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1719)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2586)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2732)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2738)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=19808)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=6919)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=21781)

- **FILTRO** `ibs_7min` < `0.2936` → IC=-0.237 (n=7175)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2936
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21525)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9710)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=18990)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.228 (n=8960)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=27001)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=8975)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=26986)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1122)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3564)

- **FILTRO** `ibs_7min` < `0.708` → IC=-0.258 (n=1546)

  - _Acción_: SKIP cuando `ibs_7min` < 0.708
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3140)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.180 (n=1141)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3545)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4178)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=2035)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.127 (n=2103)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4110)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.205 (n=1552)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4661)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3824)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1205)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3786)

- **FILTRO** `ibs_7min` < `0.7517` → IC=-0.188 (n=1247)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7517
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3744)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.175 (n=1241)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3750)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=1233)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3812)

- **FILTRO** `ibs_7min` > `0.2575` → IC=-0.174 (n=1261)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2575
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3784)

- **FILTRO** `ballena_activa_n` > `153.0` → IC=-0.185 (n=1261)

  - _Acción_: SKIP cuando `ballena_activa_n` > 153.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3784)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.170 (n=1263)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.083 (n=3162)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.312 (n=1076)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3349)

- **FILTRO** `ibs_7min` < `0.1961` → IC=-0.259 (n=1105)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1961
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3320)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1084)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3341)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1537)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=5052)

- **FILTRO** `ibs_7min` > `0.7598` → IC=-0.176 (n=1647)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7598
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=4942)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3199)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.247 (n=1159)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3558)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.180 (n=1177)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3540)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.179 (n=1150)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3567)
...
- **FILTRO** `ibs_7min` > `0.2744` → IC=-0.175 (n=1209)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3636)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.188 (n=1177)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3668)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.270 (n=1183)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3889)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.232 (n=1265)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3807)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1649)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5172)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.281 (n=1111)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3698)

- **FILTRO** `ibs_7min` < `0.71` → IC=-0.233 (n=1202)

  - _Acción_: SKIP cuando `ibs_7min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3607)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.213 (n=1157)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3652)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1599)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4849)
...
- **FILTRO** `sigma_h` < `0.0095` → IC=-0.205 (n=249)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2629)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1345)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=1353)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0042` → IC=+0.186 (n=454)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0042 (IC base=+0.185)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.219 (n=617)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0081 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.1625` → IC=+0.193 (n=1198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1625 (IC base=+0.185)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1333` → IC=+0.235 (n=458)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1333 (IC base=+0.185)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.196 (n=958)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 11.0 (IC base=+0.185)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.190 (n=646)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 6.0 (IC base=+0.185)

- **PATRÓN** `ibs_15` > `0.6154` → IC=+0.259 (n=1361)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6154 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` > `0.4417` → IC=+0.185 (n=316)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4417 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.5544` → IC=+0.173 (n=1342)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5544 (IC base=+0.185)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.106` → IC=+0.272 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.106 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `2964.2504` → IC=+0.193 (n=907)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.225 (n=216)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.207)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.209 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `drift_15min` |x|≤ `0.3791` → IC=+0.209 (n=108)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3791 (IC base=+0.207)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2571` → IC=+0.227 (n=108)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2571 (IC base=+0.207)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1506` → IC=+0.286 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1506 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.233 (n=298)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.207)

- **PATRÓN** `ibs_15` > `0.7064` → IC=+0.267 (n=324)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7064 (IC base=+0.207)

- **PATRÓN** `dist_vwap_pct` > `0.3842` → IC=+0.287 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3842 (IC base=+0.207)
...
- **PATRÓN** `libro_liquidez` > `14926.7198` → IC=+0.245 (n=147)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0714` → IC=+0.160 (n=139)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0714 (IC base=+0.138)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.157 (n=211)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.138)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.258` → IC=+0.167 (n=217)

  - _Acción_: Kelly boost +0.83€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.258 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.161 (n=234)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 11.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.139 (n=322)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 16.0 (IC base=+0.138)

- **PATRÓN** `ibs_15` > `0.6298` → IC=+0.230 (n=316)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6298 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.5233` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.5233 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1061` → IC=+0.165 (n=222)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1061 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.619` → IC=+0.210 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.619 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.151 (n=144)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.138)
...
- **FILTRO** `dist_vwap_pct` > `0.5742` → IC=-0.147 (n=117)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=720)
...
- **PATRÓN** `drift_60min` |x|≤ `0.085` → IC=+0.191 (n=163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.085 (IC base=+0.180)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0407` → IC=+0.187 (n=369)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.0407 (IC base=+0.180)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0933` → IC=+0.255 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0933 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.226 (n=184)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.180)

- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.276 (n=369)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.6231` → IC=+0.186 (n=431)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.6231 (IC base=+0.180)
...
- **PATRÓN** `libro_liquidez` > `2843.9766` → IC=+0.268 (n=123)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2843.9766 (IC base=+0.180)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.380 (n=165)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.340)

- **PATRÓN** `drift_60min` |x|≤ `0.1105` → IC=+0.349 (n=243)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1105 (IC base=+0.340)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.361 (n=242)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1476 (IC base=+0.340)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1356` → IC=+0.397 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1356 (IC base=+0.340)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.360 (n=363)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.340)

- **PATRÓN** `ibs_15` > `0.7863` → IC=+0.382 (n=363)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7863 (IC base=+0.340)

- **PATRÓN** `dist_vwap_pct` > `0.424` → IC=+0.381 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.424 (IC base=+0.340)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.08` → IC=+0.343 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.08 (IC base=+0.340)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.345 (n=444)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.340)

- **PATRÓN** `libro_liquidez` > `3507.1457` → IC=+0.357 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3507.1457 (IC base=+0.340)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.347 (n=181)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1519` → IC=+0.358 (n=181)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1519 (IC base=+0.347)

- **PATRÓN** `drift_15min` |x|≤ `0.4202` → IC=+0.349 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4202 (IC base=+0.347)

- **PATRÓN** `delta_ratio_macro` |x|> `0.152` → IC=+0.363 (n=137)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.152 (IC base=+0.347)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1284` → IC=+0.427 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1284 (IC base=+0.347)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.370 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.347)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.348 (n=215)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.347)

- **PATRÓN** `ibs_15` > `0.8112` → IC=+0.379 (n=205)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8112 (IC base=+0.347)

- **PATRÓN** `dist_vwap_pct` > `0.4016` → IC=+0.415 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4016 (IC base=+0.347)

- **PATRÓN** `sigma_ewma_delta_pct` > `21.152` → IC=+0.347 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 21.152 (IC base=+0.347)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.659` → IC=+0.353 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.659 (IC base=+0.347)

- **PATRÓN** `libro_liquidez` > `15484.5662` → IC=+0.373 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15484.5662 (IC base=+0.347)

- **PATRÓN** `ballena_activa_n` < `585.0` → IC=+0.406 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 585.0 (IC base=+0.347)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.365 (n=72)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.326)

- **PATRÓN** `drift_60min` |x|≤ `0.1062` → IC=+0.343 (n=106)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1062 (IC base=+0.326)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0624` → IC=+0.339 (n=159)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0624 (IC base=+0.326)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.298` → IC=+0.355 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.298 (IC base=+0.326)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.340 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.326)

- **PATRÓN** `ibs_15` > `0.7408` → IC=+0.388 (n=159)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7408 (IC base=+0.326)

- **PATRÓN** `dist_vwap_pct` > `0.4372` → IC=+0.340 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4372 (IC base=+0.326)

- **PATRÓN** `dist_vwap_pct` < `0.11` → IC=+0.344 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.11 (IC base=+0.326)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.196` → IC=+0.355 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.196 (IC base=+0.326)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.338 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.326)

- **PATRÓN** `libro_liquidez` > `3525.4286` → IC=+0.352 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3525.4286 (IC base=+0.326)

### UPDOWN_GBM_15M_TARDIO
- **FILTRO** `sigma_h` > `0.013` → IC=-0.214 (n=592)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1780)
...
- **FILTRO** `libro_liquidez` < `3895.4088` → IC=-0.133 (n=1565)

  - _Acción_: SKIP cuando `libro_liquidez` < 3895.4088
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=807)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.138` → IC=+0.263 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.138 (IC base=-0.059)

- **PATRÓN** `ibs_15` > `0.6314` → IC=+0.266 (n=583)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.215 (n=356)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.194 (n=1069)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.229 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=955)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.210 (n=899)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.180 (n=526)

- **FILTRO** `sigma_ewma_delta_pct` > `19.79` → IC=-0.244 (n=252)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.79
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1173)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.189 (n=133)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` < 0.0027 (IC base=+0.085)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2033` → IC=+0.268 (n=67)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2033 (IC base=+0.085)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1079` → IC=+0.357 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1079 (IC base=+0.085)

- **PATRÓN** `ibs_15` > `0.7466` → IC=+0.333 (n=148)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7466 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.1319` → IC=+0.298 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1319 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` < `0.5198` → IC=+0.278 (n=160)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.011` → IC=-0.133 (n=295)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.011
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2376)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.297 (n=200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0569` → IC=+0.322 (n=200)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0569 (IC base=+0.293)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1438` → IC=+0.298 (n=400)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.311 (n=629)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.293)

- **PATRÓN** `ibs_15` > `0.838` → IC=+0.331 (n=601)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.838 (IC base=+0.293)

- **PATRÓN** `dist_vwap_pct` > `0.2698` → IC=+0.333 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2698 (IC base=+0.293)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.294 (n=736)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `14356.961` → IC=+0.307 (n=200)
...
- **PATRÓN** `drift_60min` |x|≤ `0.058` → IC=+0.333 (n=112)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.058 (IC base=+0.284)

- **PATRÓN** `delta_ratio_macro` |x|> `0.26` → IC=+0.289 (n=112)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.303 (n=353)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.284)

- **PATRÓN** `ibs_15` > `0.8267` → IC=+0.311 (n=336)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8267 (IC base=+0.284)

- **PATRÓN** `dist_vwap_pct` > `0.2546` → IC=+0.356 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2546 (IC base=+0.284)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6154 sube el IC de +0.185 a +0.259 en UPDOWN_GBM#15min (n=1361). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7064 sube el IC de +0.207 a +0.267 en UPDOWN_GBM#BTC#15min (n=324). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6298 sube el IC de +0.138 a +0.230 en UPDOWN_GBM#ETH#15min (n=316). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.180 a +0.276 en UPDOWN_GBM#XRP#15min (n=369). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6314 sube el IC de -0.059 a +0.266 en UPDOWN_GBM_15M_TARDIO (n=583). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7466 sube el IC de +0.085 a +0.333 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=148). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.043 a +0.315 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=397). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.838 sube el IC de +0.293 a +0.331 en UPDOWN_GBM_IBS_ALTO (n=601). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8267 sube el IC de +0.284 a +0.311 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=336). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7863 sube el IC de +0.340 a +0.382 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=363). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min**: dentro de BUY_YES, IBS > 0.8112 sube el IC de +0.347 a +0.379 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min (n=205). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7408 sube el IC de +0.326 a +0.388 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=159). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1215 | +0.087 | +147.46€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1215 | +0.087 | +147.46€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 887 | +0.096 | +124.11€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 887 | +0.096 | +124.11€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 242 | +0.045 | +4.70€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 242 | +0.045 | +4.70€ | 4 | 5 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 22893 | -0.093 | -3087.73€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1374 | -0.041 | -199.60€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21519 | -0.096 | -2888.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3498 | -0.086 | -574.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3498 | -0.086 | -574.06€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6549 | -0.036 | -610.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6549 | -0.036 | -610.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6046 | -0.096 | -451.75€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6046 | -0.096 | -451.75€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5052 | -0.178 | -1091.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5052 | -0.178 | -1091.16€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15203 | -0.034 | +4134.56€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4012 | -0.003 | +1823.53€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11191 | -0.045 | +2311.02€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15203 | -0.034 | +4134.56€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4012 | -0.003 | +1823.53€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11191 | -0.045 | +2311.02€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1363 | -0.101 | -180.51€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 148 | -0.047 | -16.07€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1215 | -0.107 | -164.45€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 755 | -0.090 | -96.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 124 | -0.040 | -10.84€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 631 | -0.100 | -85.52€ | 2 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 83648 | +0.113 | -4230.38€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12857 | +0.184 | -396.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 328 | -0.106 | -45.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 64872 | +0.100 | -3606.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5591 | +0.111 | -181.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10798 | +0.097 | -959.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 42 | -0.159 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10741 | +0.099 | -946.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 16924 | +0.133 | -320.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4001 | +0.202 | -127.06€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10751 | +0.112 | -152.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2130 | +0.109 | -17.83€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10838 | +0.087 | -1062.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 49 | -0.069 | -3.34€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10774 | +0.089 | -1048.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 17859 | +0.124 | -336.98€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 