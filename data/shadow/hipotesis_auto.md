# Hipótesis automáticas — 2026-08-29 01:32 UTC
_Generado por shadow_postmortem.py sobre 195425 resoluciones (PNL=+14673.83€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.170 (n=89)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.275 (n=265)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.286 (n=180)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8178` → IC=+0.289 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8178 (IC base=+0.163)

- **PATRÓN** `banda_z` > `11.542` → IC=+0.291 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.542 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.188 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 7.0 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=278)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.163)

- **PATRÓN** `libro_liquidez` > `3094.8617` → IC=+0.240 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3094.8617 (IC base=+0.163)

- **PATRÓN** `ballena_activa_n` < `237.0` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 237.0 (IC base=+0.163)
...
- **PATRÓN** `py_entrada` > `0.715` → IC=+0.286 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.202)

- **PATRÓN** `n_ballena_banda` > `19.0` → IC=+0.219 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `n_ballena_banda` > 19.0 (IC base=+0.202)

- **PATRÓN** `n_total_lado` > `57.0` → IC=+0.255 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 57.0 (IC base=+0.202)

- **PATRÓN** `banda_hit_calibrado` > `0.8195` → IC=+0.298 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8195 (IC base=+0.202)

- **PATRÓN** `banda_z` > `11.818` → IC=+0.293 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.818 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.230 (n=161)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.217 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `3094.8617` → IC=+0.239 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3094.8617 (IC base=+0.202)

- **PATRÓN** `ballena_activa_n` < `250.0` → IC=+0.312 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 250.0 (IC base=+0.202)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.95` → IC=-0.285 (n=2731)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.95
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=8195)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `134.98` → IC=-0.273 (n=346)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.98
  - _Potencial_: sin este filtro IC_bueno=+0.038 (n=1038)
...
- **FILTRO** `restante_s_al_confirmar` < `116.1` → IC=-0.387 (n=352)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 116.1
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=1057)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `161.14` → IC=-0.155 (n=735)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.14
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2205)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `141.46` → IC=-0.310 (n=634)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 141.46
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1903)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.29` → IC=-0.351 (n=623)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.29
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1266)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=5898)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1689)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2375.6867` → IC=+0.171 (n=1626)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.207 (n=862)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=484)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.193 (n=190)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 7.0 (IC base=+0.132)

- **PATRÓN** `py_entrada` < `0.415` → IC=+0.173 (n=313)

  - _Acción_: Kelly boost +0.87€ cuando `py_entrada` < 0.415 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `4157.9328` → IC=+0.150 (n=295)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 4157.9328 (IC base=+0.132)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.127 (n=1110)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 15.0 (IC base=+0.125)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.317 (n=434)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.281 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.278 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2849.6913` → IC=+0.285 (n=328)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2849.6913 (IC base=+0.277)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.186 (n=683)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 12.0 (IC base=+0.186)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.444 (n=339)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.223 (n=319)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.226 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.220)

- **PATRÓN** `libro_liquidez` > `1958.7767` → IC=+0.236 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1958.7767 (IC base=+0.220)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=4136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.188)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=2318)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.177 (n=1063)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 15.0 (IC base=+0.167)

- **PATRÓN** `py_entrada` < `0.72` → IC=+0.177 (n=1062)
...
- **FILTRO** `libro_liquidez` < `11392.7892` → IC=-0.352 (n=59)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.171 (n=1043)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.166)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.172 (n=452)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.320 (n=398)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=1020)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 15.0 (IC base=+0.182)

- **PATRÓN** `py_entrada` < `0.729` → IC=+0.191 (n=1012)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.729 (IC base=+0.182)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.280 (n=1223)
...
- **PATRÓN** `py_entrada` > `0.76` → IC=+0.212 (n=803)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.288 (n=766)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.138 (n=1238)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 8.0 (IC base=+0.127)

- **PATRÓN** `lag_apertura_s` < `3.37` → IC=+0.174 (n=844)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.298 (n=633)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2018.5772` → IC=+0.297 (n=546)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.305 (n=291)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1758.8943` → IC=+0.308 (n=285)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9498` → IC=+0.207 (n=846)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9498 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.211` → IC=+0.229 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.211 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.268` → IC=+0.157 (n=1009)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 5.268 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6297` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6297 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `1.067` → IC=+0.233 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.067 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1716` → IC=+0.150 (n=404)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1716 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` < `2.423` → IC=+0.150 (n=1227)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.423 (IC base=+0.063)

- **PATRÓN** `ibs_20min` < `0.1158` → IC=+0.152 (n=1293)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.1158 (IC base=+0.031)

- **PATRÓN** `dist_vwap_pct` < `0.1358` → IC=+0.149 (n=819)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.1358 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` < `0.6181` → IC=+0.162 (n=282)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.6181 (IC base=+0.031)

- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.142 (n=384)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0471 (IC base=+0.031)
...
- **PATRÓN** `volumen_spike_ratio` > `2.9243` → IC=+0.236 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9243 (IC base=+0.031)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.235 (n=262)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.195 (n=188)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0075 (IC base=+0.130)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.169 (n=270)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2159` → IC=+0.163 (n=93)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.2159 (IC base=+0.130)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.160 (n=377)

  - _Acción_: Kelly boost +0.80€ cuando `libro_spread` < 0.04 (IC base=+0.130)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.137 (n=213)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 60.0 (IC base=+0.130)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.260 (n=223)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.254)

- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.291 (n=113)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0074 (IC base=+0.254)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.316 (n=112)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.254)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.261 (n=341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.254)

- **PATRÓN** `ibs_20min` < `0.4194` → IC=+0.290 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4194 (IC base=+0.254)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.818` → IC=+0.278 (n=362)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.818 (IC base=+0.254)

- **PATRÓN** `volumen_pendiente_norm` < `0.0647` → IC=+0.245 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0647 (IC base=+0.254)

- **PATRÓN** `volumen_pendiente_norm` > `0.3058` → IC=+0.311 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3058 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` < `1.8721` → IC=+0.260 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8721 (IC base=+0.254)

- **PATRÓN** `volumen_spike_ratio` > `2.8103` → IC=+0.308 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8103 (IC base=+0.254)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.296 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.254)

- **PATRÓN** `libro_liquidez` > `1950.776` → IC=+0.298 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1950.776 (IC base=+0.254)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.256 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.254)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0046` → IC=+0.222 (n=286)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.4091` → IC=+0.224 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4091 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.3135` → IC=+0.234 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3135 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.354` → IC=+0.223 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.354 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2608` → IC=+0.205 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2608 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `1.0807` → IC=+0.236 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0807 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` < `0.0948` → IC=+0.204 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0948 (IC base=+0.202)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4526` → IC=+0.256 (n=178)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4526 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `11693.3416` → IC=+0.214 (n=383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11693.3416 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.148 (n=495)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0059 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.1748` → IC=+0.151 (n=330)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1748 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=466)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.157 (n=522)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 18.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.4461` → IC=+0.182 (n=435)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.4461 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.1424` → IC=+0.171 (n=430)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1424 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.937` → IC=+0.228 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.937 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.6207` → IC=+0.191 (n=166)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6207 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0711` → IC=+0.211 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0711 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.7569` → IC=+0.176 (n=260)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.7569 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.171 (n=390)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=639)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `14033.7768` → IC=+0.199 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14033.7768 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `221.0` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 221.0 (IC base=+0.145)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.221 (n=181)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.958` → IC=+0.269 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.958 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.1358` → IC=+0.139 (n=405)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_pendiente_norm` < 0.1358 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.4132` → IC=+0.135 (n=61)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.4132 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7005` → IC=+0.143 (n=427)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.7005 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.174 (n=467)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.04 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.172 (n=199)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 46.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.289 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.249)

- **PATRÓN** `drift_60min` |x|≤ `0.461` → IC=+0.260 (n=393)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.461 (IC base=+0.249)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.249 (n=273)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.249)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.264 (n=405)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.249)

- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.290 (n=393)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.852` → IC=+0.252 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.852 (IC base=+0.249)

- **PATRÓN** `volumen_pendiente_norm` > `0.3914` → IC=+0.429 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3914 (IC base=+0.249)

- **PATRÓN** `volumen_spike_ratio` > `2.5543` → IC=+0.247 (n=180)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.172 (n=65)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=827)
...
- **PATRÓN** `dist_vwap_pct` > `0.2862` → IC=+0.196 (n=21)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.2862 (IC base=-0.049)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4256` → IC=+0.203 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4256 (IC base=-0.049)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.148 (n=86)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 142.0 (IC base=-0.049)
...
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.136 (n=676)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=721)

- **FILTRO** `sigma_ewma_delta_pct` > `5.036` → IC=-0.158 (n=296)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 5.036
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1101)
...
- **FILTRO** `drift_60min` |x|> `0.5425` → IC=-0.158 (n=252)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5425
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=491)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.201 (n=172)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=571)

- **FILTRO** `ibs_20min` > `0.7882` → IC=-0.176 (n=313)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7882
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=943)

- **FILTRO** `sigma_ewma_delta_pct` > `6.719` → IC=-0.152 (n=205)
...
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.135 (n=1449)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0078 (IC base=+0.053)

- **PATRÓN** `ibs_20min` > `0.9432` → IC=+0.245 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9432 (IC base=+0.053)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.115` → IC=+0.180 (n=1433)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` < 0.115 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.249` → IC=+0.203 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.249 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` < `1.4786` → IC=+0.205 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4786 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.8297` → IC=+0.179 (n=490)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.8297 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.276 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.053)

- **PATRÓN** `ibs_20min` < `0.0909` → IC=+0.195 (n=1299)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.0909 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `0.8093` → IC=+0.221 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8093 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` < `0.223` → IC=+0.215 (n=811)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.223 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` < `0.8592` → IC=+0.213 (n=549)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2573` → IC=+0.358 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2573 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` > `2.8751` → IC=+0.289 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8751 (IC base=+0.041)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.264 (n=604)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 60.0 (IC base=+0.041)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2448` → IC=-0.164 (n=224)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2448
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=457)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.349` → IC=+0.177 (n=128)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.349 (IC base=-0.004)
...
- **FILTRO** `ibs_20min` > `0.8836` → IC=-0.151 (n=293)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8836
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=882)

- **PATRÓN** `volumen_regimen` < `0.5584` → IC=+0.210 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5584 (IC base=-0.042)

- **PATRÓN** `volumen_spike_ratio` < `1.6985` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6985 (IC base=-0.042)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0756` → IC=+0.218 (n=168)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0756 (IC base=+0.194)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.200 (n=168)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.157` → IC=+0.300 (n=128)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.157 (IC base=+0.194)

- **PATRÓN** `volumen_pendiente_norm` < `0.1438` → IC=+0.204 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1438 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` < `2.52` → IC=+0.203 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.52 (IC base=+0.194)

- **PATRÓN** `volumen_spike_ratio` > `4.1701` → IC=+0.197 (n=140)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 4.1701 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.220 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `1934.3468` → IC=+0.206 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1934.3468 (IC base=+0.194)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.235 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 42.0 (IC base=+0.194)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.333 (n=261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.323)

- **PATRÓN** `drift_60min` |x|≤ `0.2567` → IC=+0.330 (n=198)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2567 (IC base=+0.323)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.348 (n=202)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.323)

- **PATRÓN** `ibs_20min` < `0.3333` → IC=+0.342 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3333 (IC base=+0.323)

- **PATRÓN** `ibs_20min` > `0.1304` → IC=+0.325 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1304 (IC base=+0.323)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.598` → IC=+0.334 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.598 (IC base=+0.323)

- **PATRÓN** `volumen_pendiente_norm` < `0.2265` → IC=+0.312 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2265 (IC base=+0.323)

- **PATRÓN** `volumen_pendiente_norm` > `0.3546` → IC=+0.389 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3546 (IC base=+0.323)

- **PATRÓN** `volumen_spike_ratio` < `1.7028` → IC=+0.314 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7028 (IC base=+0.323)

- **PATRÓN** `volumen_spike_ratio` > `2.433` → IC=+0.333 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.433 (IC base=+0.323)

- **PATRÓN** `libro_liquidez` > `1869.9762` → IC=+0.371 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1869.9762 (IC base=+0.323)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.325 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.323)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.180 (n=126)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.171 (n=68)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=962)
...
- **FILTRO** `ibs_20min` < `0.7451` → IC=-0.138 (n=467)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7451
  - _Potencial_: sin este filtro IC_bueno=+0.217 (n=242)

- **FILTRO** `ibs_20min` > `0.7551` → IC=-0.200 (n=231)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7551
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=695)
...
- **PATRÓN** `ibs_20min` > `0.8571` → IC=+0.268 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8571 (IC base=-0.016)

- **PATRÓN** `dist_vwap_pct` > `0.6608` → IC=+0.302 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6608 (IC base=-0.016)

- **PATRÓN** `volumen_regimen` < `0.8552` → IC=+0.186 (n=135)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.8552 (IC base=-0.016)

- **PATRÓN** `volumen_regimen` > `1.1437` → IC=+0.239 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1437 (IC base=-0.016)

- **PATRÓN** `volumen_pendiente_norm` < `0.1202` → IC=+0.179 (n=188)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` < 0.1202 (IC base=-0.016)

- **PATRÓN** `volumen_pendiente_norm` > `0.2306` → IC=+0.256 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2306 (IC base=-0.016)

- **PATRÓN** `volumen_spike_ratio` < `1.5512` → IC=+0.209 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5512 (IC base=-0.016)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.238 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 51.0 (IC base=-0.016)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0248` → IC=+0.328 (n=202)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0248 (IC base=+0.227)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.238 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.227)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.232 (n=285)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.227)
...
- **PATRÓN** `dist_vwap_pct` > `1.4364` → IC=+0.342 (n=131)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.4364 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.201` → IC=+0.278 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.201 (IC base=+0.227)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0807` → IC=+0.230 (n=517)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0807 (IC base=+0.227)

- **PATRÓN** `volumen_pendiente_norm` > `0.283` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.283 (IC base=+0.227)

- **PATRÓN** `volumen_spike_ratio` < `1.4247` → IC=+0.255 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4247 (IC base=+0.227)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.236 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.227)

- **PATRÓN** `libro_liquidez` > `2448.2154` → IC=+0.235 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2448.2154 (IC base=+0.227)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2933` → IC=+0.277 (n=420)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2788` → IC=+0.329 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2788 (IC base=+0.273)

- **PATRÓN** `dist_vwap_pct` < `0.272` → IC=+0.282 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.272 (IC base=+0.273)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.938` → IC=+0.324 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.938 (IC base=+0.273)

- **PATRÓN** `volumen_regimen` < `0.8838` → IC=+0.273 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8838 (IC base=+0.273)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.191 (n=908)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0103 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3384` → IC=+0.161 (n=2397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.3384 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.166 (n=2751)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 6.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.282 (n=1337)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.158)

- **PATRÓN** `dist_vwap_pct` > `1.1955` → IC=+0.256 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1955 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.426` → IC=+0.245 (n=1130)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.426 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` > `0.6224` → IC=+0.170 (n=1887)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.6224 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.239` → IC=+0.191 (n=513)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.239 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.2895` → IC=+0.159 (n=2173)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2895 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` > `1.8555` → IC=+0.153 (n=1646)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8555 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=2175)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `3206.2208` → IC=+0.183 (n=1235)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 3206.2208 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `109.0` → IC=+0.180 (n=1436)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 109.0 (IC base=+0.158)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.199 (n=1666)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.0814` → IC=+0.207 (n=833)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.185 (n=932)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 5.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` < `0.4118` → IC=+0.239 (n=2497)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4118 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.502` → IC=+0.208 (n=1053)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.502 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` < `1.1693` → IC=+0.169 (n=1969)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1693 (IC base=+0.184)

- **PATRÓN** `volumen_regimen` > `0.618` → IC=+0.168 (n=1968)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.618 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.258 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.5799` → IC=+0.177 (n=828)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.5799 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `2.6609` → IC=+0.208 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6609 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.190 (n=1283)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 120.0 (IC base=+0.184)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.158 (n=200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.271` → IC=+0.162 (n=445)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.271 (IC base=+0.154)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.210 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2094` → IC=+0.209 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2094 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.4412` → IC=+0.141 (n=366)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.4412 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.181 (n=308)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.04 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.250 (n=214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.251)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.267 (n=243)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.251)

- **PATRÓN** `drift_60min` |x|≤ `0.2618` → IC=+0.287 (n=214)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2618 (IC base=+0.251)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.273 (n=218)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.251)

- **PATRÓN** `ibs_20min` < `0.3945` → IC=+0.280 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3945 (IC base=+0.251)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.357` → IC=+0.269 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.357 (IC base=+0.251)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9491` → IC=+0.277 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9491 (IC base=+0.251)

- **PATRÓN** `volumen_spike_ratio` > `2.8455` → IC=+0.287 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8455 (IC base=+0.251)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.302 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.251)

- **PATRÓN** `libro_liquidez` > `1939.2468` → IC=+0.319 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1939.2468 (IC base=+0.251)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.235 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.251)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.196 (n=347)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0062 (IC base=+0.172)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.184 (n=131)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0072 (IC base=+0.172)

- **PATRÓN** `drift_60min` |x|≤ `0.4287` → IC=+0.178 (n=393)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.4287 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.199 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` > `0.6307` → IC=+0.225 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6307 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` > `0.2143` → IC=+0.234 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2143 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.599` → IC=+0.244 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.599 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` < `0.6383` → IC=+0.184 (n=131)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6383 (IC base=+0.172)

- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.200 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0844 (IC base=+0.172)

- **PATRÓN** `volumen_pendiente_norm` > `0.2234` → IC=+0.234 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2234 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.378` → IC=+0.234 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.378 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `12756.9562` → IC=+0.186 (n=262)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 12756.9562 (IC base=+0.172)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.171 (n=494)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0059 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.3` → IC=+0.167 (n=494)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=456)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` < `0.4271` → IC=+0.198 (n=494)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.4271 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.1641` → IC=+0.177 (n=493)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1641 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.387` → IC=+0.239 (n=109)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5679` → IC=+0.165 (n=386)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.5679 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4105` → IC=+0.149 (n=386)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4105 (IC base=+0.151)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1541` → IC=+0.179 (n=263)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.232 (n=151)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2298` → IC=+0.159 (n=335)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.2298 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` < `1.9664` → IC=+0.205 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9664 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=352)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `1946.061` → IC=+0.177 (n=131)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 1946.061 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.279 (n=287)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.255)

- **PATRÓN** `drift_60min` |x|≤ `0.2281` → IC=+0.294 (n=192)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.257 (n=290)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.255)

- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.312 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.131` → IC=+0.348 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.131 (IC base=+0.255)

- **PATRÓN** `volumen_pendiente_norm` > `0.3655` → IC=+0.419 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3655 (IC base=+0.255)

- **PATRÓN** `volumen_spike_ratio` > `3.139` → IC=+0.288 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.139 (IC base=+0.255)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.209 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 60.0 (IC base=+0.255)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0091` → IC=+0.209 (n=393)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0091 (IC base=+0.174)

- **PATRÓN** `drift_60min` |x|≤ `0.5012` → IC=+0.190 (n=392)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.5012 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.193 (n=405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 6.0 (IC base=+0.174)

- **PATRÓN** `ibs_20min` > `0.435` → IC=+0.228 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.435 (IC base=+0.174)

- **PATRÓN** `dist_vwap_pct` > `0.9808` → IC=+0.232 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9808 (IC base=+0.174)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.407` → IC=+0.333 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.407 (IC base=+0.174)

- **PATRÓN** `volumen_regimen` > `0.7015` → IC=+0.196 (n=350)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4303` → IC=+0.174 (n=127)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.4303 (IC base=+0.174)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=450)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.174)

- **PATRÓN** `libro_liquidez` > `12282.2056` → IC=+0.222 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12282.2056 (IC base=+0.174)

- **PATRÓN** `ballena_activa_n` < `111.0` → IC=+0.185 (n=144)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 111.0 (IC base=+0.174)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.237 (n=158)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.159 (n=473)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.381 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.161 (n=322)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.156 (n=178)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 5.0 (IC base=+0.141)

- **PATRÓN** `ibs_20min` < `0.3583` → IC=+0.208 (n=416)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3583 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.497` → IC=+0.191 (n=108)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.497 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.1654` → IC=+0.153 (n=473)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1654 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `0.5944` → IC=+0.153 (n=473)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.5944 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.1023` → IC=+0.162 (n=146)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.1023 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `1.9099` → IC=+0.175 (n=244)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 1.9099 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `2.5391` → IC=+0.161 (n=122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.5391 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `10944.7908` → IC=+0.163 (n=158)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 10944.7908 (IC base=+0.141)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.186 (n=243)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5588` → IC=+0.183 (n=535)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.5588 (IC base=+0.121)
...
- **PATRÓN** `volumen_regimen` > `0.6793` → IC=+0.144 (n=478)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.6793 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` < `0.1617` → IC=+0.135 (n=526)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1617 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4402` → IC=+0.129 (n=168)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4402 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.5512` → IC=+0.130 (n=449)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.5512 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `3239.7916` → IC=+0.224 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3239.7916 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.005` → IC=+0.169 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.005 (IC base=+0.136)

- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.204 (n=150)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0107 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.203 (n=220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 14.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.4107` → IC=+0.237 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4107 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.9932` → IC=+0.144 (n=57)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9932 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.218` → IC=+0.193 (n=177)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 3.218 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.1404` → IC=+0.146 (n=450)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.1404 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `0.8355` → IC=+0.172 (n=300)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8355 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.203 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.4538` → IC=+0.151 (n=107)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4538 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `2.273` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.273 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `2131.3425` → IC=+0.189 (n=300)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 2131.3425 (IC base=+0.136)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0238` → IC=+0.196 (n=258)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0238 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.1648` → IC=+0.202 (n=250)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1648 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.202 (n=203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.907` → IC=+0.268 (n=378)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.236 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.169 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6073` → IC=+0.182 (n=567)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6073 (IC base=+0.169)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.187 (n=465)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=569)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `2449.1286` → IC=+0.173 (n=567)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2449.1286 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.281 (n=244)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.6757` → IC=+0.229 (n=556)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.255 (n=259)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.38` → IC=+0.260 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.38 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.223` → IC=+0.281 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.223 (IC base=+0.220)

- **PATRÓN** `volumen_regimen` > `0.6925` → IC=+0.242 (n=494)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6925 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.2801` → IC=+0.359 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2801 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `2.6928` → IC=+0.250 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6928 (IC base=+0.220)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.006` → IC=+0.143 (n=354)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.006 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.192 (n=258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 16.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.6191` → IC=+0.170 (n=474)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.6191 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8872` → IC=+0.259 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8872 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.176` → IC=+0.187 (n=145)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 8.176 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.2898` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2898 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=394)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2614.875` → IC=+0.135 (n=354)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 2614.875 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.3128` → IC=+0.137 (n=340)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.3128 (IC base=+0.057)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.783` → IC=+0.138 (n=114)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 7.783 (IC base=+0.057)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.150 (n=121)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 13.0 (IC base=+0.057)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.221 (n=59)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.099)

- **PATRÓN** `drift_60min` |x|≤ `0.3657` → IC=+0.131 (n=177)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.3657 (IC base=+0.099)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.161 (n=60)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 4.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` < `0.6123` → IC=+0.171 (n=156)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6123 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.767` → IC=+0.209 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.767 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` < `1.1856` → IC=+0.126 (n=177)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.1856 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.1503` → IC=+0.304 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1503 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` < `1.7336` → IC=+0.149 (n=112)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.7336 (IC base=+0.099)

- **PATRÓN** `ballena_activa_n` < `327.0` → IC=+0.120 (n=127)

  - _Acción_: Kelly boost +0.60€ cuando `ballena_activa_n` < 327.0 (IC base=+0.099)
...
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.357 (n=26)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.015)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.159 (n=42)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 13.0 (IC base=+0.015)

- **PATRÓN** `volumen_regimen` < `0.6982` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.6982 (IC base=+0.015)

- **PATRÓN** `libro_liquidez` > `9139.2638` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9139.2638 (IC base=+0.015)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=41)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 15.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.9524` → IC=+0.167 (n=40)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.9524 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.718` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.718 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.7885` → IC=+0.123 (n=59)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.7885 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.2212` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2212 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=97)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `2433.8345` → IC=+0.122 (n=88)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 2433.8345 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 13.0 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.0588` → IC=+0.250 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0588 (IC base=+0.059)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.185 (n=2123)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0066 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.159 (n=3235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 6.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.289 (n=1444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `1.1268` → IC=+0.240 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1268 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.529` → IC=+0.229 (n=1853)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.529 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `0.6983` → IC=+0.151 (n=988)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6983 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `1.0786` → IC=+0.154 (n=1017)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0786 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.176 (n=825)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.3115` → IC=+0.152 (n=2519)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.3115 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.8689` → IC=+0.159 (n=1908)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8689 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.156 (n=2539)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `2477.03` → IC=+0.176 (n=2121)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2477.03 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `141.0` → IC=+0.189 (n=1591)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 141.0 (IC base=+0.151)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.215 (n=1964)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.4823` → IC=+0.199 (n=2945)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4823 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.210 (n=1048)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` < `0.5624` → IC=+0.244 (n=2945)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5624 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` < `0.4386` → IC=+0.181 (n=2194)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.4386 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.418` → IC=+0.206 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.418 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.655` → IC=+0.193 (n=2766)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 2.655 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` < `0.6179` → IC=+0.185 (n=726)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6179 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` > `1.1988` → IC=+0.174 (n=725)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.1988 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.271 (n=325)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.3029` → IC=+0.208 (n=1018)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3029 (IC base=+0.189)

- **PATRÓN** `ballena_activa_n` < `172.0` → IC=+0.169 (n=1818)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.173 (n=350)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.347` → IC=+0.306 (n=308)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.347 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2139` → IC=+0.233 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2139 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.9148` → IC=+0.151 (n=293)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.9148 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.200 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.283 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.264)

- **PATRÓN** `drift_60min` |x|≤ `0.3357` → IC=+0.274 (n=343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3357 (IC base=+0.264)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.265 (n=308)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.264)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.280 (n=239)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 11.0 (IC base=+0.264)

- **PATRÓN** `ibs_20min` < `0.562` → IC=+0.303 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.562 (IC base=+0.264)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.116` → IC=+0.284 (n=373)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.319 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7667 (IC base=+0.264)
...
- **PATRÓN** `libro_liquidez` > `1960.7048` → IC=+0.310 (n=114)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1960.7048 (IC base=+0.264)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.242 (n=161)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4191` → IC=+0.156 (n=509)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4191 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.182 (n=460)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 8.0 (IC base=+0.154)

- **PATRÓN** `ibs_20min` > `0.3307` → IC=+0.208 (n=509)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.582` → IC=+0.206 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.582 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.161 (n=509)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2673 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.0896` → IC=+0.174 (n=231)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0896 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.0723` → IC=+0.173 (n=411)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` < 0.0723 (IC base=+0.154)
...
- **PATRÓN** `volumen_spike_ratio` < `2.413` → IC=+0.186 (n=460)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.413 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.3655` → IC=+0.175 (n=460)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.3655 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `14489.7584` → IC=+0.178 (n=231)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 14489.7584 (IC base=+0.154)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.176 (n=492)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2779` → IC=+0.179 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2779 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=459)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.184 (n=507)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.3935` → IC=+0.218 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3935 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.183 (n=440)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.78` → IC=+0.216 (n=125)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.146` → IC=+0.283 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.146 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.7532` → IC=+0.198 (n=263)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.7532 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=634)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `13319.6098` → IC=+0.183 (n=222)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 13319.6098 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `307.0` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 307.0 (IC base=+0.168)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.300 (n=143)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.2115` → IC=+0.240 (n=286)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2115 (IC base=+0.238)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.284 (n=165)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.238)

- **PATRÓN** `ibs_20min` < `0.5536` → IC=+0.302 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5536 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.133` → IC=+0.262 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.133 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.3562` → IC=+0.316 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3562 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `1.7651` → IC=+0.240 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7651 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.3638` → IC=+0.204 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3638 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.271 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.238)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.187 (n=196)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 58.0 (IC base=+0.238)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.155 (n=511)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0089 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.1491` → IC=+0.143 (n=225)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.1491 (IC base=+0.141)
...
- **PATRÓN** `ibs_20min` > `0.3436` → IC=+0.193 (n=510)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.3436 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.8501` → IC=+0.217 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8501 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.492` → IC=+0.188 (n=245)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 4.492 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.9051` → IC=+0.165 (n=341)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.9051 (IC base=+0.141)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2692` → IC=+0.256 (n=80)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2692 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `2.1158` → IC=+0.224 (n=215)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1158 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `5139.067` → IC=+0.219 (n=340)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5139.067 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.181 (n=258)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 162.0 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.168 (n=390)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0076 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.5023` → IC=+0.161 (n=443)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.5023 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.187 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6499` → IC=+0.183 (n=443)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6499 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1732` → IC=+0.152 (n=202)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1732 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.385` → IC=+0.212 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.385 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.5754` → IC=+0.167 (n=148)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.5754 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `1.1518` → IC=+0.173 (n=148)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.1518 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2393` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2393 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `2.4896` → IC=+0.202 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4896 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `9816.3464` → IC=+0.200 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9816.3464 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `134.0` → IC=+0.209 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 134.0 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` > `0.4841` → IC=+0.178 (n=566)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4841 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.9104` → IC=+0.229 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9104 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.432` → IC=+0.224 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.432 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2971.9712` → IC=+0.270 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2971.9712 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.158 (n=340)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1241` → IC=+0.152 (n=176)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1241 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=252)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.5918` → IC=+0.203 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5918 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.5071` → IC=+0.137 (n=502)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.5071 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.086` → IC=+0.138 (n=515)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 3.086 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `0.7061` → IC=+0.154 (n=232)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7061 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.0713` → IC=+0.167 (n=154)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0713 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `2.108` → IC=+0.141 (n=332)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.108 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `1.4382` → IC=+0.145 (n=378)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4382 (IC base=+0.116)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=550)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2692.6188` → IC=+0.164 (n=239)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 2692.6188 (IC base=+0.116)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0272` → IC=+0.221 (n=220)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0272 (IC base=+0.179)
...
- **PATRÓN** `ibs_20min` > `0.9609` → IC=+0.297 (n=299)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9609 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `1.0343` → IC=+0.282 (n=177)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0343 (IC base=+0.179)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.12` → IC=+0.251 (n=343)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1708` → IC=+0.242 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1708 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `1.8195` → IC=+0.192 (n=407)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.8195 (IC base=+0.179)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.186 (n=786)

  - _Acción_: Kelly boost +0.93€ cuando `libro_spread` < 0.02 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `2449.769` → IC=+0.181 (n=660)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 2449.769 (IC base=+0.179)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4903` → IC=+0.226 (n=632)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` > `2.2111` → IC=+0.227 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2111 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.185 (n=440)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.144 (n=1264)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.160 (n=301)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 18.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.9104` → IC=+0.175 (n=290)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.9104 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `1.497` → IC=+0.144 (n=133)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 1.497 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.243` → IC=+0.167 (n=160)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.243 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `1.4448` → IC=+0.149 (n=286)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4448 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` > `2.6098` → IC=+0.132 (n=286)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.6098 (IC base=+0.106)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.193 (n=320)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0037 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3807` → IC=+0.164 (n=845)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3807 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.156 (n=373)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 17.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.190 (n=337)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 4.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.1951` → IC=+0.157 (n=423)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.1951 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.093` → IC=+0.141 (n=960)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.093 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.1963` → IC=+0.152 (n=354)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1963 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.074` → IC=+0.152 (n=962)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.074 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2072` → IC=+0.149 (n=935)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2072 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.1461` → IC=+0.147 (n=962)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.1461 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.5268` → IC=+0.156 (n=952)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5268 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.423` → IC=+0.147 (n=951)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.423 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.144 (n=1264)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `10610.2274` → IC=+0.146 (n=640)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 10610.2274 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5292` → IC=+0.160 (n=51)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5292 (IC base=+0.065)

- **PATRÓN** `libro_liquidez` > `12609.7541` → IC=+0.147 (n=114)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 12609.7541 (IC base=+0.065)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.194 (n=230)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0036 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.3904` → IC=+0.148 (n=523)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3904 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=202)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 17.0 (IC base=+0.139)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.180 (n=192)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 5.0 (IC base=+0.139)

- **PATRÓN** `ibs_20min` < `0.1706` → IC=+0.168 (n=230)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.1706 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.3794` → IC=+0.140 (n=348)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.3794 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.6838` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.6838 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.265` → IC=+0.158 (n=522)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.265 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.153 (n=523)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1847 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0692` → IC=+0.169 (n=246)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.0692 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.538` → IC=+0.151 (n=520)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.538 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.8071` → IC=+0.150 (n=347)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.8071 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `12002.2454` → IC=+0.146 (n=467)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 12002.2454 (IC base=+0.139)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.180 (n=120)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0093 (IC base=+0.127)

- **PATRÓN** `drift_60min` |x|≤ `0.3313` → IC=+0.131 (n=120)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.3313 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.204 (n=123)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` > `0.9386` → IC=+0.258 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9386 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.006` → IC=+0.293 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.006 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.2079` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2079 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `2.2663` → IC=+0.145 (n=119)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.2663 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `1906.4743` → IC=+0.154 (n=180)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 1906.4743 (IC base=+0.127)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.159 (n=306)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0093 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.5361` → IC=+0.146 (n=306)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.5361 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.192 (n=115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 18.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `0.1665` → IC=+0.143 (n=306)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.1665 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.9122` → IC=+0.176 (n=72)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.9122 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.2211` → IC=+0.137 (n=260)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.2211 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.974` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 10.974 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.266` → IC=+0.138 (n=269)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 4.266 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.7231` → IC=+0.157 (n=135)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.7231 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` < `0.1178` → IC=+0.134 (n=274)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1178 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.1754` → IC=+0.139 (n=95)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` > 0.1754 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` < `1.426` → IC=+0.167 (n=100)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.426 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `1.8484` → IC=+0.135 (n=198)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.8484 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `8994.0735` → IC=+0.151 (n=273)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8994.0735 (IC base=+0.128)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.144 (n=276)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0088 (IC base=+0.134)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.140 (n=184)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0062 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.5277` → IC=+0.176 (n=276)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.5277 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.161 (n=184)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 10.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6178` → IC=+0.141 (n=243)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.6178 (IC base=+0.134)

- **PATRÓN** `ibs_20min` > `0.1102` → IC=+0.155 (n=276)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.1102 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.1503` → IC=+0.151 (n=104)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1503 (IC base=+0.134)
...
- **PATRÓN** `volumen_regimen` < `1.1919` → IC=+0.155 (n=276)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1919 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` < `0.1338` → IC=+0.160 (n=280)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1338 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` < `2.1843` → IC=+0.176 (n=239)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.1843 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4499` → IC=+0.159 (n=271)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.4499 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `10385.425` → IC=+0.138 (n=92)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 10385.425 (IC base=+0.134)
...
- **PATRÓN** `sigma_h` < `0.0054` → IC=+0.193 (n=161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0054 (IC base=+0.079)

- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.237 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6789 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `0.129` → IC=+0.184 (n=74)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.129 (IC base=+0.079)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.183` → IC=+0.242 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.183 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` < `0.5932` → IC=+0.135 (n=50)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.5932 (IC base=+0.079)

- **PATRÓN** `volumen_regimen` > `1.1731` → IC=+0.173 (n=50)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.1731 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` < `0.0847` → IC=+0.267 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0847 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.2652` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2652 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.266 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.079)

- **PATRÓN** `volumen_spike_ratio` > `1.4971` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4971 (IC base=+0.079)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.169 (n=134)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.02 (IC base=+0.079)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.339 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0028 (IC base=+0.078)

- **PATRÓN** `ibs_20min` > `0.8088` → IC=+0.226 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8088 (IC base=+0.078)

- **PATRÓN** `dist_vwap_pct` > `0.1647` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1647 (IC base=+0.078)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.19` → IC=+0.132 (n=36)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` > 5.19 (IC base=+0.078)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.186 (n=84)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0059 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=90)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.128)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.126 (n=97)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 17.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.364 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.1092` → IC=+0.217 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1092 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.06` → IC=+0.324 (n=49)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.06 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.6219` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6219 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `1.0933` → IC=+0.250 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0933 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `2484.2771` → IC=+0.267 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2484.2771 (IC base=+0.128)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.132 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 12.0 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.659` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.659 (IC base=+0.037)

- **PATRÓN** `libro_liquidez` > `3314.3277` → IC=+0.127 (n=81)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 3314.3277 (IC base=+0.037)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=620)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=499)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.172 (n=955)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2890)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.207 (n=974)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=2954)

- **FILTRO** `ibs_20min` > `0.27` → IC=-0.171 (n=981)

  - _Acción_: SKIP cuando `ibs_20min` > 0.27
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=2947)
...
- **FILTRO** `py_entrada` > `0.67` → IC=-0.150 (n=161)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=520)

- **FILTRO** `ibs_20min` > `0.75` → IC=-0.155 (n=169)

  - _Acción_: SKIP cuando `ibs_20min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=512)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.133 (n=175)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=413)

- **FILTRO** `py_entrada` < `0.43` → IC=-0.204 (n=187)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=401)

- **FILTRO** `ibs_20min` < `0.7273` → IC=-0.191 (n=147)
...
- **FILTRO** `ibs_20min` > `0.7304` → IC=-0.225 (n=165)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.137 (n=180)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=508)
...
- **FILTRO** `py_entrada` > `0.62` → IC=-0.209 (n=149)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=479)

- **FILTRO** `ibs_20min` > `0.2759` → IC=-0.158 (n=156)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2759
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=472)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.217 (n=157)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=486)

- **FILTRO** `ibs_20min` < `0.755` → IC=-0.148 (n=160)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.135 (n=2422)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=7307)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.282 (n=2389)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=7340)

- **FILTRO** `ibs_7min` < `0.7292` → IC=-0.236 (n=2432)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7292
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=7297)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.172 (n=3271)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=6458)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=2959)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=8913)

- **FILTRO** `ibs_7min` > `0.7164` → IC=-0.173 (n=2966)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7164
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=8906)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.315 (n=327)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=999)

- **FILTRO** `ibs_7min` < `1.0` → IC=-0.190 (n=930)

  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=396)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.248 (n=315)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1011)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.226 (n=491)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1556)

- **FILTRO** `drift_7min_pct` |x|> `0.132` → IC=-0.139 (n=694)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.132
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1353)

- **FILTRO** `ibs_7min` > `0.704` → IC=-0.170 (n=695)

  - _Acción_: SKIP cuando `ibs_7min` > 0.704
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1352)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=401)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1474)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.253 (n=448)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1427)

- **FILTRO** `ibs_7min` < `0.7915` → IC=-0.187 (n=468)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7915
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1407)

- **FILTRO** `ballena_activa_n` > `163.0` → IC=-0.192 (n=465)

  - _Acción_: SKIP cuando `ballena_activa_n` > 163.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1410)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.219 (n=460)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1415)

- **FILTRO** `ballena_activa_n` > `98.0` → IC=-0.166 (n=633)

  - _Acción_: SKIP cuando `ballena_activa_n` > 98.0
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=1242)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.198 (n=339)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1074)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.314 (n=455)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=958)

- **FILTRO** `ibs_7min` < `0.2184` → IC=-0.289 (n=353)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2184
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=1060)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.271 (n=347)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1066)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.248 (n=450)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=1637)

- **FILTRO** `ibs_7min` > `0.8117` → IC=-0.188 (n=521)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8117
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=1566)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.148 (n=490)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=1147)

- **FILTRO** `py_entrada` < `0.44` → IC=-0.214 (n=786)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=851)

- **FILTRO** `ibs_7min` < `0.7576` → IC=-0.191 (n=409)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7576
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1228)

- **FILTRO** `ballena_activa_n` > `42.0` → IC=-0.200 (n=404)

  - _Acción_: SKIP cuando `ballena_activa_n` > 42.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1233)
...
- **FILTRO** `ibs_7min` > `0.1821` → IC=-0.166 (n=554)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1821
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1078)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.172 (n=550)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=1082)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.231 (n=459)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1417)

- **FILTRO** `ibs_7min` < `0.7692` → IC=-0.203 (n=460)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7692
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1416)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.184 (n=466)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1410)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.186 (n=533)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1667)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.123 (n=521)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1081)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.300 (n=388)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1214)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.234 (n=396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1206)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.272 (n=410)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=1621)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.173 (n=505)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1526)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.127 (n=660)
...
- **PATRÓN** `streak_estiramiento` < `0.2602` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `streak_estiramiento` < 0.2602 (IC base=+0.012)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.171 (n=71)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` < 5.0 (IC base=+0.069)

### STRUCT_NO_15M#BTC#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=1251)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=717)
...
- **FILTRO** `sigma_ewma_delta_pct` > `10.068` → IC=-0.125 (n=86)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 10.068
...
- **PATRÓN** `drift_60min` |x|≤ `0.1163` → IC=+0.339 (n=110)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1163 (IC base=+0.309)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1505` → IC=+0.329 (n=109)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1505 (IC base=+0.309)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.343 (n=151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.309)

- **PATRÓN** `ibs_15` > `0.814` → IC=+0.352 (n=147)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.814 (IC base=+0.309)

- **PATRÓN** `dist_vwap_pct` > `0.4534` → IC=+0.354 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4534 (IC base=+0.309)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.649` → IC=+0.322 (n=99)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.649 (IC base=+0.309)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.309 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.309)

- **PATRÓN** `libro_liquidez` > `7219.8643` → IC=+0.331 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7219.8643 (IC base=+0.309)

- **PATRÓN** `ballena_activa_n` < `528.0` → IC=+0.360 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 528.0 (IC base=+0.309)

### UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1971` → IC=+0.298 (n=82)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.294 (n=32)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.286)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.379 (n=31)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.286)

- **PATRÓN** `drift_60min` |x|≤ `0.1871` → IC=+0.302 (n=94)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1871 (IC base=+0.286)

- **PATRÓN** `drift_15min` |x|≤ `0.4136` → IC=+0.314 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4136 (IC base=+0.286)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.400 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.286)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.322 (n=99)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.286)

- **PATRÓN** `ibs_15` > `0.8374` → IC=+0.337 (n=84)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8374 (IC base=+0.286)

- **PATRÓN** `dist_vwap_pct` > `0.4531` → IC=+0.385 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4531 (IC base=+0.286)

- **PATRÓN** `sigma_ewma_delta_pct` < `8.389` → IC=+0.292 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 8.389 (IC base=+0.286)

- **PATRÓN** `libro_liquidez` > `9173.8264` → IC=+0.322 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9173.8264 (IC base=+0.286)

- **PATRÓN** `ballena_activa_n` < `581.0` → IC=+0.402 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 581.0 (IC base=+0.286)
...
- **FILTRO** `sigma_h` > `0.01` → IC=-0.178 (n=268)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.696` → IC=-0.175 (n=364)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.696
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2774)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.357` → IC=+0.142 (n=146)

  - _Acción_: Kelly boost +0.71€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.357 (IC base=-0.066)

- **PATRÓN** `ibs_15` > `0.4601` → IC=+0.156 (n=309)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` > 0.4601 (IC base=-0.066)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0648` → IC=+0.252 (n=216)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0648 (IC base=-0.075)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1081` → IC=+0.292 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1081 (IC base=-0.075)

- **PATRÓN** `ibs_15` < `0.3707` → IC=+0.313 (n=217)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3707 (IC base=-0.075)

- **PATRÓN** `dist_vwap_pct` < `0.1474` → IC=+0.257 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1474 (IC base=-0.075)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.264 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=-0.075)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0075` → IC=-0.248 (n=169)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0075
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=508)

- **FILTRO** `sigma_h` < `0.0036` → IC=-0.220 (n=223)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0036
  - _Potencial_: sin este filtro IC_bueno=-0.208 (n=454)

- **FILTRO** `hora_utc` > `17.0` → IC=-0.260 (n=144)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.199 (n=533)

- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.266 (n=126)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.895
  - _Potencial_: sin este filtro IC_bueno=-0.200 (n=551)

- **FILTRO** `libro_liquidez` < `15344.7263` → IC=-0.221 (n=446)

  - _Acción_: SKIP cuando `libro_liquidez` < 15344.7263
...
- **PATRÓN** `drift_60min` |x|≤ `0.0637` → IC=+0.194 (n=47)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.0637 (IC base=+0.048)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3719` → IC=+0.214 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3719 (IC base=+0.048)

- **PATRÓN** `ibs_15` > `0.4704` → IC=+0.186 (n=138)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.93€ cuando `ibs_15` > 0.4704 (IC base=+0.048)

- **PATRÓN** `libro_liquidez` > `10408.2229` → IC=+0.192 (n=63)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 10408.2229 (IC base=+0.048)
...
- **FILTRO** `sigma_h` > `0.011` → IC=-0.242 (n=64)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.011
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=196)

- **FILTRO** `drift_15min` |x|> `0.7956` → IC=-0.227 (n=64)
  - _Por qué funciona_: drift fuerte en 15min → momentum reciente ya en el precio Polymarket
  - _Acción_: SKIP cuando `drift_15min` |x|> 0.7956
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=196)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2134` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2134 (IC base=-0.057)

- **PATRÓN** `ibs_15` < `0.2796` → IC=+0.225 (n=38)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_ewma_delta_pct` > `14.844` → IC=-0.218 (n=37)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 14.844
  - _Potencial_: sin este filtro IC_bueno=-0.150 (n=241)
...
- **FILTRO** `libro_liquidez` < `2497.8056` → IC=-0.232 (n=69)

  - _Acción_: SKIP cuando `libro_liquidez` < 2497.8056
  - _Potencial_: sin este filtro IC_bueno=-0.135 (n=209)
...
- **PATRÓN** `ibs_15` > `0.1321` → IC=+0.367 (n=28)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.1321 (IC base=-0.066)

### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.279 (n=260)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.292 (n=118)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1879` → IC=+0.310 (n=119)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1879 (IC base=+0.279)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.352 (n=52)
...
- **PATRÓN** `ibs_15` > `0.9676` → IC=+0.350 (n=118)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9676 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.5196` → IC=+0.365 (n=72)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5196 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` < `13.643` → IC=+0.286 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 13.643 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.279 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `11817.8916` → IC=+0.317 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11817.8916 (IC base=+0.279)
...
- **PATRÓN** `drift_60min` |x|≤ `0.162` → IC=+0.294 (n=129)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.162 (IC base=+0.267)

- **PATRÓN** `drift_15min` |x|≤ `0.6649` → IC=+0.271 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.6649 (IC base=+0.267)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2616` → IC=+0.304 (n=49)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2616 (IC base=+0.267)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.328 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.267)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.295 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.267)

- **PATRÓN** `ibs_15` > `0.968` → IC=+0.314 (n=68)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.968 (IC base=+0.267)

- **PATRÓN** `dist_vwap_pct` > `0.3582` → IC=+0.364 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3582 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.453` → IC=+0.271 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.453 (IC base=+0.267)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.649` → IC=+0.287 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.649 (IC base=+0.267)

- **PATRÓN** `libro_liquidez` > `13285.6042` → IC=+0.297 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13285.6042 (IC base=+0.267)

### UPDOWN_GBM_IBS_ALTO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.302 (n=114)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.291)

- **PATRÓN** `drift_60min` |x|≤ `0.0637` → IC=+0.346 (n=50)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0637 (IC base=+0.291)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0673` → IC=+0.317 (n=102)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0673 (IC base=+0.291)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3059` → IC=+0.338 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3059 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.325 (n=118)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.291)

- **PATRÓN** `ibs_15` > `0.8687` → IC=+0.327 (n=102)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8687 (IC base=+0.291)

- **PATRÓN** `dist_vwap_pct` > `0.6569` → IC=+0.380 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6569 (IC base=+0.291)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.08` → IC=+0.296 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.08 (IC base=+0.291)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.300 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `9906.9054` → IC=+0.370 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9906.9054 (IC base=+0.291)

- **PATRÓN** `ballena_activa_n` < `107.0` → IC=+0.367 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` <