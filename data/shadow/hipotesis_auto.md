# Hipótesis automáticas — 2026-08-09 19:24 UTC
_Generado por shadow_postmortem.py sobre 100162 resoluciones (PNL=+14307.07€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.228 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.138)

- **PATRÓN** `restante_min` < `4.57` → IC=+0.154 (n=544)

  - _Acción_: Kelly boost +0.77€ cuando `restante_min` < 4.57 (IC base=+0.138)

- **PATRÓN** `restante_min` > `4.83` → IC=+0.139 (n=372)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` > 4.83 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.152 (n=828)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 7.0 (IC base=+0.138)

- **PATRÓN** `lag_apertura_s` < `9.82` → IC=+0.140 (n=359)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 9.82 (IC base=+0.138)

- **PATRÓN** `profundidad_ratio_no` > `16.5` → IC=+0.164 (n=275)

  - _Acción_: Kelly boost +0.82€ cuando `profundidad_ratio_no` > 16.5 (IC base=+0.138)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.263 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.122)

- **PATRÓN** `restante_min` < `3.91` → IC=+0.147 (n=182)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` < 3.91 (IC base=+0.122)

- **PATRÓN** `restante_min` > `4.85` → IC=+0.123 (n=144)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` > 4.85 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.133 (n=415)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.182 (n=375)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` < 0.43 (IC base=+0.153)

- **PATRÓN** `restante_min` < `4.94` → IC=+0.163 (n=411)

  - _Acción_: Kelly boost +0.82€ cuando `restante_min` < 4.94 (IC base=+0.153)

- **PATRÓN** `restante_min` > `4.12` → IC=+0.156 (n=364)

  - _Acción_: Kelly boost +0.78€ cuando `restante_min` > 4.12 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.170 (n=413)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 7.0 (IC base=+0.153)

- **PATRÓN** `lag_apertura_s` < `49.33` → IC=+0.154 (n=359)

  - _Acción_: Kelly boost +0.77€ cuando `lag_apertura_s` < 49.33 (IC base=+0.153)

- **PATRÓN** `profundidad_ratio_no` > `23.8` → IC=+0.210 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 23.8 (IC base=+0.153)
...
- **PATRÓN** `hora_utc` > `10.0` → IC=+0.167 (n=28)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 10.0 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.379` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 5.379 (IC base=+0.069)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.069)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.132 (n=85)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 14.0 (IC base=+0.055)
...
| ✅ BALLENAS_TARDIAS | 2637 | -0.074 | -599.37€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 449 | +0.218 | -41.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2188 | -0.134 | -558.12€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB | 376 | -0.280 | -100.84€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#BNB#5min | 376 | -0.280 | -100.84€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 449 | +0.218 | -41.25€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 449 | +0.218 | -41.25€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#DOGE | 337 | -0.134 | -79.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 337 | -0.134 | -79.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 466 | +0.021 | -19.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 466 | +0.021 | -19.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 493 | -0.094 | -67.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 493 | -0.094 | -67.68€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP | 516 | -0.203 | -290.06€ | 0 | 0 |
| 🚫 BALLENAS_TARDIAS#XRP#5min | 516 | -0.203 | -290.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 27461 | +0.119 | -675.20€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6469 | +0.195 | -122.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 449 | +0.045 | -43.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 18568 | +0.092 | -554.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 1975 | +0.137 | +45.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2977 | +0.083 | -167.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 12 | +0.000 | -1.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2960 | +0.084 | -168.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5880 | +0.131 | -93.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2021 | +0.184 | -99.51€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 145 | +0.051 | -15.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2967 | +0.095 | -44.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 747 | +0.146 | +66.14€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2977 | +0.080 | -167.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.222 | +8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2960 | +0.079 | -177.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6342 | +0.136 | -25.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2176 | +0.196 | +5.03€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 148 | -0.020 | -32.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3371 | +0.104 | -10.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 647 | +0.130 | +12.61€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6279 | +0.134 | -206.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2204 | +0.206 | -33.45€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 148 | +0.100 | +1.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 