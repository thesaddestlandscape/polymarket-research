# Hipótesis automáticas — 2026-06-30 00:10 UTC
_Generado por shadow_postmortem.py sobre 1334 resoluciones (PNL=-43.06€)_
...
| ✅ UPDOWN_GBM#ETH | 141 | +0.038 | +3.47€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.042) — sin ventaja clara. oversold(IBS<0.3): IC=+0.022 n=21 | neutral: IC=+0.042 n=22 | overbought(IBS>0.7): IC=+0.000 n=30
  - _Datos_: n=75 IC=+0.019 PNL=-3.25€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 75 ops, 13 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 364/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=265 IC=+0.021 PNL=+3.52€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=265 IC=+0.021 PNL=+3.52€
