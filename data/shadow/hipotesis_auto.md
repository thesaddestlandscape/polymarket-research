# Hipótesis automáticas — 2026-09-14 09:48 UTC
_Generado por shadow_postmortem.py sobre 433670 resoluciones (PNL=+46267.52€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.18` → IC=-0.259 (n=5456)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.18
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=16372)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.133 (n=1919)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=1160)

- **FILTRO** `restante_s_al_confirmar` < `138.64` → IC=-0.290 (n=769)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 138.64
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2310)
...
- **FILTRO** `restante_s_al_confirmar` < `144.22` → IC=-0.149 (n=1405)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.22
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4218)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.44` → IC=-0.256 (n=1270)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.44
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3812)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.48` → IC=-0.345 (n=1362)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.48
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=2766)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.33` → IC=-0.286 (n=68)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.232 (n=54)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.195 (n=11227)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2762)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `10962.1513` → IC=+0.195 (n=882)
...
- **PATRÓN** `py_entrada` < `0.345` → IC=+0.244 (n=7475)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.169 (n=5487)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `7066.4098` → IC=+0.173 (n=1737)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7066.4098 (IC base=+0.135)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1293)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=1598)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `13033.0053` → IC=+0.211 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13033.0053 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1181)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1303)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` < `0.325` → IC=+0.296 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.325 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=1668)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `12625.2295` → IC=+0.202 (n=586)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2234)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.140 (n=1902)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` < `0.305` → IC=+0.326 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.305 (IC base=+0.233)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.235 (n=1144)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.135 (n=519)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.193 (n=1037)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.85` → IC=+0.423 (n=515)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=658)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.179 (n=2070)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2164)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.183 (n=4683)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1629)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.205 (n=4212)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.202)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.254 (n=2150)
...
- **PATRÓN** `lag_apertura_s` < `2.83` → IC=+0.146 (n=1780)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9758` → IC=+0.230 (n=1921)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9758 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` < `0.212` → IC=+0.247 (n=1182)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.212 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.842` → IC=+0.166 (n=2231)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 5.842 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` < `1.23` → IC=+0.245 (n=1439)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.23 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.248 (n=653)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` < `0.176` → IC=+0.192 (n=3882)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.176 (IC base=+0.097)

- **PATRÓN** `volumen_pendiente_norm` > `0.1105` → IC=+0.193 (n=1458)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1105 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` < `2.8577` → IC=+0.192 (n=3747)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.8577 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `1.472` → IC=+0.195 (n=3747)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.472 (IC base=+0.097)

- **PATRÓN** `ibs_20min` < `0.5741` → IC=+0.125 (n=7073)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5741 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` < `0.1336` → IC=+0.165 (n=2103)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1336 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.161 (n=983)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.6986 (IC base=+0.056)

- **PATRÓN** `volumen_regimen` > `1.0644` → IC=+0.171 (n=1012)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0644 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.169` → IC=+0.220 (n=1102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.169 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `1.4667` → IC=+0.194 (n=3717)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4667 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.203 (n=3487)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3233` → IC=+0.166 (n=1291)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.044` → IC=+0.279 (n=563)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6362` → IC=+0.155 (n=1185)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.6362 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.4408` → IC=+0.162 (n=1185)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4408 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.188 (n=1165)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.185 (n=953)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 63.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.236 (n=850)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.236)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.252 (n=864)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.236)

- **PATRÓN** `drift_60min` |x|≤ `0.1901` → IC=+0.277 (n=643)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `drift_60min` |x|≤ `0.1102` → IC=+0.239 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1102 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.231 (n=1020)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2006` → IC=+0.221 (n=500)
...
- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.226 (n=977)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0998` → IC=+0.213 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0998 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.0745` → IC=+0.215 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0745 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.4924` → IC=+0.229 (n=418)
...
- **PATRÓN** `libro_liquidez` > `11833.4765` → IC=+0.229 (n=873)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11833.4765 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.159 (n=920)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6814` → IC=+0.176 (n=1045)
...
- **PATRÓN** `volumen_regimen` < `1.2085` → IC=+0.146 (n=1045)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2085 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `0.6125` → IC=+0.139 (n=1044)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6125 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1535` → IC=+0.200 (n=281)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1535 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.152 (n=936)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4138` → IC=+0.148 (n=936)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4138 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `12679.5686` → IC=+0.150 (n=696)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12679.5686 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `220.0` → IC=+0.156 (n=286)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 220.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.190 (n=1264)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0057 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=1333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.188 (n=845)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.412` → IC=+0.226 (n=363)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.412 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1071` → IC=+0.187 (n=1062)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` < 0.1071 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.6649` → IC=+0.182 (n=1178)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 1.6649 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=1432)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.219 (n=1087)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.211)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.211 (n=971)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0063 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.1457` → IC=+0.211 (n=479)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3902` → IC=+0.230 (n=958)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.364` → IC=+0.213 (n=1190)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3057` → IC=+0.221 (n=640)
...
- **PATRÓN** `libro_liquidez` > `1889.461` → IC=+0.232 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1889.461 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.199 (n=896)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.156 (n=88)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1594)

- **PATRÓN** `ibs_20min` > `0.9299` → IC=+0.167 (n=271)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.9299 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` > `0.3284` → IC=+0.330 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3284 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` < `0.4826` → IC=+0.337 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4826 (IC base=+0.010)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.258` → IC=+0.136 (n=500)
...
- **PATRÓN** `dist_vwap_pct` > `0.1577` → IC=+0.190 (n=172)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.1577 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.142 (n=219)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.6973 (IC base=-0.005)

- **PATRÓN** `volumen_regimen` > `0.6123` → IC=+0.139 (n=496)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6123 (IC base=-0.005)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5018` → IC=+0.168 (n=399)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.5018 (IC base=-0.005)
...
- **FILTRO** `ibs_20min` > `0.2833` → IC=-0.127 (n=1645)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2833
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.607` → IC=-0.200 (n=268)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2188)
...
- **FILTRO** `ibs_20min` < `0.6498` → IC=-0.159 (n=1069)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6498
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=551)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=344)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=1276)

- **FILTRO** `ibs_20min` > `0.775` → IC=-0.196 (n=613)

  - _Acción_: SKIP cuando `ibs_20min` > 0.775
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=1840)

- **PATRÓN** `dist_vwap_pct` > `0.8986` → IC=+0.333 (n=28)
...
- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.291 (n=189)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4697` → IC=+0.264 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4697 (IC base=-0.085)

- **PATRÓN** `volumen_spike_ratio` > `1.8015` → IC=+0.276 (n=114)
...
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.174 (n=2397)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.009 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.4583` → IC=+0.174 (n=6416)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.4583 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.6898` → IC=+0.275 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6898 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.482` → IC=+0.141 (n=3403)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` > 3.482 (IC base=+0.087)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.232 (n=2171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6736 (IC base=+0.087)

- **PATRÓN** `volumen_pendiente_norm` < `0.1138` → IC=+0.223 (n=3676)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7867` → IC=+0.234 (n=1288)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7867 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `103.0` → IC=+0.276 (n=3348)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 103.0 (IC base=+0.087)

- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.136 (n=2468)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0083 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.5603` → IC=+0.146 (n=6516)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5603 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.8952` → IC=+0.231 (n=251)
...
- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.255 (n=652)
...
- **PATRÓN** `volumen_spike_ratio` < `1.628` → IC=+0.248 (n=1114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.628 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `2.38` → IC=+0.253 (n=1148)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.38 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.249 (n=2386)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.237` → IC=-0.146 (n=484)

  - _Acción_: SKIP cuando `ibs_20min` < 0.237
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1453)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8686` → IC=+0.191 (n=334)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.8686 (IC base=+0.039)
...
- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.208 (n=406)
...
- **FILTRO** `ibs_20min` > `0.833` → IC=-0.151 (n=546)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1642)

- **PATRÓN** `dist_vwap_pct` > `0.1122` → IC=+0.127 (n=333)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.1122 (IC base=+0.009)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4165` → IC=+0.150 (n=201)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4165 (IC base=+0.009)
...
- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.268 (n=1025)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.471` → IC=+0.269 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.471 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.1113` → IC=+0.258 (n=952)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1113 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` < `2.3504` → IC=+0.238 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.3504 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `1.6757` → IC=+0.241 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6757 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.263 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 16.0 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0061` → IC=+0.298 (n=814)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.284 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.276)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.883` → IC=+0.298 (n=350)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4` → IC=+0.268 (n=817)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4 (IC base=+0.276)

- **PATRÓN** `volumen_spike_ratio` > `2.2342` → IC=+0.284 (n=544)
...
- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.269 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 25.0 (IC base=+0.276)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2335` → IC=-0.212 (n=321)
...
- **FILTRO** `ibs_20min` > `0.8227` → IC=-0.180 (n=429)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1288)

- **PATRÓN** `ibs_20min` > `0.8012` → IC=+0.143 (n=438)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.8012 (IC base=-0.018)
...
- **PATRÓN** `volumen_regimen` > `0.6109` → IC=+0.187 (n=244)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.6109 (IC base=-0.018)
...
- **PATRÓN** `dist_vwap_pct` > `0.1086` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1086 (IC base=-0.026)

- **PATRÓN** `dist_vwap_pct` < `0.2663` → IC=+0.146 (n=196)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.2663 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` < `0.9651` → IC=+0.142 (n=171)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.9651 (IC base=-0.026)

- **PATRÓN** `volumen_regimen` > `0.6646` → IC=+0.153 (n=194)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6646 (IC base=-0.026)
...
- **PATRÓN** `volumen_spike_ratio` < `1.783` → IC=+0.243 (n=103)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.211 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.026)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6667` → IC=-0.199 (n=779)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.705` → IC=-0.166 (n=396)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=1275)
...
- **PATRÓN** `ibs_20min` < `0.1154` → IC=+0.183 (n=418)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.1154 (IC base=+0.000)
...
- **PATRÓN** `sigma_h` > `0.0147` → IC=+0.322 (n=665)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.2548` → IC=+0.313 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2548 (IC base=+0.265)
...
- **PATRÓN** `volumen_regimen` > `0.68` → IC=+0.282 (n=893)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.68 (IC base=+0.265)

- **PATRÓN** `volumen_pendiente_norm` < `0.1097` → IC=+0.269 (n=872)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5515` → IC=+0.274 (n=410)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.269 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.265)

- **PATRÓN** `libro_liquidez` > `2572.5002` → IC=+0.271 (n=665)
...
- **PATRÓN** `ibs_20min` < `0.3913` → IC=+0.303 (n=1082)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3913 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` > `0.5163` → IC=+0.279 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5163 (IC base=+0.265)

- **PATRÓN** `dist_vwap_pct` < `0.2029` → IC=+0.264 (n=995)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2029 (IC base=+0.265)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.406` → IC=+0.283 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.406 (IC base=+0.265)

- **PATRÓN** `volumen_regimen` > `1.248` → IC=+0.310 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.248 (IC base=+0.265)

- **PATRÓN** `volumen_pendiente_norm` > `0.243` → IC=+0.356 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.243 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` < `2.5563` → IC=+0.260 (n=924)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5563 (IC base=+0.265)

- **PATRÓN** `volumen_spike_ratio` > `1.4425` → IC=+0.256 (n=924)
...
- **PATRÓN** `libro_liquidez` > `2549.3704` → IC=+0.276 (n=721)
...
- **PATRÓN** `sigma_h` > `0.0103` → IC=+0.202 (n=1913)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0103 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.3322` → IC=+0.175 (n=5047)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.3322 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=5973)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.6957` → IC=+0.230 (n=5125)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6957 (IC base=+0.169)

- **PATRÓN** `dist_vwap_pct` > `0.1624` → IC=+0.198 (n=2514)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.1624 (IC base=+0.169)
...
- **PATRÓN** `volumen_regimen` < `1.2168` → IC=+0.166 (n=3832)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2168 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6215` → IC=+0.162 (n=3832)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6215 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.107` → IC=+0.186 (n=2240)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.107 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `2.311` → IC=+0.170 (n=4784)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.311 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6793` → IC=+0.166 (n=1812)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.6793 (IC base=+0.169)

- **PATRÓN** `libro_liquidez` > `3813.6726` → IC=+0.176 (n=1912)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 3813.6726 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.185 (n=4643)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 124.0 (IC base=+0.169)

- **PATRÓN** `sigma_h` < `0.0063` → IC=+0.185 (n=3672)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0063 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.205 (n=1838)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4567` → IC=+0.225 (n=5506)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4567 (IC base=+0.169)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.27` → IC=+0.192 (n=960)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 10.27 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` < `1.1881` → IC=+0.152 (n=4027)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1881 (IC base=+0.169)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.150 (n=4028)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6252 (IC base=+0.169)

- **PATRÓN** `volumen_pendiente_norm` > `0.2918` → IC=+0.230 (n=780)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2918 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` < `1.5744` → IC=+0.169 (n=2138)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5744 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `2.6483` → IC=+0.177 (n=1619)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6483 (IC base=+0.169)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.169 (n=4467)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.205 (n=435)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.3158` → IC=+0.205 (n=959)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.047` → IC=+0.306 (n=437)
...
- **PATRÓN** `volumen_spike_ratio` < `2.564` → IC=+0.184 (n=868)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.564 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `1.4412` → IC=+0.180 (n=867)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4412 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.210 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.243 (n=610)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.250 (n=618)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1815` → IC=+0.297 (n=461)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1815 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.243 (n=625)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.237)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.243 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.1074` → IC=+0.265 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1074 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.966` → IC=+0.251 (n=748)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.966 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.0707` → IC=+0.236 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0707 (IC base=+0.237)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.178 (n=825)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0049 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.2856` → IC=+0.168 (n=937)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.2856 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.169 (n=861)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` < `0.5141` → IC=+0.194 (n=937)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.5141 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `1.204` → IC=+0.164 (n=937)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.204 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1586` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1586 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4411` → IC=+0.160 (n=828)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4411 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.4133` → IC=+0.154 (n=828)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4133 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `233.0` → IC=+0.159 (n=250)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 233.0 (IC base=+0.149)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.198 (n=945)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0058 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.1929` → IC=+0.196 (n=630)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.577` → IC=+0.267 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.577 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` < `0.1074` → IC=+0.189 (n=772)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=1054)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2233` → IC=+0.232 (n=527)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2233 (IC base=+0.219)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.666` → IC=+0.269 (n=323)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.666 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` > `0.3595` → IC=+0.278 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3595 (IC base=+0.219)

- **PATRÓN** `volumen_spike_ratio` > `3.5209` → IC=+0.249 (n=237)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.155 (n=845)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.006 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.3707` → IC=+0.143 (n=958)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.3707 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.186 (n=320)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 18.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` < `0.5951` → IC=+0.176 (n=958)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5951 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.1485` → IC=+0.139 (n=952)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.1485 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.181` → IC=+0.193 (n=190)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 12.181 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.133 (n=639)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8615 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.129 (n=959)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 0.6129 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.197 (n=140)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.124)

- **PATRÓN** `volumen_spike_ratio` < `1.7931` → IC=+0.129 (n=564)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.7931 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `9930.9704` → IC=+0.148 (n=435)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 9930.9704 (IC base=+0.124)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=1104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.194 (n=1077)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1682` → IC=+0.127 (n=1077)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` < 0.1682 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `2.5029` → IC=+0.121 (n=1034)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_spike_ratio` < 2.5029 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.123 (n=1103)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.194 (n=488)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.111)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.136 (n=775)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 49.0 (IC base=+0.111)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.150 (n=464)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5366` → IC=+0.207 (n=1054)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.335` → IC=+0.155 (n=224)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.335 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.0447` → IC=+0.125 (n=927)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0447 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2724` → IC=+0.185 (n=125)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2724 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.573` → IC=+0.130 (n=401)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.573 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.1727` → IC=+0.142 (n=414)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.1727 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3085.144` → IC=+0.160 (n=351)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3085.144 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.210 (n=685)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1062)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.72` → IC=+0.251 (n=920)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.72 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.1939` → IC=+0.241 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1939 (IC base=+0.200)
...
- **PATRÓN** `volumen_regimen` < `1.2039` → IC=+0.205 (n=1027)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2039 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `0.6895` → IC=+0.213 (n=917)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.151 (n=454)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0038 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.162 (n=617)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0071 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.0944` → IC=+0.156 (n=452)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.0944 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.188 (n=678)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.4079` → IC=+0.172 (n=1356)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.4079 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.783` → IC=+0.197 (n=183)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.783 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.713` → IC=+0.175 (n=614)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.713 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.8626` → IC=+0.165 (n=776)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8626 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1656` → IC=+0.172 (n=373)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1656 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.4339` → IC=+0.161 (n=432)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.4339 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.8216` → IC=+0.158 (n=863)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8216 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.152 (n=1502)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.02 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `11750.5812` → IC=+0.181 (n=452)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 11750.5812 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.172 (n=388)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 20.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.151 (n=471)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.6327` → IC=+0.136 (n=1405)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.6327 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.834` → IC=+0.126 (n=552)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.834 (IC base=+0.102)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2358` → IC=+0.123 (n=1178)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 2.2358 (IC base=+0.102)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3358` → IC=+0.137 (n=450)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.3358 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.134 (n=402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 7.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.6091` → IC=+0.173 (n=396)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.6091 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` > `1.0611` → IC=+0.155 (n=204)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 1.0611 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.1552` → IC=+0.195 (n=126)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1552 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `2.4085` → IC=+0.138 (n=440)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.4085 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `256.0` → IC=+0.141 (n=279)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 256.0 (IC base=+0.114)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0949` → IC=+0.232 (n=140)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0949 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.261 (n=207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.277` → IC=+0.242 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.277 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.3742` → IC=+0.235 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3742 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.123` → IC=+0.246 (n=132)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.123 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` < `0.8331` → IC=+0.220 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8331 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `1.156` → IC=+0.238 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.156 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` > `0.2439` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2439 (IC base=+0.208)

- **PATRÓN** `volumen_spike_ratio` < `1.368` → IC=+0.234 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.368 (IC base=+0.208)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `12428.4336` → IC=+0.223 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12428.4336 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.135 (n=236)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0047 (IC base=+0.089)

- **PATRÓN** `ibs_20min` < `0.3259` → IC=+0.139 (n=236)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.3259 (IC base=+0.089)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.534` → IC=+0.146 (n=94)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` > 6.534 (IC base=+0.089)
...
- **PATRÓN** `sigma_h` < `0.0232` → IC=+0.167 (n=157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0232 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.3227` → IC=+0.171 (n=138)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3227 (IC base=+0.154)
...
- **PATRÓN** `ibs_20min` > `0.7477` → IC=+0.192 (n=105)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.7477 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.2178` → IC=+0.185 (n=71)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.2178 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.4969` → IC=+0.153 (n=171)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.4969 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.784` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 2.784 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` < `0.9899` → IC=+0.157 (n=138)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.9899 (IC base=+0.154)

- **PATRÓN** `volumen_regimen` > `1.0975` → IC=+0.154 (n=53)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0975 (IC base=+0.154)

- **PATRÓN** `volumen_pendiente_norm` < `0.093` → IC=+0.178 (n=119)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` < 0.093 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` < `1.4437` → IC=+0.223 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4437 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.175 (n=167)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.02 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `8.0` → IC=+0.220 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 8.0 (IC base=+0.154)

- **PATRÓN** `sigma_h` > `0.0223` → IC=+0.150 (n=78)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0223 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.126 (n=121)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 9.0 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `1.0375` → IC=+0.224 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0375 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.079` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.079 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `2.8612` → IC=+0.136 (n=53)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.8612 (IC base=+0.102)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.194 (n=3270)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0085 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=7525)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4763` → IC=+0.212 (n=7210)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4763 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.8812` → IC=+0.199 (n=951)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.8812 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.566` → IC=+0.220 (n=3541)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.566 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8825` → IC=+0.166 (n=3250)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6455` → IC=+0.180 (n=2284)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.6455 (IC base=+0.165)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.171 (n=8596)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.04 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3759.7474` → IC=+0.174 (n=2404)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 3759.7474 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `96.0` → IC=+0.194 (n=5145)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 96.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.194 (n=4410)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0066 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.4721` → IC=+0.182 (n=6616)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.4721 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.201 (n=2517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.236 (n=6621)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2286` → IC=+0.164 (n=4174)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2286 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.809` → IC=+0.199 (n=962)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.809 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.6245` → IC=+0.156 (n=1524)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.6245 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2027` → IC=+0.164 (n=1523)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.2027 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2893` → IC=+0.250 (n=855)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2893 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.304` → IC=+0.188 (n=2670)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.304 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.175 (n=5493)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.796` → IC=+0.315 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.796 (IC base=+0.193)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1813` → IC=+0.159 (n=760)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1813 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.164 (n=1189)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.6972` → IC=+0.245 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6972 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.3381` → IC=+0.203 (n=446)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3381 (IC base=+0.151)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.374` → IC=+0.157 (n=1009)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.374 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.2802` → IC=+0.164 (n=1139)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2802 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1537` → IC=+0.183 (n=314)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1537 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `2.4449` → IC=+0.162 (n=1086)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4449 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7614` → IC=+0.160 (n=724)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.7614 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `10616.3534` → IC=+0.173 (n=1018)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 10616.3534 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `497.0` → IC=+0.167 (n=1017)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3181` → IC=+0.169 (n=1018)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.206 (n=1018)
...
- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.164 (n=1018)
...
- **PATRÓN** `ibs_20min` < `0.3774` → IC=+0.266 (n=965)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3774 (IC base=+0.227)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.708` → IC=+0.274 (n=391)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2531` → IC=+0.229 (n=648)
...
- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.224 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 20.0 (IC base=+0.227)
...
- **PATRÓN** `drift_60min` |x|≤ `0.424` → IC=+0.143 (n=1221)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.424 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=1276)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.7134` → IC=+0.239 (n=814)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7134 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.5539` → IC=+0.187 (n=340)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.5539 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.295` → IC=+0.172 (n=525)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 4.295 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8812` → IC=+0.165 (n=814)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8812 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.272` → IC=+0.230 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.272 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.4944` → IC=+0.149 (n=516)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4944 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.743` → IC=+0.162 (n=781)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.743 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `8917.6013` → IC=+0.234 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8917.6013 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `91.0` → IC=+0.162 (n=365)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 91.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.183 (n=329)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0032 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.4242` → IC=+0.150 (n=979)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4242 (IC base=+0.131)
...
- **PATRÓN** `ibs_20min` < `0.6897` → IC=+0.184 (n=979)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6897 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.3477` → IC=+0.135 (n=996)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.3477 (IC base=+0.131)
...
- **PATRÓN** `volumen_regimen` < `0.8594` → IC=+0.135 (n=653)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8594 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.152 (n=326)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5565` → IC=+0.138 (n=401)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5565 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.4583` → IC=+0.167 (n=304)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.4583 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `11073.7628` → IC=+0.180 (n=326)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 11073.7628 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.136 (n=902)
...
- **PATRÓN** `ibs_20min` > `0.463` → IC=+0.174 (n=1254)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` > 0.463 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `0.9969` → IC=+0.173 (n=218)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.9969 (IC base=+0.095)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.211 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.395 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=872)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2917.9058` → IC=+0.243 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2917.9058 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.124 (n=914)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 53.0 (IC base=+0.095)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.172 (n=523)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0061 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.152 (n=397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1197 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.154 (n=556)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 15.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.625` → IC=+0.209 (n=1189)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.625 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2672` → IC=+0.134 (n=1022)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.2672 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.394` → IC=+0.125 (n=1142)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 3.394 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `0.7148` → IC=+0.159 (n=523)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.7148 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4645` → IC=+0.150 (n=344)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4645 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.222` → IC=+0.126 (n=468)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 2.222 (IC base=+0.115)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.205)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.205 (n=1124)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.310 (n=456)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.1801` → IC=+0.237 (n=721)
...
- **PATRÓN** `volumen_regimen` < `1.243` → IC=+0.207 (n=1261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.243 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6223` → IC=+0.209 (n=1261)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=1278)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2554.0958` → IC=+0.208 (n=841)
...
- **PATRÓN** `sigma_h` > `0.0253` → IC=+0.219 (n=464)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.199 (n=1470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` < `0.5065` → IC=+0.251 (n=1389)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5065 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` < `0.2629` → IC=+0.204 (n=1291)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2629 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.953` → IC=+0.265 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.953 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.2333` → IC=+0.240 (n=463)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2324` → IC=+0.189 (n=1066)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.2324 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.194 (n=1212)
...
- **PATRÓN** `libro_liquidez` > `2528.1128` → IC=+0.200 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2528.1128 (IC base=+0.197)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.142 (n=2443)

- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.150 (n=2037)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0096 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.5293` → IC=+0.149 (n=2314)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.5293 (IC base=+0.139)
...
- **PATRÓN** `ibs_20min` > `0.9312` → IC=+0.204 (n=773)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9312 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.1876` → IC=+0.150 (n=780)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.1876 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.714` → IC=+0.152 (n=737)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 5.714 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.7103` → IC=+0.129 (n=642)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.7103 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.9026` → IC=+0.142 (n=972)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.9026 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.1739` → IC=+0.168 (n=637)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.1739 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `1.4575` → IC=+0.154 (n=764)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 1.4575 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.9021` → IC=+0.155 (n=1526)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.9021 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `8592.1606` → IC=+0.148 (n=1049)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 8592.1606 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.195 (n=618)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0037 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.4768` → IC=+0.163 (n=1844)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4768 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` < `0.1827` → IC=+0.163 (n=813)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1827 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.6965` → IC=+0.147 (n=315)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.6965 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.224` → IC=+0.148 (n=1823)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.224 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2534` → IC=+0.144 (n=1753)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2534 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.154 (n=875)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.5773` → IC=+0.145 (n=1825)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.5773 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.8237` → IC=+0.154 (n=1217)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.8237 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.142 (n=2443)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `7776.6954` → IC=+0.152 (n=1647)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 7776.6954 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.197 (n=242)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0068 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.189 (n=249)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0101 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.4197` → IC=+0.174 (n=480)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.4197 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.217 (n=210)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.234 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.163)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.303` → IC=+0.209 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.303 (IC base=+0.163)

- **PATRÓN** `volumen_pendiente_norm` > `0.2102` → IC=+0.199 (n=154)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2102 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.165 (n=544)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.8346` → IC=+0.170 (n=486)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.8346 (IC base=+0.163)
...
- **FILTRO** `hora_utc` > `6.0` → IC=-0.158 (n=36)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9795` → IC=+0.152 (n=44)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.9795 (IC base=+0.026)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.125` → IC=+0.184 (n=36)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 7.125 (IC base=+0.026)

- **PATRÓN** `volumen_pendiente_norm` > `0.156` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` > 0.156 (IC base=+0.026)
...
- **PATRÓN** `volumen_regimen` < `0.6265` → IC=+0.133 (n=227)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.6265 (IC base=+0.098)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5476` → IC=+0.147 (n=409)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.5476 (IC base=+0.098)
...
- **PATRÓN** `libro_liquidez` > `2445.5482` → IC=+0.162 (n=223)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2445.5482 (IC base=+0.098)
...
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.192 (n=63)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0049 (IC base=+0.073)
...
- **PATRÓN** `dist_vwap_pct` > `0.8626` → IC=+0.179 (n=26)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.8626 (IC base=+0.073)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.655` → IC=+0.185 (n=87)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.655 (IC base=+0.073)

- **PATRÓN** `volumen_regimen` > `0.95` → IC=+0.135 (n=72)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 0.95 (IC base=+0.073)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5681` → IC=+0.169 (n=140)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.5681 (IC base=+0.073)

- **PATRÓN** `libro_liquidez` > `392.9095` → IC=+0.155 (n=137)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 392.9095 (IC base=+0.073)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=449)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.106)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.121 (n=418)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=5895)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1208)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.176 (n=2474)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=7454)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.170 (n=2548)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=7724)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.215 (n=401)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.088 (n=1252)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.220 (n=426)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1372)

- **FILTRO** `ibs_20min` > `0.287` → IC=-0.176 (n=449)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.198 (n=399)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.071 (n=1232)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.190 (n=447)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=1365)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2199)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2150)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=573)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.126 (n=7236)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=16246)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.274 (n=5829)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=17653)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.235 (n=5870)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=17612)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.161 (n=7862)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=15620)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.222 (n=7298)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=21988)

- **FILTRO** `ibs_7min` > `0.2982` → IC=-0.176 (n=7318)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2982
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=21968)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.317 (n=876)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2831)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.261 (n=1222)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2485)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.206 (n=861)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=2846)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.147 (n=3440)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1663)

- **FILTRO** `drift_7min_pct` |x|> `0.1079` → IC=-0.124 (n=1732)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1079
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=3371)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.203 (n=1273)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3830)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.141 (n=956)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3174)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.252 (n=1029)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3101)

- **FILTRO** `ibs_7min` < `0.7615` → IC=-0.184 (n=1030)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7615
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=3100)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.169 (n=1029)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3101)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=962)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3188)

- **FILTRO** `ibs_7min` > `0.2503` → IC=-0.171 (n=1037)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2503
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3113)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.161 (n=1400)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2750)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=859)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=2646)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.322 (n=825)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2680)

- **FILTRO** `drift_7min_pct` |x|> `0.1836` → IC=-0.131 (n=1190)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1836
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=2315)

- **FILTRO** `ibs_7min` < `0.2068` → IC=-0.271 (n=876)
...
- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.217 (n=873)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=2632)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.232 (n=1254)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=4095)

- **FILTRO** `ibs_7min` > `0.2658` → IC=-0.155 (n=1818)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.127 (n=1232)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=2640)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.249 (n=926)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=2946)

- **FILTRO** `ibs_7min` < `0.7485` → IC=-0.190 (n=968)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7485
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=2904)

- **FILTRO** `ballena_activa_n` > `33.0` → IC=-0.185 (n=960)

  - _Acción_: SKIP cuando `ballena_activa_n` > 33.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=2912)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=967)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=2961)

- **FILTRO** `ibs_7min` > `0.2769` → IC=-0.171 (n=981)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2769
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2947)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.180 (n=972)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2956)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.236 (n=1034)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3264)

- **FILTRO** `ibs_7min` < `0.7273` → IC=-0.205 (n=1062)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7273
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3236)

- **FILTRO** `py_entrada` > `0.61` → IC=-0