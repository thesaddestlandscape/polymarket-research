# Hipótesis automáticas — 2026-07-16 11:20 UTC
_Generado por shadow_postmortem.py sobre 16869 resoluciones (PNL=+3437.10€)_
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.331 (n=342)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=1124)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `7358.3864` → IC=+0.184 (n=327)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 7358.3864 (IC base=+0.167)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.268 (n=183)
...
- **PATRÓN** `sigma_h` < `0.0133` → IC=+0.142 (n=412)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0133 (IC base=+0.131)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.875` → IC=+0.125 (n=126)
...
- **PATRÓN** `dist_vwap_pct` < `0.3632` → IC=+0.122 (n=516)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.120 (n=77)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` < 6.0 (IC base=+0.039)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2535 | +0.172 | -72.88€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 1632 | +0.209 | +5.38€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 888 | +0.170 | -38.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 536 | +0.214 | +15.20€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 4868 | +0.102 | +1518.06€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4868 | +0.102 | +1518.06€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#SOL | 1303 | +0.110 | +529.15€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1303 | +0.110 | +529.15€ | 1 | 7 |
...
| ✅ GBM_LATE_15M_TARDIO | 2067 | +0.091 | +620.87€ | 0 | 7 |
| ✅ GBM_LATE_15M_TARDIO#15min | 2067 | +0.091 | +620.87€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#SOL | 486 | +0.064 | +100.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 486 | +0.064 | +100.47€ | 1 | 6 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.102 n=9807 | tras_1loss IC=+0.069 n=6853 | tras_2loss IC=+0.038 n=2927/40 | gap=+0.064 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=14411 IC=+0.105 PNL=+3512.98€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=14411 IC=+0.105 PNL=+3512.98€
...
**🔶 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.170 n=204) pero sin cruzar ≥2 pares más — BTC: n=147 IC=-0.010; ETH: n=112 IC=+0.000; SOL: n=214 IC=+0.065 ✓
