# Hipótesis automáticas — 2026-09-21 13:04 UTC
_Generado por shadow_postmortem.py sobre 541794 resoluciones (PNL=+60495.67€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.248 (n=486)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.145 (n=359)
...
- **PATRÓN** `libro_liquidez` > `2914.8041` → IC=+0.139 (n=344)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2914.8041 (IC base=+0.130)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=385)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.3` → IC=-0.234 (n=6545)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.3
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=19635)
...
- **FILTRO** `restante_s_al_confirmar` < `493.31` → IC=-0.152 (n=349)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1049)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `133.45` → IC=-0.278 (n=789)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 133.45
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=2367)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `161.07` → IC=-0.232 (n=1541)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.07
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4629)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.85` → IC=-0.364 (n=1296)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.85
  - _Potencial_: sin este filtro IC_bueno=-0.120 (n=3891)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.199 (n=13119)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3289)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `9485.1977` → IC=+0.191 (n=1423)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 9485.1977 (IC base=+0.100)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.233 (n=10084)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.129)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=5345)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.129)

- **PATRÓN** `libro_liquidez` > `7588.1383` → IC=+0.171 (n=2008)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 7588.1383 (IC base=+0.129)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.210 (n=1596)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1570)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.349 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1973)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15739.1326` → IC=+0.234 (n=509)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15739.1326 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.203 (n=1561)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=1996)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `15448.436` → IC=+0.210 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15448.436 (IC base=+0.198)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.149 (n=426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=618)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=509)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `1297.853` → IC=+0.147 (n=613)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 1297.853 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=1031)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=703)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=10551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.198)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3627)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2470)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `py_entrada` < `0.73` → IC=+0.179 (n=2430)

  - _Acción_: Kelly boost +0.90€ cuando `py_entrada` < 0.73 (IC base=+0.168)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.262 (n=679)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.259)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.328 (n=485)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.259)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.185 (n=2540)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 5.0 (IC base=+0.182)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.187 (n=2432)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.248 (n=2260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.240)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.320 (n=794)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=5761)
...
- **PATRÓN** `libro_liquidez` > `1570.4643` → IC=+0.297 (n=1039)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1570.4643 (IC base=+0.291)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.284 (n=488)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4195.4603` → IC=+0.294 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4195.4603 (IC base=+0.275)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.335 (n=349)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.315 (n=446)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.446 (n=482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.438)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.444 (n=411)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.915` → IC=+0.445 (n=467)
...
- **PATRÓN** `libro_liquidez` > `2546.95` → IC=+0.438 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2546.95 (IC base=+0.438)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3578` → IC=+0.125 (n=6451)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3578 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.9809` → IC=+0.242 (n=2444)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9809 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.7995` → IC=+0.244 (n=427)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7995 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` < `0.6047` → IC=+0.245 (n=2049)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6047 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.935` → IC=+0.177 (n=2829)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.935 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `1.2196` → IC=+0.243 (n=1957)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2196 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` > `1.0528` → IC=+0.249 (n=887)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0528 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` > `0.3074` → IC=+0.215 (n=727)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3074 (IC base=+0.104)

- **PATRÓN** `volumen_spike_ratio` > `1.915` → IC=+0.206 (n=3318)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.915 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.5714` → IC=+0.131 (n=8846)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5714 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5751` → IC=+0.196 (n=632)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5751 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1429` → IC=+0.173 (n=2746)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1429 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7012` → IC=+0.177 (n=1332)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7012 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.174 (n=2017)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8699 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.168` → IC=+0.224 (n=1456)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.168 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5816` → IC=+0.201 (n=4499)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5816 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.211 (n=4818)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.177 (n=556)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0082 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3426` → IC=+0.166 (n=1663)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3426 (IC base=+0.162)
...
- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.257 (n=422)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.228 (n=1324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.214)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.215 (n=1292)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.214)

- **PATRÓN** `ibs_20min` > `0.9089` → IC=+0.257 (n=573)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9089 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` > `0.1883` → IC=+0.216 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1883 (IC base=+0.214)

- **PATRÓN** `dist_vwap_pct` < `0.7164` → IC=+0.218 (n=1400)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7164 (IC base=+0.214)
...
- **PATRÓN** `volumen_regimen` < `1.2572` → IC=+0.219 (n=1264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2572 (IC base=+0.214)

- **PATRÓN** `volumen_regimen` > `0.8723` → IC=+0.217 (n=843)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8723 (IC base=+0.214)

- **PATRÓN** `volumen_pendiente_norm` > `0.0746` → IC=+0.226 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0746 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` < `1.4033` → IC=+0.223 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4033 (IC base=+0.214)

- **PATRÓN** `volumen_spike_ratio` > `2.3852` → IC=+0.217 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3852 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `16473.011` → IC=+0.226 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16473.011 (IC base=+0.214)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.155 (n=1157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0048 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.158 (n=440)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0761 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.168 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.6836` → IC=+0.168 (n=1315)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.6836 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.126` → IC=+0.154 (n=1176)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.126 (IC base=+0.136)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.195` → IC=+0.136 (n=1191)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 4.195 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2089` → IC=+0.147 (n=1315)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4413` → IC=+0.148 (n=1205)
...
- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.145 (n=1123)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 411.0 (IC base=+0.136)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.204 (n=1081)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0078 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.188 (n=1702)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.186)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.191 (n=1454)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 15.0 (IC base=+0.186)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.265 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.186)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.093` → IC=+0.246 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.093 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` < `0.2136` → IC=+0.189 (n=1604)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.2136 (IC base=+0.186)

- **PATRÓN** `volumen_pendiente_norm` > `0.3672` → IC=+0.193 (n=210)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.3672 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `2.9195` → IC=+0.207 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9195 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=1092)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.186)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.222 (n=1374)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.217)

- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.219 (n=1228)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0066 (IC base=+0.217)

- **PATRÓN** `drift_60min` |x|≤ `0.5439` → IC=+0.217 (n=1374)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.1944` → IC=+0.237 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1944 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.554` → IC=+0.240 (n=459)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.554 (IC base=+0.217)

- **PATRÓN** `volumen_pendiente_norm` > `0.3598` → IC=+0.277 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3598 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` < `1.8278` → IC=+0.209 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8278 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.924` → IC=+0.230 (n=565)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.924 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.228 (n=869)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1860.1734` → IC=+0.231 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1860.1734 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.224 (n=812)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2040)

- **PATRÓN** `ibs_20min` > `0.9414` → IC=+0.206 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9414 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.3544` → IC=+0.335 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3544 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` < `0.7341` → IC=+0.325 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7341 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.724` → IC=+0.152 (n=648)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1741` → IC=+0.324 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1741 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.3004` → IC=+0.345 (n=82)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.176 (n=612)
...
- **FILTRO** `ibs_20min` > `0.2625` → IC=-0.127 (n=2018)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2625
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=994)
...
- **PATRÓN** `ibs_20min` < `0.2625` → IC=+0.126 (n=994)

  - _Acción_: Kelly boost +0.63€ cuando `ibs_20min` < 0.2625 (IC base=-0.043)

- **PATRÓN** `dist_vwap_pct` > `0.6475` → IC=+0.276 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6475 (IC base=-0.043)
...
- **FILTRO** `drift_60min` |x|> `0.6317` → IC=-0.190 (n=511)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6317
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=1535)

- **FILTRO** `ibs_20min` < `0.6977` → IC=-0.158 (n=1350)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6977
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=696)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=396)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1650)

- **FILTRO** `ibs_20min` > `0.7761` → IC=-0.201 (n=761)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7761
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=2284)

- **PATRÓN** `dist_vwap_pct` > `0.7157` → IC=+0.303 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7157 (IC base=-0.075)

- **PATRÓN** `dist_vwap_pct` < `0.2591` → IC=+0.315 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2591 (IC base=-0.075)

- **PATRÓN** `volumen_regimen` > `0.616` → IC=+0.300 (n=298)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5622` → IC=+0.292 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5622 (IC base=-0.075)

- **PATRÓN** `volumen_spike_ratio` > `1.8324` → IC=+0.293 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8324 (IC base=-0.075)

- **PATRÓN** `dist_vwap_pct` > `1.0199` → IC=+0.304 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0199 (IC base=-0.024)

- **PATRÓN** `volumen_regimen` < `0.7407` → IC=+0.259 (n=292)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2166` → IC=+0.257 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2166 (IC base=-0.024)

- **PATRÓN** `volumen_spike_ratio` > `1.5824` → IC=+0.249 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5824 (IC base=-0.024)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.192 (n=3045)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0095 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.187 (n=8157)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4706 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `1.0164` → IC=+0.295 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0164 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.569` → IC=+0.155 (n=4331)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.569 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `0.6832` → IC=+0.243 (n=2867)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6832 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.299` → IC=+0.264 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.299 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `1.4734` → IC=+0.240 (n=1743)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4734 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `2.7069` → IC=+0.240 (n=1743)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7069 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.267 (n=4733)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.146 (n=3081)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0089 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5523` → IC=+0.149 (n=8124)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5523 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6822` → IC=+0.235 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6822 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1717` → IC=+0.237 (n=2393)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1717 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.237 (n=1167)
...
- **FILTRO** `ibs_20min` > `0.8168` → IC=-0.150 (n=666)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8168
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1999)

- **PATRÓN** `ibs_20min` > `0.8636` → IC=+0.161 (n=614)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8636 (IC base=+0.023)

- **PATRÓN** `dist_vwap_pct` > `0.4622` → IC=+0.171 (n=238)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.4622 (IC base=+0.023)

- **PATRÓN** `volumen_regimen` < `1.0452` → IC=+0.146 (n=736)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0452 (IC base=+0.023)

- **PATRÓN** `volumen_regimen` > `0.6686` → IC=+0.157 (n=747)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6686 (IC base=+0.023)

- **PATRÓN** `volumen_pendiente_norm` > `0.2765` → IC=+0.206 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2765 (IC base=+0.023)

- **PATRÓN** `volumen_spike_ratio` < `1.425` → IC=+0.197 (n=272)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.425 (IC base=+0.023)

- **PATRÓN** `ballena_activa_n` < `248.0` → IC=+0.191 (n=354)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 248.0 (IC base=+0.023)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.287 (n=967)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0077 (IC base=+0.245)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.245 (n=1452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.298 (n=767)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.245)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.622` → IC=+0.280 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.622 (IC base=+0.245)

- **PATRÓN** `volumen_pendiente_norm` < `0.1072` → IC=+0.261 (n=1219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1072 (IC base=+0.245)

- **PATRÓN** `volumen_spike_ratio` > `2.9509` → IC=+0.263 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9509 (IC base=+0.245)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.257 (n=966)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.245)

- **PATRÓN** `libro_liquidez` > `1926.3032` → IC=+0.255 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.3032 (IC base=+0.245)

- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.327 (n=519)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.2233` → IC=+0.291 (n=1007)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2233 (IC base=+0.285)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.303 (n=439)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1998` → IC=+0.286 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1998 (IC base=+0.285)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.297 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.285)

- **PATRÓN** `libro_liquidez` > `1910.86` → IC=+0.318 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1910.86 (IC base=+0.285)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.285 (n=678)
...
- **FILTRO** `ibs_20min` > `0.7848` → IC=-0.178 (n=545)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7848
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1638)

- **PATRÓN** `ibs_20min` > `0.9028` → IC=+0.176 (n=440)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.9028 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.4461` → IC=+0.235 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4461 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` < `0.9853` → IC=+0.231 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9853 (IC base=+0.007)

- **PATRÓN** `volumen_regimen` > `0.6434` → IC=+0.214 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6434 (IC base=+0.007)

- **PATRÓN** `volumen_pendiente_norm` > `0.2675` → IC=+0.300 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2675 (IC base=+0.007)
...
- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.261 (n=304)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.1485` → IC=+0.192 (n=183)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1485 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.3302` → IC=+0.180 (n=345)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.3302 (IC base=-0.010)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.189 (n=355)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 1.1615 (IC base=-0.010)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8338` → IC=+0.239 (n=209)
...
- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.230 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.010)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7105` → IC=-0.203 (n=971)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7105
  - _Potencial_: sin este filtro IC_bueno=+0.270 (n=971)

- **FILTRO** `ibs_20min` > `0.6923` → IC=-0.233 (n=503)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6923
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1534)

- **FILTRO** `sigma_ewma_delta_pct` > `4.704` → IC=-0.178 (n=454)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.704
  - _Potencial_: sin este filtro IC_bueno=+0.067 (n=1583)

- **PATRÓN** `ibs_20min` > `0.7105` → IC=+0.270 (n=971)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7105 (IC base=+0.033)

- **PATRÓN** `dist_vwap_pct` > `0.8223` → IC=+0.344 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8223 (IC base=+0.033)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.157 (n=304)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` < `0.8667` → IC=+0.300 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8667 (IC base=+0.033)

- **PATRÓN** `volumen_regimen` > `0.6364` → IC=+0.285 (n=705)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6364 (IC base=+0.033)

- **PATRÓN** `volumen_pendiente_norm` < `0.1046` → IC=+0.288 (n=653)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.313 (n=592)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0994` → IC=+0.208 (n=447)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5144` → IC=+0.219 (n=457)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.316 (n=793)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6293` → IC=+0.310 (n=1190)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6293 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.193` → IC=+0.315 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.193 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.300 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.275)

- **PATRÓN** `volumen_regimen` > `0.8627` → IC=+0.300 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8627 (IC base=+0.275)

- **PATRÓN** `volumen_pendiente_norm` > `0.2809` → IC=+0.314 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2809 (IC base=+0.275)

- **PATRÓN** `volumen_spike_ratio` < `1.4407` → IC=+0.277 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4407 (IC base=+0.275)

- **PATRÓN** `volumen_spike_ratio` > `2.5336` → IC=+0.290 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5336 (IC base=+0.275)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.280 (n=1255)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2605.5314` → IC=+0.285 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2605.5314 (IC base=+0.275)

- **PATRÓN** `sigma_h` > `0.0148` → IC=+0.300 (n=872)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3966` → IC=+0.305 (n=1308)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3966 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5401` → IC=+0.285 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5401 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` < `0.9062` → IC=+0.271 (n=1481)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9062 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.477` → IC=+0.290 (n=474)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5298` → IC=+0.268 (n=1142)
...
- **PATRÓN** `libro_liquidez` > `2586.8546` → IC=+0.277 (n=872)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2586.8546 (IC base=+0.271)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2415)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.011` → IC=+0.201 (n=2402)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.011 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0895` → IC=+0.185 (n=2405)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.0895 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=7517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.582` → IC=+0.217 (n=7206)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.582 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.1698` → IC=+0.196 (n=3151)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1698 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.241` → IC=+0.259 (n=1479)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.241 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.2182` → IC=+0.161 (n=4767)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2182 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` > `0.6255` → IC=+0.160 (n=4767)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6255 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.297` → IC=+0.197 (n=1072)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.297 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5645` → IC=+0.170 (n=3031)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5645 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6409` → IC=+0.177 (n=2296)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 2.6409 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `3848.1598` → IC=+0.169 (n=2402)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 3848.1598 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=6120)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0795` → IC=+0.204 (n=2281)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.226 (n=6841)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4783 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2254` → IC=+0.159 (n=4996)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2254 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.241` → IC=+0.198 (n=1162)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.241 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1795` → IC=+0.152 (n=4987)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5729` → IC=+0.167 (n=2716)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5729 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2776` → IC=+0.173 (n=2799)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.2776 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.172 (n=5805)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.194 (n=416)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0083 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.341` → IC=+0.205 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.341 (IC base=+0.183)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.097` → IC=+0.311 (n=563)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4352` → IC=+0.182 (n=1137)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.255 (n=776)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.240)

- **PATRÓN** `drift_60min` |x|≤ `0.1824` → IC=+0.292 (n=580)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1824 (IC base=+0.240)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.247 (n=785)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1095` → IC=+0.277 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1095 (IC base=+0.240)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.073` → IC=+0.255 (n=944)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.073 (IC base=+0.240)

- **PATRÓN** `volumen_pendiente_norm` < `0.0946` → IC=+0.238 (n=716)
...
- **PATRÓN** `libro_liquidez` > `1781.58` → IC=+0.254 (n=579)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0752` → IC=+0.210 (n=357)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0752 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.189 (n=1125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 5.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` > `0.4138` → IC=+0.229 (n=1069)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4138 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` > `0.1993` → IC=+0.217 (n=644)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1993 (IC base=+0.164)
...
- **PATRÓN** `volumen_regimen` < `1.268` → IC=+0.169 (n=1069)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.268 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` > `1.0731` → IC=+0.167 (n=485)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0731 (IC base=+0.164)
...
- **PATRÓN** `volumen_spike_ratio` < `1.414` → IC=+0.203 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.414 (IC base=+0.164)

- **PATRÓN** `libro_liquidez` > `15774.7785` → IC=+0.176 (n=485)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 15774.7785 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.226 (n=546)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.198)

- **PATRÓN** `drift_60min` |x|≤ `0.2129` → IC=+0.215 (n=804)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.292 (n=642)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.803` → IC=+0.281 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.803 (IC base=+0.198)

- **PATRÓN** `volumen_pendiente_norm` < `0.2119` → IC=+0.198 (n=1162)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` < 0.2119 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` < `1.6529` → IC=+0.196 (n=380)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 1.6529 (IC base=+0.198)

- **PATRÓN** `volumen_spike_ratio` > `2.9235` → IC=+0.210 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9235 (IC base=+0.198)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.211 (n=811)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0935` → IC=+0.253 (n=330)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2462` → IC=+0.258 (n=867)
...
- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.168 (n=1147)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0077 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.162 (n=1146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3925` → IC=+0.201 (n=1146)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3925 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1549` → IC=+0.184 (n=766)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1549 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` < `0.6186` → IC=+0.170 (n=1203)
...
- **PATRÓN** `volumen_regimen` < `0.8526` → IC=+0.142 (n=802)
...
- **PATRÓN** `volumen_spike_ratio` < `1.799` → IC=+0.128 (n=724)
...
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.157 (n=595)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.01 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1339)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.52` → IC=+0.201 (n=1305)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.52 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `1.0762` → IC=+0.217 (n=295)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0762 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `1.2249` → IC=+0.127 (n=1306)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.2249 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `2.489` → IC=+0.125 (n=1258)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.489 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=1362)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `2891.3724` → IC=+0.195 (n=592)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2891.3724 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.134 (n=989)
...
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.210 (n=833)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=1296)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7351` → IC=+0.257 (n=1115)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7351 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `1.2464` → IC=+0.228 (n=310)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2464 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.444` → IC=+0.244 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.444 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` < `1.2094` → IC=+0.202 (n=1248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2094 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` > `0.8594` → IC=+0.218 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8594 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` > `0.2353` → IC=+0.274 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2353 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` < `2.1646` → IC=+0.210 (n=1058)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1646 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.8081` → IC=+0.205 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8081 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.201 (n=1309)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `2596.7996` → IC=+0.201 (n=832)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2596.7996 (IC base=+0.199)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0888` → IC=+0.217 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0888 (IC base=+0.205)
...
- **PATRÓN** `ibs_20min` < `0.4412` → IC=+0.247 (n=1297)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4412 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `1.1172` → IC=+0.233 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1172 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.374` → IC=+0.240 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.374 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.632` → IC=+0.217 (n=1297)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2447` → IC=+0.196 (n=1019)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2447 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4597` → IC=+0.199 (n=1158)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4597 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2563.709` → IC=+0.210 (n=865)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2563.709 (IC base=+0.205)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.011` → IC=+0.203 (n=3057)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.011 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.176 (n=9553)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.4717` → IC=+0.216 (n=9151)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4717 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.9144` → IC=+0.199 (n=1273)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.9144 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.609` → IC=+0.227 (n=4459)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.609 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.8818` → IC=+0.165 (n=4081)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8818 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2403` → IC=+0.198 (n=1713)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2403 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6204` → IC=+0.189 (n=2923)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6204 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2328.5676` → IC=+0.170 (n=6101)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2328.5676 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.194 (n=6857)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 89.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0069` → IC=+0.191 (n=5527)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0069 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.4839` → IC=+0.183 (n=8290)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.4839 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3151)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5658` → IC=+0.238 (n=8290)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5658 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2384` → IC=+0.161 (n=5161)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2384 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.917` → IC=+0.198 (n=1171)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.917 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.71` → IC=+0.182 (n=8040)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.71 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7054` → IC=+0.159 (n=2526)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7054 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2053` → IC=+0.151 (n=1913)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2053 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2889` → IC=+0.245 (n=1082)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2889 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.2866` → IC=+0.190 (n=3423)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.2866 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.189 (n=4823)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 49.0 (IC base=+0.181)
...
- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.218 (n=520)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.3467` → IC=+0.190 (n=1560)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.3467 (IC base=+0.190)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.978` → IC=+0.316 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.978 (IC base=+0.190)
...
- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.168 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1528)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3134` → IC=+0.203 (n=1464)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3134 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1244` → IC=+0.185 (n=832)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1244 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.757` → IC=+0.169 (n=336)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 9.757 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.265` → IC=+0.154 (n=1312)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 4.265 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6272` → IC=+0.180 (n=489)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6272 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.2688` → IC=+0.195 (n=211)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2688 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.1166` → IC=+0.160 (n=1241)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1166 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.5037` → IC=+0.154 (n=1259)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5037 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `13722.1448` → IC=+0.153 (n=976)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 13722.1448 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `481.0` → IC=+0.156 (n=1342)
...
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.246 (n=668)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.223 (n=1542)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1501)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.257 (n=1316)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2147` → IC=+0.224 (n=1444)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2147 (IC base=+0.217)

- **PATRÓN** `volumen_spike_ratio` > `2.896` → IC=+0.242 (n=633)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.896 (IC base=+0.217)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.230 (n=991)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.217)

- **PATRÓN** `libro_liquidez` > `1929.6932` → IC=+0.222 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1929.6932 (IC base=+0.217)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.242 (n=1364)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0108 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.243 (n=912)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.1573` → IC=+0.242 (n=600)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1573 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.267 (n=517)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.2` → IC=+0.282 (n=913)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.748` → IC=+0.282 (n=488)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3507` → IC=+0.295 (n=198)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3507 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.7836` → IC=+0.237 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7836 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.2258` → IC=+0.238 (n=826)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2258 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.251 (n=864)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1914.2984` → IC=+0.253 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1914.2984 (IC base=+0.237)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4371` → IC=+0.143 (n=1561)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.4371 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1634)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.8801` → IC=+0.262 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8801 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3624` → IC=+0.168 (n=622)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.3624 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.224` → IC=+0.163 (n=650)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.224 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.159 (n=1041)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8772 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2802` → IC=+0.240 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2802 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.149 (n=664)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `2.4706` → IC=+0.155 (n=503)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.4706 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8136.1215` → IC=+0.230 (n=708)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8136.1215 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.150 (n=484)

  - _Acción_: Kelly boost +0.75€ cuando `ballena_activa_n` < 81.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.155 (n=1271)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0076 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4448` → IC=+0.154 (n=1271)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.693` → IC=+0.185 (n=1271)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.693 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.5775` → IC=+0.140 (n=1402)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5775 (IC base=+0.135)
...
- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.142 (n=848)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.8616 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1836` → IC=+0.143 (n=424)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4415` → IC=+0.150 (n=1200)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4415 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11034.1392` → IC=+0.207 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11034.1392 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `182.0` → IC=+0.141 (n=1192)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 182.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.133 (n=1032)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.008 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.169 (n=578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.186 (n=1551)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4706 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0536` → IC=+0.196 (n=301)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.0536 (IC base=+0.105)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.124 (n=1076)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.128 (n=1177)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1574)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6371` → IC=+0.205 (n=1522)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.437` → IC=+0.126 (n=1470)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.206 (n=1391)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.205)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.247 (n=1549)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.8506` → IC=+0.238 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8506 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.496` → IC=+0.249 (n=739)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.496 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6352` → IC=+0.212 (n=1548)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1603)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2599.9752` → IC=+0.214 (n=1032)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.200 (n=1777)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.256 (n=1681)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5207 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.1349` → IC=+0.202 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1349 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.8545` → IC=+0.203 (n=1873)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8545 (IC base=+0.200)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.778` → IC=+0.261 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.778 (IC base=+0.200)

- **PATRÓN** `volumen_regimen` > `1.233` → IC=+0.241 (n=561)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2201` → IC=+0.196 (n=1319)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.2201 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4428` → IC=+0.201 (n=1498)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4428 (IC base=+0.200)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.134 (n=2819)
...
- **PATRÓN** `ibs_20min` > `0.9404` → IC=+0.211 (n=908)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9404 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.1894` → IC=+0.162 (n=965)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1894 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.5004` → IC=+0.141 (n=1609)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.5004 (IC base=+0.150)
...
- **PATRÓN** `volumen_regimen` > `0.9028` → IC=+0.162 (n=1143)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.9028 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1731` → IC=+0.184 (n=744)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1731 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4578` → IC=+0.155 (n=897)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4578 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8914` → IC=+0.162 (n=1794)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8914 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=1811)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3635.8033` → IC=+0.155 (n=1815)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3635.8033 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.192 (n=712)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0038 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.4815` → IC=+0.153 (n=2126)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.6896` → IC=+0.140 (n=404)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.6896 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.2433` → IC=+0.126 (n=1898)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.2433 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.224` → IC=+0.140 (n=2112)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.224 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.9014` → IC=+0.148 (n=1350)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8163` → IC=+0.140 (n=1402)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8163 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.134 (n=2819)

  - _Acción_: Kelly boost +0.67€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `7267.9636` → IC=+0.147 (n=1899)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 7267.9636 (IC base=+0.132)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.265 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=212)

- **PATRÓN** `ibs_20min` > `0.9302` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.9302 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.218` → IC=+0.167 (n=91)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 2.218 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.063)

- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.149 (n=75)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0118 (IC base=+0.061)

- **PATRÓN** `drift_60min` |x|≤ `0.3939` → IC=+0.125 (n=110)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3939 (IC base=+0.061)

- **PATRÓN** `ibs_20min` < `0.0952` → IC=+0.167 (n=55)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.0952 (IC base=+0.061)

- **PATRÓN** `dist_vwap_pct` > `0.5986` → IC=+0.146 (n=77)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.5986 (IC base=+0.061)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.122 (n=827)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 6.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.5714` → IC=+0.196 (n=708)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.5714 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.1931` → IC=+0.165 (n=353)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1931 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.488` → IC=+0.207 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.488 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `0.8064` → IC=+0.124 (n=472)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 0.8064 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `0.9789` → IC=+0.132 (n=321)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.9789 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.2867` → IC=+0.220 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2867 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.1124` → IC=+0.152 (n=527)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.1124 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.4023` → IC=+0.130 (n=598)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4023 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.132 (n=576)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.02 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `2438.1282` → IC=+0.151 (n=310)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 2438.1282 (IC base=+0.102)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.175 (n=275)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0059 (IC base=+0.109)

- **PATRÓN** `ibs_20min` > `0.5717` → IC=+0.199 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5717 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `0.1288` → IC=+0.174 (n=127)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.1288 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `1.0554` → IC=+0.127 (n=215)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0554 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.145 (n=181)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.109)

- **PATRÓN** `volumen_pendiente_norm` > `0.2692` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2692 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `2.0129` → IC=+0.194 (n=181)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.0129 (IC base=+0.109)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=249)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `3499.6095` → IC=+0.128 (n=154)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 3499.6095 (IC base=+0.109)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.181 (n=183)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.005 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5333` → IC=+0.214 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5333 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.1242` → IC=+0.164 (n=135)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1242 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `0.8141` → IC=+0.146 (n=162)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8141 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` > `0.6338` → IC=+0.139 (n=217)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6338 (IC base=+0.115)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7588` → IC=+0.164 (n=129)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.7588 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `2.5041` → IC=+0.136 (n=64)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 2.5041 (IC base=+0.115)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.137 (n=257)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.02 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `1113.1395` → IC=+0.165 (n=213)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 1113.1395 (IC base=+0.115)
...
- **PATRÓN** `ibs_20min` > `0.6905` → IC=+0.190 (n=198)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.6905 (IC base=+0.079)

- **PATRÓN** `dist_vwap_pct` > `0.1941` → IC=+0.154 (n=128)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.1941 (IC base=+0.079)
...
- **PATRÓN** `volumen_regimen` > `1.0632` → IC=+0.158 (n=74)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.0632 (IC base=+0.079)

- **PATRÓN** `volumen_pendiente_norm` > `0.0852` → IC=+0.199 (n=91)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.0852 (IC base=+0.079)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.124 (n=107)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 15.0 (IC base=+0.080)

- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.160 (n=233)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.6522 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.47` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.47 (IC base=+0.080)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.176 (n=32)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0079 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.217 (n=44)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.172)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.177 (n=94)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 17.0 (IC base=+0.172)

- **PATRÓN** `ibs_20min` < `0.7083` → IC=+0.176 (n=32)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.7083 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` > `0.6434` → IC=+0.292 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6434 (IC base=+0.172)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.614` → IC=+0.207 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.614 (IC base=+0.172)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0966` → IC=+0.239 (n=21)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0966 (IC base=+0.172)

- **PATRÓN** `volumen_spike_ratio` < `1.396` → IC=+0.382 (n=15)
...
- **PATRÓN** `libro_liquidez` > `523.3443` → IC=+0.170 (n=95)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 523.3443 (IC base=+0.172)
...
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.122 (n=615)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` > 0.5 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2859.8474` → IC=+0.168 (n=209)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2859.8474 (IC base=+0.107)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=312)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.175 (n=3085)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=9697)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3228)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=9991)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.213 (n=549)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=1652)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.172 (n=552)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1809)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.203 (n=553)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=1688)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.203 (n=587)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1765)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.168 (n=577)
...
- **FILTRO** `py_entrada` < `0.48` → IC=-0.184 (n=540)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1639)

- **FILTRO** `py_entrada` > `0.58` → IC=-0.194 (n=564)

  - _Acción_: SKIP cuando `py_entrada` > 0.58
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1788)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2625)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2782)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2788)
...
- **FILTRO** `hora_utc` > `18.0` → IC=-0.141 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.130 (n=206)

- **FILTRO** `drift_20min_pct` |x|> `0.1804` → IC=-0.162 (n=66)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=726)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=9157)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=20365)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.275 (n=7125)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=22397)

- **FILTRO** `ibs_7min` < `0.2936` → IC=-0.236 (n=7380)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2936
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=22142)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=9975)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=19547)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9188)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=27709)

- **FILTRO** `ibs_7min` > `0.2943` → IC=-0.179 (n=9223)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2943
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27674)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1155)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=3679)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.252 (n=1593)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3241)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.181 (n=1147)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3687)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.151 (n=4275)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=2089)

- **FILTRO** `drift_7min_pct` |x|> `0.1118` → IC=-0.125 (n=2162)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1118
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4202)

- **FILTRO** `ibs_7min` > `0.7929` → IC=-0.205 (n=1590)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7929
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4774)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1204)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3925)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1232)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3897)

- **FILTRO** `ibs_7min` < `0.7524` → IC=-0.188 (n=1281)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7524
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3848)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.172 (n=1278)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3851)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.259 (n=1277)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3890)

- **FILTRO** `ibs_7min` > `0.2588` → IC=-0.173 (n=1289)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2588
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3878)

- **FILTRO** `ballena_activa_n` > `155.0` → IC=-0.186 (n=1287)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.171 (n=1130)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3447)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.307 (n=1115)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3462)

- **FILTRO** `ibs_7min` < `0.1963` → IC=-0.257 (n=1144)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1963
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3433)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1094)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3483)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1578)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5187)

- **FILTRO** `ibs_7min` > `0.759` → IC=-0.178 (n=1690)

  - _Acción_: SKIP cuando `ibs_7min` > 0.759
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=5075)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1566)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3287)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.237 (n=1430)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3423)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.181 (n=1212)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3641)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.176 (n=1213)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3640)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1237)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3732)

- **FILTRO** `ibs_7min` > `0.2751` → IC=-0.173 (n=1242)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2751
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3727)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.191 (n=1212)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3757)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=1221)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=3982)

- **FILTRO** `ibs_7min` < `0.7027` → IC=-0.229 (n=1300)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7027
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3903)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1687)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5309)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.277 (n=1150)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3776)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.232 (n=1230)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3696)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1179)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3747)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1638)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=4998)
...
- **FILTRO** `pct_vs_K` |x|> `0.8662` → IC=-0.260 (n=77)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.190 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=675)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.152 (n=21)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=681)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=2694)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=1393)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.184 (n=470)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0043 (IC base=+0.184)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.217 (n=637)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0082 (IC base=+0.184)

- **PATRÓN** `drift_60min` |x|≤ `0.1629` → IC=+0.191 (n=1237)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.1629 (IC base=+0.184)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2175` → IC=+0.191 (n=470)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.95€ cuando `delta_ratio_macro` |x|> 0.2175 (IC base=+0.184)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1304` → IC=+0.224 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1304 (IC base=+0.184)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.196 (n=986)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 11.0 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.185 (n=1420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 16.0 (IC base=+0.184)

- **PATRÓN** `ibs_15` > `0.6122` → IC=+0.261 (n=1405)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6122 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` > `0.4454` → IC=+0.186 (n=336)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4454 (IC base=+0.184)

- **PATRÓN** `dist_vwap_pct` < `0.5654` → IC=+0.173 (n=1384)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5654 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.101` → IC=+0.272 (n=370)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.101 (IC base=+0.184)

- **PATRÓN** `libro_liquidez` > `9175.0527` → IC=+0.192 (n=469)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 9175.0527 (IC base=+0.184)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.227 (n=350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.156 (n=222)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` > 0.005 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.158 (n=147)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.139)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1408` → IC=+0.165 (n=222)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1408 (IC base=+0.139)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.263` → IC=+0.162 (n=232)

  - _Acción_: Kelly boost +0.81€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.263 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.160 (n=245)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.139)

- **PATRÓN** `ibs_15` > `0.6192` → IC=+0.219 (n=333)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6192 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1594` → IC=+0.160 (n=260)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1594 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.389` → IC=+0.211 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.389 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `3456.6166` → IC=+0.143 (n=298)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 3456.6166 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.224 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0168 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.0857` → IC=+0.188 (n=168)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.0857 (IC base=+0.179)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0402` → IC=+0.188 (n=382)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.0402 (IC base=+0.179)
...
- **PATRÓN** `ibs_15` > `0.5455` → IC=+0.276 (n=382)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5455 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` > `0.1228` → IC=+0.197 (n=232)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.1228 (IC base=+0.179)

- **PATRÓN** `dist_vwap_pct` < `0.6278` → IC=+0.181 (n=443)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6278 (IC base=+0.179)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.987` → IC=+0.224 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.987 (IC base=+0.179)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.489` → IC=+0.180 (n=342)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` < 7.489 (IC base=+0.179)

- **PATRÓN** `libro_liquidez` > `2861.0808` → IC=+0.254 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2861.0808 (IC base=+0.179)
...
- **PATRÓN** `sigma_h` > `0.005` → IC=+0.374 (n=172)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.005 (IC base=+0.338)

- **PATRÓN** `drift_60min` |x|≤ `0.1089` → IC=+0.346 (n=252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1089 (IC base=+0.338)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1476` → IC=+0.362 (n=252)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1476 (IC base=+0.338)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1332` → IC=+0.379 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1332 (IC base=+0.338)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.360 (n=378)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.338)

- **PATRÓN** `ibs_15` > `0.785` → IC=+0.384 (n=378)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.785 (IC base=+0.338)

- **PATRÓN** `dist_vwap_pct` > `0.424` → IC=+0.379 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.424 (IC base=+0.338)

- **PATRÓN** `dist_vwap_pct` < `0.1061` → IC=+0.337 (n=255)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1061 (IC base=+0.338)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.08` → IC=+0.346 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.08 (IC base=+0.338)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.343 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.338)

- **PATRÓN** `libro_liquidez` > `3507.1457` → IC=+0.353 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3507.1457 (IC base=+0.338)
...
- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.326 (n=165)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1004` → IC=+0.339 (n=110)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1004 (IC base=+0.328)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2262` → IC=+0.362 (n=92)
...
- **PATRÓN** `ibs_15` > `0.7401` → IC=+0.392 (n=165)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7401 (IC base=+0.328)

- **PATRÓN** `dist_vwap_pct` > `0.4449` → IC=+0.333 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4449 (IC base=+0.328)

- **PATRÓN** `dist_vwap_pct` < `0.1175` → IC=+0.350 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1175 (IC base=+0.328)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.639` → IC=+0.354 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.639 (IC base=+0.328)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.340 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.328)

- **PATRÓN** `libro_liquidez` > `3991.4206` → IC=+0.357 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3991.4206 (IC base=+0.328)

### UPDOWN_GBM_15M_TARDIO
- **FILTRO** `sigma_h` > `0.013` → IC=-0.213 (n=601)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1807)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.190 (n=778)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1630)

- **FILTRO** `libro_liquidez` < `3921.5421` → IC=-0.134 (n=1589)

  - _Acción_: SKIP cuando `libro_liquidez` < 3921.5421
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=819)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.138` → IC=+0.263 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.138 (IC base=-0.059)

- **PATRÓN** `ibs_15` > `0.6326` → IC=+0.269 (n=594)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6326 (IC base=-0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5648` → IC=+0.176 (n=109)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.5648 (IC base=-0.059)

- **PATRÓN** `dist_vwap_pct` < `0.2685` → IC=+0.180 (n=467)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2685 (IC base=-0.059)

- **PATRÓN** `delta_ratio_macro` |x|> `0.118` → IC=+0.240 (n=978)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.118 (IC base=-0.040)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1804` → IC=+0.239 (n=942)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1804 (IC base=-0.040)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.281 (n=1467)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.040)

- **PATRÓN** `dist_vwap_pct` > `0.649` → IC=+0.271 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.649 (IC base=-0.040)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.223 (n=366)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.193 (n=1101)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.224 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=983)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=924)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=543)

- **FILTRO** `sigma_ewma_delta_pct` > `19.796` → IC=-0.252 (n=260)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.796
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1207)
...
- **FILTRO** `ibs_15` < `0.6642` → IC=-0.208 (n=94)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.260 (n=285)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=17)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.157 (n=362)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.177 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0051 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.0771` → IC=+0.219 (n=126)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0771 (IC base=+0.143)

- **PATRÓN** `drift_15min` |x|≤ `0.4223` → IC=+0.160 (n=95)

  - _Acción_: Kelly boost +0.80€ cuando `drift_15min` |x|≤ 0.4223 (IC base=+0.143)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1335` → IC=+0.156 (n=190)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.78€ cuando `delta_ratio_macro` |x|> 0.1335 (IC base=+0.143)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3062` → IC=+0.238 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3062 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.192 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 15.0 (IC base=+0.143)

- **PATRÓN** `ibs_15` > `0.6642` → IC=+0.260 (n=285)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6642 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1175` → IC=+0.183 (n=203)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.1175 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.579` → IC=+0.156 (n=225)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 6.579 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=362)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `10966.626` → IC=+0.179 (n=129)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 10966.626 (IC base=+0.143)

- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.238 (n=598)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.224)

- **PATRÓN** `drift_15min` |x|≤ `0.7762` → IC=+0.231 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7762 (IC base=+0.224)
...
- **PATRÓN** `ibs_15` < `0.2722` → IC=+0.278 (n=526)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2722 (IC base=+0.224)

- **PATRÓN** `dist_vwap_pct` > `0.729` → IC=+0.272 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.729 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` > `20.646` → IC=+0.257 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.646 (IC base=+0.224)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.254` → IC=+0.227 (n=640)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.254 (IC base=+0.224)

- **PATRÓN** `libro_liquidez` > `3539.2271` → IC=+0.228 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3539.2271 (IC base=+0.224)
...
- **FILTRO** `sigma_ewma_delta_pct` > `18.011` → IC=-0.133 (n=303)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 18.011
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=2437)
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1977` → IC=-0.198 (n=246)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.260 (n=181)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.172 (n=543)
...
- **PATRÓN** `ibs_15` < `0.35` → IC=+0.314 (n=407)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.046)

- **PATRÓN** `dist_vwap_pct` > `1.0728` → IC=+0.406 (n=51)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0574` → IC=+0.316 (n=205)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0574 (IC base=+0.291)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2402` → IC=+0.302 (n=205)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2402 (IC base=+0.291)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.221` → IC=+0.328 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.221 (IC base=+0.291)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.311 (n=643)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.291)

- **PATRÓN** `ibs_15` > `0.8404` → IC=+0.330 (n=614)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8404 (IC base=+0.291)

- **PATRÓN** `dist_vwap_pct` > `0.2738` → IC=+0.330 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2738 (IC base=+0.291)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.453` → IC=+0.335 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.453 (IC base=+0.291)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.294 (n=752)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.291)

- **PATRÓN** `libro_liquidez` > `14354.3614` → IC=+0.307 (n=205)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1133` → IC=+0.305 (n=183)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.167` → IC=+0.331 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.167 (IC base=+0.298)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.309 (n=312)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6122 sube el IC de +0.184 a +0.261 en UPDOWN_GBM#15min (n=1405). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6192 sube el IC de +0.139 a +0.219 en UPDOWN_GBM#ETH#15min (n=333). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5455 sube el IC de +0.179 a +0.276 en UPDOWN_GBM#XRP#15min (n=382). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6326 sube el IC de -0.059 a +0.269 en UPDOWN_GBM_15M_TARDIO (n=594). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.040 a +0.281 en UPDOWN_GBM_15M_TARDIO (n=1467). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_YES, IBS > 0.6642 sube el IC de +0.143 a +0.260 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=285). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2722 sube el IC de +0.224 a +0.278 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=526). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.046 a +0.314 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=407). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8404 sube el IC de +0.291 a +0.330 en UPDOWN_GBM_IBS_ALTO (n=614). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO#ETH#15min**: dentro de BUY_YES, IBS > 0.8489 sube el IC de +0.298 a +0.340 en UPDOWN_GBM_IBS_ALTO#ETH#15min (n=273). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.785 sube el IC de +0.338 a +0.384 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=378). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7401 sube el IC de +0.328 a +0.392 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=165). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1250 | +0.090 | +151.01€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1250 | +0.090 | +151.01€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 922 | +0.100 | +127.66€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 922 | +0.100 | +127.66€ | 2 | 7 |
...
| ✅ BALLENAS_TARDIAS | 23398 | -0.091 | -3075.08€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1398 | -0.047 | -213.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22000 | -0.094 | -2861.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3564 | -0.084 | -574.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3564 | -0.084 | -574.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1398 | -0.047 | -213.14€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1398 | -0.047 | -213.14€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6705 | -0.030 | -601.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6705 | -0.030 | -601.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6170 | -0.094 | -418.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6170 | -0.094 | -418.19€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5187 | -0.181 | -1106.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5187 | -0.181 | -1106.27€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15835 | -0.032 | +4130.94€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4162 | -0.001 | +1829.56€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11673 | -0.043 | +2301.39€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15835 | -0.032 | +4130.94€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4162 | -0.001 | +1829.56€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11673 | -0.043 | +2301.39€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1402 | -0.101 | -178.04€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 158 | -0.050 | -18.65€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1244 | -0.107 | -159.38€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 769 | -0.090 | -93.86€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 134 | -0.044 | -13.43€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 85593 | +0.113 | -4396.44€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13120 | +0.184 | -431.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 338 | -0.100 | -48.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 66458 | +0.100 | -3726.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5677 | +0.110 | -190.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11061 | +0.097 | -977.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 43 | -0.167 | -2.82€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11003 | +0.099 | -963.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 