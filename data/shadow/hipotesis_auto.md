# Hipótesis automáticas — 2026-06-30 06:47 UTC
_Generado por shadow_postmortem.py sobre 1377 resoluciones (PNL=-51.86€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.06` → IC=+0.150 (n=18)
  ...
  - _Acción_: Kelly boost +0.75€ cuando `pct_spot_vs_ref` |x|≤ 0.06 (IC base=+0.034)

- **PATRÓN** `drift_60min` |x|≤ `0.15` → IC=+0.136 (n=20)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.15 (IC base=+0.034)

### UPDOWN_GBM#ETH#60min
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.167 (n=16)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0127 (IC base=+0.059)
...
- **H-SIGMA-ETH-60MIN**: `UPDOWN_GBM#ETH#60min` gana cuando sigma_h > 0.0127 (IC=+0.167 n=16). Implementar como filtro pre-predicción en shadow_predict.py.
...
| ✅ UPDOWN_GBM | 404 | -0.015 | -10.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 241 | +0.023 | +3.61€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 82 | +0.024 | +1.21€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 128 | +0.000 | -6.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 71 | +0.034 | -1.87€ | 0 | 2 |
| ✅ UPDOWN_GBM#BTC#240min | 5 | -0.089 | -2.96€ | 0 | 0 |
| 🚫 UPDOWN_GBM#BTC#5min | 16 | -0.133 | -6.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 32 | +0.059 | +0.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 163 | +0.015 | +0.95€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 110 | +0.027 | +1.37€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 32 | +0.059 | +1.82€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL | 79 | -0.068 | -1.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 39 | +0.012 | +3.45€ | 1 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 17 | -0.112 | -4.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 18 | -0.090 | -0.72€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.007) — sin ventaja clara. oversold(IBS<0.3): IC=-0.038 n=37 | neutral: IC=-0.045 n=31 | overbought(IBS>0.7): IC=-0.043 n=44
  - _Datos_: n=115 IC=-0.047 PNL=-11.51€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 115 ops, 20 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Estado_: ETH#60min: n=32/40 IC=+0.059 PNL=+1.82€ | BTC#60min: n=32/40 IC=+0.059 PNL=+0.11€ | SOL#60min: n=18/40 IC=-0.090 PNL=-0.72€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=305 IC=-0.005 PNL=-4.75€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=305 IC=-0.005 PNL=-4.75€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=66 IC=+0.015 PNL=+0.76€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=66 IC=+0.015 PNL=+0.76€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=183 IC=-0.013 PNL=-14.75€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=183 IC=-0.013 PNL=-14.75€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=71 IC=+0.034 PNL=-1.87€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=71 IC=+0.034 PNL=-1.87€

**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  - _Hipótesis_: Análisis n=127 GBM#15min: cuando drift_15min está entre -0.3 y +0.3 (mercado sin dirección clara) el IC es negativo (-0.043). Cuando drift>0.3 IC=+0.100 (n=28). Cuando drift<-1 IC=+0.048 (reversión). La señal requiere mercado con dirección clara.
  - _Umbral_: 50
  - _Acción_: Filtrar señales GBM#15min cuando drift_15min ∈ [-0.3, +0.3] — validar con n≥50 antes de implementar
  - _Estado_: 35/50 ops en el filtro definido (IC actual=-0.041 PNL=-1.46€)
  - _Datos_: n=35 IC=-0.041 PNL=-1.46€

**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: n=98 IC=+0.060 PNL=-0.02€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=98 IC=+0.060 PNL=-0.02€
