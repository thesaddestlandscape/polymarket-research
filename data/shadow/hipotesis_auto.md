# Hipótesis automáticas — 2026-09-23 03:38 UTC
_Generado por shadow_postmortem.py sobre 567291 resoluciones (PNL=+63420.92€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.29` → IC=-0.230 (n=6812)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.29
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=20440)
...
- **FILTRO** `restante_s_al_confirmar` < `134.98` → IC=-0.279 (n=840)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.98
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2522)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `163.57` → IC=-0.229 (n=1616)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 163.57
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4854)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `125.12` → IC=-0.358 (n=1361)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 125.12
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=4084)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.202 (n=13473)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3378)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5592.9988` → IC=+0.175 (n=2154)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1625)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2045)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.204 (n=1617)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.200)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=2073)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.200)

- **PATRÓN** `libro_liquidez` > `13965.1034` → IC=+0.207 (n=728)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13965.1034 (IC base=+0.200)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.148 (n=339)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.145 (n=2316)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.240 (n=1443)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.143 (n=572)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 15.0 (IC base=+0.137)

- **PATRÓN** `py_entrada` > `0.665` → IC=+0.230 (n=235)
...
- **PATRÓN** `libro_liquidez` > `1311.0387` → IC=+0.152 (n=633)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=715)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.202 (n=10516)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.225 (n=3704)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.176 (n=2545)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 17.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.185 (n=1860)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.252 (n=753)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.188 (n=2511)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 17.0 (IC base=+0.182)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.185 (n=2175)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.198 (n=2455)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 17.0 (IC base=+0.195)

- **PATRÓN** `py_entrada` < `0.71` → IC=+0.199 (n=1879)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.232 (n=17725)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.180 (n=5602)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 15.0 (IC base=+0.176)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.191 (n=6077)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.227 (n=5824)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.191 (n=5981)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=2050)
...
- **PATRÓN** `restante_min` < `4.19` → IC=+0.125 (n=2320)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` < 4.19 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.136 (n=2486)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.32` → IC=+0.139 (n=2315)

  - _Acción_: Kelly boost +0.69€ cuando `lag_apertura_s` < 2.32 (IC base=+0.113)
...
- **PATRÓN** `py_entrada` > `0.815` → IC=+0.387 (n=377)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.815 (IC base=+0.292)

- **PATRÓN** `libro_liquidez` > `4068.869` → IC=+0.313 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4068.869 (IC base=+0.292)
...
- **PATRÓN** `py_entrada` > `0.805` → IC=+0.343 (n=170)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.805 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `4211.4773` → IC=+0.303 (n=318)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.303 (n=537)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4766` → IC=+0.121 (n=7690)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4766 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9831` → IC=+0.242 (n=2564)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9831 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8348` → IC=+0.247 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8348 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.1558` → IC=+0.248 (n=1497)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1558 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.929` → IC=+0.177 (n=2963)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.929 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.257 (n=937)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.216 (n=767)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9076` → IC=+0.206 (n=3496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9076 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5702` → IC=+0.132 (n=9254)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5702 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.5918` → IC=+0.196 (n=714)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5918 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` < `0.1487` → IC=+0.172 (n=2858)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1487 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.176 (n=1411)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6986 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.8683` → IC=+0.176 (n=2140)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8683 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.1681` → IC=+0.222 (n=1531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1681 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` > `1.5762` → IC=+0.202 (n=4786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5762 (IC base=+0.063)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.211 (n=5139)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=+0.063)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.173 (n=1164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.165 (n=1626)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.005` → IC=+0.251 (n=1152)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.39` → IC=+0.249 (n=1344)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.39 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.231 (n=1099)
...
- **PATRÓN** `libro_liquidez` > `1789.5548` → IC=+0.239 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1789.5548 (IC base=+0.235)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.230 (n=993)
...
- **PATRÓN** `dist_vwap_pct` < `0.7391` → IC=+0.217 (n=1459)
...
- **PATRÓN** `volumen_regimen` < `1.2525` → IC=+0.217 (n=1326)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4011` → IC=+0.222 (n=433)
...
- **PATRÓN** `libro_liquidez` > `12289.9132` → IC=+0.217 (n=1184)
...
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.217 (n=567)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.193 (n=1516)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.173` → IC=+0.253 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.173 (IC base=+0.187)

- **PATRÓN** `volumen_pendiente_norm` < `0.2115` → IC=+0.189 (n=1691)
...
- **PATRÓN** `volumen_spike_ratio` > `2.88` → IC=+0.206 (n=730)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.88 (IC base=+0.187)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.196 (n=1192)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5811` → IC=+0.215 (n=1445)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.218 (n=679)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.554` → IC=+0.240 (n=491)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.554 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.359` → IC=+0.271 (n=212)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.359 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.8718` → IC=+0.228 (n=597)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8718 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.224 (n=955)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `1868.3264` → IC=+0.231 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1868.3264 (IC base=+0.215)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.160 (n=95)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2127)

- **PATRÓN** `ibs_20min` > `0.9422` → IC=+0.211 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9422 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` > `0.3625` → IC=+0.326 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3625 (IC base=+0.021)

- **PATRÓN** `dist_vwap_pct` < `0.7743` → IC=+0.327 (n=334)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7743 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.666` → IC=+0.153 (n=682)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1967` → IC=+0.319 (n=136)
...
- **PATRÓN** `dist_vwap_pct` > `0.3288` → IC=+0.186 (n=259)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.3288 (IC base=+0.013)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5138` → IC=+0.175 (n=654)
...
- **FILTRO** `ibs_20min` > `0.2581` → IC=-0.126 (n=2102)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1037)

- **FILTRO** `sigma_ewma_delta_pct` > `8.653` → IC=-0.204 (n=339)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.653
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2800)
...
- **PATRÓN** `ibs_20min` < `0.2581` → IC=+0.124 (n=1037)
...
- **FILTRO** `drift_60min` |x|> `0.6456` → IC=-0.185 (n=537)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6456
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1613)

- **FILTRO** `ibs_20min` < `0.705` → IC=-0.159 (n=1418)

  - _Acción_: SKIP cuando `ibs_20min` < 0.705
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=732)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.199 (n=400)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1750)

- **FILTRO** `ibs_20min` > `0.7727` → IC=-0.204 (n=795)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=2387)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.746` → IC=+0.201 (n=359)
...
- **FILTRO** `ibs_20min` > `0.8136` → IC=-0.149 (n=693)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.052 (n=2083)

- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.157 (n=643)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` > 0.8635 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1245` → IC=+0.171 (n=502)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.1245 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.6703` → IC=+0.162 (n=788)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.249 (n=1531)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.741` → IC=+0.279 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.741 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.1385` → IC=+0.257 (n=1349)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1385 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `2.8916` → IC=+0.258 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8916 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.256 (n=1057)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1942.2984` → IC=+0.256 (n=507)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1942.2984 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.309 (n=804)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.300 (n=469)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6079` → IC=+0.284 (n=369)
...
- **FILTRO** `ibs_20min` > `0.7783` → IC=-0.184 (n=568)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7783
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1708)

- **PATRÓN** `ibs_20min` > `0.8153` → IC=+0.160 (n=637)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.8153 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.4511` → IC=+0.224 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4511 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` < `0.9898` → IC=+0.235 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9898 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` > `0.5819` → IC=+0.208 (n=525)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5819 (IC base=+0.008)

- **PATRÓN** `volumen_pendiente_norm` > `0.0791` → IC=+0.254 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0791 (IC base=+0.008)

- **PATRÓN** `volumen_spike_ratio` < `1.5053` → IC=+0.259 (n=218)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8285` → IC=+0.251 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8285 (IC base=-0.007)

- **PATRÓN** `volumen_spike_ratio` > `2.1439` → IC=+0.248 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1439 (IC base=-0.007)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.243 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=-0.007)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.7188` → IC=-0.201 (n=1019)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7188
  - _Potencial_: sin este filtro IC_bueno=+0.279 (n=1020)

- **FILTRO** `ibs_20min` > `0.6897` → IC=-0.229 (n=533)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6897
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1606)

- **FILTRO** `sigma_ewma_delta_pct` > `4.677` → IC=-0.178 (n=467)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.677
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1672)

- **PATRÓN** `ibs_20min` > `0.7188` → IC=+0.279 (n=1020)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7188 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `0.2978` → IC=+0.324 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2978 (IC base=+0.039)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.49` → IC=+0.161 (n=325)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 9.49 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.299 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8646 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `0.6396` → IC=+0.290 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6396 (IC base=+0.039)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2247` → IC=+0.292 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2247 (IC base=+0.039)
...
- **PATRÓN** `dist_vwap_pct` < `0.2123` → IC=+0.223 (n=460)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1552` → IC=+0.206 (n=538)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1582` → IC=+0.291 (n=538)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1582 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=1335)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `2616.4926` → IC=+0.295 (n=836)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2616.4926 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.296 (n=906)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.273 (n=675)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.270)

- **PATRÓN** `ibs_20min` < `0.3985` → IC=+0.303 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3985 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` > `0.2901` → IC=+0.281 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2901 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` < `0.9422` → IC=+0.271 (n=1519)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9422 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.01` → IC=+0.295 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.01 (IC base=+0.270)

- **PATRÓN** `volumen_regimen` > `1.2434` → IC=+0.313 (n=452)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1642` → IC=+0.276 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1642 (IC base=+0.270)

- **PATRÓN** `libro_liquidez` > `2605.099` → IC=+0.277 (n=904)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2605.099 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.171 (n=2522)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.09` → IC=+0.185 (n=2519)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4779` → IC=+0.225 (n=7144)
...
- **PATRÓN** `ballena_activa_n` < `119.0` → IC=+0.172 (n=6109)
...
- **PATRÓN** `ibs_20min` > `0.4084` → IC=+0.223 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4084 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` > `0.2074` → IC=+0.211 (n=683)
...
- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.162 (n=1122)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.2653 (IC base=+0.160)

- **PATRÓN** `volumen_regimen` > `1.0742` → IC=+0.167 (n=509)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 1.0742 (IC base=+0.160)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4112` → IC=+0.193 (n=363)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.4112 (IC base=+0.160)

- **PATRÓN** `libro_liquidez` > `15859.8442` → IC=+0.163 (n=509)
...
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.226 (n=422)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.199)

- **PATRÓN** `drift_60min` |x|≤ `0.2239` → IC=+0.215 (n=845)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2239 (IC base=+0.199)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.876` → IC=+0.275 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.876 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` < `0.2104` → IC=+0.197 (n=1228)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` < 0.2104 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` > `0.1342` → IC=+0.200 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1342 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` < `1.6452` → IC=+0.197 (n=401)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6452 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `2.8814` → IC=+0.209 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8814 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=886)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `1946.6584` → IC=+0.203 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1946.6584 (IC base=+0.199)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4314` → IC=+0.160 (n=1205)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.3837` → IC=+0.196 (n=1205)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3837 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1571` → IC=+0.180 (n=816)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1571 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` < `1.0445` → IC=+0.147 (n=1060)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.0445 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6297` → IC=+0.149 (n=1205)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6297 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.2466` → IC=+0.198 (n=253)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2466 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.5364` → IC=+0.149 (n=519)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5364 (IC base=+0.144)
...
- **PATRÓN** `libro_liquidez` > `6949.3934` → IC=+0.186 (n=803)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 6949.3934 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.145 (n=1147)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.157 (n=618)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.203 (n=1363)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.679` → IC=+0.253 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.679 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.130 (n=1363)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2208 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.6379` → IC=+0.121 (n=1363)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6379 (IC base=+0.118)

- **PATRÓN** `volumen_pendiente_norm` < `0.1645` → IC=+0.131 (n=1370)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1645 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.4424` → IC=+0.144 (n=439)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.4424 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1427)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.195 (n=618)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.136 (n=1043)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.216 (n=871)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.207 (n=591)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.203)

- **PATRÓN** `ibs_20min` > `0.737` → IC=+0.261 (n=1167)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.737 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `1.341` → IC=+0.222 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.341 (IC base=+0.203)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.527` → IC=+0.246 (n=617)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.527 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` < `1.209` → IC=+0.206 (n=1306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.209 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.8592` → IC=+0.223 (n=871)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8592 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2336` → IC=+0.270 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2336 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.216 (n=1109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.412` → IC=+0.207 (n=1260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.412 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.206 (n=1383)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2797.3896` → IC=+0.207 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2797.3896 (IC base=+0.203)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.176 (n=590)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1638` → IC=+0.175 (n=487)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1638 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4373` → IC=+0.167 (n=565)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.4373 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5495` → IC=+0.160 (n=565)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.5495 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=1990)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12224.8689` → IC=+0.149 (n=588)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12224.8689 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `165.0` → IC=+0.164 (n=1545)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 165.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.130 (n=1227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5217` → IC=+0.142 (n=1619)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.5217 (IC base=+0.102)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.126 (n=444)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.104)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.147 (n=397)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 9.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` > `0.2517` → IC=+0.143 (n=444)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.2517 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.3049` → IC=+0.158 (n=159)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.3049 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.256` → IC=+0.127 (n=199)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 3.256 (IC base=+0.104)

- **PATRÓN** `volumen_regimen` < `0.6135` → IC=+0.147 (n=148)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6135 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `12605.7065` → IC=+0.133 (n=396)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0958` → IC=+0.217 (n=178)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0958 (IC base=+0.195)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.195)

- **PATRÓN** `ibs_20min` > `0.7098` → IC=+0.251 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7098 (IC base=+0.195)

- **PATRÓN** `dist_vwap_pct` > `0.3803` → IC=+0.217 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3803 (IC base=+0.195)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.043` → IC=+0.230 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.043 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` < `0.8399` → IC=+0.204 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8399 (IC base=+0.195)

- **PATRÓN** `volumen_regimen` > `1.1544` → IC=+0.217 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1544 (IC base=+0.195)

- **PATRÓN** `volumen_pendiente_norm` > `0.2601` → IC=+0.315 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2601 (IC base=+0.195)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4105` → IC=+0.240 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4105 (IC base=+0.195)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=592)
...
- **PATRÓN** `ibs_20min` < `0.0789` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.0789 (IC base=+0.078)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.178 (n=175)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.163 (n=363)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.197 (n=345)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.7333 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.6295` → IC=+0.222 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6295 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.127` → IC=+0.205 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.127 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.0697` → IC=+0.142 (n=339)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.0697 (IC base=+0.127)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2136` → IC=+0.167 (n=166)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 2.2136 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.130 (n=419)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.02 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `3060.0718` → IC=+0.202 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3060.0718 (IC base=+0.127)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.207 (n=3207)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.168)
...
- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.237 (n=8689)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5667 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.244` → IC=+0.161 (n=5336)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.244 (IC base=+0.180)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.719` → IC=+0.182 (n=8414)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.719 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.705` → IC=+0.159 (n=2639)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.705 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.204` → IC=+0.153 (n=1998)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.204 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.241 (n=1138)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.6339` → IC=+0.193 (n=2646)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.6339 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.191 (n=5045)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.218 (n=547)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.3528` → IC=+0.188 (n=1637)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.3528 (IC base=+0.188)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=790)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.199 (n=1103)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `ibs_20min` < `0.3505` → IC=+0.290 (n=1107)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3505 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.537` → IC=+0.266 (n=1268)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8654` → IC=+0.275 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8654 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1955.5` → IC=+0.274 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1955.5 (IC base=+0.258)
...
- **PATRÓN** `ibs_20min` > `0.3136` → IC=+0.201 (n=1539)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3136 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.1298` → IC=+0.186 (n=892)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.1298 (IC base=+0.148)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.227` → IC=+0.150 (n=1382)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.227 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6287` → IC=+0.176 (n=513)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.161 (n=1306)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.7577` → IC=+0.155 (n=989)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7577 (IC base=+0.148)

- **PATRÓN** `libro_liquidez` > `15634.6383` → IC=+0.151 (n=698)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 15634.6383 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `477.0` → IC=+0.157 (n=1415)
...
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.247 (n=519)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.238 (n=681)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.235)

- **PATRÓN** `ibs_20min` < `0.3621` → IC=+0.269 (n=1262)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3621 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.722` → IC=+0.279 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.722 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.3457` → IC=+0.292 (n=210)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2015` → IC=+0.239 (n=872)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2015 (IC base=+0.235)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.246 (n=948)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1926.5448` → IC=+0.252 (n=478)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1926.5448 (IC base=+0.235)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4353` → IC=+0.143 (n=1638)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4353 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=1713)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.8773` → IC=+0.260 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8773 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.5706` → IC=+0.173 (n=481)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.5706 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.156` → IC=+0.159 (n=681)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 4.156 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8769` → IC=+0.156 (n=1092)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8769 (IC base=+0.135)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5208` → IC=+0.148 (n=697)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5208 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.1389` → IC=+0.149 (n=718)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.1389 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8150.9955` → IC=+0.229 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8150.9955 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.154 (n=510)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 80.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.154 (n=1335)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0076 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4454` → IC=+0.153 (n=1333)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.142 (n=609)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.6955` → IC=+0.185 (n=1333)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.6955 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.7912` → IC=+0.141 (n=1539)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.7912 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.14` → IC=+0.172 (n=196)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 11.14 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.147 (n=587)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6962 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1836` → IC=+0.146 (n=444)
...
- **PATRÓN** `libro_liquidez` > `2848.7898` → IC=+0.162 (n=531)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2848.7898 (IC base=+0.111)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0194` → IC=+0.218 (n=1085)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.211 (n=1451)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.249 (n=1628)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.209)

- **PATRÓN** `dist_vwap_pct` > `0.197` → IC=+0.232 (n=974)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.197 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.143` → IC=+0.270 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.143 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` < `1.0716` → IC=+0.209 (n=1433)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0716 (IC base=+0.209)

- **PATRÓN** `volumen_regimen` > `0.6367` → IC=+0.217 (n=1628)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6367 (IC base=+0.209)

- **PATRÓN** `volumen_pendiente_norm` > `0.2344` → IC=+0.250 (n=286)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.218 (n=1702)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `2615.2506` → IC=+0.223 (n=1085)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2615.2506 (IC base=+0.209)

- **PATRÓN** `sigma_h` < `0.0087` → IC=+0.224 (n=581)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0087 (IC base=+0.199)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.219 (n=581)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.5207` → IC=+0.254 (n=1741)
...
- **PATRÓN** `dist_vwap_pct` < `0.8778` → IC=+0.202 (n=1920)
...
- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.239 (n=581)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4351` → IC=+0.198 (n=1558)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.138 (n=2901)

- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.159 (n=2461)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.150)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2496)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.5239` → IC=+0.160 (n=2794)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `4.0` → IC=+0.170 (n=976)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.1896` → IC=+0.158 (n=1020)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1896 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4929` → IC=+0.143 (n=1661)
...
- **PATRÓN** `volumen_regimen` > `0.9016` → IC=+0.163 (n=1188)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.9016 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1725` → IC=+0.182 (n=765)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1725 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.4563` → IC=+0.157 (n=920)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4563 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8857` → IC=+0.162 (n=1840)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8857 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3694.2392` → IC=+0.151 (n=1862)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3694.2392 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.194 (n=731)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0038 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4861` → IC=+0.155 (n=2188)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4861 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=803)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 17.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.164 (n=743)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 4.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.184` → IC=+0.164 (n=963)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.184 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.6865` → IC=+0.150 (n=430)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6865 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.214` → IC=+0.146 (n=2179)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.214 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.2464` → IC=+0.141 (n=2086)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.2464 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.0724` → IC=+0.144 (n=1016)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.0724 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.5635` → IC=+0.140 (n=2162)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.5635 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.8136` → IC=+0.142 (n=1441)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.8136 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.138 (n=2901)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `6937.818` → IC=+0.150 (n=1954)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 6937.818 (IC base=+0.136)

### GBM_LATE_5M#BTC#5min
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.166 (n=327)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0056 (IC base=+0.148)
...
- **PATRÓN** `ibs_20min` < `0.5413` → IC=+0.187 (n=247)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5413 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` > `0.2054` → IC=+0.150 (n=175)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.2054 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.3916` → IC=+0.154 (n=359)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.3916 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.201` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 10.201 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.39` → IC=+0.161 (n=396)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 2.39 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.8487` → IC=+0.187 (n=247)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` > 0.8487 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.3073` → IC=+0.281 (n=39)
...
- **PATRÓN** `libro_liquidez` > `12446.0249` → IC=+0.188 (n=331)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 12446.0249 (IC base=+0.148)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.168 (n=341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.1409` → IC=+0.175 (n=404)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.1409 (IC base=+0.136)
...
- **PATRÓN** `dist_vwap_pct` < `0.1674` → IC=+0.136 (n=908)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1674 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.106` → IC=+0.152 (n=1000)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 9.106 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8802` → IC=+0.183 (n=610)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.8802 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.0693` → IC=+0.163 (n=431)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0693 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.4214` → IC=+0.141 (n=304)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4214 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.8194` → IC=+0.144 (n=608)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8194 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `11358.0518` → IC=+0.149 (n=915)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 11358.0518 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `712.0` → IC=+0.144 (n=869)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.226 (n=82)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.089)

- **PATRÓN** `dist_vwap_pct` > `0.2712` → IC=+0.132 (n=131)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` > 0.2712 (IC base=+0.089)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.177` → IC=+0.196 (n=44)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.177 (IC base=+0.089)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.212 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.089)

- **PATRÓN** `libro_liquidez` > `3421.4081` → IC=+0.143 (n=183)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 3421.4081 (IC base=+0.089)

- **PATRÓN** `sigma_h` > `0.0119` → IC=+0.196 (n=90)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0119 (IC base=+0.104)

- **PATRÓN** `drift_60min` |x|≤ `0.3939` → IC=+0.157 (n=132)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.3939 (IC base=+0.104)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.147 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 10.0 (IC base=+0.104)

- **PATRÓN** `ibs_20min` < `0.1429` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1429 (IC base=+0.104)

- **PATRÓN** `dist_vwap_pct` > `0.6189` → IC=+0.180 (n=98)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.6189 (IC base=+0.104)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.747` → IC=+0.126 (n=113)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 2.747 (IC base=+0.104)

- **PATRÓN** `volumen_pendiente_norm` < `0.1151` → IC=+0.154 (n=160)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1151 (IC base=+0.104)

- **PATRÓN** `libro_liquidez` > `3219.8531` → IC=+0.140 (n=198)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 3219.8531 (IC base=+0.104)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.146 (n=190)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 62.0 (IC base=+0.104)
...
- **PATRÓN** `ibs_20min` > `0.5333` → IC=+0.183 (n=772)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.5333 (IC base=+0.098)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `11.428` → IC=+0.219 (n=183)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.428 (IC base=+0.098)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0922` → IC=+0.143 (n=581)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 2.0922 (IC base=+0.098)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.124 (n=623)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2435.8886` → IC=+0.148 (n=339)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 2435.8886 (IC base=+0.098)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.168 (n=197)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0051 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.145 (n=263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 8.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.6839` → IC=+0.231 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6839 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.1269` → IC=+0.158 (n=150)
...
- **PATRÓN** `volumen_regimen` < `0.807` → IC=+0.129 (n=176)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 0.807 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` > `0.9516` → IC=+0.139 (n=120)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.9516 (IC base=+0.107)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7354` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.7354 (IC base=+0.107)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `py_entrada` > `0.5` → IC=+0.124 (n=658)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` > 0.5 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2896.6197` → IC=+0.174 (n=222)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2896.6197 (IC base=+0.107)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.030 (n=1671)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=743)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7372)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.173 (n=3201)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10257)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.171 (n=3455)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10428)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.213 (n=566)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1757)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.202 (n=582)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=1790)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.205 (n=609)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1868)

- **FILTRO** `ibs_20min` > `0.2821` → IC=-0.163 (n=619)
...
- **FILTRO** `py_entrada` < `0.48` → IC=-0.175 (n=555)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1753)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.183 (n=611)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1868)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2698)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=9553)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=21395)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7522)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=23426)

- **FILTRO** `ibs_7min` < `0.2895` → IC=-0.235 (n=7735)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2895
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=23213)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10483)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=20465)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.229 (n=9557)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=29061)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9635)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=28983)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.305 (n=1217)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3886)

- **FILTRO** `ibs_7min` < `0.7097` → IC=-0.249 (n=1681)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7097
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3422)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.182 (n=1182)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=3921)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1647)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=5000)

- **FILTRO** `drift_7min_pct` |x|> `0.1117` → IC=-0.124 (n=2255)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1117
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4392)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.208 (n=1660)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4987)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.136 (n=1255)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4097)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1286)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=4066)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.192 (n=1337)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4015)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.171 (n=1334)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=4018)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1343)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=4063)

- **FILTRO** `ibs_7min` > `0.2604` → IC=-0.177 (n=1351)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2604
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4055)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.187 (n=1345)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4061)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1375)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1180)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3652)

- **FILTRO** `ibs_7min` < `0.1961` → IC=-0.258 (n=1207)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1961
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3625)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.214 (n=1133)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3699)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1641)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=5446)

- **FILTRO** `ibs_7min` > `0.7536` → IC=-0.178 (n=1771)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7536
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=5316)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1508)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=3595)

- **FILTRO** `ibs_7min` < `0.7425` → IC=-0.180 (n=1275)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7425
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3828)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.167 (n=1251)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3852)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.266 (n=1150)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4034)

- **FILTRO** `ibs_7min` > `0.2759` → IC=-0.173 (n=1293)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2759
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=3891)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.189 (n=1276)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3908)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.262 (n=1294)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4124)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.241 (n=1336)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4082)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1763)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=5574)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.270 (n=1216)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=3924)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.227 (n=1282)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3858)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1233)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3907)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.203 (n=1693)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=5264)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1050)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=814)
...
- **PATRÓN** `dist_50` > `0.4421` → IC=+0.482 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_50` > 0.4421 (IC base=+0.416)
...
- **PATRÓN** `T_h` < `0.8294` → IC=+0.466 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `T_h` < 0.8294 (IC base=+0.475)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=383)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2808)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.227 (n=684)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2136` → IC=+0.191 (n=503)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.96€ cuando `delta_ratio_macro` |x|> 0.2136 (IC base=+0.187)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1267` → IC=+0.231 (n=523)
...
- **PATRÓN** `hora_utc` < `16.0` → IC=+0.188 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 16.0 (IC base=+0.187)

- **PATRÓN** `ibs_15` > `0.6079` → IC=+0.263 (n=1508)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6079 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` > `0.2982` → IC=+0.192 (n=543)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.2982 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.86` → IC=+0.271 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.86 (IC base=+0.187)

- **PATRÓN** `libro_liquidez` > `2980.6496` → IC=+0.193 (n=1005)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2980.6496 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.208 (n=823)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=541)

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.210 (n=350)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2526` → IC=+0.239 (n=117)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` > `0.7036` → IC=+0.264 (n=350)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7036 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` > `0.1369` → IC=+0.234 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1369 (IC base=+0.199)
...
- **PATRÓN** `libro_liquidez` > `15946.6772` → IC=+0.239 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15946.6772 (IC base=+0.199)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.215 (n=633)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1900)
...
- **PATRÓN** `ibs_15` > `0.6364` → IC=+0.269 (n=612)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6364 (IC base=-0.060)

- **PATRÓN** `dist_vwap_pct` > `0.431` → IC=+0.175 (n=161)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.431 (IC base=-0.060)

- **PATRÓN** `dist_vwap_pct` < `0.2735` → IC=+0.178 (n=480)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.2735 (IC base=-0.060)

- **PATRÓN** `delta_ratio_macro` |x|> `0.118` → IC=+0.241 (n=1065)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.118 (IC base=-0.038)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.178` → IC=+0.238 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.178 (IC base=-0.038)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.277 (n=1602)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.038)

- **PATRÓN** `dist_vwap_pct` > `0.6635` → IC=+0.290 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6635 (IC base=-0.038)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.216 (n=385)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=1157)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.226 (n=385)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1157)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=977)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=565)

- **FILTRO** `sigma_ewma_delta_pct` > `19.563` → IC=-0.247 (n=275)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.563
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1267)

- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.171 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0028 (IC base=+0.075)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2023` → IC=+0.279 (n=75)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2023 (IC base=+0.075)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1378` → IC=+0.317 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1378 (IC base=+0.075)

- **PATRÓN** `ibs_15` > `0.7413` → IC=+0.314 (n=165)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7413 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.0996` → IC=+0.273 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.0996 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` < `0.536` → IC=+0.271 (n=177)
...
- **PATRÓN** `sigma_h` < `0.0075` → IC=+0.239 (n=639)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0075 (IC base=+0.228)

- **PATRÓN** `drift_15min` |x|≤ `0.7829` → IC=+0.232 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7829 (IC base=+0.228)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2011` → IC=+0.250 (n=290)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.268 (n=639)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.232 (n=680)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.228)

- **PATRÓN** `libro_liquidez` > `3546.5572` → IC=+0.229 (n=639)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1536` → IC=+0.276 (n=145)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3457` → IC=+0.308 (n=435)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2394` → IC=+0.305 (n=213)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2394 (IC base=+0.288)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1077` → IC=+0.344 (n=177)
...
- **PATRÓN** `ibs_15` > `0.8418` → IC=+0.325 (n=639)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8418 (IC base=+0.288)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.291 (n=784)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.288)

- **PATRÓN** `libro_liquidez` > `14446.4188` → IC=+0.300 (n=213)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.26` → IC=+0.300 (n=118)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.26 (IC base=+0.281)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3796` → IC=+0.301 (n=285)
...
- **PATRÓN** `ibs_15` > `0.8308` → IC=+0.315 (n=354)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8308 (IC base=+0.281)

- **PATRÓN** `dist_vwap_pct` > `0.4333` → IC=+0.356 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4333 (IC base=+0.281)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.701` → IC=+0.355 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.701 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `16049.3542` → IC=+0.325 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16049.3542 (IC base=+0.281)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6079 sube el IC de +0.187 a +0.263 en UPDOWN_GBM#15min (n=1508). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7036 sube el IC de +0.199 a +0.264 en UPDOWN_GBM#BTC#15min (n=350). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6364 sube el IC de -0.060 a +0.269 en UPDOWN_GBM_15M_TARDIO (n=612). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.038 a +0.277 en UPDOWN_GBM_15M_TARDIO (n=1602). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7413 sube el IC de +0.075 a +0.314 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=165). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3469 sube el IC de +0.228 a +0.268 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=639). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3457 sube el IC de -0.047 a +0.308 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=435). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8418 sube el IC de +0.288 a +0.325 en UPDOWN_GBM_IBS_ALTO (n=639). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8308 sube el IC de +0.281 a +0.315 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=354). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 24264 | -0.090 | -3075.91€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1431 | -0.047 | -221.52€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22833 | -0.093 | -2854.39€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 6976 | -0.023 | -609.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6976 | -0.023 | -609.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6470 | -0.096 | -429.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6470 | -0.096 | -429.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5445 | -0.182 | -1078.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5445 | -0.182 | -1078.66€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 16963 | -0.030 | +4093.57€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4445 | -0.000 | +1828.57€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 12518 | -0.040 | +2265.00€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 16963 | -0.030 | +4093.57€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4445 | -0.000 | +1828.57€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 12518 | -0.040 | +2265.00€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 89067 | +0.113 | -4519.00€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 13571 | +0.184 | -429.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 355 | -0.094 | -50.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 69290 | +0.100 | -3824.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5851 | +0.108 | -214.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 11529 | +0.098 | -995.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 44 | -0.174 | -3.33€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 11470 | +0.100 | -980.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 18016 | +0.132 | -362.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4250 | +0.202 | -139.61€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 11485 | +0.112 | -173.15€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2239 | +0.106 | -27.51€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 11568 | +0.089 | -1080.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 51 | -0.085 | -5.77€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 11502 | +0.091 | -1063.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 18978 | +0.124 | -387.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 5247 | +0.175 | -78.19€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 11604 | +0.105 | -247.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2115 | +0.098 | -53.52€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 17430 | +0.115 | -1015.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min |