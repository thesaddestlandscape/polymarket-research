# Hipótesis automáticas — 2026-07-02 08:47 UTC
_Generado por shadow_postmortem.py sobre 2591 resoluciones (PNL=-75.71€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M` — IC=+0.294 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#15min` — IC=+0.294 n=32. Faltan ~8 resoluciones para umbral n≥40. ETA: ~6h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 32 | +0.294 | +10.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 32 | +0.294 | +10.21€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 8 | +0.080 | +2.05€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 8 | +0.080 | +2.05€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 9 | +0.143 | +3.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 9 | +0.143 | +3.54€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.002 n=1208 | tras_1loss IC=-0.037 n=1269 | tras_2loss IC=-0.051 n=662/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 174/200 ops en el filtro definido (IC actual=+0.074 PNL=+17.21€)
  - _Datos_: n=174 IC=+0.074 PNL=+17.21€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=174 IC=+0.074 PNL=+17.21€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=174 IC=+0.074 PNL=+17.21€
