# Hipótesis automáticas — 2026-09-04 21:55 UTC
_Generado por shadow_postmortem.py sobre 286702 resoluciones (PNL=+28183.81€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.44` → IC=-0.299 (n=3855)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.44
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=11565)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `134.08` → IC=-0.320 (n=510)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.08
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1533)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.209 (n=1134)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `13169.0911` → IC=+0.220 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13169.0911 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.198 (n=860)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.190 (n=1206)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.01 (IC base=+0.189)

- **PATRÓN** `libro_liquidez` > `12563.1974` → IC=+0.207 (n=424)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.144 (n=1691)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.215 (n=402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.208 (n=289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.214 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `932.5146` → IC=+0.211 (n=797)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 932.5146 (IC base=+0.204)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.195 (n=6364)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=3025)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=1634)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.177 (n=1535)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.175 (n=1643)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.74 (IC base=+0.171)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.183 (n=1085)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=1562)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.181 (n=2683)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.72 (IC base=+0.151)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=3139)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.273 (n=1771)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.226)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=1148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=1603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.210 (n=1265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.190 (n=1115)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `6.9` → IC=+0.148 (n=1578)

  - _Acción_: Kelly boost +0.74€ cuando `lag_apertura_s` < 6.9 (IC base=+0.136)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=1284)
...
- **PATRÓN** `restante_min` > `4.95` → IC=+0.168 (n=1223)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` > 4.95 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.127 (n=3649)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.168 (n=1212)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3614` → IC=+0.131 (n=3839)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` > 0.3614 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` < `0.4693` → IC=+0.227 (n=821)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4693 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.65` → IC=+0.152 (n=1462)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 5.65 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` < `0.6258` → IC=+0.228 (n=296)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1704` → IC=+0.186 (n=661)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1704 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` < `2.8416` → IC=+0.179 (n=2321)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.8416 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `1.4728` → IC=+0.175 (n=2321)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.4728 (IC base=+0.084)

- **PATRÓN** `ibs_20min` < `0.4017` → IC=+0.128 (n=3684)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4017 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` < `0.3396` → IC=+0.145 (n=1368)
...
- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.144 (n=596)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8121` → IC=+0.213 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8121 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `121.0` → IC=+0.210 (n=1544)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2892` → IC=+0.156 (n=856)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.2892 (IC base=+0.154)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.244 (n=225)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.237 (n=675)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.4806` → IC=+0.220 (n=616)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4806 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.257` → IC=+0.229 (n=323)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.257 (IC base=+0.215)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.216 (n=675)
...
- **PATRÓN** `libro_liquidez` > `11046.4069` → IC=+0.238 (n=673)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11046.4069 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.150 (n=490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.004 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.145 (n=654)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.003 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.1766` → IC=+0.148 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1766 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.142 (n=661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6604` → IC=+0.165 (n=733)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6604 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.3375` → IC=+0.158 (n=714)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.3375 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.516` → IC=+0.226 (n=122)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1495` → IC=+0.219 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1495 (IC base=+0.140)
...
- **PATRÓN** `volumen_spike_ratio` > `1.3961` → IC=+0.157 (n=624)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.3961 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12711.7416` → IC=+0.153 (n=488)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12711.7416 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.199 (n=270)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.197 (n=391)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 8.0 (IC base=+0.167)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1043` → IC=+0.161 (n=668)
  ...
  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` < 0.1043 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `3.8523` → IC=+0.161 (n=724)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 3.8523 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.6803` → IC=+0.176 (n=724)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.6803 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.191 (n=845)

  - _Acción_: Kelly boost +0.95€ cuando `libro_spread` < 0.04 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.195 (n=496)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 47.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0103` → IC=+0.244 (n=662)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0103 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.386` → IC=+0.235 (n=582)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.386 (IC base=+0.234)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.239 (n=324)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0315` → IC=+0.294 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0315 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.731` → IC=+0.288 (n=64)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.731 (IC base=+0.234)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.200 (n=128)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=945)
...
- **PATRÓN** `ibs_20min` > `0.3` → IC=+0.145 (n=4735)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.449` → IC=-0.160 (n=348)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2185` → IC=+0.340 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2185 (IC base=+0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.8884` → IC=+0.226 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8884 (IC base=+0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4728` → IC=+0.227 (n=232)
...
- **PATRÓN** `ibs_20min` > `0.7083` → IC=+0.262 (n=682)
...
- **PATRÓN** `volumen_spike_ratio` > `1.727` → IC=+0.235 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.727 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.257 (n=792)
...
- **FILTRO** `ibs_20min` < `0.8224` → IC=-0.140 (n=675)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8224
  - _Potencial_: sin este filtro IC_bueno=+0.297 (n=348)
...
- **PATRÓN** `ibs_20min` > `0.8224` → IC=+0.297 (n=348)
...
- **PATRÓN** `ibs_20min` > `0.9014` → IC=+0.327 (n=507)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.175` → IC=+0.293 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.175 (IC base=+0.255)

- **PATRÓN** `volumen_regimen` > `0.839` → IC=+0.294 (n=507)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5676` → IC=+0.262 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5676 (IC base=+0.255)

- **PATRÓN** `volumen_spike_ratio` > `1.8318` → IC=+0.261 (n=466)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8318 (IC base=+0.255)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.258 (n=878)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.255)

- **PATRÓN** `libro_liquidez` > `2469.502` → IC=+0.261 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2469.502 (IC base=+0.255)
...
- **PATRÓN** `ibs_20min` < `0.4387` → IC=+0.227 (n=3715)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4387 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` < `0.2266` → IC=+0.170 (n=2817)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2266 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.024` → IC=+0.212 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.024 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` < `1.1714` → IC=+0.164 (n=2801)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1714 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` > `0.6221` → IC=+0.159 (n=2801)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6529` → IC=+0.201 (n=1029)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6529 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.177 (n=2674)
...
- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.225 (n=198)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.4092` → IC=+0.173 (n=592)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.4092 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.198 (n=544)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.2039` → IC=+0.220 (n=420)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2039 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.9` → IC=+0.233 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.9 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.6383` → IC=+0.185 (n=198)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6383 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.170 (n=268)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0678 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2302` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2302 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.4774` → IC=+0.204 (n=248)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4774 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `11389.116` → IC=+0.191 (n=528)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11389.116 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.180 (n=679)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0061 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.0625` → IC=+0.212 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0625 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.172 (n=629)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1998` → IC=+0.172 (n=686)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1998 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.232` → IC=+0.241 (n=141)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4143` → IC=+0.163 (n=571)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4143 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.3935` → IC=+0.161 (n=571)
...
- **PATRÓN** `sigma_h` > `0.0095` → IC=+0.214 (n=208)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0095 (IC base=+0.174)

- **PATRÓN** `drift_60min` |x|≤ `0.1779` → IC=+0.199 (n=417)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1779 (IC base=+0.174)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.193 (n=213)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.632` → IC=+0.316 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.632 (IC base=+0.174)

- **PATRÓN** `volumen_pendiente_norm` > `0.1318` → IC=+0.188 (n=229)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.1318 (IC base=+0.174)

- **PATRÓN** `volumen_spike_ratio` < `3.1353` → IC=+0.167 (n=494)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 3.1353 (IC base=+0.174)

- **PATRÓN** `volumen_spike_ratio` > `1.7083` → IC=+0.168 (n=561)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.7083 (IC base=+0.174)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=639)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.04 (IC base=+0.174)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.190 (n=127)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 18.0 (IC base=+0.174)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.247 (n=492)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.229)

- **PATRÓN** `drift_60min` |x|≤ `0.227` → IC=+0.245 (n=328)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.227 (IC base=+0.229)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.248 (n=340)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.229)

- **PATRÓN** `ibs_20min` < `0.374` → IC=+0.265 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.374 (IC base=+0.229)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.832` → IC=+0.300 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.832 (IC base=+0.229)

- **PATRÓN** `volumen_pendiente_norm` > `0.3671` → IC=+0.268 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3671 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` < `1.9277` → IC=+0.226 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9277 (IC base=+0.229)

- **PATRÓN** `volumen_spike_ratio` > `3.0796` → IC=+0.217 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.0796 (IC base=+0.229)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=788)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.113)
...
- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.122 (n=749)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5029` → IC=+0.124 (n=713)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0982` → IC=+0.148 (n=228)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0982 (IC base=+0.130)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.184 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 15.0 (IC base=+0.130)

- **PATRÓN** `ibs_20min` < `0.4688` → IC=+0.219 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4688 (IC base=+0.130)

- **PATRÓN** `dist_vwap_pct` < `0.2472` → IC=+0.141 (n=653)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.2472 (IC base=+0.130)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.282` → IC=+0.157 (n=272)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.282 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` < `1.1678` → IC=+0.143 (n=684)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.1678 (IC base=+0.130)

- **PATRÓN** `volumen_regimen` > `0.8537` → IC=+0.140 (n=456)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5471` → IC=+0.139 (n=242)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5471 (IC base=+0.130)
...
- **PATRÓN** `libro_liquidez` > `1452.0978` → IC=+0.149 (n=611)
...
- **PATRÓN** `sigma_h` > `0.0174` → IC=+0.218 (n=505)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0174 (IC base=+0.192)

- **PATRÓN** `drift_60min` |x|≤ `0.1686` → IC=+0.214 (n=334)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1686 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=793)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.192)

- **PATRÓN** `ibs_20min` > `0.8873` → IC=+0.271 (n=505)
...
- **PATRÓN** `volumen_regimen` > `0.6862` → IC=+0.210 (n=677)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0969` → IC=+0.145 (n=288)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.0969 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=824)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.4444` → IC=+0.171 (n=865)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.4444 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.964` → IC=+0.232 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.964 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.607` → IC=+0.179 (n=397)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 3.607 (IC base=+0.140)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1709` → IC=+0.172 (n=236)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1709 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.453` → IC=+0.162 (n=270)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.453 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.8202` → IC=+0.145 (n=539)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8202 (IC base=+0.140)
...
- **PATRÓN** `ballena_activa_n` < `14.0` → IC=+0.176 (n=220)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 14.0 (IC base=+0.140)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=4847)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.240 (n=4436)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.4479` → IC=+0.171 (n=3145)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.4479 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.693` → IC=+0.215 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.693 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.7` → IC=+0.189 (n=4151)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 2.7 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` < `0.6223` → IC=+0.168 (n=1049)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6223 (IC base=+0.187)

- **PATRÓN** `volumen_regimen` > `1.1954` → IC=+0.164 (n=1049)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2967` → IC=+0.201 (n=1688)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2967 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.182 (n=3306)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5922` → IC=+0.186 (n=313)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.5922 (IC base=+0.185)

- **PATRÓN** `volumen_spike_ratio` > `1.8862` → IC=+0.173 (n=472)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 1.8862 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.230 (n=632)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.239 (n=458)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.166 (n=698)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.006 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.0956` → IC=+0.169 (n=264)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.0956 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.182 (n=709)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 8.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.204 (n=793)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.417` → IC=+0.167 (n=692)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` < 4.417 (IC base=+0.159)

- **PATRÓN** `volumen_regimen` < `1.261` → IC=+0.168 (n=792)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1452` → IC=+0.191 (n=215)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.1452 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` < `2.3852` → IC=+0.177 (n=742)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.3852 (IC base=+0.159)

- **PATRÓN** `volumen_spike_ratio` > `1.7227` → IC=+0.174 (n=495)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.7227 (IC base=+0.159)

- **PATRÓN** `libro_liquidez` > `10792.8871` → IC=+0.183 (n=707)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10792.8871 (IC base=+0.159)

- **PATRÓN** `ballena_activa_n` < `470.0` → IC=+0.176 (n=588)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 470.0 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.171 (n=718)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0062 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.003` → IC=+0.167 (n=640)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.003 (IC base=+0.164)

- **PATRÓN** `drift_60min` |x|≤ `0.2725` → IC=+0.179 (n=631)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.2725 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.167 (n=746)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 18.0 (IC base=+0.164)

- **PATRÓN** `ibs_20min` < `0.6191` → IC=+0.202 (n=717)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6191 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.1465` → IC=+0.179 (n=622)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1465 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.763` → IC=+0.208 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.763 (IC base=+0.164)

- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.226 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.618 (IC base=+0.164)

- **PATRÓN** `volumen_pendiente_norm` > `0.1414` → IC=+0.235 (n=187)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0527` → IC=+0.193 (n=281)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.220 (n=697)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6809` → IC=+0.255 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6809 (IC base=+0.209)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.656` → IC=+0.336 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.656 (IC base=+0.209)
...
- **PATRÓN** `volumen_spike_ratio` < `3.8887` → IC=+0.206 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.8887 (IC base=+0.209)

- **PATRÓN** `volumen_spike_ratio` > `2.4543` → IC=+0.210 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4543 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.237 (n=718)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.209)

- **PATRÓN** `libro_liquidez` > `1455.0584` → IC=+0.211 (n=697)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1455.0584 (IC base=+0.209)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.261 (n=412)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4454` → IC=+0.150 (n=635)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4454 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.146 (n=244)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 17.0 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.166 (n=315)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 8.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` < `0.6809` → IC=+0.175 (n=635)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6809 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.4106` → IC=+0.130 (n=642)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4106 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.298` → IC=+0.207 (n=97)
...
- **PATRÓN** `volumen_spike_ratio` > `2.512` → IC=+0.163 (n=191)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 2.512 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `9578.0604` → IC=+0.176 (n=288)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 9578.0604 (IC base=+0.127)

- **PATRÓN** `ballena_activa_n` < `193.0` → IC=+0.143 (n=491)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 193.0 (IC base=+0.127)
...
- **PATRÓN** `hora_utc` > `12.0` → IC=+0.137 (n=563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 12.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4737` → IC=+0.179 (n=835)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.4737 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.177 (n=267)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0059 (IC base=+0.118)

- **PATRÓN** `drift_60min` |x|≤ `0.1315` → IC=+0.175 (n=266)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.1315 (IC base=+0.118)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.147 (n=386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5915` → IC=+0.199 (n=796)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5915 (IC base=+0.118)

- **PATRÓN** `dist_vwap_pct` < `0.5114` → IC=+0.139 (n=770)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.5114 (IC base=+0.118)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.218` → IC=+0.137 (n=782)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 3.218 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` < `1.0622` → IC=+0.133 (n=700)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` < 1.0622 (IC base=+0.118)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5612` → IC=+0.140 (n=284)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.5612 (IC base=+0.118)
...
- **PATRÓN** `libro_liquidez` > `2665.5883` → IC=+0.158 (n=361)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2665.5883 (IC base=+0.118)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=955)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.248 (n=451)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8201` → IC=+0.209 (n=571)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8201 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.208 (n=1030)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.783` → IC=+0.123 (n=1425)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1749` → IC=+0.155 (n=424)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1749 (IC base=+0.122)
...
- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.202 (n=122)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.4334` → IC=+0.155 (n=320)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4334 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.191 (n=331)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` > 8.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.9692` → IC=+0.232 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9692 (IC base=+0.146)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0966` → IC=+0.167 (n=148)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0966 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `3.5716` → IC=+0.151 (n=362)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 3.5716 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.4202` → IC=+0.158 (n=241)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.4202 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `1761.2152` → IC=+0.152 (n=363)
...
- **PATRÓN** `libro_liquidez` > `2782.0436` → IC=+0.191 (n=95)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2782.0436 (IC base=+0.099)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.179 (n=1526)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=4606)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.186 (n=1555)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4828)
...
- **FILTRO** `py_entrada` > `0.66` → IC=-0.166 (n=276)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=844)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=35)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=969)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.149 (n=274)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=758)
...
- **FILTRO** `drift_20min_pct` |x|> `0.2174` → IC=-0.200 (n=18)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.2174
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.135 (n=3180)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=11741)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=3650)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=11271)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.241 (n=3724)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=11197)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=5058)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=9863)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=4616)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=14240)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4702)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=14154)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=536)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1646)

- **FILTRO** `ibs_7min` < `0.7013` → IC=-0.256 (n=720)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7013
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1462)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.219 (n=536)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=1646)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.238 (n=816)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1139` → IC=-0.130 (n=1113)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2166)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.198 (n=818)
...
- **FILTRO** `py_entrada` > `0.64` → IC=-0.242 (n=657)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2127)

- **FILTRO** `ballena_activa_n` > `108.0` → IC=-0.174 (n=945)
...
- **FILTRO** `py_entrada` < `0.37` → IC=-0.310 (n=698)
...
- **FILTRO** `ibs_7min` < `0.2167` → IC=-0.294 (n=551)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1653)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.238 (n=537)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1667)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=794)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2603)

- **FILTRO** `ibs_7min` > `0.2784` → IC=-0.155 (n=1154)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2784
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2243)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.140 (n=762)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=1761)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.262 (n=608)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1915)

- **FILTRO** `ibs_7min` < `0.754` → IC=-0.193 (n=630)
...
- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.177 (n=833)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1690)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.234 (n=840)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1706)

- **FILTRO** `ibs_7min` > `0.2766` → IC=-0.179 (n=636)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2766
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1910)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.187 (n=624)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1922)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.244 (n=669)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2120)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.206 (n=691)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=2098)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.184 (n=685)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2104)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=845)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2702)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.292 (n=598)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1856)

- **FILTRO** `ibs_7min` < `0.7348` → IC=-0.240 (n=613)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7348
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=1841)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.228 (n=597)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1857)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.210 (n=818)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2485)

- **FILTRO** `ibs_7min` > `0.7674` → IC=-0.161 (n=825)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7674
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2478)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.154 (n=24)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=907)

### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.162 (n=190)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0037 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.172 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0074 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.1673` → IC=+0.136 (n=501)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.1673 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0596` → IC=+0.135 (n=570)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.67€ cuando `delta_ratio_macro` |x|> 0.0596 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.137 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5906` → IC=+0.218 (n=570)
...
- **PATRÓN** `dist_vwap_pct` < `0.5623` → IC=+0.134 (n=605)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.5623 (IC base=+0.135)
...
- **FILTRO** `sigma_ewma_delta_pct` > `7.859` → IC=-0.198 (n=41)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=990)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0501` → IC=+0.160 (n=151)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio_macro` |x|> 0.0501 (IC base=+0.121)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.176 (n=69)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 6.0 (IC base=+0.121)

- **PATRÓN** `ibs_15` > `0.5` → IC=+0.199 (n=151)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5 (IC base=+0.121)

- **PATRÓN** `dist_vwap_pct` > `0.2657` → IC=+0.196 (n=67)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.2657 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.701` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.701 (IC base=+0.121)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=126)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `2504.7554` → IC=+0.172 (n=135)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2504.7554 (IC base=+0.121)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 37.0 (IC base=+0.121)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1248` → IC=+0.229 (n=330)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `dist_vwap_pct` < `0.4544` → IC=+0.223 (n=528)
...
- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.276 (n=243)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.4118` → IC=+0.211 (n=268)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4118 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `18.178` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 18.178 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.415` → IC=+0.228 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.415 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `3621.1646` → IC=+0.210 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3621.1646 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `188.0` → IC=+0.213 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 188.0 (IC base=+0.211)
...
- **PATRÓN** `ibs_15` > `0.0833` → IC=+0.281 (n=112)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.0833 (IC base=-0.058)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5906 sube el IC de +0.135 a +0.218 en UPDOWN_GBM#15min (n=570). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5 sube el IC de +0.121 a +0.199 en UPDOWN_GBM#XRP#15min (n=151). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3696 sube el IC de +0.211 a +0.276 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=243). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS > 0.0833 sube el IC de -0.058 a +0.281 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=112). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 15420 | -0.115 | -2586.98€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 974 | -0.013 | -144.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 14446 | -0.122 | -2442.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2043 | -0.102 | -467.02€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2043 | -0.102 | -467.02€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 974 | -0.013 | -144.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 974 | -0.013 | -144.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2057 | -0.174 | -571.20€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2057 | -0.174 | -571.20€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4112 | -0.053 | -378.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4112 | -0.053 | -378.98€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3420 | -0.128 | -271.09€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3420 | -0.128 | -271.09€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2814 | -0.193 | -754.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2814 | -0.193 | -754.69€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 4569 | -0.077 | +1873.69€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1301 | -0.013 | +958.04€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3268 | -0.103 | +915.66€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 4569 | -0.077 | +1873.69€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1301 | -0.013 | +958.04€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3268 | -0.103 | +915.66€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 49473 | +0.114 | -3010.46€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 8239 | +0.184 | -275.01€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 171 | -0.107 | -54.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 37254 | +0.099 | -2600.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3809 | +0.116 | -80.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 6253 | +0.085 | -792.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 27 | -0.121 | +3.75€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 6211 | +0.087 | -784.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 9900 | +0.132 | -223.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2428 | +0.198 | -115.99€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 6154 | +0.109 | -131.40€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1276 | +0.124 | +45.82€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 6272 | +0.084 | -762.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 29 | +0.016 | +3.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#240min | 12 | -0.171 | -8.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 6231 | +0.085 | -757.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 10698 | +0.127 | -160.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 3078 | +0.171 | -20.70€ | 1 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 6196 | +0.112 | -88.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1412 | +0.096 | -43.26€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 10099 | +0.123 | -648.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2656 | +0.191 | -146.75€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 84 | -0.012 | -2.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 6238 | +0.095 | -416.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1121 | +0.131 | -83.04€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 6251 | +0.105 | -421.52€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 21 | -0.022 | +1.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 6 | +0.000 | -0.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 6224 | +0.106 | -422.35€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 8162 | +0.178 | -633.45€ | 2 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 8162 | +0.178 | -633.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2082 | +0.164 | -236.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2082 | +0.164 | -236.03€ | 0 | 2 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2036 | +0.171 | -209.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2036 | +0.171 | -209.51€ | 0 | 4 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1989 | +0.183 | -156.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1989 | +0.183 | -156.56€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 26459 | +0.189 | -2444.84€ | 2 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 26459 | +0.189 | -2444.84€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 4699 | +0.151 | -726.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 4699 | +0.151 | -726.26€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 4131 | +0.226 | -141.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 4131 | +0.226 | -141.17€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 4576 | +0.163 | -617.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 4576 | +0.163 | -617.47€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 4219 | +0.219 | -172.31€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min | 4219 | +0.219 | -172.31€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL | 4379 | +0.199 | -325.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | 4379 | +0.199 | -325.91€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP | 4455 | +0.184 | -461.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | 4455 | +0.184 | -461.71€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 9620 | +0.131 | +324.09€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 9620 | +0.131 | +324.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 4773 | +0.136 | +206.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 4773 | +0.136 | +206.64€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 4847 | +0.125 | +117.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 4847 | +0.125 | +117.45€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO_DEPTH_FASE0 | 