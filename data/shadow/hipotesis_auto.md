# Hipótesis automáticas — 2026-07-12 15:03 UTC
_Generado por shadow_postmortem.py sobre 11064 resoluciones (PNL=+2036.69€)_
...
- **PATRÓN** `hora_utc` < `9.0` → IC=+0.216 (n=167)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.145)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.303 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.150 (n=407)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `5937.8835` → IC=+0.161 (n=163)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 5937.8835 (IC base=+0.145)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.232 (n=54)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.285 (n=77)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.253)

- **PATRÓN** `py_entrada` < `0.605` → IC=+0.259 (n=27)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.605 (IC base=+0.253)

- **PATRÓN** `py_entrada` > `0.765` → IC=+0.357 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.765 (IC base=+0.253)

- **PATRÓN** `libro_liquidez` > `3151.1844` → IC=+0.279 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3151.1844 (IC base=+0.253)
...
- **PATRÓN** `py_entrada` > `0.665` → IC=+0.336 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.665 (IC base=+0.227)

- **PATRÓN** `libro_liquidez` > `1873.3412` → IC=+0.315 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1873.3412 (IC base=+0.227)
...
### GBM_LATE_15M
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.124 (n=1347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 6.0 (IC base=+0.117)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.123 (n=1343)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 17.0 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.4537` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.4537 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.122` → IC=+0.206 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.122 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.54` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.54 (IC base=+0.117)
...
- **PATRÓN** `dist_vwap_pct` < `0.1111` → IC=+0.180 (n=23)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1111 (IC base=+0.086)

### GBM_LATE_15M#ETH#15min
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.158 (n=112)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0045 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.4153` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.4153 (IC base=+0.092)
...
- **PATRÓN** `sigma_h` < `0.0161` → IC=+0.140 (n=359)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0161 (IC base=+0.125)
...
- **PATRÓN** `dist_vwap_pct` > `0.4777` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4777 (IC base=+0.125)
...
- **PATRÓN** `sigma_h` < `0.0319` → IC=+0.185 (n=306)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0319 (IC base=+0.168)

- **PATRÓN** `sigma_h` > `0.014` → IC=+0.180 (n=273)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.014 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 6.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.182 (n=209)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 11.0 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.1286` → IC=+0.278 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1286 (IC base=+0.168)
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.196 (n=324)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0049 (IC base=+0.176)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=321)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.176)

- **PATRÓN** `dist_vwap_pct` > `0.4537` → IC=+0.250 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4537 (IC base=+0.176)

- **PATRÓN** `dist_vwap_pct` < `0.1253` → IC=+0.204 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1253 (IC base=+0.176)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.685` → IC=+0.333 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.685 (IC base=+0.176)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.164 (n=102)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0058 (IC base=+0.164)

- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.220 (n=91)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.167 (n=22)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.164)
...
- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.185 (n=71)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0049 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.175 (n=75)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 12.0 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.170 (n=107)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 17.0 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `0.4274` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4274 (IC base=+0.150)
...
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.205 (n=59)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.139)
...
- **PATRÓN** `sigma_h` < `0.0186` → IC=+0.329 (n=68)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0186 (IC base=+0.272)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.300 (n=63)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_h` > `0.0135` → IC=+0.128 (n=143)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` > 0.0135 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` < `0.1146` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.1146 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.483` → IC=+0.352 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.483 (IC base=+0.081)
...
- **PATRÓN** `dist_vwap_pct` < `0.0947` → IC=+0.136 (n=20)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.0947 (IC base=+0.079)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.134 (n=39)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0035 (IC base=+0.023)

- **PATRÓN** `dist_vwap_pct` > `0.4153` → IC=+0.136 (n=20)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.4153 (IC base=+0.023)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.130 (n=52)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` < 0.0055 (IC base=-0.003)
...
- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.167 (n=31)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0053 (IC base=+0.065)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=349)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.124 (n=240)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 13.0 (IC base=+0.020)

- **PATRÓN** `ibs_15` > `0.5859` → IC=+0.122 (n=292)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` > 0.5859 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` > `0.168` → IC=+0.201 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.168 (IC base=+0.020)

- **PATRÓN** `dist_vwap_pct` < `0.267` → IC=+0.182 (n=86)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` < 0.267 (IC base=+0.020)
...
- **PATRÓN** `drift_60min` |x|≤ `0.237` → IC=+0.123 (n=136)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.237 (IC base=+0.059)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.169 (n=128)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 11.0 (IC base=+0.059)

- **PATRÓN** `ibs_15` < `0.9183` → IC=+0.158 (n=115)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.79€ cuando `ibs_15` < 0.9183 (IC base=+0.059)

- **PATRÓN** `ibs_15` > `0.6428` → IC=+0.167 (n=115)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` > 0.6428 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.2086` → IC=+0.346 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2086 (IC base=+0.059)
...
- **PATRÓN** `ibs_15` > `0.7622` → IC=+0.213 (n=85)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7622 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` < `0.5087` → IC=+0.167 (n=64)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.5087 (IC base=+0.032)
...
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS < 0.9183 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.158 n=115). Confirma señal de reversión media → alinear con BUY_YES.
- **H-IBS-UPDOWN_GBM#BTC#15min**: IBS > 0.6428 correlaciona con éxito en UPDOWN_GBM#BTC#15min (IC=+0.167 n=115). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 928 | +0.178 | -2.12€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 597 | +0.209 | +7.40€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 273 | +0.180 | -8.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 199 | +0.202 | -10.07€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 329 | +0.168 | +2.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 198 | +0.210 | +6.66€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 324 | +0.187 | +4.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 198 | +0.215 | +10.77€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 13 | +0.065 | +0.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 61 | +0.135 | -3.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 52 | +0.148 | -4.27€ | 0 | 0 |
| ✅ GBM_LATE_15M | 3611 | +0.114 | +1197.88€ | 0 | 9 |
| ✅ GBM_LATE_15M#15min | 3611 | +0.114 | +1197.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 888 | +0.070 | +115.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 888 | +0.070 | +115.98€ | 0 | 1 |
| ✅ GBM_LATE_15M#ETH | 914 | +0.072 | +144.35€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 914 | +0.072 | +144.35€ | 0 | 3 |
| ✅ GBM_LATE_15M#SOL | 941 | +0.139 | +466.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 941 | +0.139 | +466.81€ | 0 | 9 |
| ✅ GBM_LATE_15M#XRP | 868 | +0.175 | +470.74€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 868 | +0.175 | +470.74€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 972 | +0.165 | +538.50€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 972 | +0.165 | +538.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 255 | +0.165 | +168.21€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 255 | +0.165 | +168.21€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 260 | +0.126 | +92.58€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 260 | +0.126 | +92.58€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 272 | +0.120 | +88.40€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 272 | +0.120 | +88.40€ | 0 | 5 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 185 | +0.281 | +189.30€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 185 | +0.281 | +189.30€ | 0 | 5 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1134 | +0.082 | +279.69€ | 1 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1134 | +0.082 | +279.69€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 263 | +0.077 | +36.72€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 263 | +0.077 | +36.72€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 281 | +0.005 | +7.02€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 281 | +0.005 | +7.02€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 296 | +0.037 | +36.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 296 | +0.037 | +36.66€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 294 | +0.203 | +199.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 294 | +0.203 | +199.29€ | 0 | 8 |
| ✅ GBM_LATE_60M | 311 | -0.113 | +5.66€ | 2 | 1 |
| ✅ GBM_LATE_60M#60min | 311 | -0.113 | +5.66€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC | 106 | -0.028 | +4.62€ | 0 | 0 |
| ✅ GBM_LATE_60M#BTC#60min | 106 | -0.028 | +4.62€ | 3 | 1 |
...
| ✅ UPDOWN_GBM | 1328 | -0.006 | +28.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1072 | +0.023 | +66.43€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#BTC | 357 | +0.013 | +10.65€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 278 | +0.054 | +24.04€ | 1 | 8 |
...
| ✅ UPDOWN_GBM#ETH | 657 | +0.014 | +36.73€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 564 | +0.034 | +47.79€ | 0 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.119) — sin ventaja clara. oversold(IBS<0.3): IC=-0.023 n=344 | neutral: IC=-0.044 n=261 | overbought(IBS>0.7): IC=+0.075 n=292
  - _Datos_: n=938 IC=+0.009 PNL=+54.19€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.156 n=30 PNL=-6.41€ → FILTRAR | H=07h: IC=+0.110 n=39 PNL=+13.58€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.128 n=41 PNL=+13.00€ → BOOST | H=17h: IC=+0.130 n=44 PNL=+14.88€ → BOOST | H=22h: IC=+0.108 n=49 PNL=+7.56€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.092 n=6253 | tras_1loss IC=+0.045 n=4674 | tras_2loss IC=+0.011 n=2095/40 | gap=+0.081 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.081 n=501/40 PNL=+118.88€ | H=15h UTC: IC=+0.099 n=464/40 PNL=+115.98€ | H=17h UTC: IC=+0.122 n=382/40 PNL=+123.97€ | H=19h UTC: IC=+0.063 n=385/40 PNL=+49.78€
...
**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  ...
  - _Estado_: alineado_BTC IC=+0.000 n=122 | contrario_BTC IC=-0.059 n=57/40 | gap=-0.059 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=209 IC=+0.007 PNL=+11.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=209 IC=+0.007 PNL=+11.97€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1201 IC=+0.000 PNL=+42.96€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1201 IC=+0.000 PNL=+42.96€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=610 IC=+0.020 PNL=+31.39€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=610 IC=+0.020 PNL=+31.39€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=278 IC=+0.054 PNL=+24.04€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=278 IC=+0.054 PNL=+24.04€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=553 IC=+0.053 PNL=+49.28€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=553 IC=+0.053 PNL=+49.28€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8606 IC=+0.098 PNL=+2112.57€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8606 IC=+0.098 PNL=+2112.57€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=757 IC=-0.014 PNL=+0.92€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=757 IC=-0.014 PNL=+0.92€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.175 > 0.1 con n=272 PNL=+104.59€
  - _Datos_: n=272 IC=+0.175 PNL=+104.59€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.178 > 0.08 con n=206 PNL=+77.63€
  - _Datos_: n=206 IC=+0.178 PNL=+77.63€
...
**🔶 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.239 n=86) pero sin cruzar ≥2 pares más — ETH: n=108 IC=+0.145 ✓; SOL: n=7 IC=-0.019; XRP: n=5 IC=+0.018
  - _Datos_: n=86 IC=+0.239 PNL=+40.40€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.308 > 0.2 con n=144 PNL=+102.08€
  - _Datos_: n=144 IC=+0.308 PNL=+102.08€
...
**⏳ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: 12/40 ops en el filtro definido (IC actual=+0.086 PNL=+10.11€)
  - _Datos_: n=12 IC=+0.086 PNL=+10.11€

**⏳ H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: 40
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: 11/40 ops en el filtro definido (IC actual=+0.064 PNL=+9.78€)
  - _Datos_: n=11 IC=+0.064 PNL=+9.78€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.317 > 0.08 con n=69 PNL=+7.55€
  - _Datos_: n=69 IC=+0.317 PNL=+7.55€
