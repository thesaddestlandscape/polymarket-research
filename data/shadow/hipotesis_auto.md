# Hipótesis automáticas — 2026-08-17 16:49 UTC
_Generado por shadow_postmortem.py sobre 51430 resoluciones (PNL=+5689.42€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.221 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.150)

- **PATRÓN** `restante_min` < `3.72` → IC=+0.173 (n=408)

  - _Acción_: Kelly boost +0.87€ cuando `restante_min` < 3.72 (IC base=+0.150)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.198 (n=415)

  - _Acción_: Kelly boost +0.99€ cuando `restante_min` > 4.91 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.157 (n=1240)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 16.0 (IC base=+0.150)

- **PATRÓN** `lag_apertura_s` < `5.45` → IC=+0.198 (n=408)

  - _Acción_: Kelly boost +0.99€ cuando `lag_apertura_s` < 5.45 (IC base=+0.150)

- **PATRÓN** `profundidad_ratio_no` > `9.1` → IC=+0.155 (n=407)
...
- **PATRÓN** `restante_min` < `3.61` → IC=+0.188 (n=203)

  - _Acción_: Kelly boost +0.94€ cuando `restante_min` < 3.61 (IC base=+0.154)

- **PATRÓN** `restante_min` > `4.87` → IC=+0.198 (n=213)

  - _Acción_: Kelly boost +0.99€ cuando `restante_min` > 4.87 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.166 (n=630)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### MOMENTUM_IBS_15M
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.239 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.5 (IC base=+0.181)

- **PATRÓN** `ibs_20min` > `0.9851` → IC=+0.333 (n=16)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9851 (IC base=+0.181)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `ibs_20min` > `0.7299` → IC=-0.250 (n=26)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7299
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=17)

### MOMENTUM_IBS_5M
- **PATRÓN** `libro_liquidez` > `3498.1728` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 3498.1728 (IC base=+0.070)

- **PATRÓN** `drift_7min_pct` |x|≤ `0.0613` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `drift_7min_pct` |x|≤ 0.0613 (IC base=+0.061)
...
- **PATRÓN** `py_entrada` < `0.5` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.5 (IC base=+0.033)

### MOMENTUM_IBS_5M_FADE
- **FILTRO** `py_entrada` > `0.495` → IC=-0.128 (n=49)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.031 (n=30)

### MOMENTUM_IBS_5M_FADE#SOL#5min
- **FILTRO** `libro_liquidez` < `3510.9157` → IC=-0.136 (n=20)

  - _Acción_: SKIP cuando `libro_liquidez` < 3510.9157
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=7)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.124 (n=131)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0036 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.130 (n=136)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.0054 (IC base=+0.097)
...
- **PATRÓN** `sigma_h` > `0.0023` → IC=+0.146 (n=46)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0023 (IC base=+0.118)
...
- **FILTRO** `sigma_h` < `0.0041` → IC=-0.167 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0041
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=762)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` < `0.0037` → IC=-0.198 (n=167)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.246 (n=61)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0029` → IC=+0.266 (n=45)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_5M#BTC#5min` — IC=+0.219 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.
- **LIVE-CANDIDATA**: `MOMENTUM_IBS_5M#BTC` — IC=+0.219 n=30. Faltan ~10 resoluciones para umbral n≥40. ETA: ~7h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M |
 | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 97 | +0.035 | -0.20€ | 1 | 1 |
| ✅ STRUCT_NO_15M | 1689 | +0.009 | -15.71€ | 0 | 0 |
| ✅ STRUCT_NO_15M#15min | 1689 | +0.009 | -15.71€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC | 644 | +0.006 | -8.08€ | 0 | 0 |
| ✅ STRUCT_NO_15M#BTC#15min | 644 | +0.006 | -8.08€ | 1 | 0 |
| ✅ STRUCT_NO_15M#ETH | 675 | +0.010 | -5.64€ | 0 | 0 |
| ✅ STRUCT_NO_15M#ETH#15min | 675 | +0.010 | -5.64€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL | 370 | +0.011 | -1.99€ | 0 | 0 |
| ✅ STRUCT_NO_15M#SOL#15min | 370 | +0.011 | -1.99€ | 2 | 0 |
| ✅ UPDOWN_GBM | 1549 | +0.018 | +66.86€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 694 | +0.092 | +111.73€ | 0 | 3 |
| ✅ UPDOWN_GBM#240min | 105 | +0.033 | +2.11€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 465 | -0.055 | -39.11€ | 2 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 277 | -0.002 | -9.38€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 374 | +0.053 | +31.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 172 | +0.126 | +33.68€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#SOL | 287 | -0.009 | +1.97€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 107 | +0.023 | +1.68€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1412 | -0.037 | +119.11€ | 1 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1412 | -0.037 | +119.11€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 78 | -0.050 | +1.57€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 78 | -0.050 | +1.57€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 285 | -0.134 | -31.71€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 285 | -0.134 | -31.71€ | 1 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 28 | -0.067 | -2.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 28 | -0.067 | -2.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 116 | +0.000 | +18.23€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 116 | +0.000 | +18.23€ | 1 | 1 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 454 | +0.011 | +90.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 454 | +0.011 | +90.73€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 451 | -0.030 | +42.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 451 | -0.030 | +42.67€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_IBS_ALTO | 120 | +0.246 | +50.23€ | 0 | 2 |
| ✅ UPDOWN_GBM_IBS_ALTO#15min | 120 | +0.246 | +50.23€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.165: overbought→boost, oversold→filtro | oversold(IBS<0.3): IC=-0.031 n=544 | neutral: IC=-0.006 n=530 | overbought(IBS>0.7): IC=+0.134 n=747
  - _Datos_: n=1939 IC=+0.042 PNL=+125.47€
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=107 IC=+0.023 PNL=+1.68€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.116 n=30513 | tras_1loss IC=+0.072 n=20502 | tras_2loss IC=+0.029 n=8732/40 | gap=+0.087 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=64 PNL=+14.65€
  - _Datos_: n=64 IC=+0.121 PNL=+14.65€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1424 IC=+0.018 PNL=+70.95€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1424 IC=+0.018 PNL=+70.95€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=388 IC=+0.097 PNL=+49.56€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=388 IC=+0.097 PNL=+49.56€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=108 IC=+0.064 PNL=-3.31€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=108 IC=+0.064 PNL=-3.31€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.102 > 0.08 con n=443 PNL=+72.76€
  - _Datos_: n=443 IC=+0.102 PNL=+72.76€
...
**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: n=247 IC=+0.038 PNL=-4.32€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=247 IC=+0.038 PNL=-4.32€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.08 con n=83 PNL=-2.46€
  - _Datos_: n=83 IC=+0.147 PNL=-2.46€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=223 IC=+0.029 PNL=+7.44€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=223 IC=+0.029 PNL=+7.44€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=901 IC=+0.021 PNL=+19.68€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=901 IC=+0.021 PNL=+19.68€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.141 > 0.1 con n=497 PNL=+130.31€
  - _Datos_: n=497 IC=+0.141 PNL=+130.31€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=949 IC=-0.127 PNL=+120.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=949 IC=-0.127 PNL=+120.35€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.097 > 0.08 con n=388 PNL=+49.56€
  - _Datos_: n=388 IC=+0.097 PNL=+49.56€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.118 > 0.08 con n=87 PNL=+1.13€
  - _Datos_: n=87 IC=+0.118 PNL=+1.13€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=671 IC=+0.164 PNL=+341.41€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=671 IC=+0.164 PNL=+341.41€
...
**〰️ H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: n=300 IC=+0.000 PNL=+6.33€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=300 IC=+0.000 PNL=+6.33€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.251 > 0.08 con n=572 PNL=-61.42€
  - _Datos_: n=572 IC=+0.251 PNL=-61.42€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=889 IC=+0.097 PNL=-198.17€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=889 IC=+0.097 PNL=-198.17€
