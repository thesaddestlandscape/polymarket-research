# Hipótesis automáticas — 2026-07-02 06:58 UTC
_Generado por shadow_postmortem.py sobre 2552 resoluciones (PNL=-88.82€)_
...
- **PATRÓN** `ibs_15` < `0.0769` → IC=+0.202 (n=45)
...
- **PATRÓN** `sigma_h` < `0.0125` → IC=+0.167 (n=19)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0125 (IC base=+0.115)

## Estrategias nuevas sugeridas
_Derivadas de los patrones aprendidos:_

- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0769 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.202 n=45). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 5 | +0.018 | +0.50€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 5 | +0.018 | +0.50€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 789 | -0.036 | -40.44€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 566 | -0.012 | -14.04€ | 2 | 3 |
...
| ✅ UPDOWN_GBM#XRP | 69 | +0.007 | +4.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 58 | +0.050 | +7.61€ | 1 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.085) — sin ventaja clara. oversold(IBS<0.3): IC=+0.019 n=129 | neutral: IC=-0.066 n=120 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=399 IC=-0.031 PNL=-15.21€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.002 n=1203 | tras_1loss IC=-0.036 n=1262 | tras_2loss IC=-0.050 n=658/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=666 IC=-0.030 PNL=-26.89€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=666 IC=-0.030 PNL=-26.89€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=183 IC=+0.030 PNL=+13.82€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=183 IC=+0.030 PNL=+13.82€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 135/200 ops en el filtro definido (IC actual=+0.033 PNL=+4.10€)
  - _Datos_: n=135 IC=+0.033 PNL=+4.10€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=135 IC=+0.033 PNL=+4.10€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=135 IC=+0.033 PNL=+4.10€
...
**⏳ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: 37/50 ops en el filtro definido (IC actual=+0.115 PNL=+8.62€)
  - _Datos_: n=37 IC=+0.115 PNL=+8.62€
