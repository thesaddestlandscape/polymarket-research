# Hipótesis automáticas — 2026-08-28 18:50 UTC
_Generado por shadow_postmortem.py sobre 191603 resoluciones (PNL=+14316.42€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.38` → IC=-0.288 (n=2679)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.38
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=8037)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `131.73` → IC=-0.276 (n=337)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 131.73
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1013)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `n_ballenas` < `8.0` → IC=-0.130 (n=236)
...
- **FILTRO** `restante_s_al_confirmar` < `409.18` → IC=-0.223 (n=189)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=570)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `113.22` → IC=-0.393 (n=344)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 113.22
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1034)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `161.55` → IC=-0.159 (n=719)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 161.55
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=2160)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `140.27` → IC=-0.311 (n=622)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.27
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1868)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `155.05` → IC=-0.354 (n=613)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 155.05
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=1247)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=5817)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=1671)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2376.0723` → IC=+0.172 (n=1611)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2376.0723 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.148 (n=3986)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=850)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=562)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1306)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.277 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.277)

- **PATRÓN** `libro_liquidez` > `2874.5416` → IC=+0.284 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2874.5416 (IC base=+0.277)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.196 (n=977)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.263 (n=230)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.226)

- **PATRÓN** `py_entrada` < `0.205` → IC=+0.363 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.205 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.233 (n=600)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `1936.4823` → IC=+0.254 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1936.4823 (IC base=+0.226)
...
- **PATRÓN** `py_entrada` < `0.415` → IC=+0.152 (n=432)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.193 (n=4838)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2295)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.73 (IC base=+0.186)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.169 (n=840)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.72` → IC=+0.176 (n=1051)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=1170)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.7` → IC=+0.170 (n=447)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.241 (n=1104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.193 (n=1184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.73` → IC=+0.188 (n=1176)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.195 (n=12205)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.217 (n=9750)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.190)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.134 (n=2461)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `4.24` → IC=+0.162 (n=1646)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 4.24 (IC base=+0.134)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.209 (n=898)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.141)

- **PATRÓN** `restante_min` < `3.94` → IC=+0.146 (n=823)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` < 3.94 (IC base=+0.141)

- **PATRÓN** `restante_min` > `4.91` → IC=+0.163 (n=901)
...
- **PATRÓN** `lag_apertura_s` < `7.1` → IC=+0.162 (n=1083)

  - _Acción_: Kelly boost +0.81€ cuando `lag_apertura_s` < 7.1 (IC base=+0.141)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.197 (n=880)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.38 (IC base=+0.128)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.169 (n=919)

  - _Acción_: Kelly boost +0.84€ cuando `restante_min` > 4.94 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=2599)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.37` → IC=+0.176 (n=828)
...
- **PATRÓN** `libro_liquidez` > `5612.6302` → IC=+0.332 (n=87)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.305 (n=316)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.299 (n=371)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9497` → IC=+0.207 (n=833)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9497 (IC base=+0.063)

- **PATRÓN** `dist_vwap_pct` > `0.2093` → IC=+0.229 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2093 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.268` → IC=+0.155 (n=997)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 5.268 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` < `0.6298` → IC=+0.217 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6298 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `1.0681` → IC=+0.234 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0681 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` < `0.1057` → IC=+0.142 (n=1321)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.1057 (IC base=+0.063)

- **PATRÓN** `volumen_pendiente_norm` > `0.3083` → IC=+0.150 (n=195)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.3083 (IC base=+0.063)

- **PATRÓN** `volumen_spike_ratio` < `2.4267` → IC=+0.150 (n=1210)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4267 (IC base=+0.063)

- **PATRÓN** `ibs_20min` < `0.1163` → IC=+0.150 (n=1272)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.1163 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` < `0.1349` → IC=+0.148 (n=790)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.1349 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.6237` → IC=+0.157 (n=275)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6237 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `1.0607` → IC=+0.138 (n=374)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.0607 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` > `0.307` → IC=+0.281 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.307 (IC base=+0.032)

- **PATRÓN** `volumen_spike_ratio` > `2.9153` → IC=+0.245 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9153 (IC base=+0.032)

- **PATRÓN** `ballena_activa_n` < `46.0` → IC=+0.239 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 46.0 (IC base=+0.032)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.193 (n=187)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.973` → IC=+0.317 (n=189)
...
- **PATRÓN** `ibs_20min` < `0.4216` → IC=+0.300 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4216 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.289 (n=335)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2483` → IC=+0.312 (n=46)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2483 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` < `1.8611` → IC=+0.260 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8611 (IC base=+0.261)

- **PATRÓN** `volumen_spike_ratio` > `2.7667` → IC=+0.311 (n=72)
...
- **PATRÓN** `libro_liquidez` > `1960.7048` → IC=+0.298 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1960.7048 (IC base=+0.261)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.223 (n=186)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.201)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.213 (n=141)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.0927` → IC=+0.227 (n=141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0927 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=429)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.4066` → IC=+0.220 (n=423)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4066 (IC base=+0.201)
...
- **PATRÓN** `volumen_regimen` < `0.6916` → IC=+0.218 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6916 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.0844` → IC=+0.232 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0844 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` < `0.0959` → IC=+0.204 (n=394)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4524` → IC=+0.258 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4524 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `11595.8011` → IC=+0.210 (n=378)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11595.8011 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.163 (n=161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0023 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.150 (n=218)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0049 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.0775` → IC=+0.169 (n=161)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0775 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.154 (n=452)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4406` → IC=+0.178 (n=423)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.4406 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.1415` → IC=+0.172 (n=412)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1415 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.989` → IC=+0.222 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.989 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.187 (n=161)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.6279 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.1595` → IC=+0.216 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1595 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.172 (n=251)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.7599 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4105` → IC=+0.169 (n=376)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.4105 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=621)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `13834.7337` → IC=+0.191 (n=218)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 13834.7337 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `222.0` → IC=+0.173 (n=96)

  - _Acción_: Kelly boost +0.87€ cuando `ballena_activa_n` < 222.0 (IC base=+0.145)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.138 (n=434)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.4138` → IC=+0.135 (n=61)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` > 0.4138 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `1.7005` → IC=+0.141 (n=422)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 1.7005 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.173 (n=460)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.305 (n=167)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.261)

- **PATRÓN** `drift_60min` |x|≤ `0.4646` → IC=+0.272 (n=379)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4646 (IC base=+0.261)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.276 (n=257)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.303 (n=379)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5208 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.01` → IC=+0.321 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.01 (IC base=+0.261)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.613` → IC=+0.266 (n=408)
...
- **FILTRO** `ibs_20min` < `0.3016` → IC=-0.133 (n=164)
...
- **PATRÓN** `volumen_regimen` < `0.5962` → IC=+0.324 (n=15)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5962 (IC base=-0.046)
...
- **PATRÓN** `ballena_activa_n` < `128.0` → IC=+0.148 (n=69)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 128.0 (IC base=-0.050)
...
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.134 (n=667)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=718)

- **FILTRO** `sigma_ewma_delta_pct` > `5.018` → IC=-0.151 (n=293)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 5.018
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1092)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.719` → IC=-0.149 (n=203)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1043)
...
- **PATRÓN** `ibs_20min` > `0.9459` → IC=+0.245 (n=1040)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9459 (IC base=+0.054)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.34` → IC=+0.161 (n=125)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 5.34 (IC base=-0.004)
...
- **FILTRO** `ibs_20min` > `0.8811` → IC=-0.151 (n=290)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8811
  - _Potencial_: sin este filtro IC_bueno=-0.006 (n=872)

- **PATRÓN** `volumen_regimen` < `0.5591` → IC=+0.200 (n=28)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.182` → IC=+0.298 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.182 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` < `0.1438` → IC=+0.202 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1438 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` < `1.9601` → IC=+0.206 (n=182)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9601 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `4.1701` → IC=+0.193 (n=138)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 4.1701 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.218 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.191)

- **PATRÓN** `libro_liquidez` > `1936.1714` → IC=+0.207 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1936.1714 (IC base=+0.191)

- **PATRÓN** `ballena_activa_n` < `41.0` → IC=+0.224 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 41.0 (IC base=+0.191)

- **PATRÓN** `sigma_h` < `0.0084` → IC=+0.342 (n=251)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0084 (IC base=+0.335)

- **PATRÓN** `drift_60min` |x|≤ `0.2567` → IC=+0.344 (n=190)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2567 (IC base=+0.335)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.375 (n=190)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.335)

- **PATRÓN** `ibs_20min` < `0.3296` → IC=+0.350 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3296 (IC base=+0.335)

- **PATRÓN** `ibs_20min` > `0.1304` → IC=+0.339 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1304 (IC base=+0.335)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.492` → IC=+0.344 (n=312)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7067` → IC=+0.336 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7067 (IC base=+0.335)

- **PATRÓN** `volumen_spike_ratio` > `1.9441` → IC=+0.340 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9441 (IC base=+0.335)

- **PATRÓN** `libro_liquidez` > `1874.461` → IC=+0.376 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1874.461 (IC base=+0.335)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.315 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 30.0 (IC base=+0.335)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `sigma_h` > `0.0066` → IC=-0.153 (n=122)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0066
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=375)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.171 (n=68)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=955)
...
- **FILTRO** `ibs_20min` < `0.7455` → IC=-0.133 (n=459)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7455
  - _Potencial_: sin este filtro IC_bueno=+0.215 (n=237)
...
- **PATRÓN** `ibs_20min` > `0.8571` → IC=+0.268 (n=175)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8571 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` > `0.6469` → IC=+0.293 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6469 (IC base=-0.014)

- **PATRÓN** `volumen_regimen` < `0.8566` → IC=+0.189 (n=133)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_regimen` < 0.8566 (IC base=-0.014)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1202` → IC=+0.174 (n=185)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` < 0.1202 (IC base=-0.014)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4599` → IC=+0.208 (n=63)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4599 (IC base=-0.014)
...
- **PATRÓN** `sigma_h` > `0.025` → IC=+0.326 (n=199)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.025 (IC base=+0.226)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.239 (n=224)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.226)
...
- **PATRÓN** `ibs_20min` > `0.8982` → IC=+0.307 (n=397)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8982 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` > `1.3647` → IC=+0.347 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3647 (IC base=+0.226)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.0805` → IC=+0.231 (n=508)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1738` → IC=+0.240 (n=472)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1738 (IC base=+0.226)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.237 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.226)

- **PATRÓN** `libro_liquidez` > `2452.6608` → IC=+0.236 (n=596)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.423` → IC=+0.244 (n=1116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.423 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.6881` → IC=+0.171 (n=1662)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2882` → IC=+0.159 (n=2140)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2882 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8523` → IC=+0.151 (n=1621)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8523 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.164 (n=2152)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `3206.3834` → IC=+0.181 (n=1217)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 3206.3834 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.180 (n=1402)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 113.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.202 (n=1634)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.189)

- **PATRÓN** `drift_60min` |x|≤ `0.0824` → IC=+0.215 (n=818)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0824 (IC base=+0.189)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.218 (n=1114)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` < `0.41` → IC=+0.243 (n=2446)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.41 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` < `0.2216` → IC=+0.185 (n=1989)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.2216 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.921` → IC=+0.219 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.921 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` < `1.174` → IC=+0.173 (n=1936)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.174 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` > `0.6905` → IC=+0.171 (n=1729)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6905 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.2921` → IC=+0.263 (n=293)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2921 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.2888` → IC=+0.209 (n=830)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2888 (IC base=+0.189)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.200 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 122.0 (IC base=+0.189)
...
- **PATRÓN** `drift_60min` |x|≤ `0.271` → IC=+0.161 (n=438)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.752` → IC=+0.305 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.752 (IC base=+0.153)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4412` → IC=+0.139 (n=358)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.4412 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.180 (n=298)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.04 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.260 (n=206)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.271 (n=234)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.3373` → IC=+0.285 (n=235)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3373 (IC base=+0.258)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.272 (n=217)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.323` → IC=+0.298 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.323 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.436` → IC=+0.276 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.436 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.1779` → IC=+0.280 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1779 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` < `1.9432` → IC=+0.276 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9432 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `2.8455` → IC=+0.297 (n=57)
...
- **PATRÓN** `libro_liquidez` > `1948.0468` → IC=+0.338 (n=78)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1948.0468 (IC base=+0.258)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.242 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 82.0 (IC base=+0.258)

### GBM_LATE_15M_MULTIHORIZONTE#BTC#15min
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.194 (n=341)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0062 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.189 (n=130)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0072 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.4326` → IC=+0.174 (n=388)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.4326 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.195 (n=392)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 6.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` > `0.6307` → IC=+0.221 (n=346)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6307 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.2163` → IC=+0.234 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2163 (IC base=+0.170)
...
- **PATRÓN** `volumen_regimen` < `0.6381` → IC=+0.189 (n=130)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6381 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `1.0851` → IC=+0.197 (n=176)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` > 1.0851 (IC base=+0.170)
...
- **PATRÓN** `volumen_spike_ratio` < `1.378` → IC=+0.230 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.378 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `12726.9019` → IC=+0.181 (n=258)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 12726.9019 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.171 (n=484)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0059 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2334` → IC=+0.175 (n=426)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.2334 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.175 (n=444)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 7.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.4268` → IC=+0.196 (n=484)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.4268 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1622` → IC=+0.178 (n=480)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.1622 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.6385` → IC=+0.226 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6385 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` > `0.1684` → IC=+0.226 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1684 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` < `2.5679` → IC=+0.164 (n=376)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.5679 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.41` → IC=+0.151 (n=376)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.41 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `14737.2161` → IC=+0.189 (n=162)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 14737.2161 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.292 (n=277)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.270)

- **PATRÓN** `drift_60min` |x|≤ `0.1065` → IC=+0.342 (n=93)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1065 (IC base=+0.270)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.316 (n=188)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.270)

- **PATRÓN** `ibs_20min` < `0.3046` → IC=+0.329 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3046 (IC base=+0.270)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.311` → IC=+0.344 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.311 (IC base=+0.270)

- **PATRÓN** `volumen_pendiente_norm` > `0.3709` → IC=+0.443 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3709 (IC base=+0.270)

- **PATRÓN** `volumen_spike_ratio` > `1.671` → IC=+0.270 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.671 (IC base=+0.270)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3831` → IC=+0.160 (n=466)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3831 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.179 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3583` → IC=+0.211 (n=410)
...
- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.156 (n=466)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.176 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6089` → IC=+0.153 (n=465)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6089 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.1018` → IC=+0.169 (n=143)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.1018 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.9025` → IC=+0.176 (n=239)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5362` → IC=+0.147 (n=120)
  ...
  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 2.5362 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `10894.5927` → IC=+0.169 (n=155)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 10894.5927 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `123.0` → IC=+0.148 (n=123)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 123.0 (IC base=+0.143)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.180 (n=148)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.005 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.207 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0107 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.224 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.4062` → IC=+0.237 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4062 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.2296` → IC=+0.157 (n=423)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.2296 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.218` → IC=+0.199 (n=174)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 3.218 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1603` → IC=+0.152 (n=443)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1603 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.8469` → IC=+0.170 (n=295)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 0.8469 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.2176` → IC=+0.214 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2176 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `2.2667` → IC=+0.226 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2667 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `2122.9315` → IC=+0.197 (n=295)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 2122.9315 (IC base=+0.140)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.024` → IC=+0.199 (n=254)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.024 (IC base=+0.170)

- **PATRÓN** `drift_60min` |x|≤ `0.1642` → IC=+0.199 (n=247)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.1642 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.170)

- **PATRÓN** `ibs_20min` > `0.9123` → IC=+0.265 (n=373)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.143` → IC=+0.239 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.143 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.6079` → IC=+0.181 (n=560)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6079 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.2396` → IC=+0.250 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2396 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `2.1464` → IC=+0.188 (n=459)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.1464 (IC base=+0.170)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=568)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.170)

- **PATRÓN** `libro_liquidez` > `2452.6608` → IC=+0.171 (n=560)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2452.6608 (IC base=+0.170)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.277 (n=240)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.6757` → IC=+0.235 (n=546)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.6757 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.240 (n=263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.381` → IC=+0.264 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.381 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.181` → IC=+0.289 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.181 (IC base=+0.225)

- **PATRÓN** `volumen_regimen` > `0.6961` → IC=+0.246 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6961 (IC base=+0.225)

- **PATRÓN** `volumen_pendiente_norm` > `0.2801` → IC=+0.357 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2801 (IC base=+0.225)

- **PATRÓN** `volumen_spike_ratio` > `2.6983` → IC=+0.259 (n=139)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6983 (IC base=+0.225)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.134 (n=345)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0059 (IC base=+0.098)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.193 (n=203)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 17.0 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.617` → IC=+0.164 (n=459)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.617 (IC base=+0.098)

- **PATRÓN** `dist_vwap_pct` > `0.8459` → IC=+0.264 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8459 (IC base=+0.098)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.306` → IC=+0.181 (n=142)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 8.306 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.289` → IC=+0.171 (n=71)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.289 (IC base=+0.098)

- **PATRÓN** `libro_liquidez` > `2664.0574` → IC=+0.138 (n=343)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 2664.0574 (IC base=+0.098)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.161 (n=163)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0039 (IC base=+0.062)

- **PATRÓN** `ibs_20min` < `0.3033` → IC=+0.153 (n=324)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.3033 (IC base=+0.062)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.777` → IC=+0.155 (n=111)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 7.777 (IC base=+0.062)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=30)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.7425` → IC=+0.138 (n=56)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` > 0.7425 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.745` → IC=+0.237 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.745 (IC base=+0.084)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=60)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `13.0` → IC=+0.260 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 13.0 (IC base=+0.084)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.144 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 10.0 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.1125` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1125 (IC base=+0.068)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0066` → IC=+0.184 (n=2098)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0066 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.158 (n=3195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.9402` → IC=+0.289 (n=1425)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.53` → IC=+0.228 (n=1833)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.53 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6994` → IC=+0.148 (n=975)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.6994 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.0795` → IC=+0.152 (n=1006)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.0795 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3078` → IC=+0.151 (n=2485)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.3078 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.8616` → IC=+0.157 (n=1883)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.8616 (IC base=+0.149)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2515)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `2484.1984` → IC=+0.173 (n=2096)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2484.1984 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `142.0` → IC=+0.189 (n=1554)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 142.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.218 (n=1916)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.485` → IC=+0.202 (n=2871)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.485 (IC base=+0.193)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.202 (n=1048)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.248 (n=2872)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.4286` → IC=+0.184 (n=2118)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.4286 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.418` → IC=+0.207 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.418 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.654` → IC=+0.197 (n=2690)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` < 2.654 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `0.6208` → IC=+0.191 (n=709)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6208 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` > `1.2044` → IC=+0.176 (n=709)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.2044 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` > `0.2885` → IC=+0.274 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2885 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` > `2.3087` → IC=+0.212 (n=984)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3087 (IC base=+0.193)

- **PATRÓN** `ballena_activa_n` < `174.0` → IC=+0.175 (n=1743)

  - _Acción_: Kelly boost +0.88€ cuando `ballena_activa_n` < 174.0 (IC base=+0.193)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.226 (n=235)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.155 (n=523)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.312 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.347` → IC=+0.303 (n=303)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9052` → IC=+0.148 (n=288)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.9052 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.201 (n=322)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.298 (n=221)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.272)

- **PATRÓN** `drift_60min` |x|≤ `0.1115` → IC=+0.311 (n=146)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1115 (IC base=+0.272)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.276 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.562` → IC=+0.314 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.562 (IC base=+0.272)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.116` → IC=+0.292 (n=358)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.116 (IC base=+0.272)

- **PATRÓN** `volumen_pendiente_norm` > `0.3026` → IC=+0.321 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3026 (IC base=+0.272)

- **PATRÓN** `volumen_spike_ratio` > `2.7638` → IC=+0.323 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7638 (IC base=+0.272)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.315 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.272)

- **PATRÓN** `libro_liquidez` > `1963.3048` → IC=+0.304 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1963.3048 (IC base=+0.272)

- **PATRÓN** `ballena_activa_n` < `74.0` → IC=+0.255 (n=149)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 74.0 (IC base=+0.272)
...
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.178 (n=169)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0071 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.4183` → IC=+0.153 (n=503)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4183 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.179 (n=453)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 8.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.3308` → IC=+0.207 (n=503)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3308 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.709` → IC=+0.170 (n=222)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.709 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.170 (n=228)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.099 (IC base=+0.152)

- **PATRÓN** `volumen_pendiente_norm` < `0.0734` → IC=+0.168 (n=405)
...
- **PATRÓN** `volumen_spike_ratio` < `2.413` → IC=+0.182 (n=454)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.413 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.3655` → IC=+0.173 (n=454)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.3655 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `12240.9476` → IC=+0.168 (n=335)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 12240.9476 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.174 (n=477)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0061 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.279` → IC=+0.179 (n=419)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.90€ cuando `drift_60min` |x|≤ 0.279 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.176 (n=445)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 7.0 (IC base=+0.168)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.182 (n=479)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 17.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.5681` → IC=+0.203 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5681 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.151` → IC=+0.184 (n=422)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.151 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.611` → IC=+0.207 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.611 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.6225` → IC=+0.233 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6225 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.1489` → IC=+0.278 (n=115)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1489 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `2.5087` → IC=+0.189 (n=380)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.5087 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.5092` → IC=+0.187 (n=340)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 1.5092 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=616)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `12842.7063` → IC=+0.183 (n=216)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 12842.7063 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `307.0` → IC=+0.188 (n=94)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 307.0 (IC base=+0.168)
...
- **PATRÓN** `ibs_20min` > `0.7037` → IC=+0.263 (n=373)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2217` → IC=+0.190 (n=350)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.2217 (IC base=+0.185)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.215 (n=367)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.185)

- **PATRÓN** `libro_liquidez` > `1834.8686` → IC=+0.195 (n=277)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 1834.8686 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.236 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 48.0 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.324 (n=140)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0059 (IC base=+0.247)

- **PATRÓN** `drift_60min` |x|≤ `0.2118` → IC=+0.253 (n=277)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2118 (IC base=+0.247)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.254 (n=282)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5541` → IC=+0.313 (n=415)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5541 (IC base=+0.247)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.093` → IC=+0.273 (n=95)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7665` → IC=+0.250 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7665 (IC base=+0.247)

- **PATRÓN** `volumen_spike_ratio` > `2.408` → IC=+0.221 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.408 (IC base=+0.247)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.276 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.247)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.202 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 60.0 (IC base=+0.247)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.153 (n=505)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0089 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.1491` → IC=+0.138 (n=222)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.69€ cuando `drift_60min` |x|≤ 0.1491 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.165 (n=460)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 8.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.3491` → IC=+0.194 (n=504)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.3491 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.8245` → IC=+0.222 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8245 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.485` → IC=+0.187 (n=244)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 4.485 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.6219` → IC=+0.172 (n=169)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6219 (IC base=+0.138)
...
- **PATRÓN** `libro_liquidez` > `5254.2901` → IC=+0.219 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5254.2901 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.177 (n=252)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 162.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.199 (n=144)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0032 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.5115` → IC=+0.164 (n=430)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.5115 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.153 (n=148)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6499` → IC=+0.183 (n=430)
...
- **PATRÓN** `dist_vwap_pct` < `0.3875` → IC=+0.151 (n=428)
...
- **PATRÓN** `volumen_regimen` < `0.5836` → IC=+0.164 (n=144)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.5836 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.6471` → IC=+0.155 (n=384)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6471 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4862` → IC=+0.191 (n=124)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.4862 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `9771.3836` → IC=+0.206 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9771.3836 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.206 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 136.0 (IC base=+0.147)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.144 (n=254)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0113 (IC base=+0.091)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.135 (n=381)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 12.0 (IC base=+0.091)

- **PATRÓN** `ibs_20min` > `0.4872` → IC=+0.176 (n=557)
...
- **PATRÓN** `libro_liquidez` > `2971.9712` → IC=+0.266 (n=186)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2971.9712 (IC base=+0.091)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.155 (n=331)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 66.0 (IC base=+0.091)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.180 (n=173)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0056 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.1241` → IC=+0.157 (n=173)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.1241 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.175 (n=241)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 15.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` < `0.5918` → IC=+0.205 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5918 (IC base=+0.119)

- **PATRÓN** `dist_vwap_pct` < `0.5012` → IC=+0.145 (n=485)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.5012 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.097` → IC=+0.142 (n=504)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 3.097 (IC base=+0.119)

- **PATRÓN** `volumen_regimen` < `0.6365` → IC=+0.157 (n=173)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6365 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.072` → IC=+0.169 (n=149)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.072 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `2.108` → IC=+0.147 (n=324)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 2.108 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `1.7794` → IC=+0.148 (n=245)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.7794 (IC base=+0.119)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=540)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `2673.0949` → IC=+0.174 (n=234)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2673.0949 (IC base=+0.119)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0273` → IC=+0.218 (n=218)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0273 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.188 (n=655)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 6.0 (IC base=+0.178)

- **PATRÓN** `ibs_20min` > `0.96` → IC=+0.299 (n=296)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.118` → IC=+0.251 (n=339)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8157` → IC=+0.188 (n=402)
...
- **PATRÓN** `libro_liquidez` > `2453.0908` → IC=+0.181 (n=653)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 2453.0908 (IC base=+0.178)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.217 (n=387)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4947` → IC=+0.229 (n=621)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4947 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.226 (n=659)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.493` → IC=+0.282 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.493 (IC base=+0.220)

- **PATRÓN** `dist_vwap_pct` < `0.1702` → IC=+0.236 (n=639)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1702 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.6` → IC=+0.294 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.6 (IC base=+0.220)

- **PATRÓN** `volumen_regimen` > `1.2416` → IC=+0.238 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2416 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.328 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2827 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `2.2062` → IC=+0.233 (n=241)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2062 (IC base=+0.220)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.190 (n=424)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.146 (n=1223)

- **PATRÓN** `ibs_20min` > `0.2464` → IC=+0.121 (n=808)

  - _Acción_: Kelly boost +0.60€ cuando `ibs_20min` > 0.2464 (IC base=+0.101)

- **PATRÓN** `volumen_pendiente_norm` > `0.2444` → IC=+0.173 (n=151)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2444 (IC base=+0.101)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.193 (n=311)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0037 (IC base=+0.141)

- **PATRÓN** `drift_60min` |x|≤ `0.3854` → IC=+0.166 (n=818)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.3854 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.159 (n=338)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1923` → IC=+0.163 (n=410)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1923 (IC base=+0.141)

- **PATRÓN** `ibs_20min` > `0.0889` → IC=+0.144 (n=929)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.104` → IC=+0.151 (n=930)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.104 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `1.2185` → IC=+0.150 (n=905)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.2185 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` < `0.1463` → IC=+0.148 (n=931)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` < 0.1463 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.159 (n=921)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `1.4214` → IC=+0.150 (n=921)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4214 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.146 (n=1223)

  - _Acción_: Kelly boost +0.73€ cuando `libro_spread` < 0.01 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `10654.8111` → IC=+0.149 (n=619)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 10654.8111 (IC base=+0.141)
...
- **PATRÓN** `volumen_regimen` > `0.9327` → IC=+0.173 (n=47)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.9327 (IC base=+0.047)

- **PATRÓN** `volumen_spike_ratio` < `1.5013` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5013 (IC base=+0.047)

- **PATRÓN** `libro_liquidez` > `12574.1361` → IC=+0.138 (n=103)

  - _Acción_: Kelly boost +0.69€ cuando `libro_liquidez` > 12574.1361 (IC base=+0.047)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.196 (n=225)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0036 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.4002` → IC=+0.151 (n=511)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.4002 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.191 (n=189)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.1706` → IC=+0.174 (n=225)

  - _Acción_: Kelly boost +0.87€ cuando `ibs_20min` < 0.1706 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.3794` → IC=+0.143 (n=340)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` > 0.3794 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.6714` → IC=+0.188 (n=62)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.6714 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.318` → IC=+0.162 (n=510)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.318 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `1.1896` → IC=+0.159 (n=511)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1896 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6161` → IC=+0.143 (n=510)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 0.6161 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.0696` → IC=+0.167 (n=241)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0696 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `2.5395` → IC=+0.157 (n=508)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5395 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.8071` → IC=+0.151 (n=339)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8071 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `11979.2467` → IC=+0.153 (n=456)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 11979.2467 (IC base=+0.142)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.176 (n=100)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0104 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.209 (n=53)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.92` → IC=+0.269 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.92 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.371` → IC=+0.271 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.371 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.215` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.215 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.8806` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.8806 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `1867.3696` → IC=+0.151 (n=150)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1867.3696 (IC base=+0.114)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.157 (n=298)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0094 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.5466` → IC=+0.142 (n=297)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.5466 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.182 (n=108)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 18.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` > `0.7919` → IC=+0.164 (n=135)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.7919 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` > `0.8681` → IC=+0.171 (n=74)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.8681 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.2217` → IC=+0.132 (n=248)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.2217 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.031` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.031 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.327` → IC=+0.134 (n=260)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 4.327 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `0.7231` → IC=+0.154 (n=131)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7231 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` < `0.1172` → IC=+0.128 (n=267)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1172 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.175` → IC=+0.128 (n=92)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.175 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` < `1.424` → IC=+0.167 (n=97)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.424 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` > `1.8484` → IC=+0.134 (n=192)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.8484 (IC base=+0.125)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=310)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `8958.3045` → IC=+0.140 (n=265)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 8958.3045 (IC base=+0.125)

- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.146 (n=272)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0089 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.143 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0063 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.4118` → IC=+0.188 (n=238)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.4118 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.161 (n=181)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 10.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` < `0.612` → IC=+0.142 (n=238)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.612 (IC base=+0.133)

- **PATRÓN** `ibs_20min` > `0.1096` → IC=+0.154 (n=270)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.1096 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `0.1525` → IC=+0.157 (n=103)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1525 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.368` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.368 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.1943` → IC=+0.156 (n=271)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.1943 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` < `0.135` → IC=+0.160 (n=277)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.135 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `2.1996` → IC=+0.174 (n=234)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.1996 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `1.4487` → IC=+0.157 (n=266)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4487 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `10395.9451` → IC=+0.152 (n=90)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 10395.9451 (IC base=+0.133)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=597)
...
- **PATRÓN** `liq_usd_total` > `15524.23` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `liq_usd_total` > 15524.23 (IC base=+0.060)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.174 (n=928)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2823)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.208 (n=951)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=2891)

- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.173 (n=956)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2692
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2886)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.4` → IC=-0.223 (n=135)

  - _Acción_: SKIP cuando `py_entrada` < 0.4
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=409)

- **FILTRO** `ibs_20min` < `0.7353` → IC=-0.167 (n=136)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7353
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=408)

- **FILTRO** `ibs_20min` > `0.7424` → IC=-0.165 (n=165)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.182 (n=250)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=322)

- **FILTRO** `ibs_20min` < `0.7271` → IC=-0.197 (n=143)
...
- **FILTRO** `ibs_20min` > `0.7279` → IC=-0.224 (n=161)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.133 (n=186)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.040 (n=457)
...
- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.156 (n=152)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=459)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.218 (n=154)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.248 (n=204)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=415)

- **FILTRO** `ibs_20min` > `0.2734` → IC=-0.218 (n=154)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2734
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=465)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.143 (n=2723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=6764)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.283 (n=2325)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=7162)

- **FILTRO** `ibs_7min` < `0.7292` → IC=-0.235 (n=2370)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7292
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=7117)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.174 (n=3210)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=6277)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=2867)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=8703)

- **FILTRO** `ibs_7min` > `0.7153` → IC=-0.172 (n=2892)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7153
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=8678)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.317 (n=314)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=975)

- **FILTRO** `ibs_7min` < `1.0` → IC=-0.189 (n=902)

  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=387)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.244 (n=311)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=978)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.227 (n=474)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1517)

- **FILTRO** `drift_7min_pct` |x|> `0.1337` → IC=-0.139 (n=676)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1337
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=1315)

- **FILTRO** `ibs_7min` > `0.7045` → IC=-0.168 (n=676)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7045
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1315)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.142 (n=392)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1446)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.255 (n=439)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1399)

- **FILTRO** `ibs_7min` < `0.792` → IC=-0.185 (n=459)

  - _Acción_: SKIP cuando `ibs_7min` < 0.792
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1379)

- **FILTRO** `ballena_activa_n` > `162.0` → IC=-0.188 (n=459)

  - _Acción_: SKIP cuando `ballena_activa_n` > 162.0
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1379)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.214 (n=442)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=1391)

- **FILTRO** `ballena_activa_n` > `98.0` → IC=-0.162 (n=616)

  - _Acción_: SKIP cuando `ballena_activa_n` > 98.0
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1217)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.202 (n=333)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.100 (n=1037)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.315 (n=442)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=928)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.284 (n=341)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1029)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.280 (n=330)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=1040)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.251 (n=436)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1596)

- **FILTRO** `ibs_7min` > `0.8125` → IC=-0.189 (n=506)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.151 (n=480)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=1114)

- **FILTRO** `py_entrada` < `0.44` → IC=-0.216 (n=768)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=826)

- **FILTRO** `ibs_7min` < `0.7549` → IC=-0.193 (n=398)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7549
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=1196)

- **FILTRO** `ballena_activa_n` > `42.0` → IC=-0.203 (n=396)

  - _Acción_: SKIP cuando `ballena_activa_n` > 42.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1198)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.266 (n=382)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1212)

- **FILTRO** `ibs_7min` > `0.1833` → IC=-0.163 (n=541)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1833
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1053)

- **FILTRO** `ballena_activa_n` > `25.0` → IC=-0.172 (n=540)

  - _Acción_: SKIP cuando `ballena_activa_n` > 25.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=1054)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.231 (n=448)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1381)

- **FILTRO** `ibs_7min` < `0.7692` → IC=-0.204 (n=448)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7692
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1381)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.185 (n=433)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1396)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=513)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1629)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.297 (n=378)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1189)

- **FILTRO** `ibs_7min` < `0.75` → IC=-0.230 (n=383)

  - _Acción_: SKIP cuando `ibs_7min` < 0.75
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1184)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.232 (n=386)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1181)
...
- **FILTRO** `ibs_7min` > `0.8` → IC=-0.168 (n=489)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1489)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.122 (n=646)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1332)
...
- **FILTRO** `ballena_activa_n` > `66.0` → IC=-0.237 (n=17)
...
- **PATRÓN** `streak_estiramiento` < `0.3225` → IC=+0.167 (n=28)

  - _Acción_: Kelly boost +0.83€ cuando `streak_estiramiento` < 0.3225 (IC base=+0.010)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.079 (n=240)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=1238)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.123 (n=409)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2972.5116` → IC=+0.145 (n=260)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2972.5116 (IC base=+0.116)
...
- **FILTRO** `ibs_15` < `0.25` → IC=-0.192 (n=131)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=403)

- **FILTRO** `sigma_ewma_delta_pct` > `6.565` → IC=-0.209 (n=53)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.565
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=481)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.157 (n=100)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0037 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.1944` → IC=+0.181 (n=114)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.1944 (IC base=+0.154)

- **PATRÓN** `drift_15min` |x|≤ `0.4671` → IC=+0.179 (n=76)

  - _Acción_: Kelly boost +0.90€ cuando `drift_15min` |x|≤ 0.4671 (IC base=+0.154)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2457` → IC=+0.200 (n=38)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2457 (IC base=+0.154)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1411` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1411 (IC base=+0.154)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.178 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.8791` → IC=+0.256 (n=76)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8791 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` > `0.3112` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3112 (IC base=+0.154)

- **PATRÓN** `dist_vwap_pct` < `0.5429` → IC=+0.161 (n=125)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.5429 (IC base=+0.154)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.945` → IC=+0.200 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.945 (IC base=+0.154)

- **PATRÓN** `libro_liquidez` > `11686.9744` → IC=+0.167 (n=52)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 11686.9744 (IC base=+0.154)
...
### UPDOWN_GBM#ETH#5min
- **FILTRO** `delta_ratio_macro` |x|≤ `0.1858` → IC=-0.194 (n=60)
  - _Por qué funciona_: flow macro débil → el mercado no ha procesado aún la presión; lag explotable
...
- **FILTRO** `drift_15min` |x|> `0.5137` → IC=-0.148 (n=126)
...
- **PATRÓN** `ibs_15` < `0.1171` → IC=+0.202 (n=112)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1171 (IC base=+0.048)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.671` → IC=-0.173 (n=362)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.671
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=2719)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.357` → IC=+0.144 (n=144)

  - _Acción_: Kelly boost +0.72€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.357 (IC base=-0.066)
...
- **FILTRO** `sigma_h` > `0.0076` → IC=-0.250 (n=166)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0076
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=501)

- **FILTRO** `sigma_h` < `0.0036` → IC=-0.216 (n=220)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0036
  - _Potencial_: sin este filtro IC_bueno=-0.206 (n=447)

- **FILTRO** `hora_utc` > `16.0` → IC=-0.250 (n=162)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.196 (n=505)

- **FILTRO** `sigma_ewma_delta_pct` > `20.169` → IC=-0.264 (n=125)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 20.169
  - _Potencial_: sin este filtro IC_bueno=-0.197 (n=542)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1866` → IC=+0.250 (n=22)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1866 (IC base=-0.055)

- **PATRÓN** `ibs_15` < `0.2796` → IC=+0.243 (n=33)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2796 (IC base=-0.055)

- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 39.0 (IC base=-0.055)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.277 (n=253)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.275)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.295 (n=115)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0055 (IC base=+0.275)

- **PATRÓN** `drift_60min` |x|≤ `0.0776` → IC=+0.314 (n=111)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0776 (IC base=+0.275)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0568` → IC=+0.291 (n=252)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0568 (IC base=+0.275)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.304 (n=264)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.275)

- **PATRÓN** `ibs_15` > `0.8348` → IC=+0.299 (n=252)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8348 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `0.3131` → IC=+0.344 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3131 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.952` → IC=+0.282 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.952 (IC base=+0.275)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.275 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `13112.4613` → IC=+0.302 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13112.4613 (IC base=+0.275)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1224` → IC=+0.321 (n=26)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1224 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.282 (n=131)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.259)

- **PATRÓN** `ibs_15` > `0.9678` → IC=+0.306 (n=65)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.9678 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` > `0.3306` → IC=+0.352 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3306 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.453` → IC=+0.265 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.453 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.866` → IC=+0.271 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 6.866 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `14354.3614` → IC=+0.280 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 14354.3614 (IC base=+0.259)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5294 sube el IC de +0.116 a +0.204 en UPDOWN_GBM#15min (n=390). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.8791 sube el IC de +0.154 a +0.256 en UPDOWN_GBM#BTC#15min (n=76). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1171 sube el IC de +0.048 a +0.202 en UPDOWN_GBM#XRP#15min (n=112). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.4601 sube el IC de -0.066 a +0.156 en UPDOWN_GBM_15M_TARDIO (n=306). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.2796 sube el IC de -0.055 a +0.243 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=33). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8348 sube el IC de +0.275 a +0.299 en UPDOWN_GBM_IBS_ALTO (n=252). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.9678 sube el IC de +0.259 a +0.306 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=65). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 10716 | -0.096 | -1779.46€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 759 | -0.060 | -135.01€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 9957 | -0.099 | -1644.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1350 | -0.033 | -265.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1350 | -0.033 | -265.29€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 759 | -0.060 | -135.01€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 759 | -0.060 | -135.01€ | 3 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1378 | -0.152 | -432.90€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1378 | -0.152 | -432.90€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 2879 | -0.066 | -288.10€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 2879 | -0.066 | -288.10€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2490 | -0.093 | -204.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2490 | -0.093 | -204.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1860 | -0.167 | -453.72€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1860 | -0.167 | -453.72€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 616 | -0.057 | +279.11€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 176 | -0.006 | +32.84€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 440 | -0.077 | +246.27€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 616 | -0.057 | +279.11€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 176 | -0.006 | +32.84€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 440 | -0.077 | +246.27€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 35048 | +0.114 | -2224.45€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6335 | +0.186 | -224.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 111 | -0.093 | -48.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 25311 | +0.097 | -1899.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3291 | +0.119 | -52.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 4245 | +0.067 | -692.32€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 4219 | +0.068 | -688.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 7186 | +0.133 | -161.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1796 | +0.197 | -93.91€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 4212 | +0.109 | -99.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1136 | +0.128 | +53.95€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 4256 | +0.082 | -512.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 22 | +0.083 | +3.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 4233 | +0.082 | -514.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 7710 | +0.126 | -135.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2302 | +0.166 | -21.21€ | 0 | 8 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 4214 | +0.112 | -76.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1182 | +0.100 | -28.74€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 7408 | +0.133 | -450.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2177 | +0.202 | -114.21€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 50 | +0.019 | -7.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 4208 | +0.099 | -251.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 973 | +0.132 | -77.44€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 4243 | +0.107 | -272.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 4225 | +0.108 | -269.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 6255 | +0.173 | -491.67€ | 2 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 6255 | +0.173 | -491.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1579 | +0.166 | -169.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1579 | +0.166 | -169.06€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1555 | +0.164 | -173.80€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1555 | +0.164 | -173.80€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1405 | +0.230 | -42.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1405 | +0.230 | -42.20€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1514 | +0.181 | -121.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 