# Hipótesis automáticas — 2026-07-15 17:24 UTC
_Generado por shadow_postmortem.py sobre 15688 resoluciones (PNL=+3134.27€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.309 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.192)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.196 (n=928)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.01 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `4419.1321` → IC=+0.194 (n=528)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 4419.1321 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.175 (n=451)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.156)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.202 (n=317)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.156)

- **PATRÓN** `py_entrada` < `0.275` → IC=+0.322 (n=318)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.275 (IC base=+0.156)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=1009)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `7401.6146` → IC=+0.180 (n=295)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 7401.6146 (IC base=+0.156)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.256 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.615 (IC base=+0.198)

- **PATRÓN** `libro_liquidez` > `11608.2114` → IC=+0.200 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11608.2114 (IC base=+0.198)
...
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.167 (n=22)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 16.0 (IC base=+0.157)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.286 (n=26)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.157)

- **PATRÓN** `py_entrada` < `0.425` → IC=+0.211 (n=50)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.425 (IC base=+0.157)

- **PATRÓN** `py_entrada` > `0.395` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.395 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `7105.7782` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 7105.7782 (IC base=+0.157)
...
- **PATRÓN** `libro_liquidez` > `3669.7607` → IC=+0.230 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3669.7607 (IC base=+0.232)
...
- **PATRÓN** `py_entrada` > `0.625` → IC=+0.281 (n=153)
...
### GBM_LATE_15M
- **PATRÓN** `dist_vwap_pct` > `0.6633` → IC=+0.133 (n=118)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.6633 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.225` → IC=+0.227 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.225 (IC base=+0.108)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1187)
...
- **PATRÓN** `dist_vwap_pct` > `0.2319` → IC=+0.122 (n=35)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.2319 (IC base=+0.079)
...
- **PATRÓN** `dist_vwap_pct` > `0.719` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.719 (IC base=+0.064)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.148 (n=52)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.064)

### GBM_LATE_15M#SOL#15min
- **PATRÓN** `sigma_h` < `0.0109` → IC=+0.146 (n=204)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0109 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.140 (n=209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` > `0.0231` → IC=+0.192 (n=193)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` > 0.0231 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.148 (n=424)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.281` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.281 (IC base=+0.145)

- **PATRÓN** `sigma_h` > `0.0267` → IC=+0.197 (n=150)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0267 (IC base=+0.164)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.242 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.164)

- **PATRÓN** `dist_vwap_pct` < `0.963` → IC=+0.134 (n=162)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.963 (IC base=+0.164)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.696` → IC=+0.133 (n=137)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 7.696 (IC base=+0.164)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0123` → IC=+0.234 (n=224)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0123 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.180 (n=476)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3731` → IC=+0.225 (n=158)
...
- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.178 (n=702)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0048 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.164 (n=474)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.4443` → IC=+0.193 (n=473)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.4443 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.996` → IC=+0.250 (n=62)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.151 (n=167)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0028 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.181 (n=117)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 12.0 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` > `0.3426` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3426 (IC base=+0.125)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.235 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.167 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6749` → IC=+0.222 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6749 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.207` → IC=+0.400 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.207 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0068` → IC=+0.135 (n=157)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0068 (IC base=+0.128)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.144 (n=178)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.7422` → IC=+0.192 (n=37)
  ...
  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.7422 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `0.4151` → IC=+0.167 (n=97)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.4151 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.751` → IC=+0.204 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.751 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.264` → IC=+0.152 (n=110)
...
- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.187 (n=65)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0082 (IC base=+0.101)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.157 (n=68)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 5.0 (IC base=+0.101)

- **PATRÓN** `dist_vwap_pct` < `0.2503` → IC=+0.176 (n=109)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2503 (IC base=+0.101)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.165` → IC=+0.160 (n=101)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 3.165 (IC base=+0.101)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0148` → IC=+0.178 (n=206)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0148 (IC base=+0.108)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.130 (n=557)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 15.0 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.7311` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.7311 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.175` → IC=+0.308 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.175 (IC base=+0.108)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.127 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 8.0 (IC base=+0.091)

- **PATRÓN** `dist_vwap_pct` > `0.3646` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3646 (IC base=+0.091)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.72` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.72 (IC base=+0.091)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.148 (n=69)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0044 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.6294` → IC=+0.143 (n=40)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6294 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` < `0.2823` → IC=+0.128 (n=41)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2823 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.052)
...
- **PATRÓN** `sigma_h` > `0.0113` → IC=+0.217 (n=175)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1906` → IC=+0.250 (n=58)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1906 (IC base=+0.198)

- **PATRÓN** `dist_vwap_pct` < `1.3984` → IC=+0.193 (n=99)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 1.3984 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.853` → IC=+0.214 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.853 (IC base=+0.198)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.452` → IC=+0.198 (n=51)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` < 4.452 (IC base=+0.198)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.194 (n=96)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0106 (IC base=+0.192)

- **PATRÓN** `sigma_h` > `0.0228` → IC=+0.247 (n=73)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0228 (IC base=+0.192)
...
- **PATRÓN** `dist_vwap_pct` > `0.3325` → IC=+0.174 (n=44)
  ...
  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.3325 (IC base=+0.192)

- **PATRÓN** `dist_vwap_pct` < `0.5109` → IC=+0.177 (n=156)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 0.5109 (IC base=+0.192)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.188 (n=46)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `btc_momentum` |x|≤ `0.03` → IC=+0.181 (n=45)

  - _Acción_: Kelly boost +0.90€ cuando `btc_momentum` |x|≤ 0.03 (IC base=+0.151)
...
- **PATRÓN** `ibs_15` < `0.0268` → IC=+0.123 (n=136)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` < 0.0268 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.676` → IC=+0.133 (n=28)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.676 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` < `17.186` → IC=+0.141 (n=126)
...
- **PATRÓN** `dist_vwap_pct` > `0.6882` → IC=+0.143 (n=26)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.6882 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` < `15.261` → IC=+0.121 (n=56)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` < 15.261 (IC base=+0.048)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2234 | +0.173 | -47.49€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1438 | +0.206 | +0.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 94 | +0.000 | -16.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 324 | +0.092 | -46.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 378 | +0.158 | +15.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 647 | +0.178 | -17.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 480 | +0.197 | -24.39€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 31 | +0.076 | -1.24€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 126 | +0.164 | +11.52€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#ETH | 794 | +0.176 | +8.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 475 | +0.217 | +20.96€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 31 | -0.136 | -13.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 162 | +0.110 | -16.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 126 | +0.180 | +17.26€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL | 786 | +0.168 | -34.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 476 | +0.207 | +7.79€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 32 | +0.059 | -1.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 152 | +0.097 | -26.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 126 | +0.125 | -13.68€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 7 | -0.019 | -3.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 7 | -0.019 | -3.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 13 | +0.195 | +0.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 13 | +0.195 | +0.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 13 | +0.195 | +0.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 13 | +0.195 | +0.10€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4640 | +0.102 | +1433.95€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4640 | +0.102 | +1433.95€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1115 | +0.065 | +160.20€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1115 | +0.065 | +160.20€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1127 | +0.076 | +193.65€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1127 | +0.076 | +193.65€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1234 | +0.111 | +499.24€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1234 | +0.111 | +499.24€ | 0 | 6 |
| ✅ GBM_LATE_15M#XRP | 1164 | +0.155 | +580.86€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1164 | +0.155 | +580.86€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1892 | +0.153 | +1110.15€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1892 | +0.153 | +1110.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 485 | +0.120 | +242.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 485 | +0.120 | +242.16€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 500 | +0.130 | +233.64€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 500 | +0.130 | +233.64€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 510 | +0.109 | +220.76€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 510 | +0.109 | +220.76€ | 1 | 10 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 39 | +0.012 | +2.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 39 | +0.012 | +2.66€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 14 | +0.219 | +5.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 14 | +0.219 | +5.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1845 | +0.087 | +537.52€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1845 | +0.087 | +537.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 460 | +0.061 | +86.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 460 | +0.061 | +86.03€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 417 | +0.018 | +13.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 417 | +0.018 | +13.74€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 445 | +0.050 | +75.84€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 445 | +0.050 | +75.84€ | 3 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 523 | +0.195 | +361.90€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 523 | +0.195 | +361.90€ | 0 | 12 |
...
| ✅ LEADLAG_BTC_XRP_15M | 125 | +0.091 | +28.40€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 125 | +0.091 | +28.40€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 125 | +0.091 | +28.40€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 125 | +0.091 | +28.40€ | 0 | 4 |
...
| ✅ UPDOWN_GBM | 1559 | +0.010 | +72.98€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1301 | +0.037 | +110.01€ | 0 | 7 |
...
| ✅ UPDOWN_GBM#ETH | 749 | +0.018 | +34.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 656 | +0.035 | +45.99€ | 1 | 4 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 6 | +0.075 | +0.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 6 | +0.075 | +0.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 42 | +0.250 | +15.56€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 42 | +0.250 | +15.56€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 11 | +0.148 | +5.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 11 | +0.148 | +5.75€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 9 | +0.143 | +2.72€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 9 | +0.143 | +2.72€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 15 | +0.110 | +5.47€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 15 | +0.110 | +5.47€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.132) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=446 | neutral: IC=-0.015 n=342 | overbought(IBS>0.7): IC=+0.117 n=364
  - _Datos_: n=1217 IC=+0.036 PNL=+113.99€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.100 n=9070 | tras_1loss IC=+0.064 n=6401 | tras_2loss IC=+0.031 n=2764/40 | gap=+0.069 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.075 n=692/40 PNL=+165.38€ | H=15h UTC: IC=+0.128 n=699/40 PNL=+233.96€ | H=17h UTC: IC=+0.127 n=618/40 PNL=+180.89€ | H=19h UTC: IC=+0.082 n=556/40 PNL=+84.58€
...
**🔶 H-CUSTOM-GBM-17H-BTC** — GBM BTC a las 17h UTC — ¿edge real?
  ...
  - _Estado_: SEÑAL POSITIVA en BTC (IC=+0.249 n=19) pero sin cruzar ≥2 pares más — BNB: n=1 IC=+0.008; DOGE: n=1 IC=+0.008; ETH: n=37 IC=+0.115 ✓; SOL: n=3 IC=+0.015; XRP: n=1 IC=-0.008
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1432 IC=+0.017 PNL=+86.98€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1432 IC=+0.017 PNL=+86.98€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=572 IC=+0.033 PNL=+39.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=572 IC=+0.033 PNL=+39.59€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13230 IC=+0.103 PNL=+3210.15€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13230 IC=+0.103 PNL=+3210.15€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.257 > 0.2 con n=315 PNL=+220.32€
  - _Datos_: n=315 IC=+0.257 PNL=+220.32€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.116 > 0.08 con n=123 PNL=+52.89€
  - _Datos_: n=123 IC=+0.116 PNL=+52.89€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.143 > 0.08 con n=169 PNL=+92.45€
  - _Datos_: n=169 IC=+0.143 PNL=+92.45€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.202 > 0.08 con n=112 PNL=+2.64€
  - _Datos_: n=112 IC=+0.202 PNL=+2.64€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.256 > 0.08 con n=170 PNL=-5.55€
  - _Datos_: n=170 IC=+0.256 PNL=-5.55€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.151 n=61) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=61 IC=+0.151 PNL=+26.71€
