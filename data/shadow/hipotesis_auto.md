# Hipótesis automáticas — 2026-07-23 04:51 UTC
_Generado por shadow_postmortem.py sobre 30234 resoluciones (PNL=+6791.35€)_
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.215 (n=707)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.180 (n=2328)
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.252 (n=155)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.232 (n=196)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=448)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `1620.9102` → IC=+0.210 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1620.9102 (IC base=+0.211)
...
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.132 (n=909)
...
- **PATRÓN** `sigma_h` > `0.0267` → IC=+0.169 (n=246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0267 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.167 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.152)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.205 (n=269)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.771` → IC=+0.141 (n=402)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 3.771 (IC base=+0.152)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.167 (n=1036)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.143 (n=581)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 6.0 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `0.9777` → IC=+0.167 (n=118)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9777 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.7321` → IC=+0.135 (n=1539)
...
- **PATRÓN** `sigma_h` < `0.0187` → IC=+0.241 (n=395)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0187 (IC base=+0.239)

- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.251 (n=395)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.1691` → IC=+0.346 (n=89)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1691 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.006` → IC=+0.244 (n=346)
...
- **PATRÓN** `dist_vwap_pct` < `0.1065` → IC=+0.134 (n=787)
...
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.181 (n=496)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0085 (IC base=+0.178)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.197 (n=176)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 18.0 (IC base=+0.178)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.204 (n=177)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.178)

- **PATRÓN** `dist_vwap_pct` > `0.1407` → IC=+0.234 (n=141)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1407 (IC base=+0.178)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.347` → IC=+0.178 (n=482)
...
- **PATRÓN** `dist_vwap_pct` > `0.4502` → IC=+0.156 (n=62)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.4502 (IC base=+0.049)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 822 | +0.129 | +36.90€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 822 | +0.129 | +36.90€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 187 | +0.082 | +12.53€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 187 | +0.082 | +12.53€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 5280 | +0.188 | +92.12€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 3461 | +0.216 | +94.37€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1546 | +0.194 | +36.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1155 | +0.210 | -5.21€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1865 | +0.179 | +20.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1139 | +0.215 | +42.40€ | 0 | 8 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1840 | +0.191 | +30.72€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1142 | +0.224 | +57.08€ | 0 | 7 |
...
| ✅ GBM_LATE_15M | 7031 | +0.097 | +2206.97€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 7031 | +0.097 | +2206.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1696 | +0.067 | +281.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1696 | +0.067 | +281.63€ | 0 | 2 |
...
| ✅ GBM_LATE_15M#XRP | 1854 | +0.151 | +962.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1854 | +0.151 | +962.00€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 4229 | +0.128 | +2179.11€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 4229 | +0.128 | +2179.11€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1085 | +0.088 | +401.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1085 | +0.088 | +401.68€ | 0 | 4 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 1102 | +0.092 | +415.50€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 1102 | +0.092 | +415.50€ | 0 | 6 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 1069 | +0.103 | +468.25€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 1069 | +0.103 | +468.25€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 973 | +0.239 | +893.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 973 | +0.239 | +893.68€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 4230 | +0.082 | +1293.14€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 4230 | +0.082 | +1293.14€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1018 | +0.043 | +147.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1018 | +0.043 | +147.83€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 1019 | +0.030 | +86.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 1019 | +0.030 | +86.46€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 972 | +0.048 | +218.09€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 972 | +0.048 | +218.09€ | 1 | 3 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1221 | +0.184 | +840.77€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1221 | +0.184 | +840.77€ | 0 | 11 |
...
| ✅ UPDOWN_GBM | 2283 | +0.029 | +189.59€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2020 | +0.050 | +228.10€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#ETH | 940 | +0.031 | +54.36€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 846 | +0.046 | +65.92€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#XRP | 226 | +0.026 | +28.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 215 | +0.039 | +31.36€ | 4 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1313 | +0.165 | +602.22€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1313 | +0.165 | +602.22€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 258 | +0.154 | +82.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 258 | +0.154 | +82.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 320 | +0.102 | +91.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 320 | +0.102 | +91.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 331 | +0.203 | +231.08€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 331 | +0.203 | +231.08€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.201: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.059 n=1142 | neutral: IC=+0.004 n=882 | overbought(IBS>0.7): IC=+0.206 n=1113
  - _Datos_: n=3344 IC=+0.101 PNL=+840.28€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.115 n=18102 | tras_1loss IC=+0.083 n=11930 | tras_2loss IC=+0.052 n=4943/40 | gap=+0.063 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2151 IC=+0.035 PNL=+204.33€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2151 IC=+0.035 PNL=+204.33€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.090 > 0.08 con n=1076 PNL=+181.07€
  - _Datos_: n=1076 IC=+0.090 PNL=+181.07€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1058 IC=+0.038 PNL=+80.01€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1058 IC=+0.038 PNL=+80.01€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=186 IC=+0.064 PNL=+34.72€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=186 IC=+0.064 PNL=+34.72€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=927 IC=+0.054 PNL=+111.92€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=927 IC=+0.054 PNL=+111.92€
...
**〰️ H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: n=169 IC=+0.061 PNL=+30.90€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=169 IC=+0.061 PNL=+30.90€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.106 > 0.08 con n=582 PNL=+190.26€
  - _Datos_: n=582 IC=+0.106 PNL=+190.26€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.110 > 0.08 con n=442 PNL=+153.03€
  - _Datos_: n=442 IC=+0.110 PNL=+153.03€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.135 > 0.08 con n=529 PNL=+279.45€
  - _Datos_: n=529 IC=+0.135 PNL=+279.45€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.213 > 0.08 con n=319 PNL=+22.74€
  - _Datos_: n=319 IC=+0.213 PNL=+22.74€
