# Hipótesis automáticas — 2026-06-29 15:08 UTC
_Generado por shadow_postmortem.py sobre 1267 resoluciones (PNL=-35.98€)_
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0502` → IC=+0.132 (n=17)
  ...
  - _Acción_: Kelly boost +0.66€ cuando `pct_spot_vs_ref` |x|≤ 0.0502 (IC base=+0.038)
...
| ✅ PRICE_TARGET_GBM | 47 | -0.031 | -7.80€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#BTC | 24 | -0.077 | -4.65€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#BTC#atexpiry | 23 | -0.100 | -4.81€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#ETH | 18 | +0.045 | -1.79€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#ETH#atexpiry | 17 | +0.022 | -1.94€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#SOL | 5 | -0.018 | -1.36€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#SOL#atexpiry | 5 | -0.018 | -1.36€ | 0 | 0 |
| ✅ PRICE_TARGET_GBM#atexpiry | 45 | -0.053 | -8.11€ | 0 | 0 |
| 🚫 SMART_FLOW_1H | 23 | -0.260 | -10.63€ | 0 | 0 |
| ✅ SMART_FLOW_1H#BTC | 9 | -0.061 | -2.46€ | 0 | 0 |
| ✅ UPDOWN_GBM | 306 | +0.000 | -0.29€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 172 | +0.040 | +6.84€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 56 | +0.086 | +6.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 94 | +0.010 | -0.92€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 50 | +0.038 | +0.15€ | 0 | 1 |
| ✅ UPDOWN_GBM#BTC#240min | 5 | -0.089 | -2.96€ | 0 | 0 |
| 🚫 UPDOWN_GBM#BTC#5min | 16 | -0.133 | -6.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 20 | +0.136 | +3.10€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 115 | +0.030 | +1.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 72 | +0.041 | +0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 23 | +0.100 | +2.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 69 | -0.035 | +1.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 35 | +0.041 | +4.50€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 17 | -0.112 | -4.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 13 | -0.022 | +0.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 23 | -0.060 | -1.04€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 14 | +0.000 | +0.82€ | 0 | 0 |
...
| ✅ WEEKLY_PRICE | 52 | +0.037 | -10.43€ | 0 | 0 |
| ✅ WEEKLY_PRICE#BTC | 16 | -0.044 | -6.36€ | 0 | 0 |
| ✅ WEEKLY_PRICE#ETH | 20 | +0.045 | -4.24€ | 0 | 0 |
| ✅ WEEKLY_PRICE#SOL | 16 | +0.089 | +0.17€ | 0 | 0 |
...
**🟡 H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=20/15 IC=+0.045 PNL=-4.24€ | BTC: n=16/15 IC=-0.044 PNL=-6.36€ | SOL: n=16/15 IC=+0.089 PNL=+0.17€
...
**⏳ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: 17/40 ops con ibs_15. oversold(IBS<0.3): IC=-0.058 n=7 | neutral: IC=+0.015 n=3 | overbought(IBS>0.7): IC=+0.054 n=5
  - _Datos_: n=17 IC=+0.022 PNL=-1.42€

**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: 20
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: Solo 17 ops GBM con hora_utc en features. Esperar n≥20 para patrones.

**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  - _Umbral_: n_overlaps≥20 y IC_overlap > IC_base + 0.05
  - _Acción_: Cambiar _aplicar_kelly_compuesto: match por activo, no market_id
  - _Estado_: n_overlaps=17, boost estimado=+0.013. Necesita 3 más y boost>0.05
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.051 n=87/40 PNL=+0.29€ | H=15h UTC: IC=-0.006 n=83/40 PNL=-4.13€ | H=17h UTC: IC=+0.204 n=25/40 PNL=+7.08€ | H=19h UTC: IC=-0.029 n=32/40 PNL=-0.97€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=23/40 IC=+0.100 PNL=+2.69€ | BTC#60min: n=20/40 IC=+0.136 PNL=+3.10€ | SOL#60min: n=13/40 IC=-0.022 PNL=+0.76€
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 306/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=207 IC=+0.021 PNL=+5.35€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=207 IC=+0.021 PNL=+5.35€
...
**🟡 H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.081 > 0.08 con n=41 PNL=+5.58€
  - _Datos_: n=41 IC=+0.081 PNL=+5.58€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=127 IC=+0.012 PNL=-4.49€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=127 IC=+0.012 PNL=-4.49€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=50 IC=+0.038 PNL=+0.15€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=50 IC=+0.038 PNL=+0.15€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.08 con n=54 PNL=+7.25€
  - _Datos_: n=54 IC=+0.125 PNL=+7.25€

**⏳ H-CUSTOM-LONGSHOT-BIAS** — Longshot bias — ¿mejor IC cuando py_mkt < 0.20 o > 0.80?
  - _Hipótesis_: Jon-Becker repo documenta formalmente: contratos a 1-20 cents tienen win_rate < precio implícito (compradores pierden sistemáticamente en longshots). En nuestro sistema: cuando py_mkt<0.20 el GBM predice BUY_NO con edge estructural adicional al del modelo. ¿Se confirma en nuestros datos? Buscar en feature pct_spot_vs_ref si los mercados extremos tienen mejor IC en BUY_NO.
  - _Umbral_: 30
  - _Acción_: Si IC>0.10 con n≥30 en mercados extremos → boost ×1.2 en BUY_NO cuando py_mkt<0.20
  - _Estado_: 6/30 ops en el filtro definido (IC actual=+0.000 PNL=+1.41€)
  - _Datos_: n=6 IC=+0.000 PNL=+1.41€

**⏳ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  - _Hipótesis_: ETH y BTC tienen patrones opuestos: BTC funciona con momentum (drift>0.3). ETH funciona con reversión (drift<-1): 9/14 (64%) IC=+0.087. La hipótesis es que ETH tiene más mean-reversion que BTC en 15min.
  - _Umbral_: 20
  - _Acción_: Si ETH drift<-1 confirma IC>0.08 con n≥20 → boost ×1.1 en ETH#15min cuando drift_15min<-1
  - _Estado_: 15/20 ops en el filtro definido (IC actual=+0.066 PNL=+1.54€)
  - _Datos_: n=15 IC=+0.066 PNL=+1.54€
