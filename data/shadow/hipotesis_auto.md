# Hipótesis automáticas — 2026-07-03 04:01 UTC
_Generado por shadow_postmortem.py sobre 2929 resoluciones (PNL=-51.72€)_

## Patrones causales activos

### UPDOWN_GBM#15min
- **FILTRO** `ibs_15` > `0.3514` → IC=-0.134 (n=39)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.3514
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=121)

- **PATRÓN** `sigma_h` < `0.0101` → IC=+0.227 (n=75)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0101 (IC base=+0.042)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.122 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 15.0 (IC base=+0.042)

- **PATRÓN** `ibs_15` < `0.0613` → IC=+0.173 (n=53)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.86€ cuando `ibs_15` < 0.0613 (IC base=+0.042)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0613 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.173 n=53). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 289 | +0.067 | +40.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 289 | +0.067 | +40.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 76 | +0.026 | +3.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 76 | +0.026 | +3.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 75 | -0.019 | -0.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 75 | -0.019 | -0.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 70 | +0.097 | +11.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 70 | +0.097 | +11.59€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 68 | +0.171 | +25.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 68 | +0.171 | +25.54€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 847 | -0.040 | -47.68€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 618 | -0.018 | -20.35€ | 1 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 246 | -0.040 | -33.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 175 | -0.014 | -23.09€ | 3 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.061) — sin ventaja clara. oversold(IBS<0.3): IC=-0.006 n=154 | neutral: IC=-0.067 n=139 | overbought(IBS>0.7): IC=-0.043 n=149
  - _Datos_: n=457 IC=-0.038 PNL=-22.45€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.200 n=28 PNL=-13.74€ → FILTRAR | H=02h: IC=-0.180 n=23 PNL=-6.09€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=15h: IC=-0.109 n=21 PNL=-6.63€ → FILTRAR | H=16h: IC=+0.140 n=23 PNL=+3.65€ → BOOST | H=20h: IC=-0.143 n=26 PNL=-5.82€ → FILTRAR | H=23h: IC=+0.180 n=18 PNL=+12.32€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.006 n=1400 | tras_1loss IC=-0.027 n=1438 | tras_2loss IC=-0.044 n=737/40 | gap=+0.050 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=25, boost estimado=+0.008. Necesita 0 más y boost>0.05
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=724 IC=-0.034 PNL=-34.13€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=724 IC=-0.034 PNL=-34.13€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.014 < 0.02 con n=175 PNL=-23.09€
  - _Datos_: n=175 IC=-0.014 PNL=-23.09€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=262 IC=-0.015 PNL=-32.84€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=262 IC=-0.015 PNL=-32.84€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=209 IC=+0.017 PNL=+14.44€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=209 IC=+0.017 PNL=+14.44€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=503 IC=+0.043 PNL=+38.45€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=503 IC=+0.043 PNL=+38.45€
...
**〰️ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: n=41 IC=-0.012 PNL=-7.78€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=41 IC=-0.012 PNL=-7.78€
...
**⏳ H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: 69/120 ops en el filtro definido (IC actual=+0.120 PNL=+8.36€)
  - _Datos_: n=69 IC=+0.120 PNL=+8.36€
