# Hipótesis automáticas — 2026-07-15 12:55 UTC
_Generado por shadow_postmortem.py sobre 15325 resoluciones (PNL=+3001.17€)_
...
- **PATRÓN** `libro_liquidez` > `7292.9528` → IC=+0.185 (n=284)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7292.9528 (IC base=+0.161)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2148 | +0.176 | -32.94€ | 0 | 10 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 757 | +0.172 | -27.07€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8823 | tras_1loss IC=+0.061 n=6291 | tras_2loss IC=+0.029 n=2728/40 | gap=+0.070 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12867 IC=+0.102 PNL=+3077.05€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12867 IC=+0.102 PNL=+3077.05€
