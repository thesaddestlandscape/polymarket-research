# Hipótesis automáticas — 2026-07-05 18:29 UTC
_Generado por shadow_postmortem.py sobre 3966 resoluciones (PNL=+171.46€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.160 (n=95)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.0089 (IC base=+0.033)

- **PATRÓN** `ibs_15` < `0.0389` → IC=+0.167 (n=55)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.0389 (IC base=+0.033)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1289` → IC=+0.121 (n=85)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.60€ cuando `pct_spot_vs_ref` |x|≤ 0.1289 (IC base=+0.079)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.210 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.079)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.186 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 7.0 (IC base=+0.079)

- **PATRÓN** `ibs_15` < `0.099` → IC=+0.180 (n=48)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.099 (IC base=+0.079)
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: IBS < 0.099 correlaciona con éxito en UPDOWN_GBM#ETH#15min (IC=+0.180 n=48). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1126 | +0.091 | +264.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1126 | +0.091 | +264.55€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 293 | +0.039 | +29.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 293 | +0.039 | +29.52€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 294 | +0.061 | +33.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 294 | +0.061 | +33.33€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 295 | +0.123 | +108.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 295 | +0.123 | +108.00€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 244 | +0.150 | +93.69€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 244 | +0.150 | +93.69€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 962 | -0.036 | -49.40€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 723 | -0.013 | -19.44€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#BTC | 269 | -0.039 | -32.33€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 196 | -0.015 | -22.01€ | 3 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 407 | -0.004 | +7.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 320 | +0.015 | +15.66€ | 3 | 4 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.028 n=1992 | tras_1loss IC=-0.006 n=1880 | tras_2loss IC=-0.026 n=934/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.000 n=160/40 PNL=+12.57€ | H=15h UTC: IC=-0.018 n=164/40 PNL=-11.68€ | H=17h UTC: IC=+0.150 n=101/40 PNL=+32.21€ | H=19h UTC: IC=+0.028 n=104/40 PNL=+4.58€
...
**⏳ H-WEEKLY** — Predicciones semanales de precio por par
  ...
  - _Estado_: ETH: n=36/15 IC=+0.000 PNL=-8.64€ | BTC: n=35/15 IC=-0.013 PNL=-8.65€ | SOL: n=29/15 IC=-0.145 PNL=-7.05€
...
**〰️ H-WEEKLY-BUYNO** — WEEKLY_PRICE BUY_NO — dirección dominante con IC muy alto
  ...
  - _Estado_: n=66 IC=+0.073 PNL=-8.92€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=66 IC=+0.073 PNL=-8.92€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=839 IC=-0.032 PNL=-35.85€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=839 IC=-0.032 PNL=-35.85€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=438 IC=-0.043 PNL=-45.21€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=438 IC=-0.043 PNL=-45.21€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.015 < 0.02 con n=196 PNL=-22.01€
  - _Datos_: n=196 IC=-0.015 PNL=-22.01€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=326 IC=-0.012 PNL=-30.35€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=326 IC=-0.012 PNL=-30.35€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=262 IC=+0.004 PNL=+6.17€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=262 IC=+0.004 PNL=+6.17€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=465 IC=+0.044 PNL=+34.97€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=465 IC=+0.044 PNL=+34.97€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1516 IC=+0.062 PNL=+246.64€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1516 IC=+0.062 PNL=+246.64€
...
**〰️ H-CUSTOM-PRICETARGET-BUYYES-MALO** — PRICE_TARGET_GBM BUY_YES estructuralmente roto (BUY_NO no)
  ...
  - _Estado_: n=44 IC=-0.087 PNL=+15.53€ — sin señal clara aún (umbral IC: min=None max=-0.15)
  - _Datos_: n=44 IC=-0.087 PNL=+15.53€
...
**⏳ H-CUSTOM-WEEKLY-PCTDIST-BUYNO** — WEEKLY_PRICE BUY_NO con pct_dist alto — cuanto más lejos del rango, más seguro
  ...
  - _Estado_: 13/25 ops en el filtro definido (IC actual=-0.065 PNL=-3.34€)
  - _Datos_: n=13 IC=-0.065 PNL=-3.34€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.069 < -0.05 con n=582 PNL=-74.15€
  - _Datos_: n=582 IC=-0.069 PNL=-74.15€
...
**〰️ H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: n=103 IC=+0.005 PNL=-7.64€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=103 IC=+0.005 PNL=-7.64€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=95 IC=-0.077 PNL=+9.71€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=95 IC=-0.077 PNL=+9.71€
