# Hipótesis automáticas — 2026-07-27 03:15 UTC
_Generado por shadow_postmortem.py sobre 37658 resoluciones (PNL=+7807.96€)_
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.149 (n=913)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.162 (n=338)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `dist_vwap_pct` > `0.4501` → IC=+0.154 (n=325)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4501 (IC base=+0.105)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.143 (n=242)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.004 (IC base=+0.097)
...
- **PATRÓN** `dist_vwap_pct` > `0.4428` → IC=+0.178 (n=57)
  ...
  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.4428 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.155` → IC=+0.226 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.155 (IC base=+0.097)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7548` → IC=+0.218 (n=456)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7548 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.053)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.224` → IC=+0.144 (n=220)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 5.224 (IC base=+0.053)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.122 (n=207)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.61€ cuando `sigma_h` < 0.0047 (IC base=+0.097)

- **PATRÓN** `drift_60min` |x|≤ `0.2207` → IC=+0.137 (n=301)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.2207 (IC base=+0.097)
...
- **PATRÓN** `ibs_15` > `0.7248` → IC=+0.240 (n=233)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7248 (IC base=+0.097)

- **PATRÓN** `dist_vwap_pct` > `0.1441` → IC=+0.219 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1441 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` > `25.241` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 25.241 (IC base=+0.097)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.986` → IC=+0.144 (n=102)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 5.986 (IC base=+0.097)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7548 sube el IC de +0.053 a +0.218 en UPDOWN_GBM#15min (n=456). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7248 sube el IC de +0.097 a +0.240 en UPDOWN_GBM#BTC#15min (n=233). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ FAVORITO_CONFIRMADO | 6663 | +0.179 | -27.87€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 4393 | +0.203 | -34.81€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 1959 | +0.186 | +6.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1460 | +0.199 | -45.56€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 2316 | +0.185 | +7.37€ | 0 | 0 |
...
| ✅ GBM_LATE_15M | 8159 | +0.094 | +2464.11€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8159 | +0.094 | +2464.11€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1974 | +0.072 | +346.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1974 | +0.072 | +346.89€ | 0 | 5 |
...
| ✅ GBM_LATE_15M#XRP | 2189 | +0.141 | +1067.36€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2189 | +0.141 | +1067.36€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5390 | +0.117 | +2539.16€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5390 | +0.117 | +2539.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 1412 | +0.085 | +495.41€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 1412 | +0.085 | +495.41€ | 0 | 5 |
...
| ✅ GBM_LATE_15M_TARDIO | 5379 | +0.069 | +1450.92€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5379 | +0.069 | +1450.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 1285 | +0.037 | +172.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 1285 | +0.037 | +172.68€ | 0 | 4 |
...
| ✅ UPDOWN_GBM | 2753 | +0.034 | +243.07€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2490 | +0.052 | +281.59€ | 0 | 3 |
...
| ✅ UPDOWN_GBM#BTC | 576 | +0.052 | +65.49€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 492 | +0.085 | +79.97€ | 1 | 9 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1984 | +0.156 | +908.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1984 | +0.156 | +908.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 192 | +0.211 | +124.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 192 | +0.211 | +124.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 206 | +0.111 | +34.74€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 206 | +0.111 | +34.74€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 550 | +0.177 | +341.54€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 550 | +0.177 | +341.54€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.172: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.076 n=1506 | neutral: IC=+0.017 n=1223 | overbought(IBS>0.7): IC=+0.189 n=1534
  - _Datos_: n=4545 IC=+0.105 PNL=+1209.89€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.112 n=22432 | tras_1loss IC=+0.079 n=15017 | tras_2loss IC=+0.051 n=6291/40 | gap=+0.061 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2616 IC=+0.039 PNL=+256.87€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2616 IC=+0.039 PNL=+256.87€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1086 IC=+0.053 PNL=+137.17€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1086 IC=+0.053 PNL=+137.17€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=492 IC=+0.085 PNL=+79.97€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=492 IC=+0.085 PNL=+79.97€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.087 > 0.08 con n=1331 PNL=+218.95€
  - _Datos_: n=1331 IC=+0.087 PNL=+218.95€
...
**〰️ H-CUSTOM-CROSS-WINDOW-SPREAD-NEG** — GBM 15min/60min: spread negativo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: n=174 IC=+0.045 PNL=+57.40€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=174 IC=+0.045 PNL=+57.40€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=1396 IC=+0.057 PNL=+167.86€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1396 IC=+0.057 PNL=+167.86€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1236 IC=+0.028 PNL=+106.62€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1236 IC=+0.028 PNL=+106.62€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.160 > 0.1 con n=952 PNL=+320.36€
  - _Datos_: n=952 IC=+0.160 PNL=+320.36€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1089 IC=+0.056 PNL=+119.51€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1089 IC=+0.056 PNL=+119.51€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=682 PNL=+183.41€
  - _Datos_: n=682 IC=+0.121 PNL=+183.41€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.170 > 0.08 con n=280 PNL=+98.99€
  - _Datos_: n=280 IC=+0.170 PNL=+98.99€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.131 > 0.08 con n=705 PNL=+357.46€
  - _Datos_: n=705 IC=+0.131 PNL=+357.46€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.204 > 0.08 con n=421 PNL=+23.06€
  - _Datos_: n=421 IC=+0.204 PNL=+23.06€
