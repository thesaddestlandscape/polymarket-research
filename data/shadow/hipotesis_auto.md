# Hipótesis automáticas — 2026-09-13 06:34 UTC
_Generado por shadow_postmortem.py sobre 415912 resoluciones (PNL=+43869.56€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.3` → IC=-0.263 (n=5311)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.3
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=15933)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `n_ballenas` < `4.0` → IC=-0.123 (n=1829)

  - _Acción_: SKIP cuando `n_ballenas` < 4.0
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=1137)

- **FILTRO** `restante_s_al_confirmar` < `140.63` → IC=-0.282 (n=741)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.63
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2225)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `132.89` → IC=-0.291 (n=676)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 132.89
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=2030)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `144.49` → IC=-0.162 (n=1374)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.49
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4122)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `157.46` → IC=-0.254 (n=1219)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.46
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3657)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.06` → IC=-0.346 (n=1340)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.06
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=2723)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.181 (n=70)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.200 (n=9908)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=2687)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.147 (n=9726)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 7.0 (IC base=+0.136)

- **PATRÓN** `py_entrada` < `0.345` → IC=+0.245 (n=7205)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.345 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.173 (n=5297)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `6980.4173` → IC=+0.176 (n=1681)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 6980.4173 (IC base=+0.136)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1251)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` > `0.745` → IC=+0.354 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1543)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1247)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.270 (n=1092)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.206 (n=1601)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `12677.1215` → IC=+0.206 (n=563)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12677.1215 (IC base=+0.204)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.190 (n=266)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `3889.9068` → IC=+0.163 (n=411)
  ...
  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 3889.9068 (IC base=+0.136)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.146 (n=2165)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.140 (n=1841)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.196 (n=1011)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.85` → IC=+0.426 (n=498)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.183 (n=490)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.186 (n=1053)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.448 (n=344)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.442)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.450 (n=398)
...
- **PATRÓN** `hora_utc` < `14.0` → IC=+0.441 (n=134)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.439)

- **PATRÓN** `py_entrada` > `0.915` → IC=+0.457 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.915 (IC base=+0.439)

- **PATRÓN** `libro_liquidez` > `11570.9911` → IC=+0.460 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11570.9911 (IC base=+0.439)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.182 (n=4501)
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1575)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.286 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.263)

- **PATRÓN** `libro_liquidez` > `964.119` → IC=+0.278 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 964.119 (IC base=+0.263)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9744` → IC=+0.230 (n=1845)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9744 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2068` → IC=+0.243 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2068 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.826` → IC=+0.167 (n=2132)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.826 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `1.2306` → IC=+0.242 (n=1372)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2306 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0679` → IC=+0.240 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0679 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1756` → IC=+0.191 (n=3709)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1756 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.1105` → IC=+0.194 (n=1387)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.1105 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `2.8516` → IC=+0.191 (n=3576)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 2.8516 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4711` → IC=+0.193 (n=3577)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.4711 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5769` → IC=+0.124 (n=6803)

  - _Acción_: Kelly boost +0.62€ cuando `ibs_20min` < 0.5769 (IC base=+0.055)

- **PATRÓN** `dist_vwap_pct` < `0.1297` → IC=+0.163 (n=2012)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1297 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` < `1.2011` → IC=+0.160 (n=2106)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2011 (IC base=+0.055)

- **PATRÓN** `volumen_regimen` > `0.6201` → IC=+0.161 (n=2106)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6201 (IC base=+0.055)

- **PATRÓN** `volumen_pendiente_norm` > `0.1692` → IC=+0.225 (n=1027)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1692 (IC base=+0.055)

- **PATRÓN** `volumen_spike_ratio` > `1.4625` → IC=+0.193 (n=3504)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4625 (IC base=+0.055)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.203 (n=3272)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 166.0 (IC base=+0.055)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.191 (n=418)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3233` → IC=+0.169 (n=1240)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3233 (IC base=+0.167)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.188 (n=827)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.023` → IC=+0.286 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.023 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2779` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2779 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `2.6298` → IC=+0.158 (n=1135)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.6298 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.162 (n=1134)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.167)

- **PATRÓN** `libro_spread` < `0.06` → IC=+0.183 (n=1319)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.06 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.190 (n=900)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 64.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.257 (n=824)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1919` → IC=+0.280 (n=615)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0633` → IC=+0.287 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0633 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.381` → IC=+0.249 (n=960)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.381 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0688` → IC=+0.234 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0688 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` > `0.2883` → IC=+0.293 (n=114)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2883 (IC base=+0.238)

- **PATRÓN** `volumen_spike_ratio` > `2.7073` → IC=+0.268 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7073 (IC base=+0.238)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.242 (n=923)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1575.869` → IC=+0.249 (n=823)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1575.869 (IC base=+0.238)

- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.232 (n=754)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.230 (n=982)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.9266` → IC=+0.252 (n=426)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.919` → IC=+0.234 (n=212)
...
- **PATRÓN** `volumen_regimen` > `0.8783` → IC=+0.212 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8783 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.1007` → IC=+0.212 (n=886)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4189` → IC=+0.217 (n=305)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4189 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.229 (n=839)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11847.0948 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0048` → IC=+0.162 (n=882)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0048 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3201` → IC=+0.147 (n=1002)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.5418` → IC=+0.179 (n=882)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` < 0.5418 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.678` → IC=+0.172 (n=333)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.678 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1873` → IC=+0.148 (n=1002)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.1873 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.139 (n=1002)
...
- **PATRÓN** `volumen_spike_ratio` < `2.409` → IC=+0.156 (n=893)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.409 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.151 (n=893)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12789.0736` → IC=+0.151 (n=668)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 12789.0736 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `220.0` → IC=+0.168 (n=272)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=1275)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 5.0 (IC base=+0.177)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.182 (n=1075)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 15.0 (IC base=+0.177)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.256 (n=474)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.35` → IC=+0.234 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.35 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1072` → IC=+0.184 (n=1013)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` < 0.1072 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` > `0.377` → IC=+0.177 (n=159)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.377 (IC base=+0.177)

- **PATRÓN** `volumen_spike_ratio` > `1.6649` → IC=+0.184 (n=1123)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.6649 (IC base=+0.177)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=1360)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.04 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `16.0` → IC=+0.198 (n=312)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 16.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.218 (n=1044)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.211)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.211 (n=930)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.211)

- **PATRÓN** `drift_60min` |x|≤ `0.1136` → IC=+0.214 (n=348)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1136 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.239 (n=347)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.211)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.217 (n=489)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` < `0.3919` → IC=+0.229 (n=917)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3919 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.695` → IC=+0.233 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.695 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.401` → IC=+0.211 (n=1143)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.401 (IC base=+0.211)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8451` → IC=+0.199 (n=403)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.8451 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.3006` → IC=+0.217 (n=610)
...
- **PATRÓN** `libro_liquidez` > `1887.4151` → IC=+0.222 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.4151 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.203 (n=571)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=87)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1530)

- **PATRÓN** `ibs_20min` > `0.9299` → IC=+0.160 (n=260)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.9299 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` < `0.1735` → IC=+0.336 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1735 (IC base=+0.007)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.23` → IC=+0.128 (n=482)
...
- **PATRÓN** `volumen_regimen` > `1.1897` → IC=+0.346 (n=63)
...
- **PATRÓN** `ballena_activa_n` < `167.0` → IC=+0.333 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 167.0 (IC base=+0.007)

- **PATRÓN** `dist_vwap_pct` > `0.1494` → IC=+0.182 (n=149)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.1494 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` < `1.0344` → IC=+0.145 (n=406)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.0344 (IC base=-0.009)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.137 (n=461)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.6141 (IC base=-0.009)

- **PATRÓN** `volumen_pendiente_norm` > `0.2615` → IC=+0.200 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2615 (IC base=-0.009)

- **PATRÓN** `volumen_spike_ratio` > `1.5018` → IC=+0.168 (n=368)
...
- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.126 (n=1586)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.109 (n=789)

- **FILTRO** `sigma_ewma_delta_pct` > `8.613` → IC=-0.197 (n=262)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.613
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2113)
...
- **PATRÓN** `volumen_regimen` > `0.9331` → IC=+0.164 (n=126)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.9331 (IC base=-0.048)
...
- **FILTRO** `ibs_20min` > `0.7778` → IC=-0.194 (n=590)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1772)

- **PATRÓN** `dist_vwap_pct` > `0.8527` → IC=+0.308 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8527 (IC base=-0.087)

- **PATRÓN** `dist_vwap_pct` < `0.2396` → IC=+0.290 (n=155)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2396 (IC base=-0.087)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5191` → IC=+0.256 (n=158)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5191 (IC base=-0.087)
...
- **PATRÓN** `dist_vwap_pct` < `0.2346` → IC=+0.230 (n=472)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2213` → IC=+0.244 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2213 (IC base=-0.031)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.224 (n=350)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 36.0 (IC base=-0.031)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.157 (n=3127)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0076 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.4565` → IC=+0.171 (n=6156)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4565 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.6941` → IC=+0.273 (n=631)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6941 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.483` → IC=+0.137 (n=3266)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 3.483 (IC base=+0.084)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.225 (n=2069)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4809` → IC=+0.233 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4809 (IC base=+0.084)

- **PATRÓN** `volumen_spike_ratio` > `2.805` → IC=+0.231 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.805 (IC base=+0.084)

- **PATRÓN** `ballena_activa_n` < `104.0` → IC=+0.275 (n=3145)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 104.0 (IC base=+0.084)

- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.136 (n=2370)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0084 (IC base=+0.064)

- **PATRÓN** `ibs_20min` < `0.5625` → IC=+0.145 (n=6257)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` < 0.5625 (IC base=+0.064)

- **PATRÓN** `dist_vwap_pct` > `0.6528` → IC=+0.242 (n=335)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6528 (IC base=+0.064)

- **PATRÓN** `volumen_regimen` > `1.1947` → IC=+0.257 (n=614)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1947 (IC base=+0.064)
...
- **PATRÓN** `volumen_spike_ratio` < `1.6166` → IC=+0.251 (n=1047)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6166 (IC base=+0.064)

- **PATRÓN** `volumen_spike_ratio` > `2.3762` → IC=+0.255 (n=1078)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3762 (IC base=+0.064)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.254 (n=2229)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.064)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2298` → IC=-0.143 (n=466)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2298
  - _Potencial_: sin este filtro IC_bueno=+0.097 (n=1401)

- **FILTRO** `sigma_ewma_delta_pct` > `4.322` → IC=-0.158 (n=360)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.322
  - _Potencial_: sin este filtro IC_bueno=+0.024 (n=1189)
...
- **PATRÓN** `ballena_activa_n` < `61.0` → IC=+0.220 (n=369)
...
- **FILTRO** `ibs_20min` > `0.8349` → IC=-0.151 (n=528)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8349
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=1587)
...
- **PATRÓN** `volumen_regimen` > `1.1253` → IC=+0.234 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1253 (IC base=-0.005)

- **PATRÓN** `volumen_pendiente_norm` > `0.276` → IC=+0.354 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.276 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` < `1.7599` → IC=+0.223 (n=193)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7599 (IC base=-0.005)

- **PATRÓN** `volumen_spike_ratio` > `2.1523` → IC=+0.214 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1523 (IC base=-0.005)

- **PATRÓN** `ballena_activa_n` < `515.0` → IC=+0.212 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 515.0 (IC base=-0.005)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0948` → IC=+0.242 (n=367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0948 (IC base=+0.237)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.240 (n=551)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.237)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.251 (n=544)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.293 (n=562)
...
- **PATRÓN** `ibs_20min` < `0.3388` → IC=+0.286 (n=870)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3388 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.885` → IC=+0.302 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.885 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.637` → IC=+0.278 (n=936)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.637 (IC base=+0.278)
...
- **PATRÓN** `volumen_spike_ratio` < `3.3742` → IC=+0.272 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.3742 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.228` → IC=+0.284 (n=516)
...
- **PATRÓN** `libro_liquidez` > `1877.2368` → IC=+0.298 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1877.2368 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.273 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 27.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2234` → IC=-0.210 (n=301)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2234
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=904)

- **FILTRO** `ibs_20min` > `0.8315` → IC=-0.178 (n=411)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8315
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1235)

- **PATRÓN** `ibs_20min` > `0.8` → IC=+0.130 (n=411)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` > 0.8 (IC base=-0.025)

- **PATRÓN** `dist_vwap_pct` > `0.4516` → IC=+0.217 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4516 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.9231` → IC=+0.196 (n=212)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.9231 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `0.6044` → IC=+0.168 (n=215)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6044 (IC base=-0.025)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2948` → IC=+0.223 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2948 (IC base=-0.025)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.222 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 176.0 (IC base=-0.025)

- **PATRÓN** `dist_vwap_pct` > `0.1032` → IC=+0.157 (n=68)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.1032 (IC base=-0.030)

- **PATRÓN** `volumen_regimen` < `1.0874` → IC=+0.148 (n=163)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0874 (IC base=-0.030)

- **PATRÓN** `volumen_regimen` > `0.6828` → IC=+0.134 (n=162)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6828 (IC base=-0.030)

- **PATRÓN** `volumen_pendiente_norm` > `0.1858` → IC=+0.339 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1858 (IC base=-0.030)

- **PATRÓN** `volumen_spike_ratio` < `1.7071` → IC=+0.226 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7071 (IC base=-0.030)

- **PATRÓN** `volumen_spike_ratio` > `2.2216` → IC=+0.244 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2216 (IC base=-0.030)

- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.215 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 152.0 (IC base=-0.030)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6634` → IC=-0.195 (n=751)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6634
  - _Potencial_: sin este filtro IC_bueno=+0.244 (n=752)

- **FILTRO** `ibs_20min` > `0.7255` → IC=-0.234 (n=400)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7255
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1204)

- **FILTRO** `sigma_ewma_delta_pct` > `4.76` → IC=-0.160 (n=386)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.76
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1218)

- **PATRÓN** `ibs_20min` > `0.6634` → IC=+0.244 (n=752)
...
- **PATRÓN** `volumen_regimen` > `0.634` → IC=+0.263 (n=513)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.634 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1077` → IC=+0.267 (n=474)
...
- **PATRÓN** `ibs_20min` < `0.2105` → IC=+0.163 (n=535)
...
- **PATRÓN** `dist_vwap_pct` < `0.156` → IC=+0.186 (n=262)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` < 0.156 (IC base=-0.002)

- **PATRÓN** `volumen_regimen` < `0.7171` → IC=+0.227 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7171 (IC base=-0.002)

- **PATRÓN** `volumen_pendiente_norm` < `0.1003` → IC=+0.188 (n=254)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5876` → IC=+0.203 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5876 (IC base=-0.002)

- **PATRÓN** `volumen_spike_ratio` > `1.5236` → IC=+0.180 (n=264)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.276 (n=457)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` > `0.898` → IC=+0.329 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.898 (IC base=+0.260)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `9.737` → IC=+0.260 (n=1061)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 9.737 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` > `0.8495` → IC=+0.285 (n=646)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8495 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` < `0.1114` → IC=+0.263 (n=843)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1114 (IC base=+0.260)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5522` → IC=+0.273 (n=398)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.179 (n=1855)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4561` → IC=+0.224 (n=5309)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4561 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.734` → IC=+0.188 (n=2201)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 3.734 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `1.1842` → IC=+0.155 (n=3890)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.1842 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.152 (n=3890)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 0.6252 (IC base=+0.170)

- **PATRÓN** `volumen_pendiente_norm` > `0.291` → IC=+0.228 (n=745)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.291 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` < `1.8752` → IC=+0.168 (n=3108)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.8752 (IC base=+0.170)

- **PATRÓN** `volumen_spike_ratio` > `2.6321` → IC=+0.173 (n=1554)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.6321 (IC base=+0.170)

- **PATRÓN** `ballena_activa_n` < `131.0` → IC=+0.169 (n=4272)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.243 (n=659)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.237)

- **PATRÓN** `ibs_20min` < `0.1111` → IC=+0.268 (n=441)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1111 (IC base=+0.237)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.966` → IC=+0.250 (n=713)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.966 (IC base=+0.237)

- **PATRÓN** `volumen_pendiente_norm` < `0.069` → IC=+0.233 (n=511)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8716` → IC=+0.254 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8716 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.232 (n=196)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1576.48` → IC=+0.253 (n=589)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.48 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.235 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 49.0 (IC base=+0.237)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3628` → IC=+0.176 (n=798)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `libro_liquidez` > `11191.459` → IC=+0.191 (n=713)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11191.459 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `413.0` → IC=+0.164 (n=634)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 413.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.179 (n=799)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0049 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.2865` → IC=+0.169 (n=908)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `2.4266` → IC=+0.164 (n=799)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 2.4266 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.4122` → IC=+0.155 (n=800)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.4122 (IC base=+0.151)

- **PATRÓN** `ballena_activa_n` < `238.0` → IC=+0.168 (n=242)
...
- **PATRÓN** `sigma_h` < `0.0105` → IC=+0.232 (n=760)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0885` → IC=+0.243 (n=255)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3558` → IC=+0.248 (n=760)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3558 (IC base=+0.218)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.677` → IC=+0.267 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.677 (IC base=+0.218)

- **PATRÓN** `volumen_pendiente_norm` > `0.3592` → IC=+0.270 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3592 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` < `1.8282` → IC=+0.209 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8282 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `2.2488` → IC=+0.226 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2488 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1886.4395` → IC=+0.229 (n=253)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1886.4395 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.200 (n=221)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.158 (n=816)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.006 (IC base=+0.125)

- **PATRÓN** `drift_60min` |x|≤ `0.3714` → IC=+0.146 (n=928)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.3714 (IC base=+0.125)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.185 (n=312)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 18.0 (IC base=+0.125)

- **PATRÓN** `ibs_20min` < `0.5954` → IC=+0.176 (n=928)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.5954 (IC base=+0.125)

- **PATRÓN** `dist_vwap_pct` < `0.1463` → IC=+0.138 (n=927)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1463 (IC base=+0.125)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.142` → IC=+0.190 (n=182)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 12.142 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` < `0.8624` → IC=+0.139 (n=619)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8624 (IC base=+0.125)

- **PATRÓN** `volumen_regimen` > `0.6141` → IC=+0.132 (n=927)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.6141 (IC base=+0.125)

- **PATRÓN** `volumen_pendiente_norm` > `0.0737` → IC=+0.166 (n=366)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.0737 (IC base=+0.125)

- **PATRÓN** `volumen_spike_ratio` < `1.7855` → IC=+0.131 (n=543)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.7855 (IC base=+0.125)

- **PATRÓN** `libro_liquidez` > `9877.5526` → IC=+0.150 (n=421)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 9877.5526 (IC base=+0.125)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=1074)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.122 (n=1045)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2243 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.7948` → IC=+0.124 (n=668)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.7948 (IC base=+0.112)
...
- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.138 (n=746)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 49.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.148 (n=444)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.5278` → IC=+0.203 (n=1008)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5278 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.33` → IC=+0.153 (n=211)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 7.33 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `1.0417` → IC=+0.127 (n=887)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0417 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.2732` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.2732 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` < `1.4585` → IC=+0.123 (n=290)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.4585 (IC base=+0.114)

- **PATRÓN** `volumen_spike_ratio` > `2.144` → IC=+0.141 (n=394)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.144 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3098.713` → IC=+0.154 (n=336)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3098.713 (IC base=+0.114)
...
- **PATRÓN** `sigma_h` > `0.022` → IC=+0.204 (n=475)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.210 (n=485)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.431` → IC=+0.235 (n=1048)
...
- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.214 (n=1048)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6271 (IC base=+0.200)

- **PATRÓN** `volumen_pendiente_norm` > `0.2814` → IC=+0.291 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2814 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2444` → IC=+0.194 (n=805)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2444 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4601` → IC=+0.187 (n=915)
...
- **PATRÓN** `libro_liquidez` > `2515.6876` → IC=+0.210 (n=699)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2515.6876 (IC base=+0.200)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.145 (n=429)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0038 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.153 (n=583)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` > 0.0071 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0936` → IC=+0.153 (n=428)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.0936 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.189 (n=653)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.4099` → IC=+0.169 (n=1283)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4099 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.7821` → IC=+0.190 (n=172)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.7821 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.703` → IC=+0.178 (n=579)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 3.703 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.162 (n=731)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8616 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1671` → IC=+0.165 (n=353)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1671 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `1.4377` → IC=+0.146 (n=408)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.4377 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.824` → IC=+0.152 (n=815)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.824 (IC base=+0.140)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.147 (n=1415)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `8101.5764` → IC=+0.176 (n=582)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 8101.5764 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.163 (n=363)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 20.0 (IC base=+0.140)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.140 (n=442)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` < 0.0036 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.305` → IC=+0.158 (n=882)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.305 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.807` → IC=+0.128 (n=525)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` > 3.807 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.1661` → IC=+0.144 (n=338)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.1661 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` < `2.2271` → IC=+0.124 (n=1106)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.2271 (IC base=+0.102)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.135 (n=398)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1032` → IC=+0.164 (n=126)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.1032 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.158 (n=290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 8.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.9061` → IC=+0.195 (n=129)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.9061 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.2999` → IC=+0.181 (n=89)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.2999 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.31` → IC=+0.191 (n=134)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 3.31 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.5852` → IC=+0.201 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.5852 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `1.5114` → IC=+0.130 (n=244)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.5114 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `9627.5275` → IC=+0.155 (n=285)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 9627.5275 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `148.0` → IC=+0.159 (n=86)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 148.0 (IC base=+0.117)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0934` → IC=+0.237 (n=131)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0934 (IC base=+0.209)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=408)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.209)

- **PATRÓN** `ibs_20min` > `0.2721` → IC=+0.249 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2721 (IC base=+0.209)
...
- **PATRÓN** `volumen_regimen` > `1.168` → IC=+0.244 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.168 (IC base=+0.209)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0245` → IC=+0.268 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0245 (IC base=+0.209)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.211 (n=423)
...
- **PATRÓN** `sigma_h` < `0.0047` → IC=+0.129 (n=219)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0047 (IC base=+0.084)

- **PATRÓN** `drift_60min` |x|≤ `0.0956` → IC=+0.149 (n=109)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0956 (IC base=+0.084)

- **PATRÓN** `ibs_20min` < `0.3259` → IC=+0.136 (n=218)

  - _Acción_: Kelly boost +0.68€ cuando `ibs_20min` < 0.3259 (IC base=+0.084)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1657` → IC=+0.128 (n=76)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` > 0.1657 (IC base=+0.084)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.297` → IC=+0.148 (n=123)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 5.297 (IC base=+0.066)

- **PATRÓN** `libro_liquidez` > `2771.7837` → IC=+0.172 (n=126)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2771.7837 (IC base=+0.066)

- **PATRÓN** `ibs_20min` < `0.4524` → IC=+0.150 (n=244)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.4524 (IC base=+0.069)

- **PATRÓN** `volumen_spike_ratio` < `2.2675` → IC=+0.124 (n=195)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.2675 (IC base=+0.069)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.124 (n=187)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 45.0 (IC base=+0.069)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.183 (n=2930)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.182)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.236 (n=6347)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.766` → IC=+0.200 (n=930)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.766 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.689` → IC=+0.182 (n=6121)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.689 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `1.055` → IC=+0.156 (n=3853)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 1.055 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.1969` → IC=+0.159 (n=1460)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.1969 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2361` → IC=+0.244 (n=1104)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2361 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.2929` → IC=+0.189 (n=2546)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.2929 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `130.0` → IC=+0.177 (n=5214)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3209` → IC=+0.196 (n=1156)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.3209 (IC base=+0.196)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.201 (n=559)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.196)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.213 (n=779)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.79` → IC=+0.326 (n=522)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5585` → IC=+0.202 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5585 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.5813` → IC=+0.191 (n=357)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.5813 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.05` → IC=+0.225 (n=1081)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.05 (IC base=+0.196)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.231 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 80.0 (IC base=+0.196)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.266 (n=801)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2035` → IC=+0.288 (n=607)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.259 (n=833)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` < `0.0692` → IC=+0.306 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0692 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.636` → IC=+0.270 (n=909)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.636 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` > `0.2284` → IC=+0.317 (n=162)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2284 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` > `1.9123` → IC=+0.279 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9123 (IC base=+0.260)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.260 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.260)

- **PATRÓN** `libro_liquidez` > `1576.48` → IC=+0.269 (n=813)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1576.48 (IC base=+0.260)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.259 (n=662)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 69.0 (IC base=+0.260)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.191 (n=367)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0027 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.1824` → IC=+0.156 (n=731)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1824 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.165 (n=1146)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.887` → IC=+0.171 (n=256)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 9.887 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `1.2802` → IC=+0.163 (n=1096)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.2802 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.183 (n=304)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `2.4502` → IC=+0.161 (n=1043)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4502 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7709` → IC=+0.161 (n=695)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7709 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10653.1142` → IC=+0.172 (n=979)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 10653.1142 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `499.0` → IC=+0.166 (n=972)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 499.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.172 (n=860)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0049 (IC base=+0.158)

- **PATRÓN** `drift_60min` |x|≤ `0.3247` → IC=+0.173 (n=976)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3247 (IC base=+0.158)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.163 (n=915)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.158)

- **PATRÓN** `ibs_20min` < `0.6443` → IC=+0.206 (n=976)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6443 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.618` → IC=+0.189 (n=178)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 11.618 (IC base=+0.158)

- **PATRÓN** `volumen_regimen` < `1.1847` → IC=+0.168 (n=977)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.1847 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` > `0.1496` → IC=+0.223 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1496 (IC base=+0.158)

- **PATRÓN** `volumen_spike_ratio` < `2.3998` → IC=+0.173 (n=879)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.3998 (IC base=+0.158)

- **PATRÓN** `ballena_activa_n` < `289.0` → IC=+0.172 (n=260)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 289.0 (IC base=+0.158)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.226 (n=1080)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0058 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.218 (n=1135)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.211)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.218 (n=966)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.6721` → IC=+0.251 (n=965)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6721 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.811` → IC=+0.293 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.811 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.2192` → IC=+0.220 (n=1024)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2192 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `1.6864` → IC=+0.220 (n=1005)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6864 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.228 (n=1209)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.211)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.238 (n=800)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 63.0 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.236 (n=351)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.227)

- **PATRÓN** `sigma_h` > `0.0064` → IC=+0.230 (n=942)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0064 (IC base=+0.227)

- **PATRÓN** `drift_60min` |x|≤ `0.146` → IC=+0.227 (n=463)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.146 (IC base=+0.227)
...
- **PATRÓN** `libro_liquidez` > `1891.5784` → IC=+0.228 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.5784 (IC base=+0.227)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.217 (n=745)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.137)

- **PATRÓN** `ibs_20min` > `0.7151` → IC=+0.237 (n=779)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7151 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.3365` → IC=+0.179 (n=450)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.3365 (IC base=+0.137)
...
- **PATRÓN** `volumen_regimen` > `1.1997` → IC=+0.138 (n=390)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.1997 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.2741` → IC=+0.237 (n=169)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.137 (n=1269)

  - _Acción_: Kelly boost +0.68€ cuando `libro_spread` < 0.01 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `9040.9286` → IC=+0.237 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9040.9286 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `169.0` → IC=+0.146 (n=919)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 169.0 (IC base=+0.137)

- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.182 (n=313)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0032 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.4235` → IC=+0.150 (n=934)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4235 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.166 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 17.0 (IC base=+0.131)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.155 (n=421)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6933` → IC=+0.183 (n=934)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6933 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.1942` → IC=+0.137 (n=862)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1942 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.113` → IC=+0.190 (n=140)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 11.113 (IC base=+0.131)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.352` → IC=+0.132 (n=873)

  - _Acción_: Kelly boost +0.66€ cuando `sigma_ewma_delta_pct` < 4.352 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` < `0.8525` → IC=+0.140 (n=623)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.8525 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `1.1634` → IC=+0.146 (n=312)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1634 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2735` → IC=+0.248 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2735 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `1.5565` → IC=+0.138 (n=382)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5565 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.1232` → IC=+0.162 (n=394)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.1232 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `11093.2268` → IC=+0.175 (n=312)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 11093.2268 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `199.0` → IC=+0.133 (n=859)
...
- **PATRÓN** `ibs_20min` > `0.4615` → IC=+0.174 (n=1211)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.213 (n=448)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.173 (n=497)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0061 (IC base=+0.117)

- **PATRÓN** `drift_60min` |x|≤ `0.1197` → IC=+0.150 (n=378)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1197 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.156 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 15.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.209 (n=1129)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.619 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` < `0.189` → IC=+0.138 (n=921)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.189 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.368` → IC=+0.127 (n=1085)

  - _Acción_: Kelly boost +0.64€ cuando `sigma_ewma_delta_pct` < 3.368 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.151 (n=497)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.7144 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` > `0.2169` → IC=+0.176 (n=174)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.2169 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.4654` → IC=+0.151 (n=325)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4654 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` > `2.2064` → IC=+0.134 (n=441)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.2064 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2957.5462` → IC=+0.161 (n=376)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2957.5462 (IC base=+0.117)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.027` → IC=+0.219 (n=407)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.203 (n=1087)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.202)

- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.237 (n=1227)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.1738` → IC=+0.235 (n=700)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1738 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.534` → IC=+0.235 (n=663)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.534 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2397` → IC=+0.205 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2397 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.6199` → IC=+0.205 (n=1221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6199 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.2365` → IC=+0.227 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2365 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `2.6099` → IC=+0.226 (n=389)
...
- **PATRÓN** `libro_liquidez` > `2558.1816` → IC=+0.207 (n=814)
...
- **PATRÓN** `sigma_h` > `0.0252` → IC=+0.222 (n=447)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.203 (n=1420)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.5008` → IC=+0.250 (n=1343)
...
- **PATRÓN** `dist_vwap_pct` < `0.1797` → IC=+0.202 (n=1193)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1797 (IC base=+0.199)
...
- **PATRÓN** `volumen_regimen` > `1.2298` → IC=+0.237 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2298 (IC base=+0.199)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2267` → IC=+0.191 (n=1025)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2267 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4468` → IC=+0.196 (n=1164)
...
- **PATRÓN** `libro_liquidez` > `2533.0371` → IC=+0.203 (n=894)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2533.0371 (IC base=+0.199)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.181 (n=1071)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.148 (n=713)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0051 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.4177` → IC=+0.140 (n=1876)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.198 (n=714)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `10.174` → IC=+0.146 (n=343)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1731` → IC=+0.154 (n=591)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.1731 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `1.4515` → IC=+0.152 (n=703)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.4515 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `1.8856` → IC=+0.143 (n=1406)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8856 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.131 (n=1415)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `8807.137` → IC=+0.149 (n=966)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 8807.137 (IC base=+0.131)
...
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.190 (n=201)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0104 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.2875` → IC=+0.160 (n=295)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.2875 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.237 (n=154)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.988` → IC=+0.227 (n=148)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.988 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.207` → IC=+0.212 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.207 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.0931` → IC=+0.174 (n=191)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.0931 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `3.4649` → IC=+0.168 (n=441)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 3.4649 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.8314` → IC=+0.157 (n=394)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.8314 (IC base=+0.155)
...
### GBM_LATE_60M
- **FILTRO** `sigma_h` > `0.0084` → IC=-0.244 (n=84)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `hora_utc` > `11.0` → IC=-0.210 (n=105)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 11.0
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=235)

- **FILTRO** `dist_vwap_pct` > `0.1598` → IC=-0.289 (n=17)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.1598
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=181)
...
- **PATRÓN** `ibs_20min` < `0.0884` → IC=+0.265 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0884 (IC base=-0.041)

- **PATRÓN** `dist_vwap_pct` < `0.1598` → IC=+0.123 (n=181)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.1598 (IC base=-0.041)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.804` → IC=+0.129 (n=60)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 3.804 (IC base=-0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.0826` → IC=+0.192 (n=50)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.0826 (IC base=-0.041)

- **PATRÓN** `volumen_spike_ratio` < `2.4111` → IC=+0.176 (n=106)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.4111 (IC base=-0.041)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=129)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.02 (IC base=-0.041)

- **PATRÓN** `libro_liquidez` > `2892.9054` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 2892.9054 (IC base=-0.041)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0401` → IC=+0.227 (n=20)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0401 (IC base=+0.032)

- **PATRÓN** `ibs_20min` < `0.4723` → IC=+0.214 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4723 (IC base=+0.032)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.914` → IC=+0.194 (n=60)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` < 5.914 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.9643` → IC=+0.167 (n=61)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.9643 (IC base=+0.032)

- **PATRÓN** `volumen_pendiente_norm` > `0.0796` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0796 (IC base=+0.032)

- **PATRÓN** `volumen_spike_ratio` < `3.0527` → IC=+0.255 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0527 (IC base=+0.032)

- **PATRÓN** `volumen_spike_ratio` > `1.3279` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.3279 (IC base=+0.032)

- **PATRÓN** `libro_liquidez` > `2590.2271` → IC=+0.139 (n=59)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 2590.2271 (IC base=+0.032)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1021` → IC=+0.210 (n=29)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1021 (IC base=-0.066)

- **PATRÓN** `ibs_20min` < `0.1926` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.1926 (IC base=-0.066)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.069` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 6.069 (IC base=-0.066)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.412` → IC=+0.147 (n=32)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 4.412 (IC base=-0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.4506` → IC=+0.158 (n=36)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.4506 (IC base=-0.066)

- **PATRÓN** `libro_liquidez` > `1059.8551` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 1059.8551 (IC base=-0.066)
...
- **PATRÓN** `libro_liquidez` > `2812.796` → IC=+0.171 (n=141)
  ...
  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2812.796 (IC base=+0.101)

- **PATRÓN** `libro_liquidez` > `2298.3744` → IC=+0.126 (n=460)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 2298.3744 (IC base=+0.092)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=5678)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1101)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.174 (n=2358)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=7092)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.166 (n=2447)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=7358)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.211 (n=379)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=1186)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.42` → IC=-0.199 (n=397)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.074 (n=1239)
...
- **FILTRO** `ibs_20min` > `0.2883` → IC=-0.181 (n=427)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2883
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=1285)
...
- **FILTRO** `py_entrada` > `0.59` → IC=-0.185 (n=427)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=1299)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2015)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1907)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=1913)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.273 (n=5521)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=16974)

- **FILTRO** `ibs_7min` < `0.713` → IC=-0.231 (n=5623)

  - _Acción_: SKIP cuando `ibs_7min` < 0.713
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=16872)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.162 (n=7590)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=14905)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.220 (n=6937)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=21068)

- **FILTRO** `ibs_7min` > `0.2978` → IC=-0.174 (n=7001)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2978
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=21004)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.315 (n=825)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2698)

- **FILTRO** `ibs_7min` < `0.7111` → IC=-0.258 (n=1161)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7111
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2362)

- **FILTRO** `ballena_activa_n` > `10.0` → IC=-0.203 (n=850)

  - _Acción_: SKIP cuando `ballena_activa_n` > 10.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2673)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.146 (n=3290)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=1588)

- **FILTRO** `drift_7min_pct` |x|> `0.1089` → IC=-0.124 (n=1657)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1089
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=3221)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.203 (n=1219)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=3659)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.147 (n=917)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=3050)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.254 (n=984)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=2983)

- **FILTRO** `ibs_7min` < `0.7638` → IC=-0.182 (n=991)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7638
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=2976)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.170 (n=989)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=2978)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.258 (n=917)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=3070)

- **FILTRO** `ibs_7min` > `0.2503` → IC=-0.170 (n=995)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2503
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2992)

- **FILTRO** `ballena_activa_n` > `113.0` → IC=-0.162 (n=1350)

  - _Acción_: SKIP cuando `ballena_activa_n` > 113.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=2637)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.179 (n=817)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=2509)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.321 (n=781)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2545)

- **FILTRO** `ibs_7min` < `0.2097` → IC=-0.268 (n=831)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2097
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=2495)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.215 (n=773)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=2553)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.230 (n=1183)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=3926)

- **FILTRO** `ibs_7min` > `0.2667` → IC=-0.152 (n=1735)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2667
  - _Potencial_: sin este filtro IC_bueno=+0.010 (n=3374)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.132 (n=1173)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2539)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.184 (n=928)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=2784)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.183 (n=920)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=2792)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=920)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2839)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.174 (n=939)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2820)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.176 (n=937)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2822)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.232 (n=1035)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=3133)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.200 (n=1038)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=3130)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.169 (n=1266)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=4022)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.279 (n=893)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2906)

- **FILTRO** `ibs_7min` < `0.7373` → IC=-0.219 (n=949)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7373
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2850)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.209 (n=878)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=2921)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.194 (n=1193)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=3791)
...
- **FILTRO** `ibs_7min` < `1.0` → IC=-0.122 (n=43)
  ...
  - _Acción_: SKIP cuando `ibs_7min` < 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=474)
...
- **PATRÓN** `delta_ratio` |x|> `0.3985` → IC=+0.135 (n=648)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio` |x|> 0.3985 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.131 (n=515)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 6.0 (IC base=+0.123)

- **PATRÓN** `total_vol_5m` < `317935.0` → IC=+0.136 (n=625)

  - _Acción_: Kelly boost +0.68€ cuando `total_vol_5m` < 317935.0 (IC base=+0.123)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=307)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `3593.7807` → IC=+0.146 (n=261)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3593.7807 (IC base=+0.123)
...
- **PATRÓN** `delta_ratio` |x|> `0.4` → IC=+0.157 (n=103)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.79€ cuando `delta_ratio` |x|> 0.4 (IC base=+0.113)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.135 (n=102)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` < 13.0 (IC base=+0.113)

- **PATRÓN** `total_vol_5m` < `353208.2` → IC=+0.141 (n=101)

  - _Acción_: Kelly boost +0.70€ cuando `total_vol_5m` < 353208.2 (IC base=+0.113)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.254 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.185 (n=71)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 37.0 (IC base=+0.113)
...
### STREAK_FADE_15M
- **FILTRO** `hora_utc` < `7.0` → IC=-0.200 (n=28)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
...
- **PATRÓN** `streak_estiramiento` < `0.4382` → IC=+0.167 (n=37)

  - _Acción_: Kelly boost +0.83€ cuando `streak_estiramiento` < 0.4382 (IC base=+0.016)
...
- **PATRÓN** `volumen_racha` < `1182792.2` → IC=+0.140 (n=23)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_racha` < 1182792.2 (IC base=-0.022)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=811)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.5854` → IC=-0.143 (n=113)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.5854
  - _Potencial_: sin este filtro IC_bueno=+0.044 (n=481)
...
- **PATRÓN** `ibs_15` < `0.1034` → IC=+0.170 (n=292)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.85€ cuando `ibs_15` < 0.1034 (IC base=+0.045)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.163 (n=612)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1187` → IC=+0.225 (n=638)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1187 (IC base=-0.051)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1819` → IC=+0.232 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1819 (IC base=-0.051)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.270 (n=957)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.223 (n=265)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.212)

- **PATRÓN** `ibs_15` < `0.3605` → IC=+0.258 (n=395)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `11.781` → IC=+0.221 (n=424)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.781 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `3697.3773` → IC=+0.213 (n=395)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.235 (n=153)
...
- **PATRÓN** `ibs_15` < `0.3273` → IC=+0.285 (n=272)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1034 sube el IC de +0.045 a +0.170 en UPDOWN_GBM#XRP#15min (n=292). Ya aplicado como kelly_boost=+0.85€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0