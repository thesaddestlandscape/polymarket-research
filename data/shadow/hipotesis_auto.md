# Hipótesis automáticas — 2026-08-24 17:12 UTC
_Generado por shadow_postmortem.py sobre 140563 resoluciones (PNL=+9726.74€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `154.83` → IC=-0.257 (n=1965)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.83
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=5898)
...
- **FILTRO** `n_ballenas` < `5.0` → IC=-0.190 (n=140)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=490)
...
- **FILTRO** `restante_s_al_confirmar` < `97.38` → IC=-0.416 (n=224)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 97.38
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=673)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `164.63` → IC=-0.156 (n=524)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.63
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=1573)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `149.25` → IC=-0.273 (n=487)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 149.25
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=1461)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.187 (n=4676)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=2680)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `1793.4988` → IC=+0.173 (n=2218)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 1793.4988 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.188 (n=498)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.135 (n=1066)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `817.0971` → IC=+0.232 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 817.0971 (IC base=+0.214)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=9972)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.225 (n=7019)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.72 (IC base=+0.194)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1929)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.247 (n=1538)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `restante_min` > `4.92` → IC=+0.154 (n=1263)
...
- **PATRÓN** `lag_apertura_s` < `4.58` → IC=+0.152 (n=1189)
...
- **PATRÓN** `restante_min` > `4.9` → IC=+0.167 (n=593)
...
- **PATRÓN** `lag_apertura_s` < `6.26` → IC=+0.166 (n=591)

  - _Acción_: Kelly boost +0.83€ cuando `lag_apertura_s` < 6.26 (IC base=+0.139)
...
- **PATRÓN** `restante_min` < `4.4` → IC=+0.134 (n=790)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.309 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9495` → IC=+0.224 (n=622)
...
- **PATRÓN** `ibs_20min` < `0.2105` → IC=+0.125 (n=1323)
...
- **FILTRO** `sigma_h` > `0.0064` → IC=-0.137 (n=169)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=510)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.132 (n=55)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=624)
...
- **FILTRO** `ibs_20min` > `0.7526` → IC=-0.143 (n=292)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=879)
...
- **PATRÓN** `ibs_20min` < `0.0994` → IC=+0.169 (n=1071)
...
- **PATRÓN** `volumen_regimen` > `0.6318` → IC=+0.203 (n=661)
...
- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.253 (n=310)
...
- **PATRÓN** `drift_60min` |x|≤ `0.399` → IC=+0.270 (n=429)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.399 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.289 (n=221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.2766` → IC=+0.321 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2766 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` < `0.231` → IC=+0.271 (n=443)
...
- **PATRÓN** `volumen_regimen` > `1.2513` → IC=+0.300 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2513 (IC base=+0.259)
...
- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.239 (n=232)
...
- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.198 (n=1778)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0078 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.3515` → IC=+0.197 (n=1777)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.99€ cuando `drift_60min` |x|≤ 0.3515 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.215 (n=813)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.244 (n=1779)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.2043` → IC=+0.179 (n=1450)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.2043 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.766` → IC=+0.203 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.766 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `1.1821` → IC=+0.161 (n=1477)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1821 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `0.8568` → IC=+0.172 (n=984)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8568 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2449` → IC=+0.225 (n=271)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2449 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` < `1.5764` → IC=+0.181 (n=515)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6983` → IC=+0.199 (n=390)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.6983 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `217.0` → IC=+0.165 (n=736)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 217.0 (IC base=+0.183)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.195 (n=323)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0041 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.2131` → IC=+0.183 (n=323)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.2131 (IC base=+0.148)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.165 (n=335)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 7.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` < `0.377` → IC=+0.194 (n=367)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.377 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.1981` → IC=+0.180 (n=370)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1981 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.625` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.625 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` < `0.6392` → IC=+0.236 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6392 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1012` → IC=+0.207 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1012 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `2.5474` → IC=+0.168 (n=260)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.5474 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.145 (n=260)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.148)

- **PATRÓN** `ballena_activa_n` < `248.0` → IC=+0.167 (n=58)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.253 (n=156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0026 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.3515` → IC=+0.169 (n=351)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3515 (IC base=+0.148)
...
- **PATRÓN** `ibs_20min` < `0.4478` → IC=+0.205 (n=351)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4478 (IC base=+0.148)

- **PATRÓN** `dist_vwap_pct` < `0.5272` → IC=+0.167 (n=403)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.5272 (IC base=+0.148)
...
- **PATRÓN** `volumen_regimen` < `1.0395` → IC=+0.153 (n=309)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.0395 (IC base=+0.148)

- **PATRÓN** `volumen_regimen` > `0.6121` → IC=+0.163 (n=351)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6121 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1001` → IC=+0.160 (n=98)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.1001 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` < `1.8878` → IC=+0.217 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8878 (IC base=+0.148)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **FILTRO** `ibs_20min` > `0.4394` → IC=-0.231 (n=117)

  - _Acción_: SKIP cuando `ibs_20min` > 0.4394
  - _Potencial_: sin este filtro IC_bueno=+0.220 (n=352)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.192 (n=170)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 14.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` < `0.4394` → IC=+0.220 (n=352)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4394 (IC base=+0.107)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.542` → IC=+0.149 (n=55)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 7.542 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` > `0.8507` → IC=+0.146 (n=235)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.8507 (IC base=+0.107)
...
- **PATRÓN** `volumen_spike_ratio` > `2.0865` → IC=+0.180 (n=101)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 2.0865 (IC base=+0.107)

- **PATRÓN** `libro_liquidez` > `2669.2549` → IC=+0.167 (n=160)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2669.2549 (IC base=+0.107)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.603` → IC=+0.193 (n=1979)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.603 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` < `0.6208` → IC=+0.175 (n=543)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.6208 (IC base=+0.186)

- **PATRÓN** `volumen_regimen` > `1.1969` → IC=+0.181 (n=543)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` > 1.1969 (IC base=+0.186)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2474` → IC=+0.194 (n=642)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.2474 (IC base=+0.186)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.142 (n=660)
...
- **PATRÓN** `dist_vwap_pct` < `0.7697` → IC=+0.150 (n=304)
...
- **PATRÓN** `volumen_regimen` < `0.5848` → IC=+0.160 (n=98)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.5848 (IC base=+0.133)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0895` → IC=+0.179 (n=207)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.0895 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `1.443` → IC=+0.162 (n=235)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.443 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `4334.9367` → IC=+0.143 (n=194)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.172 (n=187)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 15.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` < `0.5789` → IC=+0.188 (n=405)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.5789 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` < `0.448` → IC=+0.127 (n=360)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.448 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.087` → IC=+0.129 (n=389)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 3.087 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `0.7014` → IC=+0.122 (n=178)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 0.7014 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` > `1.1789` → IC=+0.128 (n=135)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` > 1.1789 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.1471` → IC=+0.136 (n=273)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4231` → IC=+0.204 (n=86)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4231 (IC base=+0.108)

- **PATRÓN** `libro_liquidez` > `2428.959` → IC=+0.156 (n=184)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2428.959 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.0055` → IC=+0.308 (n=186)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0055 (IC base=+0.207)

- **PATRÓN** `drift_60min` |x|≤ `0.4068` → IC=+0.234 (n=490)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4068 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.223 (n=514)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` < `0.49` → IC=+0.276 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.49 (IC base=+0.207)

- **PATRÓN** `dist_vwap_pct` < `1.0977` → IC=+0.216 (n=629)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.975` → IC=+0.213 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.975 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `1.2406` → IC=+0.243 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2406 (IC base=+0.207)
...
- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.154 (n=273)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.150 (n=544)
...
- **PATRÓN** `sigma_h` < `0.0032` → IC=+0.213 (n=186)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0032 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.3238` → IC=+0.160 (n=369)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3238 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.194 (n=142)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 16.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `3.0` → IC=+0.233 (n=144)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 3.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.6004` → IC=+0.166 (n=369)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6004 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.359` → IC=+0.150 (n=381)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.359 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.491` → IC=+0.173 (n=200)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.491 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.3317` → IC=+0.166 (n=420)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.3317 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.0968` → IC=+0.142 (n=367)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0968 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.0763` → IC=+0.157 (n=211)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0763 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.6127` → IC=+0.174 (n=415)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.6127 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4235` → IC=+0.145 (n=415)
...
- **PATRÓN** `libro_liquidez` > `7478.3992` → IC=+0.161 (n=420)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 7478.3992 (IC base=+0.140)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1956` → IC=+0.254 (n=59)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1956 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `9.0` → IC=+0.226 (n=93)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 9.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.6855` → IC=+0.181 (n=133)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.6855 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `0.1577` → IC=+0.233 (n=118)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1577 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.6108` → IC=+0.198 (n=124)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` < 0.6108 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.468` → IC=+0.283 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.468 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `1.2459` → IC=+0.233 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2459 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` < `0.1245` → IC=+0.204 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1245 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `2.4413` → IC=+0.242 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4413 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `1.4925` → IC=+0.186 (n=116)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4925 (IC base=+0.180)

- **PATRÓN** `libro_liquidez` > `9521.2349` → IC=+0.226 (n=60)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9521.2349 (IC base=+0.180)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.139 (n=81)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 8.0 (IC base=+0.056)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.152 (n=598)
...
- **FILTRO** `ibs_20min` > `0.279` → IC=-0.216 (n=603)

  - _Acción_: SKIP cuando `ibs_20min` > 0.279
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1811)
...
- **FILTRO** `hora_utc` > `10.0` → IC=-0.122 (n=207)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 10.0
...
- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.164 (n=108)
...
- **FILTRO** `drift_20min_pct` |x|> `0.3568` → IC=-0.188 (n=94)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.3568
...
- **FILTRO** `ibs_20min` > `0.2759` → IC=-0.229 (n=94)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=285)

- **FILTRO** `ballena_activa_n` > `1.0` → IC=-0.153 (n=237)

  - _Acción_: SKIP cuando `ballena_activa_n` > 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=142)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.173 (n=105)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1750)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=4316)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.280 (n=1443)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=4623)

- **FILTRO** `ibs_7min` < `0.7411` → IC=-0.229 (n=1516)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7411
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=4550)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.174 (n=2044)
...
- **FILTRO** `py_entrada` > `0.68` → IC=-0.219 (n=1846)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=5587)

- **FILTRO** `ibs_7min` > `0.7125` → IC=-0.168 (n=1858)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7125
  - _Potencial_: sin este filtro IC_bueno=-0.033 (n=5575)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.319 (n=202)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=638)

- **FILTRO** `ibs_7min` < `0.985` → IC=-0.183 (n=554)

  - _Acción_: SKIP cuando `ibs_7min` < 0.985
  - _Potencial_: sin este filtro IC_bueno=+0.090 (n=286)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.239 (n=209)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=631)

- **FILTRO** `hora_utc` > `17.0` → IC=-0.134 (n=263)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 17.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=960)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.241 (n=303)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=920)

- **FILTRO** `drift_7min_pct` |x|> `0.145` → IC=-0.154 (n=414)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.145
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=809)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.242 (n=297)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=955)

- **FILTRO** `ballena_activa_n` > `142.0` → IC=-0.159 (n=312)
...
- **FILTRO** `py_entrada` > `0.55` → IC=-0.199 (n=310)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=979)
...
- **FILTRO** `ibs_7min` > `0.8261` → IC=-0.179 (n=322)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=969)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.185 (n=211)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=814)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.269 (n=245)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=780)

- **FILTRO** `ibs_7min` < `0.7802` → IC=-0.202 (n=256)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7802
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=769)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.216 (n=252)
...
- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.210 (n=257)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=778)
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.278 (n=255)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=999)

- **FILTRO** `ibs_7min` > `0.8053` → IC=-0.141 (n=313)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8053
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=941)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1059)
...
- **FILTRO** `sigma_h` > `0.0093` → IC=-0.148 (n=771)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0093
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1499)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.699` → IC=-0.197 (n=298)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.699
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=1972)
...
| ✅ BALLENAS_TARDIAS | 5953 | -0.098 | -704.30€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 630 | -0.082 | -107.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5323 | -0.100 | -596.79€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 883 | -0.005 | -97.89€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 883 | -0.005 | -97.89€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 630 | -0.082 | -107.51€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 630 | -0.082 | -107.51€ | 2 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1948 | -0.068 | -67.13€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1948 | -0.068 | -67.13€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1408 | -0.174 | -238.31€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1408 | -0.174 | -238.31€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 26705 | +0.113 | -1836.03€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5164 | +0.187 | -181.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 18423 | +0.091 | -1584.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3012 | +0.124 | -21.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3096 | +0.060 | -554.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3073 | +0.062 | -550.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5607 | +0.134 | -126.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1446 | +0.194 | -89.58€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3067 | +0.109 | -76.51€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1052 | +0.134 | +61.56€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3100 | +0.074 | -438.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3081 | +0.074 | -434.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6024 | +0.129 | -65.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 