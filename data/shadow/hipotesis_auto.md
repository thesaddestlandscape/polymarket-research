# Hipótesis automáticas — 2026-06-29 19:53 UTC
_Generado por shadow_postmortem.py sobre 1308 resoluciones (PNL=-34.73€)_

## Patrones causales activos

### UPDOWN_GBM#BTC#15min
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0921` → IC=+0.167 (n=19)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.83€ cuando `pct_spot_vs_ref` |x|≤ 0.0921 (IC base=+0.059)

- **PATRÓN** `sigma_h` < `0.0126` → IC=+0.125 (n=38)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.62€ cuando `sigma_h` < 0.0126 (IC base=+0.059)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` < `0.0119` → IC=+0.145 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0119 (IC base=+0.075)

- **PATRÓN** `drift_60min` |x|≤ `0.2409` → IC=+0.130 (n=25)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.2409 (IC base=+0.075)
...
| ✅ UPDOWN_GBM | 339 | +0.016 | +6.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 197 | +0.063 | +12.15€ | 0 | 0 |
| 🚫 UPDOWN_GBM#240min | 12 | -0.171 | -4.82€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 56 | -0.155 | -16.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#60min | 61 | +0.103 | +9.76€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 104 | +0.019 | -0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 57 | +0.059 | +1.10€ | 0 | 2 |
| ✅ UPDOWN_GBM#BTC#240min | 5 | -0.089 | -2.96€ | 0 | 0 |
| 🚫 UPDOWN_GBM#BTC#5min | 16 | -0.133 | -6.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 22 | +0.125 | +3.00€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 131 | +0.056 | +7.58€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 85 | +0.075 | +4.39€ | 0 | 2 |
| ✅ UPDOWN_GBM#ETH#240min | 5 | -0.018 | -0.44€ | 0 | 0 |
| 🚫 UPDOWN_GBM#ETH#5min | 12 | -0.086 | -3.67€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#60min | 25 | +0.130 | +5.43€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL | 73 | -0.033 | +1.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 37 | +0.038 | +4.47€ | 0 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 17 | -0.112 | -4.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 14 | +0.000 | +1.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 26 | -0.036 | -0.47€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 17 | +0.022 | +1.39€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.108) — sin ventaja clara. oversold(IBS<0.3): IC=+0.044 n=14 | neutral: IC=+0.152 n=13 | overbought(IBS>0.7): IC=+0.065 n=21
  - _Datos_: n=50 IC=+0.115 PNL=+5.57€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 50 ops, 9 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=-0.051 n=87/40 PNL=+0.29€ | H=15h UTC: IC=-0.011 n=92/40 PNL=-5.07€ | H=17h UTC: IC=+0.271 n=33/40 PNL=+13.52€ | H=19h UTC: IC=+0.037 n=39/40 PNL=+1.47€

**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40 en cualquier subtipo 60min
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=25/40 IC=+0.130 PNL=+5.43€ | BTC#60min: n=22/40 IC=+0.125 PNL=+3.00€ | SOL#60min: n=14/40 IC=+0.000 PNL=+1.32€

**⏳ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n=37/40 IC=+0.038 PNL=+4.47€ (ETA: 3 ops)
  - _Datos_: n=37 IC=+0.038 PNL=+4.47€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=240 IC=+0.041 PNL=+12.34€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=240 IC=+0.041 PNL=+12.34€
...
**🟡 H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.104 > 0.08 con n=46 PNL=+8.79€
  - _Datos_: n=46 IC=+0.104 PNL=+8.79€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=146 IC=+0.041 PNL=-1.02€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=146 IC=+0.041 PNL=-1.02€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=57 IC=+0.059 PNL=+1.10€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=57 IC=+0.059 PNL=+1.10€

**⏳ H-CUSTOM-DRIFT15-ZONA-MUERTA** — GBM#15min drift_15min ∈ [-0.3,+0.3] — zona muerta de señal
  - _Hipótesis_: Análisis n=127 GBM#15min: cuando drift_15min está entre -0.3 y +0.3 (mercado sin dirección clara) el IC es negativo (-0.043). Cuando drift>0.3 IC=+0.100 (n=28). Cuando drift<-1 IC=+0.048 (reversión). La señal requiere mercado con dirección clara.
  - _Umbral_: 50
  - _Acción_: Filtrar señales GBM#15min cuando drift_15min ∈ [-0.3, +0.3] — validar con n≥50 antes de implementar
  - _Estado_: 25/50 ops en el filtro definido (IC actual=+0.018 PNL=-1.60€)
  - _Datos_: n=25 IC=+0.018 PNL=-1.60€

**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  - _Hipótesis_: Cuando drift_15min > 0.3%/h el GBM captura bien la dirección: IC=+0.100 n=28 en todos GBM#15min; IC=+0.152 n=13 solo BTC. El mercado tiene dirección clara y el GBM la sigue. Hipótesis: este rango es donde la señal es real.
  - _Umbral_: n≥40 y IC>+0.08
  - _Acción_: Si se confirma IC>0.10 con n≥40 → boost ×1.2 en GBM#15min cuando drift_15min>0.3
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.149 > 0.08 con n=72 PNL=+11.43€
  - _Datos_: n=72 IC=+0.149 PNL=+11.43€
...
**⏳ H-CUSTOM-ETH15-REVERSION** — ETH#15min con drift_15min < -1 — ¿mean reversion?
  ...
  - _Estado_: 17/20 ops en el filtro definido (IC actual=+0.112 PNL=+2.52€)
  - _Datos_: n=17 IC=+0.112 PNL=+2.52€
