# Hipótesis automáticas — 2026-07-28 05:41 UTC
_Generado por shadow_postmortem.py sobre 39630 resoluciones (PNL=+8040.17€)_
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.897` → IC=+0.203 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.897 (IC base=+0.112)
...
- **PATRÓN** `sigma_h` < `0.01` → IC=+0.160 (n=254)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` < 0.01 (IC base=+0.140)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.472` → IC=+0.250 (n=94)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.472 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.185 (n=1209)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.4721` → IC=+0.159 (n=326)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.4721 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.168` → IC=+0.230 (n=283)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.168 (IC base=+0.094)
...
- **PATRÓN** `sigma_h` < `0.0198` → IC=+0.177 (n=466)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0198 (IC base=+0.170)

- **PATRÓN** `sigma_h` > `0.0137` → IC=+0.170 (n=353)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.0137 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.175 (n=533)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 6.0 (IC base=+0.170)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.171 (n=554)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 18.0 (IC base=+0.170)

- **PATRÓN** `dist_vwap_pct` > `0.4714` → IC=+0.236 (n=104)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4714 (IC base=+0.170)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.6075` → IC=+0.175 (n=639)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` > 0.6075 (IC base=+0.056)

- **PATRÓN** `dist_vwap_pct` > `0.1666` → IC=+0.164 (n=233)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1666 (IC base=+0.056)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.106` → IC=+0.152 (n=231)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6075 sube el IC de +0.056 a +0.175 en UPDOWN_GBM#15min (n=639). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ GBM_LATE_15M | 8512 | +0.093 | +2527.63€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 8512 | +0.093 | +2527.63€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB | 29 | +0.145 | +3.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#BNB#15min | 29 | +0.145 | +3.70€ | 0 | 0 |
...
| ✅ GBM_LATE_15M#XRP | 2283 | +0.139 | +1090.37€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 2283 | +0.139 | +1090.37€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 5754 | +0.114 | +2625.91€ | 0 | 8 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 5754 | +0.114 | +2625.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB | 23 | +0.180 | +11.73€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BNB#15min | 23 | +0.180 | +11.73€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 287 | +0.061 | +97.70€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 287 | +0.061 | +97.70€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 5741 | +0.064 | +1474.27€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#15min | 5741 | +0.064 | +1474.27€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB | 28 | +0.200 | +9.66€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BNB#15min | 28 | +0.200 | +9.66€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO#XRP | 1592 | +0.161 | +957.16€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1592 | +0.161 | +957.16€ | 0 | 12 |
...
| ✅ UPDOWN_GBM | 2943 | +0.036 | +270.41€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 2679 | +0.052 | +309.43€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 2223 | +0.150 | +971.46€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 2223 | +0.150 | +971.46€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.163: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.073 n=1689 | neutral: IC=+0.023 n=1342 | overbought(IBS>0.7): IC=+0.186 n=1651
  - _Datos_: n=4993 IC=+0.104 PNL=+1307.30€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=05h: IC=+0.161 n=107 PNL=+49.27€ → BOOST | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=14h: IC=+0.140 n=123 PNL=+41.77€ → BOOST | H=22h: IC=+0.164 n=135 PNL=+37.90€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.109 n=23518 | tras_1loss IC=+0.077 n=15897 | tras_2loss IC=+0.052 n=6681/40 | gap=+0.057 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-MADRUGADA** — GBM BUY_YES en madrugada europea (05-07h UTC) — señal alcista
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.096 > 0.08 con n=139 PNL=+46.98€
  - _Datos_: n=139 IC=+0.096 PNL=+46.98€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=2806 IC=+0.040 PNL=+284.20€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2806 IC=+0.040 PNL=+284.20€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=1128 IC=+0.056 PNL=+153.88€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1128 IC=+0.056 PNL=+153.88€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.091 > 0.08 con n=1414 PNL=+244.64€
  - _Datos_: n=1414 IC=+0.091 PNL=+244.64€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=1482 IC=+0.040 PNL=+120.32€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1482 IC=+0.040 PNL=+120.32€
...
**〰️ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: n=3348 IC=+0.055 PNL=+384.73€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=3348 IC=+0.055 PNL=+384.73€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1278 IC=+0.031 PNL=+123.32€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1278 IC=+0.031 PNL=+123.32€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.162 > 0.1 con n=1025 PNL=+348.47€
  - _Datos_: n=1025 IC=+0.162 PNL=+348.47€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.121 > 0.08 con n=724 PNL=+200.12€
  - _Datos_: n=724 IC=+0.121 PNL=+200.12€
...
**🟡 H-CUSTOM-GBM-04H-ASIA** — UPDOWN_GBM 04h-05h UTC — media sesión asiática, ¿mejor franja nocturna?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.084 > 0.08 con n=229 PNL=+43.56€
  - _Datos_: n=229 IC=+0.084 PNL=+43.56€
...
**🟡 H-CUSTOM-LATE-04H-ASIA** — GBM_LATE_15M 04h-05h UTC — media sesión asiática (gemela de GBM-04H-ASIA)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.099 > 0.08 con n=711 PNL=+215.60€
  - _Datos_: n=711 IC=+0.099 PNL=+215.60€
