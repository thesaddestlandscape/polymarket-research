# Hipótesis automáticas — 2026-08-28 01:30 UTC
_Generado por shadow_postmortem.py sobre 181569 resoluciones (PNL=+13154.57€)_
...
- **FILTRO** `py_entrada` < `0.705` → IC=-0.167 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.277 (n=245)

- **PATRÓN** `py_entrada` > `0.725` → IC=+0.289 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.725 (IC base=+0.160)

- **PATRÓN** `n_ballena_banda` > `17.0` → IC=+0.171 (n=253)

  - _Acción_: Kelly boost +0.85€ cuando `n_ballena_banda` > 17.0 (IC base=+0.160)

- **PATRÓN** `n_total_lado` > `59.0` → IC=+0.240 (n=167)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 59.0 (IC base=+0.160)

- **PATRÓN** `banda_hit_calibrado` > `0.8219` → IC=+0.280 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8219 (IC base=+0.160)

- **PATRÓN** `banda_z` > `9.958` → IC=+0.259 (n=114)
...
- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.304 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 288.0 (IC base=+0.160)
...
- **PATRÓN** `n_ballena_banda` > `19.0` → IC=+0.212 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `n_ballena_banda` > 19.0 (IC base=+0.200)

- **PATRÓN** `n_total_lado` > `52.0` → IC=+0.248 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 52.0 (IC base=+0.200)

- **PATRÓN** `banda_hit_calibrado` > `0.8266` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8266 (IC base=+0.200)

- **PATRÓN** `banda_z` > `12.042` → IC=+0.307 (n=55)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 12.042 (IC base=+0.200)
...
- **PATRÓN** `libro_liquidez` > `3827.6428` → IC=+0.266 (n=75)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3827.6428 (IC base=+0.200)

- **PATRÓN** `ballena_activa_n` < `290.0` → IC=+0.312 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 290.0 (IC base=+0.200)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.46` → IC=-0.286 (n=2532)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.46
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=7596)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.155 (n=4418)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 7.0 (IC base=+0.141)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.258 (n=3499)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.187 (n=3023)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1890.0155` → IC=+0.179 (n=2532)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 1890.0155 (IC base=+0.141)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.208 (n=816)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `13030.2014` → IC=+0.213 (n=214)
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.188 (n=664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` < 17.0 (IC base=+0.182)

- **PATRÓN** `py_entrada` < `0.365` → IC=+0.256 (n=587)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.365 (IC base=+0.182)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.182 (n=853)

  - _Acción_: Kelly boost +0.91€ cuando `libro_spread` < 0.01 (IC base=+0.182)

- **PATRÓN** `libro_liquidez` > `12580.6804` → IC=+0.216 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12580.6804 (IC base=+0.182)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.136 (n=471)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.128 (n=1061)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.280 (n=438)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.275)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.278 (n=488)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2923.071` → IC=+0.286 (n=311)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2923.071 (IC base=+0.275)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.196 (n=652)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 12.0 (IC base=+0.193)

- **PATRÓN** `py_entrada` > `0.845` → IC=+0.450 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.845 (IC base=+0.193)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.230 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.222)

- **PATRÓN** `libro_liquidez` > `1890.0155` → IC=+0.237 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1890.0155 (IC base=+0.222)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.192 (n=3959)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 15.0 (IC base=+0.187)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.200 (n=2235)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.179 (n=1016)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 15.0 (IC base=+0.166)

- **PATRÓN** `py_entrada` < `0.72` → IC=+0.175 (n=1016)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.169 (n=999)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` < 15.0 (IC base=+0.164)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.171 (n=429)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.230 (n=901)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.230)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.321 (n=372)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.184 (n=977)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 15.0 (IC base=+0.183)

- **PATRÓN** `py_entrada` < `0.7` → IC=+0.201 (n=576)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.192 (n=9073)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 12.0 (IC base=+0.191)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.220 (n=9248)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.130 (n=1670)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 12.0 (IC base=+0.127)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.156 (n=1572)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.285 (n=1154)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.194 (n=743)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 18.0 (IC base=+0.166)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.167 (n=1551)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 12.0 (IC base=+0.166)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.206 (n=1049)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.231 (n=982)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.229)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.290 (n=716)
...
- **PATRÓN** `py_entrada` > `0.73` → IC=+0.243 (n=1257)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.306 (n=611)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `3871.3378` → IC=+0.307 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3871.3378 (IC base=+0.302)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.289 (n=230)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `5623.4735` → IC=+0.326 (n=84)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5623.4735 (IC base=+0.287)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.310 (n=283)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_liquidez` > `2037.8724` → IC=+0.324 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2037.8724 (IC base=+0.300)
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.443 (n=121)
...
- **PATRÓN** `libro_liquidez` > `2089.6231` → IC=+0.449 (n=77)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2089.6231 (IC base=+0.423)
...
- **PATRÓN** `libro_liquidez` > `1694.3123` → IC=+0.330 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1694.3123 (IC base=+0.289)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.9504` → IC=+0.211 (n=791)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9504 (IC base=+0.067)

- **PATRÓN** `dist_vwap_pct` > `0.186` → IC=+0.229 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.186 (IC base=+0.067)

- **PATRÓN** `dist_vwap_pct` < `0.7362` → IC=+0.211 (n=503)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7362 (IC base=+0.067)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.229` → IC=+0.160 (n=957)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 5.229 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` < `0.6304` → IC=+0.212 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6304 (IC base=+0.067)

- **PATRÓN** `volumen_regimen` > `1.0681` → IC=+0.245 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0681 (IC base=+0.067)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4442` → IC=+0.149 (n=1138)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4442 (IC base=+0.067)

- **PATRÓN** `ibs_20min` < `0.2157` → IC=+0.131 (n=1603)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.2157 (IC base=+0.029)

- **PATRÓN** `dist_vwap_pct` < `0.3005` → IC=+0.142 (n=808)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.3005 (IC base=+0.029)

- **PATRÓN** `volumen_regimen` < `0.6267` → IC=+0.158 (n=261)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6267 (IC base=+0.029)

- **PATRÓN** `volumen_regimen` > `1.0473` → IC=+0.141 (n=355)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0473 (IC base=+0.029)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9478` → IC=+0.185 (n=601)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 1.9478 (IC base=+0.029)

- **PATRÓN** `volumen_spike_ratio` > `2.9057` → IC=+0.232 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9057 (IC base=+0.029)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.220 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 87.0 (IC base=+0.029)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.167 (n=241)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0071 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.167 (n=253)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` < 8.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.283 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.862` → IC=+0.324 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.862 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` > `0.1422` → IC=+0.148 (n=126)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.1422 (IC base=+0.124)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.152 (n=334)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.04 (IC base=+0.124)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.279 (n=197)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3166` → IC=+0.281 (n=295)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3166 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.261 (n=282)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.259)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.279 (n=260)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.4341` → IC=+0.297 (n=259)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4341 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `1.939` → IC=+0.297 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 1.939 (IC base=+0.259)

- **PATRÓN** `volumen_pendiente_norm` < `0.062` → IC=+0.263 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.062 (IC base=+0.259)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8169` → IC=+0.260 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8169 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `1.4634` → IC=+0.264 (n=189)
...
- **PATRÓN** `libro_liquidez` > `1968.0502` → IC=+0.300 (n=98)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1968.0502 (IC base=+0.259)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.252 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 57.0 (IC base=+0.259)

### GBM_LATE_15M#BTC#15min
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.241 (n=133)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.207)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.228 (n=134)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0071 (IC base=+0.207)

- **PATRÓN** `drift_60min` |x|≤ `0.3341` → IC=+0.216 (n=350)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3341 (IC base=+0.207)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.234 (n=404)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.207)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.207 (n=377)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 16.0 (IC base=+0.207)

- **PATRÓN** `ibs_20min` > `0.4244` → IC=+0.223 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4244 (IC base=+0.207)

- **PATRÓN** `dist_vwap_pct` > `0.212` → IC=+0.232 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.212 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.332` → IC=+0.223 (n=207)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.332 (IC base=+0.207)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.05` → IC=+0.208 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.05 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.215 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.207)

- **PATRÓN** `volumen_regimen` > `1.0855` → IC=+0.232 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0855 (IC base=+0.207)

- **PATRÓN** `volumen_pendiente_norm` < `0.0762` → IC=+0.206 (n=355)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4485` → IC=+0.261 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4485 (IC base=+0.207)

- **PATRÓN** `libro_liquidez` > `11354.7125` → IC=+0.221 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11354.7125 (IC base=+0.207)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.171 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0022 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.0744` → IC=+0.165 (n=153)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.0744 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.148 (n=430)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 7.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.146 (n=484)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 18.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.4406` → IC=+0.171 (n=402)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.4406 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.1371` → IC=+0.162 (n=380)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.1371 (IC base=+0.138)
...
- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.184 (n=153)
  ...
  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6279 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.0216` → IC=+0.141 (n=207)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.0216 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.0934` → IC=+0.205 (n=137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0934 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `1.7548` → IC=+0.176 (n=236)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.7548 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4105` → IC=+0.156 (n=353)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4105 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.138 (n=589)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `13590.0128` → IC=+0.170 (n=207)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 13590.0128 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `218.0` → IC=+0.178 (n=88)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 218.0 (IC base=+0.138)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.218 (n=168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.279 (n=197)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1436` → IC=+0.131 (n=369)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1436 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.4138` → IC=+0.150 (n=58)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.4138 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.7287` → IC=+0.132 (n=395)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.7287 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.172 (n=425)
...
- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.297 (n=156)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.259)

- **PATRÓN** `drift_60min` |x|≤ `0.1299` → IC=+0.291 (n=156)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.283 (n=136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.5322` → IC=+0.297 (n=353)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.578` → IC=+0.266 (n=386)
...
- **PATRÓN** `volumen_spike_ratio` < `3.4834` → IC=+0.227 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.4834 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `2.6513` → IC=+0.244 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6513 (IC base=+0.259)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.289 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.259)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.235 (n=153)
...
- **FILTRO** `ibs_20min` > `0.8686` → IC=-0.157 (n=208)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=629)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.172 (n=65)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=772)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.0689` → IC=+0.260 (n=23)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3816` → IC=+0.190 (n=27)
  ...
  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.3816 (IC base=-0.050)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 135.0 (IC base=-0.050)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `ibs_20min` > `0.5` → IC=-0.138 (n=645)

  - _Acción_: SKIP cuando `ibs_20min` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=693)

- **FILTRO** `sigma_ewma_delta_pct` > `4.972` → IC=-0.155 (n=282)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.972
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1056)
...
- **FILTRO** `ibs_20min` < `0.4355` → IC=-0.171 (n=348)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4355
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=348)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.171 (n=141)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=555)

- **FILTRO** `ibs_20min` > `0.7857` → IC=-0.170 (n=301)
...
- **FILTRO** `sigma_ewma_delta_pct` > `6.731` → IC=-0.160 (n=195)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1012)

- **PATRÓN** `dist_vwap_pct` < `0.2396` → IC=+0.175 (n=38)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2396 (IC base=-0.096)

- **PATRÓN** `volumen_regimen` > `0.6932` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 0.6932 (IC base=-0.096)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.139 (n=1348)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0077 (IC base=+0.056)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.247 (n=992)
...
- **PATRÓN** `volumen_regimen` > `1.1726` → IC=+0.198 (n=339)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_regimen` > 1.1726 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` < `0.1149` → IC=+0.175 (n=1340)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` < 0.1149 (IC base=+0.056)

- **PATRÓN** `volumen_pendiente_norm` > `0.249` → IC=+0.209 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.249 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` < `1.4785` → IC=+0.203 (n=460)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4785 (IC base=+0.056)

- **PATRÓN** `volumen_spike_ratio` > `2.8221` → IC=+0.173 (n=460)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.8221 (IC base=+0.056)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.277 (n=828)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.056)

- **PATRÓN** `ibs_20min` < `0.0952` → IC=+0.184 (n=1243)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.0952 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` > `0.7309` → IC=+0.219 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7309 (IC base=+0.039)

- **PATRÓN** `dist_vwap_pct` < `0.2116` → IC=+0.205 (n=750)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2116 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `1.2349` → IC=+0.233 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2349 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.2543` → IC=+0.362 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2543 (IC base=+0.039)

- **PATRÓN** `volumen_spike_ratio` > `1.6328` → IC=+0.260 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6328 (IC base=+0.039)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.263 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.039)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2606` → IC=-0.157 (n=196)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2606
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=400)

- **FILTRO** `sigma_ewma_delta_pct` > `3.602` → IC=-0.186 (n=183)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.602
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=614)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.222` → IC=+0.170 (n=113)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 5.222 (IC base=-0.003)
...
- **PATRÓN** `volumen_spike_ratio` > `2.317` → IC=+0.244 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.317 (IC base=-0.003)

- **PATRÓN** `ballena_activa_n` < `45.0` → IC=+0.460 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 45.0 (IC base=-0.003)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8857` → IC=-0.149 (n=280)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8857
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=846)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1014` → IC=+0.218 (n=207)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1014 (IC base=+0.191)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.196 (n=159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 18.0 (IC base=+0.191)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.259 (n=164)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.191)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=227)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1444` → IC=+0.200 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1444 (IC base=+0.191)

- **PATRÓN** `volumen_pendiente_norm` > `0.416` → IC=+0.191 (n=53)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.416 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` < `1.981` → IC=+0.211 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.981 (IC base=+0.191)

- **PATRÓN** `volumen_spike_ratio` > `3.4412` → IC=+0.185 (n=176)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 3.4412 (IC base=+0.191)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.220 (n=423)
...
- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.353 (n=229)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0082 (IC base=+0.339)

- **PATRÓN** `drift_60min` |x|≤ `0.2365` → IC=+0.352 (n=174)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2365 (IC base=+0.339)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.381 (n=175)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.339)

- **PATRÓN** `ibs_20min` < `0.3443` → IC=+0.355 (n=260)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3443 (IC base=+0.339)

- **PATRÓN** `ibs_20min` > `0.1389` → IC=+0.340 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1389 (IC base=+0.339)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.502` → IC=+0.351 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.502 (IC base=+0.339)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7462` → IC=+0.345 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7462 (IC base=+0.339)

- **PATRÓN** `volumen_spike_ratio` > `1.9885` → IC=+0.336 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9885 (IC base=+0.339)

- **PATRÓN** `libro_liquidez` > `1881.2284` → IC=+0.376 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1881.2284 (IC base=+0.339)

- **PATRÓN** `ballena_activa_n` < `31.0` → IC=+0.321 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 31.0 (IC base=+0.339)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.171 (n=68)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=929)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.228 (n=215)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.222)

- **PATRÓN** `ibs_20min` > `0.8983` → IC=+0.301 (n=385)
...
- **PATRÓN** `volumen_regimen` > `0.8368` → IC=+0.252 (n=385)
...
- **PATRÓN** `libro_liquidez` > `2451.004` → IC=+0.231 (n=578)
...
- **PATRÓN** `drift_60min` |x|≤ `0.284` → IC=+0.274 (n=397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.284 (IC base=+0.268)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.278 (n=557)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.268)

- **PATRÓN** `ibs_20min` < `0.3675` → IC=+0.308 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3675 (IC base=+0.268)

- **PATRÓN** `dist_vwap_pct` < `0.9161` → IC=+0.274 (n=670)
...
- **PATRÓN** `volumen_regimen` > `1.2602` → IC=+0.305 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2602 (IC base=+0.268)

- **PATRÓN** `volumen_pendiente_norm` > `0.2431` → IC=+0.375 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2431 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` > `2.1674` → IC=+0.292 (n=200)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1674 (IC base=+0.268)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.196 (n=862)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0101 (IC base=+0.157)

- **PATRÓN** `drift_60min` |x|≤ `0.3368` → IC=+0.158 (n=2275)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.3368 (IC base=+0.157)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.179 (n=961)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.157)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.160 (n=958)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 6.0 (IC base=+0.157)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.283 (n=1273)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.157)

- **PATRÓN** `dist_vwap_pct` > `0.8082` → IC=+0.254 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8082 (IC base=+0.157)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.352` → IC=+0.244 (n=1077)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.352 (IC base=+0.157)

- **PATRÓN** `volumen_regimen` > `0.6881` → IC=+0.174 (n=1601)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.6881 (IC base=+0.157)

- **PATRÓN** `volumen_pendiente_norm` > `0.2372` → IC=+0.191 (n=486)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2372 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` < `2.2796` → IC=+0.156 (n=2054)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.2796 (IC base=+0.157)

- **PATRÓN** `volumen_spike_ratio` > `1.8492` → IC=+0.152 (n=1556)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.8492 (IC base=+0.157)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=2091)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.157)

- **PATRÓN** `libro_liquidez` > `3198.3109` → IC=+0.181 (n=1172)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 3198.3109 (IC base=+0.157)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.181 (n=1314)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 116.0 (IC base=+0.157)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.194 (n=2019)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0076 (IC base=+0.183)

- **PATRÓN** `drift_60min` |x|≤ `0.4139` → IC=+0.194 (n=2293)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.4139 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.213 (n=876)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.183)

- **PATRÓN** `ibs_20min` < `0.4099` → IC=+0.237 (n=2293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4099 (IC base=+0.183)

- **PATRÓN** `dist_vwap_pct` < `0.2137` → IC=+0.177 (n=1845)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2137 (IC base=+0.183)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.861` → IC=+0.215 (n=440)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.861 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` < `1.1685` → IC=+0.164 (n=1835)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1685 (IC base=+0.183)

- **PATRÓN** `volumen_regimen` > `0.8526` → IC=+0.171 (n=1223)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8526 (IC base=+0.183)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.250 (n=270)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` < `1.8842` → IC=+0.173 (n=1122)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.8842 (IC base=+0.183)

- **PATRÓN** `volumen_spike_ratio` > `2.6536` → IC=+0.207 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6536 (IC base=+0.183)

- **PATRÓN** `ballena_activa_n` < `129.0` → IC=+0.189 (n=1103)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 129.0 (IC base=+0.183)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.203 (n=193)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.148)

- **PATRÓN** `drift_60min` |x|≤ `0.269` → IC=+0.154 (n=423)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.269 (IC base=+0.148)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.213 (n=155)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.092` → IC=+0.332 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.092 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.1454` → IC=+0.186 (n=100)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1454 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.4363` → IC=+0.135 (n=343)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.4363 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.156 (n=190)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.03 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.259 (n=185)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.2454` → IC=+0.302 (n=185)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2454 (IC base=+0.255)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.280 (n=193)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.255)

- **PATRÓN** `ibs_20min` < `0.3367` → IC=+0.291 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3367 (IC base=+0.255)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.358` → IC=+0.281 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.358 (IC base=+0.255)

- **PATRÓN** `volumen_pendiente_norm` < `0.081` → IC=+0.243 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.081 (IC base=+0.255)

- **PATRÓN** `volumen_spike_ratio` < `1.8747` → IC=+0.290 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8747 (IC base=+0.255)
...
- **PATRÓN** `libro_liquidez` > `1965.0404` → IC=+0.347 (n=70)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1965.0404 (IC base=+0.255)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.252 (n=103)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.198 (n=124)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0072 (IC base=+0.176)

- **PATRÓN** `drift_60min` |x|≤ `0.084` → IC=+0.177 (n=125)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.084 (IC base=+0.176)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.201 (n=373)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.176)

- **PATRÓN** `ibs_20min` > `0.9998` → IC=+0.277 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9998 (IC base=+0.176)

- **PATRÓN** `dist_vwap_pct` > `0.2093` → IC=+0.234 (n=276)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.439` → IC=+0.177 (n=342)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` < 7.439 (IC base=+0.176)

- **PATRÓN** `volumen_regimen` < `1.2907` → IC=+0.183 (n=370)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 1.2907 (IC base=+0.176)

- **PATRÓN** `volumen_regimen` > `0.8896` → IC=+0.194 (n=246)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` > 0.8896 (IC base=+0.176)
...
- **PATRÓN** `libro_liquidez` > `12309.2523` → IC=+0.190 (n=246)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 12309.2523 (IC base=+0.176)

- **PATRÓN** `sigma_h` < `0.0023` → IC=+0.201 (n=155)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0023 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.2231` → IC=+0.177 (n=404)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.2231 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.168 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` < `0.4241` → IC=+0.188 (n=460)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.4241 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.7019` → IC=+0.145 (n=74)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7019 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.151` → IC=+0.170 (n=447)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.151 (IC base=+0.145)
...
- **PATRÓN** `volumen_regimen` < `0.6399` → IC=+0.224 (n=154)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6399 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0945` → IC=+0.208 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0945 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.5404` → IC=+0.158 (n=352)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.5404 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4105` → IC=+0.140 (n=351)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.4105 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `14483.9491` → IC=+0.158 (n=153)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 14483.9491 (IC base=+0.145)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1487` → IC=+0.172 (n=248)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.1487 (IC base=+0.161)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.904` → IC=+0.298 (n=97)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.904 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` < `0.2295` → IC=+0.156 (n=309)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` < 0.2295 (IC base=+0.161)
...
- **PATRÓN** `volumen_spike_ratio` > `3.6311` → IC=+0.150 (n=141)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 3.6311 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.189 (n=323)
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.289 (n=249)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.275)

- **PATRÓN** `drift_60min` |x|≤ `0.4646` → IC=+0.301 (n=249)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4646 (IC base=+0.275)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.305 (n=167)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.275)

- **PATRÓN** `ibs_20min` < `0.3077` → IC=+0.324 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3077 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.853` → IC=+0.329 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.853 (IC base=+0.275)

- **PATRÓN** `volumen_pendiente_norm` > `0.3746` → IC=+0.433 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3746 (IC base=+0.275)

- **PATRÓN** `volumen_spike_ratio` > `1.9918` → IC=+0.272 (n=156)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9918 (IC base=+0.275)

- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.242 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 62.0 (IC base=+0.275)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.210 (n=370)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0092 (IC base=+0.173)

- **PATRÓN** `drift_60min` |x|≤ `0.5012` → IC=+0.188 (n=370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.5012 (IC base=+0.173)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.188 (n=383)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 6.0 (IC base=+0.173)

- **PATRÓN** `ibs_20min` > `0.4362` → IC=+0.229 (n=370)
...
- **PATRÓN** `volumen_regimen` > `1.2177` → IC=+0.214 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2177 (IC base=+0.173)

- **PATRÓN** `volumen_pendiente_norm` > `0.1005` → IC=+0.223 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1005 (IC base=+0.173)

- **PATRÓN** `volumen_spike_ratio` < `1.4299` → IC=+0.180 (n=120)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 1.4299 (IC base=+0.173)

- **PATRÓN** `volumen_spike_ratio` > `2.4523` → IC=+0.230 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4523 (IC base=+0.173)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.175 (n=423)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.173)

- **PATRÓN** `libro_liquidez` > `8687.9043` → IC=+0.203 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8687.9043 (IC base=+0.173)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.167 (n=136)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 117.0 (IC base=+0.173)

- **PATRÓN** `sigma_h` < `0.0025` → IC=+0.252 (n=147)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0025 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.3796` → IC=+0.161 (n=440)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.149 (n=166)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.343` → IC=+0.212 (n=387)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.343 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.1489` → IC=+0.161 (n=446)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1489 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.251` → IC=+0.198 (n=137)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.251 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.1582` → IC=+0.158 (n=440)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1582 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6129` → IC=+0.156 (n=440)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6129 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.0996` → IC=+0.172 (n=132)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.0996 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.8946` → IC=+0.179 (n=222)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.8946 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `10334.4562` → IC=+0.158 (n=147)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10334.4562 (IC base=+0.143)

- **PATRÓN** `ballena_activa_n` < `126.0` → IC=+0.137 (n=111)

  - _Acción_: Kelly boost +0.69€ cuando `ballena_activa_n` < 126.0 (IC base=+0.143)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.205 (n=232)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `1.1523` → IC=+0.278 (n=133)
...
- **PATRÓN** `volumen_regimen` > `0.6201` → IC=+0.139 (n=511)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6201 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` < `0.0715` → IC=+0.126 (n=437)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` < 0.0715 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` < `1.4326` → IC=+0.123 (n=160)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.4326 (IC base=+0.122)

- **PATRÓN** `volumen_spike_ratio` > `1.5512` → IC=+0.133 (n=428)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.181 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.005 (IC base=+0.127)

- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.202 (n=139)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.217 (n=150)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.233 (n=418)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.68` → IC=+0.150 (n=101)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.68 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `0.2188` → IC=+0.141 (n=385)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2188 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.851` → IC=+0.202 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.851 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` < `1.1545` → IC=+0.138 (n=418)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 1.1545 (IC base=+0.127)

- **PATRÓN** `volumen_regimen` > `0.8419` → IC=+0.157 (n=278)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.8419 (IC base=+0.127)

- **PATRÓN** `volumen_pendiente_norm` > `0.2176` → IC=+0.195 (n=57)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2176 (IC base=+0.127)

- **PATRÓN** `volumen_spike_ratio` > `2.2636` → IC=+0.214 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2636 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `2087.8334` → IC=+0.182 (n=278)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 2087.8334 (IC base=+0.127)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0238` → IC=+0.202 (n=246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0238 (IC base=+0.169)

- **PATRÓN** `drift_60min` |x|≤ `0.1648` → IC=+0.193 (n=239)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.1648 (IC base=+0.169)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.169)

- **PATRÓN** `ibs_20min` > `0.907` → IC=+0.269 (n=362)
...
- **PATRÓN** `libro_liquidez` > `2450.0308` → IC=+0.172 (n=543)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6623` → IC=+0.232 (n=520)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_regimen` > `0.6271` → IC=+0.237 (n=519)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6271 (IC base=+0.219)

- **PATRÓN** `volumen_pendiente_norm` > `0.2801` → IC=+0.348 (n=64)
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.129 (n=211)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.65€ cuando `sigma_h` > 0.007 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.188 (n=235)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 16.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.6267` → IC=+0.170 (n=413)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.6267 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.7932` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7932 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.104` → IC=+0.197 (n=130)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 8.104 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.1717` → IC=+0.172 (n=123)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1717 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `2815.6056` → IC=+0.132 (n=308)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 2815.6056 (IC base=+0.099)

- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.174 (n=142)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0037 (IC base=+0.069)

- **PATRÓN** `ibs_20min` < `0.2968` → IC=+0.154 (n=284)
...
- **PATRÓN** `volumen_spike_ratio` < `1.852` → IC=+0.122 (n=247)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_spike_ratio` < 1.852 (IC base=+0.069)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.195 (n=1364)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` > 0.0081 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.174 (n=1009)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.94` → IC=+0.290 (n=1364)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.94 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` > `1.1003` → IC=+0.236 (n=498)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1003 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.512` → IC=+0.227 (n=1764)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.512 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `0.8772` → IC=+0.146 (n=1421)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8772 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` > `1.0771` → IC=+0.155 (n=965)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.0771 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1651` → IC=+0.184 (n=776)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1651 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `2.307` → IC=+0.149 (n=2367)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.307 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` > `1.8616` → IC=+0.160 (n=1793)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8616 (IC base=+0.150)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.155 (n=2437)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `2500.5916` → IC=+0.176 (n=2005)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2500.5916 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `149.0` → IC=+0.193 (n=1435)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 149.0 (IC base=+0.150)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.220 (n=1803)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.4726` → IC=+0.201 (n=2701)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4726 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.197 (n=1020)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 17.0 (IC base=+0.190)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.207 (n=969)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` < `0.562` → IC=+0.246 (n=2702)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.562 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` < `0.727` → IC=+0.181 (n=2152)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.727 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.366` → IC=+0.204 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.366 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.631` → IC=+0.193 (n=2531)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` < 2.631 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` < `0.6224` → IC=+0.184 (n=670)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6224 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `1.1975` → IC=+0.181 (n=670)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1975 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2833` → IC=+0.264 (n=290)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2833 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.2963` → IC=+0.208 (n=908)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2963 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.167 (n=1575)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 177.0 (IC base=+0.190)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.212 (n=220)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.180 (n=179)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 6.0 (IC base=+0.148)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.307 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.148)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.327` → IC=+0.302 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.327 (IC base=+0.148)

- **PATRÓN** `volumen_pendiente_norm` > `0.2129` → IC=+0.218 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2129 (IC base=+0.148)

- **PATRÓN** `volumen_spike_ratio` > `1.9052` → IC=+0.143 (n=270)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.9052 (IC base=+0.148)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.197 (n=285)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.04 (IC base=+0.148)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.302 (n=205)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.268)

- **PATRÓN** `drift_60min` |x|≤ `0.1044` → IC=+0.318 (n=135)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1044 (IC base=+0.268)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.269 (n=292)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.268)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.285 (n=272)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 14.0 (IC base=+0.268)

- **PATRÓN** `ibs_20min` < `0.5755` → IC=+0.315 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5755 (IC base=+0.268)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.085` → IC=+0.290 (n=332)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.085 (IC base=+0.268)

- **PATRÓN** `volumen_pendiente_norm` < `0.0689` → IC=+0.259 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0689 (IC base=+0.268)

- **PATRÓN** `volumen_pendiente_norm` > `0.2935` → IC=+0.306 (n=34)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2935 (IC base=+0.268)

- **PATRÓN** `volumen_spike_ratio` > `2.7079` → IC=+0.317 (n=69)
...
- **PATRÓN** `libro_liquidez` > `1978.2716` → IC=+0.317 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1978.2716 (IC base=+0.268)

- **PATRÓN** `ballena_activa_n` < `69.0` → IC=+0.264 (n=125)
...
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.169 (n=161)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0028 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0071` → IC=+0.181 (n=161)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` > 0.0071 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.178 (n=436)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 8.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.3266` → IC=+0.207 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3266 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.2561` → IC=+0.232 (n=285)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2561 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.582` → IC=+0.192 (n=128)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 9.582 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.2673` → IC=+0.160 (n=483)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2673 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.174 (n=219)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0941 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2053` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2053 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.4168` → IC=+0.186 (n=434)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 2.4168 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.3655` → IC=+0.179 (n=434)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.3655 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `11985.6464` → IC=+0.173 (n=322)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 11985.6464 (IC base=+0.153)

- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.190 (n=153)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0022 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.1713` → IC=+0.194 (n=299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.1713 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.168 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 7.0 (IC base=+0.166)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.178 (n=464)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 18.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` < `0.3843` → IC=+0.212 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3843 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.1415` → IC=+0.180 (n=383)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.1415 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.638` → IC=+0.215 (n=240)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1489` → IC=+0.278 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1489 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.7476` → IC=+0.200 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7476 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `1.5054` → IC=+0.183 (n=314)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` > 1.5054 (IC base=+0.166)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.166 (n=578)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.01 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `12259.5995` → IC=+0.178 (n=203)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 12259.5995 (IC base=+0.166)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.250 (n=142)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.184)

- **PATRÓN** `ibs_20min` > `0.7044` → IC=+0.263 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7044 (IC base=+0.184)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.106` → IC=+0.345 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.106 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.2246` → IC=+0.187 (n=327)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2246 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` < `1.997` → IC=+0.194 (n=142)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 1.997 (IC base=+0.184)

- **PATRÓN** `volumen_spike_ratio` > `3.6431` → IC=+0.176 (n=146)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 3.6431 (IC base=+0.184)
...
- **PATRÓN** `libro_liquidez` > `1910.8884` → IC=+0.207 (n=179)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1910.8884 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `59.0` → IC=+0.232 (n=95)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 59.0 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.324 (n=129)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0057 (IC base=+0.248)

- **PATRÓN** `drift_60min` |x|≤ `0.1259` → IC=+0.250 (n=170)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1259 (IC base=+0.248)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.255 (n=267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.248)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.289 (n=150)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.248)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.312 (n=387)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4041` → IC=+0.213 (n=176)
...
- **PATRÓN** `ballena_activa_n` < `65.0` → IC=+0.197 (n=183)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 65.0 (IC base=+0.248)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.156 (n=486)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.345` → IC=+0.195 (n=486)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.345 (IC base=+0.141)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.433` → IC=+0.194 (n=233)
  ...
  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 4.433 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` < `0.6195` → IC=+0.171 (n=162)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 0.6195 (IC base=+0.141)

- **PATRÓN** `volumen_regimen` > `1.1936` → IC=+0.165 (n=162)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 1.1936 (IC base=+0.141)

- **PATRÓN** `volumen_pendiente_norm` > `0.2691` → IC=+0.272 (n=77)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2691 (IC base=+0.141)

- **PATRÓN** `volumen_spike_ratio` > `2.414` → IC=+0.237 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.414 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `5099.5365` → IC=+0.221 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5099.5365 (IC base=+0.141)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.185 (n=239)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 164.0 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.177 (n=351)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0076 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.5023` → IC=+0.165 (n=398)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.5023 (IC base=+0.152)
...
- **PATRÓN** `dist_vwap_pct` > `0.1635` → IC=+0.162 (n=196)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1635 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.642` → IC=+0.176 (n=424)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.642 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.829` → IC=+0.219 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.829 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `0.5848` → IC=+0.167 (n=133)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.5848 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1365` → IC=+0.181 (n=133)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1365 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8125` → IC=+0.177 (n=227)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.8125 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.4643` → IC=+0.190 (n=114)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.4643 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `9483.0008` → IC=+0.210 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9483.0008 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.227 (n=141)
...
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.157 (n=243)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0111 (IC base=+0.096)
...
- **PATRÓN** `dist_vwap_pct` > `0.8569` → IC=+0.225 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8569 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.357` → IC=+0.222 (n=203)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.357 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2942.126` → IC=+0.290 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2942.126 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.164 (n=310)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 66.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` < `0.006` → IC=+0.177 (n=215)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.006 (IC base=+0.112)

- **PATRÓN** `drift_60min` |x|≤ `0.5416` → IC=+0.126 (n=487)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.5416 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 15.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` < `0.5909` → IC=+0.199 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5909 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.4736` → IC=+0.142 (n=434)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4736 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.042` → IC=+0.135 (n=477)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` < 3.042 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `0.7039` → IC=+0.148 (n=214)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7039 (IC base=+0.112)

- **PATRÓN** `volumen_pendiente_norm` > `0.0719` → IC=+0.164 (n=138)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.0719 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `2.0886` → IC=+0.137 (n=298)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.0886 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` > `1.4382` → IC=+0.136 (n=339)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4382 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2610.631` → IC=+0.159 (n=221)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2610.631 (IC base=+0.112)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0228` → IC=+0.213 (n=284)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.9615` → IC=+0.294 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9615 (IC base=+0.177)
...
- **PATRÓN** `volumen_regimen` > `1.0357` → IC=+0.206 (n=284)
...
- **PATRÓN** `libro_liquidez` > `2451.9374` → IC=+0.179 (n=627)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2451.9374 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.224 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=+0.177)

- **PATRÓN** `sigma_h` < `0.0064` → IC=+0.294 (n=299)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0064 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.4796` → IC=+0.227 (n=598)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.213 (n=723)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.4921` → IC=+0.275 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4921 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `1.2446` → IC=+0.221 (n=787)
...
- **PATRÓN** `volumen_regimen` > `1.2332` → IC=+0.247 (n=227)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2332 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.315 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.6049` → IC=+0.229 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6049 (IC base=+0.213)

- **PATRÓN** `ballena_activa_n` < `37.0` → IC=+0.178 (n=395)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.148 (n=1055)

- **PATRÓN** `sigma_h` < `0.0106` → IC=+0.138 (n=558)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0106 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.173 (n=224)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` > `0.9286` → IC=+0.171 (n=211)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` > 0.9286 (IC base=+0.121)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.433` → IC=+0.127 (n=577)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.433 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` < `0.6834` → IC=+0.128 (n=216)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.6834 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` > `1.0516` → IC=+0.140 (n=223)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 1.0516 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.2815` → IC=+0.194 (n=83)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2815 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.138 (n=208)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` > `1.8335` → IC=+0.130 (n=414)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.8335 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `9436.689` → IC=+0.133 (n=287)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 9436.689 (IC base=+0.121)

- **PATRÓN** `sigma_h` < `0.0036` → IC=+0.190 (n=269)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0036 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.3642` → IC=+0.171 (n=707)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3642 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.163 (n=315)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 17.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `4.0` → IC=+0.194 (n=299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 4.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.633` → IC=+0.147 (n=707)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` < 0.633 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.0856` → IC=+0.152 (n=803)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` > 0.0856 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.6357` → IC=+0.158 (n=194)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` > 0.6357 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.3876` → IC=+0.135 (n=765)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.3876 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.072` → IC=+0.152 (n=806)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 6.072 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.2058` → IC=+0.155 (n=780)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2058 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` < `0.094` → IC=+0.146 (n=722)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.094 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.0712` → IC=+0.155 (n=381)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.0712 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `2.494` → IC=+0.159 (n=795)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.494 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.4174` → IC=+0.150 (n=795)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4174 (IC base=+0.143)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=1055)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `10633.6945` → IC=+0.155 (n=535)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.130 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 14.0 (IC base=+0.063)

- **PATRÓN** `volumen_regimen` > `0.9282` → IC=+0.214 (n=40)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.9282 (IC base=+0.063)

- **PATRÓN** `libro_liquidez` > `12303.8073` → IC=+0.156 (n=88)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 12303.8073 (IC base=+0.063)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.170 (n=449)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0065 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.3644` → IC=+0.160 (n=448)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.3644 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.189 (n=178)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 17.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.194 (n=168)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 5.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` < `0.1827` → IC=+0.165 (n=198)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.1827 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.3932` → IC=+0.148 (n=299)

  - _Acción_: Kelly boost +0.74€ cuando `ibs_20min` > 0.3932 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.6118` → IC=+0.179 (n=79)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.6118 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.318` → IC=+0.159 (n=453)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.318 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `1.1834` → IC=+0.158 (n=448)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 1.1834 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` > `0.0718` → IC=+0.184 (n=207)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.0718 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `2.5268` → IC=+0.154 (n=446)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.5268 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` > `1.7814` → IC=+0.145 (n=297)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7814 (IC base=+0.143)

- **PATRÓN** `libro_liquidez` > `11911.1172` → IC=+0.147 (n=400)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 11911.1172 (IC base=+0.143)

### GBM_LATE_5M#DOGE#5min
- **PATRÓN** `sigma_h` < `0.0126` → IC=+0.152 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0126 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.008` → IC=+0.183 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.008 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.262 (n=61)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 13.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` < `0.4667` → IC=+0.219 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4667 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.9219` → IC=+0.375 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9219 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.697` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.697 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.061` → IC=+0.155 (n=85)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 4.061 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2952` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2952 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `3.2505` → IC=+0.170 (n=89)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 3.2505 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `2.2445` → IC=+0.172 (n=59)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` > 2.2445 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `1726.3906` → IC=+0.185 (n=90)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1726.3906 (IC base=+0.153)

### GBM_LATE_5M#ETH#5min
- **PATRÓN** `sigma_h` < `0.0094` → IC=+0.180 (n=254)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.0094 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.4394` → IC=+0.165 (n=222)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.4394 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `19.0` → IC=+0.203 (n=89)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.142)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.142 (n=118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 5.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` < `0.8994` → IC=+0.143 (n=253)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.8994 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.803` → IC=+0.184 (n=115)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.803 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.9629` → IC=+0.190 (n=69)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.9629 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.2192` → IC=+0.150 (n=198)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.2192 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.158` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.158 (IC base=+0.142)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.662` → IC=+0.143 (n=253)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.662 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.6442` → IC=+0.190 (n=85)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` < 0.6442 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` < `0.117` → IC=+0.147 (n=230)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.117 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.1739` → IC=+0.150 (n=78)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1739 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` < `1.4142` → IC=+0.202 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4142 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `1.8053` → IC=+0.145 (n=164)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8053 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `8958.3045` → IC=+0.167 (n=226)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 8958.3045 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0088` → IC=+0.155 (n=227)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0088 (IC base=+0.138)

- **PATRÓN** `drift_60min` |x|≤ `0.5088` → IC=+0.181 (n=227)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.91€ cuando `drift_60min` |x|≤ 0.5088 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.145 (n=105)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 16.0 (IC base=+0.138)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.169 (n=155)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 10.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.619` → IC=+0.139 (n=200)

  - _Acción_: Kelly boost +0.69€ cuando `ibs_20min` < 0.619 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.0864` → IC=+0.177 (n=227)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.0864 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.1942` → IC=+0.145 (n=91)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.1942 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.3536` → IC=+0.148 (n=225)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.3536 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.157` → IC=+0.164 (n=114)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 3.157 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.6473` → IC=+0.244 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6473 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` < `0.1309` → IC=+0.161 (n=231)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1309 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.4413` → IC=+0.176 (n=223)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 2.4413 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.4479` → IC=+0.165 (n=222)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4479 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `10283.2146` → IC=+0.167 (n=76)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 10283.2146 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.130 (n=44)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 18.0 (IC base=+0.123)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.138 (n=136)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 18.0 (IC base=+0.123)

- **PATRÓN** `py_entrada` < `0.495` → IC=+0.128 (n=49)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` < 0.495 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `2493.9311` → IC=+0.156 (n=126)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 2493.9311 (IC base=+0.123)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=514)
...
- **FILTRO** `liq_usd_total` < `22365.51` → IC=-0.179 (n=26)

  - _Acción_: SKIP cuando `liq_usd_total` < 22365.51
...
- **PATRÓN** `liq_usd_total` > `22365.51` → IC=+0.125 (n=54)

  - _Acción_: Kelly boost +0.62€ cuando `liq_usd_total` > 22365.51 (IC base=+0.024)
...
- **PATRÓN** `liq_n` > `2.0` → IC=+0.135 (n=94)
  ...
  - _Acción_: Kelly boost +0.68€ cuando `liq_n` > 2.0 (IC base=+0.083)

- **PATRÓN** `liq_usd_total` > `9741.83` → IC=+0.161 (n=57)

  - _Acción_: Kelly boost +0.81€ cuando `liq_usd_total` > 9741.83 (IC base=+0.083)

- **PATRÓN** `liq_imbalance_60min` |x|> `0.9969` → IC=+0.127 (n=57)

  - _Acción_: Kelly boost +0.64€ cuando `liq_imbalance_60min` |x|> 0.9969 (IC base=+0.083)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.144 (n=130)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 8.0 (IC base=+0.083)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.169 (n=872)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.028 (n=2693)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.217 (n=842)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2707)

- **FILTRO** `ibs_20min` > `0.2727` → IC=-0.180 (n=887)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2727
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=2662)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.232 (n=125)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=+0.039 (n=391)

- **FILTRO** `ibs_20min` < `0.7312` → IC=-0.172 (n=129)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7312
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=387)

- **FILTRO** `ibs_20min` > `0.1844` → IC=-0.123 (n=306)
...
- **FILTRO** `ballena_activa_n` > `78.0` → IC=-0.169 (n=146)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=442)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.133 (n=118)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=425)

- **FILTRO** `py_entrada` < `0.5` → IC=-0.178 (n=237)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=306)

- **FILTRO** `ibs_20min` < `0.7271` → IC=-0.186 (n=135)
...
- **FILTRO** `ibs_20min` > `0.7464` → IC=-0.213 (n=148)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7464
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=447)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.49` → IC=-0.124 (n=147)

  - _Acción_: SKIP cuando `py_entrada` < 0.49
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=488)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.181 (n=155)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=470)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.171 (n=153)
...
- **FILTRO** `drift_20min_pct` |x|> `0.2852` → IC=-0.141 (n=190)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.2852
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=369)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.136 (n=2181)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=6713)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.281 (n=2151)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=6743)

- **FILTRO** `ibs_7min` < `0.7336` → IC=-0.231 (n=2223)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7336
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=6671)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.173 (n=3019)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=5875)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.231 (n=2494)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=8282)

- **FILTRO** `ibs_7min` > `0.7245` → IC=-0.174 (n=2693)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7245
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=8083)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.318 (n=289)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=910)

- **FILTRO** `ibs_7min` < `0.9776` → IC=-0.197 (n=791)

  - _Acción_: SKIP cuando `ibs_7min` < 0.9776
  - _Potencial_: sin este filtro IC_bueno=+0.059 (n=408)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.251 (n=295)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=904)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.232 (n=442)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=1415)

- **FILTRO** `drift_7min_pct` |x|> `0.1353` → IC=-0.150 (n=630)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1353
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1227)

- **FILTRO** `ibs_7min` > `0.8444` → IC=-0.189 (n=464)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8444
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1393)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.146 (n=365)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1366)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.251 (n=408)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1323)

- **FILTRO** `ibs_7min` < `0.797` → IC=-0.181 (n=431)

  - _Acción_: SKIP cuando `ibs_7min` < 0.797
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1300)

- **FILTRO** `ballena_activa_n` > `158.0` → IC=-0.189 (n=432)

  - _Acción_: SKIP cuando `ballena_activa_n` > 158.0
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1299)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.226 (n=411)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1320)

- **FILTRO** `ballena_activa_n` > `94.0` → IC=-0.160 (n=586)

  - _Acción_: SKIP cuando `ballena_activa_n` > 94.0
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1145)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.202 (n=303)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=978)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.316 (n=410)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=871)

- **FILTRO** `ibs_7min` < `0.2143` → IC=-0.285 (n=319)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2143
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=962)

- **FILTRO** `ballena_activa_n` > `16.0` → IC=-0.284 (n=308)

  - _Acción_: SKIP cuando `ballena_activa_n` > 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=973)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.260 (n=407)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.007 (n=1476)

- **FILTRO** `ibs_7min` > `0.8192` → IC=-0.197 (n=470)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8192
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1413)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.151 (n=442)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=1052)

- **FILTRO** `py_entrada` < `0.44` → IC=-0.212 (n=718)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=776)

- **FILTRO** `ibs_7min` < `0.7575` → IC=-0.188 (n=373)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7575
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=1121)

- **FILTRO** `ballena_activa_n` > `42.0` → IC=-0.207 (n=373)

  - _Acción_: SKIP cuando `ballena_activa_n` > 42.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=1121)

- **FILTRO** `hora_utc` > `15.0` → IC=-0.124 (n=501)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=984)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.277 (n=352)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=1133)

- **FILTRO** `ibs_7min` > `0.1878` → IC=-0.162 (n=504)

  - _Acción_: SKIP cuando `ibs_7min` > 0.1878
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=981)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.181 (n=494)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=991)
...
- **FILTRO** `ibs_7min` < `0.7727` → IC=-0.194 (n=426)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7727
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1281)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.186 (n=415)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=1292)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.189 (n=486)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=1505)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.120 (n=475)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1007)

- **FILTRO** `py_entrada` < `0.38` → IC=-0.287 (n=364)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=1118)

- **FILTRO** `ibs_7min` < `0.7532` → IC=-0.210 (n=370)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7532
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1112)

- **FILTRO** `ballena_activa_n` > `14.0` → IC=-0.224 (n=364)

  - _Acción_: SKIP cuando `ballena_activa_n` > 14.0
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1118)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.266 (n=379)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1450)

- **FILTRO** `ibs_7min` > `0.8136` → IC=-0.169 (n=457)
...
- **PATRÓN** `libro_liquidez` > `3582.6278` → IC=+0.146 (n=80)
  ...
  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 3582.6278 (IC base=+0.120)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.126 (n=137)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 47.0 (IC base=+0.120)
...
- **PATRÓN** `delta_ratio` |x|> `0.4208` → IC=+0.206 (n=15)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio` |x|> 0.4208 (IC base=+0.109)
...
### STREAK_FADE_5M
- **FILTRO** `py_entrada` > `0.495` → IC=-0.122 (n=43)
...
- **PATRÓN** `streak_estiramiento` < `0.3225` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `streak_estiramiento` < 0.3225 (IC base=+0.009)
...
- **FILTRO** `streak_len` > `3.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `streak_len` > 3.0
  - _Potencial_: sin este filtro IC_bueno=+0.089 (n=222)

- **PATRÓN** `hora_utc` < `14.0` → IC=+0.127 (n=159)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.014 (n=1213)
...
- **PATRÓN** `ibs_15` < `0.1304` → IC=+0.205 (n=110)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.329 (n=168)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **FILTRO** `sigma_h` > `0.0097` → IC=-0.168 (n=257)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0097
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=772)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.465` → IC=-0.170 (n=349)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.465
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=2594)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1306` → IC=+0.257 (n=113)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1306 (IC base=-0.081)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0665` → IC=+0.295 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.0665 (IC base=-0.081)

- **PATRÓN** `ibs_15` < `0.3345` → IC=+0.320 (n=170)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3345 (IC base=-0.081)

- **PATRÓN** `dist_vwap_pct` < `0.2166` → IC=+0.252 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2166 (IC base=-0.081)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0075` → IC=-0.247 (n=160)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0075
  - _Potencial_: sin este filtro IC_bueno=-0.202 (n=481)

- **FILTRO** `sigma_h` < `0.0035` → IC=-0.223 (n=211)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0035
  - _Potencial_: sin este filtro IC_bueno=-0.208 (n=430)
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.957` → IC=-0.269 (n=119)
...
- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.1045` → IC=+0.261 (n=69)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +1.00€ cuando `pct_spot_vs_ref` |x|≤ 0.1045 (IC base=+0.239)

- **PATRÓN** `sigma_h` < `0.007` → IC=+0.250 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.007 (IC base=+0.239)
...
- **PATRÓN** `drift_15min` |x|≤ `0.4361` → IC=+0.284 (n=35)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.4361 (IC base=+0.239)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.286 (n=68)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.281 (n=39)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.239)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.262 (n=40)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.239)

- **PATRÓN** `ibs_15` < `0.3299` → IC=+0.329 (n=103)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3299 (IC base=+0.239)

- **PATRÓN** `dist_vwap_pct` < `0.1207` → IC=+0.265 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1207 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.326` → IC=+0.266 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.326 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `12545.3929` → IC=+0.255 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12545.3929 (IC base=+0.239)

- **PATRÓN** `ballena_activa_n` < `209.0` → IC=+0.260 (n=73)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 209.0 (IC base=+0.239)
...
- **FILTRO** `sigma_ewma_delta_pct` > `15.88` → IC=-0.150 (n=115)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 15.88
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=906)
...
- **FILTRO** `drift_15min` |x|> `1.1396` → IC=-0.242 (n=64)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.114 (n=195)

- **FILTRO** `sigma_ewma_delta_pct` > `14.492` → IC=-0.184 (n=36)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 14.492
  - _Potencial_: sin este filtro IC_bueno=-0.140 (n=223)

- **FILTRO** `libro_liquidez` < `2519.5422` → IC=-0.197 (n=64)

  - _Acción_: SKIP cuando `libro_liquidez` < 2519.5422
  - _Potencial_: sin este filtro IC_bueno=-0.129 (n=195)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1304 sube el IC de +0.048 a +0.205 en UPDOWN_GBM#XRP#15min (n=110). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3345 sube el IC de -0.081 a +0.320 en UPDOWN_GBM_15M_TARDIO (n=170). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3299 sube el IC de +0.239 a +0.329 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 618 | +0.090 | +49.81€ | 1 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 618 | +0.090 | +49.81€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 373 | +0.116 | +38.29€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 373 | +0.116 | +38.29€ | 0 | 10 |
...
| ✅ BALLENAS_TARDIAS | 10128 | -0.094 | -1613.60€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 725 | -0.070 | -128.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 9403 | -0.096 | -1485.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1239 | -0.012 | -213.95€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1239 | -0.012 | -213.95€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 725 | -0.070 | -128.30€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 725 | -0.070 | -128.30€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1295 | -0.162 | -414.41€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1295 | -0.162 | -414.41€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 2742 | -0.068 | -265.47€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 2742 | -0.068 | -265.47€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 2364 | -0.077 | -159.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 2364 | -0.077 | -159.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1763 | -0.176 | -432.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1763 | -0.176 | -432.27€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 163 | -0.070 | +42.09€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 45 | -0.011 | +15.51€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 118 | -0.092 | +26.58€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 163 | -0.070 | +42.09€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 45 | -0.011 | +15.51€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 118 | -0.092 | +26.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 33514 | +0.115 | -2085.85€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6121 | +0.186 | -226.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 109 | -0.104 | -50.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 24044 | +0.098 | -1767.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3240 | +0.120 | -41.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 4036 | +0.065 | -677.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 21 | -0.065 | +2.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 4010 | +0.066 | -673.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6899 | +0.134 | -147.91€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1733 | +0.194 | -105.68€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 4001 | +0.111 | -79.39€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1123 | +0.130 | +59.40€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 4044 | +0.082 | -493.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 22 | +0.083 | +3.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 4021 | +0.082 | -495.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 7401 | +0.128 | -106.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2225 | +0.167 | -22.15€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 4003 | +0.115 | -49.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1161 | +0.100 | -26.53€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 7101 | +0.136 | -408.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2103 | +0.204 | -104.05€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 48 | +0.000 | -9.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3994 | +0.102 | -220.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 956 | +0.133 | -73.90€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 4033 | +0.109 | -251.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 17 | -0.022 | -0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 4015 | +0.110 | -249.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 6062 | +0.174 | -474.56€ | 3 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 6062 | +0.174 | -474.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 1529 | +0.166 | -163.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 1529 | +0.166 | -163.83€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 1508 | +0.164 | -170.56€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 1508 | +0.164 | -170.56€ | 0 | 4 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 1360 | +0.230 | -39.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 1360 | +0.230 | -39.08€ | 0 | 3 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL | 79 | -0.204 | +13.76€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#SOL#15min | 79 | -0.204 | +13.76€ | 3 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP | 1469 | +0.183 | -114.93€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#XRP#15min | 1469 | +0.183 | -114.93€ | 0 | 3 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 17181 | +0.191 | -1505.95€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 17181 | +0.191 | -1505.95€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 3140 | +0.127 | -575.28€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 3140 | +0.127 | -575.28€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2678 | +0.235 | -58.94€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2678 | +0.235 | -58.94€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 