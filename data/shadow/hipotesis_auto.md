# Hipótesis automáticas — 2026-09-26 16:54 UTC
_Generado por shadow_postmortem.py sobre 622957 resoluciones (PNL=+71218.91€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=510)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.123 (n=510)
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.115 (n=375)
...
- **PATRÓN** `libro_liquidez` > `11799.9463` → IC=+0.122 (n=146)

  - _Acción_: Kelly boost +0.61€ cuando `libro_liquidez` > 11799.9463 (IC base=+0.055)

- **PATRÓN** `ballena_activa_n` < `94.0` → IC=+0.158 (n=144)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 94.0 (IC base=+0.055)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.25` → IC=-0.223 (n=7290)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.25
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=21870)
...
- **FILTRO** `restante_s_al_confirmar` < `165.95` → IC=-0.207 (n=1777)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 165.95
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=5333)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `127.69` → IC=-0.339 (n=1435)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.206 (n=14298)
...
- **PATRÓN** `libro_liquidez` > `5664.3095` → IC=+0.177 (n=2292)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 5664.3095 (IC base=+0.102)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=11294)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.127)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=5813)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.127)

- **PATRÓN** `libro_liquidez` > `7848.8603` → IC=+0.176 (n=2199)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1569)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.202)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.208 (n=1743)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.204 (n=2227)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.144 (n=366)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 7.0 (IC base=+0.104)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.155 (n=2908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.154 (n=478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 11.0 (IC base=+0.137)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.139 (n=688)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=780)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `1313.0714` → IC=+0.151 (n=682)
...
- **PATRÓN** `py_entrada` > `0.86` → IC=+0.432 (n=656)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.163 (n=561)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=938)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.239)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.243 (n=938)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.201 (n=35568)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.236 (n=15850)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=7221)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.230 (n=3195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=2209)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.220)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.210 (n=5889)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.204)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.256 (n=2372)
...
- **PATRÓN** `lag_apertura_s` < `2.68` → IC=+0.138 (n=4999)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.140 (n=2745)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4608` → IC=+0.204 (n=5805)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4608 (IC base=+0.106)

- **PATRÓN** `ibs_20min` < `0.5708` → IC=+0.134 (n=10166)
...
- **PATRÓN** `volumen_regimen` < `0.6973` → IC=+0.186 (n=1579)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6973 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.0501` → IC=+0.176 (n=1626)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5417)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.212 (n=5857)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `3.479` → IC=+0.246 (n=1503)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6131` → IC=+0.245 (n=442)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6131 (IC base=+0.236)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.239 (n=1596)
...
- **PATRÓN** `dist_vwap_pct` < `0.5623` → IC=+0.221 (n=1529)
...
- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.176 (n=510)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` < 0.0026 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0761` → IC=+0.166 (n=507)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7028` → IC=+0.170 (n=1516)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.7028 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1296` → IC=+0.155 (n=1359)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` < 0.1296 (IC base=+0.140)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.301` → IC=+0.145 (n=1385)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 4.301 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.150 (n=1516)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4301` → IC=+0.153 (n=1406)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4301 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.148 (n=1406)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.192 (n=1977)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.184` → IC=+0.256 (n=395)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.184 (IC base=+0.185)

- **PATRÓN** `volumen_pendiente_norm` < `0.1008` → IC=+0.189 (n=1632)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.1008 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `1.7784` → IC=+0.193 (n=1602)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.7784 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1314)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.220 (n=1427)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.210)

- **PATRÓN** `drift_60min` |x|≤ `0.6121` → IC=+0.211 (n=1621)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `volumen_spike_ratio` < `1.7621` → IC=+0.206 (n=657)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7621 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `2.1841` → IC=+0.216 (n=994)
...
- **PATRÓN** `libro_liquidez` > `1909.461` → IC=+0.215 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1909.461 (IC base=+0.210)

- **PATRÓN** `ballena_activa_n` < `22.0` → IC=+0.215 (n=948)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.182 (n=61)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=339)

- **FILTRO** `ibs_20min` < `0.2857` → IC=-0.206 (n=100)
...
- **FILTRO** `ibs_20min` > `0.25` → IC=-0.125 (n=2275)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.124 (n=1131)

- **FILTRO** `sigma_ewma_delta_pct` > `8.719` → IC=-0.210 (n=364)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.719
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=3042)

- **PATRÓN** `ibs_20min` > `0.7647` → IC=+0.225 (n=136)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7647 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` > `1.0858` → IC=+0.286 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0858 (IC base=+0.042)
...
- **PATRÓN** `volumen_regimen` > `0.7668` → IC=+0.295 (n=81)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7668 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` < `2.5444` → IC=+0.281 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5444 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `1.5176` → IC=+0.264 (n=108)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5176 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.293 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 49.0 (IC base=+0.042)

- **PATRÓN** `ibs_20min` < `0.25` → IC=+0.124 (n=1131)
...
- **FILTRO** `drift_60min` |x|> `0.6536` → IC=-0.183 (n=592)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1790)

- **FILTRO** `ibs_20min` < `0.7197` → IC=-0.153 (n=1572)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7197
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=810)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.197 (n=457)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1925)
...
- **PATRÓN** `volumen_regimen` < `0.6536` → IC=+0.253 (n=273)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6536 (IC base=-0.021)

- **PATRÓN** `volumen_regimen` > `1.2485` → IC=+0.285 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2485 (IC base=-0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2441` → IC=+0.285 (n=142)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2441 (IC base=-0.021)

- **PATRÓN** `volumen_spike_ratio` < `2.1392` → IC=+0.259 (n=620)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1392 (IC base=-0.021)

- **PATRÓN** `volumen_spike_ratio` > `1.5237` → IC=+0.248 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5237 (IC base=-0.021)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.196 (n=3549)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0098 (IC base=+0.098)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.187 (n=9511)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.615` → IC=+0.156 (n=4984)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.615 (IC base=+0.098)

- **PATRÓN** `volumen_regimen` > `0.6901` → IC=+0.250 (n=3397)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6901 (IC base=+0.098)

- **PATRÓN** `volumen_pendiente_norm` > `0.2937` → IC=+0.270 (n=904)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2937 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` < `1.4634` → IC=+0.237 (n=2057)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4634 (IC base=+0.098)

- **PATRÓN** `volumen_spike_ratio` > `2.6447` → IC=+0.247 (n=2057)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6447 (IC base=+0.098)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.269 (n=5686)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 95.0 (IC base=+0.098)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.158 (n=3520)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.5499` → IC=+0.154 (n=9271)
...
- **PATRÓN** `ibs_20min` > `0.8652` → IC=+0.163 (n=713)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.8652 (IC base=+0.027)

- **PATRÓN** `dist_vwap_pct` > `0.3026` → IC=+0.176 (n=387)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3026 (IC base=+0.027)

- **PATRÓN** `volumen_regimen` > `0.6746` → IC=+0.169 (n=880)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` > 0.6746 (IC base=+0.027)

- **PATRÓN** `volumen_pendiente_norm` > `0.2712` → IC=+0.244 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2712 (IC base=+0.027)

- **PATRÓN** `volumen_spike_ratio` < `1.4239` → IC=+0.188 (n=322)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 1.4239 (IC base=+0.027)

- **PATRÓN** `volumen_spike_ratio` > `2.3925` → IC=+0.161 (n=322)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.3925 (IC base=+0.027)

- **PATRÓN** `ballena_activa_n` < `241.0` → IC=+0.186 (n=422)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 241.0 (IC base=+0.027)

- **PATRÓN** `dist_vwap_pct` < `0.1526` → IC=+0.216 (n=625)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1526 (IC base=+0.006)

- **PATRÓN** `volumen_regimen` > `0.613` → IC=+0.215 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.613 (IC base=+0.006)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1582` → IC=+0.233 (n=256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1582 (IC base=+0.006)

- **PATRÓN** `ballena_activa_n` < `460.0` → IC=+0.215 (n=563)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.251 (n=1671)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.247)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.249 (n=1686)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.102` → IC=+0.261 (n=1414)
...
- **PATRÓN** `libro_liquidez` > `1902.0299` → IC=+0.295 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1902.0299 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `27.0` → IC=+0.286 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 27.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.297` → IC=-0.172 (n=526)

  - _Acción_: SKIP cuando `ibs_20min` < 0.297
  - _Potencial_: sin este filtro IC_bueno=+0.077 (n=1581)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.187 (n=625)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7744
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=1879)

- **PATRÓN** `ibs_20min` > `0.9118` → IC=+0.180 (n=527)
...
- **FILTRO** `ibs_20min` < `0.7328` → IC=-0.193 (n=1126)
...
- **FILTRO** `ibs_20min` > `0.6875` → IC=-0.237 (n=573)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.096 (n=1740)

- **FILTRO** `sigma_ewma_delta_pct` > `4.726` → IC=-0.187 (n=506)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.726
  - _Potencial_: sin este filtro IC_bueno=+0.070 (n=1807)

- **PATRÓN** `ibs_20min` > `0.7328` → IC=+0.280 (n=1127)
...
- **PATRÓN** `ibs_20min` < `0.1923` → IC=+0.192 (n=765)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.1923 (IC base=+0.014)
...
- **PATRÓN** `sigma_h` > `0.0153` → IC=+0.302 (n=981)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0153 (IC base=+0.275)

- **PATRÓN** `drift_60min` |x|≤ `0.1951` → IC=+0.275 (n=647)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1951 (IC base=+0.275)
...
- **PATRÓN** `ibs_20min` < `0.3913` → IC=+0.306 (n=1470)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3913 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` > `1.3409` → IC=+0.284 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3409 (IC base=+0.275)

- **PATRÓN** `dist_vwap_pct` < `0.2283` → IC=+0.276 (n=1338)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2283 (IC base=+0.275)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.469` → IC=+0.290 (n=537)
...
- **PATRÓN** `volumen_regimen` > `1.2435` → IC=+0.309 (n=490)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4255` → IC=+0.283 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4255 (IC base=+0.275)

- **PATRÓN** `volumen_spike_ratio` > `2.1415` → IC=+0.276 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1415 (IC base=+0.275)

- **PATRÓN** `libro_liquidez` > `2625.3161` → IC=+0.278 (n=980)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2625.3161 (IC base=+0.275)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.174 (n=2743)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.4815` → IC=+0.226 (n=7848)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4815 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2351` → IC=+0.159 (n=5687)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2351 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.341` → IC=+0.193 (n=1329)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 10.341 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1733` → IC=+0.152 (n=5665)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.1733 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2904` → IC=+0.215 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2904 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5593` → IC=+0.166 (n=3149)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5593 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.248` → IC=+0.171 (n=3245)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.248 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `113.0` → IC=+0.175 (n=6803)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.244 (n=908)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1878` → IC=+0.291 (n=687)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1878 (IC base=+0.239)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.243 (n=926)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.264 (n=1030)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.239)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.344` → IC=+0.250 (n=1116)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.187 (n=1219)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 6.0 (IC base=+0.163)

- **PATRÓN** `ibs_20min` > `0.4056` → IC=+0.228 (n=1218)
...
- **PATRÓN** `volumen_regimen` < `0.6875` → IC=+0.167 (n=536)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6875 (IC base=+0.163)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.170 (n=553)
...
- **PATRÓN** `libro_liquidez` > `10644.0099` → IC=+0.171 (n=1218)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.207 (n=1430)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.210 (n=1630)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.200)

- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.235 (n=1014)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.3486` → IC=+0.248 (n=1151)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3486 (IC base=+0.217)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.729` → IC=+0.259 (n=495)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1982` → IC=+0.230 (n=714)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.153 (n=1375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0072 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.3828` → IC=+0.143 (n=1375)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6477` → IC=+0.172 (n=1375)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6477 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` < `0.1585` → IC=+0.139 (n=1347)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1585 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.964` → IC=+0.160 (n=489)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 6.964 (IC base=+0.122)

- **PATRÓN** `volumen_regimen` < `0.8503` → IC=+0.147 (n=917)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8007` → IC=+0.138 (n=836)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.8007 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `9988.1936` → IC=+0.161 (n=624)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.139 (n=1527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.118)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.205 (n=1489)
...
- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.130 (n=1489)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.2145 (IC base=+0.118)

- **PATRÓN** `volumen_regimen` > `0.7264` → IC=+0.124 (n=1330)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` > 0.7264 (IC base=+0.118)

- **PATRÓN** `volumen_spike_ratio` < `1.5369` → IC=+0.138 (n=633)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5369 (IC base=+0.118)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1552)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.118)

- **PATRÓN** `libro_liquidez` > `2907.8423` → IC=+0.194 (n=675)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2907.8423 (IC base=+0.118)

- **PATRÓN** `ballena_activa_n` < `49.0` → IC=+0.134 (n=1140)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=1529)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5745` → IC=+0.211 (n=1508)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5745 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` > `1.0169` → IC=+0.138 (n=216)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 1.0169 (IC base=+0.114)

- **PATRÓN** `dist_vwap_pct` < `0.2075` → IC=+0.140 (n=1380)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2075 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.604` → IC=+0.134 (n=312)

  - _Acción_: Kelly boost +0.67€ cuando `sigma_ewma_delta_pct` > 7.604 (IC base=+0.114)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4527` → IC=+0.131 (n=453)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` < 1.4527 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `2760.1991` → IC=+0.162 (n=684)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 2760.1991 (IC base=+0.114)
...
- **PATRÓN** `sigma_h` < `0.0117` → IC=+0.225 (n=646)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.0915` → IC=+0.223 (n=489)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0915 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.223 (n=715)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.246 (n=1468)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.445` → IC=+0.245 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.445 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.633` → IC=+0.215 (n=1467)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.633 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2819` → IC=+0.292 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2819 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.1933` → IC=+0.196 (n=1165)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` < 2.1933 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4336` → IC=+0.200 (n=1323)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4336 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2597.9008` → IC=+0.209 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2597.9008 (IC base=+0.205)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.175 (n=674)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.179 (n=902)
...
- **PATRÓN** `volumen_regimen` > `0.6229` → IC=+0.155 (n=1774)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.6229 (IC base=+0.151)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2086` → IC=+0.162 (n=879)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.2086 (IC base=+0.151)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.156 (n=2274)
...
- **PATRÓN** `ballena_activa_n` < `152.0` → IC=+0.170 (n=1787)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 152.0 (IC base=+0.151)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.206 (n=3515)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0114 (IC base=+0.170)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.181 (n=11008)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.9631` → IC=+0.202 (n=1500)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9631 (IC base=+0.170)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.344` → IC=+0.245 (n=2652)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.344 (IC base=+0.170)

- **PATRÓN** `volumen_regimen` < `0.88` → IC=+0.166 (n=4701)
...
- **PATRÓN** `ibs_20min` < `0.569` → IC=+0.236 (n=9543)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.569 (IC base=+0.182)

- **PATRÓN** `dist_vwap_pct` < `0.2499` → IC=+0.162 (n=5928)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2499 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.038` → IC=+0.198 (n=1341)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 10.038 (IC base=+0.182)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.732` → IC=+0.183 (n=9222)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.732 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` < `0.7044` → IC=+0.164 (n=2879)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.7044 (IC base=+0.182)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.154 (n=2181)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2022 (IC base=+0.182)

- **PATRÓN** `volumen_pendiente_norm` > `0.2873` → IC=+0.239 (n=1256)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2873 (IC base=+0.182)

- **PATRÓN** `volumen_spike_ratio` > `2.614` → IC=+0.193 (n=2929)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.614 (IC base=+0.182)

- **PATRÓN** `ballena_activa_n` < `47.0` → IC=+0.196 (n=5635)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.261 (n=938)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.1272` → IC=+0.285 (n=620)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1272 (IC base=+0.259)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.268 (n=1273)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.259)

- **PATRÓN** `ibs_20min` < `0.3517` → IC=+0.286 (n=1237)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3517 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.485` → IC=+0.263 (n=1474)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.485 (IC base=+0.259)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4331` → IC=+0.258 (n=432)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4331 (IC base=+0.259)

- **PATRÓN** `volumen_spike_ratio` > `2.6337` → IC=+0.281 (n=432)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1148` → IC=+0.161 (n=1437)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.1148 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.7549` → IC=+0.159 (n=1088)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.7549 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `11295.2956` → IC=+0.161 (n=1508)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.164 (n=1463)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0057 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.2565` → IC=+0.167 (n=1286)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2565 (IC base=+0.152)
...
- **PATRÓN** `dist_vwap_pct` < `0.1321` → IC=+0.165 (n=1327)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1321 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.493` → IC=+0.159 (n=244)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.493 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.3` → IC=+0.154 (n=1327)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4003` → IC=+0.161 (n=1363)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4003 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7548` → IC=+0.163 (n=909)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.227 (n=1799)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.218)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.223 (n=1747)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1345` → IC=+0.219 (n=1562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1345 (IC base=+0.218)

- **PATRÓN** `volumen_spike_ratio` > `1.7707` → IC=+0.228 (n=1465)
...
- **PATRÓN** `libro_liquidez` > `1914.6432` → IC=+0.220 (n=779)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1914.6432 (IC base=+0.218)

- **PATRÓN** `sigma_h` < `0.0118` → IC=+0.238 (n=1600)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0118 (IC base=+0.231)

- **PATRÓN** `drift_60min` |x|≤ `0.1709` → IC=+0.236 (n=704)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0152` → IC=+0.307 (n=533)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7482` → IC=+0.231 (n=649)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7482 (IC base=+0.231)

- **PATRÓN** `volumen_spike_ratio` > `2.175` → IC=+0.235 (n=982)
...
- **PATRÓN** `volumen_regimen` < `0.873` → IC=+0.157 (n=1196)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1367` → IC=+0.153 (n=788)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 2.1367 (IC base=+0.137)

- **PATRÓN** `libro_liquidez` > `8015.433` → IC=+0.233 (n=813)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.158 (n=1283)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0066 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.4448` → IC=+0.150 (n=1458)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.4448 (IC base=+0.134)
...
- **PATRÓN** `ibs_20min` < `0.7091` → IC=+0.180 (n=1458)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.7091 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.1587` → IC=+0.137 (n=1261)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.1587 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.238` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.238 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.151 (n=642)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.695 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1945` → IC=+0.141 (n=486)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` > 1.1945 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.29` → IC=+0.236 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.29 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.146 (n=1385)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.4421 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `7204.7935` → IC=+0.197 (n=661)

  - _Acción_: Kelly boost +0.98€ cuando `libro_liquidez` > 7204.7935 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `176.0` → IC=+0.140 (n=1382)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 176.0 (IC base=+0.134)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.141 (n=1192)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.70€ cuando `sigma_h` > 0.0081 (IC base=+0.114)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.134 (n=1841)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.191 (n=1789)
...
- **PATRÓN** `volumen_regimen` < `0.8932` → IC=+0.135 (n=1193)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8932 (IC base=+0.114)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=1803)
...
- **PATRÓN** `volumen_regimen` < `0.6501` → IC=+0.157 (n=576)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6501 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2203` → IC=+0.167 (n=271)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2203 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.44` → IC=+0.139 (n=522)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.44 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2811.5163` → IC=+0.174 (n=575)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2811.5163 (IC base=+0.113)

- **PATRÓN** `ballena_activa_n` < `51.0` → IC=+0.124 (n=1352)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 51.0 (IC base=+0.113)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1818` → IC=+0.199 (n=1505)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.1818 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `1.4297` → IC=+0.200 (n=1710)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.148 (n=3199)

- **PATRÓN** `sigma_h` < `0.009` → IC=+0.171 (n=2709)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.009 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.5157` → IC=+0.170 (n=3079)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `dist_vwap_pct` > `0.1808` → IC=+0.171 (n=1147)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1808 (IC base=+0.160)

- **PATRÓN** `dist_vwap_pct` < `0.4702` → IC=+0.160 (n=1937)
...
- **PATRÓN** `volumen_regimen` > `0.6332` → IC=+0.163 (n=2067)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8746` → IC=+0.169 (n=2027)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.8746 (IC base=+0.160)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.161 (n=3432)
...
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.203 (n=804)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.4847` → IC=+0.165 (n=2411)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.252` → IC=+0.158 (n=2404)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` < 6.252 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `1.2445` → IC=+0.153 (n=2309)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2445 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` < `0.0966` → IC=+0.150 (n=2186)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5345` → IC=+0.159 (n=1048)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 1.5345 (IC base=+0.146)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=3199)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.01 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `7068.1056` → IC=+0.158 (n=2154)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4873` → IC=+0.183 (n=850)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.7393` → IC=+0.161 (n=850)

  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` < 0.7393 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.0956` → IC=+0.167 (n=850)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.639` → IC=+0.164 (n=875)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` < 6.639 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` < `0.6464` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.6464 (IC base=+0.156)

- **PATRÓN** `volumen_regimen` > `0.7218` → IC=+0.158 (n=760)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.7218 (IC base=+0.156)

- **PATRÓN** `volumen_pendiente_norm` < `0.1512` → IC=+0.158 (n=879)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1956` → IC=+0.173 (n=734)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 2.1956 (IC base=+0.156)

- **PATRÓN** `libro_liquidez` > `7521.9824` → IC=+0.174 (n=850)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7521.9824 (IC base=+0.156)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `sigma_h` < `0.0129` → IC=+0.132 (n=264)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0129 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.147 (n=182)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 6.0 (IC base=+0.115)
...
- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.160 (n=189)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.115)
...
- **PATRÓN** `volumen_regimen` < `0.9028` → IC=+0.140 (n=176)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 0.9028 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.1658` → IC=+0.199 (n=81)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.1658 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.137 (n=254)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4355 (IC base=+0.115)

- **PATRÓN** `libro_liquidez` > `3433.6178` → IC=+0.160 (n=236)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 3433.6178 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `58.0` → IC=+0.130 (n=217)
...
- **FILTRO** `py_entrada` < `0.42` → IC=-0.134 (n=375)

  - _Acción_: SKIP cuando `py_entrada` < 0.42
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=447)
...
- **FILTRO** `py_entrada` < `0.41` → IC=-0.262 (n=19)

  - _Acción_: SKIP cuando `py_entrada` < 0.41
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=45)

- **FILTRO** `profundidad_ratio` < `60.7` → IC=-0.220 (n=48)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7663)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.167 (n=3660)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=11225)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.165 (n=3813)

  - _Acción_: SKIP cuando `py_entrada` > 0.59
  - _Potencial_: sin este filtro IC_bueno=+0.035 (n=11590)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.208 (n=629)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.100 (n=1960)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.186 (n=654)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1986)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.206 (n=669)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=2095)
...
- **FILTRO** `py_entrada` > `0.57` → IC=-0.175 (n=665)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=2107)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.131 (n=10450)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=23462)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=8336)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=25576)

- **FILTRO** `ibs_7min` < `0.2801` → IC=-0.235 (n=8477)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2801
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=25435)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=11471)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=22441)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=10468)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=32240)

- **FILTRO** `ibs_7min` > `0.2923` → IC=-0.178 (n=10672)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2923
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=32036)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.137 (n=1702)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3935)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.311 (n=1337)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4300)

- **FILTRO** `ibs_7min` < `0.7117` → IC=-0.251 (n=1860)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7117
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3777)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.188 (n=1249)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4388)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.259 (n=1813)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5530)

- **FILTRO** `drift_7min_pct` |x|> `0.1106` → IC=-0.122 (n=2495)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1106
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4848)

- **FILTRO** `ibs_7min` > `0.7875` → IC=-0.208 (n=1835)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7875
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=5508)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.139 (n=1372)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4476)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1421)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4427)

- **FILTRO** `ibs_7min` < `0.7478` → IC=-0.193 (n=1462)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7478
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4386)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.177 (n=1455)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4393)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.264 (n=1368)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=4570)

- **FILTRO** `ibs_7min` > `0.2609` → IC=-0.181 (n=1482)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.166 (n=1313)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4051)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.304 (n=1326)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=4038)

- **FILTRO** `ibs_7min` < `0.1931` → IC=-0.260 (n=1341)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1931
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.239 (n=1810)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=6048)

- **FILTRO** `ibs_7min` > `0.75` → IC=-0.171 (n=1961)

  - _Acción_: SKIP cuando `ibs_7min` > 0.75
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5897)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=1802)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3791)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.233 (n=1654)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3939)

- **FILTRO** `ibs_7min` < `0.7406` → IC=-0.180 (n=1398)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7406
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=4195)

- **FILTRO** `ballena_activa_n` > `31.0` → IC=-0.173 (n=1394)

  - _Acción_: SKIP cuando `ballena_activa_n` > 31.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4199)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.257 (n=1428)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=4293)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.177 (n=1429)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=4292)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.183 (n=1396)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=4325)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1461)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4420)

- **FILTRO** `ibs_7min` < `0.2955` → IC=-0.235 (n=1470)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2955
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=4411)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.179 (n=1928)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=6207)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.254 (n=1825)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=3764)

- **FILTRO** `ibs_7min` < `0.299` → IC=-0.225 (n=1397)

  - _Acción_: SKIP cuando `ibs_7min` < 0.299
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4192)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1354)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4235)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.208 (n=1819)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=5894)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=1114)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.122 (n=353)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 14.0 (IC base=+0.110)

- **PATRÓN** `total_vol_5m` < `469.512` → IC=+0.144 (n=259)

  - _Acción_: Kelly boost +0.72€ cuando `total_vol_5m` < 469.512 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` < `13.0` → IC=+0.129 (n=138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 13.0 (IC base=+0.094)
...
- **PATRÓN** `libro_liquidez` > `3589.6144` → IC=+0.153 (n=70)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3589.6144 (IC base=+0.094)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1161)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=3011)
...
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.226 (n=571)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1268` → IC=+0.233 (n=609)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1268 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.198 (n=1594)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` > 6.0 (IC base=+0.186)

- **PATRÓN** `ibs_15` > `0.6079` → IC=+0.266 (n=1713)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6079 (IC base=+0.186)
...
- **PATRÓN** `libro_liquidez` > `2959.5754` → IC=+0.195 (n=1142)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 2959.5754 (IC base=+0.186)
...
### UPDOWN_GBM#SOL#5min
- **FILTRO** `dist_vwap_pct` > `0.6991` → IC=-0.153 (n=99)

  - _Acción_: SKIP cuando `dist_vwap_pct` > 0.6991
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1025)
...
- **FILTRO** `sigma_h` > `0.0128` → IC=-0.221 (n=686)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0128
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2061)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.202 (n=946)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=1801)

- **FILTRO** `libro_liquidez` < `3880.484` → IC=-0.142 (n=1813)

  - _Acción_: SKIP cuando `libro_liquidez` < 3880.484
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=934)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0763` → IC=+0.244 (n=1699)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0763 (IC base=-0.030)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1783` → IC=+0.238 (n=1230)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1783 (IC base=-0.030)

- **PATRÓN** `ibs_15` < `0.3482` → IC=+0.275 (n=1902)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3482 (IC base=-0.030)

- **PATRÓN** `dist_vwap_pct` > `0.6896` → IC=+0.301 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6896 (IC base=-0.030)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.245 (n=732)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.232)

- **PATRÓN** `drift_60min` |x|≤ `0.4388` → IC=+0.236 (n=732)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_15` < `0.2693` → IC=+0.283 (n=644)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.572` → IC=+0.253 (n=95)
...
- **FILTRO** `sigma_h` > `0.0102` → IC=-0.255 (n=161)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.144 (n=487)

- **FILTRO** `drift_60min` |x|> `0.1702` → IC=-0.220 (n=219)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.1999` → IC=-0.201 (n=272)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.1999
  - _Potencial_: sin este filtro IC_bueno=-0.199 (n=530)

- **FILTRO** `sigma_h` > `0.0197` → IC=-0.259 (n=400)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0197
  - _Potencial_: sin este filtro IC_bueno=-0.141 (n=402)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.261 (n=203)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.179 (n=599)

- **PATRÓN** `delta_ratio_macro` |x|> `0.136` → IC=+0.296 (n=228)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.136 (IC base=-0.041)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1053` → IC=+0.332 (n=218)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1053 (IC base=-0.041)

- **PATRÓN** `ibs_15` < `0.34` → IC=+0.304 (n=502)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.34 (IC base=-0.041)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6079 sube el IC de +0.186 a +0.266 en UPDOWN_GBM#15min (n=1713). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.052 a +0.157 en UPDOWN_GBM#XRP#15min (n=508). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3482 sube el IC de -0.030 a +0.275 en UPDOWN_GBM_15M_TARDIO (n=1902). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2693 sube el IC de +0.232 a +0.283 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=644). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.042 a +0.262 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=325). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.34 sube el IC de -0.041 a +0.304 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=502). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1350 | +0.100 | +202.26€ | 1 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1350 | +0.100 | +202.26€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 1009 | +0.109 | +174.56€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 1009 | +0.109 | +174.56€ | 2 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 255 | +0.056 | +9.04€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 255 | +0.056 | +9.04€ | 6 | 6 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 29160 | -0.086 | -3884.01€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1540 | -0.036 | -226.99€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 27620 | -0.088 | -3657.02€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7486 | -0.020 | -705.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7486 | -0.020 | -705.54€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 7110 | -0.089 | -447.87€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 7110 | -0.089 | -447.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5740 | -0.165 | -1089.07€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5740 | -0.165 | -1089.07€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 19400 | -0.026 | +3964.07€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 5045 | +0.001 | +1816.84€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 14355 | -0.036 | +2147.24€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 19400 | -0.026 | +3964.07€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 5045 | +0.001 | +1816.84€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 14355 | -0.036 | +2147.24€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 96640 | +0.113 | -4746.56€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 14455 | +0.185 | -431.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 391 | -0.075 | -50.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 