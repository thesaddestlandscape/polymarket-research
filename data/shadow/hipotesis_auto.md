# Hipótesis automáticas — 2026-09-20 20:46 UTC
_Generado por shadow_postmortem.py sobre 531419 resoluciones (PNL=+58821.84€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.254 (n=469)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.254 (n=469)
...
- **PATRÓN** `banda_hit_calibrado` > `0.804` → IC=+0.258 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.804 (IC base=+0.132)

- **PATRÓN** `banda_z` > `4.256` → IC=+0.160 (n=504)

  - _Acción_: Kelly boost +0.80€ cuando `banda_z` > 4.256 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.146 (n=354)
...
- **PATRÓN** `libro_liquidez` > `2876.7023` → IC=+0.145 (n=336)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.134 (n=162)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.262 (n=368)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.262 (n=368)
...
- **PATRÓN** `banda_hit_calibrado` > `0.802` → IC=+0.273 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.802 (IC base=+0.141)

- **PATRÓN** `banda_z` > `4.482` → IC=+0.170 (n=398)

  - _Acción_: Kelly boost +0.85€ cuando `banda_z` > 4.482 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.162 (n=140)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=452)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.96` → IC=-0.236 (n=6439)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.96
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=19319)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `140.44` → IC=-0.242 (n=878)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 140.44
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2637)

### BALLENAS_TARDIAS#BTC#15min
- **FILTRO** `restante_s_al_confirmar` < `493.55` → IC=-0.150 (n=344)
...
- **FILTRO** `restante_s_al_confirmar` < `160.44` → IC=-0.231 (n=1518)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 160.44
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4556)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `121.38` → IC=-0.366 (n=1273)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 121.38
  - _Potencial_: sin este filtro IC_bueno=-0.116 (n=3822)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.198 (n=12939)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3233)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5449.8817` → IC=+0.173 (n=2059)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5449.8817 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.144 (n=10217)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.351 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=1927)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15659.1031` → IC=+0.234 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15659.1031 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.204 (n=1398)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.199 (n=1971)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.151 (n=2589)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.334 (n=852)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.254 (n=493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.243 (n=1378)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.236)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.146 (n=422)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 11.0 (IC base=+0.136)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.141 (n=694)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `1297.853` → IC=+0.147 (n=602)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.226 (n=654)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` > `0.86` → IC=+0.429 (n=579)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=10379)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3586)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=2548)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.287 (n=298)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.185 (n=2369)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=2426)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.192 (n=1757)

  - _Acción_: Kelly boost +0.96€ cuando `py_entrada` < 0.71 (IC base=+0.190)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.190 (n=974)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.200 (n=30780)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.198)

- **PATRÓN** `py_entrada` > `0.76` → IC=+0.240 (n=11547)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.76 (IC base=+0.198)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.174 (n=6271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=5722)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.71 (IC base=+0.174)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.226 (n=5502)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.232 (n=2762)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.18` → IC=+0.146 (n=4295)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.18 (IC base=+0.120)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.202 (n=2383)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.124)

- **PATRÓN** `restante_min` < `4.06` → IC=+0.134 (n=2137)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 4.06 (IC base=+0.124)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.141 (n=2220)
...
- **PATRÓN** `lag_apertura_s` < `3.55` → IC=+0.146 (n=2131)

  - _Acción_: Kelly boost +0.73€ cuando `lag_apertura_s` < 3.55 (IC base=+0.124)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.199 (n=2328)
...
- **PATRÓN** `libro_liquidez` > `1583.3801` → IC=+0.295 (n=1023)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.333 (n=345)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.445 (n=474)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.935` → IC=+0.441 (n=469)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.438 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.437)

- **PATRÓN** `libro_liquidez` > `1835.6869` → IC=+0.440 (n=400)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1835.6869 (IC base=+0.437)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.443 (n=208)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.439)

- **PATRÓN** `py_entrada` < `0.93` → IC=+0.452 (n=184)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.440 (n=248)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.3537` → IC=+0.126 (n=6310)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.3537 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.9804` → IC=+0.240 (n=2393)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9804 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.5957` → IC=+0.245 (n=2000)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5957 (IC base=+0.102)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.919` → IC=+0.174 (n=2766)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.919 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.245 (n=1893)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.102)

- **PATRÓN** `volumen_regimen` > `1.05` → IC=+0.244 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.05 (IC base=+0.102)

- **PATRÓN** `volumen_pendiente_norm` > `0.3076` → IC=+0.211 (n=703)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3076 (IC base=+0.102)

- **PATRÓN** `volumen_spike_ratio` > `1.9158` → IC=+0.204 (n=3228)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9158 (IC base=+0.102)

- **PATRÓN** `ibs_20min` < `0.5703` → IC=+0.132 (n=8664)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5703 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5667` → IC=+0.195 (n=592)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5667 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.1424` → IC=+0.172 (n=2693)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.1424 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.7012` → IC=+0.175 (n=1298)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.7012 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.173 (n=1967)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.8699 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.1681` → IC=+0.223 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1681 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5844` → IC=+0.201 (n=4384)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5844 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `144.0` → IC=+0.211 (n=4691)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.047` → IC=+0.273 (n=707)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.047 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.207 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.166 (n=1512)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0049` → IC=+0.247 (n=1065)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0049 (IC base=+0.234)

- **PATRÓN** `drift_60min` |x|≤ `0.0886` → IC=+0.289 (n=397)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.0604` → IC=+0.298 (n=524)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0604 (IC base=+0.234)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.381` → IC=+0.248 (n=1249)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6424` → IC=+0.254 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6424 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `1774.62` → IC=+0.243 (n=793)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1774.62 (IC base=+0.234)
...
- **PATRÓN** `volumen_regimen` < `1.2518` → IC=+0.220 (n=1229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2518 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.8719` → IC=+0.214 (n=819)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3804` → IC=+0.217 (n=401)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3804 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `15820.2665` → IC=+0.225 (n=557)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15820.2665 (IC base=+0.212)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.172 (n=434)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0026 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.158 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.165 (n=431)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 18.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6835` → IC=+0.166 (n=1291)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.6835 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.1254` → IC=+0.151 (n=1160)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1254 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.539` → IC=+0.157 (n=418)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 6.539 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.146 (n=1291)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 1.2046 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.6181` → IC=+0.135 (n=1290)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.6181 (IC base=+0.134)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.017` → IC=+0.240 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.017 (IC base=+0.184)

- **PATRÓN** `volumen_pendiente_norm` < `0.2141` → IC=+0.187 (n=1566)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2141 (IC base=+0.184)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.394` → IC=+0.219 (n=1474)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2814` → IC=+0.229 (n=812)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2814 (IC base=+0.218)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.231 (n=837)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.218)

- **PATRÓN** `libro_liquidez` > `1862.6032` → IC=+0.229 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1862.6032 (IC base=+0.218)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.227 (n=792)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=92)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=1992)

- **PATRÓN** `ibs_20min` > `0.9396` → IC=+0.199 (n=324)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9396 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` > `0.3442` → IC=+0.348 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3442 (IC base=+0.019)

- **PATRÓN** `dist_vwap_pct` < `0.6795` → IC=+0.327 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6795 (IC base=+0.019)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.632` → IC=+0.149 (n=630)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 4.632 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` < `0.8497` → IC=+0.336 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8497 (IC base=+0.019)

- **PATRÓN** `volumen_regimen` > `1.0371` → IC=+0.322 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0371 (IC base=+0.019)
...
- **PATRÓN** `dist_vwap_pct` > `0.3099` → IC=+0.167 (n=223)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.3099 (IC base=+0.009)

- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.151 (n=476)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.856 (IC base=+0.009)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5154` → IC=+0.178 (n=589)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 1.5154 (IC base=+0.009)
...
- **FILTRO** `ibs_20min` > `0.2632` → IC=-0.128 (n=1977)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2632
  - _Potencial_: sin este filtro IC_bueno=+0.126 (n=978)

- **FILTRO** `sigma_ewma_delta_pct` > `8.637` → IC=-0.205 (n=320)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.637
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2635)
...
- **PATRÓN** `ibs_20min` < `0.2632` → IC=+0.126 (n=978)
...
- **FILTRO** `ibs_20min` > `0.7734` → IC=-0.203 (n=746)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7734
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=2240)

- **PATRÓN** `dist_vwap_pct` > `0.941` → IC=+0.296 (n=47)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.941 (IC base=-0.077)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.191 (n=2977)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0094 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4671` → IC=+0.186 (n=7975)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4671 (IC base=+0.094)

- **PATRÓN** `dist_vwap_pct` > `0.704` → IC=+0.284 (n=896)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.704 (IC base=+0.094)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.547` → IC=+0.151 (n=4242)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 3.547 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` < `1.1729` → IC=+0.231 (n=3119)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1729 (IC base=+0.094)

- **PATRÓN** `volumen_regimen` > `0.6817` → IC=+0.241 (n=2786)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6817 (IC base=+0.094)

- **PATRÓN** `volumen_pendiente_norm` > `0.2988` → IC=+0.260 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2988 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` < `1.4757` → IC=+0.242 (n=1687)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4757 (IC base=+0.094)

- **PATRÓN** `volumen_spike_ratio` > `2.712` → IC=+0.243 (n=1687)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.712 (IC base=+0.094)

- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.271 (n=4572)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 99.0 (IC base=+0.094)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.147 (n=3021)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0088 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.5512` → IC=+0.150 (n=7955)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5512 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` > `0.6769` → IC=+0.237 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6769 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.1702` → IC=+0.236 (n=2346)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1702 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `0.7156` → IC=+0.237 (n=1137)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7156 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.1998` → IC=+0.245 (n=861)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1998 (IC base=+0.070)

- **PATRÓN** `volumen_pendiente_norm` > `0.2482` → IC=+0.310 (n=661)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2482 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `1.4913` → IC=+0.252 (n=1122)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4913 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `2.3535` → IC=+0.259 (n=1526)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3535 (IC base=+0.070)

- **PATRÓN** `ballena_activa_n` < `81.0` → IC=+0.263 (n=3238)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 81.0 (IC base=+0.070)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.494` → IC=-0.163 (n=478)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.494
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1613)

- **PATRÓN** `ibs_20min` > `0.8933` → IC=+0.272 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8933 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.675` → IC=+0.200 (n=338)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.675 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2236` → IC=+0.276 (n=150)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2236 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `1.4428` → IC=+0.186 (n=250)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` < 1.4428 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` > `2.1623` → IC=+0.199 (n=340)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.1623 (IC base=+0.048)
...
- **FILTRO** `ibs_20min` > `0.8163` → IC=-0.147 (n=653)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8163
  - _Potencial_: sin este filtro IC_bueno=+0.048 (n=1960)

- **PATRÓN** `ibs_20min` > `0.86` → IC=+0.157 (n=601)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.86 (IC base=+0.019)
...
- **PATRÓN** `sigma_h` > `0.0076` → IC=+0.286 (n=945)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.244 (n=709)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.326 (n=384)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.284)

- **PATRÓN** `ibs_20min` < `0.3357` → IC=+0.289 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3357 (IC base=+0.284)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3452` → IC=+0.317 (n=173)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3452 (IC base=+0.284)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2107` → IC=+0.289 (n=684)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2107 (IC base=+0.284)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.296 (n=694)
...
- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.289 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.284)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2676` → IC=-0.198 (n=428)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2676
  - _Potencial_: sin este filtro IC_bueno=+0.072 (n=1287)

- **FILTRO** `ibs_20min` > `0.7868` → IC=-0.177 (n=534)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7868
  - _Potencial_: sin este filtro IC_bueno=+0.046 (n=1603)

- **PATRÓN** `ibs_20min` > `0.8045` → IC=+0.157 (n=584)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.8045 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.4431` → IC=+0.217 (n=203)
...
- **FILTRO** `ibs_20min` > `0.6944` → IC=-0.232 (n=498)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6944
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1502)

- **FILTRO** `sigma_ewma_delta_pct` > `4.677` → IC=-0.176 (n=445)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.677
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1555)
...
- **PATRÓN** `volumen_regimen` > `0.724` → IC=+0.284 (n=613)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.724 (IC base=+0.032)
...
- **PATRÓN** `volumen_regimen` < `0.7092` → IC=+0.268 (n=209)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7092 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` < `0.1001` → IC=+0.207 (n=431)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2213` → IC=+0.200 (n=68)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2213 (IC base=+0.011)

- **PATRÓN** `volumen_spike_ratio` < `2.5185` → IC=+0.220 (n=440)
...
- **PATRÓN** `sigma_h` > `0.0161` → IC=+0.318 (n=778)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3958` → IC=+0.305 (n=1287)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3958 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.5366` → IC=+0.284 (n=359)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.455` → IC=+0.290 (n=464)
...
- **PATRÓN** `dist_vwap_pct` > `0.1685` → IC=+0.195 (n=3059)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1685 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.256 (n=1446)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2134` → IC=+0.160 (n=4654)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2134 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6255` → IC=+0.157 (n=4654)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.6255 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2463` → IC=+0.192 (n=1409)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.2463 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.452` → IC=+0.172 (n=2241)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.452 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6482` → IC=+0.174 (n=2241)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6482 (IC base=+0.167)

- **PATRÓN** `libro_liquidez` > `2372.0487` → IC=+0.167 (n=4694)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2372.0487 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.180 (n=5955)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 118.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.182 (n=4486)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0065 (IC base=+0.168)

- **PATRÓN** `drift_60min` |x|≤ `0.0794` → IC=+0.202 (n=2241)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0794 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.208 (n=2267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` < `0.4753` → IC=+0.226 (n=6719)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4753 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2247` → IC=+0.159 (n=4930)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2247 (IC base=+0.168)
...
- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.151 (n=4902)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5744` → IC=+0.167 (n=2663)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5744 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6482` → IC=+0.174 (n=2017)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6482 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.171 (n=5687)
...
- **PATRÓN** `volumen_regimen` < `1.2096` → IC=+0.154 (n=1144)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.2096 (IC base=+0.136)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4443` → IC=+0.147 (n=1033)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4315` → IC=+0.162 (n=1117)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.4315 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.163 (n=1120)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3958` → IC=+0.202 (n=1117)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3958 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1502` → IC=+0.184 (n=747)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1502 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `1.048` → IC=+0.155 (n=983)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.048 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` > `1.1897` → IC=+0.153 (n=373)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1897 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` < `0.8536` → IC=+0.143 (n=787)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7931` → IC=+0.124 (n=708)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 1.7931 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.4834` → IC=+0.140 (n=354)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 2.4834 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `9988.1936` → IC=+0.159 (n=535)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 9988.1936 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `171.0` → IC=+0.123 (n=995)

  - _Acción_: Kelly boost +0.61€ cuando `ballena_activa_n` < 171.0 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0099` → IC=+0.163 (n=582)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0099 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.133 (n=1317)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` > `0.5156` → IC=+0.203 (n=1280)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.527` → IC=+0.252 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.527 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2233` → IC=+0.127 (n=1281)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.126 (n=1333)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.147 (n=573)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.006 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1009` → IC=+0.141 (n=433)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.71€ cuando `drift_60min` |x|≤ 0.1009 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1322)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.205 (n=1299)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.9557` → IC=+0.143 (n=166)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.9557 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.1936` → IC=+0.134 (n=1191)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.1936 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.408` → IC=+0.156 (n=271)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 7.408 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `1.0418` → IC=+0.121 (n=1142)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_regimen` < 1.0418 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.2773` → IC=+0.165 (n=159)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.2773 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.4589` → IC=+0.141 (n=385)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4589 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `3069.2676` → IC=+0.158 (n=433)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3069.2676 (IC base=+0.110)
...
- **PATRÓN** `ibs_20min` < `0.3319` → IC=+0.141 (n=296)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` < 0.3319 (IC base=+0.077)

- **PATRÓN** `volumen_pendiente_norm` > `0.1654` → IC=+0.120 (n=106)

  - _Acción_: Kelly boost +0.60€ cuando `volumen_pendiente_norm` > 0.1654 (IC base=+0.077)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0109` → IC=+0.198 (n=2986)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0109 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=9368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.4706` → IC=+0.215 (n=8962)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4706 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` > `0.8979` → IC=+0.197 (n=1217)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.8979 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.599` → IC=+0.225 (n=4369)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.599 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `0.8811` → IC=+0.165 (n=3993)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8811 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.2401` → IC=+0.195 (n=1672)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2401 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.6243` → IC=+0.187 (n=2857)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 2.6243 (IC base=+0.166)

- **PATRÓN** `libro_liquidez` > `2322.7138` → IC=+0.168 (n=5968)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2322.7138 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `89.0` → IC=+0.193 (n=6675)

  - _Acción_: Kelly boost +0.96€ cuando `ballena_activa_n` < 89.0 (IC base=+0.166)

- **PATRÓN** `sigma_h` < `0.0053` → IC=+0.195 (n=3579)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.97€ cuando `sigma_h` < 0.0053 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1439` → IC=+0.185 (n=3578)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.1439 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.206 (n=3104)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5642` → IC=+0.238 (n=8130)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.882` → IC=+0.200 (n=1148)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.882 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.696` → IC=+0.182 (n=7884)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.696 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.7046` → IC=+0.159 (n=2477)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7046 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.152 (n=1877)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2022 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2885` → IC=+0.244 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2885 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.288` → IC=+0.190 (n=3351)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` > 2.288 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.198 (n=2335)
...
- **PATRÓN** `ibs_20min` < `0.3451` → IC=+0.290 (n=1023)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3451 (IC base=+0.257)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.422` → IC=+0.265 (n=1229)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8725` → IC=+0.279 (n=704)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=1493)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3102` → IC=+0.201 (n=1428)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3102 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.124` → IC=+0.183 (n=803)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.124 (IC base=+0.147)
...
- **PATRÓN** `volumen_regimen` < `0.6261` → IC=+0.182 (n=476)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` < 0.6261 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2688` → IC=+0.188 (n=206)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_pendiente_norm` > 0.2688 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1192` → IC=+0.157 (n=1208)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1192 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4084` → IC=+0.152 (n=1373)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4084 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `13656.0542` → IC=+0.151 (n=952)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 13656.0542 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `482.0` → IC=+0.156 (n=1305)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 482.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.161 (n=1246)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0056 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0782` → IC=+0.177 (n=416)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.0782 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.175 (n=420)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 18.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.6433` → IC=+0.191 (n=1246)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6433 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6839` → IC=+0.163 (n=200)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.6839 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1283` → IC=+0.163 (n=1135)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1283 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.154` → IC=+0.157 (n=608)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 3.154 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.1862` → IC=+0.160 (n=1246)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1862 (IC base=+0.147)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4305` → IC=+0.159 (n=1149)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` < 2.4305 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7532` → IC=+0.156 (n=766)
...
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.234 (n=961)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.215)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.221 (n=1511)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.733` → IC=+0.292 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.733 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` < `0.2156` → IC=+0.222 (n=1409)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2156 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.9133` → IC=+0.248 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9133 (IC base=+0.215)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.227 (n=949)
...
- **PATRÓN** `ibs_20min` < `0.3651` → IC=+0.269 (n=1179)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2335` → IC=+0.237 (n=809)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2335 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.252 (n=835)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.237)

- **PATRÓN** `libro_liquidez` > `1863.8584` → IC=+0.250 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1863.8584 (IC base=+0.237)

- **PATRÓN** `ballena_activa_n` < `32.0` → IC=+0.244 (n=765)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 32.0 (IC base=+0.237)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.183 (n=512)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0034 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4329` → IC=+0.143 (n=1528)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4329 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=1603)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.5586` → IC=+0.174 (n=434)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.5586 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` < `0.8773` → IC=+0.161 (n=1019)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8773 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2789` → IC=+0.230 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2789 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.5223` → IC=+0.153 (n=649)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 1.5223 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4149` → IC=+0.147 (n=1474)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4149 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8150.9955` → IC=+0.228 (n=693)
...
- **PATRÓN** `ibs_20min` < `0.6906` → IC=+0.189 (n=1240)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.6906 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.3593` → IC=+0.140 (n=1244)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3593 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.009` → IC=+0.190 (n=185)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` > 11.009 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.6969` → IC=+0.144 (n=546)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6969 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` > `1.1778` → IC=+0.146 (n=413)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1778 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2803` → IC=+0.265 (n=147)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2803 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `1.4415` → IC=+0.152 (n=1169)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4415 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `11008.1959` → IC=+0.208 (n=413)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11008.1959 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.142 (n=1163)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 184.0 (IC base=+0.135)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.132 (n=1012)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` > 0.0079 (IC base=+0.105)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=570)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.4695` → IC=+0.186 (n=1518)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.4695 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `1.0427` → IC=+0.196 (n=284)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.0427 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.403` → IC=+0.228 (n=576)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.403 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.120 (n=1520)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2907.4324` → IC=+0.244 (n=506)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2907.4324 (IC base=+0.105)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.126 (n=1137)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 53.0 (IC base=+0.105)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.175 (n=499)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0057 (IC base=+0.110)

- **PATRÓN** `drift_60min` |x|≤ `0.1278` → IC=+0.150 (n=498)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.75€ cuando `drift_60min` |x|≤ 0.1278 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.123 (n=1545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.205 (n=1491)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.2141` → IC=+0.128 (n=1209)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.2141 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.43` → IC=+0.125 (n=1439)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.43 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.7164` → IC=+0.154 (n=655)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.7164 (IC base=+0.110)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4566` → IC=+0.139 (n=444)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4566 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2851.5493` → IC=+0.159 (n=496)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 2851.5493 (IC base=+0.110)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=1011)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.208 (n=1586)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.5124` → IC=+0.245 (n=1517)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5124 (IC base=+0.203)

- **PATRÓN** `dist_vwap_pct` > `0.188` → IC=+0.225 (n=870)
...
- **PATRÓN** `volumen_regimen` < `1.0734` → IC=+0.203 (n=1335)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0734 (IC base=+0.203)

- **PATRÓN** `volumen_regimen` > `0.6343` → IC=+0.209 (n=1517)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6343 (IC base=+0.203)

- **PATRÓN** `volumen_pendiente_norm` > `0.2359` → IC=+0.236 (n=267)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2359 (IC base=+0.203)

- **PATRÓN** `volumen_spike_ratio` > `2.5302` → IC=+0.232 (n=487)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5302 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.209 (n=1564)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `2595.4538` → IC=+0.209 (n=1011)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2595.4538 (IC base=+0.203)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.232 (n=553)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.210 (n=812)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.52` → IC=+0.257 (n=1657)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.52 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.8353` → IC=+0.203 (n=1853)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8353 (IC base=+0.201)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2827` → IC=+0.253 (n=221)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4437` → IC=+0.201 (n=1474)
...
- **PATRÓN** `dist_vwap_pct` > `0.1877` → IC=+0.161 (n=945)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` > 0.1877 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.4988` → IC=+0.140 (n=1594)
...
- **PATRÓN** `volumen_regimen` > `0.9039` → IC=+0.162 (n=1127)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.9039 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1731` → IC=+0.182 (n=738)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8934` → IC=+0.162 (n=1779)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8934 (IC base=+0.150)

- **PATRÓN** `libro_liquidez` > `3623.6984` → IC=+0.155 (n=1799)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.173 (n=310)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.170 (n=359)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 5.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` < `0.5245` → IC=+0.200 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5245 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2159` → IC=+0.185 (n=160)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.2159 (IC base=+0.162)
...
- **PATRÓN** `volumen_regimen` > `0.8476` → IC=+0.199 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8476 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.3102` → IC=+0.316 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3102 (IC base=+0.162)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7581` → IC=+0.206 (n=117)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7581 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `12565.4829` → IC=+0.203 (n=314)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.42` → IC=+0.139 (n=81)
  ...
  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 2.42 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` > `0.1583` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1583 (IC base=+0.039)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.147 (n=219)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 16.0 (IC base=+0.110)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.127 (n=591)

  - _Acción_: Kelly boost +0.64€ cuando `py_entrada` > 0.5 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `2844.317` → IC=+0.172 (n=202)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 2844.317 (IC base=+0.110)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=7208)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.178 (n=3021)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.057 (n=9465)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.172 (n=3149)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=9798)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.44` → IC=-0.220 (n=516)

  - _Acción_: SKIP cuando `py_entrada` < 0.44
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1633)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.170 (n=541)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.060 (n=1769)

- **PATRÓN** `py_entrada` > `0.5` → IC=+0.123 (n=1295)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.202 (n=544)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1638)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=572)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1729)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.193 (n=526)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=1594)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.178 (n=575)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.055 (n=1729)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=2600)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=2737)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=2743)

### MOMENTUM_IBS_15M_FADE#BTC#15min
- **FILTRO** `hora_utc` < `15.0` → IC=-0.160 (n=92)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=337)
...
- **FILTRO** `drift_20min_pct` |x|> `0.1487` → IC=-0.167 (n=88)

  - _Acción_: SKIP cuando `drift_20min_pct` |x|> 0.1487
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=711)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=8892)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=20028)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.278 (n=6965)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=21955)

- **FILTRO** `ibs_7min` < `0.2941` → IC=-0.236 (n=7224)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=21696)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.159 (n=9780)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=19140)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.228 (n=9017)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=27175)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.179 (n=9033)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=27159)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=1129)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3599)

- **FILTRO** `ibs_7min` < `0.7091` → IC=-0.256 (n=1559)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7091
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3169)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.179 (n=1143)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3585)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.152 (n=4200)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.102 (n=2050)

- **FILTRO** `drift_7min_pct` |x|> `0.1115` → IC=-0.128 (n=2124)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1115
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4126)

- **FILTRO** `ibs_7min` > `0.7929` → IC=-0.205 (n=1562)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=1167)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3856)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.253 (n=1213)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3810)

- **FILTRO** `ibs_7min` < `0.752` → IC=-0.188 (n=1255)

  - _Acción_: SKIP cuando `ibs_7min` < 0.752
  - _Potencial_: sin este filtro IC_bueno=-0.068 (n=3768)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1254)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3769)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.257 (n=1246)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=3833)

- **FILTRO** `ibs_7min` > `0.2581` → IC=-0.172 (n=1269)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3810)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.186 (n=1263)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3816)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.173 (n=1097)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=3372)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.311 (n=1083)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=3386)

- **FILTRO** `ibs_7min` < `0.1972` → IC=-0.259 (n=1117)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1972
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=3352)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.213 (n=1087)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.073 (n=3382)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1543)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5088)

- **FILTRO** `ibs_7min` > `0.759` → IC=-0.176 (n=1657)

  - _Acción_: SKIP cuando `ibs_7min` > 0.759
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=4974)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.087 (n=3238)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.247 (n=1167)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3589)

- **FILTRO** `ibs_7min` < `0.7428` → IC=-0.181 (n=1189)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7428
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3567)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.180 (n=1157)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3599)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.261 (n=1214)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=3658)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.173 (n=1217)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3655)

- **FILTRO** `ballena_activa_n` > `29.0` → IC=-0.187 (n=1217)

  - _Acción_: SKIP cuando `ballena_activa_n` > 29.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3655)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.267 (n=1192)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=3912)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.230 (n=1274)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3830)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1659)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5206)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.34` → IC=-0.279 (n=1119)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=3721)

- **FILTRO** `ibs_7min` < `0.7098` → IC=-0.230 (n=1210)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=3630)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1165)
...
- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1611)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=4884)
...
- **FILTRO** `sigma_h` > `0.0053` → IC=-0.326 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.128 (n=41)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=1065)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2647)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1625` → IC=+0.193 (n=1208)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2175` → IC=+0.188 (n=459)
  ...
  - _Acción_: Kelly boost +0.94€ cuando `delta_ratio_macro` |x|> 0.2175 (IC base=+0.186)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1321` → IC=+0.233 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1321 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.197 (n=974)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6137` → IC=+0.260 (n=1373)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6137 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` > `0.4449` → IC=+0.182 (n=322)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.4449 (IC base=+0.186)

- **PATRÓN** `dist_vwap_pct` < `0.5589` → IC=+0.174 (n=1352)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.5589 (IC base=+0.186)
...
- **PATRÓN** `libro_liquidez` > `2964.3096` → IC=+0.194 (n=915)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.222 (n=16)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=464)
...
- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.170 (n=107)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0034 (IC base=+0.140)

- **PATRÓN** `sigma_h` > `0.0057` → IC=+0.160 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0057 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0692` → IC=+0.164 (n=141)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.0692 (IC base=+0.140)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.161 (n=213)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.80€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.140)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.263` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.263 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.164 (n=239)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6255` → IC=+0.227 (n=320)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6255 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.5388` → IC=+0.143 (n=68)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` > 0.5388 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1542` → IC=+0.160 (n=248)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1542 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.619` → IC=+0.214 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.619 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9553.1781` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 9553.1781 (IC base=+0.140)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.188 (n=768)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=1613)

- **FILTRO** `libro_liquidez` < `3905.4186` → IC=-0.133 (n=1571)
...
- **FILTRO** `sigma_h` > `0.0069` → IC=-0.217 (n=358)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.192 (n=1076)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.226 (n=473)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.184 (n=961)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=908)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.243 (n=255)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1179)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6137 sube el IC de +0.186 a +0.260 en UPDOWN_GBM#15min (n=1373). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6255 sube el IC de +0.140 a +0.227 en UPDOWN_GBM#ETH#15min (n=320). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.045 a +0.164 en UPDOWN_GBM#XRP#15min (n=415). Ya aplicado como kelly_boost=+0.82€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6314 sube el IC de -0.058 a +0.266 en UPDOWN_GBM_15M_TARDIO (n=588). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1226 | +0.090 | +152.60€ | 2 | 7 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1226 | +0.090 | +152.60€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 898 | +0.099 | +129.25€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 898 | +0.099 | +129.25€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 242 | +0.045 | +4.70€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 242 | +0.045 | +4.70€ | 4 | 5 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 60 | +0.145 | +20.16€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 60 | +0.145 | +20.16€ | 0 | 7 |
| ✅ BALLENAS_TARDIAS | 23027 | -0.093 | -3082.14€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1379 | -0.042 | -201.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 21648 | -0.096 | -2880.81€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3515 | -0.087 | -579.24€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3515 | -0.087 | -579.24€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 1379 | -0.042 | -201.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 1379 | -0.042 | -201.33€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 374 | -0.136 | -161.05€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 374 | -0.136 | -161.05€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 6590 | -0.035 | -606.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 6590 | -0.035 | -606.69€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6074 | -0.095 | -441.38€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6074 | -0.095 | -441.38€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5095 | -0.179 | -1092.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5095 | -0.179 | -1092.45€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 15362 | -0.033 | +4134.02€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4050 | -0.002 | +1830.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 11312 | -0.044 | +2303.79€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 15362 | -0.033 | +4134.02€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 4050 | -0.002 | +1830.23€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 11312 | -0.044 | +2303.79€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1370 | -0.102 | -186.03€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 149 | -0.043 | -15.16€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 1221 | -0.109 | -170.88€ | 0 | 0 |
...
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 414 | -0.130 | -74.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 390 | -0.133 | -69.33€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 119 | -0.045 | -14.09€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 57 | -0.161 | -4.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 84143 | +0.113 | -4273.16€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 12924 | +0.184 | -412.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 332 | -0.105 | -46.87€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 65275 | +0.100 | -3630.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5612 | +0.110 | -183.13€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 10864 | +0.098 | -960.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 42 | -0.159 | -1.60€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 10807 | +0.099 | -946.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 17021 | +0.132 | -334.73€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 4022 | +0.201 | -133.71€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 10818 | +0.112 | -159.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 2139 | +0.109 | -19.20€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 10904 | +0.087 | -1069.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 49 | -0.069 | -3.34€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 10840 | +0.089 | -1054.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 17961 | +0.124 | -339.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4999 | +0.175 | -77.50€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 10926 | +0.106 | -204.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 2024 | +0.098 | -48.82€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 16512 | +0.115 | -939.68€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3770 | +0.187 | -205.82€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 235 | -0.065 | +7.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 11058 | +0.093 | -625.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1449 | +0.130 | -115.11€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 10881 | +0.102 | -630.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 42 | -0.023 | +9.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 10826 | +0.103 | -639.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 13327 | +0.191 | -884.02€ | 2 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 13327 | +0.191 | -884.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 