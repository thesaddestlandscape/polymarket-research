# Hipótesis automáticas — 2026-07-15 13:38 UTC
_Generado por shadow_postmortem.py sobre 15373 resoluciones (PNL=+3007.03€)_
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.313 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.194)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.198 (n=901)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `4402.2111` → IC=+0.195 (n=509)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 4402.2111 (IC base=+0.194)
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.321 (n=288)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.158)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.169 (n=982)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.158)

- **PATRÓN** `libro_liquidez` > `4660.5456` → IC=+0.170 (n=573)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 4660.5456 (IC base=+0.158)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.219 (n=119)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.210 (n=150)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.200)

- **PATRÓN** `py_entrada` > `0.615` → IC=+0.257 (n=150)
...
- **PATRÓN** `py_entrada` < `0.235` → IC=+0.387 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.235 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `7240.499` → IC=+0.207 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7240.499 (IC base=+0.196)
...
- **PATRÓN** `py_entrada` < `0.245` → IC=+0.368 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.245 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `3727.5827` → IC=+0.203 (n=180)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3727.5827 (IC base=+0.201)
...
- **PATRÓN** `py_entrada` > `0.675` → IC=+0.330 (n=110)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.675 (IC base=+0.229)

- **PATRÓN** `libro_liquidez` > `1632.5658` → IC=+0.231 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1632.5658 (IC base=+0.229)
...
### GBM_LATE_15M
- **PATRÓN** `sigma_ewma_delta_pct` > `6.947` → IC=+0.207 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.947 (IC base=+0.107)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.132 (n=1172)
...
- **PATRÓN** `dist_vwap_pct` > `0.3108` → IC=+0.125 (n=22)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.3108 (IC base=+0.079)
...
- **PATRÓN** `dist_vwap_pct` > `0.1487` → IC=+0.129 (n=33)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` > 0.1487 (IC base=+0.059)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.941` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `sigma_ewma_delta_pct` > 2.941 (IC base=+0.059)
...
- **PATRÓN** `dist_vwap_pct` > `0.7087` → IC=+0.167 (n=34)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.7087 (IC base=+0.063)
...
- **PATRÓN** `sigma_h` > `0.0093` → IC=+0.137 (n=441)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` < `0.0296` → IC=+0.141 (n=419)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` < 0.0296 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0226` → IC=+0.172 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0226 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.149 (n=442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.6733` → IC=+0.167 (n=25)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.6733 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.431` → IC=+0.180 (n=23)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 9.431 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0261` → IC=+0.200 (n=148)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0261 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.242 (n=161)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.161)

- **PATRÓN** `dist_vwap_pct` < `0.5367` → IC=+0.130 (n=152)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.5367 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.082` → IC=+0.122 (n=125)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 6.082 (IC base=+0.161)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0121` → IC=+0.234 (n=220)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0121 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.178 (n=461)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 12.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.167 (n=692)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 18.0 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `1.0527` → IC=+0.237 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0527 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.179` → IC=+0.308 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.179 (IC base=+0.162)

- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.180 (n=680)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` < `0.4426` → IC=+0.195 (n=457)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` < 0.4426 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.927` → IC=+0.214 (n=54)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.927 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.082` → IC=+0.173 (n=337)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 3.082 (IC base=+0.160)
...
- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.182 (n=171)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0027 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.179 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.3101` → IC=+0.147 (n=15)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.3101 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.1967` → IC=+0.136 (n=116)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.1967 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.106` → IC=+0.289 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.106 (IC base=+0.139)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **PATRÓN** `sigma_h` > `0.0067` → IC=+0.232 (n=80)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0067 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.169 (n=119)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 12.0 (IC base=+0.147)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.165 (n=186)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.659` → IC=+0.250 (n=30)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.659 (IC base=+0.147)
...
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.136 (n=152)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0066 (IC base=+0.128)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.144 (n=172)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.7151` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.7151 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` < `1.1646` → IC=+0.159 (n=127)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 1.1646 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.0` → IC=+0.183 (n=39)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` > 5.0 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.121` → IC=+0.157 (n=97)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` < 10.121 (IC base=+0.128)
...
- **PATRÓN** `sigma_h` > `0.0127` → IC=+0.223 (n=81)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0127 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.151 (n=170)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 8.0 (IC base=+0.136)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.137 (n=122)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 12.0 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.4611` → IC=+0.194 (n=47)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.4611 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `1.0918` → IC=+0.146 (n=128)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 1.0918 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.268` → IC=+0.250 (n=62)
...
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.324 (n=151)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.287)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.294 (n=100)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.287)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.300 (n=138)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.287)

- **PATRÓN** `dist_vwap_pct` < `0.3458` → IC=+0.307 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.3458 (IC base=+0.287)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.071` → IC=+0.304 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.071 (IC base=+0.287)

### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0146` → IC=+0.163 (n=200)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0146 (IC base=+0.102)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.124 (n=540)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 15.0 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.6728` → IC=+0.174 (n=93)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.6728 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.125 (n=190)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.102)
...
- **PATRÓN** `sigma_h` < `0.0043` → IC=+0.138 (n=67)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0043 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.8371` → IC=+0.154 (n=24)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.8371 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.023` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.023 (IC base=+0.052)
...
- **PATRÓN** `sigma_h` < `0.0323` → IC=+0.198 (n=170)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0323 (IC base=+0.189)

- **PATRÓN** `sigma_h` > `0.0176` → IC=+0.213 (n=113)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0176 (IC base=+0.189)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.218 (n=154)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` > `0.1836` → IC=+0.222 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1836 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` < `1.4499` → IC=+0.177 (n=94)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` < 1.4499 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.343` → IC=+0.250 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.343 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.141` → IC=+0.171 (n=71)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` < 11.141 (IC base=+0.189)

- **PATRÓN** `sigma_h` < `0.0208` → IC=+0.187 (n=212)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0208 (IC base=+0.187)

- **PATRÓN** `sigma_h` > `0.0174` → IC=+0.204 (n=96)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0174 (IC base=+0.187)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.247 (n=73)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.5085` → IC=+0.171 (n=153)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.5085 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.549` → IC=+0.184 (n=115)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 2.549 (IC base=+0.187)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2162 | +0.175 | -37.88€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1394 | +0.208 | +8.29€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 628 | +0.181 | -11.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 466 | +0.199 | -20.63€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 767 | +0.176 | +5.97€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 460 | +0.219 | +21.40€ | 0 | 6 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 761 | +0.171 | -28.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 462 | +0.211 | +11.69€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 6 | +0.113 | +0.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 6 | +0.113 | +0.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 6 | +0.113 | +0.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 6 | +0.113 | +0.85€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4586 | +0.102 | +1397.19€ | 0 | 3 |
| ✅ GBM_LATE_15M#15min | 4586 | +0.102 | +1397.19€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1100 | +0.066 | +158.98€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1100 | +0.066 | +158.98€ | 0 | 4 |
| ✅ GBM_LATE_15M#ETH | 1118 | +0.075 | +189.48€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1118 | +0.075 | +189.48€ | 1 | 4 |
| ✅ GBM_LATE_15M#SOL | 1219 | +0.111 | +492.90€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1219 | +0.111 | +492.90€ | 0 | 6 |
| ✅ GBM_LATE_15M#XRP | 1149 | +0.152 | +555.83€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1149 | +0.152 | +555.83€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1841 | +0.153 | +1075.55€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1841 | +0.153 | +1075.55€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 470 | +0.123 | +233.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 470 | +0.123 | +233.00€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 485 | +0.128 | +223.33€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 485 | +0.128 | +223.33€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 497 | +0.111 | +217.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 497 | +0.111 | +217.04€ | 1 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 389 | +0.272 | +402.18€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 389 | +0.272 | +402.18€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 1797 | +0.084 | +493.60€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1797 | +0.084 | +493.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 446 | +0.060 | +73.34€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 446 | +0.060 | +73.34€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 403 | +0.016 | +11.38€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 403 | +0.016 | +11.38€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 440 | +0.048 | +71.99€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 440 | +0.048 | +71.99€ | 2 | 5 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 508 | +0.188 | +336.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 508 | +0.188 | +336.88€ | 0 | 12 |
...
| ✅ LATE_WINDOW_5MIN | 42 | +0.204 | +15.38€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#5min | 42 | +0.204 | +15.38€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC | 42 | +0.204 | +15.38€ | 0 | 0 |
| ✅ LATE_WINDOW_5MIN#BTC#5min | 42 | +0.204 | +15.38€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M | 119 | +0.087 | +28.79€ | 0 | 4 |
| ✅ LEADLAG_BTC_XRP_15M#15min | 119 | +0.087 | +28.79€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP | 119 | +0.087 | +28.79€ | 0 | 0 |
| ✅ LEADLAG_BTC_XRP_15M#XRP#15min | 119 | +0.087 | +28.79€ | 0 | 4 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 11 | +0.190 | +3.85€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11 | +0.190 | +3.85€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.124) — sin ventaja clara. oversold(IBS<0.3): IC=-0.006 n=429 | neutral: IC=-0.015 n=330 | overbought(IBS>0.7): IC=+0.109 n=348
  - _Datos_: n=1170 IC=+0.032 PNL=+104.51€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.099 n=8857 | tras_1loss IC=+0.061 n=6303 | tras_2loss IC=+0.029 n=2733/40 | gap=+0.070 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.077 n=676/40 PNL=+151.18€ | H=15h UTC: IC=+0.123 n=621/40 PNL=+193.46€ | H=17h UTC: IC=+0.127 n=575/40 PNL=+170.31€ | H=19h UTC: IC=+0.082 n=556/40 PNL=+84.58€
...
**🔶 H-LATE-WINDOW-5MIN** — Late-window BTC 5min — arbitraje timing vs Polymarket
  ...
  - _Datos_: n=42 IC=+0.204 PNL=+15.38€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=12915 IC=+0.102 PNL=+3082.91€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=12915 IC=+0.102 PNL=+3082.91€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=586 IC=+0.056 PNL=+66.74€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=586 IC=+0.056 PNL=+66.74€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.254 > 0.2 con n=299 PNL=+203.07€
  - _Datos_: n=299 IC=+0.254 PNL=+203.07€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.134 > 0.08 con n=132 PNL=+43.15€
  - _Datos_: n=132 IC=+0.134 PNL=+43.15€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.113 > 0.08 con n=117 PNL=+47.30€
  - _Datos_: n=117 IC=+0.113 PNL=+47.30€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.130 > 0.08 con n=160 PNL=+79.23€
  - _Datos_: n=160 IC=+0.130 PNL=+79.23€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.225 > 0.08 con n=107 PNL=+9.07€
  - _Datos_: n=107 IC=+0.225 PNL=+9.07€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.268 > 0.08 con n=166 PNL=-0.19€
  - _Datos_: n=166 IC=+0.268 PNL=-0.19€
