# Hipótesis automáticas — 2026-09-22 18:38 UTC
_Generado por shadow_postmortem.py sobre 561408 resoluciones (PNL=+62601.14€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.152 (n=202)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.252 (n=501)
...
- **PATRÓN** `py_entrada` > `0.505` → IC=+0.252 (n=501)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8038` → IC=+0.252 (n=353)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8038 (IC base=+0.136)

- **PATRÓN** `banda_z` > `9.862` → IC=+0.225 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 9.862 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.145 (n=482)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` > 7.0 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.148 (n=564)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.16` → IC=-0.231 (n=6752)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.16
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=20257)
...
- **FILTRO** `restante_s_al_confirmar` < `496.69` → IC=-0.147 (n=355)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=1068)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `134.67` → IC=-0.278 (n=831)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 134.67
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=2494)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `163.42` → IC=-0.228 (n=1600)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 163.42
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=4803)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `124.36` → IC=-0.362 (n=1346)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 124.36
  - _Potencial_: sin este filtro IC_bueno=-0.123 (n=4038)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.232 (n=349)
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.338 (n=35)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.096 (n=186)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.167 (n=70)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.111 (n=160)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.201 (n=13383)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.102)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.153 (n=3353)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `5583.7388` → IC=+0.175 (n=2137)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 5583.7388 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.140 (n=10746)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.233 (n=10399)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5459)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `1667.8965` → IC=+0.157 (n=6162)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 1667.8965 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.208 (n=1568)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.352 (n=741)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.203)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2026)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.203)

- **PATRÓN** `libro_liquidez` > `15781.2955` → IC=+0.230 (n=523)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15781.2955 (IC base=+0.203)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.203 (n=1453)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.263 (n=1461)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.200 (n=2054)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `13908.4681` → IC=+0.207 (n=722)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13908.4681 (IC base=+0.199)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `py_entrada` > `0.59` → IC=+0.167 (n=452)

  - _Acción_: Kelly boost +0.84€ cuando `py_entrada` > 0.59 (IC base=+0.105)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.151 (n=336)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 7.0 (IC base=+0.108)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.154 (n=2700)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.333 (n=910)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.71 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.245 (n=638)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.234)

- **PATRÓN** `py_entrada` < `0.255` → IC=+0.356 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.255 (IC base=+0.234)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.239 (n=1429)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.234)

- **PATRÓN** `libro_liquidez` > `3731.325` → IC=+0.234 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3731.325 (IC base=+0.234)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.155 (n=441)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1302.9991` → IC=+0.152 (n=628)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 1302.9991 (IC base=+0.138)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.228 (n=688)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.203)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.169 (n=1047)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.203 (n=10916)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.224 (n=3689)
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.184 (n=1847)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.264 (n=349)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.187 (n=2474)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=2535)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.198 (n=1853)

  - _Acción_: Kelly boost +0.99€ cuando `py_entrada` < 0.71 (IC base=+0.194)

### FAVORITO_CONFIRMADO_15MIN_EXTREMO
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.440 (n=478)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2062.8229` → IC=+0.438 (n=497)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.202 (n=32350)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.199)

- **PATRÓN** `py_entrada` > `0.74` → IC=+0.232 (n=17566)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.199)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.177 (n=6582)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.190 (n=6015)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.71 (IC base=+0.176)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=5794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.45` → IC=+0.144 (n=2248)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.45 (IC base=+0.122)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.194 (n=2466)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.38 (IC base=+0.113)

- **PATRÓN** `restante_min` < `4.18` → IC=+0.125 (n=2286)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.18 (IC base=+0.113)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.137 (n=2458)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 4.96 (IC base=+0.113)

- **PATRÓN** `lag_apertura_s` < `2.31` → IC=+0.142 (n=2282)

  - _Acción_: Kelly boost +0.71€ cuando `lag_apertura_s` < 2.31 (IC base=+0.113)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.323 (n=754)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1565.7184` → IC=+0.298 (n=1059)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1565.7184 (IC base=+0.293)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.337 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1466.3152` → IC=+0.316 (n=455)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1466.3152 (IC base=+0.298)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4748` → IC=+0.121 (n=7604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.60€ cuando `drift_60min` |x|≤ 0.4748 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9825` → IC=+0.241 (n=2535)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9825 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8348` → IC=+0.244 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8348 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6263` → IC=+0.245 (n=2110)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6263 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.934` → IC=+0.178 (n=2937)

  - _Acción_: Kelly boost +0.89€ cuando `sigma_ewma_delta_pct` > 5.934 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0496` → IC=+0.255 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0496 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3055` → IC=+0.214 (n=758)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3055 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.91` → IC=+0.206 (n=3453)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.91 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5706` → IC=+0.131 (n=9169)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5706 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` > `0.5923` → IC=+0.191 (n=700)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.5923 (IC base=+0.062)

- **PATRÓN** `dist_vwap_pct` < `0.148` → IC=+0.172 (n=2839)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.148 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` < `0.6989` → IC=+0.175 (n=1394)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.6989 (IC base=+0.062)

- **PATRÓN** `volumen_regimen` > `0.8699` → IC=+0.174 (n=2112)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 0.8699 (IC base=+0.062)

- **PATRÓN** `volumen_pendiente_norm` > `0.1678` → IC=+0.218 (n=1518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1678 (IC base=+0.062)

- **PATRÓN** `volumen_spike_ratio` > `1.5762` → IC=+0.200 (n=4729)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5762 (IC base=+0.062)

- **PATRÓN** `ballena_activa_n` < `139.0` → IC=+0.209 (n=5075)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 139.0 (IC base=+0.062)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.178 (n=576)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3452` → IC=+0.165 (n=1723)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.3452 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.165 (n=833)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.266 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.160)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.116` → IC=+0.271 (n=744)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.116 (IC base=+0.160)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.210 (n=229)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.160)

- **PATRÓN** `volumen_spike_ratio` > `1.4388` → IC=+0.164 (n=1608)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4388 (IC base=+0.160)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.256 (n=580)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.0888` → IC=+0.287 (n=425)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0888 (IC base=+0.235)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.243 (n=1155)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.235)

- **PATRÓN** `ibs_20min` < `0.062` → IC=+0.294 (n=561)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.062 (IC base=+0.235)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.394` → IC=+0.249 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.394 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` < `0.0914` → IC=+0.231 (n=1089)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0914 (IC base=+0.235)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.263 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2757 (IC base=+0.235)

- **PATRÓN** `volumen_spike_ratio` > `2.6417` → IC=+0.247 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6417 (IC base=+0.235)

- **PATRÓN** `libro_liquidez` > `1787.2172` → IC=+0.239 (n=850)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1787.2172 (IC base=+0.235)

- **PATRÓN** `ballena_activa_n` < `44.0` → IC=+0.230 (n=975)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0853` → IC=+0.250 (n=438)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0853 (IC base=+0.213)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.229 (n=1313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.213)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.213 (n=1341)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` > `0.9918` → IC=+0.264 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9918 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.220 (n=711)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.5785` → IC=+0.217 (n=1362)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5785 (IC base=+0.213)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.827` → IC=+0.250 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.827 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` < `1.2554` → IC=+0.216 (n=1313)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2554 (IC base=+0.213)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.224 (n=595)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.213)

- **PATRÓN** `volumen_pendiente_norm` > `0.0742` → IC=+0.228 (n=539)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0742 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` < `1.4011` → IC=+0.224 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4011 (IC base=+0.213)

- **PATRÓN** `volumen_spike_ratio` > `2.3728` → IC=+0.219 (n=429)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3728 (IC base=+0.213)

- **PATRÓN** `libro_liquidez` > `12276.9296` → IC=+0.217 (n=1173)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12276.9296 (IC base=+0.213)

- **PATRÓN** `sigma_h` < `0.0026` → IC=+0.173 (n=457)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0026 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.0753` → IC=+0.159 (n=455)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.0753 (IC base=+0.137)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=536)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6849` → IC=+0.169 (n=1363)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.6849 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1278` → IC=+0.158 (n=1209)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1278 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.204` → IC=+0.158 (n=220)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.204 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.206` → IC=+0.141 (n=1240)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.206 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.148 (n=1363)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.2046 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` > `0.8523` → IC=+0.138 (n=909)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.8523 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.096` → IC=+0.170 (n=492)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_pendiente_norm` > 0.096 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` < `2.4311` → IC=+0.149 (n=1253)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4311 (IC base=+0.137)

- **PATRÓN** `volumen_spike_ratio` > `1.7706` → IC=+0.146 (n=835)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7706 (IC base=+0.137)

- **PATRÓN** `ballena_activa_n` < `411.0` → IC=+0.146 (n=1172)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 411.0 (IC base=+0.137)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.218 (n=561)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.188)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.190 (n=1680)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.263 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.161` → IC=+0.257 (n=360)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.161 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.190 (n=1669)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` < 0.2114 (IC base=+0.188)

- **PATRÓN** `volumen_pendiente_norm` > `0.3626` → IC=+0.200 (n=221)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3626 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `2.8806` → IC=+0.205 (n=721)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8806 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.197 (n=1169)

  - _Acción_: Kelly boost +0.98€ cuando `libro_spread` < 0.02 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `1943.8205` → IC=+0.190 (n=559)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 1943.8205 (IC base=+0.188)

- **PATRÓN** `sigma_h` < `0.0113` → IC=+0.223 (n=1432)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0113 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.5811` → IC=+0.214 (n=1432)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5811 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.251 (n=540)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0636` → IC=+0.240 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0636 (IC base=+0.214)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.543` → IC=+0.236 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.543 (IC base=+0.214)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8718` → IC=+0.227 (n=591)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8718 (IC base=+0.214)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.222 (n=940)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.214)

- **PATRÓN** `libro_liquidez` > `1865.9971` → IC=+0.224 (n=650)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1865.9971 (IC base=+0.214)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.215 (n=1087)
...
- **PATRÓN** `volumen_regimen` < `0.852` → IC=+0.158 (n=515)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5133` → IC=+0.174 (n=642)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.5133 (IC base=+0.012)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `hora_utc` < `17.0` → IC=-0.161 (n=57)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.093 (n=305)

- **FILTRO** `ibs_20min` < `0.2667` → IC=-0.196 (n=90)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2667
  - _Potencial_: sin este filtro IC_bueno=+0.135 (n=272)

- **FILTRO** `ibs_20min` > `0.2581` → IC=-0.126 (n=2086)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2581
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=1029)
...
- **PATRÓN** `ibs_20min` > `0.7727` → IC=+0.222 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7727 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `1.6532` → IC=+0.357 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.6532 (IC base=+0.052)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4396` → IC=+0.259 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4396 (IC base=-0.043)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6451` → IC=-0.185 (n=531)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6451
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=1595)

- **FILTRO** `ibs_20min` < `0.7025` → IC=-0.158 (n=1403)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7025
  - _Potencial_: sin este filtro IC_bueno=+0.103 (n=723)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.198 (n=399)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=1727)

- **FILTRO** `ibs_20min` > `0.7733` → IC=-0.205 (n=787)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7733
  - _Potencial_: sin este filtro IC_bueno=+0.034 (n=2364)

- **PATRÓN** `dist_vwap_pct` > `0.7564` → IC=+0.307 (n=86)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7564 (IC base=-0.069)

- **PATRÓN** `dist_vwap_pct` < `0.2654` → IC=+0.319 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2654 (IC base=-0.069)

- **PATRÓN** `volumen_regimen` > `0.6166` → IC=+0.304 (n=315)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6166 (IC base=-0.069)

- **PATRÓN** `volumen_pendiente_norm` > `0.0744` → IC=+0.303 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0744 (IC base=-0.069)

- **PATRÓN** `volumen_spike_ratio` < `1.5298` → IC=+0.297 (n=131)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.5298 (IC base=-0.069)

- **PATRÓN** `volumen_spike_ratio` > `1.7999` → IC=+0.294 (n=197)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7999 (IC base=-0.069)

- **PATRÓN** `dist_vwap_pct` > `0.8069` → IC=+0.274 (n=153)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8069 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` < `0.7389` → IC=+0.243 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7389 (IC base=-0.025)

- **PATRÓN** `volumen_regimen` > `1.2494` → IC=+0.297 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2494 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.1035` → IC=+0.271 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1035 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `2.1737` → IC=+0.249 (n=521)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1737 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.4459` → IC=+0.247 (n=592)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4459 (IC base=-0.025)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.197 (n=3174)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` > 0.0097 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.4713` → IC=+0.187 (n=8500)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4713 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `1.0648` → IC=+0.290 (n=799)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0648 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.569` → IC=+0.156 (n=4504)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.569 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `0.6856` → IC=+0.244 (n=3004)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6856 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.2977` → IC=+0.263 (n=805)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2977 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` < `1.4706` → IC=+0.238 (n=1821)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4706 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `2.6883` → IC=+0.236 (n=1820)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6883 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `98.0` → IC=+0.267 (n=4971)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 98.0 (IC base=+0.096)

- **PATRÓN** `sigma_h` > `0.009` → IC=+0.146 (n=3175)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.009 (IC base=+0.071)

- **PATRÓN** `ibs_20min` < `0.55` → IC=+0.150 (n=8383)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.55 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.243` → IC=+0.239 (n=2602)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.243 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` < `0.7126` → IC=+0.237 (n=1222)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7126 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `1.2033` → IC=+0.247 (n=926)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2033 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` > `0.2466` → IC=+0.301 (n=691)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2466 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` < `1.4857` → IC=+0.254 (n=1209)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4857 (IC base=+0.071)

- **PATRÓN** `volumen_spike_ratio` > `2.3312` → IC=+0.257 (n=1643)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3312 (IC base=+0.071)

- **PATRÓN** `ballena_activa_n` < `82.0` → IC=+0.261 (n=3497)
...
- **PATRÓN** `ibs_20min` > `0.8893` → IC=+0.264 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8893 (IC base=+0.043)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.299` → IC=+0.164 (n=899)
...
- **PATRÓN** `ibs_20min` > `0.8635` → IC=+0.156 (n=637)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.8635 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` > `0.1245` → IC=+0.164 (n=492)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1245 (IC base=+0.024)

- **PATRÓN** `volumen_regimen` > `0.6687` → IC=+0.157 (n=779)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.6687 (IC base=+0.024)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4208` → IC=+0.199 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4208 (IC base=+0.024)

- **PATRÓN** `ballena_activa_n` < `248.0` → IC=+0.187 (n=369)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 248.0 (IC base=+0.024)

- **PATRÓN** `dist_vwap_pct` < `0.1031` → IC=+0.220 (n=515)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1031 (IC base=+0.002)

- **PATRÓN** `volumen_regimen` > `0.6093` → IC=+0.211 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6093 (IC base=+0.002)

- **PATRÓN** `volumen_pendiente_norm` < `0.0729` → IC=+0.209 (n=441)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.299 (n=804)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.246)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.749` → IC=+0.281 (n=483)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.749 (IC base=+0.246)

- **PATRÓN** `volumen_pendiente_norm` < `0.1384` → IC=+0.258 (n=1331)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1384 (IC base=+0.246)

- **PATRÓN** `volumen_spike_ratio` > `2.898` → IC=+0.258 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.898 (IC base=+0.246)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.257 (n=1036)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.246)

- **PATRÓN** `libro_liquidez` > `1936.1714` → IC=+0.256 (n=501)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1936.1714 (IC base=+0.246)

- **PATRÓN** `sigma_h` > `0.0079` → IC=+0.306 (n=794)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0079 (IC base=+0.282)

- **PATRÓN** `drift_60min` |x|≤ `0.5945` → IC=+0.283 (n=1192)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5945 (IC base=+0.282)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.327 (n=403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.282)

- **PATRÓN** `ibs_20min` < `0.2262` → IC=+0.286 (n=1049)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2262 (IC base=+0.282)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.808` → IC=+0.297 (n=462)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.808 (IC base=+0.282)

- **PATRÓN** `volumen_pendiente_norm` > `0.3431` → IC=+0.306 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3431 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` < `1.6052` → IC=+0.282 (n=365)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6052 (IC base=+0.282)

- **PATRÓN** `volumen_spike_ratio` > `2.7856` → IC=+0.286 (n=497)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7856 (IC base=+0.282)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.290 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.282)

- **PATRÓN** `libro_liquidez` > `1860.8096` → IC=+0.297 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1860.8096 (IC base=+0.282)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.285 (n=701)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.282)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.2803` → IC=-0.191 (n=461)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2803
  - _Potencial_: sin este filtro IC_bueno=+0.074 (n=1386)

- **FILTRO** `ibs_20min` > `0.7783` → IC=-0.183 (n=562)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7783
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1688)

- **PATRÓN** `ibs_20min` > `0.9075` → IC=+0.179 (n=462)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.9075 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.4586` → IC=+0.222 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4586 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` < `0.7048` → IC=+0.202 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7048 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` < `0.9978` → IC=+0.228 (n=454)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9978 (IC base=+0.008)

- **PATRÓN** `volumen_regimen` > `0.5808` → IC=+0.205 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.5808 (IC base=+0.008)

- **PATRÓN** `volumen_pendiente_norm` > `0.0791` → IC=+0.254 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0791 (IC base=+0.008)

- **PATRÓN** `volumen_spike_ratio` < `1.4982` → IC=+0.255 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4982 (IC base=+0.008)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.255 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.008)

- **PATRÓN** `dist_vwap_pct` > `0.1525` → IC=+0.200 (n=198)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1525 (IC base=-0.007)

- **PATRÓN** `dist_vwap_pct` < `0.6579` → IC=+0.191 (n=429)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.6579 (IC base=-0.007)

- **PATRÓN** `volumen_regimen` < `1.1615` → IC=+0.202 (n=380)
...
- **FILTRO** `ibs_20min` < `0.7143` → IC=-0.203 (n=1003)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.275 (n=1013)

- **FILTRO** `ibs_20min` > `0.6905` → IC=-0.231 (n=530)

  - _Acción_: SKIP cuando `ibs_20min` > 0.6905
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1592)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.179 (n=465)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.068 (n=1657)

- **PATRÓN** `ibs_20min` > `0.7143` → IC=+0.275 (n=1013)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7143 (IC base=+0.037)

- **PATRÓN** `dist_vwap_pct` > `0.8327` → IC=+0.335 (n=235)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8327 (IC base=+0.037)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.564` → IC=+0.155 (n=320)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 9.564 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.296 (n=493)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8646 (IC base=+0.037)

- **PATRÓN** `volumen_regimen` > `0.639` → IC=+0.288 (n=738)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.639 (IC base=+0.037)

- **PATRÓN** `volumen_pendiente_norm` < `0.1034` → IC=+0.291 (n=682)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4432` → IC=+0.317 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4432 (IC base=+0.037)

- **PATRÓN** `ballena_activa_n` < `56.0` → IC=+0.311 (n=617)
...
- **PATRÓN** `ibs_20min` > `0.63` → IC=+0.312 (n=1239)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.63 (IC base=+0.279)

- **PATRÓN** `dist_vwap_pct` > `0.1998` → IC=+0.320 (n=737)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1998 (IC base=+0.279)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.503` → IC=+0.304 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.503 (IC base=+0.279)

- **PATRÓN** `volumen_regimen` > `0.8622` → IC=+0.303 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8622 (IC base=+0.279)

- **PATRÓN** `volumen_pendiente_norm` > `0.2811` → IC=+0.321 (n=188)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2811 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` > `2.1646` → IC=+0.290 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1646 (IC base=+0.279)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.284 (n=1314)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.279)

- **PATRÓN** `libro_liquidez` > `2615.934` → IC=+0.294 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2615.934 (IC base=+0.279)

- **PATRÓN** `sigma_h` > `0.0151` → IC=+0.296 (n=899)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0151 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.275 (n=612)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3976` → IC=+0.303 (n=1348)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3976 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.2886` → IC=+0.278 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2886 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` < `0.9366` → IC=+0.270 (n=1512)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9366 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.981` → IC=+0.293 (n=249)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.981 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `1.241` → IC=+0.314 (n=450)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.241 (IC base=+0.269)

- **PATRÓN** `volumen_pendiente_norm` > `0.2397` → IC=+0.337 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2397 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` < `1.543` → IC=+0.263 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.543 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `2.1632` → IC=+0.275 (n=536)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1632 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `2603.2794` → IC=+0.274 (n=899)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2603.2794 (IC base=+0.269)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.168 (n=2494)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0049 (IC base=+0.167)

- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.204 (n=2495)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.167)

- **PATRÓN** `drift_60min` |x|≤ `0.3551` → IC=+0.175 (n=6578)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.88€ cuando `drift_60min` |x|≤ 0.3551 (IC base=+0.167)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=7824)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 5.0 (IC base=+0.167)

- **PATRÓN** `ibs_20min` > `0.5789` → IC=+0.216 (n=7475)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5789 (IC base=+0.167)

- **PATRÓN** `dist_vwap_pct` > `0.1741` → IC=+0.194 (n=3303)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1741 (IC base=+0.167)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.275` → IC=+0.259 (n=1542)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.275 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `1.2182` → IC=+0.159 (n=4951)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2182 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `0.6283` → IC=+0.160 (n=4950)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 0.6283 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.246` → IC=+0.195 (n=1508)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.246 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.5621` → IC=+0.171 (n=3149)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 1.5621 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `2.6286` → IC=+0.175 (n=2386)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 2.6286 (IC base=+0.167)

- **PATRÓN** `ballena_activa_n` < `117.0` → IC=+0.181 (n=6386)

  - _Acción_: Kelly boost +0.90€ cuando `ballena_activa_n` < 117.0 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.181 (n=4730)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0066 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.0799` → IC=+0.206 (n=2367)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0799 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=2742)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.225 (n=7090)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.166)

- **PATRÓN** `dist_vwap_pct` < `0.2286` → IC=+0.158 (n=5126)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.2286 (IC base=+0.166)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.234` → IC=+0.189 (n=1203)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 10.234 (IC base=+0.166)

- **PATRÓN** `volumen_regimen` < `1.1764` → IC=+0.149 (n=5154)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1764 (IC base=+0.166)

- **PATRÓN** `volumen_pendiente_norm` > `0.291` → IC=+0.219 (n=1020)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.291 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` < `1.5695` → IC=+0.162 (n=2824)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 1.5695 (IC base=+0.166)

- **PATRÓN** `volumen_spike_ratio` > `2.2631` → IC=+0.171 (n=2909)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2631 (IC base=+0.166)

- **PATRÓN** `ballena_activa_n` < `118.0` → IC=+0.171 (n=6048)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 118.0 (IC base=+0.166)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.215 (n=426)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3413` → IC=+0.205 (n=1276)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3413 (IC base=+0.181)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.198 (n=626)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.99€ cuando `hora_utc` < 8.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.300 (n=628)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.117` → IC=+0.310 (n=578)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.179 (n=1177)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.4355 (IC base=+0.181)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.238 (n=802)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0066 (IC base=+0.238)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=814)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.238)

- **PATRÓN** `drift_60min` |x|≤ `0.1831` → IC=+0.293 (n=608)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1831 (IC base=+0.238)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.246 (n=820)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.3437` → IC=+0.262 (n=911)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3437 (IC base=+0.238)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.083` → IC=+0.253 (n=988)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 5.083 (IC base=+0.238)

- **PATRÓN** `volumen_pendiente_norm` < `0.0955` → IC=+0.236 (n=756)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2661` → IC=+0.245 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.2661 (IC base=+0.238)

- **PATRÓN** `libro_liquidez` > `1791.88` → IC=+0.249 (n=607)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1791.88 (IC base=+0.238)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2325` → IC=+0.200 (n=245)
...
- **PATRÓN** `libro_liquidez` > `15840.975` → IC=+0.167 (n=505)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15840.975 (IC base=+0.160)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.154 (n=1210)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0058 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.2896` → IC=+0.156 (n=1209)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.2896 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.171 (n=405)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 18.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.5606` → IC=+0.181 (n=1209)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.5606 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.133` → IC=+0.162 (n=1193)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.133 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.806` → IC=+0.207 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.806 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.152 (n=1209)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 1.2145 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.142 (n=1098)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `219.0` → IC=+0.161 (n=340)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 219.0 (IC base=+0.134)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.228 (n=567)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0097 (IC base=+0.201)

- **PATRÓN** `drift_60min` |x|≤ `0.2234` → IC=+0.216 (n=833)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2234 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.225 (n=427)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.291 (n=667)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.877` → IC=+0.278 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.877 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` < `0.2104` → IC=+0.199 (n=1209)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` < 0.2104 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.1057` → IC=+0.202 (n=544)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1057 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `1.6453` → IC=+0.198 (n=395)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6453 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `2.8814` → IC=+0.209 (n=537)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8814 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=867)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `1938.09` → IC=+0.204 (n=417)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1938.09 (IC base=+0.201)

- **PATRÓN** `sigma_h` < `0.0111` → IC=+0.236 (n=1026)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0111 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.0946` → IC=+0.256 (n=342)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0946 (IC base=+0.220)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.279 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.220)

- **PATRÓN** `ibs_20min` < `0.2429` → IC=+0.256 (n=902)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2429 (IC base=+0.220)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.703` → IC=+0.266 (n=430)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.703 (IC base=+0.220)

- **PATRÓN** `volumen_pendiente_norm` > `0.3581` → IC=+0.264 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3581 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `2.221` → IC=+0.228 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.221 (IC base=+0.220)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.174 (n=1053)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` < 0.0067 (IC base=+0.144)

- **PATRÓN** `drift_60min` |x|≤ `0.4318` → IC=+0.159 (n=1195)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.4318 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.163 (n=1195)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.3868` → IC=+0.197 (n=1195)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3868 (IC base=+0.144)

- **PATRÓN** `dist_vwap_pct` > `0.1571` → IC=+0.179 (n=807)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1571 (IC base=+0.144)
...
- **PATRÓN** `volumen_regimen` < `1.0496` → IC=+0.149 (n=1052)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 1.0496 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `0.6319` → IC=+0.149 (n=1195)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.6319 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` > `0.2466` → IC=+0.201 (n=252)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2466 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` < `1.5341` → IC=+0.150 (n=515)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.5341 (IC base=+0.144)

- **PATRÓN** `volumen_spike_ratio` > `2.5403` → IC=+0.171 (n=390)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5403 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `6954.443` → IC=+0.185 (n=797)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 6954.443 (IC base=+0.144)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.145 (n=1134)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 166.0 (IC base=+0.144)

- **PATRÓN** `sigma_h` < `0.0073` → IC=+0.153 (n=1252)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0073 (IC base=+0.121)

- **PATRÓN** `drift_60min` |x|≤ `0.3842` → IC=+0.140 (n=1252)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3842 (IC base=+0.121)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.176 (n=492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.121)

- **PATRÓN** `ibs_20min` < `0.6258` → IC=+0.168 (n=1252)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.878` → IC=+0.170 (n=441)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 6.878 (IC base=+0.121)

- **PATRÓN** `volumen_regimen` < `0.849` → IC=+0.144 (n=835)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.849 (IC base=+0.121)

- **PATRÓN** `volumen_pendiente_norm` > `0.2894` → IC=+0.194 (n=181)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2894 (IC base=+0.121)

- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.128 (n=756)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.121)

- **PATRÓN** `libro_liquidez` > `9950.2818` → IC=+0.160 (n=568)
...
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.159 (n=613)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` > 0.0101 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.137 (n=1388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.5169` → IC=+0.201 (n=1351)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5169 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `0.8341` → IC=+0.213 (n=412)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8341 (IC base=+0.117)
...
- **PATRÓN** `volumen_regimen` < `1.2243` → IC=+0.129 (n=1352)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2243 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` < `0.1649` → IC=+0.129 (n=1355)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_pendiente_norm` < 0.1649 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `2.4811` → IC=+0.127 (n=1303)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.4811 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1411)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2897.8254` → IC=+0.193 (n=613)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2897.8254 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.135 (n=1031)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.129 (n=1379)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.207 (n=1363)
...
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.214 (n=861)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.205 (n=1348)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.737` → IC=+0.260 (n=1154)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.737 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `1.3185` → IC=+0.227 (n=331)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.3185 (IC base=+0.202)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.525` → IC=+0.245 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.525 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` < `1.2102` → IC=+0.205 (n=1292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2102 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8596` → IC=+0.223 (n=861)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8596 (IC base=+0.202)

- **PATRÓN** `volumen_pendiente_norm` > `0.234` → IC=+0.270 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.234 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.214 (n=1097)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.4095` → IC=+0.207 (n=1246)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4095 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.204 (n=1365)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2795.0881` → IC=+0.204 (n=586)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2795.0881 (IC base=+0.202)

- **PATRÓN** `sigma_h` < `0.0085` → IC=+0.236 (n=445)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0085 (IC base=+0.204)

- **PATRÓN** `sigma_h` > `0.0224` → IC=+0.213 (n=604)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.223 (n=651)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.44` → IC=+0.247 (n=1334)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.44 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.1412` → IC=+0.228 (n=167)
...
- **PATRÓN** `volumen_regimen` > `0.632` → IC=+0.216 (n=1332)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4476` → IC=+0.199 (n=1191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4476 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `2573.6445` → IC=+0.207 (n=888)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2573.6445 (IC base=+0.204)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.159 (n=581)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0039 (IC base=+0.146)

- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.177 (n=581)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` > 0.0089 (IC base=+0.146)

- **PATRÓN** `drift_60min` |x|≤ `0.1344` → IC=+0.151 (n=767)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1344 (IC base=+0.146)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.186 (n=880)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 15.0 (IC base=+0.146)

- **PATRÓN** `ibs_20min` > `0.5549` → IC=+0.187 (n=1557)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` > 0.5549 (IC base=+0.146)

- **PATRÓN** `dist_vwap_pct` > `0.387` → IC=+0.185 (n=538)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.387 (IC base=+0.146)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.691` → IC=+0.176 (n=808)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.691 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` < `0.8754` → IC=+0.162 (n=1014)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8754 (IC base=+0.146)

- **PATRÓN** `volumen_regimen` > `1.2116` → IC=+0.154 (n=507)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.2116 (IC base=+0.146)

- **PATRÓN** `volumen_pendiente_norm` > `0.1634` → IC=+0.177 (n=481)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1634 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` < `1.4364` → IC=+0.163 (n=559)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` < 1.4364 (IC base=+0.146)

- **PATRÓN** `volumen_spike_ratio` > `2.5493` → IC=+0.158 (n=559)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5493 (IC base=+0.146)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.149 (n=1965)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.146)

- **PATRÓN** `libro_liquidez` > `12247.1343` → IC=+0.148 (n=581)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 12247.1343 (IC base=+0.146)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.168 (n=516)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 21.0 (IC base=+0.146)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.129 (n=1219)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0057 (IC base=+0.100)

- **PATRÓN** `ibs_20min` < `0.0568` → IC=+0.190 (n=608)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.0568 (IC base=+0.100)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.3375` → IC=+0.124 (n=440)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.3375 (IC base=+0.102)

- **PATRÓN** `hora_utc` > `9.0` → IC=+0.146 (n=394)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 9.0 (IC base=+0.102)

- **PATRÓN** `ibs_20min` > `0.2556` → IC=+0.140 (n=440)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.2556 (IC base=+0.102)

- **PATRÓN** `dist_vwap_pct` > `0.3052` → IC=+0.154 (n=157)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.3052 (IC base=+0.102)
...
- **PATRÓN** `volumen_regimen` < `0.6182` → IC=+0.144 (n=147)
  ...
  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6182 (IC base=+0.102)

- **PATRÓN** `libro_liquidez` > `12605.7065` → IC=+0.133 (n=393)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 12605.7065 (IC base=+0.102)

- **PATRÓN** `sigma_h` < `0.0027` → IC=+0.203 (n=197)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0027 (IC base=+0.129)

- **PATRÓN** `drift_60min` |x|≤ `0.3387` → IC=+0.148 (n=583)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3387 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.141 (n=522)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 7.0 (IC base=+0.129)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.129 (n=601)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` < 17.0 (IC base=+0.129)

- **PATRÓN** `ibs_20min` < `0.6041` → IC=+0.176 (n=513)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` < 0.6041 (IC base=+0.129)

- **PATRÓN** `dist_vwap_pct` < `0.2982` → IC=+0.153 (n=614)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.2982 (IC base=+0.129)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.388` → IC=+0.151 (n=227)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 4.388 (IC base=+0.129)

- **PATRÓN** `volumen_regimen` > `1.0622` → IC=+0.162 (n=264)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0622 (IC base=+0.129)

- **PATRÓN** `volumen_pendiente_norm` > `0.1608` → IC=+0.204 (n=160)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1608 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` < `2.1115` → IC=+0.150 (n=504)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.1115 (IC base=+0.129)

- **PATRÓN** `volumen_spike_ratio` > `1.415` → IC=+0.138 (n=573)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.415 (IC base=+0.129)

- **PATRÓN** `ballena_activa_n` < `331.0` → IC=+0.142 (n=484)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 331.0 (IC base=+0.129)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.263 (n=230)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0038 (IC base=+0.197)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.210 (n=174)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.197)

- **PATRÓN** `drift_60min` |x|≤ `0.0958` → IC=+0.216 (n=174)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0958 (IC base=+0.197)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.241 (n=264)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.197)

- **PATRÓN** `ibs_20min` > `0.7051` → IC=+0.251 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7051 (IC base=+0.197)

- **PATRÓN** `dist_vwap_pct` > `0.3816` → IC=+0.228 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3816 (IC base=+0.197)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.976` → IC=+0.239 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.976 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` < `0.8432` → IC=+0.209 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8432 (IC base=+0.197)

- **PATRÓN** `volumen_regimen` > `1.1584` → IC=+0.222 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1584 (IC base=+0.197)

- **PATRÓN** `volumen_pendiente_norm` > `0.2555` → IC=+0.321 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2555 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` < `1.3853` → IC=+0.236 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3853 (IC base=+0.197)

- **PATRÓN** `volumen_spike_ratio` > `2.405` → IC=+0.236 (n=172)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.405 (IC base=+0.197)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.202 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.197)

- **PATRÓN** `libro_liquidez` > `12307.7364` → IC=+0.204 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12307.7364 (IC base=+0.197)

- **PATRÓN** `ibs_20min` < `0.0811` → IC=+0.159 (n=162)

  - _Acción_: Kelly boost +0.79€ cuando `ibs_20min` < 0.0811 (IC base=+0.074)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.169 (n=173)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0089 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.1107` → IC=+0.123 (n=128)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.62€ cuando `drift_60min` |x|≤ 0.1107 (IC base=+0.123)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.160 (n=360)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 8.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` > `0.7333` → IC=+0.195 (n=342)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` > 0.7333 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.6259` → IC=+0.213 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6259 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.127` → IC=+0.202 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.127 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `1.0712` → IC=+0.139 (n=336)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` < 1.0712 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` > `0.7268` → IC=+0.144 (n=341)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 0.7268 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.288` → IC=+0.179 (n=54)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.288 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `2.2078` → IC=+0.159 (n=165)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.2078 (IC base=+0.123)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=414)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.02 (IC base=+0.123)

- **PATRÓN** `libro_liquidez` > `3062.644` → IC=+0.205 (n=127)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3062.644 (IC base=+0.123)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.167 (n=94)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 18.0 (IC base=+0.123)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0111` → IC=+0.207 (n=3171)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0111 (IC base=+0.168)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=9949)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.168)

- **PATRÓN** `ibs_20min` > `0.4721` → IC=+0.215 (n=9508)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4721 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9512` → IC=+0.206 (n=1381)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9512 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.615` → IC=+0.227 (n=4621)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.615 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `0.8827` → IC=+0.164 (n=4241)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 0.8827 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2402` → IC=+0.200 (n=1785)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2402 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.6123` → IC=+0.188 (n=3041)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.6123 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2340.773` → IC=+0.170 (n=6339)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2340.773 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `88.0` → IC=+0.194 (n=7164)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 88.0 (IC base=+0.168)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.187 (n=7574)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0092 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.1458` → IC=+0.187 (n=3788)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.1458 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.204 (n=3260)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.5658` → IC=+0.237 (n=8604)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5658 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2434` → IC=+0.161 (n=5304)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2434 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.933` → IC=+0.195 (n=1209)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 9.933 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.718` → IC=+0.182 (n=8344)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.718 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `0.705` → IC=+0.159 (n=2615)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.705 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `1.205` → IC=+0.153 (n=1980)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.205 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.239 (n=1123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.635` → IC=+0.192 (n=2620)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 2.635 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.190 (n=4993)

  - _Acción_: Kelly boost +0.95€ cuando `ballena_activa_n` < 48.0 (IC base=+0.180)

### GBM_LATE_15M_TARDIO#BNB#15min
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.208 (n=540)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_60min` |x|≤ `0.3504` → IC=+0.188 (n=1618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.94€ cuando `drift_60min` |x|≤ 0.3504 (IC base=+0.187)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.196 (n=777)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.321 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.999` → IC=+0.311 (n=722)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5862` → IC=+0.202 (n=508)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5862 (IC base=+0.187)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.258 (n=1244)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0078 (IC base=+0.258)

- **PATRÓN** `sigma_h` > `0.007` → IC=+0.262 (n=564)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.258)

- **PATRÓN** `drift_60min` |x|≤ `0.1277` → IC=+0.287 (n=548)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1277 (IC base=+0.258)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.269 (n=1125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.3509` → IC=+0.288 (n=1095)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3509 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.466` → IC=+0.266 (n=1308)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.466 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2245` → IC=+0.289 (n=230)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2245 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `1.8654` → IC=+0.275 (n=757)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.8654 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1787.1589` → IC=+0.267 (n=829)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1787.1589 (IC base=+0.258)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `sigma_h` < `0.0028` → IC=+0.191 (n=510)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0028 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.0845` → IC=+0.163 (n=509)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.0845 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.162 (n=1597)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` > `0.3136` → IC=+0.200 (n=1525)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3136 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.1304` → IC=+0.184 (n=878)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1304 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.721` → IC=+0.171 (n=351)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 9.721 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.233` → IC=+0.149 (n=1366)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` < 4.233 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `0.628` → IC=+0.175 (n=509)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` < 0.628 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.2687` → IC=+0.199 (n=217)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_pendiente_norm` > 0.2687 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.1166` → IC=+0.159 (n=1294)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1166 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.7583` → IC=+0.154 (n=980)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7583 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `478.0` → IC=+0.156 (n=1401)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 478.0 (IC base=+0.147)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.163 (n=1316)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0057 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.3199` → IC=+0.159 (n=1316)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6489` → IC=+0.191 (n=1316)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6489 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.6891` → IC=+0.154 (n=229)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.6891 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.132` → IC=+0.167 (n=1182)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.132 (IC base=+0.149)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.199` → IC=+0.155 (n=632)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` > 3.199 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `1.1894` → IC=+0.161 (n=1316)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1894 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.409` → IC=+0.158 (n=1218)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.409 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `2.1015` → IC=+0.161 (n=552)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 2.1015 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `425.0` → IC=+0.157 (n=986)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 425.0 (IC base=+0.149)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0117` → IC=+0.247 (n=511)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0117 (IC base=+0.218)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1610)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.182 (n=546)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` < 0.0035 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4364` → IC=+0.143 (n=1621)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.4364 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.150 (n=1701)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 5.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` > `0.8798` → IC=+0.260 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8798 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` > `0.3665` → IC=+0.168 (n=655)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` > 0.3665 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.174` → IC=+0.162 (n=673)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.174 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `0.8781` → IC=+0.157 (n=1081)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8781 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.2836` → IC=+0.219 (n=226)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2836 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `1.5181` → IC=+0.149 (n=690)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5181 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `2.1389` → IC=+0.150 (n=710)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 2.1389 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `8151.7402` → IC=+0.230 (n=735)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8151.7402 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.155 (n=499)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 80.0 (IC base=+0.136)

- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.161 (n=1158)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` < 0.0066 (IC base=+0.136)

- **PATRÓN** `drift_60min` |x|≤ `0.4461` → IC=+0.154 (n=1316)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4461 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.171 (n=494)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6936` → IC=+0.185 (n=1316)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.6936 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.7996` → IC=+0.141 (n=1518)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.7996 (IC base=+0.136)
...
- **PATRÓN** `volumen_regimen` < `0.8615` → IC=+0.144 (n=879)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8615 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `1.1867` → IC=+0.144 (n=439)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4416` → IC=+0.151 (n=1245)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.4416 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `10973.4331` → IC=+0.210 (n=439)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10973.4331 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.142 (n=1240)

  - _Acción_: Kelly boost +0.71€ cuando `ballena_activa_n` < 181.0 (IC base=+0.136)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0081` → IC=+0.136 (n=1071)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0081 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.170 (n=601)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 17.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` > `0.4722` → IC=+0.188 (n=1605)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.4722 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` > `1.0691` → IC=+0.201 (n=326)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0691 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.447` → IC=+0.234 (n=603)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.447 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `0.8932` → IC=+0.134 (n=1071)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 0.8932 (IC base=+0.109)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1617)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `2913.9614` → IC=+0.245 (n=535)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2913.9614 (IC base=+0.109)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.127 (n=1220)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 54.0 (IC base=+0.109)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.174 (n=528)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.122 (n=1633)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 5.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.203 (n=1579)
...
- **PATRÓN** `ibs_20min` > `0.5146` → IC=+0.249 (n=1608)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5146 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.8871` → IC=+0.244 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8871 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.516` → IC=+0.251 (n=766)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.516 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.6363` → IC=+0.215 (n=1608)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6363 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` > `0.2344` → IC=+0.248 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2344 (IC base=+0.208)

- **PATRÓN** `volumen_spike_ratio` > `2.5127` → IC=+0.238 (n=517)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5127 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.216 (n=1677)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2613.0554` → IC=+0.217 (n=1072)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2613.0554 (IC base=+0.208)

- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.224 (n=577)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0086 (IC base=+0.199)

- **PATRÓN** `sigma_h` > `0.0256` → IC=+0.218 (n=577)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0256 (IC base=+0.199)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.207 (n=1222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.199)

- **PATRÓN** `ibs_20min` < `0.5208` → IC=+0.254 (n=1731)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5208 (IC base=+0.199)

- **PATRÓN** `dist_vwap_pct` < `0.8769` → IC=+0.202 (n=1913)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.8769 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.731` → IC=+0.261 (n=245)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.731 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.239 (n=577)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2099` → IC=+0.191 (n=1362)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 2.2099 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.197 (n=1548)
...
- **PATRÓN** `sigma_h` < `0.0093` → IC=+0.159 (n=2438)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0093 (IC base=+0.151)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.151 (n=2475)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.5256` → IC=+0.160 (n=2770)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.5256 (IC base=+0.151)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.163 (n=1106)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.9414` → IC=+0.212 (n=924)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9414 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.191` → IC=+0.159 (n=1001)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.191 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `1.1405` → IC=+0.142 (n=1964)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 1.1405 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.136` → IC=+0.183 (n=453)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 10.136 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.9026` → IC=+0.164 (n=1173)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.9026 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` > `0.1728` → IC=+0.184 (n=757)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1728 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` < `1.4565` → IC=+0.157 (n=913)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 1.4565 (IC base=+0.151)

- **PATRÓN** `volumen_spike_ratio` > `1.8869` → IC=+0.162 (n=1824)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.8869 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `3672.2918` → IC=+0.154 (n=1847)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 3672.2918 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.154 (n=374)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.005 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0044` → IC=+0.163 (n=846)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0044 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.1256` → IC=+0.156 (n=283)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.1256 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.165 (n=326)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.5599` → IC=+0.154 (n=565)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5599 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.8892` → IC=+0.169 (n=282)
...
- **PATRÓN** `dist_vwap_pct` < `0.4248` → IC=+0.164 (n=780)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.4248 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.676` → IC=+0.161 (n=848)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` < 6.676 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `0.7212` → IC=+0.156 (n=756)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` > 0.7212 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` < `0.1121` → IC=+0.154 (n=779)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` < 0.1121 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.164 (n=248)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_pendiente_norm` > 0.1721 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.2097` → IC=+0.159 (n=730)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.2097 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.5168` → IC=+0.154 (n=741)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.5168 (IC base=+0.153)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.160 (n=825)
...
- **PATRÓN** `ibs_20min` > `0.9583` → IC=+0.217 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9583 (IC base=+0.090)

- **PATRÓN** `dist_vwap_pct` > `0.1983` → IC=+0.121 (n=138)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.1983 (IC base=+0.090)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.157` → IC=+0.211 (n=43)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.157 (IC base=+0.090)
...
- **PATRÓN** `libro_liquidez` > `3406.9619` → IC=+0.148 (n=177)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3406.9619 (IC base=+0.090)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.208 (n=375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.004 (IC base=+0.100)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.134 (n=790)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 8.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.557` → IC=+0.189 (n=756)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.557 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.1483` → IC=+0.164 (n=424)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 0.1483 (IC base=+0.100)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.283` → IC=+0.217 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.283 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` < `2.0983` → IC=+0.147 (n=567)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 2.0983 (IC base=+0.100)

- **PATRÓN** `volumen_spike_ratio` > `1.3977` → IC=+0.127 (n=644)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` > 1.3977 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.128 (n=608)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2432.8034` → IC=+0.153 (n=332)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 2432.8034 (IC base=+0.100)
...
- **PATRÓN** `sigma_h` < `0.003` → IC=+0.277 (n=128)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.003 (IC base=+0.111)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.123 (n=271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 8.0 (IC base=+0.111)

- **PATRÓN** `ibs_20min` > `0.5717` → IC=+0.197 (n=259)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` > 0.5717 (IC base=+0.111)

- **PATRÓN** `dist_vwap_pct` > `0.1318` → IC=+0.193 (n=138)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1318 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `1.0669` → IC=+0.126 (n=228)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0669 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` < `0.0651` → IC=+0.140 (n=195)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.0651 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2764` → IC=+0.186 (n=33)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.2764 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` < `2.0198` → IC=+0.194 (n=194)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.0198 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=264)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `3992.2294` → IC=+0.140 (n=112)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 3992.2294 (IC base=+0.111)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.150 (n=258)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 8.0 (IC base=+0.110)

- **PATRÓN** `ibs_20min` > `0.6967` → IC=+0.234 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6967 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` > `0.1269` → IC=+0.167 (n=145)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.1269 (IC base=+0.110)

- **PATRÓN** `dist_vwap_pct` < `0.7468` → IC=+0.126 (n=287)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` < 0.7468 (IC base=+0.110)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.815` → IC=+0.295 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.815 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` < `0.8144` → IC=+0.129 (n=173)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 0.8144 (IC base=+0.110)

- **PATRÓN** `volumen_regimen` > `0.974` → IC=+0.139 (n=117)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 0.974 (IC base=+0.110)

- **PATRÓN** `volumen_pendiente_norm` > `0.291` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.291 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` < `1.7369` → IC=+0.167 (n=139)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.7369 (IC base=+0.110)

- **PATRÓN** `volumen_spike_ratio` > `2.456` → IC=+0.134 (n=69)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.456 (IC base=+0.110)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.127 (n=269)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.02 (IC base=+0.110)

- **PATRÓN** `libro_liquidez` > `1599.0586` → IC=+0.184 (n=115)

  - _Acción_: Kelly boost +0.92€ cuando `libro_liquidez` > 1599.0586 (IC base=+0.110)
...
- **PATRÓN** `hora_utc` > `9.0` → IC=+0.121 (n=246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.60€ cuando `hora_utc` > 9.0 (IC base=+0.075)

- **PATRÓN** `ibs_20min` > `0.6774` → IC=+0.176 (n=214)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 0.6774 (IC base=+0.075)

- **PATRÓN** `dist_vwap_pct` > `0.1957` → IC=+0.152 (n=139)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.1957 (IC base=+0.075)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.244` → IC=+0.207 (n=97)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.244 (IC base=+0.075)

- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.163 (n=81)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 1.0643 (IC base=+0.075)
...
- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.136 (n=108)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` > 0.0058 (IC base=+0.086)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.134 (n=110)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.67€ cuando `hora_utc` > 15.0 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.6522` → IC=+0.164 (n=239)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` > 0.6522 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `0.4724` → IC=+0.190 (n=56)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` > 0.4724 (IC base=+0.086)
...
### LEADLAG_BTC_XRP_15M
- **PATRÓN** `hora_utc` > `16.0` → IC=+0.133 (n=238)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2880.8552` → IC=+0.167 (n=220)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2880.8552 (IC base=+0.108)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=1645)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.167 (n=16)
  ...
  - _Acción_: SKIP cuando `liq_imbalance_15min` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=735)
...
- **FILTRO** `liq_imbalance` |x|≤ `1.0` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `liq_imbalance` |x|≤ 1.0
  - _Potencial_: sin este filtro IC_bueno=-0.042 (n=328)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=7342)
...
- **FILTRO** `py_entrada` < `0.47` → IC=-0.173 (n=3178)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.056 (n=10124)

- **FILTRO** `py_entrada` > `0.595` → IC=-0.171 (n=3425)

  - _Acción_: SKIP cuando `py_entrada` > 0.595
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=10313)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.45` → IC=-0.213 (n=563)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1732)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.171 (n=561)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1898)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.46` → IC=-0.201 (n=580)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.107 (n=1760)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.205 (n=602)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.062 (n=1850)

- **FILTRO** `ibs_20min` > `0.283` → IC=-0.163 (n=612)

  - _Acción_: SKIP cuando `ibs_20min` > 0.283
  - _Potencial_: sin este filtro IC_bueno=+0.049 (n=1840)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.48` → IC=-0.176 (n=553)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.083 (n=1725)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.183 (n=606)

  - _Acción_: SKIP cuando `py_entrada` > 0.57
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1844)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2674)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=2834)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=2840)

### MOMENTUM_IBS_15M_FADE#BTC#15min
- **FILTRO** `ibs_20min` > `0.1751` → IC=-0.143 (n=113)
...
- **FILTRO** `py_entrada` > `0.625` → IC=-0.273 (n=64)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=217)

### MOMENTUM_IBS_15M_FADE#SOL#15min
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=746)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.130 (n=9434)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=21217)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.274 (n=7436)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=23215)

- **FILTRO** `ibs_7min` < `0.29` → IC=-0.235 (n=7662)

  - _Acción_: SKIP cuando `ibs_7min` < 0.29
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=22989)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.156 (n=10381)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.061 (n=20270)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=9461)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.000 (n=28735)

- **FILTRO** `ibs_7min` > `0.2941` → IC=-0.180 (n=9516)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2941
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=28680)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1544)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3501)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.308 (n=1204)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3841)

- **FILTRO** `ibs_7min` < `0.7098` → IC=-0.252 (n=1664)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7098
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3381)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.183 (n=1174)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3871)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.261 (n=1632)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.005 (n=4942)

- **FILTRO** `drift_7min_pct` |x|> `0.1118` → IC=-0.124 (n=2235)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1118
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=4339)

- **FILTRO** `ibs_7min` > `0.7945` → IC=-0.208 (n=1641)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7945
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=4933)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1237)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=4073)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.251 (n=1278)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=4032)

- **FILTRO** `ibs_7min` < `0.7495` → IC=-0.192 (n=1327)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7495
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=3983)

- **FILTRO** `ballena_activa_n` > `160.0` → IC=-0.171 (n=1324)

  - _Acción_: SKIP cuando `ballena_activa_n` > 160.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3986)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.254 (n=1321)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=4019)

- **FILTRO** `ibs_7min` > `0.2598` → IC=-0.177 (n=1334)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2598
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=4006)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.188 (n=1327)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4013)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.169 (n=1352)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.080 (n=3426)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.309 (n=1166)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=3612)

- **FILTRO** `ibs_7min` < `0.1963` → IC=-0.258 (n=1194)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1963
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3584)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.214 (n=1125)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3653)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.238 (n=1624)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=5388)

- **FILTRO** `ibs_7min` > `0.7539` → IC=-0.178 (n=1752)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7539
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5260)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.232 (n=1489)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=3561)

- **FILTRO** `ibs_7min` < `0.7427` → IC=-0.180 (n=1262)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7427
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=3788)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.168 (n=1236)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=3814)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.265 (n=1139)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=3990)

- **FILTRO** `ibs_7min` > `0.275` → IC=-0.174 (n=1282)

  - _Acción_: SKIP cuando `ibs_7min` > 0.275
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=3847)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.192 (n=1254)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3875)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.263 (n=1275)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=4093)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.240 (n=1320)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=4048)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.178 (n=1740)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=5518)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.252 (n=1628)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=3472)

- **FILTRO** `ibs_7min` < `0.7037` → IC=-0.228 (n=1275)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7037
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=3825)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.212 (n=1225)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3875)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.204 (n=1680)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5203)
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.129 (n=33)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=711)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=2787)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.230 (n=672)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.0756` → IC=+0.201 (n=653)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0756 (IC base=+0.188)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2136` → IC=+0.194 (n=495)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.97€ cuando `delta_ratio_macro` |x|> 0.2136 (IC base=+0.188)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1267` → IC=+0.233 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1267 (IC base=+0.188)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.197 (n=1384)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6087` → IC=+0.263 (n=1482)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6087 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` > `0.2952` → IC=+0.195 (n=532)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.2952 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.881` → IC=+0.273 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.881 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `2985.1852` → IC=+0.192 (n=988)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 2985.1852 (IC base=+0.188)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.208 (n=802)
...
- **FILTRO** `sigma_ewma_delta_pct` > `29.889` → IC=-0.152 (n=21)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=340)

### UPDOWN_GBM#ETH#15min
- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.167 (n=232)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0051 (IC base=+0.142)

- **PATRÓN** `drift_60min` |x|≤ `0.0691` → IC=+0.160 (n=154)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0691 (IC base=+0.142)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1405` → IC=+0.167 (n=232)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1405 (IC base=+0.142)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2561` → IC=+0.172 (n=245)

  - _Acción_: Kelly boost +0.86€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2561 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.164 (n=257)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 11.0 (IC base=+0.142)

- **PATRÓN** `ibs_15` > `0.6679` → IC=+0.238 (n=311)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6679 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.4333` → IC=+0.145 (n=108)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` > 0.4333 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` < `0.1631` → IC=+0.161 (n=272)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.1631 (IC base=+0.142)
...
- **PATRÓN** `libro_liquidez` > `3459.7073` → IC=+0.152 (n=311)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 3459.7073 (IC base=+0.142)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1498` → IC=+0.210 (n=160)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1498 (IC base=+0.172)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0665` → IC=+0.209 (n=163)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0665 (IC base=+0.172)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2717` → IC=+0.230 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2717 (IC base=+0.172)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.216 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.172)

- **PATRÓN** `ibs_15` > `0.6111` → IC=+0.255 (n=182)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6111 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` > `0.122` → IC=+0.197 (n=107)

  - _Acción_: Kelly boost +0.99€ cuando `dist_vwap_pct` > 0.122 (IC base=+0.172)

- **PATRÓN** `dist_vwap_pct` < `0.476` → IC=+0.172 (n=199)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.476 (IC base=+0.172)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.176 (n=140)

  - _Acción_: Kelly boost +0.88€ cuando `libro_spread` < 0.01 (IC base=+0.172)

- **PATRÓN** `libro_liquidez` > `3038.6807` → IC=+0.277 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3038.6807 (IC base=+0.172)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.227 (n=97)
...
- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.236 (n=267)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.0904` → IC=+0.252 (n=103)
...
- **PATRÓN** `ibs_15` > `0.5488` → IC=+0.284 (n=400)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5488 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` > `0.1292` → IC=+0.206 (n=246)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1292 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.726` → IC=+0.222 (n=88)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.726 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.396` → IC=+0.189 (n=358)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 7.396 (IC base=+0.188)

- **PATRÓN** `libro_liquidez` > `2902.2574` → IC=+0.279 (n=134)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2902.2574 (IC base=+0.188)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.157 (n=444)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.78€ cuando `ibs_15` < 0.1176 (IC base=+0.044)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1462` → IC=+0.359 (n=261)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.357 (n=396)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.334)

- **PATRÓN** `ibs_15` > `0.7853` → IC=+0.379 (n=393)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7853 (IC base=+0.334)

- **PATRÓN** `dist_vwap_pct` > `0.4313` → IC=+0.378 (n=121)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4313 (IC base=+0.334)

- **PATRÓN** `dist_vwap_pct` < `0.1089` → IC=+0.334 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1089 (IC base=+0.334)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.143` → IC=+0.339 (n=234)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.143 (IC base=+0.334)

- **PATRÓN** `sigma_ewma_delta_pct` < `13.899` → IC=+0.335 (n=355)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 13.899 (IC base=+0.334)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.341 (n=482)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.334)

- **PATRÓN** `libro_liquidez` > `3525.4286` → IC=+0.351 (n=393)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3525.4286 (IC base=+0.334)

- **PATRÓN** `ballena_activa_n` < `474.0` → IC=+0.357 (n=320)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1175` → IC=+0.236 (n=1047)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1175 (IC base=-0.039)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1778` → IC=+0.234 (n=1012)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1778 (IC base=-0.039)

- **PATRÓN** `ibs_15` < `0.35` → IC=+0.275 (n=1572)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.35 (IC base=-0.039)

- **PATRÓN** `dist_vwap_pct` > `0.6682` → IC=+0.286 (n=274)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6682 (IC base=-0.039)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.220 (n=380)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1144)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.226 (n=381)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1143)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=968)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.708` → IC=-0.253 (n=273)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.186 (n=1251)
...
- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.237 (n=630)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0076 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7787` → IC=+0.232 (n=554)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7787 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2011` → IC=+0.246 (n=286)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `ibs_15` < `0.3469` → IC=+0.266 (n=630)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3469 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.7529` → IC=+0.304 (n=90)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7529 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.925` → IC=+0.243 (n=107)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.925 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.189` → IC=+0.230 (n=672)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.189 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3546.5572` → IC=+0.226 (n=630)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3546.5572 (IC base=+0.225)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.987` → IC=-0.133 (n=311)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=2525)
...
- **PATRÓN** `dist_vwap_pct` > `0.4766` → IC=+0.200 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4766 (IC base=-0.045)
...
- **PATRÓN** `hora_utc` > `4.0` → IC=+0.308 (n=664)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6087 sube el IC de +0.188 a +0.263 en UPDOWN_GBM#15min (n=1482). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.6679 sube el IC de +0.142 a +0.238 en UPDOWN_GBM#ETH#15min (n=311). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.6111 sube el IC de +0.172 a +0.255 en UPDOWN_GBM#SOL#15min (n=182). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5488 sube el IC de +0.188 a +0.284 en UPDOWN_GBM#XRP#15min (n=400). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.044 a +0.157 en UPDOWN_GBM#XRP#15min (n=444). Ya aplicado como kelly_boost=+0.78€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.35 sube el IC de -0.039 a +0.275 en UPDOWN_GBM_15M_TARDIO (n=1572). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3469 sube el IC de +0.225 a +0.266 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=630). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3542 sube el IC de -0.045 a +0.256 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=289). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD**: dentro de BUY_YES, IBS > 0.7853 sube el IC de +0.334 a +0.379 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD (n=393). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min**: dentro de BUY_YES, IBS > 0.7401 sube el IC de +0.328 a +0.386 en UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min (n=173). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1270 | +0.094 | +171.42€ | 2 | 8 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1270 | +0.094 | +171.42€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS | 24058 | -0.090 | -3050.10€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1423 | -0.046 | -217.07€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 22635 | -0.093 | -2833.03€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3568 | -0.084 | -575.55€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3568 | -0.084 | -575.55€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 
 | 0 | 12 |
| ✅ UPDOWN_GBM#SOL#240min | 328 | -0.006 | -3.12€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 5147 | +0.014 | +56.34€ | 1 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 432 | +0.023 | +9.18€ | 0 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 37 | -0.167 | -2.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 4961 | +0.035 | +520.52€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 2296 | +0.078 | +553.24€ | 0 | 11 |
| ✅ UPDOWN_GBM#XRP#240min | 205 | -0.002 | -2.88€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 2460 | -0.002 | -29.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#daily | 131 | -0.139 | +1.67€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 523 | +0.334 | +147.62€ | 0 | 14 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 523 | +0.334 | +147.62€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 230 | +0.328 | +68.77€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 230 | +0.328 | +68.77€ | 0 | 13 |
| ✅ UPDOWN_GBM_15M_TARDIO | 11138 | -0.044 | +2268.39€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 11138 | -0.044 | +2268.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB | 658 | -0.049 | +324.66€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BNB#15min | 658 | -0.049 | +324.66€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 2090 | -0.124 | +24.39€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 2090 | -0.124 | +24.39€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE | 307 | +0.163 | +183.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#DOGE#15min | 307 | +0.163 | +183.38€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 1224 | +0.201 | +701.69€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 1224 | +0.201 | +701.69€ | 2 | 21 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 3421 | -0.065 | +518.87€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 3421 | -0.065 | +518.87€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 3438 | -0.079 | +515.40€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 3438 | -0.079 | +515.40€ | 2 | 4 |
...
**✅ H-GBM-18H** — Bloquear hora 18h UTC en GBM
  ...
  - _Estado_: IC=+0.018 n=459 — no justifica filtro, seguir monitorizando
  - _Datos_: n=459 IC=+0.018 PNL=+21.72€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: 519 celda(s) pasan gate riguroso completo de 2177 evaluadas (n>=40) y 3179 trackeadas (n>=15). Detalle: kelly_hora_segmentado.json

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.023 < 0.08 — monitorear
  - _Datos_: n=2295 IC=+0.023 PNL=+151.67€
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.090 n=264/60 | contraria IC=+0.150 n=261 | gap=-0.060 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=705/40 IC=+0.008 PNL=+0.58€ | BTC#60min: n=928/40 IC=+0.004 PNL=+16.95€ | SOL#60min: n=432/40 IC=+0.023 PNL=+9.18€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.051 n=315294 | tras_1loss IC=+0.076 n=245501 | tras_2loss IC=+0.045 n=103919/40 | gap=+0.006 (umbral 0.05)
...
**🟡 H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.216 > 0.08 con n=361 PNL=+257.19€
  - _Datos_: n=361 IC=+0.216 PNL=+257.19€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=1486 IC=+0.019 PNL=+19.26€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1486 IC=+0.019 PNL=+19.26€

**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  - _Hipótesis_: En 15min BUY_NO tiene IC=+0.119. ¿Se repite en 60min? Datos actuales: 8/14 (57%) IC=+0.044 — positivo pero débil. Puede ser que 60min requiera dirección alcista (BUY_YES) y no bajista.
  - _Umbral_: n≥30 para confirmar dirección
  - _Acción_: Si IC<0.05 con n≥30 → en 60min priorizar solo BUY_YES; si IC>0.08 → igualar al BUY_YES
  - _Estado_: n=579 IC=-0.016 PNL=+7.45€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=579 IC=-0.016 PNL=+7.45€

**〰️ H-CUSTOM-GBM-18H** — GBM a las 18h UTC — ¿blacklist necesario?
  - _Hipótesis_: IC=-0.148 con n=11 en GBM a las 18h UTC. P5 del roadmap: bloquear cuando n≥15. Esta hipótesis hace el tracking automático.
  - _Umbral_: n≥15 y IC<-0.08
  - _Acción_: Auto-añadir 18h a GBM_BLACKLIST cuando IC<-0.08 con n≥15 (P5 roadmap)
  - _Estado_: n=459 IC=+0.018 PNL=+21.72€ — sin señal clara aún (umbral IC: min=None max=-0.08)
  - _Datos_: n=459 IC=+0.018 PNL=+21.72€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.188 > 0.1 con n=1976 PNL=+1244.80€
  - _Datos_: n=1976 IC=+0.188 PNL=+1244.80€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=1165 IC=+0.079 PNL=+250.24€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=1165 IC=+0.079 PNL=+250.24€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=11798 IC=+0.057 PNL=+1490.98€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=11798 IC=+0.057 PNL=+1490.98€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=1763 IC=+0.044 PNL=+178.97€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=1763 IC=+0.044 PNL=+178.97€
...
**🟡 H-CUSTOM-BTC15-TARDE** — BTC#15min en tarde UTC (hora>=16) — el bolsillo rentable dentro de un subtipo mediocre
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.125 > 0.1 con n=369 PNL=+103.70€
  - _Datos_: n=369 IC=+0.125 PNL=+103.70€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=16722 IC=-0.137 PNL=+1156.86€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=16722 IC=-0.137 PNL=+1156.86€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=1815 IC=+0.137 PNL=+973.05€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=1815 IC=+0.137 PNL=+973.05€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema. IMPLEMENTADO 21-Jul
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.237 < -0.1 con n=1644 PNL=-172.70€
  - _Datos_: n=1644 IC=-0.237 PNL=-172.70€
...
**🔶 H-CUSTOM-LEADLAG-XRP-BUYNO** — LEADLAG_BTC_XRP_15M -- la señal se concentra en BUY_NO, BUY_YES está plano
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.088 n=923) pero sin cruzar ≥2 pares más — sin otros pares con datos
  - _Datos_: n=923 IC=+0.088 PNL=+209.46€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=8324 IC=+0.176 PNL=-967.48€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=8324 IC=+0.176 PNL=-967.48€
...
**🟡 H-CUSTOM-GBMLATE15M-SOL-RESCATE-PRECIO** — GBM_LATE_15M#SOL#15min#BUY_YES (pausada 05-Ago) -- posible rescate con filtro py en [0.45,0.55)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.192 > 0.1 con n=131 PNL=+73.85€
  - _Datos_: n=131 IC=+0.192 PNL=+73.85€
