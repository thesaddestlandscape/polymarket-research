# Hipótesis automáticas — 2026-07-02 08:56 UTC
_Generado por shadow_postmortem.py sobre 2592 resoluciones (PNL=-76.22€)_
...
- **LIVE-CANDIDATA**: `GBM_LATE_15M` — IC=+0.271 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.
- **LIVE-CANDIDATA**: `GBM_LATE_15M#15min` — IC=+0.271 n=33. Faltan ~7 resoluciones para umbral n≥40. ETA: ~5h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 33 | +0.271 | +9.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 33 | +0.271 | +9.70€ | 0 | 0 |
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 175/200 ops en el filtro definido (IC actual=+0.071 PNL=+16.70€)
  - _Datos_: n=175 IC=+0.071 PNL=+16.70€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=175 IC=+0.071 PNL=+16.70€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=175 IC=+0.071 PNL=+16.70€
