# Hipótesis automáticas — 2026-07-04 04:43 UTC
_Generado por shadow_postmortem.py sobre 3352 resoluciones (PNL=+2.95€)_
...
- **FILTRO** `drift_60min` |x|> `0.4113` → IC=-0.136 (n=42)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.4113
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 618 | +0.073 | +108.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 618 | +0.073 | +108.73€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 162 | +0.024 | +9.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 162 | +0.024 | +9.97€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 162 | +0.012 | +4.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 162 | +0.012 | +4.70€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 155 | +0.112 | +43.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 155 | +0.112 | +43.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 139 | +0.152 | +50.45€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 139 | +0.152 | +50.45€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 900 | -0.044 | -62.24€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 667 | -0.025 | -33.93€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 366 | -0.016 | -0.14€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 281 | -0.002 | +6.84€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.048) — sin ventaja clara. oversold(IBS<0.3): IC=-0.024 n=183 | neutral: IC=-0.072 n=150 | overbought(IBS>0.7): IC=-0.053 n=159
  - _Datos_: n=510 IC=-0.047 PNL=-37.01€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.014 n=1623 | tras_1loss IC=-0.021 n=1624 | tras_2loss IC=-0.041 n=828/40 | gap=+0.055 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=777 IC=-0.040 PNL=-48.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=777 IC=-0.040 PNL=-48.69€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=400 IC=-0.055 PNL=-47.74€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=400 IC=-0.055 PNL=-47.74€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=919 IC=+0.042 PNL=+88.52€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=919 IC=+0.042 PNL=+88.52€
...
**🔴 H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.077 < -0.05 con n=542 PNL=-75.66€
  - _Datos_: n=542 IC=-0.077 PNL=-75.66€
