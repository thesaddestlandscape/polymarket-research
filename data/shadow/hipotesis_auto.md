# Hipótesis automáticas — 2026-07-09 23:00 UTC
_Generado por shadow_postmortem.py sobre 6872 resoluciones (PNL=+897.85€)_
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.125 (n=86)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.081 (n=275)

- **PATRÓN** `ibs_15` > `0.8261` → IC=+0.124 (n=123)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.62€ cuando `ibs_15` > 0.8261 (IC base=-0.004)
...
- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.132 (n=17)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.66€ cuando `sigma_h` < 0.0115 (IC base=+0.000)

- **PATRÓN** `hora_utc` > `22.0` → IC=+0.132 (n=17)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 22.0 (IC base=+0.000)
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 2660 | +0.113 | +875.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 2660 | +0.113 | +875.26€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 674 | +0.055 | +68.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 674 | +0.055 | +68.38€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 678 | +0.072 | +113.41€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 678 | +0.072 | +113.41€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 685 | +0.162 | +388.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 685 | +0.162 | +388.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 623 | +0.167 | +305.07€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 623 | +0.167 | +305.07€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 165 | +0.153 | +45.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 165 | +0.153 | +45.26€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 37 | +0.141 | +10.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 37 | +0.141 | +10.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 43 | +0.122 | +11.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 43 | +0.122 | +11.00€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 44 | +0.109 | +5.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 44 | +0.109 | +5.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 41 | +0.221 | +18.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 41 | +0.221 | +18.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 208 | +0.024 | +14.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#15min | 208 | +0.024 | +14.68€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 51 | +0.047 | +4.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 51 | +0.047 | +4.47€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 53 | -0.027 | +1.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 53 | -0.027 | +1.92€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 48 | -0.100 | -3.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 48 | -0.100 | -3.03€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 56 | +0.155 | +11.32€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 56 | +0.155 | +11.32€ | 0 | 0 |
...
| ✅ STREAK_FADE_15M | 105 | +0.089 | +10.04€ | 0 | 0 |
| ✅ STREAK_FADE_15M#15min | 105 | +0.089 | +10.04€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH | 22 | +0.208 | +7.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#ETH#15min | 22 | +0.208 | +7.63€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL | 38 | +0.050 | +0.89€ | 0 | 0 |
| ✅ STREAK_FADE_15M#SOL#15min | 38 | +0.050 | +0.89€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 1197 | -0.016 | -3.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 945 | +0.012 | +32.19€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 566 | +0.004 | +18.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 474 | +0.023 | +28.77€ | 1 | 2 |
...
| ✅ UPDOWN_GBM#SOL | 166 | -0.083 | -12.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 99 | -0.054 | -6.19€ | 5 | 2 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.101) — sin ventaja clara. oversold(IBS<0.3): IC=-0.017 n=296 | neutral: IC=-0.059 n=225 | overbought(IBS>0.7): IC=+0.042 n=249
  - _Datos_: n=807 IC=-0.004 PNL=+22.00€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=02h: IC=-0.177 n=29 PNL=-7.49€ → FILTRAR | H=03h: IC=-0.115 n=24 PNL=-7.44€ → FILTRAR | H=07h: IC=+0.113 n=29 PNL=+7.41€ → BOOST | H=08h: IC=-0.107 n=26 PNL=-3.42€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.132 n=36 PNL=+7.33€ → BOOST | H=17h: IC=+0.132 n=36 PNL=+12.29€ → BOOST | H=22h: IC=+0.128 n=41 PNL=+7.59€ → BOOST
...
**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  ...
  - _Datos_: n=99 IC=-0.054 PNL=-6.19€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.062 n=3660 | tras_1loss IC=+0.014 n=3093 | tras_2loss IC=-0.017 n=1471/40 | gap=+0.079 (umbral 0.05)
...
**⏳ H-WINDOW-MOMENTUM** — Momentum de outcome entre ventanas 15min contiguas
  ...
  - _Estado_: alineada_con_outcome_prev IC=+0.181 n=45/60 | contraria IC=+0.066 n=15 | gap=+0.115 (umbral 0.08) — verificar independencia de drift_15min/60min antes de actuar
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1074 IC=-0.010 PNL=+10.32€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1074 IC=-0.010 PNL=+10.32€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=536 IC=-0.004 PNL=-4.98€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=536 IC=-0.004 PNL=-4.98€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=464 IC=+0.034 PNL=+15.61€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=464 IC=+0.034 PNL=+15.61€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=385 IC=+0.014 PNL=+18.72€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=385 IC=+0.014 PNL=+18.72€
...
**⏳ H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: 38/40 ops en el filtro definido (IC actual=+0.225 PNL=+10.12€)
  - _Datos_: n=38 IC=+0.225 PNL=+10.12€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=4414 IC=+0.073 PNL=+973.74€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=4414 IC=+0.073 PNL=+973.74€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=683 IC=-0.036 PNL=-35.46€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=683 IC=-0.036 PNL=-35.46€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.174 > 0.1 con n=185 PNL=+67.67€
  - _Datos_: n=185 IC=+0.174 PNL=+67.67€
...
**⏳ H-CUSTOM-BUYNO-LONGSHOT-15MIN** — BUY_NO longshot en 15min (py_mkt≥0.55) — comprar NO barato pierde
  ...
  - _Estado_: 30/40 ops en el filtro definido (IC actual=-0.094 PNL=-1.32€)
  - _Datos_: n=30 IC=-0.094 PNL=-1.32€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.08 con n=132 PNL=+41.26€
  - _Datos_: n=132 IC=+0.172 PNL=+41.26€
...
**⏳ H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: 277/289 ops en el filtro definido (IC actual=-0.188 PNL=-50.06€)
  - _Datos_: n=277 IC=-0.188 PNL=-50.06€
...
**⏳ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: 34/100 ops en el filtro definido (IC actual=+0.333 PNL=+19.85€)
  - _Datos_: n=34 IC=+0.333 PNL=+19.85€
