# Hipótesis automáticas — 2026-09-04 01:35 UTC
_Generado por shadow_postmortem.py sobre 274153 resoluciones (PNL=+26632.03€)_
...
- **FILTRO** `py_entrada` < `0.505` → IC=-0.170 (n=107)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.255 (n=337)

- **FILTRO** `py_entrada` > `0.5` → IC=-0.392 (n=81)

  - _Acción_: SKIP cuando `py_entrada` > 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.123 (n=282)

- **PATRÓN** `py_entrada` > `0.505` → IC=+0.255 (n=337)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.505 (IC base=+0.152)

- **PATRÓN** `n_ballena_banda` > `19.0` → IC=+0.166 (n=306)

  - _Acción_: Kelly boost +0.83€ cuando `n_ballena_banda` > 19.0 (IC base=+0.152)

- **PATRÓN** `n_total_lado` > `75.0` → IC=+0.245 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `n_total_lado` > 75.0 (IC base=+0.152)

- **PATRÓN** `banda_hit_calibrado` > `0.6242` → IC=+0.252 (n=336)

  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.6242 (IC base=+0.152)

- **PATRÓN** `banda_z` > `11.795` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 11.795 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.161 (n=302)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.158 (n=241)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 12.0 (IC base=+0.152)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.178 (n=346)

  - _Acción_: Kelly boost +0.89€ cuando `libro_spread` < 0.01 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `3103.76` → IC=+0.199 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3103.76 (IC base=+0.152)

- **PATRÓN** `py_entrada` < `0.5` → IC=+0.123 (n=282)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` < 0.5 (IC base=+0.007)

### BALLENAS_CONFIRMADAS_15M#ETH#15min
- **FILTRO** `py_entrada` > `0.495` → IC=-0.370 (n=52)

  - _Acción_: SKIP cuando `py_entrada` > 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.110 (n=157)
...
- **PATRÓN** `n_ballena_banda` > `18.0` → IC=+0.195 (n=244)
  ...
  - _Acción_: Kelly boost +0.98€ cuando `n_ballena_banda` > 18.0 (IC base=+0.183)
...
- **PATRÓN** `banda_hit_calibrado` > `0.8026` → IC=+0.269 (n=240)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `banda_hit_calibrado` > 0.8026 (IC base=+0.183)

- **PATRÓN** `banda_z` > `12.634` → IC=+0.281 (n=80)

  - _Acción_: Kelly boost +1.00€ cuando `banda_z` > 12.634 (IC base=+0.183)

- **PATRÓN** `ballenas_wallet_edge_medio` > `3.102` → IC=+0.188 (n=78)

  - _Acción_: Kelly boost +0.94€ cuando `ballenas_wallet_edge_medio` > 3.102 (IC base=+0.183)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.192 (n=222)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 7.0 (IC base=+0.183)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.190 (n=169)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.95€ cuando `hora_utc` < 12.0 (IC base=+0.183)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=269)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.183)

- **PATRÓN** `libro_liquidez` > `2935.919` → IC=+0.198 (n=160)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2935.919 (IC base=+0.183)

- **PATRÓN** `py_entrada` < `0.485` → IC=+0.124 (n=115)

  - _Acción_: Kelly boost +0.62€ cuando `py_entrada` < 0.485 (IC base=-0.012)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `146.54` → IC=-0.298 (n=3694)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 146.54
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=11089)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.02` → IC=-0.292 (n=479)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.02
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=1440)
...
- **FILTRO** `restante_s_al_confirmar` < `113.85` → IC=-0.405 (n=492)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 113.85
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1478)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `142.53` → IC=-0.315 (n=820)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 142.53
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=2463)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `156.95` → IC=-0.378 (n=892)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.95
  - _Potencial_: sin este filtro IC_bueno=-0.103 (n=1812)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.188 (n=8011)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.7 (IC base=+0.094)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.168 (n=2023)

  - _Acción_: Kelly boost +0.84€ cuando `libro_spread` < 0.01 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2371.8427` → IC=+0.170 (n=1940)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.153 (n=6428)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 7.0 (IC base=+0.141)

- **PATRÓN** `py_entrada` < `0.34` → IC=+0.253 (n=4892)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.34 (IC base=+0.141)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=3845)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.141)

- **PATRÓN** `libro_liquidez` > `1928.8728` → IC=+0.175 (n=3288)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1928.8728 (IC base=+0.141)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.126 (n=562)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.139 (n=1373)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` < 15.0 (IC base=+0.134)

- **PATRÓN** `py_entrada` > `0.69` → IC=+0.311 (n=542)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.263 (n=697)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.261 (n=704)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1939.4936` → IC=+0.266 (n=674)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.149 (n=337)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.143 (n=458)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.213 (n=803)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `918.1633` → IC=+0.215 (n=771)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.195 (n=5191)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` < 15.0 (IC base=+0.189)

- **PATRÓN** `py_entrada` > `0.73` → IC=+0.201 (n=2942)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.178 (n=1346)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` < 15.0 (IC base=+0.165)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.180 (n=1584)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.176 (n=1311)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 15.0 (IC base=+0.169)

- **PATRÓN** `py_entrada` < `0.74` → IC=+0.174 (n=1589)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.237 (n=1182)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.237)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.314 (n=499)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.186 (n=1283)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.206 (n=17438)
...
- **PATRÓN** `hora_utc` < `12.0` → IC=+0.147 (n=2415)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` < 12.0 (IC base=+0.146)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.175 (n=2565)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.226 (n=1113)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.225)

- **PATRÓN** `py_entrada` > `0.72` → IC=+0.258 (n=2215)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.178 (n=3007)
...
- **PATRÓN** `hora_utc` < `6.0` → IC=+0.226 (n=1131)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.220)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.269 (n=1095)
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.236 (n=1504)
...
- **PATRÓN** `restante_min` < `4.43` → IC=+0.135 (n=1534)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 4.43 (IC base=+0.128)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.160 (n=1301)
...
- **PATRÓN** `hora_utc` < `8.0` → IC=+0.138 (n=1706)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 8.0 (IC base=+0.128)

- **PATRÓN** `lag_apertura_s` < `3.32` → IC=+0.168 (n=1161)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3571` → IC=+0.128 (n=3669)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` > 0.3571 (IC base=+0.081)

- **PATRÓN** `dist_vwap_pct` > `0.2733` → IC=+0.222 (n=477)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2733 (IC base=+0.081)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.606` → IC=+0.150 (n=1404)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 5.606 (IC base=+0.081)

- **PATRÓN** `volumen_regimen` < `0.6962` → IC=+0.224 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6962 (IC base=+0.081)

- **PATRÓN** `volumen_regimen` > `1.0858` → IC=+0.243 (n=380)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0858 (IC base=+0.081)

- **PATRÓN** `volumen_pendiente_norm` > `0.1732` → IC=+0.176 (n=627)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1732 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` < `2.88` → IC=+0.174 (n=2196)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` < 2.88 (IC base=+0.081)

- **PATRÓN** `volumen_spike_ratio` > `1.4772` → IC=+0.170 (n=2196)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 1.4772 (IC base=+0.081)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.198 (n=1098)

  - _Acción_: Kelly boost +0.99€ cuando `ballena_activa_n` < 54.0 (IC base=+0.081)

- **PATRÓN** `ibs_20min` < `0.4031` → IC=+0.128 (n=3530)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4031 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` < `0.3413` → IC=+0.145 (n=1278)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3413 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.6878` → IC=+0.151 (n=548)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 0.6878 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `1.0473` → IC=+0.138 (n=564)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` > 1.0473 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.3042` → IC=+0.251 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3042 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.8602` → IC=+0.213 (n=622)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8602 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `127.0` → IC=+0.213 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 127.0 (IC base=+0.042)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2794` → IC=+0.157 (n=818)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.2794 (IC base=+0.153)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.276 (n=573)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` < `0.4014` → IC=+0.284 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4014 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.165` → IC=+0.273 (n=575)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 3.165 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` < `0.0672` → IC=+0.258 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0672 (IC base=+0.258)
...
- **PATRÓN** `volumen_spike_ratio` > `1.6072` → IC=+0.282 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6072 (IC base=+0.258)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.269 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1701.724` → IC=+0.284 (n=363)
...
- **PATRÓN** `ibs_20min` > `0.9278` → IC=+0.238 (n=292)
...
- **PATRÓN** `dist_vwap_pct` < `0.487` → IC=+0.215 (n=578)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.487 (IC base=+0.211)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.05` → IC=+0.214 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.05 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.215 (n=643)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2628 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` > `1.099` → IC=+0.228 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.099 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.0999` → IC=+0.216 (n=610)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0999 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.4875` → IC=+0.241 (n=272)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4875 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11847.0948` → IC=+0.241 (n=574)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11847.0948 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.004` → IC=+0.156 (n=469)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.004 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.1757` → IC=+0.152 (n=469)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.1757 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.141 (n=636)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.142 (n=735)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 18.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` < `0.6603` → IC=+0.164 (n=703)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.6603 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.3375` → IC=+0.159 (n=676)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.3375 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.516` → IC=+0.223 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.516 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.179 (n=235)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.618 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1499` → IC=+0.217 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1499 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.3943` → IC=+0.152 (n=596)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.3943 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` > `1.4046` → IC=+0.155 (n=596)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 1.4046 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.154 (n=469)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.140)

- **PATRÓN** `ballena_activa_n` < `293.0` → IC=+0.159 (n=341)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 293.0 (IC base=+0.140)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.210 (n=257)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0096 (IC base=+0.161)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.201 (n=286)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1322` → IC=+0.160 (n=659)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` < 0.1322 (IC base=+0.161)

- **PATRÓN** `volumen_pendiente_norm` > `0.3904` → IC=+0.153 (n=96)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_pendiente_norm` > 0.3904 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` < `3.8997` → IC=+0.154 (n=686)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 3.8997 (IC base=+0.161)

- **PATRÓN** `volumen_spike_ratio` > `1.8939` → IC=+0.175 (n=614)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` > 1.8939 (IC base=+0.161)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.184 (n=793)
...
- **PATRÓN** `sigma_h` < `0.0102` → IC=+0.253 (n=625)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0102 (IC base=+0.240)

- **PATRÓN** `drift_60min` |x|≤ `0.3789` → IC=+0.245 (n=550)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.262 (n=284)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.240)

- **PATRÓN** `ibs_20min` < `0.0351` → IC=+0.306 (n=209)
...
- **PATRÓN** `dist_vwap_pct` > `0.2938` → IC=+0.189 (n=59)

  - _Acción_: Kelly boost +0.94€ cuando `dist_vwap_pct` > 0.2938 (IC base=-0.040)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5804` → IC=+0.137 (n=180)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` > 1.5804 (IC base=-0.040)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1212` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_pendiente_norm` > 0.1212 (IC base=-0.057)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.5298` → IC=-0.154 (n=348)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.5298
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=676)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.196 (n=113)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.089 (n=911)

- **FILTRO** `ibs_20min` > `0.7917` → IC=-0.188 (n=411)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7917
  - _Potencial_: sin este filtro IC_bueno=-0.002 (n=1234)
...
- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.204 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2288 (IC base=-0.101)

- **PATRÓN** `volumen_regimen` > `1.0562` → IC=+0.295 (n=37)
...
- **PATRÓN** `dist_vwap_pct` < `0.2666` → IC=+0.216 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2666 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` < `0.742` → IC=+0.192 (n=92)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.742 (IC base=-0.048)

- **PATRÓN** `volumen_regimen` > `1.3205` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.3205 (IC base=-0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.2742` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2742 (IC base=-0.048)

- **PATRÓN** `volumen_spike_ratio` < `2.3188` → IC=+0.177 (n=91)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.3188 (IC base=-0.048)

- **PATRÓN** `volumen_spike_ratio` > `1.906` → IC=+0.162 (n=69)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.906 (IC base=-0.048)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.148 (n=69)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 20.0 (IC base=-0.048)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.172 (n=1513)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0094 (IC base=+0.071)

- **PATRÓN** `ibs_20min` > `0.2903` → IC=+0.139 (n=4533)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.2903 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` > `0.9248` → IC=+0.288 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9248 (IC base=+0.071)

- **PATRÓN** `volumen_regimen` > `0.6815` → IC=+0.217 (n=1314)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6815 (IC base=+0.071)

- **PATRÓN** `volumen_pendiente_norm` < `0.115` → IC=+0.213 (n=2135)
...
- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.224 (n=1062)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2288 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` < `0.7144` → IC=+0.229 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7144 (IC base=+0.053)

- **PATRÓN** `volumen_regimen` > `1.229` → IC=+0.251 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.229 (IC base=+0.053)

- **PATRÓN** `volumen_pendiente_norm` > `0.2588` → IC=+0.346 (n=265)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2588 (IC base=+0.053)

- **PATRÓN** `volumen_spike_ratio` > `2.4249` → IC=+0.275 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4249 (IC base=+0.053)

- **PATRÓN** `ballena_activa_n` < `66.0` → IC=+0.271 (n=1131)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 66.0 (IC base=+0.053)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2957` → IC=-0.148 (n=376)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2957
  - _Potencial_: sin este filtro IC_bueno=+0.104 (n=766)

- **FILTRO** `sigma_ewma_delta_pct` > `2.434` → IC=-0.161 (n=325)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 2.434
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=719)

- **PATRÓN** `ibs_20min` > `0.8257` → IC=+0.215 (n=286)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8257 (IC base=+0.021)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.053` → IC=+0.126 (n=428)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` > 2.053 (IC base=+0.021)

- **PATRÓN** `volumen_pendiente_norm` > `0.2248` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2248 (IC base=+0.021)

- **PATRÓN** `volumen_spike_ratio` < `1.9482` → IC=+0.226 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9482 (IC base=+0.021)

- **PATRÓN** `volumen_spike_ratio` > `2.7246` → IC=+0.279 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7246 (IC base=+0.021)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.321 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.021)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **FILTRO** `ibs_20min` > `0.8608` → IC=-0.164 (n=382)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8608
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=1147)

- **PATRÓN** `ballena_activa_n` < `288.0` → IC=+0.145 (n=139)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 288.0 (IC base=-0.014)

- **PATRÓN** `dist_vwap_pct` < `0.1132` → IC=+0.167 (n=163)
...
- **PATRÓN** `volumen_regimen` > `1.1181` → IC=+0.167 (n=58)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1181 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` < `0.0647` → IC=+0.146 (n=128)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.0647 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` > `0.0817` → IC=+0.159 (n=39)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` > 0.0817 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` < `1.763` → IC=+0.230 (n=87)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.763 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `1.3934` → IC=+0.151 (n=130)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` > 1.3934 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `262.0` → IC=+0.189 (n=43)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 262.0 (IC base=-0.027)

### GBM_LATE_15M_ESPACIO_ATR#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.281 (n=332)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0083 (IC base=+0.220)

- **PATRÓN** `drift_60min` |x|≤ `0.1246` → IC=+0.221 (n=321)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1246 (IC base=+0.220)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.251 (n=271)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.220)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1403` → IC=+0.234 (n=615)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1403 (IC base=+0.220)

- **PATRÓN** `volumen_spike_ratio` > `1.727` → IC=+0.225 (n=645)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.727 (IC base=+0.220)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.248 (n=747)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.220)

- **PATRÓN** `sigma_h` > `0.0062` → IC=+0.328 (n=457)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3296` → IC=+0.325 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3296 (IC base=+0.311)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.68` → IC=+0.342 (n=162)
...
- **PATRÓN** `volumen_spike_ratio` < `3.5056` → IC=+0.312 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.5056 (IC base=+0.311)

- **PATRÓN** `volumen_spike_ratio` > `2.3984` → IC=+0.322 (n=279)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3984 (IC base=+0.311)

- **PATRÓN** `libro_liquidez` > `1841.9597` → IC=+0.327 (n=171)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1841.9597 (IC base=+0.311)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.308 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 29.0 (IC base=+0.311)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.152 (n=228)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=504)

- **FILTRO** `ibs_20min` < `0.7759` → IC=-0.133 (n=483)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7759
  - _Potencial_: sin este filtro IC_bueno=+0.086 (n=249)

- **FILTRO** `ibs_20min` > `0.7357` → IC=-0.148 (n=413)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7357
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=803)
...
- **FILTRO** `ibs_20min` < `0.8085` → IC=-0.140 (n=646)

  - _Acción_: SKIP cuando `ibs_20min` < 0.8085
  - _Potencial_: sin este filtro IC_bueno=+0.285 (n=333)
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.709` → IC=-0.150 (n=287)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.709
  - _Potencial_: sin este filtro IC_bueno=+0.013 (n=839)
...
- **PATRÓN** `volumen_regimen` < `0.8696` → IC=+0.244 (n=201)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1169` → IC=+0.253 (n=289)
...
- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.305 (n=224)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 57.0 (IC base=+0.005)

- **PATRÓN** `volumen_regimen` < `0.735` → IC=+0.146 (n=46)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.735 (IC base=-0.029)

- **PATRÓN** `volumen_pendiente_norm` > `0.1626` → IC=+0.219 (n=30)
...
- **PATRÓN** `volumen_spike_ratio` > `1.9868` → IC=+0.135 (n=50)
  ...
  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.9868 (IC base=-0.029)

- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 60.0 (IC base=-0.029)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0132` → IC=+0.332 (n=492)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0132 (IC base=+0.249)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.258 (n=349)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.249)

- **PATRÓN** `ibs_20min` > `0.8915` → IC=+0.322 (n=492)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.191` → IC=+0.290 (n=403)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.191 (IC base=+0.249)

- **PATRÓN** `volumen_regimen` > `0.8467` → IC=+0.289 (n=492)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8467 (IC base=+0.249)

- **PATRÓN** `volumen_pendiente_norm` > `0.2413` → IC=+0.293 (n=143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2413 (IC base=+0.249)

- **PATRÓN** `volumen_spike_ratio` < `2.5754` → IC=+0.257 (n=678)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5754 (IC base=+0.249)

- **PATRÓN** `volumen_spike_ratio` > `1.844` → IC=+0.253 (n=452)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.844 (IC base=+0.249)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.254 (n=861)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.249)

- **PATRÓN** `libro_liquidez` > `2467.2556` → IC=+0.254 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2467.2556 (IC base=+0.249)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.280 (n=266)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0062 (IC base=+0.278)

- **PATRÓN** `sigma_h` > `0.0239` → IC=+0.298 (n=265)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0239 (IC base=+0.278)

- **PATRÓN** `drift_60min` |x|≤ `0.3185` → IC=+0.280 (n=529)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.375` → IC=+0.318 (n=794)
...
- **PATRÓN** `dist_vwap_pct` < `0.2116` → IC=+0.283 (n=716)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2435` → IC=+0.382 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2435 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` < `1.4376` → IC=+0.267 (n=213)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4376 (IC base=+0.278)

- **PATRÓN** `volumen_spike_ratio` > `2.1984` → IC=+0.297 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1984 (IC base=+0.278)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.0106` → IC=+0.208 (n=1279)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0106 (IC base=+0.162)

- **PATRÓN** `drift_60min` |x|≤ `0.3424` → IC=+0.169 (n=3371)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.283 (n=1752)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.7937` → IC=+0.237 (n=845)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7937 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.704` → IC=+0.233 (n=1555)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.704 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` > `0.6287` → IC=+0.165 (n=2589)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6287 (IC base=+0.162)

- **PATRÓN** `volumen_pendiente_norm` > `0.1057` → IC=+0.183 (n=1429)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1057 (IC base=+0.162)

- **PATRÓN** `volumen_spike_ratio` < `2.324` → IC=+0.162 (n=3136)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.324 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.03` → IC=+0.165 (n=3912)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.03 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `3936.5622` → IC=+0.177 (n=1277)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 3936.5622 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.178 (n=2745)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 143.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0083` → IC=+0.189 (n=3136)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` < 0.0083 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.0793` → IC=+0.215 (n=1187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0793 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.197 (n=1748)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` > 15.0 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.184 (n=1620)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` < 7.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` < `0.4375` → IC=+0.231 (n=3561)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4375 (IC base=+0.180)

- **PATRÓN** `dist_vwap_pct` < `0.2295` → IC=+0.175 (n=2687)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.2295 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.992` → IC=+0.219 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.992 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` < `1.176` → IC=+0.169 (n=2692)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 1.176 (IC base=+0.180)

- **PATRÓN** `volumen_regimen` > `0.6238` → IC=+0.162 (n=2692)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` > 0.6238 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.2954` → IC=+0.255 (n=479)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2954 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` < `1.5762` → IC=+0.173 (n=1291)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.5762 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `2.6561` → IC=+0.200 (n=978)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6561 (IC base=+0.180)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.181 (n=2518)
...
- **PATRÓN** `libro_liquidez` > `1698.3448` → IC=+0.281 (n=267)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4155` → IC=+0.173 (n=567)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.4155 (IC base=+0.167)
...
- **PATRÓN** `ibs_20min` > `0.4793` → IC=+0.208 (n=567)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4793 (IC base=+0.167)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.405` → IC=+0.167 (n=539)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` < 7.405 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` < `0.6381` → IC=+0.186 (n=189)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_regimen` < 0.6381 (IC base=+0.167)

- **PATRÓN** `volumen_regimen` > `1.0731` → IC=+0.183 (n=257)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` > 1.0731 (IC base=+0.167)

- **PATRÓN** `volumen_pendiente_norm` > `0.2311` → IC=+0.194 (n=119)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_pendiente_norm` > 0.2311 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` < `1.4857` → IC=+0.203 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4857 (IC base=+0.167)
...
- **PATRÓN** `libro_liquidez` > `11309.5324` → IC=+0.191 (n=506)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 11309.5324 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.184 (n=656)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` < 0.0061 (IC base=+0.155)

- **PATRÓN** `drift_60min` |x|≤ `0.2979` → IC=+0.175 (n=656)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4833` → IC=+0.193 (n=656)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.4833 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` < `0.1998` → IC=+0.175 (n=657)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1998 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.232` → IC=+0.236 (n=138)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.232 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` < `0.6967` → IC=+0.222 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6967 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.221 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.442` → IC=+0.167 (n=548)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.442 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.3983` → IC=+0.162 (n=548)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.3983 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `15544.0472` → IC=+0.161 (n=219)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 15544.0472 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `238.0` → IC=+0.167 (n=154)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 238.0 (IC base=+0.155)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2845` → IC=+0.184 (n=526)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.188 (n=206)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1302` → IC=+0.171 (n=217)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1302 (IC base=+0.169)

- **PATRÓN** `volumen_spike_ratio` > `1.7067` → IC=+0.162 (n=534)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7067 (IC base=+0.169)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.192 (n=602)
...
- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.257 (n=468)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.237)

- **PATRÓN** `drift_60min` |x|≤ `0.2233` → IC=+0.258 (n=312)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3684` → IC=+0.272 (n=467)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3684 (IC base=+0.237)
...
- **PATRÓN** `ibs_20min` > `0.4481` → IC=+0.203 (n=571)
...
- **PATRÓN** `volumen_regimen` > `1.2091` → IC=+0.225 (n=191)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2091 (IC base=+0.159)

- **PATRÓN** `volumen_pendiente_norm` > `0.3006` → IC=+0.217 (n=97)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4303` → IC=+0.158 (n=185)
  ...
  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4303 (IC base=+0.159)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.160 (n=637)
...
- **PATRÓN** `ballena_activa_n` < `134.0` → IC=+0.147 (n=338)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 134.0 (IC base=+0.159)

- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.213 (n=214)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0029 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.381` → IC=+0.153 (n=641)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.381 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.171 (n=220)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.143 (n=289)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 7.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.3925` → IC=+0.201 (n=564)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3925 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.3499` → IC=+0.143 (n=702)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.3499 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.378` → IC=+0.208 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.378 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.8646` → IC=+0.144 (n=428)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.8646 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `0.6135` → IC=+0.139 (n=641)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6135 (IC base=+0.132)

- **PATRÓN** `volumen_pendiente_norm` > `0.1051` → IC=+0.176 (n=217)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_pendiente_norm` > 0.1051 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` < `1.8593` → IC=+0.147 (n=355)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.8593 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `2.5362` → IC=+0.161 (n=178)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 2.5362 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `5103.8872` → IC=+0.143 (n=427)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 5103.8872 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `181.0` → IC=+0.125 (n=403)

  - _Acción_: Kelly boost +0.62€ cuando `ballena_activa_n` < 181.0 (IC base=+0.132)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0065` → IC=+0.155 (n=644)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.5405` → IC=+0.194 (n=718)
...
- **PATRÓN** `volumen_regimen` > `0.7086` → IC=+0.130 (n=642)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` > 0.7086 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` < `0.1675` → IC=+0.135 (n=715)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_pendiente_norm` < 0.1675 (IC base=+0.114)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=723)

  - _Acción_: Kelly boost +0.60€ cuando `libro_spread` < 0.02 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `3182.8788` → IC=+0.219 (n=240)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3182.8788 (IC base=+0.114)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.148 (n=526)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 57.0 (IC base=+0.114)

- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.149 (n=297)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0094 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.1005` → IC=+0.147 (n=219)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.1005 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=308)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.4642` → IC=+0.228 (n=655)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4642 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.2524` → IC=+0.149 (n=616)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.2524 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.213` → IC=+0.176 (n=257)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.213 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `1.1985` → IC=+0.150 (n=655)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1985 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.8586` → IC=+0.151 (n=436)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 0.8586 (IC base=+0.134)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1018` → IC=+0.202 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1018 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `2179.137` → IC=+0.160 (n=436)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 2179.137 (IC base=+0.134)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0177` → IC=+0.215 (n=490)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0177 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.1724` → IC=+0.209 (n=324)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1724 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=769)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `0.8873` → IC=+0.270 (n=490)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8873 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` > `0.1663` → IC=+0.224 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1663 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.223` → IC=+0.240 (n=363)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.223 (IC base=+0.190)

- **PATRÓN** `volumen_regimen` > `0.6862` → IC=+0.210 (n=656)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6862 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.2397` → IC=+0.262 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2397 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `2.5276` → IC=+0.209 (n=695)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5276 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.193 (n=845)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0065` → IC=+0.276 (n=248)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0065 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.6429` → IC=+0.223 (n=742)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.248 (n=340)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.212)

- **PATRÓN** `ibs_20min` < `0.41` → IC=+0.257 (n=743)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.41 (IC base=+0.212)

- **PATRÓN** `dist_vwap_pct` < `0.5151` → IC=+0.219 (n=819)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5151 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.576` → IC=+0.260 (n=277)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.576 (IC base=+0.212)

- **PATRÓN** `volumen_regimen` > `0.6252` → IC=+0.230 (n=742)
...
- **PATRÓN** `libro_liquidez` > `2514.0359` → IC=+0.212 (n=495)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2514.0359 (IC base=+0.212)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.173 (n=267)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.476` → IC=+0.170 (n=801)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.476 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `0.9607` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9607 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.607` → IC=+0.175 (n=374)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.607 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.8754` → IC=+0.161 (n=431)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8754 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.1751` → IC=+0.154 (n=215)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 1.1751 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.1785` → IC=+0.174 (n=222)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.1785 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` < `2.2724` → IC=+0.149 (n=657)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.2724 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.8529` → IC=+0.144 (n=498)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.8529 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.157 (n=598)

  - _Acción_: Kelly boost +0.78€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `7345.5998` → IC=+0.177 (n=267)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7345.5998 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `12.0` → IC=+0.185 (n=195)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 12.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` < `0.31` → IC=+0.133 (n=545)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.31 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.149 (n=297)

  - _Acción_: Kelly boost +0.74€ cuando `ballena_activa_n` < 20.0 (IC base=+0.068)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.270 (n=133)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.260)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.312 (n=67)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0075 (IC base=+0.260)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.291 (n=199)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.260)

- **PATRÓN** `ibs_20min` > `0.7759` → IC=+0.307 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7759 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` > `0.1787` → IC=+0.286 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1787 (IC base=+0.260)

- **PATRÓN** `dist_vwap_pct` < `0.7873` → IC=+0.266 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7873 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.256` → IC=+0.330 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.256 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` < `0.8463` → IC=+0.278 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8463 (IC base=+0.260)

- **PATRÓN** `volumen_regimen` > `1.168` → IC=+0.312 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.168 (IC base=+0.260)

- **PATRÓN** `volumen_pendiente_norm` > `0.1004` → IC=+0.347 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1004 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` < `1.3759` → IC=+0.306 (n=65)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3759 (IC base=+0.260)

- **PATRÓN** `volumen_spike_ratio` > `2.0363` → IC=+0.324 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.0363 (IC base=+0.260)

- **PATRÓN** `drift_60min` |x|≤ `0.1083` → IC=+0.154 (n=50)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1083 (IC base=+0.045)

- **PATRÓN** `libro_liquidez` > `10478.1704` → IC=+0.152 (n=67)

  - _Acción_: Kelly boost +0.76€ cuando `libro_liquidez` > 10478.1704 (IC base=+0.045)
...
- **PATRÓN** `sigma_h` < `0.0215` → IC=+0.157 (n=138)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0215 (IC base=+0.143)

- **PATRÓN** `drift_60min` |x|≤ `0.303` → IC=+0.167 (n=121)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.303 (IC base=+0.143)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.180 (n=48)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 16.0 (IC base=+0.143)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.144 (n=99)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 10.0 (IC base=+0.143)

- **PATRÓN** `ibs_20min` > `0.4` → IC=+0.167 (n=139)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.4 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` > `0.1933` → IC=+0.178 (n=57)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1933 (IC base=+0.143)

- **PATRÓN** `dist_vwap_pct` < `0.4345` → IC=+0.147 (n=154)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.4345 (IC base=+0.143)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.317` → IC=+0.183 (n=118)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` < 3.317 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` < `0.9833` → IC=+0.142 (n=121)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.9833 (IC base=+0.143)

- **PATRÓN** `volumen_regimen` > `0.6516` → IC=+0.164 (n=123)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` > 0.6516 (IC base=+0.143)

- **PATRÓN** `volumen_pendiente_norm` < `0.2201` → IC=+0.178 (n=119)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` < 0.2201 (IC base=+0.143)

- **PATRÓN** `volumen_spike_ratio` < `1.9259` → IC=+0.205 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9259 (IC base=+0.143)
...
- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.228 (n=90)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=+0.143)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.201 (n=2081)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_h` > `0.007` → IC=+0.235 (n=342)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.007 (IC base=+0.184)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.216 (n=283)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `sigma_ewma_delta_pct` > `2.073` → IC=+0.297 (n=480)
...
- **PATRÓN** `volumen_spike_ratio` > `2.308` → IC=+0.177 (n=305)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.308 (IC base=+0.184)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.232 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.184)

- **PATRÓN** `ballena_activa_n` < `77.0` → IC=+0.234 (n=422)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 77.0 (IC base=+0.184)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.274 (n=490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.269)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.277 (n=555)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.269)

- **PATRÓN** `drift_60min` |x|≤ `0.1755` → IC=+0.293 (n=370)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1755 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.278 (n=508)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.269)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.279 (n=558)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.4058` → IC=+0.304 (n=488)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4058 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.482` → IC=+0.283 (n=570)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.482 (IC base=+0.269)

- **PATRÓN** `volumen_pendiente_norm` > `0.1771` → IC=+0.310 (n=135)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1771 (IC base=+0.269)

- **PATRÓN** `volumen_spike_ratio` > `1.5185` → IC=+0.288 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5185 (IC base=+0.269)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.275 (n=548)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.269)

- **PATRÓN** `libro_liquidez` > `1454.9848` → IC=+0.279 (n=496)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1454.9848 (IC base=+0.269)
...
- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.160 (n=251)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0069 (IC base=+0.160)

- **PATRÓN** `drift_60min` |x|≤ `0.0968` → IC=+0.168 (n=251)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.0968 (IC base=+0.160)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.184 (n=672)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.92€ cuando `hora_utc` > 8.0 (IC base=+0.160)

- **PATRÓN** `ibs_20min` > `0.3271` → IC=+0.205 (n=751)
...
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.243 (n=220)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.01 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.241 (n=311)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.204)

- **PATRÓN** `ibs_20min` > `0.6815` → IC=+0.253 (n=588)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6815 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.62` → IC=+0.337 (n=157)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.62 (IC base=+0.204)
...
- **PATRÓN** `volumen_spike_ratio` < `3.9401` → IC=+0.200 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.9401 (IC base=+0.204)

- **PATRÓN** `volumen_spike_ratio` > `2.4715` → IC=+0.204 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4715 (IC base=+0.204)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.234 (n=666)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `1451.2984` → IC=+0.209 (n=658)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1451.2984 (IC base=+0.204)

- **PATRÓN** `ballena_activa_n` < `63.0` → IC=+0.263 (n=370)
...
- **PATRÓN** `sigma_h` > `0.0089` → IC=+0.249 (n=301)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0089 (IC base=+0.243)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.269 (n=305)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.243)

- **PATRÓN** `ibs_20min` < `0.4031` → IC=+0.296 (n=585)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4031 (IC base=+0.243)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.441` → IC=+0.294 (n=207)
...
- **PATRÓN** `volumen_spike_ratio` < `3.0458` → IC=+0.249 (n=476)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 3.0458 (IC base=+0.243)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.221 (n=407)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.243)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0071` → IC=+0.159 (n=666)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0071 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.1439` → IC=+0.145 (n=333)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.1439 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.160 (n=686)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 8.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.74` → IC=+0.240 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.74 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` > `0.3783` → IC=+0.191 (n=309)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.3783 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.369` → IC=+0.172 (n=346)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 4.369 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.9021` → IC=+0.173 (n=505)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1486` → IC=+0.201 (n=326)
...
- **PATRÓN** `libro_liquidez` > `9488.8794` → IC=+0.243 (n=344)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9488.8794 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.159 (n=534)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0072 (IC base=+0.134)

- **PATRÓN** `drift_60min` |x|≤ `0.4487` → IC=+0.157 (n=604)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.4487 (IC base=+0.134)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.141 (n=232)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 17.0 (IC base=+0.134)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.179 (n=266)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` < 7.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.6727` → IC=+0.180 (n=604)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6727 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` < `0.4068` → IC=+0.139 (n=602)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.4068 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.341` → IC=+0.226 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.341 (IC base=+0.134)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.296` → IC=+0.137 (n=571)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 4.296 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` < `0.8251` → IC=+0.137 (n=403)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_regimen` < 0.8251 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `1.1408` → IC=+0.167 (n=202)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` > 1.1408 (IC base=+0.134)

- **PATRÓN** `volumen_pendiente_norm` > `0.2783` → IC=+0.266 (n=62)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2783 (IC base=+0.134)

- **PATRÓN** `volumen_spike_ratio` > `1.4591` → IC=+0.150 (n=544)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4591 (IC base=+0.134)

- **PATRÓN** `libro_liquidez` > `11624.4939` → IC=+0.206 (n=202)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11624.4939 (IC base=+0.134)

- **PATRÓN** `ballena_activa_n` < `192.0` → IC=+0.154 (n=463)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 192.0 (IC base=+0.134)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.148 (n=529)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0085 (IC base=+0.095)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.136 (n=539)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 12.0 (IC base=+0.095)

- **PATRÓN** `ibs_20min` > `0.4805` → IC=+0.181 (n=792)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4805 (IC base=+0.095)

- **PATRÓN** `dist_vwap_pct` > `1.1427` → IC=+0.197 (n=153)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.1427 (IC base=+0.095)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=550)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `2942.126` → IC=+0.271 (n=264)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2942.126 (IC base=+0.095)

- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.143 (n=500)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 54.0 (IC base=+0.095)
...
- **PATRÓN** `drift_60min` |x|≤ `0.132` → IC=+0.174 (n=256)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.87€ cuando `drift_60min` |x|≤ 0.132 (IC base=+0.116)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.143 (n=376)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 15.0 (IC base=+0.116)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.138 (n=288)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 6.0 (IC base=+0.116)

- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.200 (n=770)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6 (IC base=+0.116)

- **PATRÓN** `dist_vwap_pct` < `0.5192` → IC=+0.135 (n=733)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.5192 (IC base=+0.116)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.187` → IC=+0.136 (n=757)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 3.187 (IC base=+0.116)

- **PATRÓN** `volumen_regimen` < `0.8798` → IC=+0.136 (n=511)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.8798 (IC base=+0.116)

- **PATRÓN** `volumen_pendiente_norm` > `0.0725` → IC=+0.160 (n=254)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0725 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` < `1.4553` → IC=+0.139 (n=206)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.4553 (IC base=+0.116)

- **PATRÓN** `volumen_spike_ratio` > `2.1867` → IC=+0.144 (n=279)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 2.1867 (IC base=+0.116)

- **PATRÓN** `libro_liquidez` > `2648.8968` → IC=+0.168 (n=347)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2648.8968 (IC base=+0.116)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.028` → IC=+0.259 (n=292)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.167` → IC=+0.251 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.167 (IC base=+0.199)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.141` → IC=+0.244 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.141 (IC base=+0.199)

- **PATRÓN** `volumen_regimen` > `1.2346` → IC=+0.228 (n=292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2346 (IC base=+0.199)

- **PATRÓN** `volumen_pendiente_norm` > `0.1011` → IC=+0.234 (n=299)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1011 (IC base=+0.199)

- **PATRÓN** `volumen_spike_ratio` > `1.4407` → IC=+0.202 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4407 (IC base=+0.199)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.207 (n=1003)
...
- **PATRÓN** `sigma_h` > `0.0254` → IC=+0.224 (n=320)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0254 (IC base=+0.213)

- **PATRÓN** `drift_60min` |x|≤ `0.5323` → IC=+0.218 (n=845)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.219 (n=1008)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.213)

- **PATRÓN** `ibs_20min` < `0.4984` → IC=+0.266 (n=960)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4984 (IC base=+0.213)

- **PATRÓN** `dist_vwap_pct` < `0.2682` → IC=+0.223 (n=867)
...
- **PATRÓN** `volumen_regimen` > `0.7057` → IC=+0.224 (n=857)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=1724)

- **PATRÓN** `sigma_h` < `0.01` → IC=+0.133 (n=1317)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.01 (IC base=+0.119)

- **PATRÓN** `drift_60min` |x|≤ `0.5508` → IC=+0.130 (n=1496)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.5508 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.168 (n=507)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 18.0 (IC base=+0.119)

- **PATRÓN** `ibs_20min` > `0.921` → IC=+0.191 (n=499)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` > 0.921 (IC base=+0.119)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.96` → IC=+0.121 (n=1520)

  - _Acción_: Kelly boost +0.60€ cuando `sigma_ewma_delta_pct` < 5.96 (IC base=+0.119)

- **PATRÓN** `volumen_pendiente_norm` > `0.1747` → IC=+0.149 (n=406)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.1747 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` < `1.4626` → IC=+0.147 (n=494)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4626 (IC base=+0.119)

- **PATRÓN** `volumen_spike_ratio` > `1.8986` → IC=+0.139 (n=987)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.8986 (IC base=+0.119)

- **PATRÓN** `libro_liquidez` > `8997.6558` → IC=+0.134 (n=678)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8997.6558 (IC base=+0.119)

- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.173 (n=435)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0039 (IC base=+0.126)

- **PATRÓN** `drift_60min` |x|≤ `0.3998` → IC=+0.152 (n=1148)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.3998 (IC base=+0.126)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.151 (n=491)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 17.0 (IC base=+0.126)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.144 (n=504)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.72€ cuando `hora_utc` < 5.0 (IC base=+0.126)

- **PATRÓN** `ibs_20min` < `0.1994` → IC=+0.151 (n=574)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.1994 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `0.4806` → IC=+0.130 (n=360)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` > 0.4806 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.347` → IC=+0.137 (n=1304)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` < 6.347 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `1.232` → IC=+0.135 (n=1273)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` < 1.232 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.0691` → IC=+0.145 (n=621)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.0691 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `2.4757` → IC=+0.134 (n=1291)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.4757 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.7939` → IC=+0.130 (n=861)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.7939 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=1724)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `8431.5409` → IC=+0.134 (n=1166)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 8431.5409 (IC base=+0.126)
...
- **PATRÓN** `ibs_20min` < `0.1703` → IC=+0.162 (n=273)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` < 0.1703 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.363` → IC=+0.140 (n=617)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 6.363 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.8701` → IC=+0.148 (n=413)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.8701 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.0635` → IC=+0.150 (n=292)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` > 0.0635 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.3995` → IC=+0.144 (n=206)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` < 1.3995 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `11116.1452` → IC=+0.125 (n=619)
...
- **PATRÓN** `sigma_h` < `0.009` → IC=+0.149 (n=551)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.009 (IC base=+0.133)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.135 (n=551)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` > 0.0046 (IC base=+0.133)

- **PATRÓN** `drift_60min` |x|≤ `0.4809` → IC=+0.146 (n=551)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.4809 (IC base=+0.133)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.194 (n=194)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.97€ cuando `hora_utc` > 18.0 (IC base=+0.133)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.137 (n=246)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` < 6.0 (IC base=+0.133)

- **PATRÓN** `ibs_20min` > `0.186` → IC=+0.146 (n=552)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.186 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` > `1.0768` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 1.0768 (IC base=+0.133)

- **PATRÓN** `dist_vwap_pct` < `0.4417` → IC=+0.142 (n=521)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4417 (IC base=+0.133)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.914` → IC=+0.147 (n=553)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 6.914 (IC base=+0.133)

- **PATRÓN** `volumen_regimen` < `1.2728` → IC=+0.144 (n=551)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2728 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` < `0.1175` → IC=+0.135 (n=508)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_pendiente_norm` < 0.1175 (IC base=+0.133)

- **PATRÓN** `volumen_pendiente_norm` > `0.1782` → IC=+0.157 (n=164)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1782 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` < `1.4475` → IC=+0.169 (n=182)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4475 (IC base=+0.133)

- **PATRÓN** `volumen_spike_ratio` > `1.825` → IC=+0.139 (n=361)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` > 1.825 (IC base=+0.133)

- **PATRÓN** `libro_liquidez` > `8958.19` → IC=+0.144 (n=492)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 8958.19 (IC base=+0.133)

- **PATRÓN** `sigma_h` < `0.0078` → IC=+0.171 (n=363)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0078 (IC base=+0.145)

- **PATRÓN** `drift_60min` |x|≤ `0.4118` → IC=+0.206 (n=362)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4118 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.148 (n=211)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 15.0 (IC base=+0.145)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.155 (n=276)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 10.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.1096` → IC=+0.161 (n=411)

  - _Acción_: Kelly boost +0.81€ cuando `ibs_20min` > 0.1096 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.42` → IC=+0.155 (n=418)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.42 (IC base=+0.145)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.927` → IC=+0.186 (n=68)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 10.927 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `1.2231` → IC=+0.167 (n=412)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.2231 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `0.7334` → IC=+0.146 (n=368)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 0.7334 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` < `0.1489` → IC=+0.151 (n=419)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.1489 (IC base=+0.145)

- **PATRÓN** `volumen_pendiente_norm` > `0.0723` → IC=+0.161 (n=181)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_pendiente_norm` > 0.0723 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` < `2.1791` → IC=+0.170 (n=355)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` < 2.1791 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.4499` → IC=+0.164 (n=403)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4499 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `8201.961` → IC=+0.163 (n=411)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 8201.961 (IC base=+0.145)

### GBM_LATE_5M#SOL#5min
- **FILTRO** `ibs_20min` < `0.4222` → IC=-0.269 (n=24)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4222
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.206 (n=226)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` > `0.6789` → IC=+0.250 (n=246)
...
- **PATRÓN** `dist_vwap_pct` < `0.2167` → IC=+0.161 (n=187)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2167 (IC base=+0.111)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.919` → IC=+0.288 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.919 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` < `0.6313` → IC=+0.185 (n=109)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6313 (IC base=+0.111)

- **PATRÓN** `volumen_regimen` > `1.0983` → IC=+0.191 (n=82)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_regimen` > 1.0983 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` < `0.1482` → IC=+0.219 (n=144)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1482 (IC base=+0.111)

- **PATRÓN** `volumen_pendiente_norm` > `0.2807` → IC=+0.367 (n=28)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2807 (IC base=+0.111)

- **PATRÓN** `volumen_spike_ratio` > `1.7679` → IC=+0.240 (n=98)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7679 (IC base=+0.111)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.194 (n=207)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.02 (IC base=+0.111)

- **PATRÓN** `libro_liquidez` > `1318.075` → IC=+0.187 (n=199)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 1318.075 (IC base=+0.111)
...
- **PATRÓN** `hora_utc` < `10.0` → IC=+0.143 (n=54)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 10.0 (IC base=+0.123)

- **PATRÓN** `ibs_20min` > `0.7937` → IC=+0.233 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7937 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` > `0.325` → IC=+0.242 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.325 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `17.206` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 17.206 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.6265` → IC=+0.218 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6265 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` < `0.0635` → IC=+0.263 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0635 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.4853` → IC=+0.283 (n=21)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4853 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` > `1.6708` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.6708 (IC base=+0.123)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.217 (n=90)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0051 (IC base=+0.144)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.161 (n=125)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 7.0 (IC base=+0.144)

- **PATRÓN** `ibs_20min` > `0.5632` → IC=+0.290 (n=103)
...
- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.211 (n=88)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.144)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.341` → IC=+0.333 (n=70)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.341 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` < `0.789` → IC=+0.218 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.789 (IC base=+0.144)

- **PATRÓN** `volumen_regimen` > `1.0173` → IC=+0.203 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0173 (IC base=+0.144)

- **PATRÓN** `volumen_pendiente_norm` < `0.158` → IC=+0.282 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.158 (IC base=+0.144)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.210 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.144)

- **PATRÓN** `libro_liquidez` > `2227.7698` → IC=+0.245 (n=45)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2227.7698 (IC base=+0.144)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.188 (n=46)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 18.0 (IC base=+0.041)

- **PATRÓN** `ibs_20min` > `0.6842` → IC=+0.177 (n=60)

  - _Acción_: Kelly boost +0.89€ cuando `ibs_20min` > 0.6842 (IC base=+0.041)

- **PATRÓN** `dist_vwap_pct` > `0.9778` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9778 (IC base=+0.041)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.36` → IC=+0.250 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.36 (IC base=+0.041)

- **PATRÓN** `volumen_regimen` > `1.0843` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.0843 (IC base=+0.041)

- **PATRÓN** `volumen_pendiente_norm` > `0.0896` → IC=+0.184 (n=17)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.0896 (IC base=+0.041)

- **PATRÓN** `volumen_spike_ratio` < `1.3627` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.3627 (IC base=+0.041)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.041)
...
- **FILTRO** `volumen_regimen` < `1.2094` → IC=-0.362 (n=78)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.154 (n=79)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` > 15.0 (IC base=+0.058)

- **PATRÓN** `ibs_20min` < `0.4` → IC=+0.128 (n=162)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4 (IC base=+0.058)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.866` → IC=+0.125 (n=70)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 5.866 (IC base=+0.058)

- **PATRÓN** `volumen_pendiente_norm` > `0.0687` → IC=+0.143 (n=40)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` > 0.0687 (IC base=+0.058)

- **PATRÓN** `libro_liquidez` > `3965.7979` → IC=+0.158 (n=74)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 3965.7979 (IC base=+0.058)
...
- **PATRÓN** `sigma_h` < `0.0024` → IC=+0.300 (n=28)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0024 (IC base=+0.071)

- **PATRÓN** `drift_60min` |x|≤ `0.2013` → IC=+0.132 (n=36)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.2013 (IC base=+0.071)

- **PATRÓN** `ibs_20min` > `0.7289` → IC=+0.192 (n=37)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.7289 (IC base=+0.071)

- **PATRÓN** `dist_vwap_pct` < `0.0986` → IC=+0.150 (n=38)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.0986 (IC base=+0.071)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.514` → IC=+0.141 (n=37)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 7.514 (IC base=+0.071)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.194 (n=34)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.01 (IC base=+0.071)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.12` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.12 (IC base=+0.061)
...
- **PATRÓN** `libro_liquidez` > `2814.271` → IC=+0.186 (n=84)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 2814.271 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2270.1402` → IC=+0.135 (n=228)

  - _Acción_: Kelly boost +0.67€ cuando `libro_liquidez` > 2270.1402 (IC base=+0.105)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.178 (n=1447)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=4355)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.183 (n=1482)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=4565)
...
- **FILTRO** `py_entrada` > `0.67` → IC=-0.164 (n=251)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=805)
...
- **FILTRO** `ballena_activa_n` > `37.0` → IC=-0.138 (n=318)
...
- **FILTRO** `py_entrada` < `0.45` → IC=-0.204 (n=305)

  - _Acción_: SKIP cuando `py_entrada` < 0.45
  - _Potencial_: sin este filtro IC_bueno=+0.043 (n=641)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.218 (n=239)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=782)

- **FILTRO** `ibs_20min` > `0.7156` → IC=-0.193 (n=255)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7156
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=766)

### MOMENTUM_IBS_15M_BALLENA#ETH#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.160 (n=236)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=752)

- **FILTRO** `py_entrada` > `0.56` → IC=-0.168 (n=233)

  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=744)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.172 (n=239)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.145 (n=263)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=713)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.160 (n=251)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=762)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.201 (n=252)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=765)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=471)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=3031)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=11157)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=3490)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=10698)

- **FILTRO** `ibs_7min` < `0.7115` → IC=-0.246 (n=3546)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7115
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=10642)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.171 (n=4743)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=9445)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.220 (n=4395)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=13489)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.172 (n=4449)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=13435)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.153 (n=609)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.31` → IC=-0.316 (n=510)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=1557)

- **FILTRO** `ibs_7min` < `0.3` → IC=-0.258 (n=681)

  - _Acción_: SKIP cuando `ibs_7min` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1386)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.226 (n=513)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=1554)

- **FILTRO** `py_entrada` > `0.52` → IC=-0.140 (n=2072)

  - _Acción_: SKIP cuando `py_entrada` > 0.52
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1038)

- **FILTRO** `drift_7min_pct` |x|> `0.1142` → IC=-0.127 (n=1057)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1142
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2053)

- **FILTRO** `ibs_7min` > `0.8349` → IC=-0.189 (n=777)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8349
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2333)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.137 (n=579)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=2070)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.260 (n=643)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2006)

- **FILTRO** `ibs_7min` < `0.7711` → IC=-0.194 (n=662)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7711
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=1987)

- **FILTRO** `ballena_activa_n` > `168.0` → IC=-0.180 (n=657)

  - _Acción_: SKIP cuando `ballena_activa_n` > 168.0
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=1992)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.246 (n=617)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.016 (n=2045)

- **FILTRO** `ballena_activa_n` > `107.0` → IC=-0.174 (n=896)

  - _Acción_: SKIP cuando `ballena_activa_n` > 107.0
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=1766)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.185 (n=664)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.097 (n=1436)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.311 (n=669)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1431)

- **FILTRO** `ibs_7min` < `0.2105` → IC=-0.289 (n=524)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2105
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1576)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.252 (n=493)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=1607)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=744)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=2463)

- **FILTRO** `ibs_7min` > `0.796` → IC=-0.170 (n=801)

  - _Acción_: SKIP cuando `ibs_7min` > 0.796
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2406)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.139 (n=724)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=587)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=1819)

- **FILTRO** `ibs_7min` < `0.7519` → IC=-0.195 (n=601)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7519
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1805)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.239 (n=786)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1632)

- **FILTRO** `ibs_7min` > `0.2748` → IC=-0.178 (n=604)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2748
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=1814)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.182 (n=593)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=1825)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.250 (n=641)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2005)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.213 (n=661)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=1985)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.193 (n=627)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.032 (n=2019)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.178 (n=800)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=2562)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `hora_utc` < `9.0` → IC=-0.126 (n=746)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.069 (n=1574)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.296 (n=567)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=1753)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.248 (n=578)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7333
  - _Potencial_: sin este filtro IC_bueno=-0.034 (n=1742)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.234 (n=561)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=1759)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.252 (n=616)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2509)

- **FILTRO** `ibs_7min` > `0.7752` → IC=-0.162 (n=781)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7752
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=2344)
...
- **PATRÓN** `delta_ratio` |x|> `0.3982` → IC=+0.145 (n=511)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.73€ cuando `delta_ratio` |x|> 0.3982 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.150 (n=304)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 11.0 (IC base=+0.131)

- **PATRÓN** `total_vol_5m` < `451.687` → IC=+0.173 (n=163)

  - _Acción_: Kelly boost +0.86€ cuando `total_vol_5m` < 451.687 (IC base=+0.131)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=230)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.01 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `3282.1951` → IC=+0.157 (n=199)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 3282.1951 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.128 (n=358)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 64.0 (IC base=+0.131)
...
- **PATRÓN** `ballena_activa_n` < `153.0` → IC=+0.131 (n=82)

  - _Acción_: Kelly boost +0.65€ cuando `ballena_activa_n` < 153.0 (IC base=+0.111)

### ORDER_FLOW_5M#SOL#5min
- **PATRÓN** `delta_ratio` |x|> `0.4038` → IC=+0.231 (n=76)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio` |x|> 0.4038 (IC base=+0.199)

- **PATRÓN** `hora_utc` < `12.0` → IC=+0.232 (n=54)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 12.0 (IC base=+0.199)

- **PATRÓN** `total_vol_5m` < `6013.826` → IC=+0.210 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `total_vol_5m` < 6013.826 (IC base=+0.199)

- **PATRÓN** `libro_liquidez` > `3741.2041` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3741.2041 (IC base=+0.199)

- **PATRÓN** `ballena_activa_n` < `70.0` → IC=+0.212 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 70.0 (IC base=+0.199)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1583)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` > `0.0053` → IC=+0.145 (n=350)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0053 (IC base=+0.124)

- **PATRÓN** `drift_60min` |x|≤ `0.168` → IC=+0.126 (n=463)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.63€ cuando `drift_60min` |x|≤ 0.168 (IC base=+0.124)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.128 (n=525)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.64€ cuando `delta_ratio_macro` |x|> 0.0597 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.128 (n=563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 4.0 (IC base=+0.124)

- **PATRÓN** `hora_utc` < `19.0` → IC=+0.137 (n=565)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 19.0 (IC base=+0.124)

- **PATRÓN** `ibs_15` > `0.5788` → IC=+0.213 (n=525)
...
- **PATRÓN** `dist_vwap_pct` > `0.4311` → IC=+0.154 (n=134)
  ...
  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` > 0.4311 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.5508` → IC=+0.121 (n=544)

  - _Acción_: Kelly boost +0.60€ cuando `dist_vwap_pct` < 0.5508 (IC base=+0.124)
...
- **PATRÓN** `libro_liquidez` > `3051.8123` → IC=+0.148 (n=350)

  - _Acción_: Kelly boost +0.74€ cuando `libro_liquidez` > 3051.8123 (IC base=+0.124)

### UPDOWN_GBM#5min
- **FILTRO** `sigma_ewma_delta_pct` > `6.428` → IC=-0.205 (n=59)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 6.428
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=809)
...
- **FILTRO** `ibs_15` > `0.6343` → IC=-0.146 (n=46)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: SKIP cuando `ibs_15` > 0.6343
...
- **PATRÓN** `ibs_15` > `0.9606` → IC=+0.151 (n=41)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.76€ cuando `ibs_15` > 0.9606 (IC base=+0.008)
...
- **FILTRO** `libro_spread` > `0.03` → IC=-0.132 (n=36)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0615` → IC=+0.129 (n=60)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.65€ cuando `delta_ratio_macro` |x|> 0.0615 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.182 (n=20)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` < 5.0 (IC base=+0.105)

- **PATRÓN** `ibs_15` > `0.5385` → IC=+0.264 (n=53)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5385 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.935` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.935 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=54)

  - _Acción_: Kelly boost +0.62€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `3008.8466` → IC=+0.273 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3008.8466 (IC base=+0.105)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0487` → IC=+0.150 (n=138)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.75€ cuando `delta_ratio_macro` |x|> 0.0487 (IC base=+0.105)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.156 (n=62)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` < 6.0 (IC base=+0.105)

- **PATRÓN** `ibs_15` > `0.5556` → IC=+0.198 (n=124)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.99€ cuando `ibs_15` > 0.5556 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.4411` → IC=+0.208 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4411 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.511` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.511 (IC base=+0.105)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.128 (n=119)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.105)

- **PATRÓN** `libro_liquidez` > `2694.5464` → IC=+0.208 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2694.5464 (IC base=+0.105)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.227 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 18.0 (IC base=+0.105)

- **PATRÓN** `ibs_15` < `0.1237` → IC=+0.167 (n=163)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.83€ cuando `ibs_15` < 0.1237 (IC base=+0.033)
...
- **FILTRO** `sigma_h` > `0.0108` → IC=-0.207 (n=336)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=1010)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.142 (n=347)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=999)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.1246` → IC=+0.235 (n=296)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1246 (IC base=-0.064)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1026` → IC=+0.251 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1026 (IC base=-0.064)

- **PATRÓN** `ibs_15` < `0.3696` → IC=+0.268 (n=446)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3696 (IC base=-0.064)

- **PATRÓN** `dist_vwap_pct` < `0.4772` → IC=+0.217 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4772 (IC base=-0.064)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.220 (n=359)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 95.0 (IC base=-0.064)
...
- **FILTRO** `sigma_h` > `0.0074` → IC=-0.236 (n=225)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0074
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=678)
...
- **FILTRO** `sigma_ewma_delta_pct` > `19.521` → IC=-0.248 (n=165)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.521
  - _Potencial_: sin este filtro IC_bueno=-0.191 (n=738)
...
- **PATRÓN** `sigma_h` < `0.008` → IC=+0.249 (n=225)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.008 (IC base=+0.208)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.209 (n=225)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0046 (IC base=+0.208)

- **PATRÓN** `drift_60min` |x|≤ `0.4455` → IC=+0.218 (n=225)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4455 (IC base=+0.208)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0914` → IC=+0.214 (n=201)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **PATRÓN** `hora_utc` < `5.0` → IC=+0.279 (n=75)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 5.0 (IC base=+0.208)

- **PATRÓN** `ibs_15` < `0.2941` → IC=+0.290 (n=198)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.2941 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.1907` → IC=+0.223 (n=81)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1907 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` < `0.4127` → IC=+0.207 (n=244)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4127 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.337` → IC=+0.226 (n=239)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.337 (IC base=+0.208)

- **PATRÓN** `ballena_activa_n` < `184.0` → IC=+0.207 (n=196)
...
- **PATRÓN** `ibs_15` > `0.8182` → IC=+0.237 (n=17)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8182 (IC base=-0.126)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1232` → IC=+0.167 (n=64)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.83€ cuando `delta_ratio_macro` |x|> 0.1232 (IC base=-0.047)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.182` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.182 (IC base=-0.047)

- **PATRÓN** `ibs_15` < `0.3814` → IC=+0.217 (n=97)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3814 (IC base=-0.047)

- **PATRÓN** `ibs_15` > `0.0714` → IC=+0.140 (n=87)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.70€ cuando `ibs_15` > 0.0714 (IC base=-0.047)

- **PATRÓN** `dist_vwap_pct` < `0.6071` → IC=+0.180 (n=101)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` < 0.6071 (IC base=-0.047)

- **PATRÓN** `ballena_activa_n` < `42.0` → IC=+0.159 (n=86)
...
- **FILTRO** `sigma_ewma_delta_pct` > `3.98` → IC=-0.177 (n=131)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.175 (n=235)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.273 (n=42)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.163 (n=324)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1534` → IC=+0.343 (n=68)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1534 (IC base=-0.059)

- **PATRÓN** `ibs_15` < `0.0495` → IC=+0.316 (n=36)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0495 (IC base=-0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5629` → IC=+0.346 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5629 (IC base=-0.059)

- **PATRÓN** `ballena_activa_n` < `20.0` → IC=+0.292 (n=75)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.2855` → IC=+0.308 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.2855 (IC base=+0.282)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5788 sube el IC de +0.124 a +0.213 en UPDOWN_GBM#15min (n=525). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#SOL#15min**: dentro de BUY_YES, IBS > 0.5385 sube el IC de +0.105 a +0.264 en UPDOWN_GBM#SOL#15min (n=53). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5556 sube el IC de +0.105 a +0.198 en UPDOWN_GBM#XRP#15min (n=124). Ya aplicado como kelly_boost=+0.99€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1237 sube el IC de +0.033 a +0.167 en UPDOWN_GBM#XRP#15min (n=163). Ya aplicado como kelly_boost=+0.83€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#60min**: dentro de BUY_YES, IBS > 0.9606 sube el IC de +0.008 a +0.151 en UPDOWN_GBM#BTC#60min (n=41). Ya aplicado como kelly_boost=+0.76€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.064 a +0.268 en UPDOWN_GBM_15M_TARDIO (n=446). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.2941 sube el IC de +0.208 a +0.290 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=198). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_YES, IBS > 0.8182 sube el IC de -0.126 a +0.237 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=17). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3814 sube el IC de -0.047 a +0.217 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=97). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.0495 sube el IC de -0.059 a +0.316 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=36). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 807 | +0.087 | +45.94€ | 2 | 10 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 807 | +0.087 | +45.94€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 23 | +0.060 | +0.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 23 | +0.060 | +0.96€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 529 | +0.106 | +38.40€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 529 | +0.106 | +38.40€ | 2 | 11 |
...
| ✅ BALLENAS_TARDIAS | 14783 | -0.112 | -2515.68€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 956 | -0.010 | -142.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 13827 | -0.119 | -2373.06€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1919 | -0.091 | -423.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1919 | -0.091 | -423.97€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 956 | -0.010 | -142.62€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 956 | -0.010 | -142.62€ | 2 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1970 | -0.169 | -540.45€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1970 | -0.169 | -540.45€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3951 | -0.049 | -366.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3951 | -0.049 | -366.83€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3283 | -0.128 | -290.23€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3283 | -0.128 | -290.23€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2704 | -0.194 | -751.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2704 | -0.194 | -751.59€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 