# Hipótesis automáticas — 2026-07-02 07:49 UTC
_Generado por shadow_postmortem.py sobre 2573 resoluciones (PNL=-78.68€)_
...
- **PATRÓN** `sigma_h` < `0.0098` → IC=+0.218 (n=69)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0098 (IC base=+0.054)

- **PATRÓN** `hora_utc` > `14.0` → IC=+0.150 (n=38)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 14.0 (IC base=+0.054)

- **PATRÓN** `ibs_15` < `0.0669` → IC=+0.214 (n=47)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.0669 (IC base=+0.054)
...
- **FILTRO** `pct_spot_vs_ref` |x|> `0.0016` → IC=-0.152 (n=21)
  - _Por qué funciona_: precio spot lejos de la referencia → señal GBM sobreextiende; riesgo de reversión
  - _Acción_: SKIP cuando `pct_spot_vs_ref` |x|> 0.0016
  - _Potencial_: sin este filtro IC_bueno=+0.192 (n=11)

- **PATRÓN** `pct_spot_vs_ref` |x|≤ `0.0853` → IC=+0.132 (n=17)
  - _Por qué funciona_: precio spot cerca de la referencia → señal GBM más calibrada
  - _Acción_: Kelly boost +0.66€ cuando `pct_spot_vs_ref` |x|≤ 0.0853 (IC base=-0.029)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0669 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.214 n=47). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 17 | +0.246 | +5.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 17 | +0.246 | +5.71€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 5 | +0.089 | +2.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 5 | +0.089 | +2.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 5 | +0.054 | +1.58€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 5 | +0.054 | +1.58€ | 0 | 0 |
| ✅ ORDER_FLOW_5M | 1508 | +0.014 | +13.03€ | 0 | 0 |
| ✅ ORDER_FLOW_5M#5min | 1372 | +0.009 | +0.43€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 798 | -0.035 | -35.51€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 574 | -0.012 | -9.68€ | 2 | 3 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 121 | -0.053 | -9.81€ | 5 | 1 |
| ✅ UPDOWN_GBM#BNB | 22 | -0.125 | -5.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 22 | -0.125 | -5.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC | 230 | -0.043 | -30.20€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 160 | -0.018 | -20.00€ | 2 | 1 |
| 🚫 UPDOWN_GBM#BTC#5min | 19 | -0.158 | -7.19€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#60min | 42 | -0.068 | -6.16€ | 2 | 0 |
| ✅ UPDOWN_GBM#BTC#daily | 5 | +0.054 | +5.61€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 25 | -0.093 | -4.69€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 22 | -0.083 | -3.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 309 | -0.005 | +10.13€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 226 | +0.013 | +16.09€ | 4 | 7 |
...
| ✅ UPDOWN_GBM#SOL | 139 | -0.074 | -8.87€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 84 | -0.058 | -5.22€ | 5 | 0 |
| 🚫 UPDOWN_GBM#SOL#5min | 23 | -0.060 | -3.42€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 26 | -0.107 | -1.60€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.091) — sin ventaja clara. oversold(IBS<0.3): IC=+0.022 n=136 | neutral: IC=-0.069 n=121 | overbought(IBS>0.7): IC=-0.047 n=137
  - _Datos_: n=408 IC=-0.029 PNL=-10.28€
...
**🟡 H-OF-PAR** — ORDER_FLOW per-pair delta_ratio ranges
  ...
  - _Estado_: BTC: 150 ops con delta_ratio | SOL: 188 ops con delta_ratio

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=-0.058 < 0.08 — monitorear
  - _Datos_: n=84 IC=-0.058 PNL=-5.22€

**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.002 n=1207 | tras_1loss IC=-0.036 n=1267 | tras_2loss IC=-0.051 n=661/40 | gap=+0.053 (umbral 0.05)
...
**⏳ H-CROSS-ASSET** — Cross-asset confirmation GBM+OF BUY_NO
  ...
  - _Estado_: n_overlaps=23, boost estimado=+0.003. Necesita 0 más y boost>0.05
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=53/40 IC=-0.009 PNL=-2.05€ | BTC#60min: n=42/40 IC=-0.068 PNL=-6.16€ | SOL#60min: n=26/40 IC=-0.107 PNL=-1.60€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=675 IC=-0.029 PNL=-21.96€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=675 IC=-0.029 PNL=-21.96€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYNO** — GBM 60min BUY_NO — tracking por separado
  ...
  - _Estado_: n=32 IC=-0.029 PNL=-2.21€ — sin señal clara aún (umbral IC: min=0.05 max=None)
  - _Datos_: n=32 IC=-0.029 PNL=-2.21€
...
**🔴 H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.018 < 0.02 con n=160 PNL=-20.00€
  - _Datos_: n=160 IC=-0.018 PNL=-20.00€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=238 IC=-0.004 PNL=-22.99€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=238 IC=-0.004 PNL=-22.99€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=191 IC=+0.029 PNL=+18.18€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=191 IC=+0.029 PNL=+18.18€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 156/200 ops en el filtro definido (IC actual=+0.063 PNL=+14.24€)
  - _Datos_: n=156 IC=+0.063 PNL=+14.24€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=156 IC=+0.063 PNL=+14.24€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=156 IC=+0.063 PNL=+14.24€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 24/40 ops en el filtro definido (IC actual=+0.000 PNL=-3.88€)
  - _Datos_: n=24 IC=+0.000 PNL=-3.88€
