# Hipótesis automáticas — 2026-08-24 06:59 UTC
_Generado por shadow_postmortem.py sobre 135300 resoluciones (PNL=+9385.09€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `157.75` → IC=-0.254 (n=1888)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 157.75
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=5664)
...
- **FILTRO** `restante_s_al_confirmar` < `109.55` → IC=-0.384 (n=214)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 109.55
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=645)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `169.49` → IC=-0.146 (n=498)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 169.49
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1497)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `148.13` → IC=-0.272 (n=467)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 148.13
  - _Potencial_: sin este filtro IC_bueno=+0.007 (n=1407)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `172.34` → IC=-0.298 (n=449)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 172.34
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=914)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.185 (n=4527)
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.150 (n=3533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` < 7.0 (IC base=+0.135)

- **PATRÓN** `py_entrada` < `0.335` → IC=+0.262 (n=2554)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.335 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.184 (n=2641)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `1773.8252` → IC=+0.173 (n=2180)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1773.8252 (IC base=+0.135)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.288 (n=399)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.284)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.292 (n=397)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.284)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.324 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.284)

- **PATRÓN** `libro_liquidez` > `2723.905` → IC=+0.301 (n=254)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2723.905 (IC base=+0.284)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.198 (n=822)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.160 (n=1105)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` < 11.0 (IC base=+0.159)

- **PATRÓN** `py_entrada` > `0.71` → IC=+0.188 (n=1302)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.195 (n=1075)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `restante_min` < `3.87` → IC=+0.157 (n=570)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` < 3.87 (IC base=+0.140)

- **PATRÓN** `restante_min` > `4.86` → IC=+0.159 (n=775)

  - _Acción_: Kelly boost +0.79€ cuando `restante_min` > 4.86 (IC base=+0.140)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.154 (n=1499)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.77€ cuando `hora_utc` < 15.0 (IC base=+0.140)

- **PATRÓN** `lag_apertura_s` < `6.36` → IC=+0.164 (n=566)

  - _Acción_: Kelly boost +0.82€ cuando `lag_apertura_s` < 6.36 (IC base=+0.140)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.37` → IC=+0.186 (n=604)

  - _Acción_: Kelly boost +0.93€ cuando `py_entrada` < 0.37 (IC base=+0.120)

- **PATRÓN** `restante_min` < `3.98` → IC=+0.140 (n=579)

  - _Acción_: Kelly boost +0.70€ cuando `restante_min` < 3.98 (IC base=+0.120)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.152 (n=630)

  - _Acción_: Kelly boost +0.76€ cuando `restante_min` > 4.94 (IC base=+0.120)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.136 (n=798)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` < 7.0 (IC base=+0.120)

- **PATRÓN** `lag_apertura_s` < `3.42` → IC=+0.159 (n=576)
...
- **PATRÓN** `dist_vwap_pct` > `0.2566` → IC=+0.229 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2566 (IC base=+0.070)

- **PATRÓN** `dist_vwap_pct` < `0.7061` → IC=+0.223 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7061 (IC base=+0.070)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.015` → IC=+0.193 (n=772)

  - _Acción_: Kelly boost +0.96€ cuando `sigma_ewma_delta_pct` > 5.015 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` < `1.2653` → IC=+0.221 (n=357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2653 (IC base=+0.070)

- **PATRÓN** `volumen_regimen` > `1.0858` → IC=+0.244 (n=162)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.3107` → IC=+0.152 (n=133)
  ...
  - _Acción_: Kelly boost +0.76€ cuando `volumen_pendiente_norm` > 0.3107 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` < `2.554` → IC=+0.132 (n=842)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 2.554 (IC base=+0.070)

- **PATRÓN** `volumen_spike_ratio` > `1.4734` → IC=+0.130 (n=957)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 1.4734 (IC base=+0.070)

- **PATRÓN** `ibs_20min` < `0.2105` → IC=+0.127 (n=1299)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.2105 (IC base=+0.032)

- **PATRÓN** `dist_vwap_pct` < `0.1309` → IC=+0.148 (n=628)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.1309 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` < `0.6271` → IC=+0.158 (n=217)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.6271 (IC base=+0.032)

- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.136 (n=295)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` > 1.0471 (IC base=+0.032)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4155` → IC=+0.215 (n=272)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4155 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.240 (n=279)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.211)

- **PATRÓN** `ibs_20min` > `0.6025` → IC=+0.227 (n=243)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6025 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` > `0.1985` → IC=+0.230 (n=187)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1985 (IC base=+0.211)

- **PATRÓN** `dist_vwap_pct` < `0.7179` → IC=+0.222 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.7179 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.549` → IC=+0.267 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.549 (IC base=+0.211)

- **PATRÓN** `volumen_regimen` < `1.3035` → IC=+0.215 (n=272)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2704` → IC=+0.281 (n=39)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2704 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` < `1.3544` → IC=+0.253 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3544 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `11900.8434` → IC=+0.227 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11900.8434 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0021` → IC=+0.185 (n=125)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` < 0.0021 (IC base=+0.132)

- **PATRÓN** `drift_60min` |x|≤ `0.3117` → IC=+0.141 (n=374)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.3117 (IC base=+0.132)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.140 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.70€ cuando `hora_utc` > 8.0 (IC base=+0.132)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.142 (n=389)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 18.0 (IC base=+0.132)

- **PATRÓN** `ibs_20min` < `0.5667` → IC=+0.152 (n=374)

  - _Acción_: Kelly boost +0.76€ cuando `ibs_20min` < 0.5667 (IC base=+0.132)

- **PATRÓN** `dist_vwap_pct` < `0.1827` → IC=+0.168 (n=332)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1827 (IC base=+0.132)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.993` → IC=+0.227 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.993 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` < `0.6279` → IC=+0.177 (n=125)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` < 0.6279 (IC base=+0.132)

- **PATRÓN** `volumen_regimen` > `1.0176` → IC=+0.134 (n=170)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 1.0176 (IC base=+0.132)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5491` → IC=+0.156 (n=271)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.5491 (IC base=+0.132)

- **PATRÓN** `volumen_spike_ratio` > `1.4221` → IC=+0.151 (n=270)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4221 (IC base=+0.132)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=483)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.132)

- **PATRÓN** `libro_liquidez` > `12461.8732` → IC=+0.145 (n=170)

  - _Acción_: Kelly boost +0.73€ cuando `libro_liquidez` > 12461.8732 (IC base=+0.132)

- **PATRÓN** `ballena_activa_n` < `254.0` → IC=+0.171 (n=80)

  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 254.0 (IC base=+0.132)
...
- **FILTRO** `sigma_h` > `0.0061` → IC=-0.137 (n=166)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **FILTRO** `sigma_ewma_delta_pct` > `4.792` → IC=-0.149 (n=246)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.792
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=895)
...
- **FILTRO** `ibs_20min` < `0.4414` → IC=-0.139 (n=275)

  - _Acción_: SKIP cuando `ibs_20min` < 0.4414
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=275)

- **FILTRO** `sigma_h` > `0.0121` → IC=-0.150 (n=255)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0121
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=768)
...
- **PATRÓN** `volumen_regimen` > `0.7077` → IC=+0.175 (n=38)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.7077 (IC base=-0.065)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.146 (n=775)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.008 (IC base=+0.052)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.248 (n=775)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.052)

- **PATRÓN** `dist_vwap_pct` > `0.4287` → IC=+0.258 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4287 (IC base=+0.052)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.333` → IC=+0.124 (n=1329)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` > 2.333 (IC base=+0.052)

- **PATRÓN** `volumen_regimen` > `1.1718` → IC=+0.192 (n=261)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.1718 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` < `0.1155` → IC=+0.158 (n=994)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_pendiente_norm` < 0.1155 (IC base=+0.052)

- **PATRÓN** `volumen_pendiente_norm` > `0.2486` → IC=+0.211 (n=195)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2486 (IC base=+0.052)

- **PATRÓN** `volumen_spike_ratio` < `1.5011` → IC=+0.167 (n=343)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 1.5011 (IC base=+0.052)
...
- **PATRÓN** `ballena_activa_n` < `99.0` → IC=+0.273 (n=473)
...
- **PATRÓN** `dist_vwap_pct` < `0.1319` → IC=+0.192 (n=601)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.1319 (IC base=+0.034)

- **PATRÓN** `volumen_regimen` > `0.63` → IC=+0.200 (n=648)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.247 (n=298)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.161 (n=57)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=840)
...
- **FILTRO** `ibs_20min` < `0.5094` → IC=-0.143 (n=256)
...
- **PATRÓN** `dist_vwap_pct` > `0.2084` → IC=+0.216 (n=86)
...
- **PATRÓN** `ballena_activa_n` < `80.0` → IC=+0.177 (n=94)

  - _Acción_: Kelly boost +0.89€ cuando `ballena_activa_n` < 80.0 (IC base=-0.011)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0107` → IC=+0.324 (n=214)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0107 (IC base=+0.204)
...
- **PATRÓN** `ibs_20min` > `0.9064` → IC=+0.282 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9064 (IC base=+0.204)

- **PATRÓN** `dist_vwap_pct` > `1.2515` → IC=+0.325 (n=124)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2515 (IC base=+0.204)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.097` → IC=+0.269 (n=284)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.097 (IC base=+0.204)

- **PATRÓN** `volumen_regimen` > `1.0201` → IC=+0.245 (n=214)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0201 (IC base=+0.204)
...
- **PATRÓN** `ibs_20min` < `0.2788` → IC=+0.324 (n=419)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2788 (IC base=+0.259)

- **PATRÓN** `dist_vwap_pct` < `0.2288` → IC=+0.271 (n=438)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2288 (IC base=+0.259)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.49` → IC=+0.280 (n=116)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.49 (IC base=+0.259)

- **PATRÓN** `volumen_regimen` > `0.715` → IC=+0.278 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.715 (IC base=+0.259)
...
- **PATRÓN** `ballena_activa_n` < `39.0` → IC=+0.232 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 39.0 (IC base=+0.259)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` > `0.009` → IC=+0.201 (n=666)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.009 (IC base=+0.155)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.161 (n=2076)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.155)

- **PATRÓN** `ibs_20min` > `0.9` → IC=+0.256 (n=1333)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9 (IC base=+0.155)

- **PATRÓN** `dist_vwap_pct` > `0.7427` → IC=+0.240 (n=486)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7427 (IC base=+0.155)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.089` → IC=+0.256 (n=880)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.089 (IC base=+0.155)

- **PATRÓN** `volumen_regimen` > `0.6988` → IC=+0.172 (n=1207)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` > 0.6988 (IC base=+0.155)

- **PATRÓN** `volumen_pendiente_norm` > `0.1042` → IC=+0.179 (n=703)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_pendiente_norm` > 0.1042 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` < `2.3331` → IC=+0.150 (n=1543)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.3331 (IC base=+0.155)

- **PATRÓN** `volumen_spike_ratio` > `1.4526` → IC=+0.143 (n=1752)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4526 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=1587)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `2446.9132` → IC=+0.175 (n=1332)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2446.9132 (IC base=+0.155)

- **PATRÓN** `ballena_activa_n` < `132.0` → IC=+0.187 (n=797)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 132.0 (IC base=+0.155)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.204 (n=1534)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.3449` → IC=+0.195 (n=1742)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.3974` → IC=+0.244 (n=1742)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3974 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.3299` → IC=+0.177 (n=1521)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.472` → IC=+0.185 (n=1762)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` < 5.472 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` < `1.1777` → IC=+0.163 (n=1442)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 1.1777 (IC base=+0.185)

- **PATRÓN** `volumen_regimen` > `0.8556` → IC=+0.178 (n=961)
...
- **PATRÓN** `volumen_spike_ratio` < `1.585` → IC=+0.184 (n=501)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.193 (n=470)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=276)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.175)

- **PATRÓN** `ibs_20min` > `0.6555` → IC=+0.231 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6555 (IC base=+0.175)

- **PATRÓN** `dist_vwap_pct` > `0.2573` → IC=+0.243 (n=185)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2573 (IC base=+0.175)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.061` → IC=+0.285 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.061 (IC base=+0.175)

- **PATRÓN** `volumen_regimen` > `0.8987` → IC=+0.208 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.8987 (IC base=+0.175)

- **PATRÓN** `volumen_pendiente_norm` > `0.2804` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2804 (IC base=+0.175)

- **PATRÓN** `volumen_spike_ratio` < `1.4115` → IC=+0.228 (n=79)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4115 (IC base=+0.175)

- **PATRÓN** `volumen_spike_ratio` > `2.1727` → IC=+0.179 (n=107)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.1727 (IC base=+0.175)

- **PATRÓN** `libro_liquidez` > `11533.5682` → IC=+0.202 (n=176)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 11533.5682 (IC base=+0.175)
...
- **PATRÓN** `sigma_h` < `0.0096` → IC=+0.225 (n=263)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0096 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.133` → IC=+0.203 (n=116)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.133 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.212 (n=265)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `0.435` → IC=+0.255 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.435 (IC base=+0.190)

- **PATRÓN** `dist_vwap_pct` > `0.1644` → IC=+0.222 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1644 (IC base=+0.190)
...
- **PATRÓN** `volumen_regimen` > `0.6382` → IC=+0.217 (n=263)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6382 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.1005` → IC=+0.265 (n=117)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1005 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `1.4657` → IC=+0.213 (n=85)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4657 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.4523` → IC=+0.233 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4523 (IC base=+0.190)

- **PATRÓN** `libro_liquidez` > `9534.4594` → IC=+0.211 (n=119)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9534.4594 (IC base=+0.190)

- **PATRÓN** `ballena_activa_n` < `196.0` → IC=+0.167 (n=175)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 196.0 (IC base=+0.190)
...
- **PATRÓN** `volumen_spike_ratio` < `2.2067` → IC=+0.182 (n=347)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 2.2067 (IC base=+0.167)

- **PATRÓN** `volumen_spike_ratio` > `1.8289` → IC=+0.175 (n=263)
...
- **PATRÓN** `libro_liquidez` > `2512.7673` → IC=+0.169 (n=385)

  - _Acción_: Kelly boost +0.85€ cuando `libro_liquidez` > 2512.7673 (IC base=+0.167)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.270 (n=176)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.226)

- **PATRÓN** `drift_60min` |x|≤ `0.4823` → IC=+0.231 (n=399)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `7.0` → IC=+0.246 (n=195)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.226)

- **PATRÓN** `ibs_20min` < `0.125` → IC=+0.317 (n=266)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.125 (IC base=+0.226)

- **PATRÓN** `dist_vwap_pct` < `0.9579` → IC=+0.236 (n=471)
...
- **PATRÓN** `volumen_regimen` > `0.7022` → IC=+0.254 (n=356)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7022 (IC base=+0.226)

- **PATRÓN** `volumen_pendiente_norm` > `0.2872` → IC=+0.341 (n=42)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2872 (IC base=+0.226)

- **PATRÓN** `volumen_spike_ratio` > `2.7756` → IC=+0.263 (n=91)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7756 (IC base=+0.226)

- **PATRÓN** `ballena_activa_n` < `30.0` → IC=+0.189 (n=181)

  - _Acción_: Kelly boost +0.94€ cuando `ballena_activa_n` < 30.0 (IC base=+0.226)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.160 (n=145)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0059 (IC base=+0.084)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.210 (n=160)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.084)

- **PATRÓN** `ibs_20min` > `0.5074` → IC=+0.140 (n=320)

  - _Acción_: Kelly boost +0.70€ cuando `ibs_20min` > 0.5074 (IC base=+0.084)

- **PATRÓN** `dist_vwap_pct` > `0.5225` → IC=+0.217 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5225 (IC base=+0.084)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.962` → IC=+0.240 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.962 (IC base=+0.084)
...
- **PATRÓN** `ballena_activa_n` < `256.0` → IC=+0.197 (n=97)

  - _Acción_: Kelly boost +0.98€ cuando `ballena_activa_n` < 256.0 (IC base=+0.084)

- **PATRÓN** `sigma_h` < `0.0031` → IC=+0.250 (n=98)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0031 (IC base=+0.046)

- **PATRÓN** `ibs_20min` < `0.2667` → IC=+0.129 (n=195)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.2667 (IC base=+0.046)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.58` → IC=+0.222 (n=52)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.58 (IC base=+0.046)
...
- **PATRÓN** `sigma_h` < `0.0022` → IC=+0.250 (n=34)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0022 (IC base=+0.150)

- **PATRÓN** `drift_60min` |x|≤ `0.3109` → IC=+0.192 (n=102)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.96€ cuando `drift_60min` |x|≤ 0.3109 (IC base=+0.150)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.148 (n=103)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 4.0 (IC base=+0.150)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.211 (n=50)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.150)

- **PATRÓN** `ibs_20min` < `0.5587` → IC=+0.164 (n=102)

  - _Acción_: Kelly boost +0.82€ cuando `ibs_20min` < 0.5587 (IC base=+0.150)

- **PATRÓN** `ibs_20min` > `0.0244` → IC=+0.156 (n=91)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` > 0.0244 (IC base=+0.150)

- **PATRÓN** `dist_vwap_pct` < `0.2247` → IC=+0.176 (n=103)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.2247 (IC base=+0.150)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.286` → IC=+0.324 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.286 (IC base=+0.150)

- **PATRÓN** `volumen_regimen` < `1.2384` → IC=+0.192 (n=102)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 1.2384 (IC base=+0.150)

- **PATRÓN** `volumen_pendiente_norm` > `0.1782` → IC=+0.306 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1782 (IC base=+0.150)

- **PATRÓN** `volumen_spike_ratio` < `1.6083` → IC=+0.244 (n=41)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6083 (IC base=+0.150)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 159.0 (IC base=+0.150)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.145 (n=60)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.034)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.177 (n=63)

  - _Acción_: Kelly boost +0.88€ cuando `ibs_20min` > 1.0 (IC base=+0.034)

- **PATRÓN** `dist_vwap_pct` > `0.4443` → IC=+0.182 (n=20)

  - _Acción_: Kelly boost +0.91€ cuando `dist_vwap_pct` > 0.4443 (IC base=+0.034)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.14` → IC=+0.210 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.14 (IC base=+0.034)

- **PATRÓN** `volumen_pendiente_norm` > `0.1823` → IC=+0.145 (n=29)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` > 0.1823 (IC base=+0.034)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0084` → IC=+0.207 (n=765)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0084 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.161 (n=1169)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 15.0 (IC base=+0.138)

- **PATRÓN** `ibs_20min` > `0.9474` → IC=+0.285 (n=1042)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9474 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` > `1.0166` → IC=+0.242 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0166 (IC base=+0.138)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.406` → IC=+0.229 (n=1406)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.406 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` < `0.7083` → IC=+0.147 (n=692)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.7083 (IC base=+0.138)

- **PATRÓN** `volumen_regimen` > `1.2443` → IC=+0.144 (n=524)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.2443 (IC base=+0.138)

- **PATRÓN** `volumen_pendiente_norm` > `0.2391` → IC=+0.177 (n=398)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.2391 (IC base=+0.138)

- **PATRÓN** `volumen_spike_ratio` > `1.9173` → IC=+0.149 (n=1321)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.9173 (IC base=+0.138)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=1817)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `3474.8446` → IC=+0.179 (n=765)

  - _Acción_: Kelly boost +0.90€ cuando `libro_liquidez` > 3474.8446 (IC base=+0.138)

- **PATRÓN** `ballena_activa_n` < `166.0` → IC=+0.186 (n=810)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 166.0 (IC base=+0.138)

- **PATRÓN** `sigma_h` < `0.0061` → IC=+0.226 (n=1375)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0061 (IC base=+0.185)

- **PATRÓN** `drift_60min` |x|≤ `0.3962` → IC=+0.200 (n=2061)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3962 (IC base=+0.185)
...
- **PATRÓN** `ibs_20min` < `0.5413` → IC=+0.241 (n=2061)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5413 (IC base=+0.185)

- **PATRÓN** `dist_vwap_pct` < `0.6738` → IC=+0.174 (n=1666)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.6738 (IC base=+0.185)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.61` → IC=+0.192 (n=1934)
...
- **PATRÓN** `volumen_regimen` > `1.1856` → IC=+0.179 (n=527)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_regimen` > 1.1856 (IC base=+0.185)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2643` → IC=+0.195 (n=621)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_spike_ratio` > 2.2643 (IC base=+0.185)

- **PATRÓN** `ballena_activa_n` < `57.0` → IC=+0.138 (n=630)
...
- **PATRÓN** `sigma_h` < `0.0029` → IC=+0.171 (n=150)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0029 (IC base=+0.153)

- **PATRÓN** `sigma_h` > `0.0054` → IC=+0.181 (n=155)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0054 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.179 (n=356)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` > `0.3307` → IC=+0.214 (n=341)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3307 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.2258` → IC=+0.238 (n=204)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2258 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.973` → IC=+0.226 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.973 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `0.6608` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6608 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` > `1.1082` → IC=+0.181 (n=155)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.1082 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.2551` → IC=+0.229 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2551 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.5592` → IC=+0.188 (n=293)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.5592 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` > `1.3711` → IC=+0.192 (n=293)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` > 1.3711 (IC base=+0.153)

- **PATRÓN** `libro_liquidez` > `11102.6859` → IC=+0.194 (n=227)

  - _Acción_: Kelly boost +0.97€ cuando `libro_liquidez` > 11102.6859 (IC base=+0.153)
...
- **PATRÓN** `sigma_h` < `0.0086` → IC=+0.143 (n=340)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` < 0.0086 (IC base=+0.128)

- **PATRÓN** `drift_60min` |x|≤ `0.1293` → IC=+0.132 (n=150)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.1293 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.157 (n=307)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 8.0 (IC base=+0.128)

- **PATRÓN** `ibs_20min` > `0.3557` → IC=+0.195 (n=339)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3557 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.9611` → IC=+0.196 (n=77)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.9611 (IC base=+0.128)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.499` → IC=+0.186 (n=167)

  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 4.499 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` < `0.6318` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.6318 (IC base=+0.128)

- **PATRÓN** `volumen_regimen` > `1.2094` → IC=+0.152 (n=113)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2094 (IC base=+0.128)

- **PATRÓN** `volumen_pendiente_norm` > `0.2719` → IC=+0.300 (n=53)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2719 (IC base=+0.128)

- **PATRÓN** `volumen_spike_ratio` > `1.4212` → IC=+0.204 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4212 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `4224.1911` → IC=+0.193 (n=226)

  - _Acción_: Kelly boost +0.96€ cuando `libro_liquidez` > 4224.1911 (IC base=+0.128)

- **PATRÓN** `ballena_activa_n` < `232.0` → IC=+0.167 (n=211)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 232.0 (IC base=+0.128)
...
- **PATRÓN** `sigma_h` > `0.0086` → IC=+0.167 (n=181)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` > 0.0086 (IC base=+0.078)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.162` → IC=+0.259 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.162 (IC base=+0.078)

- **PATRÓN** `libro_liquidez` > `2747.518` → IC=+0.270 (n=133)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2747.518 (IC base=+0.078)
...
- **PATRÓN** `volumen_regimen` > `1.2439` → IC=+0.183 (n=165)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_regimen` > 1.2439 (IC base=+0.168)

- **PATRÓN** `volumen_pendiente_norm` > `0.2417` → IC=+0.240 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2417 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` < `1.5848` → IC=+0.177 (n=196)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.5848 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `1.88` → IC=+0.168 (n=296)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 1.88 (IC base=+0.168)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.180 (n=545)

  - _Acción_: Kelly boost +0.90€ cuando `libro_spread` < 0.01 (IC base=+0.168)

- **PATRÓN** `libro_liquidez` > `2639.8541` → IC=+0.177 (n=329)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 2639.8541 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.223 (n=225)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3909` → IC=+0.233 (n=478)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4875` → IC=+0.280 (n=543)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4875 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` < `0.6843` → IC=+0.222 (n=595)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `2.947` → IC=+0.216 (n=547)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 2.947 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `1.227` → IC=+0.243 (n=181)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.227 (IC base=+0.208)
...
- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.146 (n=255)

  - _Acción_: Kelly boost +0.73€ cuando `ballena_activa_n` < 36.0 (IC base=+0.208)
...
- **PATRÓN** `dist_vwap_pct` > `0.2483` → IC=+0.156 (n=155)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.2483 (IC base=+0.058)

- **PATRÓN** `volumen_regimen` > `1.1336` → IC=+0.149 (n=92)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.200 (n=261)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0041 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.2987` → IC=+0.162 (n=341)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.81€ cuando `drift_60min` |x|≤ 0.2987 (IC base=+0.147)
...
- **PATRÓN** `ibs_20min` < `0.6029` → IC=+0.171 (n=341)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` < 0.6029 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` > `0.6965` → IC=+0.170 (n=101)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.6965 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.3243` → IC=+0.153 (n=370)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.3243 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.422` → IC=+0.174 (n=188)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 3.422 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.335` → IC=+0.167 (n=388)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 1.335 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` > `0.6526` → IC=+0.148 (n=387)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.6526 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` < `0.0971` → IC=+0.151 (n=336)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_pendiente_norm` < 0.0971 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.0772` → IC=+0.160 (n=198)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.0772 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.6557` → IC=+0.184 (n=384)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.6557 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` > `1.4319` → IC=+0.150 (n=384)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` > 1.4319 (IC base=+0.147)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=501)

  - _Acción_: Kelly boost +0.79€ cuando `libro_spread` < 0.01 (IC base=+0.147)

- **PATRÓN** `libro_liquidez` > `7230.0627` → IC=+0.176 (n=387)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7230.0627 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `194.0` → IC=+0.168 (n=209)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 194.0 (IC base=+0.147)
...
- **PATRÓN** `dist_vwap_pct` > `1.7942` → IC=+0.214 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.7942 (IC base=+0.061)

- **PATRÓN** `volumen_regimen` > `1.1774` → IC=+0.132 (n=36)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 1.1774 (IC base=+0.061)

- **PATRÓN** `volumen_spike_ratio` < `1.4862` → IC=+0.179 (n=26)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 1.4862 (IC base=+0.061)

- **PATRÓN** `sigma_h` < `0.0034` → IC=+0.271 (n=46)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0034 (IC base=+0.193)

- **PATRÓN** `drift_60min` |x|≤ `0.4064` → IC=+0.217 (n=104)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.4064 (IC base=+0.193)

- **PATRÓN** `hora_utc` < `13.0` → IC=+0.211 (n=95)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 13.0 (IC base=+0.193)

- **PATRÓN** `ibs_20min` < `0.6855` → IC=+0.198 (n=104)

  - _Acción_: Kelly boost +0.99€ cuando `ibs_20min` < 0.6855 (IC base=+0.193)

- **PATRÓN** `ibs_20min` > `0.1608` → IC=+0.247 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.1608 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` > `0.5036` → IC=+0.197 (n=31)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5036 (IC base=+0.193)

- **PATRÓN** `dist_vwap_pct` < `0.1836` → IC=+0.204 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1836 (IC base=+0.193)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.306` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.306 (IC base=+0.193)

- **PATRÓN** `volumen_regimen` < `1.1102` → IC=+0.255 (n=92)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1102 (IC base=+0.193)

- **PATRÓN** `volumen_pendiente_norm` < `0.122` → IC=+0.229 (n=105)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.122 (IC base=+0.193)

- **PATRÓN** `volumen_spike_ratio` < `2.5699` → IC=+0.250 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5699 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `9525.8523` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 9525.8523 (IC base=+0.193)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.126 (n=89)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` < 18.0 (IC base=+0.098)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.153 (n=572)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.042 (n=1765)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.237 (n=554)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=1720)

- **FILTRO** `ibs_20min` > `0.2774` → IC=-0.205 (n=568)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2774
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=1706)
...
- **FILTRO** `ibs_20min` < `0.7263` → IC=-0.190 (n=85)
...
- **FILTRO** `py_entrada` < `0.495` → IC=-0.139 (n=106)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=+0.029 (n=312)
...
- **FILTRO** `drift_20min_pct` |x|> `0.3304` → IC=-0.189 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.078 (n=266)

- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.200 (n=88)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.278 (n=1363)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=4317)

- **FILTRO** `ibs_7min` < `0.7411` → IC=-0.226 (n=1420)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7411
  - _Potencial_: sin este filtro IC_bueno=-0.023 (n=4260)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.180 (n=1896)
...
- **FILTRO** `py_entrada` > `0.68` → IC=-0.219 (n=1700)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=5283)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.310 (n=193)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=594)

- **FILTRO** `ibs_7min` < `0.9787` → IC=-0.185 (n=519)
...
- **FILTRO** `drift_7min_pct` |x|> `0.1399` → IC=-0.165 (n=383)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1399
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=746)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.248 (n=276)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=908)

- **FILTRO** `ballena_activa_n` > `131.0` → IC=-0.176 (n=294)

  - _Acción_: SKIP cuando `ballena_activa_n` > 131.0
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=890)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.207 (n=230)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
...
- **FILTRO** `py_entrada` < `0.32` → IC=-0.340 (n=186)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=594)

- **FILTRO** `ibs_7min` < `0.2127` → IC=-0.282 (n=195)
...
- **FILTRO** `ibs_7min` > `0.2771` → IC=-0.159 (n=409)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2771
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=794)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.265 (n=228)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=735)

- **FILTRO** `ibs_7min` < `0.7797` → IC=-0.198 (n=240)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7797
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=723)

- **FILTRO** `ballena_activa_n` > `43.0` → IC=-0.215 (n=233)

  - _Acción_: SKIP cuando `ballena_activa_n` > 43.0
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=730)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.128 (n=617)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
...
- **FILTRO** `py_entrada` > `0.7` → IC=-0.284 (n=234)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=950)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.125 (n=395)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=1028)

### STRUCT_NO_15M#SOL#15min
- **FILTRO** `py_entrada` < `0.495` → IC=-0.147 (n=32)

  - _Acción_: SKIP cuando `py_entrada` < 0.495
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=602)
...
- **FILTRO** `ibs_15` < `0.4359` → IC=-0.311 (n=88)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.142 (n=266)

- **FILTRO** `sigma_h` > `0.0089` → IC=-0.147 (n=747)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0089
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1451)
...
- **FILTRO** `sigma_ewma_delta_pct` > `16.683` → IC=-0.200 (n=295)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 16.683
  - _Potencial_: sin este filtro IC_bueno=-0.081 (n=1903)

- **PATRÓN** `ibs_15` > `0.4359` → IC=+0.142 (n=266)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.71€ cuando `ibs_15` > 0.4359 (IC base=-0.053)
...
- **PATRÓN** `ibs_15` > `0.3899` → IC=+0.131 (n=109)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.65€ cuando `ibs_15` > 0.3899 (IC base=-0.003)
...
| ✅ BALLENAS_TARDIAS | 5782 | -0.098 | -662.73€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 618 | -0.082 | -107.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 5164 | -0.100 | -555.44€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#SOL | 1874 | -0.063 | -50.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 1874 | -0.063 | -50.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 1363 | -0.170 | -210.94€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 1363 | -0.170 | -210.94€ | 1 | 0 |
| ✅ FAVORITO_CONFIRMADO | 25810 | +0.113 | -1788.38€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 5038 | +0.185 | -189.18€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 106 | -0.102 | -48.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 17685 | +0.091 | -1536.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2981 | +0.124 | -14.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 2974 | +0.059 | -541.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 18 | -0.045 | +2.07€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | -0.089 | -6.26€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2951 | +0.060 | -536.83€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5432 | +0.134 | -126.00€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 1406 | +0.193 | -93.15€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 2942 | +0.109 | -72.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1042 | +0.134 | +61.72€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 2977 | +0.074 | -423.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 18 | +0.045 | -1.48€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 2958 | +0.074 | -419.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 5843 | +0.129 | -60.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1837 | +0.168 | -6.31€ | 0 | 7 |
| 🚫 FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 2942 | +0.113 | -37.65€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1052 | +0.108 | -8.23€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 5610 | +0.127 | -426.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1743 | +0.201 | -90.82€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 45 | +0.011 | -8.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 2935 | +0.083 | -259.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 887 | +0.132 | -67.59€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 