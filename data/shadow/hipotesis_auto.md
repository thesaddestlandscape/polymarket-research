...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.255 (n=198)
...
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.147 (n=579)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 18.0 (IC base=+0.142)

- **PATRÓN** `profundidad_ratio_no` > `17.8` → IC=+0.182 (n=193)

  - _Acción_: Kelly boost +0.91€ cuando `profundidad_ratio_no` > 17.8 (IC base=+0.142)
...
- **PATRÓN** `restante_min` < `4.86` → IC=+0.135 (n=294)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` < 4.86 (IC base=+0.120)

- **PATRÓN** `hora_utc` < `10.0` → IC=+0.142 (n=135)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` < 10.0 (IC base=+0.120)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.43` → IC=+0.197 (n=252)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` < 0.43 (IC base=+0.163)

- **PATRÓN** `restante_min` < `4.14` → IC=+0.211 (n=126)

  - _Acción_: Kelly boost +1.00€ cuando `restante_min` < 4.14 (IC base=+0.163)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.174 (n=286)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 8.0 (IC base=+0.163)
...
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 2758 | +0.084 | -150.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 5597 | +0.131 | -87.57€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#5min | 769 | +0.142 | +29.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE | 388 | +0.120 | -2.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#DOGE#5min | 388 | +0.120 | -2.44€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP | 381 | +0.163 | +31.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | 381 | +0.163 | +31.61€ | 0 | 4 |
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=2069 IC=+0.158 PNL=-284.47€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=2069 IC=+0.158 PNL=-284.47€
