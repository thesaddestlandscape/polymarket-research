# Hipótesis automáticas — 2026-07-02 02:25 UTC
_Generado por shadow_postmortem.py sobre 2521 resoluciones (PNL=-82.48€)_
...
- **FILTRO** `ibs_15` > `0.4545` → IC=-0.210 (n=29)
...
- **PATRÓN** `drift_15min` |x|≤ `0.7351` → IC=+0.127 (n=81)

  - _Acción_: Kelly boost +0.63€ cuando `drift_15min` |x|≤ 0.7351 (IC base=+0.081)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.206 (n=32)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 16.0 (IC base=+0.081)

- **PATRÓN** `ibs_15` < `0.4545` → IC=+0.144 (n=88)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.4545 (IC base=+0.081)
...
| ✅ UPDOWN_GBM | 769 | -0.032 | -31.32€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 549 | -0.006 | -5.39€ | 2 | 4 |
...
| ✅ UPDOWN_GBM#XRP | 66 | +0.015 | +6.26€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 55 | +0.061 | +9.55€ | 1 | 1 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.094) — sin ventaja clara. oversold(IBS<0.3): IC=+0.038 n=115 | neutral: IC=-0.056 n=115 | overbought(IBS>0.7): IC=-0.051 n=136
  - _Datos_: n=379 IC=-0.022 PNL=-6.08€

**🟡 H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  - _Umbral_: n≥20 forward con hora_utc + alguna hora con n≥15 IC<-0.10 o >+0.10
  - _Acción_: El sistema lo aplica automáticamente vía FEATURE_RULES. Verificar en strategy_params.json.
  - _Estado_: H=01h: IC=-0.179 n=26 PNL=-12.72€ → FILTRAR | H=02h: IC=-0.133 n=16 PNL=-1.82€ → FILTRAR | H=10h: IC=-0.154 n=15 PNL=-6.77€ → FILTRAR | H=16h: IC=+0.225 n=18 PNL=+7.60€ → BOOST | H=17h: IC=+0.110 n=15 PNL=+2.13€ → BOOST | H=20h: IC=-0.180 n=23 PNL=-6.41€ → FILTRAR | H=23h: IC=+0.243 n=15 PNL=+13.85€ → BOOST
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.003 n=1190 | tras_1loss IC=-0.036 n=1249 | tras_2loss IC=-0.049 n=650/40 | gap=+0.052 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=646 IC=-0.025 PNL=-17.76€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=646 IC=-0.025 PNL=-17.76€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=166 IC=+0.054 PNL=+22.47€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=166 IC=+0.054 PNL=+22.47€
...
**⏳ H-CUSTOM-MOON-LLENA** — Fase lunar: ¿rendimiento peor cerca de luna llena?
  ...
  - _Estado_: 104/200 ops en el filtro definido (IC actual=+0.057 PNL=+10.45€)
  - _Datos_: n=104 IC=+0.057 PNL=+10.45€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=104 IC=+0.057 PNL=+10.45€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=104 IC=+0.057 PNL=+10.45€
...
**⏳ H-CUSTOM-SMART-MONEY-CONSENSUS** — Consenso de wallets 'smart money' — ¿confirma nuestra dirección?
  ...
  - _Estado_: 13/40 ops en el filtro definido (IC actual=+0.065 PNL=+2.22€)
  - _Datos_: n=13 IC=+0.065 PNL=+2.22€
