# Hipótesis automáticas — 2026-07-12 12:13 UTC
_Generado por shadow_postmortem.py sobre 10886 resoluciones (PNL=+1911.25€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.220 (n=291)
...
- **PATRÓN** `libro_liquidez` > `2363.0481` → IC=+0.232 (n=323)
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 879 | +0.188 | +20.29€ | 0 | 9 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 311 | +0.174 | +6.42€ | 0 | 0 |
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.090 n=6136 | tras_1loss IC=+0.044 n=4613 | tras_2loss IC=+0.010 n=2076/40 | gap=+0.080 (umbral 0.05)
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=8428 IC=+0.096 PNL=+1987.14€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=8428 IC=+0.096 PNL=+1987.14€
