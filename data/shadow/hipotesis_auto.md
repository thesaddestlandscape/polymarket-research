# Hipótesis automáticas — 2026-07-15 23:11 UTC
_Generado por shadow_postmortem.py sobre 16063 resoluciones (PNL=+3266.29€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.188 (n=789)
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.288 (n=389)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.189 (n=981)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.01 (IC base=+0.186)

- **PATRÓN** `libro_liquidez` > `4419.1321` → IC=+0.187 (n=557)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 4419.1321 (IC base=+0.186)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.185 (n=433)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 16.0 (IC base=+0.162)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.202 (n=317)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 6.0 (IC base=+0.162)

- **PATRÓN** `py_entrada` < `0.265` → IC=+0.325 (n=307)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.162)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.172 (n=1039)

  - _Acción_: Kelly boost +0.86€ cuando `libro_spread` < 0.01 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `7407.0697` → IC=+0.186 (n=304)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 7407.0697 (IC base=+0.162)
...
- **PATRÓN** `py_entrada` > `0.615` → IC=+0.247 (n=168)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.615 (IC base=+0.193)

- **PATRÓN** `libro_liquidez` > `11311.7874` → IC=+0.198 (n=61)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 11311.7874 (IC base=+0.193)
...
- **PATRÓN** `libro_liquidez` > `7259.2748` → IC=+0.212 (n=175)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 7259.2748 (IC base=+0.202)

### FAVORITO_CONFIRMADO#BTC#60min
- **PATRÓN** `hora_utc` < `18.0` → IC=+0.196 (n=44)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 18.0 (IC base=+0.151)

- **PATRÓN** `py_entrada` < `0.565` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` < 0.565 (IC base=+0.151)

- **PATRÓN** `py_entrada` > `0.635` → IC=+0.167 (n=16)

  - _Acción_: Kelly boost +0.83€ cuando `py_entrada` > 0.635 (IC base=+0.151)

- **PATRÓN** `libro_liquidez` > `6840.9445` → IC=+0.167 (n=46)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 6840.9445 (IC base=+0.151)
...
- **PATRÓN** `py_entrada` < `0.575` → IC=+0.309 (n=19)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.575 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `5972.9638` → IC=+0.220 (n=23)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 5972.9638 (IC base=+0.202)
...
- **PATRÓN** `py_entrada` > `0.625` → IC=+0.281 (n=162)
...
- **PATRÓN** `py_entrada` < `0.365` → IC=+0.259 (n=168)
...
- **PATRÓN** `hora_utc` > `19.0` → IC=+0.237 (n=17)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 19.0 (IC base=+0.172)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.289 (n=17)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 8.0 (IC base=+0.172)

- **PATRÓN** `py_entrada` < `0.65` → IC=+0.207 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.65 (IC base=+0.172)
...
### GBM_LATE_15M
- **PATRÓN** `dist_vwap_pct` > `0.6433` → IC=+0.124 (n=123)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.6433 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.256` → IC=+0.204 (n=113)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.256 (IC base=+0.109)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.135 (n=1202)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.176` → IC=+0.185 (n=52)
  ...
  - _Acción_: Kelly boost +0.93€ cuando `sigma_ewma_delta_pct` > 3.176 (IC base=+0.059)
...
- **PATRÓN** `dist_vwap_pct` > `0.3457` → IC=+0.122 (n=43)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` > 0.3457 (IC base=+0.092)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.25` → IC=+0.261 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.25 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.762` → IC=+0.136 (n=42)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.762 (IC base=+0.063)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.012` → IC=+0.161 (n=54)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 5.012 (IC base=+0.063)

### GBM_LATE_15M#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `8.591` → IC=-0.265 (n=15)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.591
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=140)

- **PATRÓN** `sigma_h` < `0.0108` → IC=+0.147 (n=205)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0108 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.142 (n=216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_h` < `0.0135` → IC=+0.141 (n=399)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `sigma_h` > `0.0233` → IC=+0.188 (n=197)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.94€ cuando `sigma_h` > 0.0233 (IC base=+0.151)
...
- **PATRÓN** `dist_vwap_pct` > `0.6767` → IC=+0.227 (n=31)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6767 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.178` → IC=+0.204 (n=25)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.178 (IC base=+0.151)
...
- **PATRÓN** `sigma_h` > `0.0108` → IC=+0.224 (n=317)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0108 (IC base=+0.161)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.170 (n=468)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.1541` → IC=+0.194 (n=263)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.1541 (IC base=+0.161)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.023` → IC=+0.298 (n=82)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.023 (IC base=+0.161)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.175 (n=716)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0048 (IC base=+0.159)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.162 (n=492)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.4443` → IC=+0.191 (n=486)

  - _Acción_: Kelly boost +0.95€ cuando `dist_vwap_pct` < 0.4443 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.097` → IC=+0.256 (n=84)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.097 (IC base=+0.159)

### GBM_LATE_15M_ESPACIO_ATR#BTC#15min
- **PATRÓN** `sigma_h` > `0.0027` → IC=+0.144 (n=172)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.72€ cuando `sigma_h` > 0.0027 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.159 (n=124)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` > 12.0 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` > `0.5737` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5737 (IC base=+0.115)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.176 (n=180)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0028 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.154 (n=163)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.1946` → IC=+0.132 (n=123)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.1946 (IC base=+0.136)
...
- **PATRÓN** `sigma_h` < `0.0044` → IC=+0.147 (n=83)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0044 (IC base=+0.141)

- **PATRÓN** `sigma_h` > `0.0069` → IC=+0.236 (n=85)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0069 (IC base=+0.141)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.157 (n=135)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 12.0 (IC base=+0.141)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.165 (n=195)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` < 18.0 (IC base=+0.141)

- **PATRÓN** `dist_vwap_pct` > `0.3709` → IC=+0.177 (n=63)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` > 0.3709 (IC base=+0.141)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.752` → IC=+0.400 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.752 (IC base=+0.141)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.136 (n=160)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.0067 (IC base=+0.127)

- **PATRÓN** `sigma_h` > `0.0037` → IC=+0.147 (n=182)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0037 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.172 (n=62)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 18.0 (IC base=+0.127)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.162 (n=69)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` < 6.0 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` > `0.7629` → IC=+0.174 (n=41)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` > 0.7629 (IC base=+0.127)

- **PATRÓN** `dist_vwap_pct` < `1.433` → IC=+0.155 (n=140)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 1.433 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.012` → IC=+0.217 (n=44)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.012 (IC base=+0.127)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `sigma_ewma_delta_pct` > `3.165` → IC=-0.167 (n=16)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 3.165
  - _Potencial_: sin este filtro IC_bueno=+0.154 (n=105)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.153 (n=70)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.76€ cuando `hora_utc` > 18.0 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` > `0.4593` → IC=+0.186 (n=49)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.4593 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `1.0657` → IC=+0.153 (n=142)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 1.0657 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.082` → IC=+0.271 (n=59)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.082 (IC base=+0.139)

- **PATRÓN** `sigma_h` < `0.0082` → IC=+0.191 (n=66)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.96€ cuando `sigma_h` < 0.0082 (IC base=+0.099)

- **PATRÓN** `hora_utc` < `5.0` → IC=+0.157 (n=68)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.79€ cuando `hora_utc` < 5.0 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` < `0.2673` → IC=+0.164 (n=114)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.2673 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.165` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `sigma_ewma_delta_pct` < 3.165 (IC base=+0.099)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` < `0.018` → IC=+0.275 (n=149)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.018 (IC base=+0.260)

- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.262 (n=149)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0101 (IC base=+0.260)
...
- **PATRÓN** `dist_vwap_pct` > `0.8165` → IC=+0.364 (n=20)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8165 (IC base=+0.260)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.136` → IC=+0.333 (n=58)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.136 (IC base=+0.260)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0149` → IC=+0.196 (n=215)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0149 (IC base=+0.112)

- **PATRÓN** `hora_utc` < `16.0` → IC=+0.123 (n=593)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` < 16.0 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `0.7118` → IC=+0.172 (n=114)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.7118 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` < `0.1427` → IC=+0.151 (n=216)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` < 0.1427 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `13.68` → IC=+0.325 (n=61)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 13.68 (IC base=+0.112)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `dist_vwap_pct` > `0.5186` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.5186 (IC base=+0.085)
...
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.149 (n=55)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0039 (IC base=+0.050)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.366` → IC=+0.364 (n=20)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.366 (IC base=+0.050)
...
- **PATRÓN** `sigma_h` > `0.0134` → IC=+0.143 (n=68)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.71€ cuando `sigma_h` > 0.0134 (IC base=+0.082)

- **PATRÓN** `hora_utc` < `8.0` → IC=+0.149 (n=72)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` < 8.0 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` > `0.6196` → IC=+0.150 (n=18)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.6196 (IC base=+0.082)

- **PATRÓN** `dist_vwap_pct` < `0.6196` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` < 0.6196 (IC base=+0.082)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.065` → IC=+0.360 (n=41)
...
- **PATRÓN** `sigma_h` > `0.0114` → IC=+0.223 (n=186)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `dist_vwap_pct` > `0.6119` → IC=+0.269 (n=37)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6119 (IC base=+0.208)

- **PATRÓN** `sigma_ewma_delta_pct` < `11.36` → IC=+0.225 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 11.36 (IC base=+0.208)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7197` → IC=+0.177 (n=261)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `15.266` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 15.266 (IC base=+0.026)

- **PATRÓN** `ibs_15` < `0.0265` → IC=+0.121 (n=138)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.61€ cuando `ibs_15` < 0.0265 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` < `17.186` → IC=+0.135 (n=135)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` < 17.186 (IC base=+0.049)
...
- **PATRÓN** `dist_vwap_pct` > `0.974` → IC=+0.200 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.974 (IC base=+0.047)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7197 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.177 n=261). Confirma señal de reversión media → alinear con BUY_NO.
...
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2328 | +0.173 | -50.43€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#15min | 1500 | +0.208 | +8.38€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 97 | +0.015 | -15.58€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 335 | +0.087 | -53.89€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 396 | +0.153 | +10.67€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 676 | +0.178 | -17.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 502 | +0.198 | -21.52€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 32 | +0.088 | -0.96€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BTC#5min | 10 | -0.125 | -3.77€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 132 | +0.157 | +9.17€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#ETH | 828 | +0.173 | +1.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 497 | +0.215 | +20.13€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 32 | -0.118 | -13.02€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 167 | +0.104 | -20.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 132 | +0.172 | +14.73€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL | 817 | +0.170 | -30.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 494 | +0.212 | +13.51€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 33 | +0.071 | -1.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 158 | +0.094 | -29.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 132 | +0.127 | -13.24€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#XRP | 7 | -0.019 | -3.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 7 | -0.019 | -3.74€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 23 | +0.300 | +1.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 23 | +0.300 | +1.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 23 | +0.300 | +1.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 23 | +0.300 | +1.36€ | 0 | 0 |
| ✅ GBM_LATE_15M | 4714 | +0.103 | +1473.81€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4714 | +0.103 | +1473.81€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1132 | +0.064 | +160.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1132 | +0.064 | +160.61€ | 0 | 3 |
| ✅ GBM_LATE_15M#ETH | 1139 | +0.076 | +199.40€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1139 | +0.076 | +199.40€ | 1 | 5 |
| ✅ GBM_LATE_15M#SOL | 1257 | +0.111 | +509.67€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1257 | +0.111 | +509.67€ | 1 | 6 |
| ✅ GBM_LATE_15M#XRP | 1186 | +0.157 | +604.14€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1186 | +0.157 | +604.14€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1959 | +0.151 | +1148.83€ | 0 | 10 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1959 | +0.151 | +1148.83€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 502 | +0.111 | +245.79€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 502 | +0.111 | +245.79€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 519 | +0.128 | +240.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 519 | +0.128 | +240.98€ | 0 | 13 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 529 | +0.112 | +233.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 529 | +0.112 | +233.08€ | 1 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 409 | +0.276 | +428.97€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 409 | +0.276 | +428.97€ | 0 | 11 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_MULTIHORIZONTE#15min | 6 | +0.000 | -0.08€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO | 50 | +0.096 | +16.35€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 50 | +0.096 | +16.35€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP | 25 | +0.352 | +19.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#XRP#15min | 25 | +0.352 | +19.29€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO | 1918 | +0.088 | +571.19€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1918 | +0.088 | +571.19€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 476 | +0.059 | +85.53€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 476 | +0.059 | +85.53€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 436 | +0.016 | +11.91€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 436 | +0.016 | +11.91€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 461 | +0.055 | +84.61€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 461 | +0.055 | +84.61€ | 2 | 6 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 545 | +0.200 | +389.15€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 545 | +0.200 | +389.15€ | 0 | 10 |
...
| ✅ UPDOWN_GBM | 1571 | +0.010 | +72.66€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1313 | +0.037 | +109.69€ | 0 | 6 |
| 🚫 UPDOWN_GBM#240min | 11 | -0.148 | -4.31€ | 0 | 0 |
| 🚫 UPDOWN_GBM#5min | 75 | -0.162 | -22.48€ | 4 | 0 |
| ✅ UPDOWN_GBM#60min | 127 | -0.058 | -10.76€ | 7 | 0 |
| ✅ UPDOWN_GBM#BNB | 79 | +0.080 | +19.39€ | 0 | 0 |
| ✅ UPDOWN_GBM#BNB#15min | 79 | +0.080 | +19.39€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 755 | +0.018 | +34.71€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 662 | +0.035 | +45.76€ | 1 | 3 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 8 | +0.080 | -0.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 8 | +0.080 | -0.16€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH | 5 | +0.054 | +0.05€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#ETH#15min | 5 | +0.054 | +0.05€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 66 | +0.206 | +20.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 66 | +0.206 | +20.43€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 12 | +0.129 | +4.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 12 | +0.129 | +4.41€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 18 | +0.180 | +2.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 18 | +0.180 | +2.35€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 24 | +0.154 | +7.83€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 24 | +0.154 | +7.83€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.141) — sin ventaja clara. oversold(IBS<0.3): IC=+0.004 n=458 | neutral: IC=-0.021 n=357 | overbought(IBS>0.7): IC=+0.120 n=372
  - _Datos_: n=1255 IC=+0.038 PNL=+118.16€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.101 n=9314 | tras_1loss IC=+0.065 n=6533 | tras_2loss IC=+0.033 n=2801/40 | gap=+0.069 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1444 IC=+0.017 PNL=+86.66€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1444 IC=+0.017 PNL=+86.66€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=697 IC=+0.026 PNL=+44.62€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=697 IC=+0.026 PNL=+44.62€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=695 IC=+0.072 PNL=+86.97€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=695 IC=+0.072 PNL=+86.97€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=581 IC=+0.033 PNL=+41.23€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=581 IC=+0.033 PNL=+41.23€

**⏳ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: 40
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: 3/40 ops en el filtro definido (IC actual=+0.015 PNL=+0.13€)
  - _Datos_: n=3 IC=+0.015 PNL=+0.13€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13605 IC=+0.104 PNL=+3342.17€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13605 IC=+0.104 PNL=+3342.17€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=845 IC=-0.004 PNL=+15.09€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=845 IC=-0.004 PNL=+15.09€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.165 > 0.1 con n=398 PNL=+138.40€
  - _Datos_: n=398 IC=+0.165 PNL=+138.40€
...
**〰️ H-CUSTOM-LATE15-BTC-BUYNO-COINFLIP** — GBM_LATE_15M BTC#BUY_NO es moneda al aire — candidata a quitar del motor estrella
  ...
  - _Estado_: n=602 IC=+0.055 PNL=+70.91€ — sin señal clara aún (umbral IC: min=None max=0.03)
  - _Datos_: n=602 IC=+0.055 PNL=+70.91€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.147 > 0.08 con n=293 PNL=+90.87€
  - _Datos_: n=293 IC=+0.147 PNL=+90.87€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.212 > 0.08 con n=130 PNL=+58.61€
...
**🔴 H-CUSTOM-GBMLATE-PYBAJO-LONGSHOT** — GBM_LATE_15M BUY_YES con prob_yes_modelo<0.53 — mismo sesgo favorito-longshot que el resto del sistema, sin filtrar todavía
  ...
  - _Estado_: SEÑAL NEGATIVA confirmada: IC=-0.184 < -0.1 con n=391 PNL=-85.54€
  - _Datos_: n=391 IC=-0.184 PNL=-85.54€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.256 > 0.2 con n=330 PNL=+228.76€
  - _Datos_: n=330 IC=+0.256 PNL=+228.76€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.146 > 0.08 con n=145 PNL=+52.93€
  - _Datos_: n=145 IC=+0.146 PNL=+52.93€

**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  - _Hipótesis_: 12-Jul: mismo mecanismo que ETH (ver H-CUSTOM-ETH15-SIGMA-ACCEL). Verificado ad-hoc n=35: hit sube de 63.6% (agregado BTC) a 68.6%, ic_bayes=+0.176.
  - _Umbral_: n>=40 y IC>+0.08
  - _Acción_: Si confirma con n>=40 -> proponer kelly_boost condicionado a sigma_ewma_delta_pct>=0 en BTC#15min
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.109 > 0.08 con n=131 PNL=+50.02€
  - _Datos_: n=131 IC=+0.109 PNL=+50.02€
...
**🔶 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA en XRP (IC=+0.146 n=179) pero sin cruzar ≥2 pares más — BTC: n=134 IC=+0.000; ETH: n=102 IC=+0.000; SOL: n=189 IC=+0.060 ✓
  - _Datos_: n=179 IC=+0.146 PNL=+99.78€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.211 > 0.08 con n=119 PNL=+6.58€
  - _Datos_: n=119 IC=+0.211 PNL=+6.58€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.243 > 0.08 con n=181 PNL=-11.49€
  - _Datos_: n=181 IC=+0.243 PNL=-11.49€
...
**🔶 H-CUSTOM-ETH15-BUYNO-TARDIO** — UPDOWN_GBM ETH#15min BUY_NO tardío (T_h<0.2) -- edge fuerte no capturado por el aprendizaje causal automático
  ...
  - _Estado_: SEÑAL POSITIVA en ETH (IC=+0.267 n=58) pero sin cruzar ≥2 pares más — BNB: n=10 IC=+0.083; BTC: n=12 IC=+0.043; DOGE: n=8 IC=+0.080; SOL: n=8 IC=+0.000; XRP: n=9 IC=+0.061
  - _Datos_: n=58 IC=+0.267 PNL=+33.03€
