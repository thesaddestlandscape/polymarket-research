# Hipótesis automáticas — 2026-07-21 20:47 UTC
_Generado por shadow_postmortem.py sobre 27479 resoluciones (PNL=+6297.77€)_

## Patrones causales activos

### FAVORITO_CONFIRMADO
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.203 (n=1542)
...
- **PATRÓN** `py_entrada` > `0.695` → IC=+0.316 (n=787)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.695 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1931)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.229 (n=341)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `4295.8159` → IC=+0.219 (n=247)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.256 (n=133)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.675` → IC=+0.334 (n=251)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.675 (IC base=+0.240)

- **PATRÓN** `libro_liquidez` > `1866.6998` → IC=+0.246 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1866.6998 (IC base=+0.240)
...
- **PATRÓN** `dist_vwap_pct` > `0.2641` → IC=+0.125 (n=379)

  - _Acción_: Kelly boost +0.62€ cuando `dist_vwap_pct` > 0.2641 (IC base=+0.101)
...
- **PATRÓN** `dist_vwap_pct` > `1.1838` → IC=+0.155 (n=27)
  ...
  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 1.1838 (IC base=+0.069)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.447` → IC=+0.180 (n=101)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.182 (n=231)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.3689` → IC=+0.206 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3689 (IC base=+0.158)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.708` → IC=+0.152 (n=360)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.169 (n=934)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` > 0.0073 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.177 (n=527)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 17.0 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `1.0028` → IC=+0.164 (n=114)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` > 1.0028 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.775` → IC=+0.148 (n=1355)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.775 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.191` → IC=+0.162 (n=267)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 6.191 (IC base=+0.140)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.145 (n=184)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `0.7149` → IC=+0.138 (n=67)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.7149 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.58` → IC=+0.185 (n=128)

  - _Acción_: Kelly boost +0.92€ cuando `sigma_ewma_delta_pct` > 4.58 (IC base=+0.100)
...
- **PATRÓN** `dist_vwap_pct` > `0.1301` → IC=+0.237 (n=131)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1301 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `10.223` → IC=+0.189 (n=426)

  - _Acción_: Kelly boost +0.95€ cuando `sigma_ewma_delta_pct` < 10.223 (IC base=+0.187)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7548` → IC=+0.214 (n=344)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7548 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` > `0.1333` → IC=+0.178 (n=172)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.1333 (IC base=+0.049)

- **PATRÓN** `dist_vwap_pct` < `0.5023` → IC=+0.149 (n=249)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.5023 (IC base=+0.049)

- **PATRÓN** `sigma_ewma_delta_pct` > `23.684` → IC=+0.200 (n=48)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 23.684 (IC base=+0.049)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.7548 sube el IC de +0.049 a +0.214 en UPDOWN_GBM#15min (n=344). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 639 | +0.126 | +19.14€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 639 | +0.126 | +19.14€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 237 | +0.128 | +1.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 237 | +0.128 | +1.37€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 248 | +0.144 | +6.09€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 248 | +0.144 | +6.09€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 4744 | +0.184 | +60.81€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 3094 | +0.215 | +97.13€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 1677 | +0.173 | -10.66€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 1019 | +0.211 | +27.71€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#SOL | 1661 | +0.186 | +20.45€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 1024 | +0.226 | +69.76€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 233 | +0.313 | +10.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#15min | 233 | +0.313 | +10.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL | 233 | +0.313 | +10.63€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_SOL_ALTACONVICCION#SOL#15min | 233 | +0.313 | +10.63€ | 0 | 0 |
| ✅ GBM_LATE_15M | 6623 | +0.099 | +2125.60€ | 0 | 5 |
| ✅ GBM_LATE_15M#15min | 6623 | +0.099 | +2125.60€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1583 | +0.070 | +282.54€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1583 | +0.070 | +282.54€ | 0 | 5 |
| ✅ GBM_LATE_15M#ETH | 1506 | +0.072 | +262.89€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 1506 | +0.072 | +262.89€ | 0 | 6 |
| ✅ GBM_LATE_15M#SOL | 1789 | +0.090 | +639.06€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 1789 | +0.090 | +639.06€ | 1 | 4 |
| ✅ GBM_LATE_15M#XRP | 1745 | +0.157 | +941.12€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 1745 | +0.157 | +941.12€ | 0 | 12 |
| ✅ GBM_LATE_15M_ESPACIO_ATR | 3819 | +0.134 | +2057.62€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 3819 | +0.134 | +2057.62€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 971 | +0.097 | +401.20€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 971 | +0.097 | +401.20€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 995 | +0.095 | +389.52€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 995 | +0.095 | +389.52€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL | 967 | +0.105 | +414.46€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#SOL#15min | 967 | +0.105 | +414.46€ | 0 | 7 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP | 886 | +0.250 | +852.45€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#XRP#15min | 886 | +0.250 | +852.45€ | 0 | 11 |
...
| ✅ GBM_LATE_15M_TARDIO | 3789 | +0.087 | +1221.74€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#15min | 3789 | +0.087 | +1221.74€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 906 | +0.053 | +159.05€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 906 | +0.053 | +159.05€ | 0 | 5 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 915 | +0.029 | +81.28€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 915 | +0.029 | +81.28€ | 0 | 2 |
| ✅ GBM_LATE_15M_TARDIO#SOL | 865 | +0.047 | +181.80€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#SOL#15min | 865 | +0.047 | +181.80€ | 0 | 1 |
| ✅ GBM_LATE_15M_TARDIO#XRP | 1103 | +0.194 | +799.60€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#XRP#15min | 1103 | +0.194 | +799.60€ | 0 | 13 |
...
| ✅ UPDOWN_GBM | 2084 | +0.026 | +166.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1822 | +0.049 | +206.02€ | 0 | 4 |
...
| ✅ UPDOWN_GBM#ETH | 884 | +0.027 | +47.34€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 790 | +0.043 | +58.90€ | 2 | 5 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 105 | +0.285 | +18.78€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 105 | +0.285 | +18.78€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 1039 | +0.167 | +469.80€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 1039 | +0.167 | +469.80€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 218 | +0.154 | +65.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 218 | +0.154 | +65.07€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 255 | +0.095 | +71.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 255 | +0.095 | +71.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 255 | +0.228 | +197.93€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 255 | +0.228 | +197.93€ | 0 | 0 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.186: overbought→boost, neutral→filtro | oversold(IBS<0.3): IC=+0.056 n=956 | neutral: IC=+0.005 n=745 | overbought(IBS>0.7): IC=+0.191 n=961
  - _Datos_: n=2846 IC=+0.096 PNL=+680.49€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.114 n=16431 | tras_1loss IC=+0.083 n=10845 | tras_2loss IC=+0.050 n=4485/40 | gap=+0.065 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1952 IC=+0.032 PNL=+181.69€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1952 IC=+0.032 PNL=+181.69€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=863 IC=+0.049 PNL=+104.08€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=863 IC=+0.049 PNL=+104.08€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.082 > 0.08 con n=977 PNL=+150.00€
  - _Datos_: n=977 IC=+0.082 PNL=+150.00€
...
**🟡 H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.129 > 0.08 con n=157 PNL=+39.26€
  - _Datos_: n=157 IC=+0.129 PNL=+39.26€
...
**🟡 H-CUSTOM-CROSS-WINDOW-SPREAD-POS** — GBM 15min/60min: spread positivo alto de precio_yes contra la ventana relacionada
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.229 > 0.08 con n=127 PNL=+13.81€
  - _Datos_: n=127 IC=+0.229 PNL=+13.81€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=25011 IC=+0.113 PNL=+6375.66€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=25011 IC=+0.113 PNL=+6375.66€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=1013 IC=+0.019 PNL=+73.53€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1013 IC=+0.019 PNL=+73.53€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.172 > 0.1 con n=636 PNL=+239.91€
  - _Datos_: n=636 IC=+0.172 PNL=+239.91€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.146 > 0.08 con n=459 PNL=+150.33€
  - _Datos_: n=459 IC=+0.146 PNL=+150.33€
...
**🟡 H-CUSTOM-ETH15-SIGMA-ACCEL** — GBM_LATE_15M ETH — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.110 > 0.08 con n=375 PNL=+110.25€
  - _Datos_: n=375 IC=+0.110 PNL=+110.25€
...
**🟡 H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.150 > 0.08 con n=473 PNL=+282.93€
  - _Datos_: n=473 IC=+0.150 PNL=+282.93€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.286 > 0.08 con n=358 PNL=+12.04€
  - _Datos_: n=358 IC=+0.286 PNL=+12.04€
