# Hipótesis automáticas — 2026-07-05 20:30 UTC
_Generado por shadow_postmortem.py sobre 3991 resoluciones (PNL=+175.96€)_
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.149 (n=95)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` < 0.0089 (IC base=+0.031)

- **PATRÓN** `ibs_15` < `0.0563` → IC=+0.153 (n=73)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.77€ cuando `ibs_15` < 0.0563 (IC base=+0.031)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.210 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.006 (IC base=+0.074)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.186 (n=33)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` < 7.0 (IC base=+0.074)

- **PATRÓN** `ibs_15` < `0.099` → IC=+0.180 (n=48)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.90€ cuando `ibs_15` < 0.099 (IC base=+0.074)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS < 0.0563 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.153 n=73). Confirma señal de reversión media → alinear con BUY_YES.
...
|---|---|---|---|---|---|
| ✅ GBM_LATE_15M | 1150 | +0.089 | +270.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#15min | 1150 | +0.089 | +270.88€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 300 | +0.036 | +30.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 300 | +0.036 | +30.31€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH | 300 | +0.056 | +32.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#ETH#15min | 300 | +0.056 | +32.34€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL | 302 | +0.125 | +114.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#SOL#15min | 302 | +0.125 | +114.30€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP | 248 | +0.148 | +93.93€ | 0 | 0 |
| ✅ GBM_LATE_15M#XRP#15min | 248 | +0.148 | +93.93€ | 0 | 0 |
...
| ✅ UPDOWN_GBM | 963 | -0.037 | -51.23€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 724 | -0.014 | -21.27€ | 0 | 2 |
...
| ✅ UPDOWN_GBM#ETH | 408 | -0.005 | +5.84€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 321 | +0.014 | +13.83€ | 3 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.060) — sin ventaja clara. oversold(IBS<0.3): IC=-0.010 n=202 | neutral: IC=-0.070 n=163 | overbought(IBS>0.7): IC=-0.043 n=186
  - _Datos_: n=573 IC=-0.034 PNL=-26.00€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.027 n=2004 | tras_1loss IC=-0.006 n=1893 | tras_2loss IC=-0.024 n=939/40 | gap=+0.051 (umbral 0.05)
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=840 IC=-0.032 PNL=-37.68€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=840 IC=-0.032 PNL=-37.68€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=263 IC=+0.002 PNL=+4.34€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=263 IC=+0.002 PNL=+4.34€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=1541 IC=+0.061 PNL=+251.14€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=1541 IC=+0.061 PNL=+251.14€
