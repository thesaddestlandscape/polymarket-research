# Hipótesis automáticas — 2026-08-10 12:32 UTC
_Generado por shadow_postmortem.py sobre 104754 resoluciones (PNL=+14775.53€)_
...
- **PATRÓN** `py_entrada` < `0.36` → IC=+0.233 (n=361)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.36 (IC base=+0.129)

- **PATRÓN** `restante_min` < `4.63` → IC=+0.134 (n=713)

  - _Acción_: Kelly boost +0.67€ cuando `restante_min` < 4.63 (IC base=+0.129)

- **PATRÓN** `restante_min` > `4.86` → IC=+0.138 (n=484)

  - _Acción_: Kelly boost +0.69€ cuando `restante_min` > 4.86 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.143 (n=969)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.71€ cuando `hora_utc` > 8.0 (IC base=+0.129)

- **PATRÓN** `lag_apertura_s` < `5.71` → IC=+0.140 (n=354)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 5.71 (IC base=+0.129)
...
- **PATRÓN** `restante_min` > `4.87` → IC=+0.125 (n=182)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` > 4.87 (IC base=+0.119)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.135 (n=486)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 8.0 (IC base=+0.119)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.41` → IC=+0.194 (n=374)

  - _Acción_: Kelly boost +0.97€ cuando `py_entrada` < 0.41 (IC base=+0.138)

- **PATRÓN** `restante_min` < `4.95` → IC=+0.143 (n=556)

  - _Acción_: Kelly boost +0.72€ cuando `restante_min` < 4.95 (IC base=+0.138)

- **PATRÓN** `restante_min` > `4.22` → IC=+0.146 (n=478)

  - _Acción_: Kelly boost +0.73€ cuando `restante_min` > 4.22 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.161 (n=384)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.138)

- **PATRÓN** `lag_apertura_s` < `42.17` → IC=+0.144 (n=470)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 42.17 (IC base=+0.138)

- **PATRÓN** `profundidad_ratio_no` > `24.2` → IC=+0.207 (n=179)

  - _Acción_: Kelly boost +1.00€ cuando `profundidad_ratio_no` > 24.2 (IC base=+0.138)
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1864 | +0.048 | -19.03€ | 0 | 4 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1864 | +0.048 | -19.03€ | 0 | 0 |
...
| ✅ BALLENAS_CONFIRMADAS_15M#SOL | 657 | +0.066 | -15.54€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#SOL#15min | 657 | +0.066 | -15.54€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#XRP#15min | 312 | +0.073 | +19.97€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS | 2990 | -0.059 | -620.88€ | 0 | 1 |
| ✅ BALLENAS_TARDIAS#15min | 473 | +0.218 | -44.10€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 2517 | -0.112 | -576.78€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#DOGE | 421 | -0.157 | -47.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 421 | -0.157 | -47.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 540 | +0.052 | -22.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 540 | +0.052 | -22.86€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 583 | -0.044 | -76.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 583 | -0.044 | -76.63€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 586 | -0.194 | -327.59€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 586 | -0.194 | -327.59€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 28971 | +0.119 | -709.50€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 6680 | +0.196 | -127.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 457 | +0.049 | -41.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 19801 | +0.093 | -585.05€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 2033 | +0.137 | +44.09€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 3183 | +0.082 | -187.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 13 | -0.022 | -3.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 5 | +0.018 | +2.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 3165 | +0.083 | -186.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 6179 | +0.132 | -88.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2085 | +0.185 | -101.70€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 149 | +0.056 | -15.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 3174 | +0.097 | -41.20€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 771 | +0.147 | +69.91€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 3181 | +0.082 | -177.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 16 | +0.222 | +8.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 3164 | +0.080 | -187.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 6644 | +0.135 | -31.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2251 | +0.196 | +7.80€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 149 | -0.017 | -32.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 3576 | +0.103 | -19.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 668 | +0.130 | +12.90€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#SOL | 6572 | +0.134 | -216.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2274 | +0.207 | -35.03€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 150 | +0.105 | +4.44€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 3554 | +0.089 | -147.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 594 | +0.131 | -38.71€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 3212 | +0.105 | -9.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 41 | +0.128 | -3.86€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 3168 | +0.105 | -3.20€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 13252 | +0.200 | -963.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 13252 | +0.200 | -963.03€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 2102 | +0.225 | -51.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 2102 | +0.225 | -51.61€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 2294 | +0.184 | -242.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 2294 | +0.184 | -242.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 