# Hipótesis automáticas — 2026-09-16 22:33 UTC
_Generado por shadow_postmortem.py sobre 472630 resoluciones (PNL=+50847.74€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `144.23` → IC=-0.252 (n=5840)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.23
  - _Potencial_: sin este filtro IC_bueno=-0.046 (n=17520)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `139.07` → IC=-0.275 (n=802)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 139.07
  - _Potencial_: sin este filtro IC_bueno=-0.059 (n=2408)
...
- **FILTRO** `restante_s_al_confirmar` < `135.58` → IC=-0.281 (n=712)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=2137)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `158.17` → IC=-0.252 (n=1389)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.17
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=4168)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `118.48` → IC=-0.364 (n=1124)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 118.48
  - _Potencial_: sin este filtro IC_bueno=-0.103 (n=3375)

### CANDIDATA9_BOT_CONSENSO
- **FILTRO** `py_entrada` < `0.47` → IC=-0.246 (n=262)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=279)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.141 (n=126)
...
- **FILTRO** `py_entrada` < `0.48` → IC=-0.259 (n=135)

  - _Acción_: SKIP cuando `py_entrada` < 0.48
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=155)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.151 (n=61)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.196 (n=11837)

  - _Acción_: Kelly boost +0.98€ cuando `py_entrada` > 0.69 (IC base=+0.097)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.151 (n=2949)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.01 (IC base=+0.097)

- **PATRÓN** `libro_liquidez` > `5298.6645` → IC=+0.168 (n=1878)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 5298.6645 (IC base=+0.097)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.146 (n=9237)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.745` → IC=+0.347 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.745 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.201 (n=1721)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `15006.8301` → IC=+0.207 (n=445)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15006.8301 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.208 (n=1269)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1274)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=1785)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `13219.4335` → IC=+0.215 (n=626)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 13219.4335 (IC base=+0.202)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=2373)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.327 (n=790)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.7 (IC base=+0.138)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.246 (n=1066)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.246 (n=1236)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.239)

- **PATRÓN** `libro_liquidez` > `3756.3222` → IC=+0.245 (n=527)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3756.3222 (IC base=+0.239)

### FAVORITO_CONFIRMADO#ETH#60min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=575)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.222 (n=519)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.193)

- **PATRÓN** `py_entrada` > `0.85` → IC=+0.423 (n=545)
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.181 (n=1125)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.142 (n=694)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.202 (n=9311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.220 (n=3291)
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.178 (n=2301)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.311 (n=204)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.715` → IC=+0.333 (n=382)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.715 (IC base=+0.278)

### FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.183 (n=2159)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.200 (n=2209)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.71` → IC=+0.195 (n=1591)
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.187 (n=5082)

  - _Acción_: Kelly boost +0.94€ cuando `py_entrada` > 0.71 (IC base=+0.170)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.225 (n=4921)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.268 (n=1746)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.207 (n=4565)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.74` → IC=+0.255 (n=2316)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.74 (IC base=+0.203)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.192 (n=4628)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `2.49` → IC=+0.150 (n=1935)

  - _Acción_: Kelly boost +0.75€ cuando `lag_apertura_s` < 2.49 (IC base=+0.120)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.301 (n=1002)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1604.6829` → IC=+0.297 (n=942)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1604.6829 (IC base=+0.287)

### FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION#BTC#60min
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.299 (n=292)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.328 (n=318)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `1492.929` → IC=+0.314 (n=402)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.4978` → IC=+0.154 (n=5608)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.4978 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` < `0.2156` → IC=+0.245 (n=1333)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2156 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.862` → IC=+0.167 (n=2424)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 5.862 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.6081` → IC=+0.253 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6081 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` > `1.0678` → IC=+0.244 (n=724)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0678 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` < `0.1746` → IC=+0.191 (n=4302)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` < 0.1746 (IC base=+0.096)

- **PATRÓN** `volumen_pendiente_norm` > `0.308` → IC=+0.203 (n=594)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.308 (IC base=+0.096)

- **PATRÓN** `volumen_spike_ratio` > `1.4707` → IC=+0.194 (n=4141)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4707 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.5676` → IC=+0.131 (n=7706)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` < 0.5676 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` > `0.5751` → IC=+0.187 (n=458)

  - _Acción_: Kelly boost +0.93€ cuando `dist_vwap_pct` > 0.5751 (IC base=+0.059)

- **PATRÓN** `dist_vwap_pct` < `0.3454` → IC=+0.168 (n=2684)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.3454 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` < `0.6983` → IC=+0.168 (n=1110)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.6983 (IC base=+0.059)

- **PATRÓN** `volumen_regimen` > `0.8706` → IC=+0.177 (n=1682)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 0.8706 (IC base=+0.059)

- **PATRÓN** `volumen_pendiente_norm` > `0.2444` → IC=+0.224 (n=853)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2444 (IC base=+0.059)

- **PATRÓN** `volumen_spike_ratio` > `1.4676` → IC=+0.197 (n=4195)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 1.4676 (IC base=+0.059)

- **PATRÓN** `ballena_activa_n` < `155.0` → IC=+0.209 (n=3963)
...
- **PATRÓN** `sigma_h` > `0.0077` → IC=+0.181 (n=472)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.91€ cuando `sigma_h` > 0.0077 (IC base=+0.163)

- **PATRÓN** `drift_60min` |x|≤ `0.3237` → IC=+0.164 (n=1416)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.057` → IC=+0.276 (n=619)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6248` → IC=+0.153 (n=1305)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_spike_ratio` < 2.6248 (IC base=+0.163)

- **PATRÓN** `volumen_spike_ratio` > `1.4349` → IC=+0.163 (n=1305)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.4349 (IC base=+0.163)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.184 (n=1319)

  - _Acción_: Kelly boost +0.92€ cuando `libro_spread` < 0.04 (IC base=+0.163)

- **PATRÓN** `sigma_h` > `0.0048` → IC=+0.251 (n=943)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0048 (IC base=+0.235)

- **PATRÓN** `drift_60min` |x|≤ `0.193` → IC=+0.273 (n=702)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.193 (IC base=+0.235)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.252 (n=723)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` < `1.7478` → IC=+0.218 (n=696)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7478 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.368` → IC=+0.220 (n=348)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.368 (IC base=+0.211)

- **PATRÓN** `libro_liquidez` > `10984.4814` → IC=+0.221 (n=1071)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 10984.4814 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.155 (n=1010)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.144 (n=1148)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 1.2046 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` > `0.8472` → IC=+0.139 (n=766)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.8472 (IC base=+0.136)

- **PATRÓN** `volumen_pendiente_norm` > `0.1571` → IC=+0.184 (n=311)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1571 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` < `2.4267` → IC=+0.153 (n=1039)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.4267 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `13502.5597` → IC=+0.149 (n=765)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 13502.5597 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `423.0` → IC=+0.145 (n=955)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 423.0 (IC base=+0.136)

### GBM_LATE_15M#DOGE#15min
- **PATRÓN** `sigma_h` < `0.0089` → IC=+0.177 (n=1216)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0089 (IC base=+0.177)

- **PATRÓN** `sigma_h` > `0.0058` → IC=+0.189 (n=1382)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.95€ cuando `sigma_h` > 0.0058 (IC base=+0.177)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.178 (n=1386)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `7.507` → IC=+0.226 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.507 (IC base=+0.177)

- **PATRÓN** `volumen_pendiente_norm` < `0.1063` → IC=+0.182 (n=1176)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.152 (n=90)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.012 (n=1748)
...
- **PATRÓN** `volumen_regimen` < `0.695` → IC=+0.152 (n=254)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.695 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` > `1.1666` → IC=+0.149 (n=192)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` > 1.1666 (IC base=+0.004)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5104` → IC=+0.186 (n=469)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.5104 (IC base=+0.004)
...
- **FILTRO** `ibs_20min` > `0.2692` → IC=-0.127 (n=1774)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2692
  - _Potencial_: sin este filtro IC_bueno=+0.118 (n=874)

- **FILTRO** `sigma_ewma_delta_pct` > `8.642` → IC=-0.204 (n=289)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.642
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=2359)
...
- **PATRÓN** `volumen_regimen` < `1.1044` → IC=+0.214 (n=218)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4885` → IC=+0.249 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4885 (IC base=-0.046)

### GBM_LATE_15M#XRP#15min
- **FILTRO** `drift_60min` |x|> `0.6599` → IC=-0.197 (n=440)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6599
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=1321)

- **FILTRO** `ibs_20min` < `0.79` → IC=-0.142 (n=1319)
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.201 (n=379)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=1382)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.201 (n=667)
...
- **PATRÓN** `dist_vwap_pct` < `0.2651` → IC=+0.247 (n=564)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2651 (IC base=-0.027)

- **PATRÓN** `volumen_regimen` > `1.0829` → IC=+0.294 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0829 (IC base=-0.027)

- **PATRÓN** `volumen_pendiente_norm` > `0.1062` → IC=+0.273 (n=192)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1062 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` < `2.224` → IC=+0.263 (n=390)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.224 (IC base=-0.027)

- **PATRÓN** `volumen_spike_ratio` > `1.4752` → IC=+0.244 (n=443)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4752 (IC base=-0.027)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.249 (n=449)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 35.0 (IC base=-0.027)

### GBM_LATE_15M_ESPACIO_ATR
- **PATRÓN** `sigma_h` > `0.0092` → IC=+0.174 (n=2628)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0092 (IC base=+0.086)

- **PATRÓN** `ibs_20min` > `0.9801` → IC=+0.288 (n=2622)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9801 (IC base=+0.086)

- **PATRÓN** `dist_vwap_pct` > `1.0156` → IC=+0.286 (n=550)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0156 (IC base=+0.086)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.519` → IC=+0.143 (n=3717)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 3.519 (IC base=+0.086)

- **PATRÓN** `volumen_regimen` > `0.6736` → IC=+0.236 (n=2391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6736 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` < `0.1131` → IC=+0.226 (n=4057)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1131 (IC base=+0.086)

- **PATRÓN** `volumen_pendiente_norm` > `0.2476` → IC=+0.256 (n=841)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2476 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` < `1.4768` → IC=+0.244 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4768 (IC base=+0.086)

- **PATRÓN** `volumen_spike_ratio` > `2.7675` → IC=+0.235 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7675 (IC base=+0.086)

- **PATRÓN** `ballena_activa_n` < `102.0` → IC=+0.277 (n=3743)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 102.0 (IC base=+0.086)

- **PATRÓN** `sigma_h` > `0.0085` → IC=+0.139 (n=2666)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` > 0.0085 (IC base=+0.068)

- **PATRÓN** `ibs_20min` < `0.5556` → IC=+0.150 (n=7033)

  - _Acción_: Kelly boost +0.75€ cuando `ibs_20min` < 0.5556 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` > `0.686` → IC=+0.241 (n=392)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.686 (IC base=+0.068)

- **PATRÓN** `dist_vwap_pct` < `0.231` → IC=+0.231 (n=2135)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.231 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.231 (n=967)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7129 (IC base=+0.068)

- **PATRÓN** `volumen_regimen` > `1.2011` → IC=+0.250 (n=733)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2011 (IC base=+0.068)

- **PATRÓN** `volumen_pendiente_norm` > `0.2516` → IC=+0.321 (n=584)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2516 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` < `1.4927` → IC=+0.254 (n=954)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4927 (IC base=+0.068)

- **PATRÓN** `volumen_spike_ratio` > `2.37` → IC=+0.255 (n=1298)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.37 (IC base=+0.068)

- **PATRÓN** `ballena_activa_n` < `78.0` → IC=+0.256 (n=2723)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 78.0 (IC base=+0.068)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `ibs_20min` < `0.2308` → IC=-0.140 (n=540)

  - _Acción_: SKIP cuando `ibs_20min` < 0.2308
  - _Potencial_: sin este filtro IC_bueno=+0.095 (n=1623)

- **FILTRO** `sigma_ewma_delta_pct` > `4.413` → IC=-0.166 (n=393)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.413
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1321)

- **PATRÓN** `ibs_20min` > `0.8622` → IC=+0.248 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8622 (IC base=+0.036)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.293` → IC=+0.148 (n=729)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` > 3.293 (IC base=+0.036)

- **PATRÓN** `volumen_pendiente_norm` > `0.2262` → IC=+0.289 (n=112)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2262 (IC base=+0.036)

- **PATRÓN** `volumen_spike_ratio` < `1.4419` → IC=+0.203 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4419 (IC base=+0.036)

- **PATRÓN** `volumen_spike_ratio` > `2.6489` → IC=+0.192 (n=183)
...
- **FILTRO** `ibs_20min` > `0.8266` → IC=-0.149 (n=588)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8266
  - _Potencial_: sin este filtro IC_bueno=+0.050 (n=1768)

- **PATRÓN** `dist_vwap_pct` > `0.2998` → IC=+0.136 (n=256)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` > 0.2998 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` < `0.1641` → IC=+0.130 (n=592)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.1641 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` < `1.0507` → IC=+0.130 (n=608)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_regimen` < 1.0507 (IC base=+0.011)

- **PATRÓN** `volumen_regimen` > `0.6495` → IC=+0.139 (n=616)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.6495 (IC base=+0.011)

- **PATRÓN** `volumen_pendiente_norm` > `0.2196` → IC=+0.175 (n=124)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_pendiente_norm` > 0.2196 (IC base=+0.011)

- **PATRÓN** `volumen_spike_ratio` < `1.4208` → IC=+0.177 (n=224)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4208 (IC base=+0.011)

- **PATRÓN** `ballena_activa_n` < `230.0` → IC=+0.186 (n=221)

  - _Acción_: Kelly boost +0.93€ cuando `ballena_activa_n` < 230.0 (IC base=+0.011)

- **PATRÓN** `dist_vwap_pct` < `0.1592` → IC=+0.207 (n=428)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.1592 (IC base=+0.000)

- **PATRÓN** `volumen_regimen` > `0.68` → IC=+0.202 (n=364)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.68 (IC base=+0.000)

- **PATRÓN** `volumen_pendiente_norm` > `0.284` → IC=+0.311 (n=51)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.284 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` < `1.808` → IC=+0.209 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.808 (IC base=+0.000)

- **PATRÓN** `volumen_spike_ratio` > `2.1626` → IC=+0.219 (n=165)
...
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.292 (n=641)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1109` → IC=+0.254 (n=1050)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1109 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` < `1.8779` → IC=+0.239 (n=512)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8779 (IC base=+0.237)

- **PATRÓN** `volumen_spike_ratio` > `3.6325` → IC=+0.251 (n=388)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.6325 (IC base=+0.237)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.254 (n=1419)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.237)

- **PATRÓN** `sigma_h` > `0.0055` → IC=+0.296 (n=997)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0055 (IC base=+0.278)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.317 (n=342)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.278)

- **PATRÓN** `ibs_20min` < `0.3321` → IC=+0.285 (n=997)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3321 (IC base=+0.278)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.774` → IC=+0.295 (n=383)
...
- **PATRÓN** `volumen_spike_ratio` > `2.237` → IC=+0.280 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.237 (IC base=+0.278)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.285 (n=533)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.278)

- **PATRÓN** `libro_liquidez` > `1876.5391` → IC=+0.303 (n=333)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1876.5391 (IC base=+0.278)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.272 (n=384)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 21.0 (IC base=+0.278)

### GBM_LATE_15M_ESPACIO_ATR#ETH#15min
- **FILTRO** `ibs_20min` < `0.245` → IC=-0.210 (n=360)

  - _Acción_: SKIP cuando `ibs_20min` < 0.245
  - _Potencial_: sin este filtro IC_bueno=+0.053 (n=1081)

- **FILTRO** `ibs_20min` > `0.8065` → IC=-0.184 (n=470)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8065
  - _Potencial_: sin este filtro IC_bueno=+0.037 (n=1414)

- **PATRÓN** `ibs_20min` > `0.8048` → IC=+0.146 (n=490)

  - _Acción_: Kelly boost +0.73€ cuando `ibs_20min` > 0.8048 (IC base=-0.013)

- **PATRÓN** `dist_vwap_pct` > `0.4602` → IC=+0.220 (n=130)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4602 (IC base=-0.013)

- **PATRÓN** `volumen_regimen` < `0.9592` → IC=+0.215 (n=296)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.9592 (IC base=-0.013)

- **PATRÓN** `volumen_regimen` > `0.5518` → IC=+0.192 (n=336)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 0.5518 (IC base=-0.013)

- **PATRÓN** `volumen_pendiente_norm` > `0.2672` → IC=+0.305 (n=39)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2672 (IC base=-0.013)

- **PATRÓN** `volumen_spike_ratio` < `2.0676` → IC=+0.244 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0676 (IC base=-0.013)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.243 (n=313)
...
- **PATRÓN** `dist_vwap_pct` < `0.2862` → IC=+0.173 (n=252)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.2862 (IC base=-0.018)

- **PATRÓN** `volumen_regimen` < `1.1494` → IC=+0.172 (n=242)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 1.1494 (IC base=-0.018)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.244 (n=205)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=-0.018)

### GBM_LATE_15M_ESPACIO_ATR#SOL#15min
- **FILTRO** `ibs_20min` < `0.6712` → IC=-0.208 (n=851)

  - _Acción_: SKIP cuando `ibs_20min` < 0.6712
  - _Potencial_: sin este filtro IC_bueno=+0.259 (n=851)

- **FILTRO** `ibs_20min` > `0.7111` → IC=-0.232 (n=450)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7111
  - _Potencial_: sin este filtro IC_bueno=+0.082 (n=1353)

- **FILTRO** `sigma_ewma_delta_pct` > `4.678` → IC=-0.175 (n=420)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.678
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=1383)

- **PATRÓN** `ibs_20min` > `0.6712` → IC=+0.259 (n=851)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6712 (IC base=+0.025)

- **PATRÓN** `dist_vwap_pct` > `0.7682` → IC=+0.338 (n=165)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7682 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` < `0.8605` → IC=+0.293 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8605 (IC base=+0.025)

- **PATRÓN** `volumen_regimen` > `0.717` → IC=+0.277 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.717 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.1055` → IC=+0.279 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1055 (IC base=+0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.2757` → IC=+0.328 (n=85)
...
- **PATRÓN** `ballena_activa_n` < `54.0` → IC=+0.320 (n=480)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 54.0 (IC base=+0.025)

- **PATRÓN** `ibs_20min` < `0.1071` → IC=+0.196 (n=452)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.1071 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` > `0.5893` → IC=+0.195 (n=80)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.5893 (IC base=+0.004)

- **PATRÓN** `dist_vwap_pct` < `0.3961` → IC=+0.191 (n=393)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` < 0.3961 (IC base=+0.004)

- **PATRÓN** `volumen_regimen` < `0.7129` → IC=+0.253 (n=168)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2178` → IC=+0.212 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2178 (IC base=+0.004)

- **PATRÓN** `volumen_spike_ratio` < `2.5839` → IC=+0.209 (n=349)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5839 (IC base=+0.004)

- **PATRÓN** `ballena_activa_n` < `55.0` → IC=+0.228 (n=347)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 55.0 (IC base=+0.004)

### GBM_LATE_15M_ESPACIO_ATR#XRP#15min
- **PATRÓN** `sigma_h` > `0.0155` → IC=+0.322 (n=706)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0155 (IC base=+0.271)

- **PATRÓN** `hora_utc` < `18.0` → IC=+0.277 (n=1111)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 18.0 (IC base=+0.271)

- **PATRÓN** `ibs_20min` > `0.9024` → IC=+0.346 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9024 (IC base=+0.271)

- **PATRÓN** `dist_vwap_pct` > `0.1867` → IC=+0.314 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1867 (IC base=+0.271)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.383` → IC=+0.299 (n=569)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.383 (IC base=+0.271)

- **PATRÓN** `volumen_regimen` > `0.6815` → IC=+0.287 (n=947)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6815 (IC base=+0.271)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2067` → IC=+0.277 (n=451)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2067 (IC base=+0.271)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.275 (n=1098)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.271)

- **PATRÓN** `libro_liquidez` > `2589.9202` → IC=+0.281 (n=706)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2589.9202 (IC base=+0.271)

- **PATRÓN** `sigma_h` > `0.0144` → IC=+0.295 (n=779)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0144 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.285 (n=585)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.269)

- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.306 (n=1168)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3939 (IC base=+0.269)

- **PATRÓN** `dist_vwap_pct` > `0.5491` → IC=+0.286 (n=316)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5491 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.441` → IC=+0.291 (n=420)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.441 (IC base=+0.269)

- **PATRÓN** `volumen_regimen` > `1.244` → IC=+0.309 (n=390)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.049` → IC=+0.307 (n=481)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5428` → IC=+0.179 (n=956)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` < 2.5428 (IC base=+0.186)

- **PATRÓN** `volumen_spike_ratio` > `1.427` → IC=+0.179 (n=956)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_spike_ratio` > 1.427 (IC base=+0.186)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.205 (n=986)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `5.095` → IC=+0.253 (n=820)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3638` → IC=+0.170 (n=905)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.85€ cuando `drift_60min` |x|≤ 0.3638 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.188 (n=816)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 8.0 (IC base=+0.162)

- **PATRÓN** `ibs_20min` > `0.4289` → IC=+0.222 (n=905)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4289 (IC base=+0.162)

- **PATRÓN** `dist_vwap_pct` > `0.2099` → IC=+0.210 (n=530)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2099 (IC base=+0.162)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.537` → IC=+0.224 (n=183)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.537 (IC base=+0.162)

- **PATRÓN** `volumen_regimen` < `1.2628` → IC=+0.174 (n=905)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4144` → IC=+0.200 (n=291)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4144 (IC base=+0.162)

- **PATRÓN** `libro_liquidez` > `10070.4177` → IC=+0.177 (n=905)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 10070.4177 (IC base=+0.162)

- **PATRÓN** `ballena_activa_n` < `403.0` → IC=+0.159 (n=728)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 403.0 (IC base=+0.162)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.167 (n=1029)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0057 (IC base=+0.147)

- **PATRÓN** `drift_60min` |x|≤ `0.059` → IC=+0.196 (n=343)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.98€ cuando `drift_60min` |x|≤ 0.059 (IC base=+0.147)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.163 (n=953)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 7.0 (IC base=+0.147)

- **PATRÓN** `ibs_20min` < `0.5312` → IC=+0.191 (n=1029)

  - _Acción_: Kelly boost +0.95€ cuando `ibs_20min` < 0.5312 (IC base=+0.147)

- **PATRÓN** `dist_vwap_pct` < `0.1347` → IC=+0.165 (n=1046)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` < 0.1347 (IC base=+0.147)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.043` → IC=+0.216 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.043 (IC base=+0.147)

- **PATRÓN** `volumen_regimen` < `1.2129` → IC=+0.161 (n=1029)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.2129 (IC base=+0.147)

- **PATRÓN** `volumen_pendiente_norm` > `0.1586` → IC=+0.178 (n=318)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_pendiente_norm` > 0.1586 (IC base=+0.147)

- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.158 (n=919)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.147)

- **PATRÓN** `ballena_activa_n` < `228.0` → IC=+0.161 (n=278)

  - _Acción_: Kelly boost +0.80€ cuando `ballena_activa_n` < 228.0 (IC base=+0.147)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.199 (n=1028)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.190)

- **PATRÓN** `drift_60min` |x|≤ `0.1967` → IC=+0.201 (n=684)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1967 (IC base=+0.190)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.222 (n=354)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.190)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.286 (n=541)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.190)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.63` → IC=+0.269 (n=314)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.63 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` < `0.2175` → IC=+0.187 (n=985)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` < 0.2175 (IC base=+0.190)

- **PATRÓN** `volumen_pendiente_norm` > `0.1357` → IC=+0.187 (n=394)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_pendiente_norm` > 0.1357 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` < `1.6708` → IC=+0.189 (n=320)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_spike_ratio` < 1.6708 (IC base=+0.190)

- **PATRÓN** `volumen_spike_ratio` > `2.3431` → IC=+0.197 (n=639)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.3431 (IC base=+0.190)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.204 (n=1162)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.190)

- **PATRÓN** `sigma_h` < `0.0077` → IC=+0.225 (n=576)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0077 (IC base=+0.223)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.223 (n=863)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `volumen_spike_ratio` < `1.8388` → IC=+0.215 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8388 (IC base=+0.223)

- **PATRÓN** `volumen_spike_ratio` > `3.5278` → IC=+0.249 (n=261)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.5278 (IC base=+0.223)

- **PATRÓN** `libro_liquidez` > `1887.358` → IC=+0.237 (n=287)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1887.358 (IC base=+0.223)

- **PATRÓN** `ballena_activa_n` < `19.0` → IC=+0.220 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 19.0 (IC base=+0.223)

### GBM_LATE_15M_MULTIHORIZONTE#ETH#15min
- **PATRÓN** `sigma_h` < `0.0066` → IC=+0.179 (n=857)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.0066 (IC base=+0.152)

- **PATRÓN** `drift_60min` |x|≤ `0.4217` → IC=+0.169 (n=973)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.4217 (IC base=+0.152)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.164 (n=979)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.82€ cuando `hora_utc` > 6.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` > `0.4076` → IC=+0.205 (n=973)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4076 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.1362` → IC=+0.193 (n=633)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.1362 (IC base=+0.152)
...
- **PATRÓN** `volumen_regimen` < `0.8575` → IC=+0.161 (n=649)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.8575 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` > `1.1917` → IC=+0.170 (n=325)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.1917 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1672` → IC=+0.158 (n=836)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1672 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `2.5103` → IC=+0.177 (n=317)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` > 2.5103 (IC base=+0.152)

- **PATRÓN** `libro_liquidez` > `7148.6032` → IC=+0.188 (n=649)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 7148.6032 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `120.0` → IC=+0.165 (n=613)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 120.0 (IC base=+0.152)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.165 (n=1057)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0072 (IC base=+0.131)

- **PATRÓN** `drift_60min` |x|≤ `0.3801` → IC=+0.147 (n=1057)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.3801 (IC base=+0.131)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.179 (n=416)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.131)

- **PATRÓN** `ibs_20min` < `0.6008` → IC=+0.181 (n=1057)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` < 0.6008 (IC base=+0.131)

- **PATRÓN** `dist_vwap_pct` < `0.15` → IC=+0.145 (n=1061)
...
- **PATRÓN** `volumen_regimen` < `0.856` → IC=+0.144 (n=705)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.856 (IC base=+0.131)

- **PATRÓN** `volumen_regimen` > `0.609` → IC=+0.133 (n=1057)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_regimen` > 0.609 (IC base=+0.131)

- **PATRÓN** `volumen_pendiente_norm` > `0.2884` → IC=+0.201 (n=152)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2884 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` < `1.7982` → IC=+0.140 (n=628)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 1.7982 (IC base=+0.131)

- **PATRÓN** `volumen_spike_ratio` > `2.4806` → IC=+0.142 (n=314)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.4806 (IC base=+0.131)

- **PATRÓN** `libro_liquidez` > `10015.5876` → IC=+0.160 (n=480)

  - _Acción_: Kelly boost +0.80€ cuando `libro_liquidez` > 10015.5876 (IC base=+0.131)

- **PATRÓN** `ballena_activa_n` < `177.0` → IC=+0.128 (n=872)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 177.0 (IC base=+0.131)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0078` → IC=+0.148 (n=766)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` > 0.0078 (IC base=+0.112)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.131 (n=1181)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.112)

- **PATRÓN** `ibs_20min` > `0.5` → IC=+0.196 (n=1162)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.5 (IC base=+0.112)

- **PATRÓN** `dist_vwap_pct` > `1.0166` → IC=+0.234 (n=242)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0166 (IC base=+0.112)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.465` → IC=+0.254 (n=258)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.465 (IC base=+0.112)

- **PATRÓN** `volumen_regimen` < `1.2203` → IC=+0.121 (n=1150)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2203 (IC base=+0.112)

- **PATRÓN** `volumen_spike_ratio` < `1.4424` → IC=+0.132 (n=368)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` < 1.4424 (IC base=+0.112)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.122 (n=1184)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.112)

- **PATRÓN** `libro_liquidez` > `2898.7698` → IC=+0.190 (n=521)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 2898.7698 (IC base=+0.112)

- **PATRÓN** `ballena_activa_n` < `48.0` → IC=+0.137 (n=838)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 48.0 (IC base=+0.112)

- **PATRÓN** `sigma_h` < `0.0059` → IC=+0.148 (n=512)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0059 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.169 (n=536)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.85€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.5492` → IC=+0.209 (n=1157)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5492 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.188` → IC=+0.136 (n=1071)

  - _Acción_: Kelly boost +0.68€ cuando `dist_vwap_pct` < 0.188 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.385` → IC=+0.163 (n=247)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 7.385 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.124 (n=1157)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_regimen` < 1.1954 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2785` → IC=+0.183 (n=140)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.2785 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.573` → IC=+0.136 (n=446)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 1.573 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` > `2.177` → IC=+0.131 (n=459)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 2.177 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `3081.0348` → IC=+0.162 (n=386)

  - _Acción_: Kelly boost +0.81€ cuando `libro_liquidez` > 3081.0348 (IC base=+0.113)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0182` → IC=+0.213 (n=727)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0182 (IC base=+0.202)

- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.212 (n=480)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1678 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.218 (n=395)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.202)
...
- **PATRÓN** `sigma_h` > `0.0165` → IC=+0.211 (n=778)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0165 (IC base=+0.205)

- **PATRÓN** `drift_60min` |x|≤ `0.0917` → IC=+0.211 (n=389)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0917 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.219 (n=578)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.0272` → IC=+0.310 (n=514)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0272 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `1.1734` → IC=+0.228 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.1734 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` < `0.2686` → IC=+0.205 (n=1218)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2686 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.355` → IC=+0.245 (n=222)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.355 (IC base=+0.205)

- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.218 (n=1167)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6282 (IC base=+0.205)

- **PATRÓN** `volumen_pendiente_norm` > `0.2821` → IC=+0.283 (n=159)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2821 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` < `2.2519` → IC=+0.198 (n=906)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 2.2519 (IC base=+0.205)

- **PATRÓN** `volumen_spike_ratio` > `1.4614` → IC=+0.195 (n=1029)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 1.4614 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `2540.6834` → IC=+0.214 (n=778)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2540.6834 (IC base=+0.205)

### GBM_LATE_15M_PYCONFIRMADO
- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.148 (n=504)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0038 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0088` → IC=+0.165 (n=502)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` > 0.0088 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0969` → IC=+0.151 (n=500)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0969 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.180 (n=757)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 15.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.388` → IC=+0.166 (n=1499)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.388 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.8295` → IC=+0.172 (n=205)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.8295 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.015` → IC=+0.172 (n=522)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 6.015 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8616` → IC=+0.154 (n=862)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 0.8616 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.1642` → IC=+0.167 (n=409)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1642 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.4313` → IC=+0.149 (n=479)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.4313 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.5666` → IC=+0.158 (n=478)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 2.5666 (IC base=+0.135)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.140 (n=1665)

  - _Acción_: Kelly boost +0.70€ cuando `libro_spread` < 0.02 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8471.0872` → IC=+0.150 (n=680)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 8471.0872 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `156.0` → IC=+0.158 (n=1278)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 156.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.135 (n=1063)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.67€ cuando `sigma_h` < 0.0057 (IC base=+0.115)

- **PATRÓN** `drift_60min` |x|≤ `0.3384` → IC=+0.128 (n=1403)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.64€ cuando `drift_60min` |x|≤ 0.3384 (IC base=+0.115)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=1618)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.115)

- **PATRÓN** `ibs_20min` < `0.4878` → IC=+0.156 (n=1403)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.4878 (IC base=+0.115)

- **PATRÓN** `dist_vwap_pct` < `0.2044` → IC=+0.122 (n=1419)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2044 (IC base=+0.115)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.996` → IC=+0.137 (n=469)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 5.996 (IC base=+0.115)

- **PATRÓN** `volumen_regimen` < `1.2224` → IC=+0.121 (n=1414)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` < 1.2224 (IC base=+0.115)

- **PATRÓN** `volumen_pendiente_norm` > `0.1666` → IC=+0.143 (n=407)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_pendiente_norm` > 0.1666 (IC base=+0.115)

- **PATRÓN** `volumen_spike_ratio` < `2.2286` → IC=+0.137 (n=1342)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` < 2.2286 (IC base=+0.115)

- **PATRÓN** `ballena_activa_n` < `25.0` → IC=+0.126 (n=634)

  - _Acción_: Kelly boost +0.63€ cuando `ballena_activa_n` < 25.0 (IC base=+0.115)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1077` → IC=+0.145 (n=150)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.72€ cuando `drift_60min` |x|≤ 0.1077 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.145 (n=311)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 10.0 (IC base=+0.096)

- **PATRÓN** `ibs_20min` > `0.8688` → IC=+0.188 (n=155)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` > 0.8688 (IC base=+0.096)

- **PATRÓN** `dist_vwap_pct` > `0.5286` → IC=+0.139 (n=70)

  - _Acción_: Kelly boost +0.69€ cuando `dist_vwap_pct` > 0.5286 (IC base=+0.096)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.256` → IC=+0.150 (n=158)

  - _Acción_: Kelly boost +0.75€ cuando `sigma_ewma_delta_pct` > 3.256 (IC base=+0.096)

- **PATRÓN** `volumen_regimen` < `0.6919` → IC=+0.151 (n=150)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.6919 (IC base=+0.096)
...
- **PATRÓN** `libro_liquidez` > `9834.2432` → IC=+0.126 (n=340)

  - _Acción_: Kelly boost +0.63€ cuando `libro_liquidez` > 9834.2432 (IC base=+0.096)

- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.154 (n=105)

  - _Acción_: Kelly boost +0.77€ cuando `ballena_activa_n` < 151.0 (IC base=+0.096)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3402` → IC=+0.148 (n=490)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.3402 (IC base=+0.127)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.146 (n=442)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 7.0 (IC base=+0.127)

- **PATRÓN** `ibs_20min` < `0.3422` → IC=+0.202 (n=327)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3422 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.384` → IC=+0.137 (n=199)

  - _Acción_: Kelly boost +0.68€ cuando `sigma_ewma_delta_pct` > 4.384 (IC base=+0.127)

- **PATRÓN** `sigma_ewma_delta_pct` < `9.142` → IC=+0.128 (n=554)
...
- **PATRÓN** `volumen_regimen` > `1.0616` → IC=+0.170 (n=222)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` > 1.0616 (IC base=+0.127)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4085` → IC=+0.149 (n=480)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 2.4085 (IC base=+0.127)

- **PATRÓN** `ballena_activa_n` < `159.0` → IC=+0.152 (n=156)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 159.0 (IC base=+0.127)

### GBM_LATE_15M_PYCONFIRMADO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.256 (n=199)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.242 (n=223)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `0.2554` → IC=+0.225 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.2554 (IC base=+0.189)

- **PATRÓN** `dist_vwap_pct` > `0.1389` → IC=+0.217 (n=231)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1389 (IC base=+0.189)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.085` → IC=+0.228 (n=145)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.085 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` < `0.8275` → IC=+0.201 (n=302)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8275 (IC base=+0.189)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3827` → IC=+0.255 (n=149)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.129 (n=408)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `ibs_20min` < `0.0523` → IC=+0.188 (n=136)

  - _Acción_: Kelly boost +0.94€ cuando `ibs_20min` < 0.0523 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.5939` → IC=+0.127 (n=65)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.5939 (IC base=+0.107)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8232` → IC=+0.135 (n=258)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 1.8232 (IC base=+0.107)

### GBM_LATE_15M_PYCONFIRMADO#SOL#15min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.177 (n=156)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 15.0 (IC base=+0.087)

- **PATRÓN** `ibs_20min` > `0.8947` → IC=+0.203 (n=217)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8947 (IC base=+0.087)

- **PATRÓN** `dist_vwap_pct` > `0.7807` → IC=+0.167 (n=43)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.7807 (IC base=+0.087)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.328` → IC=+0.171 (n=147)

  - _Acción_: Kelly boost +0.86€ cuando `sigma_ewma_delta_pct` > 5.328 (IC base=+0.087)

- **PATRÓN** `libro_liquidez` > `3054.897` → IC=+0.191 (n=108)

  - _Acción_: Kelly boost +0.95€ cuando `libro_liquidez` > 3054.897 (IC base=+0.087)

- **PATRÓN** `ballena_activa_n` < `21.0` → IC=+0.136 (n=105)

  - _Acción_: Kelly boost +0.68€ cuando `ballena_activa_n` < 21.0 (IC base=+0.087)

- **PATRÓN** `ibs_20min` < `0.4783` → IC=+0.153 (n=318)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.4783 (IC base=+0.088)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.199` → IC=+0.131 (n=109)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` > 5.199 (IC base=+0.088)

- **PATRÓN** `volumen_regimen` < `0.7121` → IC=+0.148 (n=140)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` < 0.7121 (IC base=+0.088)

- **PATRÓN** `volumen_pendiente_norm` < `0.1025` → IC=+0.122 (n=297)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_pendiente_norm` < 0.1025 (IC base=+0.088)

- **PATRÓN** `volumen_spike_ratio` < `2.5615` → IC=+0.139 (n=294)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 2.5615 (IC base=+0.088)

- **PATRÓN** `libro_liquidez` > `2922.5748` → IC=+0.137 (n=144)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 2922.5748 (IC base=+0.088)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.195 (n=3555)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0087 (IC base=+0.165)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.175 (n=8216)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 5.0 (IC base=+0.165)

- **PATRÓN** `ibs_20min` > `0.4725` → IC=+0.214 (n=7841)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.4725 (IC base=+0.165)

- **PATRÓN** `dist_vwap_pct` > `0.9038` → IC=+0.201 (n=1009)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9038 (IC base=+0.165)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.777` → IC=+0.230 (n=2936)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.777 (IC base=+0.165)

- **PATRÓN** `volumen_regimen` < `0.8818` → IC=+0.167 (n=3515)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_regimen` < 0.8818 (IC base=+0.165)

- **PATRÓN** `volumen_pendiente_norm` > `0.2398` → IC=+0.189 (n=1482)

  - _Acción_: Kelly boost +0.95€ cuando `volumen_pendiente_norm` > 0.2398 (IC base=+0.165)

- **PATRÓN** `volumen_spike_ratio` > `2.6355` → IC=+0.183 (n=2491)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` > 2.6355 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `3803.692` → IC=+0.169 (n=2614)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 3803.692 (IC base=+0.165)

- **PATRÓN** `ballena_activa_n` < `93.0` → IC=+0.194 (n=5697)

  - _Acción_: Kelly boost +0.97€ cuando `ballena_activa_n` < 93.0 (IC base=+0.165)

- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.196 (n=4816)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0067 (IC base=+0.181)

- **PATRÓN** `drift_60min` |x|≤ `0.48` → IC=+0.183 (n=7219)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.92€ cuando `drift_60min` |x|≤ 0.48 (IC base=+0.181)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.203 (n=2774)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 17.0 (IC base=+0.181)

- **PATRÓN** `ibs_20min` < `0.5593` → IC=+0.239 (n=7220)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5593 (IC base=+0.181)

- **PATRÓN** `dist_vwap_pct` < `0.2337` → IC=+0.162 (n=4595)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.2337 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.852` → IC=+0.197 (n=1039)

  - _Acción_: Kelly boost +0.99€ cuando `sigma_ewma_delta_pct` > 9.852 (IC base=+0.181)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.699` → IC=+0.183 (n=6976)

  - _Acción_: Kelly boost +0.91€ cuando `sigma_ewma_delta_pct` < 3.699 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` < `0.7031` → IC=+0.158 (n=2200)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.7031 (IC base=+0.181)

- **PATRÓN** `volumen_regimen` > `1.2043` → IC=+0.159 (n=1664)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 1.2043 (IC base=+0.181)

- **PATRÓN** `volumen_pendiente_norm` > `0.2899` → IC=+0.249 (n=942)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2899 (IC base=+0.181)

- **PATRÓN** `volumen_spike_ratio` > `2.3006` → IC=+0.189 (n=2940)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` > 2.3006 (IC base=+0.181)

- **PATRÓN** `ballena_activa_n` < `124.0` → IC=+0.179 (n=6093)
...
- **PATRÓN** `sigma_h` > `0.0072` → IC=+0.231 (n=600)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0072 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=646)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.887` → IC=+0.312 (n=600)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.358` → IC=+0.153 (n=1109)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` < 4.358 (IC base=+0.149)

- **PATRÓN** `volumen_regimen` < `0.6938` → IC=+0.185 (n=550)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_regimen` < 0.6938 (IC base=+0.149)
...
- **PATRÓN** `volumen_spike_ratio` < `2.3936` → IC=+0.157 (n=1192)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.3936 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.7514` → IC=+0.155 (n=795)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.7514 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `10851.6928` → IC=+0.166 (n=1113)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 10851.6928 (IC base=+0.149)

- **PATRÓN** `ballena_activa_n` < `491.0` → IC=+0.161 (n=1122)

  - _Acción_: Kelly boost +0.81€ cuando `ballena_activa_n` < 491.0 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.169 (n=1115)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.84€ cuando `sigma_h` < 0.0058 (IC base=+0.153)

- **PATRÓN** `drift_60min` |x|≤ `0.2605` → IC=+0.166 (n=981)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.83€ cuando `drift_60min` |x|≤ 0.2605 (IC base=+0.153)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.171 (n=509)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 16.0 (IC base=+0.153)

- **PATRÓN** `ibs_20min` < `0.6377` → IC=+0.204 (n=1115)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6377 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` > `0.699` → IC=+0.161 (n=169)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` > 0.699 (IC base=+0.153)

- **PATRÓN** `dist_vwap_pct` < `0.1309` → IC=+0.164 (n=1030)

  - _Acción_: Kelly boost +0.82€ cuando `dist_vwap_pct` < 0.1309 (IC base=+0.153)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.22` → IC=+0.164 (n=555)

  - _Acción_: Kelly boost +0.82€ cuando `sigma_ewma_delta_pct` > 3.22 (IC base=+0.153)

- **PATRÓN** `volumen_regimen` < `1.1954` → IC=+0.161 (n=1115)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 1.1954 (IC base=+0.153)

- **PATRÓN** `volumen_pendiente_norm` > `0.1509` → IC=+0.208 (n=306)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1509 (IC base=+0.153)

- **PATRÓN** `volumen_spike_ratio` < `2.4071` → IC=+0.166 (n=1018)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4071 (IC base=+0.153)

- **PATRÓN** `ballena_activa_n` < `370.0` → IC=+0.165 (n=613)

  - _Acción_: Kelly boost +0.83€ cuando `ballena_activa_n` < 370.0 (IC base=+0.153)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.226 (n=1247)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0059 (IC base=+0.211)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.213 (n=1246)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.211)
...
- **PATRÓN** `ibs_20min` > `0.6739` → IC=+0.250 (n=1113)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6739 (IC base=+0.211)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.59` → IC=+0.297 (n=368)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.59 (IC base=+0.211)

- **PATRÓN** `volumen_pendiente_norm` < `0.2176` → IC=+0.216 (n=1206)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2176 (IC base=+0.211)

- **PATRÓN** `volumen_spike_ratio` > `2.9933` → IC=+0.232 (n=531)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.9933 (IC base=+0.211)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.225 (n=1426)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.211)

- **PATRÓN** `sigma_h` < `0.0104` → IC=+0.235 (n=1196)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0104 (IC base=+0.232)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.234 (n=543)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` < `0.3642` → IC=+0.266 (n=1051)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3642 (IC base=+0.232)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.718` → IC=+0.273 (n=425)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.718 (IC base=+0.232)

- **PATRÓN** `volumen_pendiente_norm` > `0.3603` → IC=+0.294 (n=178)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3603 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` < `1.7962` → IC=+0.225 (n=471)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7962 (IC base=+0.232)

- **PATRÓN** `volumen_spike_ratio` > `2.2501` → IC=+0.232 (n=713)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2501 (IC base=+0.232)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.243 (n=651)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.232)

- **PATRÓN** `libro_liquidez` > `1891.307` → IC=+0.235 (n=398)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1891.307 (IC base=+0.232)

- **PATRÓN** `ballena_activa_n` < `15.0` → IC=+0.256 (n=330)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 15.0 (IC base=+0.232)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.173 (n=585)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` < 0.0039 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.4312` → IC=+0.140 (n=1328)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.70€ cuando `drift_60min` |x|≤ 0.4312 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.147 (n=1395)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 5.0 (IC base=+0.135)

- **PATRÓN** `ibs_20min` > `0.7033` → IC=+0.232 (n=885)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7033 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.353` → IC=+0.178 (n=489)

  - _Acción_: Kelly boost +0.89€ cuando `dist_vwap_pct` > 0.353 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.258` → IC=+0.162 (n=563)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 4.258 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8789` → IC=+0.159 (n=886)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8789 (IC base=+0.135)

- **PATRÓN** `volumen_pendiente_norm` > `0.2748` → IC=+0.228 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2748 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` < `1.5052` → IC=+0.148 (n=563)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` < 1.5052 (IC base=+0.135)

- **PATRÓN** `volumen_spike_ratio` > `2.4628` → IC=+0.157 (n=426)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.4628 (IC base=+0.135)

- **PATRÓN** `libro_liquidez` > `8841.0428` → IC=+0.229 (n=602)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 8841.0428 (IC base=+0.135)

- **PATRÓN** `ballena_activa_n` < `87.0` → IC=+0.168 (n=405)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 87.0 (IC base=+0.135)

- **PATRÓN** `sigma_h` < `0.0076` → IC=+0.158 (n=1077)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0076 (IC base=+0.139)

- **PATRÓN** `drift_60min` |x|≤ `0.4405` → IC=+0.158 (n=1077)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4405 (IC base=+0.139)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.172 (n=412)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.6883` → IC=+0.193 (n=1076)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6883 (IC base=+0.139)

- **PATRÓN** `dist_vwap_pct` < `0.2051` → IC=+0.144 (n=1012)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` < 0.2051 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.031` → IC=+0.199 (n=161)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 11.031 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.6938` → IC=+0.145 (n=474)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` < 0.6938 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `1.1877` → IC=+0.145 (n=359)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1877 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.2787` → IC=+0.269 (n=128)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2787 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `2.4663` → IC=+0.168 (n=335)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` > 2.4663 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `10953.5869` → IC=+0.198 (n=359)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 10953.5869 (IC base=+0.139)

- **PATRÓN** `ballena_activa_n` < `192.0` → IC=+0.145 (n=1000)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 192.0 (IC base=+0.139)

### GBM_LATE_15M_TARDIO#SOL#15min
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.168 (n=507)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 17.0 (IC base=+0.100)

- **PATRÓN** `ibs_20min` > `0.4687` → IC=+0.182 (n=1342)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` > 0.4687 (IC base=+0.100)

- **PATRÓN** `dist_vwap_pct` > `1.0059` → IC=+0.195 (n=231)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 1.0059 (IC base=+0.100)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.395` → IC=+0.220 (n=505)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.395 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.126 (n=934)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `2917.745` → IC=+0.244 (n=448)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2917.745 (IC base=+0.100)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.128 (n=1003)

  - _Acción_: Kelly boost +0.64€ cuando `ballena_activa_n` < 53.0 (IC base=+0.100)

- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.164 (n=576)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.0062 (IC base=+0.113)

- **PATRÓN** `drift_60min` |x|≤ `0.1259` → IC=+0.154 (n=435)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1259 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.147 (n=615)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.73€ cuando `hora_utc` > 15.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` < `0.6364` → IC=+0.208 (n=1308)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.6364 (IC base=+0.113)

- **PATRÓN** `dist_vwap_pct` < `0.4695` → IC=+0.129 (n=1288)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.4695 (IC base=+0.113)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.439` → IC=+0.126 (n=1256)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.439 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` < `0.72` → IC=+0.152 (n=575)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` < 0.72 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` > `0.2225` → IC=+0.168 (n=203)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.2225 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `1.4615` → IC=+0.149 (n=383)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_spike_ratio` < 1.4615 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2903.4398` → IC=+0.166 (n=435)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2903.4398 (IC base=+0.113)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0184` → IC=+0.211 (n=905)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0184 (IC base=+0.206)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=1419)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.206)

- **PATRÓN** `ibs_20min` > `0.5116` → IC=+0.244 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5116 (IC base=+0.206)

- **PATRÓN** `dist_vwap_pct` > `0.1869` → IC=+0.233 (n=765)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1869 (IC base=+0.206)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.35` → IC=+0.247 (n=658)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.35 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` < `1.2457` → IC=+0.209 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2457 (IC base=+0.206)

- **PATRÓN** `volumen_regimen` > `0.6266` → IC=+0.209 (n=1357)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6266 (IC base=+0.206)

- **PATRÓN** `volumen_pendiente_norm` > `0.0803` → IC=+0.230 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0803 (IC base=+0.206)

- **PATRÓN** `volumen_spike_ratio` > `2.5793` → IC=+0.238 (n=434)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5793 (IC base=+0.206)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.213 (n=1372)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.206)

- **PATRÓN** `libro_liquidez` > `2574.1546` → IC=+0.212 (n=905)
...
- **PATRÓN** `sigma_h` > `0.0255` → IC=+0.227 (n=500)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0255 (IC base=+0.201)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.215 (n=729)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` < `0.51` → IC=+0.254 (n=1502)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.51 (IC base=+0.201)

- **PATRÓN** `dist_vwap_pct` < `0.271` → IC=+0.206 (n=1397)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.271 (IC base=+0.201)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.738` → IC=+0.262 (n=216)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.738 (IC base=+0.201)

- **PATRÓN** `volumen_regimen` > `1.2323` → IC=+0.239 (n=500)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2323 (IC base=+0.201)

- **PATRÓN** `volumen_pendiente_norm` > `0.2863` → IC=+0.255 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2863 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` < `2.24` → IC=+0.194 (n=1161)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.24 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.4438` → IC=+0.198 (n=1319)
...
- **PATRÓN** `libro_liquidez` > `2548.3818` → IC=+0.202 (n=999)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2548.3818 (IC base=+0.201)

### GBM_LATE_5M
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.138 (n=2582)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4873` → IC=+0.154 (n=1948)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.4873 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.167 (n=737)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7054` → IC=+0.144 (n=346)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.7054 (IC base=+0.136)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.306` → IC=+0.144 (n=1931)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` < 6.306 (IC base=+0.136)

- **PATRÓN** `volumen_regimen` < `1.1137` → IC=+0.145 (n=1627)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5724` → IC=+0.140 (n=1929)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.5724 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.8251` → IC=+0.147 (n=1286)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.8251 (IC base=+0.136)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.138 (n=2582)

  - _Acción_: Kelly boost +0.69€ cuando `libro_spread` < 0.01 (IC base=+0.136)

- **PATRÓN** `libro_liquidez` > `7723.2634` → IC=+0.151 (n=1740)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 7723.2634 (IC base=+0.136)
...
- **PATRÓN** `ibs_20min` > `0.75` → IC=+0.153 (n=194)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` > 0.75 (IC base=+0.067)
...
- **FILTRO** `liq_imbalance_15min` |x|≤ `1.0` → IC=-0.121 (n=85)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=1339)
...
### MOMENTUM_IBS_15M
- **FILTRO** `py_entrada` < `0.5` → IC=-0.123 (n=1055)

  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=5515)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.000 (n=6429)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1376)

### MOMENTUM_IBS_15M_BALLENA
- **FILTRO** `py_entrada` < `0.47` → IC=-0.180 (n=2703)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=8208)

- **FILTRO** `py_entrada` > `0.6` → IC=-0.171 (n=2797)

  - _Acción_: SKIP cuando `py_entrada` > 0.6
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=8603)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.43` → IC=-0.221 (n=442)

  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.092 (n=1403)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.166 (n=471)
...
- **FILTRO** `py_entrada` < `0.43` → IC=-0.203 (n=462)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.43
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1430)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.216 (n=480)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=+0.061 (n=1528)

- **FILTRO** `ibs_20min` > `0.2857` → IC=-0.164 (n=498)

  - _Acción_: SKIP cuando `ibs_20min` > 0.2857
  - _Potencial_: sin este filtro IC_bueno=+0.047 (n=1510)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.202 (n=447)
...
- **FILTRO** `py_entrada` > `0.58` → IC=-0.193 (n=497)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.051 (n=1511)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=80)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2429)

- **FILTRO** `py_entrada` < `0.505` → IC=-0.239 (n=21)

  - _Acción_: SKIP cuando `py_entrada` < 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=2469)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=2475)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=631)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=7781)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=17847)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.283 (n=6012)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.039 (n=19616)

- **FILTRO** `ibs_7min` < `0.703` → IC=-0.242 (n=6405)

  - _Acción_: SKIP cuando `ibs_7min` < 0.703
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=19223)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.160 (n=8709)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=16919)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.224 (n=7994)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.001 (n=24113)

- **FILTRO** `ibs_7min` > `0.2963` → IC=-0.177 (n=8009)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2963
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=24098)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=974)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=3158)

- **FILTRO** `ibs_7min` < `0.7089` → IC=-0.257 (n=1363)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7089
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2769)

- **FILTRO** `ballena_activa_n` > `9.0` → IC=-0.196 (n=967)

  - _Acción_: SKIP cuando `ballena_activa_n` > 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3165)

- **FILTRO** `py_entrada` > `0.505` → IC=-0.149 (n=3736)

  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=+0.101 (n=1842)

- **FILTRO** `drift_7min_pct` |x|> `0.137` → IC=-0.133 (n=1392)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.137
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=4186)

- **FILTRO** `ibs_7min` > `0.8` → IC=-0.207 (n=1390)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=4188)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1024)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=3452)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.257 (n=1049)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=3427)

- **FILTRO** `ibs_7min` < `0.7558` → IC=-0.188 (n=1119)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7558
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=3357)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1117)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3359)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.255 (n=1070)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=3463)

- **FILTRO** `ibs_7min` > `0.2531` → IC=-0.169 (n=1133)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2531
  - _Potencial_: sin este filtro IC_bueno=-0.052 (n=3400)

- **FILTRO** `ballena_activa_n` > `152.0` → IC=-0.178 (n=1131)

  - _Acción_: SKIP cuando `ballena_activa_n` > 152.0
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=3402)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `7.0` → IC=-0.182 (n=937)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.094 (n=2927)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.320 (n=932)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=2932)

- **FILTRO** `drift_7min_pct` |x|> `0.1812` → IC=-0.132 (n=1313)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1812
  - _Potencial_: sin este filtro IC_bueno=-0.106 (n=2551)

- **FILTRO** `ibs_7min` < `0.2031` → IC=-0.275 (n=966)

  - _Acción_: SKIP cuando `ibs_7min` < 0.2031
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=2898)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.221 (n=909)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=2955)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.234 (n=1383)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.017 (n=4495)

- **FILTRO** `ibs_7min` > `0.2611` → IC=-0.154 (n=1998)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2611
  - _Potencial_: sin este filtro IC_bueno=+0.015 (n=3880)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1324)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=2893)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.252 (n=1029)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3188)

- **FILTRO** `ibs_7min` < `0.7437` → IC=-0.192 (n=1054)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7437
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=3163)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.183 (n=1041)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3176)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1065)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3250)

- **FILTRO** `ibs_7min` > `0.2739` → IC=-0.174 (n=1077)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2739
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=3238)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.182 (n=1066)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=3249)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.37` → IC=-0.255 (n=1102)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=3509)

- **FILTRO** `ibs_7min` < `0.7187` → IC=-0.221 (n=1149)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7187
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=3462)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.169 (n=1465)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=4617)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.35` → IC=-0.283 (n=1057)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=3271)

- **FILTRO** `ibs_7min` < `0.725` → IC=-0.233 (n=1082)

  - _Acción_: SKIP cuando `ibs_7min` < 0.725
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=3246)

- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.210 (n=1058)

  - _Acción_: SKIP cuando `ballena_activa_n` > 11.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=3270)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.207 (n=1355)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=4366)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.3987` → IC=+0.135 (n=639)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.021 (n=2370)
...
- **PATRÓN** `sigma_h` > `0.0096` → IC=+0.211 (n=368)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0096 (IC base=+0.175)

- **PATRÓN** `drift_60min` |x|≤ `0.0771` → IC=+0.178 (n=486)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.89€ cuando `drift_60min` |x|≤ 0.0771 (IC base=+0.175)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0585` → IC=+0.176 (n=1103)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.88€ cuando `delta_ratio_macro` |x|> 0.0585 (IC base=+0.175)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1354` → IC=+0.226 (n=345)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1354 (IC base=+0.175)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.179 (n=786)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.6207` → IC=+0.246 (n=1103)
...
- **PATRÓN** `libro_liquidez` > `2632.9944` → IC=+0.179 (n=985)

  - _Acción_: Kelly boost +0.89€ cuando `libro_liquidez` > 2632.9944 (IC base=+0.175)
...
- **PATRÓN** `ibs_15` < `0.1111` → IC=+0.178 (n=352)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **FILTRO** `sigma_h` > `0.0126` → IC=-0.203 (n=540)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1623)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.2103` → IC=+0.240 (n=387)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2103 (IC base=-0.044)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1819` → IC=+0.240 (n=740)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1819 (IC base=-0.044)

- **PATRÓN** `ibs_15` < `0.3557` → IC=+0.280 (n=1160)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3557 (IC base=-0.044)

- **PATRÓN** `dist_vwap_pct` > `0.6604` → IC=+0.273 (n=174)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6604 (IC base=-0.044)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.007` → IC=-0.206 (n=325)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.007
  - _Potencial_: sin este filtro IC_bueno=-0.195 (n=977)

- **FILTRO** `sigma_h` < `0.0037` → IC=-0.229 (n=429)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0037
  - _Potencial_: sin este filtro IC_bueno=-0.182 (n=873)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.209 (n=832)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=470)

- **FILTRO** `sigma_ewma_delta_pct` > `19.895` → IC=-0.242 (n=231)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 19.895
  - _Potencial_: sin este filtro IC_bueno=-0.188 (n=1071)
...
- **PATRÓN** `sigma_h` < `0.0074` → IC=+0.248 (n=490)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0074 (IC base=+0.225)

- **PATRÓN** `drift_60min` |x|≤ `0.3574` → IC=+0.230 (n=431)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3574 (IC base=+0.225)

- **PATRÓN** `drift_15min` |x|≤ `0.7706` → IC=+0.230 (n=431)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7706 (IC base=+0.225)

- **PATRÓN** `delta_ratio_macro` |x|> `0.2028` → IC=+0.259 (n=222)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.2028 (IC base=+0.225)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.224 (n=230)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` < `0.3657` → IC=+0.268 (n=490)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3657 (IC base=+0.225)

- **PATRÓN** `dist_vwap_pct` > `0.3809` → IC=+0.248 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3809 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.294` → IC=+0.231 (n=184)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.294 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.229 (n=522)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3591.8273` → IC=+0.227 (n=489)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 3591.8273 (IC base=+0.225)

- **PATRÓN** `ballena_activa_n` < `138.0` → IC=+0.224 (n=408)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 138.0 (IC base=+0.225)
...
- **PATRÓN** `delta_ratio_macro` |x|> `0.0717` → IC=+0.212 (n=210)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.0717 (IC base=-0.042)

- **PATRÓN** `ibs_15` < `0.3667` → IC=+0.248 (n=236)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `ibs_15` < `0.3333` → IC=+0.307 (n=340)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6207 sube el IC de +0.175 a +0.246 en UPDOWN_GBM#15min (n=1103). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1111 sube el IC de +0.049 a +0.178 en UPDOWN_GBM#XRP#15min (n=352). Ya aplicado como kelly_boost=+0.89€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3557 sube el IC de -0.044 a +0.280 en UPDOWN_GBM_15M_TARDIO (n=1160). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.8098 sube el IC de +0.070 a +0.330 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=110). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3657 sube el IC de +0.225 a +0.268 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=490). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#SOL#15min**: dentro de BUY_NO, IBS < 0.3667 sube el IC de -0.042 a +0.248 en UPDOWN_GBM_15M_TARDIO#SOL#15min (n=236). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3333 sube el IC de -0.045 a +0.307 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=340). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 20885 | -0.100 | -3043.17€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1256 | -0.046 | -182.68€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 19629 | -0.104 | -2860.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 3210 | -0.113 | -559.19€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 3210 | -0.113 | -559.19€ | 1 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 5989 | -0.044 | -590.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 5989 | -0.044 | -590.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 5557 | -0.108 | -477.93€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 5557 | -0.108 | -477.93€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 4499 | -0.168 | -1071.66€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 4499 | -0.168 | -1071.66€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 12684 | -0.041 | +4227.20€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 3401 | -0.006 | +1847.74€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 9283 | -0.053 | +2379.46€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 12684 | -0.041 | +4227.20€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 3401 | -0.006 | +1847.74€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 9283 | -0.053 | +2379.46€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO | 1069 | -0.107 | -159.95€ | 3 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#15min | 73 | -0.087 | -14.55€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#5min | 996 | -0.108 | -145.40€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BNB#5min | 22 | -0.083 | +4.56€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC | 610 | -0.088 | -78.15€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#15min | 49 | -0.088 | -9.33€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#BTC#5min | 561 | -0.088 | -68.82€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH | 299 | -0.148 | -64.13€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#15min | 24 | -0.077 | -5.22€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#ETH#5min | 275 | -0.153 | -58.90€ | 2 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL | 99 | -0.074 | -17.53€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#SOL#5min | 99 | -0.074 | -17.53€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP | 39 | -0.159 | -4.70€ | 0 | 0 |
| ✅ CANDIDATA9_BOT_CONSENSO#XRP#5min | 39 | -0.159 | -4.70€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO | 75792 | +0.113 | -3901.76€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 11801 | +0.183 | -363.81€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 292 | -0.116 | -43.55€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 58490 | +0.100 | -3379.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 5209 | +0.115 | -115.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 9745 | +0.097 | -903.36€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 38 | -0.150 | -1.48€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 9692 | +0.098 | -890.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 15319 | +0.131 | -319.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 3619 | +0.201 | -119.78€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 9689 | +0.110 | -188.16€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1969 | +0.115 | +11.07€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 9784 | +0.089 | -954.54€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 45 | -0.053 | -1.73€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#DOGE#240min | 15 | -0.243 | -11.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 9724 | +0.090 | -941.62€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 16220 | +0.125 | -302.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 4556 | +0.172 | -74.54€ | 1 | 7 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 9779 | +0.108 | -173.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1873 | +0.100 | -45.85€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL | 14965 | +0.115 | -852.75€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 3505 | +0.186 | -176.99€ | 0 | 6 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 195 | -0.074 | +10.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 9898 | +0.091 | -605.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1367 | +0.137 | -80.45€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#XRP | 9759 | +0.103 | -569.76€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 38 | +0.000 | +10.71€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#240min | 13 | -0.022 | -0.19€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 9708 | +0.104 | -580.27€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 11978 | +0.189 | -820.78€ | 3 | 5 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#15min | 11978 | +0.189 | -820.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB | 2938 | +0.168 | -318.85€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BNB#15min | 2938 | +0.168 | -318.85€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC | 674 | +0.185 | +6.12€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#BTC#15min | 674 | +0.185 | +6.12€ | 4 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE | 2878 | +0.178 | -264.30€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#DOGE#15min | 2878 | +0.178 | -264.30€ | 0 | 3 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH | 2587 | +0.237 | -79.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION#ETH#15min | 