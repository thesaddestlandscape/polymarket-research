# Hipótesis automáticas — 2026-09-01 16:52 UTC
_Generado por shadow_postmortem.py sobre 241445 resoluciones (PNL=+20737.24€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.74` → IC=-0.295 (n=3347)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.74
  - _Potencial_: sin este filtro IC_bueno=-0.044 (n=10042)

### BALLENAS_TARDIAS#BNB#5min
- **FILTRO** `restante_s_al_confirmar` < `149.38` → IC=-0.251 (n=431)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 149.38
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1294)

### BALLENAS_TARDIAS#DOGE#5min
- **FILTRO** `restante_s_al_confirmar` < `109.52` → IC=-0.414 (n=429)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 109.52
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=1290)

### BALLENAS_TARDIAS#ETH#5min
- **FILTRO** `restante_s_al_confirmar` < `156.5` → IC=-0.160 (n=913)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 156.5
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2740)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `137.07` → IC=-0.325 (n=750)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 137.07
  - _Potencial_: sin este filtro IC_bueno=-0.051 (n=2250)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `154.32` → IC=-0.375 (n=788)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 154.32
  - _Potencial_: sin este filtro IC_bueno=-0.093 (n=1601)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.191 (n=7136)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` > 0.7 (IC base=+0.095)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.173 (n=1874)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.095)

- **PATRÓN** `libro_liquidez` > `7212.1092` → IC=+0.198 (n=812)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 7212.1092 (IC base=+0.095)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.202 (n=746)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.194)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.203 (n=826)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.195 (n=1059)

  - _Acción_: Kelly boost +0.97€ cuando `libro_spread` < 0.01 (IC base=+0.194)

- **PATRÓN** `libro_liquidez` > `12473.6532` → IC=+0.216 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12473.6532 (IC base=+0.194)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.285 (n=402)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `2193.6078` → IC=+0.280 (n=525)
...
- **PATRÓN** `lag_apertura_s` < `4.25` → IC=+0.158 (n=2073)
...
- **PATRÓN** `restante_min` > `4.88` → IC=+0.150 (n=1417)
...
- **PATRÓN** `lag_apertura_s` < `7.04` → IC=+0.152 (n=1360)

  - _Acción_: Kelly boost +0.76€ cuando `lag_apertura_s` < 7.04 (IC base=+0.136)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.205 (n=1108)
...
- **PATRÓN** `restante_min` > `4.94` → IC=+0.162 (n=1150)

  - _Acción_: Kelly boost +0.81€ cuando `restante_min` > 4.94 (IC base=+0.129)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.130 (n=3267)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `lag_apertura_s` < `3.39` → IC=+0.169 (n=1041)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3493` → IC=+0.122 (n=3154)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `5.425` → IC=+0.146 (n=1212)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1716` → IC=+0.167 (n=518)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.1716 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` < `2.4318` → IC=+0.168 (n=1608)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 2.4318 (IC base=+0.073)

- **PATRÓN** `volumen_spike_ratio` > `1.4772` → IC=+0.163 (n=1828)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_spike_ratio` > 1.4772 (IC base=+0.073)

- **PATRÓN** `ibs_20min` < `0.413` → IC=+0.121 (n=3113)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` < 0.413 (IC base=+0.035)

- **PATRÓN** `dist_vwap_pct` < `0.1336` → IC=+0.138 (n=979)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8839` → IC=+0.216 (n=494)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2657` → IC=+0.149 (n=701)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.2657 (IC base=+0.145)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.335` → IC=+0.294 (n=221)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 6.335 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.137 (n=606)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.188 (n=536)
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.147 (n=547)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.637` → IC=+0.168 (n=610)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` < 0.637 (IC base=+0.145)

- **PATRÓN** `dist_vwap_pct` < `0.1378` → IC=+0.165 (n=520)
...
- **PATRÓN** `volumen_regimen` < `0.618` → IC=+0.194 (n=204)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_regimen` < 0.618 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4168` → IC=+0.167 (n=502)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_spike_ratio` < 2.4168 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `1.3878` → IC=+0.159 (n=502)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` > 1.3878 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.145 (n=789)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12550.5978` → IC=+0.172 (n=406)

  - _Acción_: Kelly boost +0.86€ cuando `libro_liquidez` > 12550.5978 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `234.0` → IC=+0.165 (n=183)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 234.0 (IC base=+0.145)
...
- **PATRÓN** `ibs_20min` < `0.5082` → IC=+0.274 (n=516)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9824` → IC=+0.220 (n=173)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9824 (IC base=+0.240)
...
- **FILTRO** `hora_utc` < `17.0` → IC=-0.150 (n=38)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 17.0
  - _Potencial_: sin este filtro IC_bueno=+0.080 (n=117)

- **FILTRO** `ibs_20min` < `0.1818` → IC=-0.218 (n=37)
...
- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.167 (n=40)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.83€ cuando `sigma_h` < 0.0057 (IC base=+0.022)

- **PATRÓN** `ibs_20min` > `0.2727` → IC=+0.123 (n=104)

  - _Acción_: Kelly boost +0.61€ cuando `ibs_20min` > 0.2727 (IC base=+0.022)

- **PATRÓN** `dist_vwap_pct` < `0.6887` → IC=+0.250 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6887 (IC base=+0.022)
...
- **FILTRO** `sigma_h` > `0.0202` → IC=-0.133 (n=494)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.2709` → IC=+0.125 (n=3964)
...
- **PATRÓN** `ibs_20min` < `0.589` → IC=+0.124 (n=3899)
...
- **PATRÓN** `volumen_regimen` < `0.8592` → IC=+0.229 (n=641)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8592 (IC base=+0.047)

- **PATRÓN** `volumen_regimen` > `1.2272` → IC=+0.239 (n=320)
...
- **PATRÓN** `ballena_activa_n` < `62.0` → IC=+0.276 (n=868)
...
- **FILTRO** `ibs_20min` > `0.8755` → IC=-0.155 (n=343)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1033)
...
- **PATRÓN** `sigma_h` > `0.0073` → IC=+0.334 (n=281)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0073 (IC base=+0.313)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.344 (n=280)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 12.0 (IC base=+0.313)

- **PATRÓN** `ibs_20min` < `0.325` → IC=+0.330 (n=421)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.325 (IC base=+0.313)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.72` → IC=+0.317 (n=129)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 2.72 (IC base=+0.313)

- **PATRÓN** `sigma_ewma_delta_pct` < `5.446` → IC=+0.316 (n=477)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.286 (n=676)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.2755` → IC=+0.283 (n=681)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2881` → IC=+0.382 (n=83)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2881 (IC base=+0.279)

- **PATRÓN** `volumen_spike_ratio` > `2.1785` → IC=+0.297 (n=254)
...
- **PATRÓN** `sigma_h` < `0.0062` → IC=+0.197 (n=2084)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.99€ cuando `sigma_h` < 0.0062 (IC base=+0.179)

- **PATRÓN** `drift_60min` |x|≤ `0.0788` → IC=+0.212 (n=1041)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0788 (IC base=+0.179)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.198 (n=1477)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4186` → IC=+0.232 (n=3123)
...
- **PATRÓN** `volumen_regimen` < `1.1685` → IC=+0.170 (n=2386)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_regimen` < 1.1685 (IC base=+0.179)

- **PATRÓN** `volumen_pendiente_norm` > `0.2945` → IC=+0.260 (n=406)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2945 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` < `1.575` → IC=+0.172 (n=1100)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.575 (IC base=+0.179)

- **PATRÓN** `volumen_spike_ratio` > `2.6609` → IC=+0.195 (n=834)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.6609 (IC base=+0.179)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.177 (n=2083)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.301 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.247)

- **PATRÓN** `libro_liquidez` > `1697.4448` → IC=+0.275 (n=229)
...
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.175 (n=588)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.173 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 7.0 (IC base=+0.152)

- **PATRÓN** `ibs_20min` < `0.4506` → IC=+0.193 (n=588)

  - _Acción_: Kelly boost +0.97€ cuando `ibs_20min` < 0.4506 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` > `0.5824` → IC=+0.157 (n=100)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.5824 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4667` → IC=+0.168 (n=480)
...
- **PATRÓN** `libro_liquidez` > `15514.0842` → IC=+0.167 (n=196)
  ...
  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 15514.0842 (IC base=+0.152)
...
- **PATRÓN** `volumen_spike_ratio` > `3.139` → IC=+0.236 (n=146)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 3.139 (IC base=+0.233)
...
- **PATRÓN** `hora_utc` > `14.0` → IC=+0.182 (n=284)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.91€ cuando `hora_utc` > 14.0 (IC base=+0.134)

- **PATRÓN** `ibs_20min` < `0.4286` → IC=+0.237 (n=560)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4286 (IC base=+0.134)

- **PATRÓN** `dist_vwap_pct` > `0.4473` → IC=+0.140 (n=170)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` > 0.4473 (IC base=+0.134)
...
- **PATRÓN** `volumen_regimen` < `1.1603` → IC=+0.149 (n=560)

  - _Acción_: Kelly boost +0.75€ cuando `volumen_regimen` < 1.1603 (IC base=+0.134)

- **PATRÓN** `volumen_regimen` > `0.8432` → IC=+0.148 (n=373)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_regimen` > 0.8432 (IC base=+0.134)
...
- **PATRÓN** `libro_liquidez` > `1433.9335` → IC=+0.163 (n=500)

  - _Acción_: Kelly boost +0.82€ cuando `libro_liquidez` > 1433.9335 (IC base=+0.134)
...
- **PATRÓN** `ibs_20min` < `0.3044` → IC=+0.134 (n=460)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.3044 (IC base=+0.061)

- **PATRÓN** `ballena_activa_n` < `18.0` → IC=+0.168 (n=242)

  - _Acción_: Kelly boost +0.84€ cuando `ballena_activa_n` < 18.0 (IC base=+0.061)
...
- **PATRÓN** `ibs_20min` < `0.6399` → IC=+0.142 (n=199)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` < 0.6399 (IC base=+0.050)

- **PATRÓN** `volumen_pendiente_norm` > `0.0848` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_pendiente_norm` > 0.0848 (IC base=+0.050)

- **PATRÓN** `ballena_activa_n` < `274.0` → IC=+0.157 (n=129)

  - _Acción_: Kelly boost +0.78€ cuando `ballena_activa_n` < 274.0 (IC base=+0.050)
...
- **PATRÓN** `sigma_h` < `0.0067` → IC=+0.207 (n=2460)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0067 (IC base=+0.188)

- **PATRÓN** `drift_60min` |x|≤ `0.4706` → IC=+0.194 (n=3686)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.97€ cuando `drift_60min` |x|≤ 0.4706 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `7.0` → IC=+0.207 (n=1666)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 7.0 (IC base=+0.188)

- **PATRÓN** `ibs_20min` < `0.5597` → IC=+0.240 (n=3686)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5597 (IC base=+0.188)

- **PATRÓN** `dist_vwap_pct` < `0.2378` → IC=+0.174 (n=2327)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.2378 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.588` → IC=+0.219 (n=532)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.588 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.559` → IC=+0.189 (n=3615)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` < 3.559 (IC base=+0.188)

- **PATRÓN** `volumen_regimen` < `0.6213` → IC=+0.181 (n=885)
...
- **PATRÓN** `volumen_spike_ratio` > `2.3166` → IC=+0.201 (n=1351)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3166 (IC base=+0.188)

- **PATRÓN** `ballena_activa_n` < `53.0` → IC=+0.179 (n=1708)
...
- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.277 (n=473)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0072 (IC base=+0.272)

- **PATRÓN** `sigma_h` > `0.0046` → IC=+0.276 (n=472)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.276 (n=430)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.272)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.281 (n=481)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.272)

- **PATRÓN** `ibs_20min` < `0.4058` → IC=+0.306 (n=416)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4903` → IC=+0.287 (n=369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4903 (IC base=+0.272)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.288 (n=220)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.272)

- **PATRÓN** `libro_liquidez` > `1903.8` → IC=+0.275 (n=158)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1903.8 (IC base=+0.272)

- **PATRÓN** `ballena_activa_n` < `76.0` → IC=+0.262 (n=309)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 76.0 (IC base=+0.272)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4315` → IC=+0.187 (n=506)

  - _Acción_: Kelly boost +0.94€ cuando `volumen_spike_ratio` < 2.4315 (IC base=+0.165)

- **PATRÓN** `libro_liquidez` > `11545.7195` → IC=+0.168 (n=401)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 11545.7195 (IC base=+0.165)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.238 (n=388)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4203` → IC=+0.302 (n=494)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7297` → IC=+0.258 (n=147)
...
- **PATRÓN** `ballena_activa_n` < `60.0` → IC=+0.211 (n=354)
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.138 (n=313)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 15.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.6` → IC=+0.193 (n=655)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` < 0.6 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.5202` → IC=+0.127 (n=620)

  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.5202 (IC base=+0.109)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.186` → IC=+0.127 (n=641)

  - _Acción_: Kelly boost +0.63€ cuando `sigma_ewma_delta_pct` < 3.186 (IC base=+0.109)

- **PATRÓN** `volumen_regimen` < `1.1975` → IC=+0.121 (n=655)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5516` → IC=+0.128 (n=224)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 1.5516 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` > `1.7854` → IC=+0.131 (n=337)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.7854 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `1306.7984` → IC=+0.141 (n=585)

  - _Acción_: Kelly boost +0.70€ cuando `libro_liquidez` > 1306.7984 (IC base=+0.109)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4625` → IC=+0.211 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4625 (IC base=+0.217)

- **PATRÓN** `ballena_activa_n` < `35.0` → IC=+0.196 (n=573)
...
- **PATRÓN** `sigma_h` < `0.0128` → IC=+0.128 (n=1179)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.64€ cuando `sigma_h` < 0.0128 (IC base=+0.120)
...
- **PATRÓN** `ibs_20min` > `0.2696` → IC=+0.143 (n=1179)

  - _Acción_: Kelly boost +0.71€ cuando `ibs_20min` > 0.2696 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.506` → IC=+0.161 (n=178)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 10.506 (IC base=+0.120)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.037` → IC=+0.124 (n=1212)

  - _Acción_: Kelly boost +0.62€ cuando `sigma_ewma_delta_pct` < 6.037 (IC base=+0.120)

- **PATRÓN** `volumen_regimen` > `0.8864` → IC=+0.122 (n=564)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.8864 (IC base=+0.120)

- **PATRÓN** `volumen_pendiente_norm` > `0.1719` → IC=+0.156 (n=324)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_pendiente_norm` > 0.1719 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` < `1.449` → IC=+0.168 (n=389)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.449 (IC base=+0.120)

- **PATRÓN** `volumen_spike_ratio` > `2.6552` → IC=+0.147 (n=389)
...
- **PATRÓN** `sigma_h` > `0.0047` → IC=+0.128 (n=436)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.7919` → IC=+0.160 (n=198)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `ibs_20min` > 0.7919 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` > `0.9122` → IC=+0.155 (n=114)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.9122 (IC base=+0.126)

- **PATRÓN** `dist_vwap_pct` < `0.2349` → IC=+0.129 (n=354)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.2349 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.348` → IC=+0.158 (n=71)

  - _Acción_: Kelly boost +0.79€ cuando `sigma_ewma_delta_pct` > 11.348 (IC base=+0.126)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.130 (n=439)

  - _Acción_: Kelly boost +0.65€ cuando `sigma_ewma_delta_pct` < 7.07 (IC base=+0.126)

- **PATRÓN** `volumen_regimen` < `0.6576` → IC=+0.142 (n=146)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 0.6576 (IC base=+0.126)

- **PATRÓN** `volumen_pendiente_norm` > `0.1741` → IC=+0.159 (n=136)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_pendiente_norm` > 0.1741 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` < `1.4147` → IC=+0.176 (n=143)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.4147 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `2.5484` → IC=+0.141 (n=143)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_spike_ratio` > 2.5484 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `8873.6006` → IC=+0.135 (n=390)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 8873.6006 (IC base=+0.126)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.181 (n=1243)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.198 (n=1207)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.003 (n=4009)

- **FILTRO** `ibs_20min` > `0.2701` → IC=-0.155 (n=1302)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.144 (n=3603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=8758)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.283 (n=3036)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=9325)

- **FILTRO** `ibs_7min` < `0.7139` → IC=-0.245 (n=3090)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7139
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=9271)

- **FILTRO** `ballena_activa_n` > `19.0` → IC=-0.171 (n=4116)

  - _Acción_: SKIP cuando `ballena_activa_n` > 19.0
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=8245)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.224 (n=3622)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=11929)

- **FILTRO** `ibs_7min` > `0.73` → IC=-0.170 (n=3887)

  - _Acción_: SKIP cuando `ibs_7min` > 0.73
  - _Potencial_: sin este filtro IC_bueno=-0.030 (n=11664)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.167 (n=533)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.107 (n=1231)

- **FILTRO** `py_entrada` < `0.3` → IC=-0.325 (n=432)

  - _Acción_: SKIP cuando `py_entrada` < 0.3
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=1332)

- **FILTRO** `ibs_7min` < `0.2846` → IC=-0.271 (n=582)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.239 (n=427)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.088 (n=1337)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.227 (n=669)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=2048)

- **FILTRO** `drift_7min_pct` |x|> `0.1159` → IC=-0.132 (n=923)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1159
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1794)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.145 (n=513)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.063 (n=1828)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=545)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=1796)

- **FILTRO** `ibs_7min` < `0.7751` → IC=-0.185 (n=585)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7751
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=1756)

- **FILTRO** `ballena_activa_n` > `163.0` → IC=-0.190 (n=585)

  - _Acción_: SKIP cuando `ballena_activa_n` > 163.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1756)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.223 (n=579)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.192 (n=455)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.102 (n=1374)
...
- **FILTRO** `py_entrada` < `0.35` → IC=-0.259 (n=513)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1597)

- **FILTRO** `ibs_7min` < `0.7527` → IC=-0.193 (n=526)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7527
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=1584)

- **FILTRO** `ballena_activa_n` > `27.0` → IC=-0.183 (n=701)

  - _Acción_: SKIP cuando `ballena_activa_n` > 27.0
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=1409)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.235 (n=701)

  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=1421)

- **FILTRO** `ibs_7min` > `0.2771` → IC=-0.186 (n=530)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2771
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1592)

- **FILTRO** `ballena_activa_n` > `34.0` → IC=-0.188 (n=523)

  - _Acción_: SKIP cuando `ballena_activa_n` > 34.0
  - _Potencial_: sin este filtro IC_bueno=-0.064 (n=1599)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.39` → IC=-0.240 (n=548)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.011 (n=1761)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.208 (n=570)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.019 (n=1739)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.188 (n=574)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.189 (n=693)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.63
  - _Potencial_: sin este filtro IC_bueno=-0.003 (n=2197)
...
- **FILTRO** `py_entrada` < `0.36` → IC=-0.296 (n=497)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1511)

- **FILTRO** `ibs_7min` < `0.7321` → IC=-0.246 (n=502)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7321
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1506)
...
- **FILTRO** `libro_liquidez` < `2663.0184` → IC=-0.139 (n=1325)
...
- **FILTRO** `ibs_7min` > `0.7937` → IC=-0.162 (n=675)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7937
  - _Potencial_: sin este filtro IC_bueno=-0.027 (n=2026)

- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.135 (n=658)

  - _Acción_: SKIP cuando `ballena_activa_n` > 13.0
  - _Potencial_: sin este filtro IC_bueno=-0.036 (n=2043)
...
- **FILTRO** `ibs_15` < `0.2857` → IC=-0.160 (n=151)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=463)
...
- **FILTRO** `sigma_h` < `0.0047` → IC=-0.176 (n=32)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0047
...
- **PATRÓN** `ibs_15` < `0.1379` → IC=+0.181 (n=133)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.91€ cuando `ibs_15` < 0.1379 (IC base=+0.031)
...
- **FILTRO** `sigma_ewma_delta_pct` > `17.932` → IC=-0.156 (n=440)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 17.932
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=3360)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1634` → IC=+0.296 (n=47)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1634 (IC base=-0.068)

- **PATRÓN** `ibs_15` < `0.1321` → IC=+0.292 (n=51)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.1321 (IC base=-0.068)

- **PATRÓN** `ibs_15` > `0.3273` → IC=+0.321 (n=26)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.3273 (IC base=-0.068)

- **PATRÓN** `dist_vwap_pct` > `0.5392` → IC=+0.382 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.5392 (IC base=-0.068)
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1379 sube el IC de +0.031 a +0.181 en UPDOWN_GBM#XRP#15min (n=133). Ya aplicado como kelly_boost=+0.91€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.1321 sube el IC de -0.068 a +0.292 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=51). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS > 0.3273 sube el IC de -0.068 a +0.321 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=26). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 13389 | -0.107 | -2294.87€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 903 | -0.004 | -128.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 12486 | -0.114 | -2166.37€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 1725 | -0.071 | -348.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 1725 | -0.071 | -348.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 903 | -0.004 | -128.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 903 | -0.004 | -128.50€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 1719 | -0.156 | -521.32€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 1719 | -0.156 | -521.32€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 3653 | -0.064 | -369.48€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 3653 | -0.064 | -369.48€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3000 | -0.119 | -304.18€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3000 | -0.119 | -304.18€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2389 | -0.186 | -622.78€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2389 | -0.186 | -622.78€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 2945 | -0.058 | +1364.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 831 | -0.005 | +438.80€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 2114 | -0.079 | +925.26€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 2945 | -0.058 | +1364.06€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 831 | -0.005 | +438.80€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 2114 | -0.079 | +925.26€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 42787 | +0.113 | -2724.50€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 7358 | +0.187 | -229.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 133 | -0.100 | -55.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 31743 | +0.096 | -2388.33€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3553 | +0.119 | -51.08€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 5325 | +0.077 | -763.50€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 22 | -0.083 | +0.79€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#240min | 9 | -0.143 | -7.82€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 5294 | +0.078 | -756.47€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 8654 | +0.132 | -193.92€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2134 | +0.201 | -78.20€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 5268 | +0.106 | -151.46€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 1210 | +0.130 | +57.97€ | 0 | 7 |
| ✅ FAVORITO_CONFIRMADO#DOGE | 5340 | +0.081 | -676.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#15min | 26 | +0.036 | +0.17€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#240min | 6 | -0.075 | -4.10€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#DOGE#5min | 5308 | +0.082 | -672.24€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH | 9301 | +0.127 | -120.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 2701 | +0.173 | -0.12€ | 1 | 6 |
| ✅ FAVORITO_CONFIRMADO#ETH#240min | 12 | -0.129 | -8.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#5min | 5297 | +0.111 | -81.57€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#60min | 1291 | +0.097 | -29.77€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#SOL | 8848 | +0.128 | -594.64€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#15min | 2457 | +0.195 | -153.11€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#SOL#240min | 61 | +0.008 | -11.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#5min | 5278 | +0.097 | -351.21€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#SOL#60min | 1052 | +0.132 | -79.29€ | 0 | 5 |
| ✅ FAVORITO_CONFIRMADO#XRP | 5319 | +0.104 | -376.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#15min | 18 | +0.000 | +0.88€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#XRP#5min | 5298 | +0.104 | -375.37€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 22615 | +0.189 | -2080.43€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#5min | 22615 | +0.189 | -2080.43€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB | 4044 | +0.140 | -675.03€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | 4044 | +0.140 | -675.03€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC | 3552 | +0.227 | -120.37€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | 3552 | +0.227 | -120.37€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE | 3894 | +0.165 | -504.22€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | 3894 | +0.165 | -504.22€ | 0 | 2 |
| ✅ FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH | 