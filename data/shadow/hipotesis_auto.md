# Hipótesis automáticas — 2026-09-24 11:55 UTC
_Generado por shadow_postmortem.py sobre 588553 resoluciones (PNL=+65896.93€)_
...
- **FILTRO** `py_entrada` > `0.495` → IC=-0.263 (n=112)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.122 (n=474)
...
- **PATRÓN** `py_entrada` < `0.495` → IC=+0.122 (n=474)

  - _Acción_: Kelly boost +0.61€ cuando `py_entrada` < 0.495 (IC base=+0.048)

- **PATRÓN** `ballena_activa_n` < `95.0` → IC=+0.141 (n=165)

  - _Acción_: Kelly boost +0.70€ cuando `ballena_activa_n` < 95.0 (IC base=+0.048)
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `145.96` → IC=-0.234 (n=7014)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 145.96
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=21052)
...
- **FILTRO** `restante_s_al_confirmar` < `126.99` → IC=-0.306 (n=866)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 126.99
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=2598)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `164.89` → IC=-0.226 (n=1678)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 164.89
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=5039)
...
### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.69` → IC=+0.203 (n=13741)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.69 (IC base=+0.100)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.154 (n=3457)

  - _Acción_: Kelly boost +0.77€ cuando `libro_spread` < 0.01 (IC base=+0.100)

- **PATRÓN** `libro_liquidez` > `5620.2261` → IC=+0.176 (n=2202)
...
- **PATRÓN** `py_entrada` < `0.35` → IC=+0.231 (n=10782)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.35 (IC base=+0.128)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.174 (n=5622)

  - _Acción_: Kelly boost +0.87€ cuando `libro_spread` < 0.01 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `7792.889` → IC=+0.175 (n=2119)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 7792.889 (IC base=+0.128)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.211 (n=1702)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.204)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.205 (n=1672)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.205 (n=2101)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.204)

- **PATRÓN** `libro_liquidez` > `15944.5355` → IC=+0.235 (n=542)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 15944.5355 (IC base=+0.204)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.205 (n=1505)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.201)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.206 (n=1673)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.201)

- **PATRÓN** `py_entrada` < `0.375` → IC=+0.264 (n=1522)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.375 (IC base=+0.201)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.203 (n=2140)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.201)

- **PATRÓN** `libro_liquidez` > `15869.986` → IC=+0.217 (n=553)
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.139 (n=518)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `hora_utc` < `17.0` → IC=+0.140 (n=654)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.152 (n=533)

  - _Acción_: Kelly boost +0.76€ cuando `libro_spread` < 0.01 (IC base=+0.138)

- **PATRÓN** `libro_liquidez` > `1302.4168` → IC=+0.150 (n=650)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.166 (n=1074)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.171 (n=722)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.249 (n=815)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.244)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.244 (n=822)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.264 (n=2090)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.219)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.208 (n=5571)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 8.0 (IC base=+0.203)

- **PATRÓN** `py_entrada` > `0.75` → IC=+0.255 (n=2252)
...
- **PATRÓN** `hora_utc` < `15.0` → IC=+0.194 (n=5639)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
...
- **PATRÓN** `lag_apertura_s` < `2.84` → IC=+0.141 (n=4737)
...
- **PATRÓN** `restante_min` < `4.1` → IC=+0.133 (n=2353)

  - _Acción_: Kelly boost +0.66€ cuando `restante_min` < 4.1 (IC base=+0.123)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.140 (n=2544)
...
- **PATRÓN** `lag_apertura_s` < `3.41` → IC=+0.144 (n=2353)

  - _Acción_: Kelly boost +0.72€ cuando `lag_apertura_s` < 3.41 (IC base=+0.123)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.191 (n=2551)

  - _Acción_: Kelly boost +0.95€ cuando `py_entrada` < 0.38 (IC base=+0.114)

- **PATRÓN** `restante_min` < `4.19` → IC=+0.127 (n=2391)

  - _Acción_: Kelly boost +0.63€ cuando `restante_min` < 4.19 (IC base=+0.114)

- **PATRÓN** `restante_min` > `4.96` → IC=+0.136 (n=2593)

  - _Acción_: Kelly boost +0.68€ cuando `restante_min` > 4.96 (IC base=+0.114)

- **PATRÓN** `lag_apertura_s` < `2.29` → IC=+0.140 (n=2384)

  - _Acción_: Kelly boost +0.70€ cuando `lag_apertura_s` < 2.29 (IC base=+0.114)
...
### GBM_LATE_15M
- **PATRÓN** `drift_60min` |x|≤ `0.4837` → IC=+0.121 (n=7962)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.61€ cuando `drift_60min` |x|≤ 0.4837 (IC base=+0.105)

- **PATRÓN** `ibs_20min` > `0.9834` → IC=+0.244 (n=2654)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.9834 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` > `0.8435` → IC=+0.249 (n=473)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8435 (IC base=+0.105)

- **PATRÓN** `dist_vwap_pct` < `0.6343` → IC=+0.247 (n=2240)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.6343 (IC base=+0.105)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.966` → IC=+0.176 (n=3052)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 5.966 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` < `1.211` → IC=+0.246 (n=2143)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.211 (IC base=+0.105)

- **PATRÓN** `volumen_regimen` > `1.0481` → IC=+0.257 (n=973)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0481 (IC base=+0.105)

- **PATRÓN** `volumen_pendiente_norm` > `0.3044` → IC=+0.216 (n=795)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3044 (IC base=+0.105)

- **PATRÓN** `volumen_spike_ratio` > `1.9075` → IC=+0.205 (n=3629)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.9075 (IC base=+0.105)

- **PATRÓN** `ibs_20min` < `0.5689` → IC=+0.134 (n=9609)

  - _Acción_: Kelly boost +0.67€ cuando `ibs_20min` < 0.5689 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` > `0.6152` → IC=+0.194 (n=700)

  - _Acción_: Kelly boost +0.97€ cuando `dist_vwap_pct` > 0.6152 (IC base=+0.066)

- **PATRÓN** `dist_vwap_pct` < `0.1525` → IC=+0.174 (n=3053)

  - _Acción_: Kelly boost +0.87€ cuando `dist_vwap_pct` < 0.1525 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` < `0.6986` → IC=+0.181 (n=1479)

  - _Acción_: Kelly boost +0.90€ cuando `volumen_regimen` < 0.6986 (IC base=+0.066)

- **PATRÓN** `volumen_regimen` > `1.0548` → IC=+0.176 (n=1524)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.0548 (IC base=+0.066)

- **PATRÓN** `volumen_pendiente_norm` > `0.1676` → IC=+0.222 (n=1604)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1676 (IC base=+0.066)

- **PATRÓN** `volumen_spike_ratio` > `1.5708` → IC=+0.201 (n=5045)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.5708 (IC base=+0.066)

- **PATRÓN** `ballena_activa_n` < `135.0` → IC=+0.211 (n=5432)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 135.0 (IC base=+0.066)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` < `0.005` → IC=+0.179 (n=603)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.90€ cuando `sigma_h` < 0.005 (IC base=+0.159)

- **PATRÓN** `sigma_h` > `0.0082` → IC=+0.173 (n=601)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0082 (IC base=+0.159)

- **PATRÓN** `drift_60min` |x|≤ `0.3502` → IC=+0.166 (n=1802)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `hora_utc` < `11.0` → IC=+0.168 (n=1219)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` < 11.0 (IC base=+0.159)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.267 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.159)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.136` → IC=+0.268 (n=771)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.136 (IC base=+0.159)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4349` → IC=+0.162 (n=1684)
...
- **PATRÓN** `dist_vwap_pct` > `0.2016` → IC=+0.220 (n=726)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2016 (IC base=+0.215)

- **PATRÓN** `dist_vwap_pct` < `0.5863` → IC=+0.218 (n=1436)
...
- **PATRÓN** `volumen_regimen` < `1.2525` → IC=+0.218 (n=1369)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2525 (IC base=+0.215)

- **PATRÓN** `volumen_regimen` > `1.0826` → IC=+0.226 (n=621)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0826 (IC base=+0.215)

- **PATRÓN** `volumen_pendiente_norm` > `0.2797` → IC=+0.240 (n=194)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2797 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` < `1.7485` → IC=+0.217 (n=895)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7485 (IC base=+0.215)

- **PATRÓN** `volumen_spike_ratio` > `2.3766` → IC=+0.226 (n=447)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3766 (IC base=+0.215)

- **PATRÓN** `libro_liquidez` > `16635.3804` → IC=+0.221 (n=457)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16635.3804 (IC base=+0.215)

- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.152 (n=1431)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.76€ cuando `sigma_h` < 0.0056 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0766` → IC=+0.164 (n=477)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.82€ cuando `drift_60min` |x|≤ 0.0766 (IC base=+0.140)
...
- **PATRÓN** `ibs_20min` < `0.3234` → IC=+0.196 (n=953)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` < 0.3234 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` < `0.1328` → IC=+0.158 (n=1279)

  - _Acción_: Kelly boost +0.79€ cuando `dist_vwap_pct` < 0.1328 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.236` → IC=+0.168 (n=227)

  - _Acción_: Kelly boost +0.84€ cuando `sigma_ewma_delta_pct` > 11.236 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.261` → IC=+0.141 (n=1304)

  - _Acción_: Kelly boost +0.70€ cuando `sigma_ewma_delta_pct` < 4.261 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `1.2046` → IC=+0.151 (n=1429)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.2114` → IC=+0.188 (n=1760)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8411` → IC=+0.203 (n=759)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8411 (IC base=+0.185)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.192 (n=1274)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.185)

- **PATRÓN** `sigma_h` < `0.0115` → IC=+0.219 (n=1519)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0115 (IC base=+0.212)

- **PATRÓN** `drift_60min` |x|≤ `0.5968` → IC=+0.214 (n=1517)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5968 (IC base=+0.212)
...
- **PATRÓN** `ibs_20min` < `0.0625` → IC=+0.250 (n=669)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.0625 (IC base=+0.212)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.626` → IC=+0.245 (n=516)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.626 (IC base=+0.212)
...
- **PATRÓN** `volumen_spike_ratio` < `1.7757` → IC=+0.208 (n=611)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.7757 (IC base=+0.212)

- **PATRÓN** `volumen_spike_ratio` > `2.2107` → IC=+0.220 (n=925)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2107 (IC base=+0.212)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.219 (n=1043)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.212)

- **PATRÓN** `libro_liquidez` > `1883.1265` → IC=+0.226 (n=688)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1883.1265 (IC base=+0.212)

- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.215 (n=893)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.153 (n=99)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.025 (n=2201)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.725` → IC=+0.156 (n=705)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 4.725 (IC base=+0.022)
...
- **PATRÓN** `volumen_regimen` < `0.8486` → IC=+0.162 (n=551)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8486 (IC base=+0.017)
...
- **PATRÓN** `volumen_spike_ratio` > `1.5154` → IC=+0.177 (n=691)
...
- **FILTRO** `ibs_20min` > `0.2553` → IC=-0.124 (n=2164)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.654` → IC=-0.211 (n=347)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.020 (n=2883)
...
- **FILTRO** `drift_60min` |x|> `0.6615` → IC=-0.183 (n=559)
  - _Por qué funciona_: drift fuerte en 1h → el movimiento ya está priceado en Polymarket; edge agotado
  - _Acción_: SKIP cuando `drift_60min` |x|> 0.6615
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=1681)

- **FILTRO** `ibs_20min` < `0.71` → IC=-0.157 (n=1475)

  - _Acción_: SKIP cuando `ibs_20min` < 0.71
  - _Potencial_: sin este filtro IC_bueno=+0.106 (n=765)

- **FILTRO** `libro_spread` > `0.02` → IC=-0.200 (n=408)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=1832)

- **FILTRO** `ibs_20min` > `0.77` → IC=-0.200 (n=819)

  - _Acción_: SKIP cuando `ibs_20min` > 0.77
  - _Potencial_: sin este filtro IC_bueno=+0.036 (n=2476)
...
- **PATRÓN** `sigma_h` > `0.0097` → IC=+0.195 (n=3327)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` > 0.0097 (IC base=+0.097)

- **PATRÓN** `ibs_20min` > `0.475` → IC=+0.187 (n=8911)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.593` → IC=+0.155 (n=4709)

  - _Acción_: Kelly boost +0.78€ cuando `sigma_ewma_delta_pct` > 3.593 (IC base=+0.097)

- **PATRÓN** `volumen_regimen` > `0.6888` → IC=+0.246 (n=3162)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4663` → IC=+0.239 (n=1919)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.4663 (IC base=+0.097)

- **PATRÓN** `volumen_spike_ratio` > `2.6694` → IC=+0.237 (n=1918)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6694 (IC base=+0.097)

- **PATRÓN** `ballena_activa_n` < `97.0` → IC=+0.265 (n=5263)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 97.0 (IC base=+0.097)

- **PATRÓN** `sigma_h` > `0.0091` → IC=+0.154 (n=3323)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0091 (IC base=+0.074)

- **PATRÓN** `ibs_20min` < `0.5464` → IC=+0.154 (n=8771)

  - _Acción_: Kelly boost +0.77€ cuando `ibs_20min` < 0.5464 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` < `0.2484` → IC=+0.239 (n=2788)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2484 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` < `0.7096` → IC=+0.240 (n=1292)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7096 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.2049` → IC=+0.247 (n=979)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2049 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2968` → IC=+0.304 (n=553)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2968 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` < `1.6041` → IC=+0.257 (n=1699)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.6041 (IC base=+0.074)

- **PATRÓN** `volumen_spike_ratio` > `2.3196` → IC=+0.255 (n=1751)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.3196 (IC base=+0.074)

- **PATRÓN** `ballena_activa_n` < `84.0` → IC=+0.262 (n=3745)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 84.0 (IC base=+0.074)

### GBM_LATE_15M_ESPACIO_ATR#BNB#15min
- **FILTRO** `sigma_ewma_delta_pct` > `4.528` → IC=-0.155 (n=526)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 4.528
  - _Potencial_: sin este filtro IC_bueno=+0.026 (n=1769)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1445` → IC=+0.192 (n=394)
...
- **PATRÓN** `dist_vwap_pct` > `0.1279` → IC=+0.171 (n=506)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` > 0.1279 (IC base=+0.025)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4405` → IC=+0.223 (n=171)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1372` → IC=+0.256 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1372 (IC base=+0.244)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.253 (n=1126)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.244)

- **PATRÓN** `libro_liquidez` > `1956.8086` → IC=+0.252 (n=526)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1956.8086 (IC base=+0.244)

- **PATRÓN** `sigma_h` > `0.0098` → IC=+0.315 (n=572)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0098 (IC base=+0.281)

- **PATRÓN** `drift_60min` |x|≤ `0.6055` → IC=+0.284 (n=1261)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2222` → IC=+0.290 (n=1110)
...
- **PATRÓN** `volumen_spike_ratio` > `2.7414` → IC=+0.285 (n=528)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.7414 (IC base=+0.281)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.289 (n=859)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.281)

- **PATRÓN** `libro_liquidez` > `1875.32` → IC=+0.298 (n=572)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1875.32 (IC base=+0.281)

- **PATRÓN** `ballena_activa_n` < `29.0` → IC=+0.286 (n=751)
...
- **FILTRO** `ibs_20min` < `0.2846` → IC=-0.187 (n=487)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.075 (n=1461)

- **FILTRO** `ibs_20min` > `0.7744` → IC=-0.183 (n=591)
...
- **PATRÓN** `dist_vwap_pct` > `0.4536` → IC=+0.225 (n=242)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4536 (IC base=+0.010)

- **PATRÓN** `volumen_regimen` < `0.9865` → IC=+0.233 (n=488)
...
- **PATRÓN** `ballena_activa_n` < `151.0` → IC=+0.240 (n=529)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 151.0 (IC base=+0.010)

- **PATRÓN** `dist_vwap_pct` > `0.1552` → IC=+0.207 (n=206)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1552 (IC base=-0.004)
...
- **PATRÓN** `volumen_regimen` < `1.1607` → IC=+0.212 (n=421)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.1607 (IC base=-0.004)

- **PATRÓN** `volumen_pendiente_norm` > `0.1645` → IC=+0.276 (n=96)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1645 (IC base=-0.004)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1499` → IC=+0.236 (n=172)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1499 (IC base=-0.004)
...
- **FILTRO** `ibs_20min` < `0.7188` → IC=-0.203 (n=1057)

  - _Acción_: SKIP cuando `ibs_20min` < 0.7188
  - _Potencial_: sin este filtro IC_bueno=+0.280 (n=1060)
...
- **PATRÓN** `ibs_20min` > `0.7188` → IC=+0.280 (n=1060)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.595` → IC=+0.162 (n=335)

  - _Acción_: Kelly boost +0.81€ cuando `sigma_ewma_delta_pct` > 9.595 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` < `0.8696` → IC=+0.300 (n=518)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8696 (IC base=+0.039)

- **PATRÓN** `volumen_regimen` > `0.7298` → IC=+0.292 (n=694)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7298 (IC base=+0.039)

- **PATRÓN** `volumen_pendiente_norm` < `0.1016` → IC=+0.290 (n=722)
...
- **PATRÓN** `volumen_spike_ratio` < `1.422` → IC=+0.322 (n=251)
...
- **PATRÓN** `sigma_h` > `0.0168` → IC=+0.317 (n=862)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `ibs_20min` > `0.6319` → IC=+0.311 (n=1293)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6319 (IC base=+0.276)

- **PATRÓN** `dist_vwap_pct` > `0.2044` → IC=+0.317 (n=764)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.2044 (IC base=+0.276)
...
- **PATRÓN** `volumen_regimen` > `0.8619` → IC=+0.302 (n=862)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1503` → IC=+0.292 (n=556)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.1503 (IC base=+0.276)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.282 (n=1384)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.276)

- **PATRÓN** `libro_liquidez` > `2626.4292` → IC=+0.290 (n=862)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2626.4292 (IC base=+0.276)
...
- **PATRÓN** `ibs_20min` < `0.3939` → IC=+0.304 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3939 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` > `0.3029` → IC=+0.278 (n=534)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3029 (IC base=+0.270)

- **PATRÓN** `dist_vwap_pct` < `0.9721` → IC=+0.271 (n=1585)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.9721 (IC base=+0.270)
...
- **PATRÓN** `volumen_regimen` < `0.6412` → IC=+0.275 (n=468)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6412 (IC base=+0.270)
...
- **PATRÓN** `volumen_spike_ratio` < `1.8208` → IC=+0.268 (n=824)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.8208 (IC base=+0.270)
...
- **PATRÓN** `libro_liquidez` > `2620.4702` → IC=+0.273 (n=935)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2620.4702 (IC base=+0.270)

### GBM_LATE_15M_MULTIHORIZONTE
- **PATRÓN** `sigma_h` < `0.0049` → IC=+0.169 (n=2600)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` < 0.0049 (IC base=+0.166)

- **PATRÓN** `sigma_h` > `0.0112` → IC=+0.199 (n=2592)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0112 (IC base=+0.166)

- **PATRÓN** `drift_60min` |x|≤ `0.09` → IC=+0.186 (n=2592)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.93€ cuando `drift_60min` |x|≤ 0.09 (IC base=+0.166)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.178 (n=8085)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.89€ cuando `hora_utc` > 5.0 (IC base=+0.166)

- **PATRÓN** `ibs_20min` > `0.5779` → IC=+0.216 (n=7774)
...
- **PATRÓN** `ibs_20min` < `0.4773` → IC=+0.227 (n=7460)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4773 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` > `0.9186` → IC=+0.145 (n=713)

  - _Acción_: Kelly boost +0.72€ cuando `dist_vwap_pct` > 0.9186 (IC base=+0.168)

- **PATRÓN** `dist_vwap_pct` < `0.2329` → IC=+0.159 (n=5433)

  - _Acción_: Kelly boost +0.80€ cuando `dist_vwap_pct` < 0.2329 (IC base=+0.168)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.345` → IC=+0.197 (n=1265)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 10.345 (IC base=+0.168)

- **PATRÓN** `volumen_regimen` < `1.1756` → IC=+0.152 (n=5408)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5618` → IC=+0.168 (n=2983)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.5618 (IC base=+0.168)

- **PATRÓN** `volumen_spike_ratio` > `2.2559` → IC=+0.170 (n=3074)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.2559 (IC base=+0.168)

- **PATRÓN** `ballena_activa_n` < `116.0` → IC=+0.173 (n=6421)

  - _Acción_: Kelly boost +0.86€ cuando `ballena_activa_n` < 116.0 (IC base=+0.168)

### GBM_LATE_15M_MULTIHORIZONTE#BNB#15min
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.217 (n=443)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0052 (IC base=+0.180)

- **PATRÓN** `sigma_h` > `0.0075` → IC=+0.186 (n=603)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.93€ cuando `sigma_h` > 0.0075 (IC base=+0.180)

- **PATRÓN** `drift_60min` |x|≤ `0.3432` → IC=+0.206 (n=1327)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.3432 (IC base=+0.180)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.180 (n=483)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.90€ cuando `hora_utc` > 17.0 (IC base=+0.180)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.192 (n=893)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` < 11.0 (IC base=+0.180)

- **PATRÓN** `ibs_20min` > `0.8969` → IC=+0.274 (n=884)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.8969 (IC base=+0.180)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.122` → IC=+0.311 (n=596)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.122 (IC base=+0.180)

- **PATRÓN** `volumen_pendiente_norm` > `0.23` → IC=+0.230 (n=257)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.23 (IC base=+0.180)

- **PATRÓN** `volumen_spike_ratio` > `1.4355` → IC=+0.177 (n=1226)
...
- **PATRÓN** `ibs_20min` < `0.5646` → IC=+0.187 (n=1268)

  - _Acción_: Kelly boost +0.93€ cuando `ibs_20min` < 0.5646 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.1339` → IC=+0.162 (n=1258)
...
- **PATRÓN** `volumen_regimen` < `1.2145` → IC=+0.157 (n=1268)
...
- **PATRÓN** `ballena_activa_n` < `215.0` → IC=+0.170 (n=359)
  ...
  - _Acción_: Kelly boost +0.85€ cuando `ballena_activa_n` < 215.0 (IC base=+0.137)

### GBM_LATE_15M_MULTIHORIZONTE#DOGE#15min
- **PATRÓN** `sigma_h` > `0.01` → IC=+0.212 (n=592)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.01 (IC base=+0.196)

- **PATRÓN** `drift_60min` |x|≤ `0.2283` → IC=+0.214 (n=871)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.2283 (IC base=+0.196)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1321` → IC=+0.196 (n=508)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_pendiente_norm` > 0.1321 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` < `1.6331` → IC=+0.197 (n=414)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` < 1.6331 (IC base=+0.196)

- **PATRÓN** `volumen_spike_ratio` > `2.8468` → IC=+0.209 (n=562)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8468 (IC base=+0.196)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.206 (n=936)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.196)

- **PATRÓN** `libro_liquidez` > `1957.842` → IC=+0.200 (n=435)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1957.842 (IC base=+0.196)
...
- **PATRÓN** `drift_60min` |x|≤ `0.4324` → IC=+0.157 (n=1244)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.79€ cuando `drift_60min` |x|≤ 0.4324 (IC base=+0.142)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.160 (n=1303)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 5.0 (IC base=+0.142)

- **PATRÓN** `ibs_20min` > `0.3782` → IC=+0.195 (n=1244)

  - _Acción_: Kelly boost +0.98€ cuando `ibs_20min` > 0.3782 (IC base=+0.142)

- **PATRÓN** `dist_vwap_pct` > `0.1608` → IC=+0.180 (n=825)

  - _Acción_: Kelly boost +0.90€ cuando `dist_vwap_pct` > 0.1608 (IC base=+0.142)
...
- **PATRÓN** `volumen_regimen` < `1.0413` → IC=+0.143 (n=1095)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.0413 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `0.6251` → IC=+0.147 (n=1244)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5369` → IC=+0.147 (n=536)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` < 1.5369 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.5292` → IC=+0.169 (n=406)

  - _Acción_: Kelly boost +0.85€ cuando `volumen_spike_ratio` > 2.5292 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `6488.9388` → IC=+0.182 (n=829)

  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 6488.9388 (IC base=+0.142)

- **PATRÓN** `ballena_activa_n` < `164.0` → IC=+0.144 (n=1182)

  - _Acción_: Kelly boost +0.72€ cuando `ballena_activa_n` < 164.0 (IC base=+0.142)

- **PATRÓN** `sigma_h` < `0.0072` → IC=+0.154 (n=1318)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0072 (IC base=+0.123)

- **PATRÓN** `drift_60min` |x|≤ `0.3848` → IC=+0.143 (n=1318)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.6361` → IC=+0.171 (n=1318)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.6361 (IC base=+0.123)

- **PATRÓN** `dist_vwap_pct` < `0.5831` → IC=+0.133 (n=1533)

  - _Acción_: Kelly boost +0.66€ cuando `dist_vwap_pct` < 0.5831 (IC base=+0.123)

- **PATRÓN** `sigma_ewma_delta_pct` > `6.963` → IC=+0.171 (n=463)

  - _Acción_: Kelly boost +0.85€ cuando `sigma_ewma_delta_pct` > 6.963 (IC base=+0.123)

- **PATRÓN** `volumen_regimen` < `0.8485` → IC=+0.147 (n=879)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.8485 (IC base=+0.123)

- **PATRÓN** `volumen_pendiente_norm` > `0.2919` → IC=+0.200 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2919 (IC base=+0.123)

- **PATRÓN** `volumen_spike_ratio` < `1.7906` → IC=+0.134 (n=799)
...
- **PATRÓN** `libro_liquidez` > `10007.3401` → IC=+0.158 (n=598)

  - _Acción_: Kelly boost +0.79€ cuando `libro_liquidez` > 10007.3401 (IC base=+0.123)

### GBM_LATE_15M_MULTIHORIZONTE#SOL#15min
- **PATRÓN** `sigma_h` > `0.0101` → IC=+0.155 (n=638)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0101 (IC base=+0.117)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.136 (n=1432)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 5.0 (IC base=+0.117)

- **PATRÓN** `ibs_20min` > `0.5167` → IC=+0.203 (n=1403)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5167 (IC base=+0.117)

- **PATRÓN** `dist_vwap_pct` > `1.0933` → IC=+0.223 (n=319)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.0933 (IC base=+0.117)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.729` → IC=+0.249 (n=317)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.729 (IC base=+0.117)

- **PATRÓN** `volumen_regimen` < `1.2208` → IC=+0.129 (n=1403)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_regimen` < 1.2208 (IC base=+0.117)

- **PATRÓN** `volumen_pendiente_norm` < `0.1637` → IC=+0.127 (n=1408)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_pendiente_norm` < 0.1637 (IC base=+0.117)

- **PATRÓN** `volumen_spike_ratio` < `1.5449` → IC=+0.139 (n=596)

  - _Acción_: Kelly boost +0.69€ cuando `volumen_spike_ratio` < 1.5449 (IC base=+0.117)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.125 (n=1469)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.02 (IC base=+0.117)

- **PATRÓN** `libro_liquidez` > `2891.4485` → IC=+0.198 (n=636)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 2891.4485 (IC base=+0.117)

- **PATRÓN** `ballena_activa_n` < `50.0` → IC=+0.135 (n=1079)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.132 (n=1447)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.66€ cuando `hora_utc` > 5.0 (IC base=+0.114)

- **PATRÓN** `ibs_20min` < `0.5652` → IC=+0.211 (n=1431)
...
- **PATRÓN** `dist_vwap_pct` < `0.2001` → IC=+0.140 (n=1323)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.2001 (IC base=+0.114)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.006` → IC=+0.144 (n=231)

  - _Acción_: Kelly boost +0.72€ cuando `sigma_ewma_delta_pct` > 9.006 (IC base=+0.114)

- **PATRÓN** `volumen_regimen` < `0.6362` → IC=+0.137 (n=477)

  - _Acción_: Kelly boost +0.68€ cuando `volumen_regimen` < 0.6362 (IC base=+0.114)

- **PATRÓN** `volumen_pendiente_norm` > `0.277` → IC=+0.167 (n=175)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.277 (IC base=+0.114)
...
- **PATRÓN** `volumen_spike_ratio` > `2.4249` → IC=+0.134 (n=427)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` > 2.4249 (IC base=+0.114)

- **PATRÓN** `libro_liquidez` > `1463.4782` → IC=+0.136 (n=1278)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 1463.4782 (IC base=+0.114)

### GBM_LATE_15M_MULTIHORIZONTE#XRP#15min
- **PATRÓN** `sigma_h` > `0.0188` → IC=+0.213 (n=894)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0188 (IC base=+0.202)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=1389)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` > `0.7396` → IC=+0.260 (n=1198)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7396 (IC base=+0.202)

- **PATRÓN** `dist_vwap_pct` > `0.5042` → IC=+0.222 (n=638)
...
- **PATRÓN** `volumen_regimen` < `1.2068` → IC=+0.204 (n=1341)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.2068 (IC base=+0.202)

- **PATRÓN** `volumen_regimen` > `0.8579` → IC=+0.221 (n=894)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1508` → IC=+0.212 (n=1140)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.1508 (IC base=+0.202)

- **PATRÓN** `volumen_spike_ratio` > `1.7991` → IC=+0.209 (n=864)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.7991 (IC base=+0.202)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.205 (n=1427)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.202)

- **PATRÓN** `libro_liquidez` > `2615.934` → IC=+0.208 (n=894)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2615.934 (IC base=+0.202)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0997` → IC=+0.151 (n=617)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.76€ cuando `drift_60min` |x|≤ 0.0997 (IC base=+0.145)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.187 (n=922)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.94€ cuando `hora_utc` > 15.0 (IC base=+0.145)

- **PATRÓN** `ibs_20min` > `0.3913` → IC=+0.178 (n=1846)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.726` → IC=+0.176 (n=849)

  - _Acción_: Kelly boost +0.88€ cuando `sigma_ewma_delta_pct` > 3.726 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` < `0.8739` → IC=+0.162 (n=1080)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_regimen` < 0.8739 (IC base=+0.145)

- **PATRÓN** `volumen_regimen` > `1.2081` → IC=+0.151 (n=540)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2081 (IC base=+0.145)
...
- **PATRÓN** `volumen_spike_ratio` < `1.4378` → IC=+0.167 (n=593)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_spike_ratio` < 1.4378 (IC base=+0.145)

- **PATRÓN** `volumen_spike_ratio` > `2.5403` → IC=+0.155 (n=593)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` > 2.5403 (IC base=+0.145)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.148 (n=2095)

  - _Acción_: Kelly boost +0.74€ cuando `libro_spread` < 0.02 (IC base=+0.145)

- **PATRÓN** `libro_liquidez` > `12369.1399` → IC=+0.154 (n=616)

  - _Acción_: Kelly boost +0.77€ cuando `libro_liquidez` > 12369.1399 (IC base=+0.145)

- **PATRÓN** `ballena_activa_n` < `162.0` → IC=+0.164 (n=1626)

  - _Acción_: Kelly boost +0.82€ cuando `ballena_activa_n` < 162.0 (IC base=+0.145)

- **PATRÓN** `sigma_h` < `0.0057` → IC=+0.137 (n=1302)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.69€ cuando `sigma_h` < 0.0057 (IC base=+0.109)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1963)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 5.0 (IC base=+0.109)

- **PATRÓN** `ibs_20min` < `0.3134` → IC=+0.166 (n=1297)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` < 0.3134 (IC base=+0.109)

- **PATRÓN** `dist_vwap_pct` < `0.2116` → IC=+0.122 (n=1733)

  - _Acción_: Kelly boost +0.61€ cuando `dist_vwap_pct` < 0.2116 (IC base=+0.109)

- **PATRÓN** `volumen_spike_ratio` < `2.227` → IC=+0.126 (n=1647)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_spike_ratio` < 2.227 (IC base=+0.109)

- **PATRÓN** `libro_liquidez` > `3894.1106` → IC=+0.128 (n=1296)

  - _Acción_: Kelly boost +0.64€ cuando `libro_liquidez` > 3894.1106 (IC base=+0.109)

### GBM_LATE_15M_PYCONFIRMADO#BTC#15min
- **PATRÓN** `drift_60min` |x|≤ `0.1106` → IC=+0.131 (n=204)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.66€ cuando `drift_60min` |x|≤ 0.1106 (IC base=+0.103)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3378` → IC=+0.153 (n=618)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.3378 (IC base=+0.136)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.149 (n=554)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.75€ cuando `hora_utc` > 7.0 (IC base=+0.136)

- **PATRÓN** `ibs_20min` < `0.5957` → IC=+0.181 (n=544)

  - _Acción_: Kelly boost +0.91€ cuando `ibs_20min` < 0.5957 (IC base=+0.136)

- **PATRÓN** `dist_vwap_pct` < `0.4881` → IC=+0.153 (n=712)
...
- **PATRÓN** `volumen_regimen` < `1.2138` → IC=+0.140 (n=618)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1022` → IC=+0.157 (n=535)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 2.1022 (IC base=+0.136)

- **PATRÓN** `volumen_spike_ratio` > `1.4187` → IC=+0.147 (n=608)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_spike_ratio` > 1.4187 (IC base=+0.136)

- **PATRÓN** `ballena_activa_n` < `386.0` → IC=+0.150 (n=586)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.204 (n=596)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.189)

- **PATRÓN** `ibs_20min` > `0.7004` → IC=+0.242 (n=382)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.93` → IC=+0.222 (n=250)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.93 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` < `0.8389` → IC=+0.195 (n=382)

  - _Acción_: Kelly boost +0.98€ cuando `volumen_regimen` < 0.8389 (IC base=+0.189)

- **PATRÓN** `volumen_regimen` > `1.1573` → IC=+0.205 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1573 (IC base=+0.189)

- **PATRÓN** `volumen_pendiente_norm` > `0.1517` → IC=+0.259 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1517 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` < `1.3982` → IC=+0.233 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3982 (IC base=+0.189)

- **PATRÓN** `volumen_spike_ratio` > `2.4036` → IC=+0.223 (n=189)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4036 (IC base=+0.189)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.197 (n=635)

  - _Acción_: Kelly boost +0.99€ cuando `libro_spread` < 0.01 (IC base=+0.189)

- **PATRÓN** `libro_liquidez` > `12380.0176` → IC=+0.210 (n=191)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 12380.0176 (IC base=+0.189)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.130 (n=444)

  - _Acción_: Kelly boost +0.65€ cuando `libro_spread` < 0.02 (IC base=+0.128)

- **PATRÓN** `libro_liquidez` > `3071.7984` → IC=+0.188 (n=136)

  - _Acción_: Kelly boost +0.94€ cuando `libro_liquidez` > 3071.7984 (IC base=+0.128)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3555` → IC=+0.190 (n=1689)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.95€ cuando `drift_60min` |x|≤ 0.3555 (IC base=+0.188)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.200 (n=807)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 15.0 (IC base=+0.188)

- **PATRÓN** `hora_utc` < `11.0` → IC=+0.196 (n=1151)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.98€ cuando `hora_utc` < 11.0 (IC base=+0.188)

- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.322 (n=605)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.188)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.539` → IC=+0.344 (n=382)
...
- **PATRÓN** `volumen_spike_ratio` < `1.5477` → IC=+0.183 (n=701)

  - _Acción_: Kelly boost +0.91€ cuando `volumen_spike_ratio` < 1.5477 (IC base=+0.188)

- **PATRÓN** `volumen_spike_ratio` > `2.5711` → IC=+0.198 (n=531)

  - _Acción_: Kelly boost +0.99€ cuando `volumen_spike_ratio` > 2.5711 (IC base=+0.188)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.190 (n=1021)
...
- **PATRÓN** `drift_60min` |x|≤ `0.0846` → IC=+0.160 (n=531)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.80€ cuando `drift_60min` |x|≤ 0.0846 (IC base=+0.149)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.163 (n=1661)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.81€ cuando `hora_utc` > 5.0 (IC base=+0.149)

- **PATRÓN** `ibs_20min` > `0.3107` → IC=+0.203 (n=1591)
...
- **PATRÓN** `ibs_20min` < `0.2685` → IC=+0.237 (n=919)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2685 (IC base=+0.152)

- **PATRÓN** `dist_vwap_pct` < `0.1343` → IC=+0.167 (n=1248)

  - _Acción_: Kelly boost +0.84€ cuando `dist_vwap_pct` < 0.1343 (IC base=+0.152)

- **PATRÓN** `sigma_ewma_delta_pct` > `11.479` → IC=+0.165 (n=231)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 11.479 (IC base=+0.152)

- **PATRÓN** `volumen_regimen` < `1.1917` → IC=+0.163 (n=1378)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4046` → IC=+0.162 (n=1280)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` < 2.4046 (IC base=+0.152)

- **PATRÓN** `volumen_spike_ratio` > `1.7535` → IC=+0.162 (n=853)

  - _Acción_: Kelly boost +0.81€ cuando `volumen_spike_ratio` > 1.7535 (IC base=+0.152)

- **PATRÓN** `ballena_activa_n` < `422.0` → IC=+0.159 (n=1041)

  - _Acción_: Kelly boost +0.79€ cuando `ballena_activa_n` < 422.0 (IC base=+0.152)

### GBM_LATE_15M_TARDIO#DOGE#15min
- **PATRÓN** `sigma_h` > `0.0118` → IC=+0.243 (n=536)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0118 (IC base=+0.217)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.224 (n=1681)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.217)

- **PATRÓN** `hora_utc` < `17.0` → IC=+0.222 (n=1636)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 17.0 (IC base=+0.217)

- **PATRÓN** `ibs_20min` > `0.6697` → IC=+0.256 (n=1436)
...
- **PATRÓN** `ibs_20min` < `0.3594` → IC=+0.270 (n=1322)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.3594 (IC base=+0.233)

- **PATRÓN** `sigma_ewma_delta_pct` > `2.756` → IC=+0.279 (n=554)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `4.203` → IC=+0.160 (n=706)
  ...
  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` > 4.203 (IC base=+0.135)

- **PATRÓN** `volumen_regimen` < `0.8743` → IC=+0.153 (n=1128)
...
- **PATRÓN** `ibs_20min` < `0.7022` → IC=+0.184 (n=1387)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` < 0.7022 (IC base=+0.138)

- **PATRÓN** `dist_vwap_pct` < `0.6029` → IC=+0.144 (n=1540)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4421` → IC=+0.152 (n=1316)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.124 (n=1696)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `volumen_spike_ratio` > `2.5044` → IC=+0.129 (n=494)

  - _Acción_: Kelly boost +0.65€ cuando `volumen_spike_ratio` > 2.5044 (IC base=+0.113)

- **PATRÓN** `libro_liquidez` > `2824.0599` → IC=+0.166 (n=548)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 2824.0599 (IC base=+0.113)

### GBM_LATE_15M_TARDIO#XRP#15min
- **PATRÓN** `sigma_h` > `0.0193` → IC=+0.218 (n=1120)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0193 (IC base=+0.208)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.215 (n=1747)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.208)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.209 (n=1504)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` < 15.0 (IC base=+0.208)

- **PATRÓN** `ibs_20min` > `0.5143` → IC=+0.249 (n=1681)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.5143 (IC base=+0.208)

- **PATRÓN** `dist_vwap_pct` > `0.2017` → IC=+0.234 (n=989)
...
- **PATRÓN** `volumen_regimen` < `1.0683` → IC=+0.211 (n=1478)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 1.0683 (IC base=+0.208)

- **PATRÓN** `volumen_regimen` > `0.637` → IC=+0.215 (n=1680)
...
- **PATRÓN** `volumen_spike_ratio` > `2.5093` → IC=+0.238 (n=540)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.5093 (IC base=+0.208)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.217 (n=1767)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.02 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `2623.1911` → IC=+0.220 (n=1120)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 2623.1911 (IC base=+0.208)
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.208 (n=1264)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 11.0 (IC base=+0.200)

- **PATRÓN** `ibs_20min` < `0.5172` → IC=+0.256 (n=1802)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.5172 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` > `1.2446` → IC=+0.201 (n=289)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 1.2446 (IC base=+0.200)

- **PATRÓN** `dist_vwap_pct` < `0.9192` → IC=+0.203 (n=2010)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.2826` → IC=+0.265 (n=236)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2826 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` < `2.2014` → IC=+0.195 (n=1424)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` < 2.2014 (IC base=+0.200)

- **PATRÓN** `volumen_spike_ratio` > `1.4297` → IC=+0.196 (n=1618)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.139 (n=3007)

- **PATRÓN** `sigma_h` < `0.0092` → IC=+0.157 (n=2516)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.78€ cuando `sigma_h` < 0.0092 (IC base=+0.149)

- **PATRÓN** `sigma_h` > `0.0056` → IC=+0.150 (n=2554)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.75€ cuando `sigma_h` > 0.0056 (IC base=+0.149)

- **PATRÓN** `drift_60min` |x|≤ `0.5214` → IC=+0.159 (n=2857)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` > `0.942` → IC=+0.210 (n=953)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.942 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` > `0.1866` → IC=+0.156 (n=1039)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1866 (IC base=+0.149)

- **PATRÓN** `dist_vwap_pct` < `0.4925` → IC=+0.143 (n=1739)

  - _Acción_: Kelly boost +0.71€ cuando `dist_vwap_pct` < 0.4925 (IC base=+0.149)
...
- **PATRÓN** `volumen_regimen` > `0.9001` → IC=+0.159 (n=1231)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` > 0.9001 (IC base=+0.149)

- **PATRÓN** `volumen_pendiente_norm` > `0.1721` → IC=+0.183 (n=781)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1721 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` < `1.4562` → IC=+0.159 (n=941)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_spike_ratio` < 1.4562 (IC base=+0.149)

- **PATRÓN** `volumen_spike_ratio` > `1.8832` → IC=+0.161 (n=1881)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8832 (IC base=+0.149)

- **PATRÓN** `libro_liquidez` > `3749.6012` → IC=+0.151 (n=1905)

  - _Acción_: Kelly boost +0.75€ cuando `libro_liquidez` > 3749.6012 (IC base=+0.149)

- **PATRÓN** `sigma_h` < `0.0038` → IC=+0.196 (n=760)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0038 (IC base=+0.137)

- **PATRÓN** `drift_60min` |x|≤ `0.4897` → IC=+0.155 (n=2267)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.085` → IC=+0.173 (n=756)

  - _Acción_: Kelly boost +0.86€ cuando `ibs_20min` < 0.085 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` > `0.6926` → IC=+0.149 (n=428)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` > 0.6926 (IC base=+0.137)

- **PATRÓN** `dist_vwap_pct` < `0.4314` → IC=+0.130 (n=2252)

  - _Acción_: Kelly boost +0.65€ cuando `dist_vwap_pct` < 0.4314 (IC base=+0.137)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.273` → IC=+0.147 (n=2258)

  - _Acción_: Kelly boost +0.74€ cuando `sigma_ewma_delta_pct` < 6.273 (IC base=+0.137)

- **PATRÓN** `volumen_regimen` < `1.2465` → IC=+0.143 (n=2165)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_regimen` < 1.2465 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` < `0.0971` → IC=+0.139 (n=2051)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.0971 (IC base=+0.137)

- **PATRÓN** `volumen_pendiente_norm` > `0.0731` → IC=+0.144 (n=1050)
...
- **PATRÓN** `sigma_h` > `0.0043` → IC=+0.160 (n=896)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.80€ cuando `sigma_h` > 0.0043 (IC base=+0.151)

- **PATRÓN** `drift_60min` |x|≤ `0.1233` → IC=+0.154 (n=299)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.77€ cuando `drift_60min` |x|≤ 0.1233 (IC base=+0.151)
...
- **PATRÓN** `ibs_20min` < `0.5623` → IC=+0.155 (n=598)

  - _Acción_: Kelly boost +0.78€ cuando `ibs_20min` < 0.5623 (IC base=+0.151)

- **PATRÓN** `ibs_20min` > `0.8888` → IC=+0.168 (n=299)

  - _Acción_: Kelly boost +0.84€ cuando `ibs_20min` > 0.8888 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` > `0.9801` → IC=+0.167 (n=199)

  - _Acción_: Kelly boost +0.83€ cuando `dist_vwap_pct` > 0.9801 (IC base=+0.151)

- **PATRÓN** `dist_vwap_pct` < `0.4255` → IC=+0.162 (n=838)

  - _Acción_: Kelly boost +0.81€ cuando `dist_vwap_pct` < 0.4255 (IC base=+0.151)

- **PATRÓN** `sigma_ewma_delta_pct` < `6.684` → IC=+0.160 (n=899)

  - _Acción_: Kelly boost +0.80€ cuando `sigma_ewma_delta_pct` < 6.684 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` < `1.0856` → IC=+0.154 (n=789)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` < 1.0856 (IC base=+0.151)

- **PATRÓN** `volumen_regimen` > `0.7179` → IC=+0.155 (n=800)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_regimen` > 0.7179 (IC base=+0.151)

- **PATRÓN** `volumen_pendiente_norm` < `0.1099` → IC=+0.153 (n=827)
...
- **PATRÓN** `ibs_20min` < `0.7363` → IC=+0.144 (n=766)

  - _Acción_: Kelly boost +0.72€ cuando `ibs_20min` < 0.7363 (IC base=+0.139)

- **PATRÓN** `ibs_20min` > `0.0998` → IC=+0.147 (n=766)
...
- **PATRÓN** `dist_vwap_pct` < `0.3871` → IC=+0.140 (n=785)

  - _Acción_: Kelly boost +0.70€ cuando `dist_vwap_pct` < 0.3871 (IC base=+0.139)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.36` → IC=+0.147 (n=694)

  - _Acción_: Kelly boost +0.73€ cuando `sigma_ewma_delta_pct` < 4.36 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` < `0.6472` → IC=+0.174 (n=256)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` < 0.6472 (IC base=+0.139)

- **PATRÓN** `volumen_regimen` > `0.7259` → IC=+0.141 (n=685)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.7259 (IC base=+0.139)

- **PATRÓN** `volumen_pendiente_norm` > `0.0741` → IC=+0.168 (n=323)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_pendiente_norm` > 0.0741 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` < `2.1949` → IC=+0.156 (n=661)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_spike_ratio` < 2.1949 (IC base=+0.139)

- **PATRÓN** `volumen_spike_ratio` > `1.7791` → IC=+0.146 (n=501)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_spike_ratio` > 1.7791 (IC base=+0.139)

- **PATRÓN** `libro_liquidez` > `7573.3328` → IC=+0.165 (n=766)

  - _Acción_: Kelly boost +0.83€ cuando `libro_liquidez` > 7573.3328 (IC base=+0.139)

### GBM_LATE_5M#SOL#5min
- **PATRÓN** `ibs_20min` > `1.0` → IC=+0.225 (n=89)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 1.0 (IC base=+0.085)

- **PATRÓN** `dist_vwap_pct` > `0.2619` → IC=+0.126 (n=137)

  - _Acción_: Kelly boost +0.63€ cuando `dist_vwap_pct` > 0.2619 (IC base=+0.085)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.369` → IC=+0.188 (n=46)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 9.369 (IC base=+0.085)

- **PATRÓN** `volumen_pendiente_norm` > `0.1587` → IC=+0.210 (n=67)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1587 (IC base=+0.085)

- **PATRÓN** `libro_liquidez` > `3417.5406` → IC=+0.136 (n=196)

  - _Acción_: Kelly boost +0.68€ cuando `libro_liquidez` > 3417.5406 (IC base=+0.085)
...
- **PATRÓN** `volumen_spike_ratio` < `2.0813` → IC=+0.139 (n=616)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.0813 (IC base=+0.096)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.121 (n=653)

  - _Acción_: Kelly boost +0.61€ cuando `libro_spread` < 0.02 (IC base=+0.096)

- **PATRÓN** `libro_liquidez` > `2424.4386` → IC=+0.143 (n=357)

  - _Acción_: Kelly boost +0.72€ cuando `libro_liquidez` > 2424.4386 (IC base=+0.096)

- **PATRÓN** `ibs_20min` < `0.057` → IC=+0.267 (n=127)
...
- **PATRÓN** `volumen_spike_ratio` < `2.1644` → IC=+0.128 (n=202)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_spike_ratio` < 2.1644 (IC base=+0.001)

### GBM_LATE_60M#BTC#60min
- **PATRÓN** `sigma_h` < `0.006` → IC=+0.165 (n=308)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.82€ cuando `sigma_h` < 0.006 (IC base=+0.107)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.125 (n=321)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.63€ cuando `hora_utc` > 6.0 (IC base=+0.107)

- **PATRÓN** `ibs_20min` > `0.52` → IC=+0.185 (n=277)

  - _Acción_: Kelly boost +0.92€ cuando `ibs_20min` > 0.52 (IC base=+0.107)

- **PATRÓN** `dist_vwap_pct` > `0.1343` → IC=+0.185 (n=144)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` > 0.1343 (IC base=+0.107)

- **PATRÓN** `volumen_regimen` < `1.0669` → IC=+0.126 (n=244)

  - _Acción_: Kelly boost +0.63€ cuando `volumen_regimen` < 1.0669 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` < `0.0677` → IC=+0.140 (n=212)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_pendiente_norm` < 0.0677 (IC base=+0.107)

- **PATRÓN** `volumen_pendiente_norm` > `0.2764` → IC=+0.149 (n=35)

  - _Acción_: Kelly boost +0.74€ cuando `volumen_pendiente_norm` > 0.2764 (IC base=+0.107)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.121 (n=288)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.71` → IC=+0.141 (n=104)

  - _Acción_: Kelly boost +0.71€ cuando `sigma_ewma_delta_pct` < 4.71 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` < `0.6023` → IC=+0.159 (n=42)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` < 0.6023 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.07` → IC=+0.229 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.07 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `2.3732` → IC=+0.154 (n=102)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` < 2.3732 (IC base=+0.048)
...
- **PATRÓN** `sigma_h` < `0.004` → IC=+0.179 (n=135)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.89€ cuando `sigma_h` < 0.004 (IC base=+0.106)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.136 (n=289)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.68€ cuando `hora_utc` > 7.0 (IC base=+0.106)

- **PATRÓN** `ibs_20min` > `0.6816` → IC=+0.235 (n=247)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6816 (IC base=+0.106)

- **PATRÓN** `dist_vwap_pct` > `0.3437` → IC=+0.170 (n=110)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` > 0.3437 (IC base=+0.106)
...
- **PATRÓN** `volumen_regimen` > `0.9419` → IC=+0.141 (n=126)
  ...
  - _Acción_: Kelly boost +0.70€ cuando `volumen_regimen` > 0.9419 (IC base=+0.106)

- **PATRÓN** `volumen_pendiente_norm` > `0.2822` → IC=+0.257 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2822 (IC base=+0.106)

- **PATRÓN** `volumen_spike_ratio` < `1.7261` → IC=+0.171 (n=150)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_spike_ratio` < 1.7261 (IC base=+0.106)
...
- **PATRÓN** `libro_liquidez` > `1749.1894` → IC=+0.199 (n=91)
  ...
  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 1749.1894 (IC base=+0.106)
...
- **PATRÓN** `ibs_20min` > `0.6731` → IC=+0.179 (n=232)
  ...
  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.6731 (IC base=+0.074)

- **PATRÓN** `dist_vwap_pct` > `0.1982` → IC=+0.155 (n=146)

  - _Acción_: Kelly boost +0.78€ cuando `dist_vwap_pct` > 0.1982 (IC base=+0.074)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.438` → IC=+0.173 (n=102)

  - _Acción_: Kelly boost +0.87€ cuando `sigma_ewma_delta_pct` > 5.438 (IC base=+0.074)

- **PATRÓN** `volumen_regimen` > `1.0643` → IC=+0.174 (n=87)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_regimen` > 1.0643 (IC base=+0.074)

- **PATRÓN** `volumen_pendiente_norm` > `0.2448` → IC=+0.167 (n=49)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.2448 (IC base=+0.074)
...
- **FILTRO** `restante_min` < `3.45` → IC=-0.139 (n=120)
...
- **FILTRO** `hora_utc` < `7.0` → IC=-0.144 (n=99)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.092 (n=383)

- **FILTRO** `profundidad_ratio` < `42.5` → IC=-0.130 (n=241)

  - _Acción_: SKIP cuando `profundidad_ratio` < 42.5
  - _Potencial_: sin este filtro IC_bueno=-0.076 (n=241)

- **PATRÓN** `py_entrada` < `0.48` → IC=+0.175 (n=115)

  - _Acción_: Kelly boost +0.88€ cuando `py_entrada` < 0.48 (IC base=+0.030)

- **PATRÓN** `profundidad_ratio` > `99.5` → IC=+0.181 (n=114)

  - _Acción_: Kelly boost +0.91€ cuando `profundidad_ratio` > 99.5 (IC base=+0.030)

### LIQUIDACIONES_DEPTH_FASE0#BTC#15min
- **PATRÓN** `py_entrada` < `0.52` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.52 (IC base=+0.087)

- **PATRÓN** `restante_min` > `9.72` → IC=+0.125 (n=46)

  - _Acción_: Kelly boost +0.62€ cuando `restante_min` > 9.72 (IC base=+0.087)

- **PATRÓN** `hora_utc` > `10.0` → IC=+0.122 (n=43)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.61€ cuando `hora_utc` > 10.0 (IC base=+0.087)

- **PATRÓN** `lag_apertura_s` < `316.92` → IC=+0.125 (n=46)

  - _Acción_: Kelly boost +0.62€ cuando `lag_apertura_s` < 316.92 (IC base=+0.087)

- **PATRÓN** `profundidad_ratio` > `227.6` → IC=+0.197 (n=31)

  - _Acción_: Kelly boost +0.98€ cuando `profundidad_ratio` > 227.6 (IC base=+0.087)
...
- **FILTRO** `profundidad_ratio` < `49.3` → IC=-0.167 (n=25)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.147 (n=15)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.74€ cuando `hora_utc` > 17.0 (IC base=+0.024)
...
- **FILTRO** `py_entrada` > `0.505` → IC=-0.126 (n=241)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.505
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=7482)
...
- **FILTRO** `py_entrada` < `0.475` → IC=-0.168 (n=3481)

  - _Acción_: SKIP cuando `py_entrada` < 0.475
  - _Potencial_: sin este filtro IC_bueno=+0.058 (n=10483)

- **FILTRO** `py_entrada` > `0.59` → IC=-0.167 (n=3614)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.210 (n=598)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.099 (n=1825)

### MOMENTUM_IBS_15M_BALLENA#DOGE#15min
- **FILTRO** `py_entrada` < `0.47` → IC=-0.190 (n=611)

  - _Acción_: SKIP cuando `py_entrada` < 0.47
  - _Potencial_: sin este filtro IC_bueno=+0.105 (n=1855)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.202 (n=632)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.065 (n=1959)

### MOMENTUM_IBS_15M_BALLENA#XRP#15min
- **FILTRO** `py_entrada` < `0.485` → IC=-0.173 (n=597)

  - _Acción_: SKIP cuando `py_entrada` < 0.485
  - _Potencial_: sin este filtro IC_bueno=+0.084 (n=1811)

- **FILTRO** `py_entrada` > `0.57` → IC=-0.176 (n=634)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.147 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.060 (n=2934)
...
- **FILTRO** `hora_utc` < `8.0` → IC=-0.129 (n=9940)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.079 (n=22091)

- **FILTRO** `py_entrada` < `0.34` → IC=-0.273 (n=7826)

  - _Acción_: SKIP cuando `py_entrada` < 0.34
  - _Potencial_: sin este filtro IC_bueno=-0.037 (n=24205)

- **FILTRO** `ibs_7min` < `0.284` → IC=-0.235 (n=8007)

  - _Acción_: SKIP cuando `ibs_7min` < 0.284
  - _Potencial_: sin este filtro IC_bueno=-0.048 (n=24024)

- **FILTRO** `ballena_activa_n` > `15.0` → IC=-0.157 (n=10880)

  - _Acción_: SKIP cuando `ballena_activa_n` > 15.0
  - _Potencial_: sin este filtro IC_bueno=-0.062 (n=21151)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.230 (n=9846)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=30324)

- **FILTRO** `ibs_7min` > `0.2922` → IC=-0.178 (n=10038)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2922
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=30132)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.135 (n=1628)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3664)

- **FILTRO** `py_entrada` < `0.31` → IC=-0.307 (n=1264)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.026 (n=4028)

- **FILTRO** `ibs_7min` < `0.7103` → IC=-0.249 (n=1746)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7103
  - _Potencial_: sin este filtro IC_bueno=-0.017 (n=3546)

- **FILTRO** `ballena_activa_n` > `8.0` → IC=-0.184 (n=1217)

  - _Acción_: SKIP cuando `ballena_activa_n` > 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.066 (n=4075)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.260 (n=1704)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.004 (n=5193)

- **FILTRO** `drift_7min_pct` |x|> `0.1121` → IC=-0.124 (n=2343)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1121
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=4554)

- **FILTRO** `ibs_7min` > `0.7881` → IC=-0.206 (n=1724)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7881
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=5173)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.138 (n=1299)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.086 (n=4233)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.250 (n=1335)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.050 (n=4197)

- **FILTRO** `ibs_7min` < `0.7473` → IC=-0.192 (n=1383)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7473
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=4149)

- **FILTRO** `ballena_activa_n` > `161.0` → IC=-0.174 (n=1376)

  - _Acción_: SKIP cuando `ballena_activa_n` > 161.0
  - _Potencial_: sin este filtro IC_bueno=-0.074 (n=4156)

- **FILTRO** `py_entrada` > `0.65` → IC=-0.253 (n=1399)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4217)

- **FILTRO** `ibs_7min` > `0.2599` → IC=-0.176 (n=1403)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2599
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4213)

- **FILTRO** `ballena_activa_n` > `154.0` → IC=-0.181 (n=1400)

  - _Acción_: SKIP cuando `ballena_activa_n` > 154.0
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4216)

### MOMENTUM_IBS_5M_BALLENA#DOGE#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.165 (n=1430)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.082 (n=3591)

- **FILTRO** `py_entrada` < `0.32` → IC=-0.306 (n=1231)

  - _Acción_: SKIP cuando `py_entrada` < 0.32
  - _Potencial_: sin este filtro IC_bueno=-0.041 (n=3790)

- **FILTRO** `ibs_7min` < `0.1935` → IC=-0.259 (n=1253)

  - _Acción_: SKIP cuando `ibs_7min` < 0.1935
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=3768)

- **FILTRO** `ballena_activa_n` > `7.0` → IC=-0.219 (n=1167)

  - _Acción_: SKIP cuando `ballena_activa_n` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=3854)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.237 (n=1684)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=+0.019 (n=5701)

- **FILTRO** `ibs_7min` > `0.7439` → IC=-0.175 (n=1846)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7439
  - _Potencial_: sin este filtro IC_bueno=+0.006 (n=5539)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.128 (n=1705)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.084 (n=3575)

- **FILTRO** `py_entrada` < `0.37` → IC=-0.231 (n=1564)

  - _Acción_: SKIP cuando `py_entrada` < 0.37
  - _Potencial_: sin este filtro IC_bueno=-0.043 (n=3716)

- **FILTRO** `ibs_7min` < `0.7407` → IC=-0.181 (n=1319)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7407
  - _Potencial_: sin este filtro IC_bueno=-0.070 (n=3961)

- **FILTRO** `ballena_activa_n` > `32.0` → IC=-0.170 (n=1302)

  - _Acción_: SKIP cuando `ballena_activa_n` > 32.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=3978)

- **FILTRO** `py_entrada` > `0.66` → IC=-0.260 (n=1348)

  - _Acción_: SKIP cuando `py_entrada` > 0.66
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=4047)

- **FILTRO** `ibs_7min` > `0.2745` → IC=-0.177 (n=1348)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2745
  - _Potencial_: sin este filtro IC_bueno=-0.057 (n=4047)

- **FILTRO** `ballena_activa_n` > `30.0` → IC=-0.186 (n=1337)

  - _Acción_: SKIP cuando `ballena_activa_n` > 30.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=4058)

### MOMENTUM_IBS_5M_BALLENA#SOL#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.257 (n=1361)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.021 (n=4233)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.239 (n=1396)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.025 (n=4198)

- **FILTRO** `py_entrada` > `0.61` → IC=-0.177 (n=1815)

  - _Acción_: SKIP cuando `py_entrada` > 0.61
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=5824)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.38` → IC=-0.255 (n=1712)

  - _Acción_: SKIP cuando `py_entrada` < 0.38
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=3600)

- **FILTRO** `ibs_7min` < `0.7` → IC=-0.227 (n=1315)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.214 (n=1293)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.053 (n=4019)

- **FILTRO** `py_entrada` > `0.67` → IC=-0.205 (n=1731)

  - _Acción_: SKIP cuando `py_entrada` > 0.67
  - _Potencial_: sin este filtro IC_bueno=+0.011 (n=5507)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.324 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1071)
...
### ORDER_FLOW_5M
- **PATRÓN** `delta_ratio` |x|> `0.4161` → IC=+0.140 (n=490)
  - _Por qué funciona_: delta_ratio alto → flow informado visible; edge real en el desequilibrio
  - _Acción_: Kelly boost +0.70€ cuando `delta_ratio` |x|> 0.4161 (IC base=+0.110)

- **PATRÓN** `hora_utc` > `13.0` → IC=+0.124 (n=368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.62€ cuando `hora_utc` > 13.0 (IC base=+0.110)
...
- **FILTRO** `py_entrada` < `0.5` → IC=-0.121 (n=27)
  ...
  - _Acción_: SKIP cuando `py_entrada` < 0.5
  - _Potencial_: sin este filtro IC_bueno=+0.033 (n=743)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.167 (n=19)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.018 (n=2883)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.215 (n=360)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `drift_15min` |x|≤ `0.3839` → IC=+0.205 (n=120)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.3839 (IC base=+0.205)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1443` → IC=+0.272 (n=125)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1443 (IC base=+0.205)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.234 (n=333)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.205)

- **PATRÓN** `ibs_15` > `0.7064` → IC=+0.271 (n=360)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.7064 (IC base=+0.205)

- **PATRÓN** `dist_vwap_pct` > `0.4066` → IC=+0.250 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4066 (IC base=+0.205)

- **PATRÓN** `sigma_ewma_delta_pct` > `19.385` → IC=+0.270 (n=111)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 19.385 (IC base=+0.205)

- **PATRÓN** `libro_liquidez` > `16111.0352` → IC=+0.246 (n=120)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 16111.0352 (IC base=+0.205)
...
- **PATRÓN** `sigma_h` < `0.0041` → IC=+0.148 (n=163)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.74€ cuando `sigma_h` < 0.0041 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0051` → IC=+0.161 (n=246)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.81€ cuando `sigma_h` > 0.0051 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.0674` → IC=+0.148 (n=163)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.74€ cuando `drift_60min` |x|≤ 0.0674 (IC base=+0.135)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.263` → IC=+0.155 (n=262)

  - _Acción_: Kelly boost +0.78€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.263 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.159 (n=271)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.80€ cuando `hora_utc` > 11.0 (IC base=+0.135)

- **PATRÓN** `ibs_15` > `0.662` → IC=+0.249 (n=329)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.1604` → IC=+0.148 (n=291)

  - _Acción_: Kelly boost +0.74€ cuando `dist_vwap_pct` < 0.1604 (IC base=+0.135)
...
- **PATRÓN** `libro_liquidez` > `9584.2249` → IC=+0.157 (n=167)

  - _Acción_: Kelly boost +0.78€ cuando `libro_liquidez` > 9584.2249 (IC base=+0.135)
...
- **PATRÓN** `ibs_15` < `0.1159` → IC=+0.162 (n=468)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.81€ cuando `ibs_15` < 0.1159 (IC base=+0.048)
...
- **FILTRO** `sigma_h` > `0.013` → IC=-0.218 (n=650)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.013
  - _Potencial_: sin este filtro IC_bueno=-0.008 (n=1953)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.191 (n=878)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.005 (n=1725)

- **FILTRO** `libro_liquidez` < `3914.9244` → IC=-0.137 (n=1717)

  - _Acción_: SKIP cuando `libro_liquidez` < 3914.9244
  - _Potencial_: sin este filtro IC_bueno=+0.087 (n=886)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1366` → IC=+0.254 (n=201)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1366 (IC base=-0.061)

- **PATRÓN** `ibs_15` > `0.6371` → IC=+0.274 (n=625)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.6371 (IC base=-0.061)

- **PATRÓN** `dist_vwap_pct` < `0.2788` → IC=+0.184 (n=495)

  - _Acción_: Kelly boost +0.92€ cuando `dist_vwap_pct` < 0.2788 (IC base=-0.061)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1198` → IC=+0.245 (n=1147)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +1.00€ cuando `delta_ratio_macro` |x|> 0.1198 (IC base=-0.033)

- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.177` → IC=+0.235 (n=1111)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.177 (IC base=-0.033)

- **PATRÓN** `ibs_15` < `0.3453` → IC=+0.278 (n=1721)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3453 (IC base=-0.033)

- **PATRÓN** `dist_vwap_pct` > `0.6882` → IC=+0.287 (n=275)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.6882 (IC base=-0.033)

### UPDOWN_GBM_15M_TARDIO#BTC#15min
- **FILTRO** `sigma_h` > `0.0068` → IC=-0.219 (n=396)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: SKIP cuando `sigma_h` > 0.0068
  - _Potencial_: sin este filtro IC_bueno=-0.190 (n=1190)

- **FILTRO** `sigma_h` < `0.0034` → IC=-0.231 (n=396)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: SKIP cuando `sigma_h` < 0.0034
  - _Potencial_: sin este filtro IC_bueno=-0.185 (n=1190)

- **FILTRO** `hora_utc` > `7.0` → IC=-0.208 (n=1001)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: SKIP cuando `hora_utc` > 7.0
  - _Potencial_: sin este filtro IC_bueno=-0.178 (n=585)

- **FILTRO** `sigma_ewma_delta_pct` > `23.623` → IC=-0.245 (n=222)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 23.623
  - _Potencial_: sin este filtro IC_bueno=-0.189 (n=1364)
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.1373` → IC=+0.322 (n=71)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.1373 (IC base=+0.082)

- **PATRÓN** `ibs_15` > `0.7466` → IC=+0.327 (n=171)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.5746` → IC=+0.275 (n=185)
...
- **PATRÓN** `drift_15min` |x|≤ `0.7897` → IC=+0.230 (n=595)

  - _Acción_: Kelly boost +1.00€ cuando `drift_15min` |x|≤ 0.7897 (IC base=+0.225)
...
- **PATRÓN** `ibs_15` < `0.3452` → IC=+0.267 (n=676)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` < 0.3452 (IC base=+0.225)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `20.251` → IC=+0.250 (n=82)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 20.251 (IC base=+0.225)

- **PATRÓN** `sigma_ewma_delta_pct` < `12.221` → IC=+0.231 (n=720)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 12.221 (IC base=+0.225)

- **PATRÓN** `libro_liquidez` > `3546.5572` → IC=+0.226 (n=676)
...
- **FILTRO** `drift_60min` |x|> `0.1671` → IC=-0.220 (n=209)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.140 (n=406)
...
### UPDOWN_GBM_IBS_ALTO
- **PATRÓN** `sigma_h` < `0.0045` → IC=+0.297 (n=437)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.296 (n=802)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.01 (IC base=+0.293)

- **PATRÓN** `libro_liquidez` > `13084.0601` → IC=+0.306 (n=297)
...
- **PATRÓN** `drift_60min` |x|≤ `0.058` → IC=+0.347 (n=122)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `divergencia_cvd_spot_perp` |x|≤ `0.3807` → IC=+0.307 (n=294)

  - _Acción_: Kelly boost +1.00€ cuando `divergencia_cvd_spot_perp` |x|≤ 0.3807 (IC base=+0.286)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.305 (n=382)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 4.0 (IC base=+0.286)

- **PATRÓN** `ibs_15` > `0.8305` → IC=+0.316 (n=363)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.8305 (IC base=+0.286)
...
- **PATRÓN** `libro_liquidez` > `16193.642` → IC=+0.329 (n=121)
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.6053 sube el IC de +0.185 a +0.266 en UPDOWN_GBM#15min (n=1576). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#BTC#15min**: dentro de BUY_YES, IBS > 0.7064 sube el IC de +0.205 a +0.271 en UPDOWN_GBM#BTC#15min (n=360). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#ETH#15min**: dentro de BUY_YES, IBS > 0.662 sube el IC de +0.135 a +0.249 en UPDOWN_GBM#ETH#15min (n=329). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1159 sube el IC de +0.048 a +0.162 en UPDOWN_GBM#XRP#15min (n=468). Ya aplicado como kelly_boost=+0.81€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.6371 sube el IC de -0.061 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=625). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3453 sube el IC de -0.033 a +0.278 en UPDOWN_GBM_15M_TARDIO (n=1721). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO#BTC#15min**: dentro de BUY_YES, IBS > 0.7466 sube el IC de +0.082 a +0.327 en UPDOWN_GBM_15M_TARDIO#BTC#15min (n=171). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#ETH#15min**: dentro de BUY_NO, IBS < 0.3452 sube el IC de +0.225 a +0.267 en UPDOWN_GBM_15M_TARDIO#ETH#15min (n=676). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_IBS_ALTO**: dentro de BUY_YES, IBS > 0.8404 sube el IC de +0.293 a +0.328 en UPDOWN_GBM_IBS_ALTO (n=655). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_IBS_ALTO#BTC#15min**: dentro de BUY_YES, IBS > 0.8305 sube el IC de +0.286 a +0.316 en UPDOWN_GBM_IBS_ALTO#BTC#15min (n=363). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
|---|---|---|---|---|---|
| ✅ BALLENAS_CONFIRMADAS_15M | 1313 | +0.099 | +194.90€ | 1 | 9 |
| ✅ BALLENAS_CONFIRMADAS_15M#15min | 1313 | +0.099 | +194.90€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#DOGE#15min | 26 | +0.036 | -1.50€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH | 978 | +0.108 | +168.00€ | 0 | 0 |
| ✅ BALLENAS_CONFIRMADAS_15M#ETH#15min | 978 | +0.108 | +168.00€ | 2 | 8 |
...
| ✅ BALLENAS_TARDIAS | 24976 | -0.092 | -3199.71€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 1444 | -0.049 | -221.33€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 23532 | -0.095 | -2978.38€ | 0 | 0 |
...
| ✅ BALLENAS_TARDIAS#ETH | 7219 | -0.025 | -680.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 7219 | -0.025 | -680.85€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 6717 | -0.099 | -465.31€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 6717 | -0.099 | -465.31€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 5539 | -0.181 | -1082.57€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 5539 | -0.181 | -1082.57€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 17908 | -0.028 | +4056.49€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 4681 | +0.000 | +1827.82€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 