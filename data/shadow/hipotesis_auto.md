# Hipótesis automáticas — 2026-09-04 22:15 UTC
_Generado por shadow_postmortem.py sobre 286862 resoluciones (PNL=+28185.43€)_
...
### BALLENAS_TARDIAS
- **FILTRO** `restante_s_al_confirmar` < `147.44` → IC=-0.299 (n=3857)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 147.44
  - _Potencial_: sin este filtro IC_bueno=-0.054 (n=11571)
...
- **FILTRO** `restante_s_al_confirmar` < `115.55` → IC=-0.403 (n=514)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.098 (n=1544)

### BALLENAS_TARDIAS#SOL#5min
- **FILTRO** `restante_s_al_confirmar` < `144.66` → IC=-0.311 (n=855)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 144.66
  - _Potencial_: sin este filtro IC_bueno=-0.067 (n=2566)

### BALLENAS_TARDIAS#XRP#5min
- **FILTRO** `restante_s_al_confirmar` < `158.23` → IC=-0.377 (n=928)

  - _Acción_: SKIP cuando `restante_s_al_confirmar` < 158.23
  - _Potencial_: sin este filtro IC_bueno=-0.101 (n=1887)

### FAVORITO_CONFIRMADO
- **PATRÓN** `py_entrada` > `0.7` → IC=+0.190 (n=8185)
...
- **PATRÓN** `libro_liquidez` > `2371.8427` → IC=+0.169 (n=1995)

  - _Acción_: Kelly boost +0.84€ cuando `libro_liquidez` > 2371.8427 (IC base=+0.096)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.149 (n=5767)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.34` → IC=+0.254 (n=5094)
...
- **PATRÓN** `libro_liquidez` > `1944.7027` → IC=+0.174 (n=3402)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1944.7027 (IC base=+0.140)

### FAVORITO_CONFIRMADO#BTC#15min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.217 (n=888)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `13169.0911` → IC=+0.220 (n=402)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=675)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.143 (n=1692)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `11.0` → IC=+0.139 (n=275)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.216 (n=403)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.182)

- **PATRÓN** `py_entrada` > `0.84` → IC=+0.426 (n=418)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.205 (n=290)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_liquidez` > `932.5146` → IC=+0.210 (n=798)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 932.5146 (IC base=+0.203)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.125 (n=545)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.195 (n=6368)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.179 (n=1635)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.176 (n=1537)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` < `0.74` → IC=+0.175 (n=1645)
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.246 (n=1370)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.196 (n=1563)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.72` → IC=+0.181 (n=2685)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.72 (IC base=+0.150)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.228 (n=3143)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.178 (n=1149)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.71` → IC=+0.181 (n=3141)

  - _Acción_: Kelly boost +0.91€ cuando `py_entrada` > 0.71 (IC base=+0.163)

### FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#ETH#5min
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.231 (n=1605)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.204 (n=2974)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.186 (n=3008)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `py_entrada` > `0.75` → IC=+0.231 (n=1535)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` > 0.75 (IC base=+0.184)

### FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA
- **PATRÓN** `py_entrada` < `0.38` → IC=+0.204 (n=2580)

  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.38 (IC base=+0.131)

- **PATRÓN** `restante_min` < `4.0` → IC=+0.141 (n=2410)

  - _Acción_: Kelly boost +0.71€ cuando `restante_min` < 4.0 (IC base=+0.131)

- **PATRÓN** `restante_min` > `4.94` → IC=+0.158 (n=2413)
...
- **PATRÓN** `lag_apertura_s` < `3.87` → IC=+0.158 (n=2407)
...
- **PATRÓN** `restante_min` < `3.95` → IC=+0.150 (n=1200)
...
- **PATRÓN** `lag_apertura_s` < `3.28` → IC=+0.168 (n=1213)
...
- **PATRÓN** `hora_utc` > `17.0` → IC=+0.312 (n=163)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `libro_spread` < `0.03` → IC=+0.279 (n=441)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.03 (IC base=+0.259)

- **PATRÓN** `libro_liquidez` > `1058.8097` → IC=+0.276 (n=386)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1058.8097 (IC base=+0.259)
...
### GBM_LATE_15M
- **PATRÓN** `ibs_20min` > `0.3614` → IC=+0.130 (n=3843)

  - _Acción_: Kelly boost +0.65€ cuando `ibs_20min` > 0.3614 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` > `0.1833` → IC=+0.224 (n=545)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1833 (IC base=+0.083)

- **PATRÓN** `dist_vwap_pct` < `0.4705` → IC=+0.226 (n=823)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4705 (IC base=+0.083)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.65` → IC=+0.152 (n=1465)

  - _Acción_: Kelly boost +0.76€ cuando `sigma_ewma_delta_pct` > 5.65 (IC base=+0.083)

- **PATRÓN** `volumen_regimen` < `0.6932` → IC=+0.228 (n=391)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.6932 (IC base=+0.083)

- **PATRÓN** `volumen_regimen` > `1.0825` → IC=+0.245 (n=402)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.0825 (IC base=+0.083)

- **PATRÓN** `volumen_pendiente_norm` > `0.1704` → IC=+0.184 (n=663)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_pendiente_norm` > 0.1704 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` < `2.8416` → IC=+0.179 (n=2323)

  - _Acción_: Kelly boost +0.89€ cuando `volumen_spike_ratio` < 2.8416 (IC base=+0.083)

- **PATRÓN** `volumen_spike_ratio` > `1.4731` → IC=+0.175 (n=2323)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.4731 (IC base=+0.083)

- **PATRÓN** `ibs_20min` < `0.4016` → IC=+0.128 (n=3684)

  - _Acción_: Kelly boost +0.64€ cuando `ibs_20min` < 0.4016 (IC base=+0.042)

- **PATRÓN** `dist_vwap_pct` < `0.3396` → IC=+0.145 (n=1369)

  - _Acción_: Kelly boost +0.73€ cuando `dist_vwap_pct` < 0.3396 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` < `0.6867` → IC=+0.145 (n=579)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` < 0.6867 (IC base=+0.042)

- **PATRÓN** `volumen_regimen` > `1.0471` → IC=+0.144 (n=597)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_regimen` > 1.0471 (IC base=+0.042)

- **PATRÓN** `volumen_pendiente_norm` > `0.3031` → IC=+0.238 (n=300)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.3031 (IC base=+0.042)

- **PATRÓN** `volumen_spike_ratio` > `2.8133` → IC=+0.214 (n=670)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8133 (IC base=+0.042)

- **PATRÓN** `ballena_activa_n` < `122.0` → IC=+0.210 (n=1546)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 122.0 (IC base=+0.042)

### GBM_LATE_15M#BNB#15min
- **PATRÓN** `sigma_h` > `0.0063` → IC=+0.175 (n=573)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.87€ cuando `sigma_h` > 0.0063 (IC base=+0.154)

- **PATRÓN** `drift_60min` |x|≤ `0.2868` → IC=+0.156 (n=856)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.78€ cuando `drift_60min` |x|≤ 0.2868 (IC base=+0.154)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `6.685` → IC=+0.297 (n=264)
...
- **PATRÓN** `volumen_spike_ratio` < `2.6455` → IC=+0.140 (n=759)

  - _Acción_: Kelly boost +0.70€ cuando `volumen_spike_ratio` < 2.6455 (IC base=+0.154)

- **PATRÓN** `volumen_spike_ratio` > `1.4427` → IC=+0.144 (n=759)

  - _Acción_: Kelly boost +0.72€ cuando `volumen_spike_ratio` > 1.4427 (IC base=+0.154)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.188 (n=704)

  - _Acción_: Kelly boost +0.94€ cuando `libro_spread` < 0.04 (IC base=+0.154)

- **PATRÓN** `ballena_activa_n` < `64.0` → IC=+0.187 (n=506)
...
- **PATRÓN** `hora_utc` > `7.0` → IC=+0.264 (n=531)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4048` → IC=+0.282 (n=511)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4048 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.474` → IC=+0.261 (n=69)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.474 (IC base=+0.258)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.069` → IC=+0.258 (n=423)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.268 (n=580)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.258)

- **PATRÓN** `libro_liquidez` > `1709.5178` → IC=+0.281 (n=387)
...
- **PATRÓN** `sigma_h` < `0.0035` → IC=+0.249 (n=297)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0035 (IC base=+0.214)

- **PATRÓN** `sigma_h` > `0.0068` → IC=+0.218 (n=225)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0068 (IC base=+0.214)

- **PATRÓN** `drift_60min` |x|≤ `0.0967` → IC=+0.241 (n=226)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.0967 (IC base=+0.214)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.236 (n=676)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` < `0.4813` → IC=+0.219 (n=618)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.4813 (IC base=+0.214)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `7.07` → IC=+0.215 (n=676)
...
- **FILTRO** `ibs_20min` > `0.8241` → IC=-0.178 (n=299)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.008 (n=900)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.149 (n=72)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=1127)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8023` → IC=+0.160 (n=142)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_spike_ratio` > 1.8023 (IC base=-0.039)
...
- **FILTRO** `sigma_ewma_delta_pct` > `8.354` → IC=-0.189 (n=207)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.354
...
- **FILTRO** `ibs_20min` > `0.79` → IC=-0.193 (n=428)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=1290)

- **FILTRO** `sigma_ewma_delta_pct` > `8.99` → IC=-0.135 (n=198)

  - _Acción_: SKIP cuando `sigma_ewma_delta_pct` > 8.99
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=1520)
...
- **PATRÓN** `volumen_spike_ratio` > `1.8908` → IC=+0.174 (n=87)

  - _Acción_: Kelly boost +0.87€ cuando `volumen_spike_ratio` > 1.8908 (IC base=-0.047)
...
- **PATRÓN** `sigma_h` > `0.0094` → IC=+0.175 (n=1579)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0094 (IC base=+0.076)

- **PATRÓN** `ibs_20min` > `0.3` → IC=+0.145 (n=4742)
...
- **PATRÓN** `volumen_regimen` > `0.6802` → IC=+0.221 (n=1383)
...
- **PATRÓN** `volumen_spike_ratio` > `2.8014` → IC=+0.217 (n=783)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.8014 (IC base=+0.076)

- **PATRÓN** `ballena_activa_n` < `100.0` → IC=+0.294 (n=1810)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 100.0 (IC base=+0.076)

- **PATRÓN** `ibs_20min` < `0.5833` → IC=+0.132 (n=4575)

  - _Acción_: Kelly boost +0.66€ cuando `ibs_20min` < 0.5833 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` > `0.7837` → IC=+0.247 (n=219)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7837 (IC base=+0.054)

- **PATRÓN** `dist_vwap_pct` < `0.2275` → IC=+0.222 (n=1127)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2275 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` < `0.7084` → IC=+0.222 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.7084 (IC base=+0.054)

- **PATRÓN** `volumen_regimen` > `1.2256` → IC=+0.250 (n=394)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.2256 (IC base=+0.054)

- **PATRÓN** `volumen_pendiente_norm` > `0.2563` → IC=+0.340 (n=280)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2563 (IC base=+0.054)

- **PATRÓN** `volumen_spike_ratio` > `2.4031` → IC=+0.276 (n=624)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.4031 (IC base=+0.054)

- **PATRÓN** `ballena_activa_n` < `68.0` → IC=+0.268 (n=1216)

  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 68.0 (IC base=+0.054)
...
- **FILTRO** `sigma_ewma_delta_pct` > `2.451` → IC=-0.161 (n=349)
...
- **FILTRO** `ibs_20min` > `0.8618` → IC=-0.159 (n=394)

  - _Acción_: SKIP cuando `ibs_20min` > 0.8618
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=1186)

- **PATRÓN** `volumen_spike_ratio` < `2.0452` → IC=+0.124 (n=309)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.0452 (IC base=-0.010)

- **PATRÓN** `ballena_activa_n` < `261.0` → IC=+0.152 (n=113)

  - _Acción_: Kelly boost +0.76€ cuando `ballena_activa_n` < 261.0 (IC base=-0.010)

- **PATRÓN** `dist_vwap_pct` < `0.123` → IC=+0.163 (n=182)
...
- **PATRÓN** `volumen_regimen` > `1.1078` → IC=+0.177 (n=63)
  ...
  - _Acción_: Kelly boost +0.88€ cuando `volumen_regimen` > 1.1078 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` < `0.0635` → IC=+0.146 (n=145)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_pendiente_norm` < 0.0635 (IC base=-0.025)

- **PATRÓN** `volumen_pendiente_norm` > `0.1467` → IC=+0.167 (n=31)

  - _Acción_: Kelly boost +0.83€ cuando `volumen_pendiente_norm` > 0.1467 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` < `1.9755` → IC=+0.192 (n=128)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_spike_ratio` < 1.9755 (IC base=-0.025)

- **PATRÓN** `volumen_spike_ratio` > `1.3934` → IC=+0.153 (n=145)

  - _Acción_: Kelly boost +0.77€ cuando `volumen_spike_ratio` > 1.3934 (IC base=-0.025)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1246` → IC=+0.231 (n=336)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.358` → IC=+0.301 (n=184)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.358 (IC base=+0.228)

- **PATRÓN** `volumen_pendiente_norm` < `0.11` → IC=+0.241 (n=623)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.11 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` < `2.4282` → IC=+0.228 (n=453)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.4282 (IC base=+0.228)

- **PATRÓN** `volumen_spike_ratio` > `1.727` → IC=+0.234 (n=679)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.727 (IC base=+0.228)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.256 (n=793)
...
- **FILTRO** `ibs_20min` > `0.7357` → IC=-0.146 (n=422)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7357
  - _Potencial_: sin este filtro IC_bueno=+0.016 (n=822)
...
- **PATRÓN** `dist_vwap_pct` < `0.2061` → IC=+0.282 (n=745)
...
- **PATRÓN** `volumen_regimen` > `1.096` → IC=+0.304 (n=371)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.096 (IC base=+0.278)

- **PATRÓN** `volumen_pendiente_norm` > `0.2891` → IC=+0.389 (n=97)
...
- **PATRÓN** `volumen_spike_ratio` > `2.1847` → IC=+0.295 (n=301)
...
- **PATRÓN** `drift_60min` |x|≤ `0.3422` → IC=+0.171 (n=3512)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.86€ cuando `drift_60min` |x|≤ 0.3422 (IC base=+0.162)

- **PATRÓN** `hora_utc` > `17.0` → IC=+0.181 (n=1454)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `hora_utc` > `15.0` → IC=+0.195 (n=1794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4385` → IC=+0.227 (n=3717)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4385 (IC base=+0.177)

- **PATRÓN** `dist_vwap_pct` < `0.2267` → IC=+0.170 (n=2819)

  - _Acción_: Kelly boost +0.85€ cuando `dist_vwap_pct` < 0.2267 (IC base=+0.177)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.033` → IC=+0.213 (n=660)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.033 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` < `1.1724` → IC=+0.165 (n=2803)

  - _Acción_: Kelly boost +0.82€ cuando `volumen_regimen` < 1.1724 (IC base=+0.177)

- **PATRÓN** `volumen_regimen` > `0.6221` → IC=+0.160 (n=2803)
...
- **PATRÓN** `volumen_spike_ratio` > `2.6529` → IC=+0.202 (n=1030)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.6529 (IC base=+0.177)

- **PATRÓN** `ballena_activa_n` < `157.0` → IC=+0.177 (n=2676)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1645` → IC=+0.310 (n=282)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.2708` → IC=+0.267 (n=372)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.2708 (IC base=+0.242)

- **PATRÓN** `sigma_ewma_delta_pct` < `4.691` → IC=+0.253 (n=463)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 4.691 (IC base=+0.242)

- **PATRÓN** `volumen_pendiente_norm` < `0.0675` → IC=+0.230 (n=305)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0675 (IC base=+0.242)
...
- **PATRÓN** `volumen_spike_ratio` < `1.9129` → IC=+0.236 (n=237)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.9129 (IC base=+0.242)
...
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.233 (n=200)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0037 (IC base=+0.156)

- **PATRÓN** `drift_60min` |x|≤ `0.3661` → IC=+0.167 (n=527)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.84€ cuando `drift_60min` |x|≤ 0.3661 (IC base=+0.156)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.172 (n=611)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.86€ cuando `hora_utc` > 6.0 (IC base=+0.156)

- **PATRÓN** `ibs_20min` > `0.4362` → IC=+0.202 (n=599)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.158 (n=671)
...
- **PATRÓN** `ballena_activa_n` < `136.0` → IC=+0.148 (n=359)
...
- **PATRÓN** `sigma_h` > `0.0104` → IC=+0.184 (n=340)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.92€ cuando `sigma_h` > 0.0104 (IC base=+0.113)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.128 (n=789)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.64€ cuando `hora_utc` > 5.0 (IC base=+0.113)

- **PATRÓN** `ibs_20min` > `0.5357` → IC=+0.190 (n=750)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `9.303` → IC=+0.271 (n=164)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.303 (IC base=+0.113)

- **PATRÓN** `volumen_regimen` > `0.6282` → IC=+0.122 (n=750)

  - _Acción_: Kelly boost +0.61€ cuando `volumen_regimen` > 0.6282 (IC base=+0.113)

- **PATRÓN** `volumen_pendiente_norm` < `0.1692` → IC=+0.129 (n=750)

  - _Acción_: Kelly boost +0.64€ cuando `volumen_pendiente_norm` < 0.1692 (IC base=+0.113)

- **PATRÓN** `volumen_spike_ratio` < `2.5029` → IC=+0.124 (n=714)

  - _Acción_: Kelly boost +0.62€ cuando `volumen_spike_ratio` < 2.5029 (IC base=+0.113)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1678` → IC=+0.217 (n=334)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1678 (IC base=+0.192)

- **PATRÓN** `hora_utc` > `5.0` → IC=+0.201 (n=794)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.172` → IC=+0.237 (n=375)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 3.172 (IC base=+0.192)

- **PATRÓN** `volumen_regimen` > `0.6862` → IC=+0.210 (n=678)
...
- **PATRÓN** `volumen_spike_ratio` < `2.5204` → IC=+0.210 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.5204 (IC base=+0.192)

- **PATRÓN** `volumen_spike_ratio` > `1.5152` → IC=+0.197 (n=642)
...
- **PATRÓN** `drift_60min` |x|≤ `0.6471` → IC=+0.218 (n=772)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
...
- **PATRÓN** `ibs_20min` < `0.4118` → IC=+0.256 (n=772)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4118 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.5141` → IC=+0.215 (n=858)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.5141 (IC base=+0.210)

- **PATRÓN** `sigma_ewma_delta_pct` > `7.918` → IC=+0.269 (n=154)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 7.918 (IC base=+0.210)

- **PATRÓN** `volumen_regimen` > `0.6912` → IC=+0.237 (n=690)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.6912 (IC base=+0.210)
...
- **PATRÓN** `sigma_h` > `0.008` → IC=+0.170 (n=392)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.85€ cuando `sigma_h` > 0.008 (IC base=+0.140)

- **PATRÓN** `drift_60min` |x|≤ `0.0973` → IC=+0.146 (n=289)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.73€ cuando `drift_60min` |x|≤ 0.0973 (IC base=+0.140)

- **PATRÓN** `hora_utc` > `8.0` → IC=+0.168 (n=825)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.84€ cuando `hora_utc` > 8.0 (IC base=+0.140)

- **PATRÓN** `ibs_20min` > `0.4481` → IC=+0.171 (n=864)

  - _Acción_: Kelly boost +0.85€ cuando `ibs_20min` > 0.4481 (IC base=+0.140)

- **PATRÓN** `dist_vwap_pct` > `0.964` → IC=+0.232 (n=106)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.964 (IC base=+0.140)

- **PATRÓN** `sigma_ewma_delta_pct` > `3.627` → IC=+0.179 (n=397)

  - _Acción_: Kelly boost +0.90€ cuando `sigma_ewma_delta_pct` > 3.627 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` < `0.8649` → IC=+0.159 (n=464)

  - _Acción_: Kelly boost +0.79€ cuando `volumen_regimen` < 0.8649 (IC base=+0.140)

- **PATRÓN** `volumen_regimen` > `1.1634` → IC=+0.145 (n=232)

  - _Acción_: Kelly boost +0.73€ cuando `volumen_regimen` > 1.1634 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` < `0.0754` → IC=+0.141 (n=728)

  - _Acción_: Kelly boost +0.71€ cuando `volumen_pendiente_norm` < 0.0754 (IC base=+0.140)

- **PATRÓN** `volumen_pendiente_norm` > `0.1708` → IC=+0.172 (n=236)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` > 0.1708 (IC base=+0.140)

- **PATRÓN** `volumen_spike_ratio` < `2.254` → IC=+0.150 (n=713)
...
- **PATRÓN** `libro_spread` < `0.02` → IC=+0.150 (n=901)

  - _Acción_: Kelly boost +0.75€ cuando `libro_spread` < 0.02 (IC base=+0.140)

- **PATRÓN** `libro_liquidez` > `9305.5773` → IC=+0.186 (n=288)

  - _Acción_: Kelly boost +0.93€ cuando `libro_liquidez` > 9305.5773 (IC base=+0.140)
...
- **PATRÓN** `sigma_h` < `0.0052` → IC=+0.271 (n=151)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
...
- **PATRÓN** `hora_utc` > `6.0` → IC=+0.293 (n=225)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 6.0 (IC base=+0.258)

- **PATRÓN** `ibs_20min` > `0.3963` → IC=+0.284 (n=225)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.3963 (IC base=+0.258)

- **PATRÓN** `dist_vwap_pct` > `0.1675` → IC=+0.290 (n=103)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.1675 (IC base=+0.258)

- **PATRÓN** `sigma_ewma_delta_pct` > `4.256` → IC=+0.314 (n=100)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 4.256 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` < `0.8258` → IC=+0.271 (n=151)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` < 0.8258 (IC base=+0.258)

- **PATRÓN** `volumen_regimen` > `1.1387` → IC=+0.331 (n=75)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 1.1387 (IC base=+0.258)

- **PATRÓN** `volumen_pendiente_norm` > `0.2439` → IC=+0.368 (n=36)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2439 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` < `1.3667` → IC=+0.289 (n=74)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 1.3667 (IC base=+0.258)

- **PATRÓN** `volumen_spike_ratio` > `2.0296` → IC=+0.324 (n=100)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0087` → IC=+0.200 (n=2188)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` > 0.0087 (IC base=+0.164)

- **PATRÓN** `hora_utc` > `6.0` → IC=+0.171 (n=4852)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `dist_vwap_pct` > `0.7605` → IC=+0.213 (n=912)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7605 (IC base=+0.164)
...
- **PATRÓN** `ibs_20min` < `0.56` → IC=+0.240 (n=4440)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.56 (IC base=+0.187)

- **PATRÓN** `dist_vwap_pct` < `0.448` → IC=+0.171 (n=3151)

  - _Acción_: Kelly boost +0.86€ cuando `dist_vwap_pct` < 0.448 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` > `9.698` → IC=+0.216 (n=629)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 9.698 (IC base=+0.187)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.703` → IC=+0.189 (n=4152)
...
- **PATRÓN** `volumen_spike_ratio` > `2.2973` → IC=+0.202 (n=1690)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 2.2973 (IC base=+0.187)

- **PATRÓN** `ballena_activa_n` < `143.0` → IC=+0.182 (n=3308)
...
- **PATRÓN** `drift_60min` |x|≤ `0.1847` → IC=+0.298 (n=394)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.1847 (IC base=+0.269)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.278 (n=538)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_20min` < `0.4058` → IC=+0.303 (n=520)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4058 (IC base=+0.269)

- **PATRÓN** `sigma_ewma_delta_pct` < `2.577` → IC=+0.285 (n=599)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `4.396` → IC=+0.166 (n=693)
...
- **PATRÓN** `volumen_regimen` > `1.0941` → IC=+0.160 (n=360)

  - _Acción_: Kelly boost +0.80€ cuando `volumen_regimen` > 1.0941 (IC base=+0.158)

- **PATRÓN** `volumen_pendiente_norm` < `0.0706` → IC=+0.170 (n=670)
...
- **PATRÓN** `sigma_h` > `0.0059` → IC=+0.220 (n=701)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
...
- **PATRÓN** `sigma_ewma_delta_pct` > `8.656` → IC=+0.336 (n=163)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.656 (IC base=+0.208)

- **PATRÓN** `volumen_pendiente_norm` < `0.2205` → IC=+0.213 (n=635)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.2205 (IC base=+0.208)

- **PATRÓN** `volumen_spike_ratio` < `3.8947` → IC=+0.206 (n=624)
...
- **PATRÓN** `libro_spread` < `0.04` → IC=+0.236 (n=719)

  - _Acción_: Kelly boost +1.00€ cuando `libro_spread` < 0.04 (IC base=+0.208)

- **PATRÓN** `libro_liquidez` > `1455.0584` → IC=+0.210 (n=698)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1455.0584 (IC base=+0.208)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `12.071` → IC=+0.188 (n=139)

  - _Acción_: Kelly boost +0.94€ cuando `sigma_ewma_delta_pct` > 12.071 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` < `0.8925` → IC=+0.167 (n=533)

  - _Acción_: Kelly boost +0.84€ cuando `volumen_regimen` < 0.8925 (IC base=+0.142)

- **PATRÓN** `volumen_regimen` > `1.2022` → IC=+0.153 (n=266)

  - _Acción_: Kelly boost +0.76€ cuando `volumen_regimen` > 1.2022 (IC base=+0.142)

- **PATRÓN** `volumen_pendiente_norm` > `0.2746` → IC=+0.228 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2746 (IC base=+0.142)

- **PATRÓN** `volumen_spike_ratio` > `2.1431` → IC=+0.195 (n=345)

  - _Acción_: Kelly boost +0.97€ cuando `volumen_spike_ratio` > 2.1431 (IC base=+0.142)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.143 (n=873)

  - _Acción_: Kelly boost +0.72€ cuando `libro_spread` < 0.01 (IC base=+0.142)

- **PATRÓN** `libro_liquidez` > `9561.2883` → IC=+0.234 (n=362)
...
- **PATRÓN** `sigma_h` > `0.0083` → IC=+0.146 (n=558)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` > 0.0083 (IC base=+0.094)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.138 (n=564)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.69€ cuando `hora_utc` > 12.0 (IC base=+0.094)

- **PATRÓN** `ibs_20min` > `0.4762` → IC=+0.179 (n=834)

  - _Acción_: Kelly boost +0.90€ cuando `ibs_20min` > 0.4762 (IC base=+0.094)
...
- **PATRÓN** `libro_spread` < `0.01` → IC=+0.125 (n=580)

  - _Acción_: Kelly boost +0.63€ cuando `libro_spread` < 0.01 (IC base=+0.094)

- **PATRÓN** `libro_liquidez` > `2968.0736` → IC=+0.246 (n=278)
...
- **PATRÓN** `hora_utc` > `5.0` → IC=+0.212 (n=956)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 5.0 (IC base=+0.201)

- **PATRÓN** `ibs_20min` > `0.9333` → IC=+0.292 (n=412)
...
- **PATRÓN** `sigma_ewma_delta_pct` > `3.169` → IC=+0.249 (n=452)
...
- **PATRÓN** `volumen_pendiente_norm` > `0.1029` → IC=+0.245 (n=312)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.1029 (IC base=+0.201)

- **PATRÓN** `volumen_spike_ratio` > `1.8195` → IC=+0.209 (n=572)
...
- **PATRÓN** `drift_60min` |x|≤ `0.5271` → IC=+0.211 (n=880)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +1.00€ cuando `drift_60min` |x|≤ 0.5271 (IC base=+0.210)

- **PATRÓN** `hora_utc` > `7.0` → IC=+0.210 (n=947)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 7.0 (IC base=+0.210)
...
- **PATRÓN** `ibs_20min` < `0.4977` → IC=+0.263 (n=1000)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` < 0.4977 (IC base=+0.210)

- **PATRÓN** `dist_vwap_pct` < `0.2656` → IC=+0.218 (n=916)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` < 0.2656 (IC base=+0.210)
...
- **PATRÓN** `volumen_regimen` > `0.7033` → IC=+0.225 (n=893)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_regimen` > 0.7033 (IC base=+0.210)

- **PATRÓN** `volumen_pendiente_norm` > `0.2831` → IC=+0.308 (n=123)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2831 (IC base=+0.210)

- **PATRÓN** `volumen_spike_ratio` > `1.4567` → IC=+0.203 (n=825)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4567 (IC base=+0.210)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.212 (n=1148)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.206 (n=15)
  ...
  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=+0.129 (n=1775)

- **PATRÓN** `sigma_h` < `0.01` → IC=+0.136 (n=1376)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.68€ cuando `sigma_h` < 0.01 (IC base=+0.122)

- **PATRÓN** `drift_60min` |x|≤ `0.4327` → IC=+0.134 (n=1376)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.67€ cuando `drift_60min` |x|≤ 0.4327 (IC base=+0.122)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.173 (n=534)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.87€ cuando `hora_utc` > 18.0 (IC base=+0.122)

- **PATRÓN** `ibs_20min` > `0.926` → IC=+0.192 (n=521)

  - _Acción_: Kelly boost +0.96€ cuando `ibs_20min` > 0.926 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.483` → IC=+0.139 (n=247)

  - _Acción_: Kelly boost +0.69€ cuando `sigma_ewma_delta_pct` > 10.483 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` < `3.78` → IC=+0.122 (n=1425)

  - _Acción_: Kelly boost +0.61€ cuando `sigma_ewma_delta_pct` < 3.78 (IC base=+0.122)

- **PATRÓN** `volumen_pendiente_norm` > `0.175` → IC=+0.155 (n=424)
...
- **PATRÓN** `sigma_ewma_delta_pct` < `6.341` → IC=+0.137 (n=1341)
...
- **PATRÓN** `volumen_pendiente_norm` < `0.1484` → IC=+0.127 (n=1342)
...
- **PATRÓN** `volumen_spike_ratio` < `2.4869` → IC=+0.135 (n=1329)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_spike_ratio` < 2.4869 (IC base=+0.126)

- **PATRÓN** `volumen_spike_ratio` > `1.7963` → IC=+0.133 (n=886)

  - _Acción_: Kelly boost +0.66€ cuando `volumen_spike_ratio` > 1.7963 (IC base=+0.126)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.129 (n=1775)

  - _Acción_: Kelly boost +0.64€ cuando `libro_spread` < 0.01 (IC base=+0.126)

- **PATRÓN** `libro_liquidez` > `4286.0906` → IC=+0.132 (n=1343)

  - _Acción_: Kelly boost +0.66€ cuando `libro_liquidez` > 4286.0906 (IC base=+0.126)
...
- **PATRÓN** `ballena_activa_n` < `24.0` → IC=+0.326 (n=21)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `ballena_activa_n` < 24.0 (IC base=+0.267)
...
- **PATRÓN** `sigma_h` < `0.0058` → IC=+0.200 (n=245)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0058 (IC base=+0.099)

- **PATRÓN** `hora_utc` > `18.0` → IC=+0.191 (n=134)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.96€ cuando `hora_utc` > 18.0 (IC base=+0.099)

- **PATRÓN** `ibs_20min` > `0.6306` → IC=+0.219 (n=276)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6306 (IC base=+0.099)

- **PATRÓN** `dist_vwap_pct` > `0.8642` → IC=+0.250 (n=38)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.8642 (IC base=+0.099)

- **PATRÓN** `sigma_ewma_delta_pct` > `5.134` → IC=+0.245 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 5.134 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` < `0.8192` → IC=+0.156 (n=184)

  - _Acción_: Kelly boost +0.78€ cuando `volumen_regimen` < 0.8192 (IC base=+0.099)

- **PATRÓN** `volumen_regimen` > `0.5803` → IC=+0.133 (n=276)

  - _Acción_: Kelly boost +0.67€ cuando `volumen_regimen` > 0.5803 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` < `0.1435` → IC=+0.172 (n=172)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_pendiente_norm` < 0.1435 (IC base=+0.099)

- **PATRÓN** `volumen_pendiente_norm` > `0.2582` → IC=+0.311 (n=35)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.2582 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` < `1.9736` → IC=+0.175 (n=155)

  - _Acción_: Kelly boost +0.88€ cuando `volumen_spike_ratio` < 1.9736 (IC base=+0.099)

- **PATRÓN** `volumen_spike_ratio` > `1.4867` → IC=+0.185 (n=157)

  - _Acción_: Kelly boost +0.93€ cuando `volumen_spike_ratio` > 1.4867 (IC base=+0.099)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.170 (n=228)

  - _Acción_: Kelly boost +0.85€ cuando `libro_spread` < 0.02 (IC base=+0.099)

- **PATRÓN** `libro_liquidez` > `1225.9743` → IC=+0.174 (n=225)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 1225.9743 (IC base=+0.099)
...
- **PATRÓN** `sigma_h` < `0.0056` → IC=+0.221 (n=109)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +1.00€ cuando `sigma_h` < 0.0056 (IC base=+0.108)

- **PATRÓN** `hora_utc` > `16.0` → IC=+0.156 (n=59)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.78€ cuando `hora_utc` > 16.0 (IC base=+0.108)

- **PATRÓN** `ibs_20min` > `0.7788` → IC=+0.216 (n=93)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.7788 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.3468` → IC=+0.274 (n=29)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.3468 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `16.35` → IC=+0.250 (n=26)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 16.35 (IC base=+0.108)

- **PATRÓN** `volumen_regimen` < `0.8937` → IC=+0.172 (n=62)

  - _Acción_: Kelly boost +0.86€ cuando `volumen_regimen` < 0.8937 (IC base=+0.108)

- **PATRÓN** `volumen_pendiente_norm` < `0.0635` → IC=+0.208 (n=46)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.0635 (IC base=+0.108)

- **PATRÓN** `volumen_spike_ratio` < `2.0892` → IC=+0.224 (n=56)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` < 2.0892 (IC base=+0.108)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.141 (n=90)

  - _Acción_: Kelly boost +0.71€ cuando `libro_spread` < 0.01 (IC base=+0.108)
...
- **PATRÓN** `sigma_h` < `0.0051` → IC=+0.197 (n=97)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.98€ cuando `sigma_h` < 0.0051 (IC base=+0.124)

- **PATRÓN** `hora_utc` > `15.0` → IC=+0.175 (n=75)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` > 15.0 (IC base=+0.124)

- **PATRÓN** `ibs_20min` > `0.6741` → IC=+0.288 (n=102)

  - _Acción_: Kelly boost +1.00€ cuando `ibs_20min` > 0.6741 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` > `0.4909` → IC=+0.269 (n=24)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.4909 (IC base=+0.124)

- **PATRÓN** `dist_vwap_pct` < `0.1714` → IC=+0.176 (n=100)

  - _Acción_: Kelly boost +0.88€ cuando `dist_vwap_pct` < 0.1714 (IC base=+0.124)

- **PATRÓN** `sigma_ewma_delta_pct` > `10.218` → IC=+0.331 (n=57)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 10.218 (IC base=+0.124)

- **PATRÓN** `volumen_regimen` < `0.7864` → IC=+0.192 (n=76)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` < 0.7864 (IC base=+0.124)

- **PATRÓN** `volumen_pendiente_norm` < `0.1322` → IC=+0.208 (n=63)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` < 0.1322 (IC base=+0.124)
...
- **PATRÓN** `volumen_spike_ratio` > `1.4015` → IC=+0.221 (n=66)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_spike_ratio` > 1.4015 (IC base=+0.124)

- **PATRÓN** `libro_spread` < `0.02` → IC=+0.191 (n=121)

  - _Acción_: Kelly boost +0.96€ cuando `libro_spread` < 0.02 (IC base=+0.124)

- **PATRÓN** `libro_liquidez` > `1225.9743` → IC=+0.221 (n=109)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 1225.9743 (IC base=+0.124)
...
- **PATRÓN** `hora_utc` > `18.0` → IC=+0.206 (n=49)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +1.00€ cuando `hora_utc` > 18.0 (IC base=+0.048)

- **PATRÓN** `ibs_20min` > `0.6744` → IC=+0.167 (n=70)

  - _Acción_: Kelly boost +0.83€ cuando `ibs_20min` > 0.6744 (IC base=+0.048)

- **PATRÓN** `dist_vwap_pct` > `0.9623` → IC=+0.206 (n=15)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.9623 (IC base=+0.048)

- **PATRÓN** `sigma_ewma_delta_pct` > `8.144` → IC=+0.262 (n=19)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 8.144 (IC base=+0.048)

- **PATRÓN** `volumen_regimen` > `1.083` → IC=+0.192 (n=24)

  - _Acción_: Kelly boost +0.96€ cuando `volumen_regimen` > 1.083 (IC base=+0.048)

- **PATRÓN** `volumen_pendiente_norm` > `0.0896` → IC=+0.208 (n=22)

  - _Acción_: Kelly boost +1.00€ cuando `volumen_pendiente_norm` > 0.0896 (IC base=+0.048)

- **PATRÓN** `volumen_spike_ratio` < `2.308` → IC=+0.184 (n=55)

  - _Acción_: Kelly boost +0.92€ cuando `volumen_spike_ratio` < 2.308 (IC base=+0.048)

- **PATRÓN** `libro_spread` < `0.04` → IC=+0.167 (n=22)

  - _Acción_: Kelly boost +0.83€ cuando `libro_spread` < 0.04 (IC base=+0.048)
...
- **FILTRO** `py_entrada` < `0.46` → IC=-0.179 (n=1526)

  - _Acción_: SKIP cuando `py_entrada` < 0.46
  - _Potencial_: sin este filtro IC_bueno=+0.027 (n=4614)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.185 (n=1556)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.009 (n=4830)

### MOMENTUM_IBS_15M_BALLENA#BNB#15min
- **FILTRO** `py_entrada` < `0.41` → IC=-0.226 (n=235)

  - _Acción_: SKIP cuando `py_entrada` < 0.41
  - _Potencial_: sin este filtro IC_bueno=+0.054 (n=722)

- **FILTRO** `ibs_20min` < `0.7368` → IC=-0.208 (n=238)
...
- **FILTRO** `py_entrada` > `0.66` → IC=-0.166 (n=276)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.022 (n=845)
...
- **FILTRO** `ballena_activa_n` > `60.0` → IC=-0.147 (n=250)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=755)

- **FILTRO** `libro_spread` > `0.01` → IC=-0.122 (n=35)

  - _Acción_: SKIP cuando `libro_spread` > 0.01
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=970)
...
- **FILTRO** `py_entrada` > `0.65` → IC=-0.215 (n=251)

  - _Acción_: SKIP cuando `py_entrada` > 0.65
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=837)

- **FILTRO** `ibs_20min` > `0.7143` → IC=-0.199 (n=270)

  - _Acción_: SKIP cuando `ibs_20min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=+0.023 (n=818)
...
- **FILTRO** `py_entrada` > `0.56` → IC=-0.165 (n=249)
  ...
  - _Acción_: SKIP cuando `py_entrada` > 0.56
  - _Potencial_: sin este filtro IC_bueno=-0.014 (n=771)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.176 (n=251)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.010 (n=769)
...
- **FILTRO** `py_entrada` > `0.61` → IC=-0.162 (n=264)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.012 (n=805)
...
- **FILTRO** `py_entrada` > `0.63` → IC=-0.195 (n=260)
  ...
  - _Potencial_: sin este filtro IC_bueno=+0.020 (n=823)

### MOMENTUM_IBS_15M_FADE
- **FILTRO** `hora_utc` < `16.0` → IC=-0.340 (n=48)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 16.0
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=152)
...
- **FILTRO** `hora_utc` < `6.0` → IC=-0.135 (n=3180)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.085 (n=11749)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.282 (n=3651)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.035 (n=11278)

- **FILTRO** `ibs_7min` < `0.7143` → IC=-0.242 (n=3725)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.047 (n=11204)

- **FILTRO** `ballena_activa_n` > `18.0` → IC=-0.169 (n=5059)

  - _Acción_: SKIP cuando `ballena_activa_n` > 18.0
  - _Potencial_: sin este filtro IC_bueno=-0.058 (n=9870)

- **FILTRO** `py_entrada` > `0.68` → IC=-0.221 (n=4619)

  - _Acción_: SKIP cuando `py_entrada` > 0.68
  - _Potencial_: sin este filtro IC_bueno=-0.009 (n=14247)

- **FILTRO** `ibs_7min` > `0.7143` → IC=-0.173 (n=4704)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7143
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=14162)

### MOMENTUM_IBS_5M_BALLENA#BNB#5min
- **FILTRO** `py_entrada` < `0.31` → IC=-0.312 (n=536)

  - _Acción_: SKIP cuando `py_entrada` < 0.31
  - _Potencial_: sin este filtro IC_bueno=-0.045 (n=1649)

- **FILTRO** `ibs_7min` < `0.7014` → IC=-0.255 (n=721)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7014
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=1464)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.220 (n=537)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.075 (n=1648)

- **FILTRO** `py_entrada` > `0.71` → IC=-0.237 (n=817)

  - _Acción_: SKIP cuando `py_entrada` > 0.71
  - _Potencial_: sin este filtro IC_bueno=-0.015 (n=2463)

- **FILTRO** `drift_7min_pct` |x|> `0.1139` → IC=-0.130 (n=1113)

  - _Acción_: SKIP cuando `drift_7min_pct` |x|> 0.1139
  - _Potencial_: sin este filtro IC_bueno=-0.040 (n=2167)

- **FILTRO** `ibs_7min` > `0.8364` → IC=-0.197 (n=819)

  - _Acción_: SKIP cuando `ibs_7min` > 0.8364
  - _Potencial_: sin este filtro IC_bueno=-0.028 (n=2461)

### MOMENTUM_IBS_5M_BALLENA#BTC#5min
- **FILTRO** `hora_utc` < `6.0` → IC=-0.133 (n=603)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 6.0
  - _Potencial_: sin este filtro IC_bueno=-0.072 (n=2166)

- **FILTRO** `py_entrada` < `0.36` → IC=-0.261 (n=671)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.029 (n=2098)

- **FILTRO** `ibs_7min` < `0.7711` → IC=-0.195 (n=692)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7711
  - _Potencial_: sin este filtro IC_bueno=-0.049 (n=2077)

- **FILTRO** `ballena_activa_n` > `168.0` → IC=-0.179 (n=689)

  - _Acción_: SKIP cuando `ballena_activa_n` > 168.0
  - _Potencial_: sin este filtro IC_bueno=-0.055 (n=2080)

- **FILTRO** `py_entrada` > `0.64` → IC=-0.241 (n=659)

  - _Acción_: SKIP cuando `py_entrada` > 0.64
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=2129)
...
- **FILTRO** `hora_utc` < `9.0` → IC=-0.187 (n=694)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 9.0
  - _Potencial_: sin este filtro IC_bueno=-0.099 (n=1511)
...
- **FILTRO** `ballena_activa_n` > `11.0` → IC=-0.238 (n=537)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.090 (n=1668)

- **FILTRO** `py_entrada` > `0.7` → IC=-0.224 (n=794)

  - _Acción_: SKIP cuando `py_entrada` > 0.7
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2605)

- **FILTRO** `ibs_7min` > `0.2784` → IC=-0.155 (n=1154)

  - _Acción_: SKIP cuando `ibs_7min` > 0.2784
  - _Potencial_: sin este filtro IC_bueno=-0.001 (n=2245)

### MOMENTUM_IBS_5M_BALLENA#ETH#5min
- **FILTRO** `hora_utc` < `8.0` → IC=-0.140 (n=762)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: SKIP cuando `hora_utc` < 8.0
  - _Potencial_: sin este filtro IC_bueno=-0.091 (n=1762)

- **FILTRO** `py_entrada` < `0.35` → IC=-0.262 (n=608)

  - _Acción_: SKIP cuando `py_entrada` < 0.35
  - _Potencial_: sin este filtro IC_bueno=-0.056 (n=1916)

- **FILTRO** `ibs_7min` < `0.754` → IC=-0.194 (n=631)

  - _Acción_: SKIP cuando `ibs_7min` < 0.754
  - _Potencial_: sin este filtro IC_bueno=-0.077 (n=1893)

- **FILTRO** `ballena_activa_n` > `26.0` → IC=-0.177 (n=833)

  - _Acción_: SKIP cuando `ballena_activa_n` > 26.0
  - _Potencial_: sin este filtro IC_bueno=-0.071 (n=1691)

- **FILTRO** `py_entrada` > `0.63` → IC=-0.233 (n=841)
...
- **FILTRO** `ibs_7min` > `0.2769` → IC=-0.177 (n=636)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.065 (n=1911)
...
- **FILTRO** `py_entrada` < `0.39` → IC=-0.244 (n=670)

  - _Acción_: SKIP cuando `py_entrada` < 0.39
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2121)

- **FILTRO** `ibs_7min` < `0.7368` → IC=-0.206 (n=691)

  - _Acción_: SKIP cuando `ibs_7min` < 0.7368
  - _Potencial_: sin este filtro IC_bueno=-0.024 (n=2100)

- **FILTRO** `ballena_activa_n` > `12.0` → IC=-0.184 (n=685)

  - _Acción_: SKIP cuando `ballena_activa_n` > 12.0
  - _Potencial_: sin este filtro IC_bueno=-0.031 (n=2106)

- **FILTRO** `py_entrada` > `0.62` → IC=-0.176 (n=845)

  - _Acción_: SKIP cuando `py_entrada` > 0.62
  - _Potencial_: sin este filtro IC_bueno=+0.004 (n=2703)

### MOMENTUM_IBS_5M_BALLENA#XRP#5min
- **FILTRO** `py_entrada` < `0.36` → IC=-0.292 (n=598)

  - _Acción_: SKIP cuando `py_entrada` < 0.36
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=1857)

- **FILTRO** `ibs_7min` < `0.7333` → IC=-0.239 (n=607)
...
- **FILTRO** `ballena_activa_n` > `13.0` → IC=-0.228 (n=597)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.038 (n=1858)

- **FILTRO** `py_entrada` > `0.69` → IC=-0.210 (n=818)

  - _Acción_: SKIP cuando `py_entrada` > 0.69
  - _Potencial_: sin este filtro IC_bueno=+0.002 (n=2486)

- **FILTRO** `ibs_7min` > `0.7674` → IC=-0.161 (n=825)

  - _Acción_: SKIP cuando `ibs_7min` > 0.7674
  - _Potencial_: sin este filtro IC_bueno=-0.013 (n=2479)
...
### UPDOWN_GBM#15min
- **PATRÓN** `sigma_h` < `0.0037` → IC=+0.158 (n=191)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.79€ cuando `sigma_h` < 0.0037 (IC base=+0.135)

- **PATRÓN** `sigma_h` > `0.0074` → IC=+0.172 (n=190)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.86€ cuando `sigma_h` > 0.0074 (IC base=+0.135)

- **PATRÓN** `drift_60min` |x|≤ `0.1673` → IC=+0.137 (n=502)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.68€ cuando `drift_60min` |x|≤ 0.1673 (IC base=+0.135)

- **PATRÓN** `delta_ratio_macro` |x|> `0.0597` → IC=+0.136 (n=570)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.68€ cuando `delta_ratio_macro` |x|> 0.0597 (IC base=+0.135)

- **PATRÓN** `hora_utc` > `4.0` → IC=+0.137 (n=613)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
...
- **PATRÓN** `ibs_15` > `0.5909` → IC=+0.218 (n=570)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5909 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` > `0.4346` → IC=+0.149 (n=132)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` > 0.4346 (IC base=+0.135)

- **PATRÓN** `dist_vwap_pct` < `0.5654` → IC=+0.135 (n=606)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` < 0.5654 (IC base=+0.135)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.544` → IC=+0.233 (n=163)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 15.544 (IC base=+0.135)
...
- **PATRÓN** `libro_liquidez` > `10043.6494` → IC=+0.182 (n=190)
  ...
  - _Acción_: Kelly boost +0.91€ cuando `libro_liquidez` > 10043.6494 (IC base=+0.135)
...
- **FILTRO** `sigma_ewma_delta_pct` > `7.859` → IC=-0.198 (n=41)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.018 (n=991)
...
- **FILTRO** `ibs_15` < `0.3814` → IC=-0.203 (n=35)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **PATRÓN** `dist_vwap_pct` < `0.3849` → IC=+0.153 (n=47)

  - _Acción_: Kelly boost +0.77€ cuando `dist_vwap_pct` < 0.3849 (IC base=+0.016)

### UPDOWN_GBM#XRP#15min
- **PATRÓN** `delta_ratio_macro` |x|> `0.0501` → IC=+0.162 (n=152)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
  - _Acción_: Kelly boost +0.81€ cuando `delta_ratio_macro` |x|> 0.0501 (IC base=+0.122)

- **PATRÓN** `hora_utc` < `6.0` → IC=+0.176 (n=69)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.88€ cuando `hora_utc` < 6.0 (IC base=+0.122)

- **PATRÓN** `ibs_15` > `0.5` → IC=+0.201 (n=152)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +1.00€ cuando `ibs_15` > 0.5 (IC base=+0.122)

- **PATRÓN** `dist_vwap_pct` > `0.2672` → IC=+0.191 (n=66)

  - _Acción_: Kelly boost +0.96€ cuando `dist_vwap_pct` > 0.2672 (IC base=+0.122)

- **PATRÓN** `sigma_ewma_delta_pct` > `14.701` → IC=+0.258 (n=31)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 14.701 (IC base=+0.122)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.133 (n=126)

  - _Acción_: Kelly boost +0.66€ cuando `libro_spread` < 0.01 (IC base=+0.122)

- **PATRÓN** `libro_liquidez` > `2503.3208` → IC=+0.174 (n=136)

  - _Acción_: Kelly boost +0.87€ cuando `libro_liquidez` > 2503.3208 (IC base=+0.122)

- **PATRÓN** `ballena_activa_n` < `36.0` → IC=+0.183 (n=58)

  - _Acción_: Kelly boost +0.92€ cuando `ballena_activa_n` < 36.0 (IC base=+0.122)

- **PATRÓN** `ibs_15` < `0.1176` → IC=+0.176 (n=177)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.88€ cuando `ibs_15` < 0.1176 (IC base=+0.034)
...
- **FILTRO** `sigma_h` > `0.0109` → IC=-0.209 (n=352)
  ...
  - _Potencial_: sin este filtro IC_bueno=-0.022 (n=1060)
...
- **FILTRO** `libro_spread` > `0.01` → IC=-0.148 (n=362)
...
- **PATRÓN** `dist_vwap_pct` < `0.1823` → IC=+0.128 (n=224)
  ...
  - _Acción_: Kelly boost +0.64€ cuando `dist_vwap_pct` < 0.1823 (IC base=-0.069)

- **PATRÓN** `delta_ratio_macro` |x|> `0.1246` → IC=+0.231 (n=332)
  - _Por qué funciona_: flow macro dominante → el lado comprador/vendedor ya fijó el precio en Polymarket
...
- **FILTRO** `libro_spread` > `0.02` → IC=-0.259 (n=52)

  - _Acción_: SKIP cuando `libro_spread` > 0.02
  - _Potencial_: sin este filtro IC_bueno=-0.166 (n=333)

- **FILTRO** `libro_liquidez` < `2503.3208` → IC=-0.229 (n=127)

  - _Acción_: SKIP cuando `libro_liquidez` < 2503.3208
  - _Potencial_: sin este filtro IC_bueno=-0.154 (n=258)
...
- **PATRÓN** `ibs_15` < `0.3448` → IC=+0.289 (n=126)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
...
- **H-IBS-UPDOWN_GBM#15min**: dentro de BUY_YES, IBS > 0.5909 sube el IC de +0.135 a +0.218 en UPDOWN_GBM#15min (n=570). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_YES, IBS > 0.5 sube el IC de +0.122 a +0.201 en UPDOWN_GBM#XRP#15min (n=152). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM#XRP#15min**: dentro de BUY_NO, IBS < 0.1176 sube el IC de +0.034 a +0.176 en UPDOWN_GBM#XRP#15min (n=177). Ya aplicado como kelly_boost=+0.88€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_YES, IBS > 0.5762 sube el IC de -0.069 a +0.225 en UPDOWN_GBM_15M_TARDIO (n=329). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
- **H-IBS-UPDOWN_GBM_15M_TARDIO**: dentro de BUY_NO, IBS < 0.3696 sube el IC de -0.062 a +0.274 en UPDOWN_GBM_15M_TARDIO (n=497). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
- **H-IBS-UPDOWN_GBM_15M_TARDIO#XRP#15min**: dentro de BUY_NO, IBS < 0.3448 sube el IC de -0.058 a +0.289 en UPDOWN_GBM_15M_TARDIO#XRP#15min (n=126). Ya aplicado como kelly_boost=+1.00€ automático (shadow) — no es señal de reversión a la dirección contraria.
...
| ✅ BALLENAS_TARDIAS | 15428 | -0.116 | -2593.61€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#15min | 974 | -0.013 | -144.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#5min | 14454 | -0.122 | -2449.61€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB | 2046 | -0.102 | -468.29€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BNB#5min | 2046 | -0.102 | -468.29€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#BTC | 974 | -0.013 | -144.00€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#BTC#15min | 974 | -0.013 | -144.00€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE | 2058 | -0.174 | -572.27€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#DOGE#5min | 2058 | -0.174 | -572.27€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#ETH | 4114 | -0.053 | -381.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#ETH#5min | 4114 | -0.053 | -381.12€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL | 3421 | -0.128 | -272.16€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#SOL#5min | 3421 | -0.128 | -272.16€ | 1 | 0 |
| ✅ BALLENAS_TARDIAS#XRP | 2815 | -0.193 | -755.77€ | 0 | 0 |
| ✅ BALLENAS_TARDIAS#XRP#5min | 2815 | -0.193 | -755.77€ | 1 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA | 4576 | -0.077 | +1869.28€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#15min | 1304 | -0.013 | +956.55€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#5min | 3272 | -0.103 | +912.73€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC | 4576 | -0.077 | +1869.28€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#15min | 1304 | -0.013 | +956.55€ | 0 | 0 |
| ✅ CANDIDATA10_CONFIRMACION_CRUZADA#BTC#5min | 3272 | -0.103 | +912.73€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO | 49493 | +0.114 | -3016.81€ | 0 | 8 |
| ✅ FAVORITO_CONFIRMADO#15min | 8244 | +0.183 | -278.96€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#240min | 171 | -0.107 | -54.25€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#5min | 37269 | +0.099 | -2603.11€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#60min | 3809 | +0.116 | -80.49€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB | 6256 | +0.085 | -794.06€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#15min | 27 | -0.121 | +3.75€ | 0 | 0 |
| 🚫 FAVORITO_CONFIRMADO#BNB#240min | 15 | -0.243 | -11.78€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BNB#5min | 6214 | +0.087 | -786.04€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC | 9906 | +0.132 | -226.41€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 2430 | +0.198 | -117.57€ | 0 | 10 |
| ✅ FAVORITO_CONFIRMADO#BTC#240min | 42 | -0.114 | -22.23€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#5min | 6158 | +0.109 | -132.42€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#60min | 
02€ | 0 | 0 |
| ✅ STREAK_MOM_5M#XRP#5min | 704 | +0.014 | +12.02€ | 2 | 0 |
...
| ✅ UPDOWN_GBM | 10497 | +0.011 | +338.96€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 3669 | +0.042 | +386.58€ | 0 | 12 |
| ✅ UPDOWN_GBM#240min | 445 | +0.010 | +6.85€ | 0 | 0 |
| ✅ UPDOWN_GBM#5min | 5666 | -0.004 | -48.67€ | 2 | 0 |
| ✅ UPDOWN_GBM#60min | 665 | -0.005 | -4.87€ | 3 | 0 |
...
| ✅ UPDOWN_GBM#BTC | 1981 | +0.016 | +109.36€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#BTC#60min | 253 | +0.002 | -2.11€ | 2 | 1 |
| ✅ UPDOWN_GBM#BTC#daily | 20 | -0.136 | +1.50€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE | 1191 | +0.000 | +0.57€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#15min | 129 | +0.088 | +27.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#240min | 10 | +0.042 | +0.80€ | 0 | 0 |
| ✅ UPDOWN_GBM#DOGE#5min | 1052 | -0.011 | -28.16€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH | 2155 | +0.001 | +19.30€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 1061 | +0.029 | +45.65€ | 1 | 5 |
...
| ✅ UPDOWN_GBM#SOL | 3022 | +0.006 | +21.70€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#15min | 957 | +0.010 | +21.26€ | 1 | 10 |
| ✅ UPDOWN_GBM#SOL#240min | 119 | -0.004 | -3.09€ | 0 | 0 |
| ✅ UPDOWN_GBM#SOL#5min | 1795 | +0.006 | +2.90€ | 2 | 0 |
| ✅ UPDOWN_GBM#SOL#60min | 138 | +0.000 | +1.26€ | 2 | 1 |
| ✅ UPDOWN_GBM#SOL#daily | 13 | -0.152 | -0.64€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP | 1705 | +0.021 | +137.82€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#15min | 908 | +0.054 | +162.93€ | 0 | 9 |
| ✅ UPDOWN_GBM#XRP#240min | 47 | -0.112 | -6.22€ | 0 | 0 |
| ✅ UPDOWN_GBM#XRP#5min | 750 | -0.011 | -18.90€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO | 5852 | -0.063 | +1319.37€ | 3 | 8 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 5852 | -0.063 | +1319.37€ | 0 | 0 |
...
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 557 | +0.160 | +271.20€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 557 | +0.160 | +271.20€ | 2 | 16 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL | 1901 | -0.062 | +384.96€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#SOL#15min | 1901 | -0.062 | +384.96€ | 4 | 6 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP | 1797 | -0.084 | +366.84€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#XRP#15min | 1797 | -0.084 | +366.84€ | 2 | 3 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.085) — sin ventaja clara. oversold(IBS<0.3): IC=+0.030 n=3747 | neutral: IC=+0.005 n=4084 | overbought(IBS>0.7): IC=+0.089 n=4091
  - _Datos_: n=12380 IC=+0.043 PNL=+1317.03€

**🟡 H-KELLY-HORA** — Kelly boost ×1.2 por celda (estrategia#subtype#dirección#hora)
  - _Umbral_: n≥40 por celda + gate riguroso completo (Wilson+shuffle+PnL bootstrap)
  - _Acción_: Añadir claves 'ESTRATEGIA#SUBTYPE#DIRECCION#HORA':1.2 a meta.hora_boost_factor, solo por celda confirmada
  - _Estado_: (cache 543s) 209 celda(s) GATE OK de 2504 trackeadas

**⚠️ H-SOL-15MIN** — SOL#15min → umbral live (IC≥0.08 n≥40)
  - _Umbral_: IC≥0.08 y n≥40
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: SOL#15min: n≥40 pero IC=+0.010 < 0.08 — monitorear
  - _Datos_: n=957 IC=+0.010 PNL=+21.26€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 10435 ops, 22 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-60MIN-LIVE** — Estrategias 60min → umbral live (IC≥0.08 n≥40)
  ...
  - _Acción_: Activar live cuando haya credenciales Polymarket API
  - _Estado_: ETH#60min: n=274/40 IC=-0.015 PNL=-4.03€ | BTC#60min: n=253/40 IC=+0.002 PNL=-2.11€ | SOL#60min: n=138/40 IC=+0.000 PNL=+1.26€

**⏳ H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  - _Umbral_: n≥40 tras 2 losses y gap(IC_tras_win - IC_tras_2loss)≥0.05
  - _Acción_: Reducir stake (no desactivar) 1-2h tras 2 derrotas consecutivas en el mismo subtype
  - _Estado_: tras_win IC=+0.065 n=160319 | tras_1loss IC=+0.052 n=126276 | tras_2loss IC=+0.016 n=56500/40 | gap=+0.049 (umbral 0.05)

**⏳ H-BTC-LEADS-ETH** — ETH/SOL GBM contrario al drift_15min de BTC del mismo ciclo
  - _Umbral_: n≥40 en contrario_BTC y gap≥0.08 — y descartar confound con drift propio antes de actuar
  - _Acción_: Si se confirma y no es confound → boost en ETH/SOL cuando decisión contraria a drift_15min BTC
  - _Estado_: alineado_BTC IC=-0.001 n=962 | contrario_BTC IC=-0.006 n=852/40 | gap=-0.005 (umbral 0.08) — SIN CONFIRMAR independencia de filtros propios de ETH
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=10218 IC=+0.009 PNL=+284.38€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=10218 IC=+0.009 PNL=+284.38€
...
**〰️ H-CUSTOM-GBM-60MIN-BUYYES** — GBM 60min BUY_YES — ¿edge superior al BUY_NO?
  ...
  - _Estado_: n=526 IC=+0.004 PNL=-0.71€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=526 IC=+0.004 PNL=-0.71€
...
**🟡 H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.135 > 0.1 con n=760 PNL=+259.10€
  - _Datos_: n=760 IC=+0.135 PNL=+259.10€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=2710 IC=+0.017 PNL=+121.76€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=2710 IC=+0.017 PNL=+121.76€

**〰️ H-CUSTOM-POLY-DRIFT-CONFIRM** — poly_drift_5obs: ¿el precio YES interno de Polymarket confirma nuestra señal?
  - _Hipótesis_: Feature nueva 2026-06-27: drift del precio YES en Polymarket en últimas 5 obs (~5min). Si poly_drift<0 y decidimos BUY_NO (o poly_drift>0 y BUY_YES) → confluencia. Si diverge → reducción de stake. Hipótesis: confluencia Binance+Polymarket mejora IC; divergencia empeora.
  - _Umbral_: n≥40 en confluencia vs divergencia para validar el boost ×1.1
  - _Acción_: Si IC_confluencia>IC_divergencia con n≥40 → mantener el boost. Si no → retirar.
  - _Estado_: n=761 IC=+0.031 PNL=+19.83€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=761 IC=+0.031 PNL=+19.83€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=2623 IC=+0.034 PNL=+230.79€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=2623 IC=+0.034 PNL=+230.79€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=1136 PNL=+451.89€
  - _Datos_: n=1136 IC=+0.169 PNL=+451.89€
...
**〰️ H-CUSTOM-XRP15-BUYNO-LIVE** — XRP#15min BUY_NO — candidato live nº2 (detrás de ETH#15min)
  ...
  - _Estado_: n=706 IC=+0.034 PNL=+76.94€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=706 IC=+0.034 PNL=+76.94€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=8096 IC=-0.140 PNL=+450.05€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=8096 IC=-0.140 PNL=+450.05€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.137 > 0.08 con n=722 PNL=+244.73€
  - _Datos_: n=722 IC=+0.137 PNL=+244.73€
...
**〰️ H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: n=2317 IC=+0.141 PNL=+1364.68€ — sin señal clara aún (umbral IC: min=0.2 max=None)
  - _Datos_: n=2317 IC=+0.141 PNL=+1364.68€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.183 > 0.08 con n=891 PNL=+605.57€
  - _Datos_: n=891 IC=+0.183 PNL=+605.57€
...
**〰️ H-CUSTOM-XRP15-SIGMA-DECEL** — GBM_LATE_15M XRP — vol DESacelerando (EWMA10<=flat) mejora la señal (signo opuesto a ETH/BTC)
  ...
  - _Estado_: n=1470 IC=-0.058 PNL=+319.01€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=1470 IC=-0.058 PNL=+319.01€
...
**🟡 H-CUSTOM-SMARTMONEY-FAVORITO-SOL** — FAVORITO_CONFIRMADO SOL — alineado con smart_money_consensus bate ir en contra (REABRE hallazgo cerrado 08-Jul)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.114 > 0.08 con n=322 PNL=-33.54€
  - _Datos_: n=322 IC=+0.114 PNL=-33.54€
...
**🟡 H-CUSTOM-FAVORITO-SOL-ALTACONVICCION** — FAVORITO_CONFIRMADO SOL BUY_YES alta conviccion (py_entrada alto) — UNICO caso positivo en fill-ability de hoy
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.227 > 0.08 con n=2076 PNL=-217.47€
  - _Datos_: n=2076 IC=+0.227 PNL=-217.47€
...
**〰️ H-CUSTOM-FAVALTACONV-BNB5M-PAYOUT-NEGATIVO** — ALERTA -- FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min#BUY_YES pierde dinero en TODOS los buckets de precio pese a IC positivo
  ...
  - _Estado_: n=4702 IC=+0.150 PNL=-728.02€ — sin señal clara aún (umbral IC: min=999 max=None)
  - _Datos_: n=4702 IC=+0.150 PNL=-728.02€
