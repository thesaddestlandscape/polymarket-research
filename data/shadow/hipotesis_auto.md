# Hipótesis automáticas — 2026-06-29 20:50 UTC
_Generado por shadow_postmortem.py sobre 1314 resoluciones (PNL=-33.06€)_
...
- **PATRÓN** `sigma_h` < `0.0107` → IC=+0.145 (n=29)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.73€ cuando `sigma_h` < 0.0107 (IC base=+0.073)
...
| ✅ UPDOWN_GBM | 345 | +0.016 | +8.38€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 202 | +0.059 | +12.33€ | 0 | 0 |
...
| ✅ UPDOWN_GBM#ETH | 133 | +0.056 | +7.54€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 87 | +0.073 | +4.35€ | 0 | 1 |
...
**🟡 H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread=0.156: neutral→boost, oversold→filtro | oversold(IBS<0.3): IC=+0.022 n=15 | neutral: IC=+0.178 n=16 | overbought(IBS>0.7): IC=+0.060 n=23
  - _Datos_: n=56 IC=+0.103 PNL=+7.25€
...
**⏳ H-HORA-GBM** — hora_utc causal automático en GBM (forward)
  ...
  - _Estado_: 56 ops, 10 horas distintas. Sin hora con n≥15 y IC extremo aún.
...
**⏳ H-KALMAN** — Kalman filter para drift adaptativo
  ...
  - _Estado_: Máximo n actual en GBM: 345/200. Esperar 3+ subtypes con n≥200.
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=246 IC=+0.040 PNL=+14.02€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=246 IC=+0.040 PNL=+14.02€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=151 IC=+0.036 PNL=-0.84€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=151 IC=+0.036 PNL=-0.84€
...
**🟡 H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.136 > 0.08 con n=75 PNL=+10.12€
  - _Datos_: n=75 IC=+0.136 PNL=+10.12€
