# Hipótesis automáticas — 2026-07-15 15:58 UTC
_Generado por shadow_postmortem.py sobre 15546 resoluciones (PNL=+3113.70€)_
...
- **PATRÓN** `py_entrada` < `0.265` → IC=+0.320 (n=292)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.265 (IC base=+0.155)

- **PATRÓN** `libro_spread` < `0.01` → IC=+0.165 (n=997)

  - _Acción_: Kelly boost +0.82€ cuando `libro_spread` < 0.01 (IC base=+0.155)

- **PATRÓN** `libro_liquidez` > `7379.7569` → IC=+0.176 (n=291)

  - _Acción_: Kelly boost +0.88€ cuando `libro_liquidez` > 7379.7569 (IC base=+0.155)
...
- **PATRÓN** `py_entrada` < `0.225` → IC=+0.392 (n=63)
  ...
  - _Acción_: Kelly boost +1.00€ cuando `py_entrada` < 0.225 (IC base=+0.192)

- **PATRÓN** `libro_liquidez` > `7250.1498` → IC=+0.198 (n=167)

  - _Acción_: Kelly boost +0.99€ cuando `libro_liquidez` > 7250.1498 (IC base=+0.192)
...
- **PATRÓN** `libro_liquidez` > `4732.3209` → IC=+0.210 (n=122)

  - _Acción_: Kelly boost +1.00€ cuando `libro_liquidez` > 4732.3209 (IC base=+0.199)
...
- **PATRÓN** `sigma_h` > `0.0028` → IC=+0.155 (n=166)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` > 0.0028 (IC base=+0.128)

- **PATRÓN** `hora_utc` > `12.0` → IC=+0.186 (n=116)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.93€ cuando `hora_utc` > 12.0 (IC base=+0.128)

- **PATRÓN** `dist_vwap_pct` > `0.3426` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `dist_vwap_pct` > 0.3426 (IC base=+0.128)
...
### GBM_LATE_15M_TARDIO
- **PATRÓN** `sigma_h` > `0.0148` → IC=+0.176 (n=205)
  - _Por qué funciona_: alta volatilidad → el modelo GBM sobreestima la señal; el mercado es más aleatorio
  - _Acción_: Kelly boost +0.88€ cuando `sigma_h` > 0.0148 (IC base=+0.108)

- **PATRÓN** `hora_utc` < `15.0` → IC=+0.131 (n=556)
  - _Por qué funciona_: hora temprana → mercados cripto menos líquidos, spreads más amplios; edge real menor
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` < 15.0 (IC base=+0.108)

- **PATRÓN** `dist_vwap_pct` > `0.7123` → IC=+0.199 (n=101)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7123 (IC base=+0.108)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.253` → IC=+0.308 (n=76)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.253 (IC base=+0.108)

### GBM_LATE_15M_TARDIO#BTC#15min
- **PATRÓN** `hora_utc` > `8.0` → IC=+0.129 (n=122)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.65€ cuando `hora_utc` > 8.0 (IC base=+0.092)

- **PATRÓN** `dist_vwap_pct` > `0.3681` → IC=+0.152 (n=21)

  - _Acción_: Kelly boost +0.76€ cuando `dist_vwap_pct` > 0.3681 (IC base=+0.092)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.025` → IC=+0.196 (n=21)

  - _Acción_: Kelly boost +0.98€ cuando `sigma_ewma_delta_pct` > 12.025 (IC base=+0.092)

### GBM_LATE_15M_TARDIO#ETH#15min
- **PATRÓN** `sigma_h` < `0.0039` → IC=+0.154 (n=53)
  - _Por qué funciona_: baja volatilidad → señal GBM más fiable; el spread de Polymarket cubre mejor el edge
  - _Acción_: Kelly boost +0.77€ cuando `sigma_h` < 0.0039 (IC base=+0.053)

- **PATRÓN** `dist_vwap_pct` > `0.6154` → IC=+0.134 (n=39)

  - _Acción_: Kelly boost +0.67€ cuando `dist_vwap_pct` > 0.6154 (IC base=+0.053)

- **PATRÓN** `sigma_ewma_delta_pct` > `12.728` → IC=+0.350 (n=18)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` > 12.728 (IC base=+0.053)
...
### UPDOWN_GBM#15min
- **PATRÓN** `ibs_15` > `0.7222` → IC=+0.178 (n=259)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.89€ cuando `ibs_15` > 0.7222 (IC base=+0.028)

- **PATRÓN** `dist_vwap_pct` > `0.7415` → IC=+0.214 (n=33)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7415 (IC base=+0.028)

- **PATRÓN** `dist_vwap_pct` < `0.3343` → IC=+0.150 (n=135)

  - _Acción_: Kelly boost +0.75€ cuando `dist_vwap_pct` < 0.3343 (IC base=+0.028)

- **PATRÓN** `sigma_ewma_delta_pct` > `15.613` → IC=+0.167 (n=19)

  - _Acción_: Kelly boost +0.83€ cuando `sigma_ewma_delta_pct` > 15.613 (IC base=+0.028)

- **PATRÓN** `ibs_15` < `0.0286` → IC=+0.128 (n=135)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.64€ cuando `ibs_15` < 0.0286 (IC base=+0.047)

- **PATRÓN** `sigma_ewma_delta_pct` < `16.748` → IC=+0.135 (n=124)
...
- **PATRÓN** `drift_60min` |x|≤ `0.2429` → IC=+0.130 (n=187)
  - _Por qué funciona_: drift moderado → precio aún no ha reaccionado del todo; lag explotable
  - _Acción_: Kelly boost +0.65€ cuando `drift_60min` |x|≤ 0.2429 (IC base=+0.080)

- **PATRÓN** `hora_utc` > `11.0` → IC=+0.167 (n=157)
  - _Por qué funciona_: hora tardía/noche → sesión US cerrada, menos participantes informados; señales más ruidosas
  - _Acción_: Kelly boost +0.83€ cuando `hora_utc` > 11.0 (IC base=+0.080)

- **PATRÓN** `ibs_15` < `0.9306` → IC=+0.144 (n=147)
  - _Por qué funciona_: IBS bajo (precio cerca del mínimo) → sobreventa de corto plazo; BUY_NO menos fiable
  - _Acción_: Kelly boost +0.72€ cuando `ibs_15` < 0.9306 (IC base=+0.080)

- **PATRÓN** `ibs_15` > `0.6323` → IC=+0.198 (n=147)
  - _Por qué funciona_: IBS alto (precio cerca del máximo) → sobrecompra de corto plazo; BUY_YES menos fiable
  - _Acción_: Kelly boost +0.99€ cuando `ibs_15` > 0.6323 (IC base=+0.080)

- **PATRÓN** `dist_vwap_pct` > `0.7736` → IC=+0.342 (n=17)

  - _Acción_: Kelly boost +1.00€ cuando `dist_vwap_pct` > 0.7736 (IC base=+0.080)

- **PATRÓN** `sigma_ewma_delta_pct` < `7.039` → IC=+0.206 (n=32)

  - _Acción_: Kelly boost +1.00€ cuando `sigma_ewma_delta_pct` < 7.039 (IC base=+0.080)
...
- **H-IBS-UPDOWN_GBM#15min**: IBS > 0.7222 correlaciona con éxito en UPDOWN_GBM#15min (IC=+0.178 n=259). Confirma señal de reversión media → alinear con BUY_NO.
...
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO` — IC=+0.348 n=31. Faltan ~9 resoluciones para umbral n≥40. ETA: ~6h.
- **LIVE-CANDIDATA**: `UPDOWN_GBM_15M_TARDIO#15min` — IC=+0.348 n=31. Faltan ~9 resoluciones para umbral n≥40. ETA: ~6h.

## Estado de aprendizaje por estrategia

| Estrategia | n | IC | PNL | Filtros | Patrones |
|---|---|---|---|---|---|
| ✅ FAVORITO_CONFIRMADO | 2201 | +0.173 | -49.19€ | 0 | 9 |
| ✅ FAVORITO_CONFIRMADO#15min | 1419 | +0.206 | -0.04€ | 0 | 0 |
...
| ✅ FAVORITO_CONFIRMADO#BTC | 638 | +0.180 | -15.60€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#BTC#15min | 474 | +0.198 | -23.84€ | 0 | 7 |
...
| ✅ FAVORITO_CONFIRMADO#ETH | 782 | +0.173 | +1.34€ | 0 | 0 |
| ✅ FAVORITO_CONFIRMADO#ETH#15min | 469 | +0.215 | +17.31€ | 0 | 6 |
...
| ✅ GBM_LATE_15M | 4618 | +0.103 | +1429.61€ | 0 | 4 |
| ✅ GBM_LATE_15M#15min | 4618 | +0.103 | +1429.61€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC | 1109 | +0.065 | +159.41€ | 0 | 0 |
| ✅ GBM_LATE_15M#BTC#15min | 1109 | +0.065 | +159.41€ | 0 | 3 |
...
| ✅ GBM_LATE_15M_ESPACIO_ATR | 1871 | +0.153 | +1106.54€ | 0 | 11 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#15min | 1871 | +0.153 | +1106.54€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC | 479 | +0.122 | +244.98€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#BTC#15min | 479 | +0.122 | +244.98€ | 0 | 9 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH | 494 | +0.129 | +233.36€ | 0 | 0 |
| ✅ GBM_LATE_15M_ESPACIO_ATR#ETH#15min | 494 | +0.129 | +233.36€ | 0 | 13 |
...
| ✅ GBM_LATE_15M_PYCONFIRMADO | 35 | -0.041 | +0.12€ | 0 | 0 |
| ✅ GBM_LATE_15M_PYCONFIRMADO#15min | 35 | -0.041 | +0.12€ | 0 | 0 |
...
| ✅ GBM_LATE_15M_TARDIO | 1824 | +0.086 | +532.04€ | 0 | 4 |
| ✅ GBM_LATE_15M_TARDIO#15min | 1824 | +0.086 | +532.04€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC | 454 | +0.061 | +87.88€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#BTC#15min | 454 | +0.061 | +87.88€ | 0 | 3 |
| ✅ GBM_LATE_15M_TARDIO#ETH | 411 | +0.018 | +14.94€ | 0 | 0 |
| ✅ GBM_LATE_15M_TARDIO#ETH#15min | 411 | +0.018 | +14.94€ | 0 | 3 |
...
| ✅ UPDOWN_GBM | 1553 | +0.010 | +74.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#15min | 1296 | +0.037 | +110.70€ | 0 | 6 |
...
| ✅ UPDOWN_GBM#BTC | 403 | +0.031 | +32.18€ | 0 | 0 |
| ✅ UPDOWN_GBM#BTC#15min | 323 | +0.069 | +44.63€ | 1 | 9 |
...
| ✅ UPDOWN_GBM#ETH | 746 | +0.017 | +34.94€ | 0 | 0 |
| ✅ UPDOWN_GBM#ETH#15min | 653 | +0.034 | +46.00€ | 1 | 2 |
...
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD | 5 | +0.054 | +0.10€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_CROSS_WINDOW_SPREAD#15min | 5 | +0.054 | +0.10€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO | 31 | +0.348 | +16.32€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#15min | 31 | +0.348 | +16.32€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC | 10 | +0.167 | +7.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#BTC#15min | 10 | +0.167 | +7.01€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH | 7 | +0.097 | +2.55€ | 0 | 0 |
| ✅ UPDOWN_GBM_15M_TARDIO#ETH#15min | 7 | +0.097 | +2.55€ | 0 | 0 |
...
**〰️ H-IBS-15** — IBS-15 como señal de mean-reversion
  ...
  - _Estado_: Spread bajo (0.134) — sin ventaja clara. oversold(IBS<0.3): IC=+0.000 n=436 | neutral: IC=-0.015 n=340 | overbought(IBS>0.7): IC=+0.119 n=358
  - _Datos_: n=1199 IC=+0.037 PNL=+115.83€
...
**🟡 H-STREAK-COOLDOWN** — Cooldown tras 2 derrotas consecutivas (mismo subtype)
  ...
  - _Estado_: tras_win IC=+0.101 n=8977 | tras_1loss IC=+0.062 n=6359 | tras_2loss IC=+0.030 n=2753/40 | gap=+0.071 (umbral 0.05)
...
**⏳ H-KELLY-HORA** — Kelly boost ×1.2 en horas top (15/17/19h UTC)
  ...
  - _Estado_: H=13h UTC: IC=+0.075 n=692/40 PNL=+165.38€ | H=15h UTC: IC=+0.128 n=699/40 PNL=+233.96€ | H=17h UTC: IC=+0.127 n=575/40 PNL=+170.31€ | H=19h UTC: IC=+0.082 n=556/40 PNL=+84.58€
...
**〰️ H-24H-GBM-BUYYES-TARDE** — GBM BUY_YES en tarde europea (15-19h UTC) — señal alcista sostenida
  ...
  - _Estado_: n=223 IC=+0.011 PNL=+9.17€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=223 IC=+0.011 PNL=+9.17€
...
**〰️ H-CUSTOM-GBM-SIGMA-ALTO** — GBM con sigma_h alto (>0.002/h) — ¿destruye edge?
  ...
  - _Estado_: n=1426 IC=+0.017 PNL=+88.18€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=1426 IC=+0.017 PNL=+88.18€
...
**〰️ H-CUSTOM-BUYYES-15MIN-POSTFILTRO** — BUY_YES #15min con filtro drift_60min activo — ¿funciona en forward?
  ...
  - _Estado_: n=693 IC=+0.028 PNL=+48.59€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=693 IC=+0.028 PNL=+48.59€
...
**〰️ H-CUSTOM-BTC15-TENDENCIA** — BTC#15min — ¿el edge está decayendo?
  ...
  - _Estado_: n=323 IC=+0.069 PNL=+44.63€ — sin señal clara aún (umbral IC: min=None max=0.02)
  - _Datos_: n=323 IC=+0.069 PNL=+44.63€
...
**〰️ H-CUSTOM-DRIFT15-MOMENTUM** — GBM#15min drift_15min > 0.3 — zona de momentum (señal fuerte)
  ...
  - _Estado_: n=683 IC=+0.074 PNL=+88.55€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=683 IC=+0.074 PNL=+88.55€
...
**〰️ H-DVOL-SPIKE-BUYNO** — DVOL spike (sigma_h alto) → BUY_NO tiene más edge (panic regime)
  ...
  - _Estado_: n=568 IC=+0.032 PNL=+38.27€ — sin señal clara aún (umbral IC: min=0.1 max=None)
  - _Datos_: n=568 IC=+0.032 PNL=+38.27€
...
**〰️ H-CUSTOM-MERCURY-RETROGRADO** — Mercurio retrógrado: ¿rendimiento peor durante la ventana?
  ...
  - _Estado_: n=13088 IC=+0.103 PNL=+3189.59€ — sin señal clara aún (umbral IC: min=None max=-0.03)
  - _Datos_: n=13088 IC=+0.103 PNL=+3189.59€
...
**〰️ H-CUSTOM-GBM-BUYYES-GLOBAL-MALO** — UPDOWN_GBM BUY_YES global — ¿estructuralmente peor que BUY_NO en todas las estrategias activas?
  ...
  - _Estado_: n=841 IC=-0.003 PNL=+19.05€ — sin señal clara aún (umbral IC: min=None max=-0.05)
  - _Datos_: n=841 IC=-0.003 PNL=+19.05€
...
**🟡 H-CUSTOM-LATE-ENTRY-15MIN** — Entrada tardía en ventanas 15min (T_h<0.2) — el edge vive al final de la ventana
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.169 > 0.1 con n=391 PNL=+141.75€
  - _Datos_: n=391 IC=+0.169 PNL=+141.75€
...
**〰️ H-PRECIO-YES-BARATO** — BUY_YES con precio de mercado 0.30-0.40 — mercado infravalora YES
  ...
  - _Estado_: n=473 IC=-0.075 PNL=+87.08€ — sin señal clara aún (umbral IC: min=0.08 max=None)
  - _Datos_: n=473 IC=-0.075 PNL=+87.08€
...
**🟡 H-CUSTOM-BUYYES15-SOLO-TARDIO** — UPDOWN_GBM BUY_YES #15min solo tardío (T_h<0.2) — gate forward hacia live
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.153 > 0.08 con n=289 PNL=+94.83€
  - _Datos_: n=289 IC=+0.153 PNL=+94.83€
...
**🟡 H-CUSTOM-UPDOWNGBM-BTC15-TARDIO** — UPDOWN_GBM BTC#15min BUY_YES tardío (T_h<0.2) — lane nueva, no cubierta por GBM_LATE_15M
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.223 > 0.08 con n=128 PNL=+62.61€
  - _Datos_: n=128 IC=+0.223 PNL=+62.61€
...
**🟡 H-CUSTOM-GBMLATE-ANCHURA-MERCADO** — GBM_LATE_15M BUY_YES — anchura de mercado (retorno concurrente de los otros 3 majors) como modificador secundario
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.257 > 0.2 con n=311 PNL=+218.03€
  - _Datos_: n=311 IC=+0.257 PNL=+218.03€
...
**🟡 H-CUSTOM-BTC15-SIGMA-ACCEL** — GBM_LATE_15M BTC — vol acelerando (EWMA10>flat) mejora la señal
  ...
  - _Estado_: SEÑAL POSITIVA confirmada: IC=+0.115 > 0.08 con n=120 PNL=+50.64€
  - _Datos_: n=120 IC=+0.115 PNL=+50.64€
