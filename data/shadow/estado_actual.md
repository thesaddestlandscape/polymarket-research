# Estado del bot — 2026-08-05 16:08 UTC
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +5975.81 $ |
| P&L sim compuesto | 🟢 +12832.89 $ (ficción Kelly: +50444% s/ operativo) |
| P&L sim hoy (2026-08-05) | 🟢 +481.49 $ |
| Operaciones resueltas | 74856 (45940 WIN / 28916 LOSS) — 61.4% |
| Señales abiertas | 353 |

## Estrategias (visión global)

| Estrategia | n | Win% | IC_efectivo | Tendencia | PNL | Apuesta | Estado |
|---|---|---|---|---|---|---|---|
| GBM_LATE_15M_ESPACIO_ATR | 9171 | 62.9% | +0.129 | ➡️ estable | +4588.27$ | 1.29$ | ✅ activa |
| GBM_LATE_15M | 11781 | 60.1% | +0.101 | ➡️ estable | +3824.36$ | 1.02$ | ✅ activa |
| GBM_LATE_15M_TARDIO | 9098 | 58.1% | +0.081 | ➡️ estable | +2954.50$ | 0.81$ | ✅ activa |
| UPDOWN_GBM_15M_TARDIO | 3203 | 66.8% | +0.168 | ➡️ estable | +1670.06$ | 1.68$ | ✅ activa |
...
| GBM_LATE_5M | 1379 | 47.8% | -0.022 | ➡️ estable | +23.56$ | 0.50$ | ⚠️ IC negativo |
...
| PRICE_TARGET_GBM_FADE | 6 | 33.3% | -0.037 | — | -0.77$ | 0.50$ | ⏳ acumulando |
| GBM_LATE_60M_PYCONFIRMADO | 9 | 11.1% | -0.143 | — | -2.77$ | 0.00$ | 🚫 desactivada |
| FAVORITO_CONFIRMADO_60MIN_ALTACONVICCION | 221 | 79.6% | +0.294 | ➡️ estable | -2.95$ | 2.00$ | ✅ activa |
...
| BALLENAS_TARDIAS | 886 | 51.0% | +0.010 | 📉 agota (-0.26) | -57.52$ | 0.50$ | ✅ activa |
| FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 1351 | 72.2% | +0.222 | 📉 agota (-0.05) | -84.62$ | 2.00$ | ✅ activa |
| FAVORITO_CONFIRMADO | 18842 | 62.4% | +0.124 | 📉 agota (-0.06) | -449.26$ | 1.24$ | ✅ activa |
| FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 7301 | 70.1% | +0.201 | ➡️ estable | -480.22$ | 2.00$ | ✅ activa |

## Últimas 5 resoluciones

| Timestamp | Estrategia | Mercado | Resultado | PNL |
|---|---|---|---|---|
| 2026-08-05T16:07 | BALLENAS_TARDIAS#SOL#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-05T16:07 | FAVORITO_CONFIRMADO#BTC#5min | … | ✅ WIN | +0.84$ |
| 2026-08-05T16:07 | FAVORITO_CONFIRMADO#SOL#5min | … | ✅ WIN | +0.71$ |
| 2026-08-05T16:07 | GBM_LATE_15M_TARDIO#BTC#15min | Bitcoin Up or Down - August 5, 11:45AM-12:00PM ET… | ✅ WIN | +0.22$ |
| 2026-08-05T16:07 | GBM_LATE_15M_ESPACIO_ATR#BNB#15min | BNB Up or Down - August 5, 11:45AM-12:00PM ET… | ✅ WIN | +1.88$ |

## Calidad de datos

✅ **OK** — última verificación 2026-08-05T16:06 UTC

| Asset | Precio | Age | Alertas |
|---|---|---|---|
| ✅ BTC | $64,354.97 | 0.1min |  |
| ✅ ETH | $1,873.96 | 0.1min |  |
| ✅ SOL | $74.11 | 0.1min |  |
| ✅ XRP | $1.06 | 0.1min |  |
...
|---|---|---|---|
| BTC | $64,362.50 | consenso |  |
| ETH | $1,874.42 | consenso |  |
| SOL | $73.95 | consenso |  |
| XRP | $1.06 | consenso |  |
