# Estado del bot — 2026-07-11 19:46 UTC

## Live — dinero real (on-chain)
| | |
|---|---|
| Depósito inicial | 25.44 $ |
| Balance on-chain | **22.39 $** |
| P&L real total | 🔴 **-3.05 $** |
| P&L real hoy | -5.09 $ |
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +978.38 $ |
| P&L sim compuesto | 🟢 +1523.24 $ (ficción Kelly: +5988% s/ operativo) |
| P&L sim hoy (2026-07-11) | 🟢 +243.84 $ |
| Operaciones resueltas | 9678 (5426 WIN / 4252 LOSS) — 56.1% |
...
| FAVORITO_CONFIRMADO | 585 | 66.0% | +0.159 | 📉 agota (-0.06) | -29.43$ | 1.59$ | ✅ activa |

## Últimas 5 resoluciones

| Timestamp | Estrategia | Mercado | Resultado | PNL |
|---|---|---|---|---|
| 2026-07-11T19:44 | FAVORITO_CONFIRMADO#SOL#5min | Solana Up or Down - July 11, 3:35PM-3:40PM ET… | ✅ WIN | +1.31$ |
| 2026-07-11T19:44 | FAVORITO_CONFIRMADO#ETH#5min | Ethereum Up or Down - July 11, 3:35PM-3:40PM ET… | ✅ WIN | +0.60$ |
| 2026-07-11T19:44 | STREAK_FADE_5M#XRP#5min | XRP Up or Down - July 11, 3:35PM-3:40PM ET… | ✅ WIN | +0.48$ |
...
✅ **OK** — última verificación 2026-07-11T19:45 UTC | rechazos 1h: 1 (rango=0, spike=0)

| Asset | Precio | Age | Alertas |
|---|---|---|---|
| ✅ BTC | $64,216.96 | 0.1min |  |
| ✅ ETH | $1,819.64 | 0.1min |  |
| ✅ SOL | $78.07 | 0.1min |  |
| ✅ XRP | $1.12 | 0.1min |  |
...
|---|---|---|---|
| BTC | $64,216.96 | consenso |  |
| ETH | $1,819.64 | consenso |  |
| SOL | $77.92 | consenso |  |
| XRP | $1.11 | consenso |  |
