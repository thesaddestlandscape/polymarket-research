# Estado del bot — 2026-07-12 23:11 UTC

## Live — dinero real (on-chain)
| | |
|---|---|
| Depósito inicial | 25.44 $ |
| Balance on-chain | **14.27 $** |
| P&L real total | 🔴 **-11.17 $** |
| P&L real hoy | -4.96 $ |
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +1346.14 $ |
| P&L sim compuesto | 🟢 +2204.40 $ (ficción Kelly: +8665% s/ operativo) |
| P&L sim hoy (2026-07-12) | 🟢 +599.69 $ |
| Operaciones resueltas | 11570 (6636 WIN / 4934 LOSS) — 57.4% |
...
| FAVORITO_CONFIRMADO | 1076 | 68.4% | +0.184 | 📈 madura (+0.07) | +11.20$ | 1.83$ | ✅ activa |
...
|---|---|---|---|---|
| 2026-07-12T23:07 | FAVORITO_CONFIRMADO#BTC#60min | Bitcoin Up or Down - July 12, 6PM ET… | ✅ WIN | +1.16$ |
...
✅ **OK** — última verificación 2026-07-12T23:10 UTC | rechazos 1h: 1 (rango=0, spike=0)
