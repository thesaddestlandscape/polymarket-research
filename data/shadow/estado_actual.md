# Estado del bot — 2026-08-08 18:21 UTC
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +5968.63 $ |
| P&L sim compuesto | 🟢 +14007.44 $ (ficción Kelly: +55061% s/ operativo) |
| P&L sim hoy (2026-08-08) | 🟢 +277.15 $ |
| Operaciones resueltas | 93881 (57466 WIN / 36415 LOSS) — 61.2% |
| Señales abiertas | 607 |

## Estrategias (visión global)

| Estrategia | n | Win% | IC_efectivo | Tendencia | PNL | Apuesta | Estado |
|---|---|---|---|---|---|---|---|
| GBM_LATE_15M_ESPACIO_ATR | 10276 | 62.5% | +0.125 | ➡️ estable | +5095.76$ | 1.25$ | ✅ activa |
| GBM_LATE_15M | 12824 | 60.2% | +0.102 | ➡️ estable | +4313.29$ | 1.02$ | ✅ activa |
| GBM_LATE_15M_TARDIO | 9861 | 58.8% | +0.088 | ➡️ estable | +3472.23$ | 0.88$ | ✅ activa |
...
| GBM_LATE_15M_MULTIHORIZONTE | 561 | 71.7% | +0.216 | ➡️ estable | +434.80$ | 2.00$ | ✅ activa |
...
| FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 609 | 62.7% | +0.127 | ➡️ estable | +10.47$ | 1.27$ | ✅ activa |
...
| STRUCT_NO_15M | 457 | 51.9% | +0.019 | ➡️ estable | -0.90$ | 0.50$ | ✅ activa |
...
| FAVORITO_CONFIRMADO_SOL_ALTACONVICCION | 617 | 80.2% | +0.301 | 📉 agota (-0.03) | -2.93$ | 2.00$ | ✅ activa |
...
| BALLENAS_CONFIRMADAS_15M | 1785 | 54.5% | +0.045 | 📉 agota (-0.16) | -30.66$ | 0.50$ | ✅ activa |
| UPDOWN_OU_5M | 335 | 32.5% | -0.174 | ➡️ estable | -57.63$ | 0.50$ | ⚠️ IC negativo |
| FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 2341 | 70.1% | +0.200 | 📉 agota (-0.06) | -163.14$ | 2.00$ | ✅ activa |
| BALLENAS_TARDIAS | 2194 | 42.5% | -0.075 | 📉 agota (-0.09) | -441.60$ | 0.50$ | ⚠️ IC negativo |
| FAVORITO_CONFIRMADO | 25246 | 61.9% | +0.119 | 📉 agota (-0.05) | -607.66$ | 1.19$ | ✅ activa |
| FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 11137 | 69.7% | +0.197 | ➡️ estable | -840.91$ | 1.97$ | ✅ activa |

## Últimas 5 resoluciones

| Timestamp | Estrategia | Mercado | Resultado | PNL |
|---|---|---|---|---|
| 2026-08-08T18:18 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | … | ✅ WIN | +0.29$ |
| 2026-08-08T18:18 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-08T18:18 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BTC#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-08T18:18 | BALLENAS_TARDIAS#SOL#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-08T18:18 | FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA#XRP#5min | … | ✅ WIN | +0.39$ |

## Calidad de datos

✅ **OK** — última verificación 2026-08-08T18:15 UTC

| Asset | Precio | Age | Alertas |
|---|---|---|---|
| ✅ BTC | $65,052.15 | 0.2min |  |
| ✅ ETH | $1,921.62 | 0.2min |  |
| ✅ SOL | $76.27 | 0.2min |  |
| ✅ XRP | $1.04 | 0.2min |  |
...
|---|---|---|---|
| BTC | $65,069.20 | consenso |  |
| ETH | $1,921.62 | consenso |  |
| SOL | $76.22 | consenso |  |
| XRP | $1.04 | consenso |  |
