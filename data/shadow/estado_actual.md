# Estado del bot — 2026-08-19 10:54 UTC
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +5614.10 $ |
| P&L sim compuesto | 🟢 +19192.53 $ (ficción Kelly: +75442% s/ operativo) |
| P&L sim hoy (2026-08-19) | 🟢 +1023.40 $ |
| Operaciones resueltas | 182470 (109169 WIN / 73301 LOSS) — 59.8% |
...
|---|---|---|---|---|---|---|---|
| GBM_LATE_15M_ESPACIO_ATR | 15449 | 59.8% | +0.098 | 📉 agota (-0.05) | +6942.36$ | 0.50$ | ✅ activa |
| GBM_LATE_15M | 17084 | 59.7% | +0.097 | ➡️ estable | +5896.91$ | 0.85$ | ✅ activa |
| GBM_LATE_15M_TARDIO | 13587 | 61.0% | +0.110 | 📈 madura (+0.09) | +5847.91$ | 1.67$ | ✅ activa |
...
| GBM_LATE_5M | 2260 | 52.2% | +0.022 | 📈 madura (+0.08) | +239.68$ | 1.04$ | ✅ activa |
...
| MOMENTUM_IBS_15M | 887 | 53.6% | +0.035 | ➡️ estable | +39.42$ | 0.50$ | ✅ activa |
| LEADLAG_BTC_XRP_15M | 400 | 54.0% | +0.040 | ➡️ estable | +36.76$ | 1.45$ | ✅ activa |
| MOMENTUM_IBS_5M_FADE | 2812 | 51.6% | +0.016 | ➡️ estable | +22.27$ | 0.50$ | ✅ activa |
...
| FAVORITO_CONFIRMADO_DEPTH_FASE0 | 5 | 60.0% | +0.018 | — | -2.07$ | 0.50$ | ⏳ acumulando |
...
| MOMENTUM_IBS_15M_FADE | 403 | 44.7% | -0.053 | 📈 madura (+0.09) | -22.72$ | 0.50$ | ⚠️ IC negativo |
...
| STREAK_MOM_5M | 1148 | 49.3% | -0.007 | 📈 madura (+0.06) | -30.09$ | 0.50$ | ⚠️ IC negativo |
...
| FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 5445 | 67.4% | +0.174 | 📉 agota (-0.05) | -484.28$ | 1.58$ | ✅ activa |
| BALLENAS_TARDIAS | 9065 | 42.8% | -0.072 | 📉 agota (-0.08) | -1448.73$ | 0.50$ | ⚠️ IC negativo |
| FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 24300 | 69.2% | +0.192 | ➡️ estable | -2111.32$ | 1.81$ | ✅ activa |
| FAVORITO_CONFIRMADO | 47758 | 60.9% | +0.109 | ➡️ estable | -2239.50$ | 1.12$ | ✅ activa |

## Últimas 5 resoluciones

| Timestamp | Estrategia | Mercado | Resultado | PNL |
|---|---|---|---|---|
| 2026-08-19T10:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-19T10:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | … | ✅ WIN | +0.00$ |
| 2026-08-19T10:52 | FAVORITO_CONFIRMADO#BNB#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-19T10:52 | FAVORITO_CONFIRMADO_DEPTH_FASE0#SOL#5min | … | ✅ WIN | +0.00$ |
| 2026-08-19T10:52 | FAVORITO_CONFIRMADO#SOL#5min | … | ✅ WIN | +0.00$ |

## Calidad de datos

✅ **OK** — última verificación 2026-08-19T10:53 UTC

| Asset | Precio | Age | Alertas |
|---|---|---|---|
| ✅ BTC | $64,353.93 | 0.2min |  |
| ✅ ETH | $1,917.95 | 0.2min |  |
| ✅ SOL | $77.33 | 0.2min |  |
| ✅ XRP | $1.01 | 0.2min |  |
