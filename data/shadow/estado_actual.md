# Estado del bot — 2026-08-09 15:53 UTC
...
| | |
|---|---|
| P&L fiel (stake fijo 1$) | +6017.15 $ |
| P&L sim compuesto | 🟢 +14226.03 $ (ficción Kelly: +55920% s/ operativo) |
| P&L sim hoy (2026-08-09) | 🟢 +166.12 $ |
| Operaciones resueltas | 99271 (60864 WIN / 38407 LOSS) — 61.3% |
...
|---|---|---|---|---|---|---|---|
| GBM_LATE_15M_ESPACIO_ATR | 10642 | 62.2% | +0.122 | ➡️ estable | +5220.39$ | 1.22$ | ✅ activa |
| GBM_LATE_15M | 13106 | 60.1% | +0.101 | ➡️ estable | +4394.29$ | 1.01$ | ✅ activa |
| GBM_LATE_15M_TARDIO | 10041 | 59.0% | +0.090 | 📈 madura (+0.03) | +3611.19$ | 0.90$ | ✅ activa |
...
| FAVORITO_CONFIRMADO_5MIN_BAJALATENCIA | 1014 | 63.3% | +0.133 | ➡️ estable | +19.28$ | 1.33$ | ✅ activa |
...
| LIQUIDACIONES_60M | 105 | 54.3% | +0.042 | 📈 madura (+0.08) | -0.24$ | 0.50$ | ✅ activa |
| FAVORITO_CONFIRMADO_15MIN_EXTREMO | 131 | 93.9% | +0.432 | 📈 madura (+0.06) | -0.45$ | 2.00$ | ✅ activa |
| STRUCT_NO_15M | 600 | 52.0% | +0.020 | 📉 agota (-0.03) | -0.71$ | 0.50$ | ✅ activa |
...
| LIQUIDACIONES_15M | 91 | 40.7% | -0.091 | 📈 madura (+0.05) | -10.65$ | 0.50$ | ⚠️ IC negativo |
...
| BALLENAS_CONFIRMADAS_15M | 1823 | 54.6% | +0.046 | 📉 agota (-0.16) | -29.70$ | 0.50$ | ✅ activa |
| UPDOWN_OU_5M | 342 | 32.5% | -0.174 | ➡️ estable | -58.67$ | 0.50$ | ⚠️ IC negativo |
| FAVORITO_CONFIRMADO_15MIN_ALTACONVICCION | 2609 | 70.1% | +0.201 | 📉 agota (-0.05) | -171.64$ | 2.00$ | ✅ activa |
| BALLENAS_TARDIAS | 2583 | 42.7% | -0.073 | 📉 agota (-0.04) | -573.00$ | 0.50$ | ⚠️ IC negativo |
| FAVORITO_CONFIRMADO | 27151 | 61.9% | +0.119 | 📉 agota (-0.04) | -674.15$ | 1.19$ | ✅ activa |
| FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION | 12211 | 69.9% | +0.199 | ➡️ estable | -899.52$ | 1.99$ | ✅ activa |

## Últimas 5 resoluciones

| Timestamp | Estrategia | Mercado | Resultado | PNL |
|---|---|---|---|---|
| 2026-08-09T15:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#XRP#5min | … | ✅ WIN | +0.26$ |
| 2026-08-09T15:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#BNB#5min | … | ❌ LOSS | -1.07$ |
| 2026-08-09T15:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#DOGE#5min | … | ✅ WIN | +0.31$ |
| 2026-08-09T15:52 | FAVORITO_CONFIRMADO_5MIN_ALTACONVICCION#SOL#5min | … | ✅ WIN | +0.37$ |
| 2026-08-09T15:52 | FAVORITO_CONFIRMADO#SOL#5min | … | ✅ WIN | +0.65$ |

## Calidad de datos

✅ **OK** — última verificación 2026-08-09T15:50 UTC

| Asset | Precio | Age | Alertas |
|---|---|---|---|
| ✅ BTC | $65,177.47 | 0.1min |  |
| ✅ ETH | $1,924.90 | 0.1min |  |
| ✅ SOL | $77.14 | 0.1min |  |
| ✅ XRP | $1.04 | 0.1min |  |
...
|---|---|---|---|
| BTC | $65,177.47 | consenso |  |
| ETH | $1,925.00 | consenso |  |
| SOL | $77.14 | consenso |  |
| XRP | $1.04 | consenso |  |
