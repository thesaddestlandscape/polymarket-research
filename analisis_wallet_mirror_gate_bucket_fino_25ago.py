...
def main() -> int:
    ...
    # 10-Sep: este generador también corre HORARIO (vigia_gate_bucket_
    # wallet_mirror_fino.py, vigias_frecuentes_fase0.py, 3600s) -- mismo fix
    # que analisis_wallet_mirror_gate_bucket_10ago.py, ver
    # gate_confirmacion_historial.py::veredicto_con_tolerancia_diario().
    ...
    def _preservar_historial(clave_str: str) -> None:
        ...
        10-Sep: preserva también fecha_historial -- mismo motivo exacto
        que en analisis_wallet_mirror_gate_bucket_10ago.py (si esta clave
        ya tenía una entrada de HOY de una corrida horaria anterior y esta
        hora deja de sobrevivir evaluar_tupla()/BH-FDR, sin esto la próxima
        vez que reaparezca hoy se contaría como "día nuevo")."""
    ...
    for idx, p in enumerate(pendientes):
        ...
        # 10-Sep: versión "diaria" del wrapper -- este generador corre
        # horario, ver comentario junto a fecha_historial_previo arriba.
