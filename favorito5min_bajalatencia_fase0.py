...
def _registrar_prediccion(activo: str, mercado: dict, py: float, prob_yes: float,
    ...
    # 09-Sep, petición explícita Javi: mismo hueco de instrumentación que
    # BALLENAS_TARDIAS -- esta CSV ni tenía la columna. Puro logging, no
    # toca py/edge/decisión. leer_snapshot_reciente() lee el fichero
    # compartido data/live/ballenas_recientes.json, no requiere que este
    # proceso corra su propio _fc.iniciar() (ver comentario 22-Ago arriba).
