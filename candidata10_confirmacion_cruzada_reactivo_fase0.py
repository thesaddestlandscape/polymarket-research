...
ACTIVITY_CHECKPOINT_PATH = DIR_SHADOW / "candidata10_confirmacion_cruzada_reactivo_fase0_activity_checkpoint.json"
...
def main() -> None:
    ...
    # adelante).
    # 07-Sep: checkpoint incremental (ver docstring de leer_activity_
    # incremental() -- arreglo real de la sobrecarga crónica de CPU, 4
    # consumidores releían el fichero completo cada 5-15s). Este backlog
    # consume el fichero hasta el final actual, así que el `while True`
    # de abajo ya solo ve filas genuinamente nuevas desde aquí.
